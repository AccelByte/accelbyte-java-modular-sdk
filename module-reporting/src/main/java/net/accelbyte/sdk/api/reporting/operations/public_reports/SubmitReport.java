...
public class SubmitReport extends Operation {
  ...
  @Deprecated
  public SubmitReport(String customBasePath, String namespace, RestapiSubmitReportRequest body) {
  ...
  public SubmitReportOpResponse parseResponse(int code, String contentType, InputStream payload)
