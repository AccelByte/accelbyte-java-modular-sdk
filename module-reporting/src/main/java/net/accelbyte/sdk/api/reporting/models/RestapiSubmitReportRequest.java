...
public class RestapiSubmitReportRequest extends Model {
    ...
    @JsonIgnore
    public List<RestapiSubmitReportRequest> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<RestapiSubmitReportRequest>>() {});
    }
