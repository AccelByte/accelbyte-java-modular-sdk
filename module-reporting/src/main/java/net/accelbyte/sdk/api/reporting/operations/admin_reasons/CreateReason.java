...
import net.accelbyte.sdk.api.reporting.operation_responses.admin_reasons.CreateReasonOpResponse;
...
public class CreateReason extends Operation {
  ...
  @Deprecated
  public CreateReason(String customBasePath, String namespace, RestapiCreateReasonRequest body) {
  ...
  public CreateReasonOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final CreateReasonOpResponse response = new CreateReasonOpResponse();
