...
import net.accelbyte.sdk.api.reporting.operation_responses.admin_tickets.ListTicketsOpResponse;
...
public class ListTickets extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("extensionCategory", this.extensionCategory == null ? null : Arrays.asList(this.extensionCategory));
        queryParams.put("limit", this.limit == null ? null : Arrays.asList(String.valueOf(this.limit)));
        queryParams.put("offset", this.offset == null ? null : Arrays.asList(String.valueOf(this.offset)));
        queryParams.put("order", this.order == null ? null : Arrays.asList(this.order));
        queryParams.put("reportedUserId", this.reportedUserId == null ? null : Arrays.asList(this.reportedUserId));
    ...
    public ListTicketsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ListTicketsOpResponse response = new ListTicketsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new RestapiTicketListResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 500) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public RestapiTicketListResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
