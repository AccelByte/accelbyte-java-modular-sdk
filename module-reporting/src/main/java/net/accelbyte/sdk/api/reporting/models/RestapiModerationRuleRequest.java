...
public class RestapiModerationRuleRequest extends Model {
    ...
    @JsonIgnore
    public List<RestapiModerationRuleRequest> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<RestapiModerationRuleRequest>>() {});
    }
