...
public class Get extends Operation {
  ...
  @Deprecated
  public Get(String customBasePath, String namespace, String category) {
  ...
  public GetOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetOpResponse response = new GetOpResponse();
