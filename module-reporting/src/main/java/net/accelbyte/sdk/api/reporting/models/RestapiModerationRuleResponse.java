...
public class RestapiModerationRuleResponse extends Model {
    ...
    @JsonIgnore
    public List<RestapiModerationRuleResponse> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<RestapiModerationRuleResponse>>() {});
    }
