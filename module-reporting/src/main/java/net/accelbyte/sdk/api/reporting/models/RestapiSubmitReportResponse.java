...
public class RestapiSubmitReportResponse extends Model {
    ...
    @JsonIgnore
    public List<RestapiSubmitReportResponse> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<RestapiSubmitReportResponse>>() {});
    }
