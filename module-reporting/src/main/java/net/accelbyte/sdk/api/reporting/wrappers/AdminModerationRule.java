...
public class AdminModerationRule {
   ...
   */
  public CreateModerationRuleOpResponse createModerationRule(CreateModerationRule input)
      throws Exception {
   ...
   */
  public UpdateModerationRuleOpResponse updateModerationRule(UpdateModerationRule input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public DeleteModerationRuleOpResponse deleteModerationRule(DeleteModerationRule input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public UpdateModerationRuleStatusOpResponse updateModerationRuleStatus(
      UpdateModerationRuleStatus input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public GetModerationRulesOpResponse getModerationRules(GetModerationRules input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public GetModerationRuleDetailsOpResponse getModerationRuleDetails(GetModerationRuleDetails input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
