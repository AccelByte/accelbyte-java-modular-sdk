...
import net.accelbyte.sdk.api.reporting.operation_responses.admin_tickets.UpdateTicketResolutionsOpResponse;
...
public class UpdateTicketResolutions extends Operation {
    ...
    */
    ...
    public UpdateTicketResolutionsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateTicketResolutionsOpResponse response = new UpdateTicketResolutionsOpResponse();
