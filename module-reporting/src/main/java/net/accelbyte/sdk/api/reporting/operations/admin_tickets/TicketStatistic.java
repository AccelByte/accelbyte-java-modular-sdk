...
public class TicketStatistic extends Operation {
  ...
  public TicketStatistic(
      String customBasePath, String namespace, String extensionCategory, String category) {
  ...
  public TicketStatisticOpResponse parseResponse(int code, String contentType, InputStream payload)
