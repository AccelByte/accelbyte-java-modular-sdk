...
public class AdminCreateExtensionCategory extends Operation {
  ...
  public AdminCreateExtensionCategoryOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminCreateExtensionCategoryOpResponse response =
        new AdminCreateExtensionCategoryOpResponse();
