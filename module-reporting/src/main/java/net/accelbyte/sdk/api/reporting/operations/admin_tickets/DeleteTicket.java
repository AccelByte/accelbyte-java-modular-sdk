...
import net.accelbyte.sdk.api.reporting.operation_responses.admin_tickets.DeleteTicketOpResponse;
...
public class DeleteTicket extends Operation {
  ...
  @Deprecated
  public DeleteTicket(String customBasePath, String namespace, String ticketId) {
  ...
  public DeleteTicketOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final DeleteTicketOpResponse response = new DeleteTicketOpResponse();
