...
public class AdminTickets {
   ...
   */
  public GetReportsByTicketOpResponse getReportsByTicket(GetReportsByTicket input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public UpdateTicketResolutionsOpResponse updateTicketResolutions(UpdateTicketResolutions input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
