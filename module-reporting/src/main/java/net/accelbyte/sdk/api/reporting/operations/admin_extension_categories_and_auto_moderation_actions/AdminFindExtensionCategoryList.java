...
public class AdminFindExtensionCategoryList extends Operation {
  ...
  @Deprecated
  public AdminFindExtensionCategoryList(String customBasePath, String order, String sortBy) {
    this.order = order;
    this.sortBy = sortBy;
  ...
  public AdminFindExtensionCategoryListOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminFindExtensionCategoryListOpResponse response =
        new AdminFindExtensionCategoryListOpResponse();
