...
public class AdminExtensionCategoriesAndAutoModerationActions {
   ...
   */
  public AdminFindActionListOpResponse adminFindActionList(AdminFindActionList input)
      throws Exception {
   ...
   */
  public AdminCreateModActionOpResponse adminCreateModAction(AdminCreateModAction input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminFindExtensionCategoryListOpResponse adminFindExtensionCategoryList(
   ...
   */
  public AdminCreateExtensionCategoryOpResponse adminCreateExtensionCategory(
