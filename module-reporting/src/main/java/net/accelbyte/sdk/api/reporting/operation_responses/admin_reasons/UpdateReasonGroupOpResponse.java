...
@Getter
@Setter
public class UpdateReasonGroupOpResponse extends ApiResponseWithData<RestapiReasonGroupResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.reporting.operations.admin_reasons.UpdateReasonGroup";
  }
}
