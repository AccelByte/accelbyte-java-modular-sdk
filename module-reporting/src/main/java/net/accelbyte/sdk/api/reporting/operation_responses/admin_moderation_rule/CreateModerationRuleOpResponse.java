...
@Getter
@Setter
public class CreateModerationRuleOpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.reporting.operations.admin_moderation_rule.CreateModerationRule";
    }
}