...
import net.accelbyte.sdk.api.reporting.operation_responses.admin_reasons.CreateReasonGroupOpResponse;
...
public class CreateReasonGroup extends Operation {
    ...
    */
    ...
    public CreateReasonGroupOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreateReasonGroupOpResponse response = new CreateReasonGroupOpResponse();
