...
import net.accelbyte.sdk.api.basic.operation_responses.namespace.PublicGetNamespacesOpResponse;
...
public class PublicGetNamespaces extends Operation {
  ...
  @Deprecated
  public PublicGetNamespaces(String customBasePath, Boolean activeOnly) {
  ...
  public PublicGetNamespacesOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGetNamespacesOpResponse response = new PublicGetNamespacesOpResponse();
    ...
    if (code == 204) {
      ...
      response.setSuccess(true);
      response.setData(
          new ObjectMapper().readValue(json, new TypeReference<List<NamespaceInfo>>() {}));
    } else if (code == 401) {
      final String json = Helper.convertInputStreamToString(payload);
