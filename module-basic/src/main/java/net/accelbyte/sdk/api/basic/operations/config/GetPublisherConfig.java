...
import net.accelbyte.sdk.api.basic.operation_responses.config.GetPublisherConfigOpResponse;
...
public class GetPublisherConfig extends Operation {
    ...
    */
    ...
    public GetPublisherConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetPublisherConfigOpResponse response = new GetPublisherConfigOpResponse();
