...
public class PublicGetUserProfilePublicInfoByIds extends Operation {
    ...
    */
    ...
    public PublicGetUserProfilePublicInfoByIdsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetUserProfilePublicInfoByIdsOpResponse response = new PublicGetUserProfilePublicInfoByIdsOpResponse();
