...
@Getter
@Setter
public class UpdateMyZipCodeOpResponse extends ApiResponseWithData<UserZipCode> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.basic.operations.user_profile.UpdateMyZipCode";
    }
}