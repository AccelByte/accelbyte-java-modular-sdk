...
@Getter
@Setter
public class CreateNamespaceOpResponse extends ApiResponseWithData<NamespaceInfo> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.basic.operations.namespace.CreateNamespace";
  }
}
