...
import net.accelbyte.sdk.api.basic.operation_responses.config.DeleteConfigOpResponse;
...
public class DeleteConfig extends Operation {
    ...
    */
    ...
    public DeleteConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
