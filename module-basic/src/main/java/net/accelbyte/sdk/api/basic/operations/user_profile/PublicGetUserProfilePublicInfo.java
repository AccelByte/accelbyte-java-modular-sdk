...
public class PublicGetUserProfilePublicInfo extends Operation {
    ...
    */
    ...
    public PublicGetUserProfilePublicInfoOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetUserProfilePublicInfoOpResponse response = new PublicGetUserProfilePublicInfoOpResponse();
