...
import net.accelbyte.sdk.api.basic.operation_responses.namespace.GetGameNamespacesOpResponse;
...
public class GetGameNamespaces extends Operation {
    ...
    */
    ...
    public GetGameNamespacesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetGameNamespacesOpResponse response = new GetGameNamespacesOpResponse();
