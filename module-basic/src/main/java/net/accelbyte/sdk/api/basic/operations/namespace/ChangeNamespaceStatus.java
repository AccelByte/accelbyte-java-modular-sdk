...
import net.accelbyte.sdk.api.basic.operation_responses.namespace.ChangeNamespaceStatusOpResponse;
...
public class ChangeNamespaceStatus extends Operation {
  ...
  public ChangeNamespaceStatus(
      String customBasePath, String namespace, NamespaceStatusUpdate body) {
  ...
  public ChangeNamespaceStatusOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final ChangeNamespaceStatusOpResponse response = new ChangeNamespaceStatusOpResponse();
