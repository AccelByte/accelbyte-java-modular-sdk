...
public class PublicBulkGetUserProfilePublicInfo extends Operation {
  ...
  public PublicBulkGetUserProfilePublicInfoOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicBulkGetUserProfilePublicInfoOpResponse response =
        new PublicBulkGetUserProfilePublicInfoOpResponse();
