...
import net.accelbyte.sdk.api.basic.operation_responses.user_profile.GetUserProfileInfoOpResponse;
...
public class GetUserProfileInfo extends Operation {
    ...
    */
    ...
    public GetUserProfileInfoOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserProfileInfoOpResponse response = new GetUserProfileInfoOpResponse();
