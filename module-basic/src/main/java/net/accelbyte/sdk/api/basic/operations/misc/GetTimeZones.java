...
public class GetTimeZones extends Operation {
  ...
  @Deprecated
  public GetTimeZones(String customBasePath, String namespace) {
  ...
  public GetTimeZonesOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetTimeZonesOpResponse response = new GetTimeZonesOpResponse();
