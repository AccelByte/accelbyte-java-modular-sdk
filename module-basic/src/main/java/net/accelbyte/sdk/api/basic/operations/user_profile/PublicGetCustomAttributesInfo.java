...
public class PublicGetCustomAttributesInfo extends Operation {
  ...
  public PublicGetCustomAttributesInfoOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGetCustomAttributesInfoOpResponse response =
        new PublicGetCustomAttributesInfoOpResponse();
