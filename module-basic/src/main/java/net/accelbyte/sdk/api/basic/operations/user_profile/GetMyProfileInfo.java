...
import net.accelbyte.sdk.api.basic.operation_responses.user_profile.GetMyProfileInfoOpResponse;
...
public class GetMyProfileInfo extends Operation {
  ...
  @Deprecated
  public GetMyProfileInfo(String customBasePath, String namespace) {
  ...
  public GetMyProfileInfoOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetMyProfileInfoOpResponse response = new GetMyProfileInfoOpResponse();
