...
@Getter
@Setter
public class ChangeNamespaceStatusOpResponse extends ApiResponseWithData<NamespaceInfo> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.basic.operations.namespace.ChangeNamespaceStatus";
  }
}
