...
public class FileUpload {
   ...
   */
  public GeneratedUploadUrlOpResponse generatedUploadUrl(GeneratedUploadUrl input)
      throws Exception {
   ...
   */
  public GeneratedUserUploadContentUrlOpResponse generatedUserUploadContentUrl(
      GeneratedUserUploadContentUrl input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public PublicGeneratedUploadUrlOpResponse publicGeneratedUploadUrl(PublicGeneratedUploadUrl input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public PublicGeneratedUserUploadContentUrlOpResponse publicGeneratedUserUploadContentUrl(
