...
public class PublicGeneratedUploadUrl extends Operation {
    ...
    */
    ...
    public PublicGeneratedUploadUrlOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGeneratedUploadUrlOpResponse response = new PublicGeneratedUploadUrlOpResponse();
