...
@Getter
@Setter
public class UpdateTestingFlagOpResponse extends ApiResponseWithData<NamespaceInfo> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.basic.operations.namespace.UpdateTestingFlag";
  }
}
