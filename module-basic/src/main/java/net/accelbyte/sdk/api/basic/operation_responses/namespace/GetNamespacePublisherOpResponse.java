...
@Getter
@Setter
public class GetNamespacePublisherOpResponse extends ApiResponseWithData<NamespacePublisherInfo> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.basic.operations.namespace.GetNamespacePublisher";
  }
}
