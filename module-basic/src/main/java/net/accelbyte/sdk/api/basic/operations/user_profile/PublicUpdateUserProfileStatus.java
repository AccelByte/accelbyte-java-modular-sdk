...
public class PublicUpdateUserProfileStatus extends Operation {
  ...
  public PublicUpdateUserProfileStatus(
      String customBasePath, String namespace, String userId, UserProfileStatusUpdate body) {
  ...
  public PublicUpdateUserProfileStatusOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicUpdateUserProfileStatusOpResponse response =
        new PublicUpdateUserProfileStatusOpResponse();
