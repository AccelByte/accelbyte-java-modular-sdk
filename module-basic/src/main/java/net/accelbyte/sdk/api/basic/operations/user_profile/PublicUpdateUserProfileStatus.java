...
import net.accelbyte.sdk.api.basic.operation_responses.user_profile.PublicUpdateUserProfileStatusOpResponse;
...
public class PublicUpdateUserProfileStatus extends Operation {
    ...
    */
    ...
    public PublicUpdateUserProfileStatusOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicUpdateUserProfileStatusOpResponse response = new PublicUpdateUserProfileStatusOpResponse();
