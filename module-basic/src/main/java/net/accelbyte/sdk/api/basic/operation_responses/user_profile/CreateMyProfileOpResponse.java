...
@Getter
@Setter
public class CreateMyProfileOpResponse extends ApiResponseWithData<UserProfilePrivateInfo> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.basic.operations.user_profile.CreateMyProfile";
    }
}