...
public class GetNamespaces extends Operation {
  ...
  @Deprecated
  public GetNamespaces(String customBasePath, Boolean activeOnly, Boolean isTesting) {
  ...
  public GetNamespacesOpResponse parseResponse(int code, String contentType, InputStream payload)
