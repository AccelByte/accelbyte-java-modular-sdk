...
public class AdminGetUserProfilePublicInfoByIds extends Operation {
    ...
    */
    ...
    public AdminGetUserProfilePublicInfoByIdsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetUserProfilePublicInfoByIdsOpResponse response = new AdminGetUserProfilePublicInfoByIdsOpResponse();
