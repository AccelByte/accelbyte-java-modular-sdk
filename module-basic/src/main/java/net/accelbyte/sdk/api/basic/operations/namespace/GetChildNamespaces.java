...
import net.accelbyte.sdk.api.basic.operation_responses.namespace.GetChildNamespacesOpResponse;
...
public class GetChildNamespaces extends Operation {
    ...
    */
    ...
    public GetChildNamespacesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetChildNamespacesOpResponse response = new GetChildNamespacesOpResponse();
