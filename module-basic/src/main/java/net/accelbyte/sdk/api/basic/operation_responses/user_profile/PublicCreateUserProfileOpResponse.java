...
@Getter
@Setter
public class PublicCreateUserProfileOpResponse extends ApiResponseWithData<UserProfileInfo> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.basic.operations.user_profile.PublicCreateUserProfile";
    }
}