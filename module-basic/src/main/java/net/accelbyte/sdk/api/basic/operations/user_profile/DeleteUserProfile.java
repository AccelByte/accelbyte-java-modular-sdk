...
import net.accelbyte.sdk.api.basic.operation_responses.user_profile.DeleteUserProfileOpResponse;
...
public class DeleteUserProfile extends Operation {
    ...
    */
    ...
    public DeleteUserProfileOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteUserProfileOpResponse response = new DeleteUserProfileOpResponse();
