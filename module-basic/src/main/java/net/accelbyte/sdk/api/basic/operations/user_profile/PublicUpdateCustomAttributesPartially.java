...
public class PublicUpdateCustomAttributesPartially extends Operation {
  ...
  public PublicUpdateCustomAttributesPartiallyOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicUpdateCustomAttributesPartiallyOpResponse response =
        new PublicUpdateCustomAttributesPartiallyOpResponse();
