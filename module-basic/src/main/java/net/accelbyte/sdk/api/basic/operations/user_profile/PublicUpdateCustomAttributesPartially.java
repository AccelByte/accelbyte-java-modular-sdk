...
import net.accelbyte.sdk.api.basic.operation_responses.user_profile.PublicUpdateCustomAttributesPartiallyOpResponse;
...
public class PublicUpdateCustomAttributesPartially extends Operation {
    ...
    */
    ...
    public PublicUpdateCustomAttributesPartiallyOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicUpdateCustomAttributesPartiallyOpResponse response = new PublicUpdateCustomAttributesPartiallyOpResponse();
