...
@Getter
@Setter
public class PublicGetUserProfileInfoOpResponse extends ApiResponseWithData<UserProfileInfo> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.basic.operations.user_profile.PublicGetUserProfileInfo";
    }
}