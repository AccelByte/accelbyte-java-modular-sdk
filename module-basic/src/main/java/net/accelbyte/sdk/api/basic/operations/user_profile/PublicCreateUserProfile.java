...
import net.accelbyte.sdk.api.basic.operation_responses.user_profile.PublicCreateUserProfileOpResponse;
...
public class PublicCreateUserProfile extends Operation {
    ...
    */
    ...
    public PublicCreateUserProfileOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicCreateUserProfileOpResponse response = new PublicCreateUserProfileOpResponse();
