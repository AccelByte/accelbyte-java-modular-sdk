...
import net.accelbyte.sdk.api.basic.operation_responses.namespace.UpdateTestingFlagOpResponse;
...
public class UpdateTestingFlag extends Operation {
  ...
  public UpdateTestingFlag(
      String customBasePath, String namespace, NamespaceTestingFlagUpdate body) {
  ...
  public UpdateTestingFlagOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdateTestingFlagOpResponse response = new UpdateTestingFlagOpResponse();
