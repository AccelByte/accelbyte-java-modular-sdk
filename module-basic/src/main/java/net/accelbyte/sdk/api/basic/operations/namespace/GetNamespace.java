...
import net.accelbyte.sdk.api.basic.operation_responses.namespace.GetNamespaceOpResponse;
...
public class GetNamespace extends Operation {
    ...
    */
    ...
    public GetNamespaceOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetNamespaceOpResponse response = new GetNamespaceOpResponse();
