...
@Getter
@Setter
public class PublicUpdateUserProfileOpResponse extends ApiResponseWithData<UserProfileInfo> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.basic.operations.user_profile.PublicUpdateUserProfile";
  }
}
