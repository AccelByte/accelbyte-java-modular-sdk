...
@Getter
@Setter
public class DeleteNamespaceOpResponse extends ApiResponseWithData<NamespaceInfo> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.basic.operations.namespace.DeleteNamespace";
    }
}