...
public class GetCountryGroups extends Operation {
    ...
    */
    ...
    public GetCountryGroupsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetCountryGroupsOpResponse response = new GetCountryGroupsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<RetrieveCountryGroupResponse>>() {}));
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
