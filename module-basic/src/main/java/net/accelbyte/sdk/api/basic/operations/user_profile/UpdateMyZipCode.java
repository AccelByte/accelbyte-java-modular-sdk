...
public class UpdateMyZipCode extends Operation {
  ...
  public UpdateMyZipCode(
      String customBasePath, String namespace, UserZipCodeUpdate userZipCodeUpdate) {
  ...
  public UpdateMyZipCodeOpResponse parseResponse(int code, String contentType, InputStream payload)
