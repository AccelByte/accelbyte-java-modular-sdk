...
import net.accelbyte.sdk.api.basic.operation_responses.user_profile.CreateMyProfileOpResponse;
...
public class CreateMyProfile extends Operation {
  ...
  @Deprecated
  public CreateMyProfile(String customBasePath, String namespace, UserProfilePrivateCreate body) {
  ...
  public CreateMyProfileOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final CreateMyProfileOpResponse response = new CreateMyProfileOpResponse();
