...
public class UpdateCountryGroup extends Operation {
    ...
    */
    ...
    public UpdateCountryGroup(
            String customBasePath,            String countryGroupCode,
            String namespace,
    ...
    public UpdateCountryGroupOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
