...
import net.accelbyte.sdk.api.basic.operation_responses.user_profile.UpdatePrivateCustomAttributesPartiallyOpResponse;
...
public class UpdatePrivateCustomAttributesPartially extends Operation {
    ...
    */
    ...
    public UpdatePrivateCustomAttributesPartiallyOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdatePrivateCustomAttributesPartiallyOpResponse response = new UpdatePrivateCustomAttributesPartiallyOpResponse();
