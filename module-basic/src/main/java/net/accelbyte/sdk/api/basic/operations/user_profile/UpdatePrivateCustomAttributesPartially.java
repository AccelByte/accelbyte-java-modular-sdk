...
public class UpdatePrivateCustomAttributesPartially extends Operation {
  ...
  public UpdatePrivateCustomAttributesPartially(
      String customBasePath, String namespace, String userId, Map<String, ?> body) {
  ...
  public UpdatePrivateCustomAttributesPartiallyOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdatePrivateCustomAttributesPartiallyOpResponse response =
        new UpdatePrivateCustomAttributesPartiallyOpResponse();
