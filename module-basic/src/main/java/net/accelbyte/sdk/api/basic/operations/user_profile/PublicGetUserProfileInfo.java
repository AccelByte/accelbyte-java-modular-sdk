...
import net.accelbyte.sdk.api.basic.operation_responses.user_profile.PublicGetUserProfileInfoOpResponse;
...
public class PublicGetUserProfileInfo extends Operation {
    ...
    */
    ...
    public PublicGetUserProfileInfoOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetUserProfileInfoOpResponse response = new PublicGetUserProfileInfoOpResponse();
