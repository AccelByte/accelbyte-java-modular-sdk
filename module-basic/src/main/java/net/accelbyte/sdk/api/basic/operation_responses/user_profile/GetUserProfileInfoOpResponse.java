...
@Getter
@Setter
public class GetUserProfileInfoOpResponse extends ApiResponseWithData<UserProfilePrivateInfo> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.basic.operations.user_profile.GetUserProfileInfo";
  }
}
