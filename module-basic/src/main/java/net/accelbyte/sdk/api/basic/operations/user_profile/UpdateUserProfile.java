...
import net.accelbyte.sdk.api.basic.operation_responses.user_profile.UpdateUserProfileOpResponse;
...
public class UpdateUserProfile extends Operation {
    ...
    */
    ...
    public UpdateUserProfileOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateUserProfileOpResponse response = new UpdateUserProfileOpResponse();
