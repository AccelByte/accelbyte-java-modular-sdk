...
@Getter
@Setter
public class GetMyProfileInfoOpResponse extends ApiResponseWithData<UserProfilePrivateInfo> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.basic.operations.user_profile.GetMyProfileInfo";
  }
}
