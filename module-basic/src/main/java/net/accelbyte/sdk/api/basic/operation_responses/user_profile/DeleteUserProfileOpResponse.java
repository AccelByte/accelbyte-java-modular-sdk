...
@Getter
@Setter
public class DeleteUserProfileOpResponse extends ApiResponseWithData<UserProfilePrivateInfo> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.basic.operations.user_profile.DeleteUserProfile";
    }
}