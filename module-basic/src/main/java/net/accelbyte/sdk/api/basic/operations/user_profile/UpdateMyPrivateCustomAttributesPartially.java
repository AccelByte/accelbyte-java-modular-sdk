...
public class UpdateMyPrivateCustomAttributesPartially extends Operation {
  ...
  public UpdateMyPrivateCustomAttributesPartially(
      String customBasePath, String namespace, Map<String, ?> body) {
  ...
  public UpdateMyPrivateCustomAttributesPartiallyOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdateMyPrivateCustomAttributesPartiallyOpResponse response =
        new UpdateMyPrivateCustomAttributesPartiallyOpResponse();
