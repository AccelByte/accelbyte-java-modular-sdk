...
import net.accelbyte.sdk.api.basic.operation_responses.user_profile.UpdateMyPrivateCustomAttributesPartiallyOpResponse;
...
public class UpdateMyPrivateCustomAttributesPartially extends Operation {
     ...
     */
    private String path = "/basic/v1/public/namespaces/{namespace}/users/me/profiles/privateCustomAttributes";
    ...
    */
    ...
    public UpdateMyPrivateCustomAttributesPartiallyOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateMyPrivateCustomAttributesPartiallyOpResponse response = new UpdateMyPrivateCustomAttributesPartiallyOpResponse();
