...
@Getter
@Setter
public class PublicGeneratedUploadUrlOpResponse extends ApiResponseWithData<FileUploadUrlInfo> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.basic.operations.file_upload.PublicGeneratedUploadUrl";
    }
}