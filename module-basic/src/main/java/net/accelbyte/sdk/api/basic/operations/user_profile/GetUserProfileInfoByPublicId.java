...
import net.accelbyte.sdk.api.basic.operation_responses.user_profile.GetUserProfileInfoByPublicIdOpResponse;
...
public class GetUserProfileInfoByPublicId extends Operation {
    ...
    */
    ...
    public GetUserProfileInfoByPublicIdOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserProfileInfoByPublicIdOpResponse response = new GetUserProfileInfoByPublicIdOpResponse();
