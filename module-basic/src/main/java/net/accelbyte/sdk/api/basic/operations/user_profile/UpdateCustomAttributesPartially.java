...
public class UpdateCustomAttributesPartially extends Operation {
  ...
  public UpdateCustomAttributesPartiallyOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdateCustomAttributesPartiallyOpResponse response =
        new UpdateCustomAttributesPartiallyOpResponse();
