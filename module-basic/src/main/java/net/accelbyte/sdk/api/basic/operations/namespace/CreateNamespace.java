...
public class CreateNamespace extends Operation {
  ...
  @Deprecated
  public CreateNamespace(String customBasePath, NamespaceCreate body) {
    this.body = body;
  ...
  public CreateNamespaceOpResponse parseResponse(int code, String contentType, InputStream payload)
