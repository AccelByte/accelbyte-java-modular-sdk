...
import net.accelbyte.sdk.api.basic.operation_responses.user_profile.GetCustomAttributesInfoOpResponse;
...
public class GetCustomAttributesInfo extends Operation {
    ...
    */
    ...
    public GetCustomAttributesInfoOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetCustomAttributesInfoOpResponse response = new GetCustomAttributesInfoOpResponse();
