...
@Getter
@Setter
public class UpdateMyProfileOpResponse extends ApiResponseWithData<UserProfilePrivateInfo> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.basic.operations.user_profile.UpdateMyProfile";
  }
}
