...
@Getter
@Setter
public class UpdateNamespaceOpResponse extends ApiResponseWithData<NamespaceInfo> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.basic.operations.namespace.UpdateNamespace";
    }
}