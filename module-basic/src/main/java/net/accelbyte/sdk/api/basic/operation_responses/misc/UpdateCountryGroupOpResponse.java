...
@Getter
@Setter
public class UpdateCountryGroupOpResponse extends ApiResponseWithData<CountryGroupObject> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.basic.operations.misc.UpdateCountryGroup";
  }
}
