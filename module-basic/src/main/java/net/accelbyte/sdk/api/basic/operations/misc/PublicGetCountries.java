...
public class PublicGetCountries extends Operation {
    ...
    */
    ...
    public PublicGetCountriesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetCountriesOpResponse response = new PublicGetCountriesOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<CountryObject>>() {}));
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
