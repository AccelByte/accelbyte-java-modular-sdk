...
import net.accelbyte.sdk.api.basic.operation_responses.user_profile.UpdateUserProfileStatusOpResponse;
...
public class UpdateUserProfileStatus extends Operation {
  ...
  public UpdateUserProfileStatusOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdateUserProfileStatusOpResponse response = new UpdateUserProfileStatusOpResponse();
