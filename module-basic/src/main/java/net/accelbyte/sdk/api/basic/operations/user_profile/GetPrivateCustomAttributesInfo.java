...
public class GetPrivateCustomAttributesInfo extends Operation {
    ...
    */
    ...
    public GetPrivateCustomAttributesInfoOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetPrivateCustomAttributesInfoOpResponse response = new GetPrivateCustomAttributesInfoOpResponse();
