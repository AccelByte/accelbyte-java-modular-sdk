...
import net.accelbyte.sdk.api.basic.operation_responses.user_profile.GetPrivateCustomAttributesInfoOpResponse;
...
public class GetPrivateCustomAttributesInfo extends Operation {
  ...
  @Deprecated
  public GetPrivateCustomAttributesInfo(String customBasePath, String namespace, String userId) {
  ...
  public GetPrivateCustomAttributesInfoOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetPrivateCustomAttributesInfoOpResponse response =
        new GetPrivateCustomAttributesInfoOpResponse();
