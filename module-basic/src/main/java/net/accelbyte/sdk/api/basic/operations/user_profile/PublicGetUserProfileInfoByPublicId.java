...
public class PublicGetUserProfileInfoByPublicId extends Operation {
  ...
  public PublicGetUserProfileInfoByPublicIdOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGetUserProfileInfoByPublicIdOpResponse response =
        new PublicGetUserProfileInfoByPublicIdOpResponse();
