...
import net.accelbyte.sdk.api.basic.operation_responses.user_profile.GetMyPrivateCustomAttributesInfoOpResponse;
...
public class GetMyPrivateCustomAttributesInfo extends Operation {
    ...
    */
    ...
    public GetMyPrivateCustomAttributesInfoOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetMyPrivateCustomAttributesInfoOpResponse response = new GetMyPrivateCustomAttributesInfoOpResponse();
