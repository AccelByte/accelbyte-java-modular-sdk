...
public class GetMyPrivateCustomAttributesInfo extends Operation {
  ...
  public GetMyPrivateCustomAttributesInfoOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetMyPrivateCustomAttributesInfoOpResponse response =
        new GetMyPrivateCustomAttributesInfoOpResponse();
