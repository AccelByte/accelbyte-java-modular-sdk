...
@Getter
@Setter
public class PublicGeneratedUserUploadContentUrlOpResponse extends ApiResponseWithData<FileUploadUrlInfo> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.basic.operations.file_upload.PublicGeneratedUserUploadContentUrl";
    }
}