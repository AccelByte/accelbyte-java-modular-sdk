...
import net.accelbyte.sdk.api.basic.operation_responses.namespace.DeleteNamespaceOpResponse;
...
public class DeleteNamespace extends Operation {
    ...
    */
    ...
    public DeleteNamespaceOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteNamespaceOpResponse response = new DeleteNamespaceOpResponse();
