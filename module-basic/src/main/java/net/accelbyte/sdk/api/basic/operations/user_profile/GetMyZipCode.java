...
import net.accelbyte.sdk.api.basic.operation_responses.user_profile.GetMyZipCodeOpResponse;
...
public class GetMyZipCode extends Operation {
  ...
  @Deprecated
  public GetMyZipCode(String customBasePath, String namespace) {
  ...
  public GetMyZipCodeOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetMyZipCodeOpResponse response = new GetMyZipCodeOpResponse();
