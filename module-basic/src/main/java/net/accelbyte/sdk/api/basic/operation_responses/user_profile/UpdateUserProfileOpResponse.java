...
@Getter
@Setter
public class UpdateUserProfileOpResponse extends ApiResponseWithData<UserProfilePrivateInfo> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.basic.operations.user_profile.UpdateUserProfile";
    }
}