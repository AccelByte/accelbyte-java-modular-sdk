...
@Getter
@Setter
public class AdminUpdateInventoryOpResponse extends ApiResponseWithData<ApimodelsInventoryResp> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.inventory.operations.admin_inventories.AdminUpdateInventory";
  }
}
