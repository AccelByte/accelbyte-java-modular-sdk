...
public class AdminInventoryConfigurations {
   ...
   */
  public AdminListInventoryConfigurationsOpResponse adminListInventoryConfigurations(
   ...
   */
  public AdminCreateInventoryConfigurationOpResponse adminCreateInventoryConfiguration(
   ...
   */
  public AdminGetInventoryConfigurationOpResponse adminGetInventoryConfiguration(
   ...
   */
  public AdminUpdateInventoryConfigurationOpResponse adminUpdateInventoryConfiguration(
   ...
   */
  public AdminDeleteInventoryConfigurationOpResponse adminDeleteInventoryConfiguration(
      AdminDeleteInventoryConfiguration input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
