...
public class AdminConsumeUserItem extends Operation {
     ...
     */
    private String path = "/inventory/v1/admin/namespaces/{namespace}/users/{userId}/inventories/{inventoryId}/consume";
    ...
    */
    ...
    public AdminConsumeUserItemOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminConsumeUserItemOpResponse response = new AdminConsumeUserItemOpResponse();
