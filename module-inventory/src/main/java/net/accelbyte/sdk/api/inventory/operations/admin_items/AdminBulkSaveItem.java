...
public class AdminBulkSaveItem extends Operation {
    ...
    */
    ...
    public AdminBulkSaveItemOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminBulkSaveItemOpResponse response = new AdminBulkSaveItemOpResponse();
