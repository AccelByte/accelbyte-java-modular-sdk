...
public class AdminDeleteInventoryConfiguration extends Operation {
    ...
    */
    ...
    public AdminDeleteInventoryConfigurationOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDeleteInventoryConfigurationOpResponse response = new AdminDeleteInventoryConfigurationOpResponse();
