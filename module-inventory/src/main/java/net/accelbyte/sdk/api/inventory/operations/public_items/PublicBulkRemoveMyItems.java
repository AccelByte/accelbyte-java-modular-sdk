...
public class PublicBulkRemoveMyItems extends Operation {
    ...
    */
    ...
    public PublicBulkRemoveMyItemsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicBulkRemoveMyItemsOpResponse response = new PublicBulkRemoveMyItemsOpResponse();
