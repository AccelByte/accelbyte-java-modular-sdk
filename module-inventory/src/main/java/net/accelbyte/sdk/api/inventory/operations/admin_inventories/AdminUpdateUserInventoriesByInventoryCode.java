...
public class AdminUpdateUserInventoriesByInventoryCode extends Operation {
     ...
     */
    private String path = "/inventory/v1/admin/namespaces/{namespace}/users/{userId}/inventoryConfigurations/{inventoryConfigurationCode}/inventories";
    ...
    */
    ...
    public AdminUpdateUserInventoriesByInventoryCode(
            String customBasePath,            String inventoryConfigurationCode,
            String namespace,
            String userId,
    ...
    public AdminUpdateUserInventoriesByInventoryCodeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateUserInventoriesByInventoryCodeOpResponse response = new AdminUpdateUserInventoriesByInventoryCodeOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<ApimodelsInventoryResp>>() {}));
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public List<ApimodelsInventoryResp> parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
