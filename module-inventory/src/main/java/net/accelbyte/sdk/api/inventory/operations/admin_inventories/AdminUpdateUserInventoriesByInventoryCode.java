...
public class AdminUpdateUserInventoriesByInventoryCode extends Operation {
  ...
  public AdminUpdateUserInventoriesByInventoryCodeOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminUpdateUserInventoriesByInventoryCodeOpResponse response =
        new AdminUpdateUserInventoriesByInventoryCodeOpResponse();
    ...
    if (code == 204) {
      ...
      response.setSuccess(true);
      response.setData(
          new ObjectMapper().readValue(json, new TypeReference<List<ApimodelsInventoryResp>>() {}));
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
