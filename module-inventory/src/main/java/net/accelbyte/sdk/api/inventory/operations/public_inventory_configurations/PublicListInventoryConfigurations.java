...
public class PublicListInventoryConfigurations extends Operation {
    ...
    */
    ...
    public PublicListInventoryConfigurationsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicListInventoryConfigurationsOpResponse response = new PublicListInventoryConfigurationsOpResponse();
