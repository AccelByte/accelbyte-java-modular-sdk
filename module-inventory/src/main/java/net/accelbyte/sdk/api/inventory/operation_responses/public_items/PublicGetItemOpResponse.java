...
@Getter
@Setter
public class PublicGetItemOpResponse extends ApiResponseWithData<ApimodelsItemResp> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.inventory.operations.public_items.PublicGetItem";
    }
}