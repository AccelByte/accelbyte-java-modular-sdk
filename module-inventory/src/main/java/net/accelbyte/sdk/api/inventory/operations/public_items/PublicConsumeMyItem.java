...
public class PublicConsumeMyItem extends Operation {
     ...
     */
    private String path = "/inventory/v1/public/namespaces/{namespace}/users/me/inventories/{inventoryId}/consume";
    ...
    */
    ...
    public PublicConsumeMyItemOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicConsumeMyItemOpResponse response = new PublicConsumeMyItemOpResponse();
