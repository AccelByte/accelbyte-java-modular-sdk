...
public class AdminUpdateIntegrationConfiguration extends Operation {
     ...
     */
    private String path = "/inventory/v1/admin/namespaces/{namespace}/integrationConfigurations/{integrationConfigurationId}";
    ...
    */
    ...
    public AdminUpdateIntegrationConfigurationOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateIntegrationConfigurationOpResponse response = new AdminUpdateIntegrationConfigurationOpResponse();
