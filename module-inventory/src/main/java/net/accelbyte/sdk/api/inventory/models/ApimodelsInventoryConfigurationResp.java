...
public class ApimodelsInventoryConfigurationResp extends Model {
    ...
    @JsonIgnore
    public ApimodelsInventoryConfigurationResp createFromJson(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, this.getClass());
    }

    @JsonIgnore
    public List<ApimodelsInventoryConfigurationResp> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ApimodelsInventoryConfigurationResp>>() {});
    }
