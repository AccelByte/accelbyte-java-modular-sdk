...
public class AdminItemTypes {
     ...
     */
    public AdminListItemTypesOpResponse adminListItemTypes(AdminListItemTypes input) throws Exception {
     ...
     */
    public AdminCreateItemTypeOpResponse adminCreateItemType(AdminCreateItemType input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public AdminDeleteItemTypeOpResponse adminDeleteItemType(AdminDeleteItemType input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
