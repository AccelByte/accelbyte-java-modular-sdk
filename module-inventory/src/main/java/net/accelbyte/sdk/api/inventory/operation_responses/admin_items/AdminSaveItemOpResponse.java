...
@Getter
@Setter
public class AdminSaveItemOpResponse extends ApiResponseWithData<ApimodelsItemResp> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.inventory.operations.admin_items.AdminSaveItem";
    }
}