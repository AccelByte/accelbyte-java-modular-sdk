...
public class ApimodelsChainingOperationReq extends Model {
    ...
    @JsonIgnore
    public List<ApimodelsChainingOperationReq> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ApimodelsChainingOperationReq>>() {});
    }
