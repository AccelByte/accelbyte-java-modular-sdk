...
public class AdminCreateIntegrationConfiguration extends Operation {
  ...
  public AdminCreateIntegrationConfigurationOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminCreateIntegrationConfigurationOpResponse response =
        new AdminCreateIntegrationConfigurationOpResponse();
