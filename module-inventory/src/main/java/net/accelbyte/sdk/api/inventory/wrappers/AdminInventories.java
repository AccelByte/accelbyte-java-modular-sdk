...
public class AdminInventories {
     ...
     */
    public AdminListInventoriesOpResponse adminListInventories(AdminListInventories input) throws Exception {
     ...
     */
    public AdminCreateInventoryOpResponse adminCreateInventory(AdminCreateInventory input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public AdminUpdateInventoryOpResponse adminUpdateInventory(AdminUpdateInventory input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public AdminUpdateUserInventoriesByInventoryCodeOpResponse adminUpdateUserInventoriesByInventoryCode(AdminUpdateUserInventoriesByInventoryCode input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
