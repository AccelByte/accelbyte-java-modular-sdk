...
public class AdminItems {
     ...
     */
    public AdminGetInventoryItemOpResponse adminGetInventoryItem(AdminGetInventoryItem input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public AdminConsumeUserItemOpResponse adminConsumeUserItem(AdminConsumeUserItem input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public AdminBulkUpdateMyItemsOpResponse adminBulkUpdateMyItems(AdminBulkUpdateMyItems input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public AdminSaveItemToInventoryOpResponse adminSaveItemToInventory(AdminSaveItemToInventory input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public AdminBulkRemoveItemsOpResponse adminBulkRemoveItems(AdminBulkRemoveItems input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public AdminBulkSaveItemToInventoryOpResponse adminBulkSaveItemToInventory(AdminBulkSaveItemToInventory input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public AdminSyncUserEntitlementsOpResponse adminSyncUserEntitlements(AdminSyncUserEntitlements input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
