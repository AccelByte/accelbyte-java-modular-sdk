...
public class ApimodelsSaveItemToInventoryReq extends Model {
    ...
    @JsonIgnore
    public ApimodelsSaveItemToInventoryReq createFromJson(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, this.getClass());
    }

    @JsonIgnore
    public List<ApimodelsSaveItemToInventoryReq> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ApimodelsSaveItemToInventoryReq>>() {});
    }
