...
public class AdminListItems extends Operation {
     ...
     */
    private String path = "/inventory/v1/admin/namespaces/{namespace}/inventories/{inventoryId}/items";
    ...
    */
    ...
    public AdminListItemsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminListItemsOpResponse response = new AdminListItemsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApimodelsListItemResp().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
