...
@Getter
@Setter
public class PublicBulkRemoveMyItemsOpResponse extends ApiResponseWithData<List<ApimodelsUpdateItemResp>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.inventory.operations.public_items.PublicBulkRemoveMyItems";
    }
}