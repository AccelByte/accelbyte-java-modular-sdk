...
@Getter
@Setter
public class AdminSyncUserEntitlementsOpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.inventory.operations.admin_items.AdminSyncUserEntitlements";
    }
}