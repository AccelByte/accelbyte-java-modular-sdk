...
@Getter
@Setter
public class AdminBulkSaveItemToInventoryOpResponse extends ApiResponseWithData<List<ApimodelsBulkSaveItemResp>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.inventory.operations.admin_items.AdminBulkSaveItemToInventory";
    }
}