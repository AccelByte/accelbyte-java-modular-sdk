...
public class AdminCreateChainingOperations extends Operation {
    ...
    */
    ...
    public AdminCreateChainingOperationsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminCreateChainingOperationsOpResponse response = new AdminCreateChainingOperationsOpResponse();
