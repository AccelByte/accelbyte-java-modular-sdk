...
public class PublicItems {
   ...
   */
  public PublicConsumeMyItemOpResponse publicConsumeMyItem(PublicConsumeMyItem input)
      throws Exception {
   ...
   */
  public PublicBulkUpdateMyItemsOpResponse publicBulkUpdateMyItems(PublicBulkUpdateMyItems input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public PublicBulkRemoveMyItemsOpResponse publicBulkRemoveMyItems(PublicBulkRemoveMyItems input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
