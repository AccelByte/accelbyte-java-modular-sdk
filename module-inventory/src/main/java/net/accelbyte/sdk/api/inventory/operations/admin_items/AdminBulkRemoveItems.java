...
public class AdminBulkRemoveItems extends Operation {
    ...
    */
    ...
    public AdminBulkRemoveItemsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminBulkRemoveItemsOpResponse response = new AdminBulkRemoveItemsOpResponse();
