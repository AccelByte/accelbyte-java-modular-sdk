...
public class AdminIntegrationConfigurations {
     ...
     */
    public AdminListIntegrationConfigurationsOpResponse adminListIntegrationConfigurations(AdminListIntegrationConfigurations input) throws Exception {
     ...
     */
    public AdminCreateIntegrationConfigurationOpResponse adminCreateIntegrationConfiguration(AdminCreateIntegrationConfiguration input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public AdminUpdateIntegrationConfigurationOpResponse adminUpdateIntegrationConfiguration(AdminUpdateIntegrationConfiguration input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public AdminUpdateStatusIntegrationConfigurationOpResponse adminUpdateStatusIntegrationConfiguration(AdminUpdateStatusIntegrationConfiguration input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
