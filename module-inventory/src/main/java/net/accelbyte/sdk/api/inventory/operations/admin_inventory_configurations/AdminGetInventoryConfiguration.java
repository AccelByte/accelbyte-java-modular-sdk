...
public class AdminGetInventoryConfiguration extends Operation {
  ...
  public AdminGetInventoryConfigurationOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetInventoryConfigurationOpResponse response =
        new AdminGetInventoryConfigurationOpResponse();
