...
public class AdminSyncUserEntitlements extends Operation {
     ...
     */
    private String path = "/inventory/v1/admin/namespaces/{namespace}/users/{userId}/items/entitlements/sync";
    ...
    */
    ...
    public AdminSyncUserEntitlementsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminSyncUserEntitlementsOpResponse response = new AdminSyncUserEntitlementsOpResponse();
