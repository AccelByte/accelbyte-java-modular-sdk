...
public class AdminCreateInventoryConfiguration extends Operation {
  ...
  public AdminCreateInventoryConfiguration(
      String customBasePath, String namespace, ApimodelsCreateInventoryConfigurationReq body) {
  ...
  public AdminCreateInventoryConfigurationOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminCreateInventoryConfigurationOpResponse response =
        new AdminCreateInventoryConfigurationOpResponse();
