...
public class AdminCreateInventoryConfiguration extends Operation {
    ...
    */
    ...
    public AdminCreateInventoryConfigurationOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminCreateInventoryConfigurationOpResponse response = new AdminCreateInventoryConfigurationOpResponse();
