...
public class ApimodelsAdminUpdateItemReq extends Model {
    ...
    @JsonIgnore
    public List<ApimodelsAdminUpdateItemReq> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ApimodelsAdminUpdateItemReq>>() {});
    }
