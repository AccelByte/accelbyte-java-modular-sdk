...
public class AdminUpdateInventoryConfiguration extends Operation {
  ...
  public AdminUpdateInventoryConfigurationOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminUpdateInventoryConfigurationOpResponse response =
        new AdminUpdateInventoryConfigurationOpResponse();
