...
public class PublicListItems extends Operation {
    ...
    */
    ...
    public PublicListItemsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicListItemsOpResponse response = new PublicListItemsOpResponse();
