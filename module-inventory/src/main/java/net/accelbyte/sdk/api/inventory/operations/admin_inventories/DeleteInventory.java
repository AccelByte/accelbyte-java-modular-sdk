...
public class DeleteInventory extends Operation {
    ...
    */
    ...
    public DeleteInventoryOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteInventoryOpResponse response = new DeleteInventoryOpResponse();
