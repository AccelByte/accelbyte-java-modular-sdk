...
@Getter
@Setter
public class AdminBulkRemoveItemsOpResponse extends ApiResponseWithData<List<ApimodelsUpdateItemResp>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.inventory.operations.admin_items.AdminBulkRemoveItems";
    }
}