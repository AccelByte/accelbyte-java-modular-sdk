...
@Getter
@Setter
public class AdminBulkUpdateMyItemsOpResponse extends ApiResponseWithData<List<ApimodelsUpdateItemResp>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.inventory.operations.admin_items.AdminBulkUpdateMyItems";
    }
}