...
@Getter
@Setter
public class AdminGetInventoryOpResponse extends ApiResponseWithData<ApimodelsInventoryResp> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.inventory.operations.admin_inventories.AdminGetInventory";
    }
}