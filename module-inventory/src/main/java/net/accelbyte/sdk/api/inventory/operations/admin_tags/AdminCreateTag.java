...
import net.accelbyte.sdk.api.inventory.operation_responses.admin_tags.AdminCreateTagOpResponse;
...
public class AdminCreateTag extends Operation {
  ...
  @Deprecated
  public AdminCreateTag(String customBasePath, String namespace, ApimodelsCreateTagReq body) {
  ...
  public AdminCreateTagOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final AdminCreateTagOpResponse response = new AdminCreateTagOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ApimodelsCreateTagResp().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public ApimodelsCreateTagResp parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 201){
          final String json = Helper.convertInputStreamToString(payload);
