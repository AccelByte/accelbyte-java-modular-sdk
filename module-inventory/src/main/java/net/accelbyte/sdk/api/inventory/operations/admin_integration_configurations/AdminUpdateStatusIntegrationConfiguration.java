...
public class AdminUpdateStatusIntegrationConfiguration extends Operation {
  ...
  public AdminUpdateStatusIntegrationConfigurationOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminUpdateStatusIntegrationConfigurationOpResponse response =
        new AdminUpdateStatusIntegrationConfigurationOpResponse();
