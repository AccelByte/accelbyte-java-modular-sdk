...
public class AdminUpdateStatusIntegrationConfiguration extends Operation {
     ...
     */
    private String path = "/inventory/v1/admin/namespaces/{namespace}/integrationConfigurations/{integrationConfigurationId}/status";
    ...
    */
    ...
    public AdminUpdateStatusIntegrationConfiguration(
            String customBasePath,            String integrationConfigurationId,
            String namespace,
    ...
    public AdminUpdateStatusIntegrationConfigurationOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateStatusIntegrationConfigurationOpResponse response = new AdminUpdateStatusIntegrationConfigurationOpResponse();
