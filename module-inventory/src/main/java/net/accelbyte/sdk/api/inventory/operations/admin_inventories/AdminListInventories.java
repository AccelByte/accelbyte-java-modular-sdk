...
public class AdminListInventories extends Operation {
    ...
    */
    ...
    public AdminListInventoriesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminListInventoriesOpResponse response = new AdminListInventoriesOpResponse();
