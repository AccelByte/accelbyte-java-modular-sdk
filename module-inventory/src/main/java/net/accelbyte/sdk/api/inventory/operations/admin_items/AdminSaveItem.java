...
public class AdminSaveItem extends Operation {
  ...
  public AdminSaveItem(
      String customBasePath, String namespace, String userId, ApimodelsSaveItemReq body) {
  ...
  public AdminSaveItemOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final AdminSaveItemOpResponse response = new AdminSaveItemOpResponse();
