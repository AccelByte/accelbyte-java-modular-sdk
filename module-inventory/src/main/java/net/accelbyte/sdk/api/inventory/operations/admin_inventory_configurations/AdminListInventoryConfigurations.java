...
public class AdminListInventoryConfigurations extends Operation {
    ...
    */
    ...
    public AdminListInventoryConfigurationsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminListInventoryConfigurationsOpResponse response = new AdminListInventoryConfigurationsOpResponse();
