...
@Getter
@Setter
public class AdminConsumeUserItemOpResponse extends ApiResponseWithData<ApimodelsItemResp> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.inventory.operations.admin_items.AdminConsumeUserItem";
  }
}
