...
public class AdminGetInventory extends Operation {
    ...
    */
    ...
    public AdminGetInventoryOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetInventoryOpResponse response = new AdminGetInventoryOpResponse();
