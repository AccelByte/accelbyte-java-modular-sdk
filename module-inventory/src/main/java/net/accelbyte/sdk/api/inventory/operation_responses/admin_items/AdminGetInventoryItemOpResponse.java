...
@Getter
@Setter
public class AdminGetInventoryItemOpResponse extends ApiResponseWithData<ApimodelsItemResp> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.inventory.operations.admin_items.AdminGetInventoryItem";
    }
}