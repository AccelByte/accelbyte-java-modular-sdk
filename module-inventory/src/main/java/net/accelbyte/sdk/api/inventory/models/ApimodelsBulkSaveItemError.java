...
public class ApimodelsBulkSaveItemError extends Model {
    ...
    @JsonIgnore
    public List<ApimodelsBulkSaveItemError> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ApimodelsBulkSaveItemError>>() {});
    }
