...
@Getter
@Setter
public class UpdateSessionOpResponse extends ApiResponseWithData<ModelsSessionResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionbrowser.operations.session.UpdateSession";
    }
}