...
public class CreateSession extends Operation {
  ...
  @Deprecated
  public CreateSession(String customBasePath, String namespace, ModelsCreateSessionRequest body) {
  ...
  public CreateSessionOpResponse parseResponse(int code, String contentType, InputStream payload)
    ...
    if (code == 204) {
      ...
      final String json = Helper.convertInputStreamToString(payload);
      response.setError409(new RestapiErrorResponseV2().createFromJson(json));
