...
public class GetActiveMatchmakingGameSessions extends Operation {
  ...
  public GetActiveMatchmakingGameSessionsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetActiveMatchmakingGameSessionsOpResponse response =
        new GetActiveMatchmakingGameSessionsOpResponse();
