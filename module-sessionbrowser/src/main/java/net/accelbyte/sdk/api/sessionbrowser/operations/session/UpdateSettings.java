...
public class UpdateSettings extends Operation {
  ...
  public UpdateSettings(
      String customBasePath, String namespace, String sessionID, ModelsUpdateSettingsRequest body) {
  ...
  public UpdateSettingsOpResponse parseResponse(int code, String contentType, InputStream payload)
