...
public class ModelsGetSessionHistoryDetailedResponseItem extends Model {
    ...
    @JsonIgnore
    public ModelsGetSessionHistoryDetailedResponseItem createFromJson(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, this.getClass());
    }

    @JsonIgnore
    public List<ModelsGetSessionHistoryDetailedResponseItem> createFromJsonList(String json) throws JsonProcessingException {
