...
public class AdminSearchSessionsV2 extends Operation {
    ...
    */
    ...
    public AdminSearchSessionsV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminSearchSessionsV2OpResponse response = new AdminSearchSessionsV2OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsGetSessionHistorySearchResponseV2().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
