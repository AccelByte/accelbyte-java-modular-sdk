...
public class GetActiveCustomGameSessions extends Operation {
  ...
  public GetActiveCustomGameSessionsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetActiveCustomGameSessionsOpResponse response =
        new GetActiveCustomGameSessionsOpResponse();
