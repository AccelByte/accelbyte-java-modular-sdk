...
public class GetActiveCustomGameSessions extends Operation {
    ...
    */
    ...
    public GetActiveCustomGameSessionsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetActiveCustomGameSessionsOpResponse response = new GetActiveCustomGameSessionsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsActiveCustomGameResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsActiveCustomGameResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
