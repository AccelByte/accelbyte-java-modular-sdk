...
public class UserQuerySession extends Operation {
    ...
    */
    ...
    public UserQuerySessionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UserQuerySessionOpResponse response = new UserQuerySessionOpResponse();
