...
public class AdminGetSession extends Operation {
  ...
  @Deprecated
  public AdminGetSession(String customBasePath, String namespace, String sessionID) {
  ...
  public AdminGetSessionOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final AdminGetSessionOpResponse response = new AdminGetSessionOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ModelsAdminSessionResponse().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 404) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public ModelsAdminSessionResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
