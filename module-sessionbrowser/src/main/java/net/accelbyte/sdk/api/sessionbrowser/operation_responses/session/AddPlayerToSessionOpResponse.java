...
@Getter
@Setter
public class AddPlayerToSessionOpResponse extends ApiResponseWithData<ModelsAddPlayerResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.sessionbrowser.operations.session.AddPlayerToSession";
  }
}
