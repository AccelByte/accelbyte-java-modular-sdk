...
@Getter
@Setter
public class RemovePlayerFromSessionOpResponse extends ApiResponseWithData<ModelsAddPlayerResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionbrowser.operations.session.RemovePlayerFromSession";
    }
}