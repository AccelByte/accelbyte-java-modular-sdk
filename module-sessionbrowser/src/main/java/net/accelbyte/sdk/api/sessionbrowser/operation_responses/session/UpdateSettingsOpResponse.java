...
@Getter
@Setter
public class UpdateSettingsOpResponse extends ApiResponseWithData<ModelsSessionResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.sessionbrowser.operations.session.UpdateSettings";
  }
}
