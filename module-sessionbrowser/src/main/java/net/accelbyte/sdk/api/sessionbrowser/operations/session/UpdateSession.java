...
public class UpdateSession extends Operation {
  ...
  public UpdateSession(
      String customBasePath, String namespace, String sessionID, ModelsUpdateSessionRequest body) {
  ...
  public UpdateSessionOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final UpdateSessionOpResponse response = new UpdateSessionOpResponse();
