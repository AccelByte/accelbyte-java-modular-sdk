...
public class AdminQueryPlayerAttributes extends Operation {
  ...
  @Deprecated
  public AdminQueryPlayerAttributes(String customBasePath, String namespace, String users) {
  ...
  public AdminQueryPlayerAttributesOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminQueryPlayerAttributesOpResponse response =
        new AdminQueryPlayerAttributesOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(
          new ObjectMapper()
              .readValue(
                  json, new TypeReference<List<ApimodelsPlayerAttributesResponseBody>>() {}));
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
