...
@Getter
@Setter
public class UpdateGameSessionOpResponse extends ApiResponseWithData<ApimodelsGameSessionResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.session.operations.game_session.UpdateGameSession";
  }
}
