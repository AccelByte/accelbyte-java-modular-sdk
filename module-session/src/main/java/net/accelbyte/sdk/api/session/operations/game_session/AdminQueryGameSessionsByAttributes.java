...
public class AdminQueryGameSessionsByAttributes extends Operation {
    ...
    */
    ...
    public AdminQueryGameSessionsByAttributesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminQueryGameSessionsByAttributesOpResponse response = new AdminQueryGameSessionsByAttributesOpResponse();
