...
public class PublicSessionJoinCode extends Operation {
    ...
    */
    ...
    public PublicSessionJoinCodeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicSessionJoinCodeOpResponse response = new PublicSessionJoinCodeOpResponse();
