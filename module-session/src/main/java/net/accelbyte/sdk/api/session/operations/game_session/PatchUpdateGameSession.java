...
public class PatchUpdateGameSession extends Operation {
    ...
    */
    ...
    public PatchUpdateGameSessionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PatchUpdateGameSessionOpResponse response = new PatchUpdateGameSessionOpResponse();
