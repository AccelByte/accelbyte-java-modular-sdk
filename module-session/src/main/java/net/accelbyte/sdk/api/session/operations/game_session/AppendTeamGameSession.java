...
public class AppendTeamGameSession extends Operation {
    ...
    */
    ...
    public AppendTeamGameSessionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AppendTeamGameSessionOpResponse response = new AppendTeamGameSessionOpResponse();
