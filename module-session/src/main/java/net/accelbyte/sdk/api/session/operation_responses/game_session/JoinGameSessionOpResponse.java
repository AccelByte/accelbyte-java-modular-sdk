...
@Getter
@Setter
public class JoinGameSessionOpResponse extends ApiResponseWithData<ApimodelsGameSessionResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.session.operations.game_session.JoinGameSession";
  }
}
