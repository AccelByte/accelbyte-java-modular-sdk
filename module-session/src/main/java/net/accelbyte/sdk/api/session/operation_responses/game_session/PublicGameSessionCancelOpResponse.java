...
@Getter
@Setter
public class PublicGameSessionCancelOpResponse extends ApiResponse {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.session.operations.game_session.PublicGameSessionCancel";
  }
}
