...
import net.accelbyte.sdk.api.session.operation_responses.recent_player.PublicGetRecentPlayerOpResponse;
...
public class PublicGetRecentPlayer extends Operation {
    ...
    */
    ...
    public PublicGetRecentPlayerOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetRecentPlayerOpResponse response = new PublicGetRecentPlayerOpResponse();
