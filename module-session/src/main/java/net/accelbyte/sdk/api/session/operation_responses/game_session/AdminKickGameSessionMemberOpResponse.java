...
@Getter
@Setter
public class AdminKickGameSessionMemberOpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.session.operations.game_session.AdminKickGameSessionMember";
    }
}