...
public class ModelsXBLCertificateCredential extends Model {
    ...
    @JsonIgnore
    public List<ModelsXBLCertificateCredential> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelsXBLCertificateCredential>>() {});
    }
