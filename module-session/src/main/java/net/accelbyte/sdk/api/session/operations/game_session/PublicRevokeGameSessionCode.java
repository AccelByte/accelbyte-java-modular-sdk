...
public class PublicRevokeGameSessionCode extends Operation {
    ...
    */
    ...
    public PublicRevokeGameSessionCodeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicRevokeGameSessionCodeOpResponse response = new PublicRevokeGameSessionCodeOpResponse();
