 ...
 * autoJoin. If enabled (set to true), players provided in the request will automatically joined the
 * initial game session creation. Game session will not send any invite and players dont need to act
 * upon it. - minPlayers - maxPlayers - inviteTimeout - inactiveTimeout - dsSource -
