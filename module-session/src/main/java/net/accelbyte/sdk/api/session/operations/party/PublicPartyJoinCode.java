...
import net.accelbyte.sdk.api.session.operation_responses.party.PublicPartyJoinCodeOpResponse;
...
public class PublicPartyJoinCode extends Operation {
    ...
    */
    ...
    public PublicPartyJoinCodeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicPartyJoinCodeOpResponse response = new PublicPartyJoinCodeOpResponse();
