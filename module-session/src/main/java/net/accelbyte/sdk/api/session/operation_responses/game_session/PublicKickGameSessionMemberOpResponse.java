...
@Getter
@Setter
public class PublicKickGameSessionMemberOpResponse extends ApiResponse {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.session.operations.game_session.PublicKickGameSessionMember";
  }
}
