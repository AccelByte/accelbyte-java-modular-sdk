...
public class PublicStorePlayerAttributes extends Operation {
  ...
  public PublicStorePlayerAttributes(
      String customBasePath, String namespace, ApimodelsPlayerAttributesRequestBody body) {
  ...
  public PublicStorePlayerAttributesOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicStorePlayerAttributesOpResponse response =
        new PublicStorePlayerAttributesOpResponse();
