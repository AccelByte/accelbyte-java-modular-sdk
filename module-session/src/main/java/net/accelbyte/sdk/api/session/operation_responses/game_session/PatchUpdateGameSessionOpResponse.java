...
@Getter
@Setter
public class PatchUpdateGameSessionOpResponse extends ApiResponseWithData<ApimodelsGameSessionResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.session.operations.game_session.PatchUpdateGameSession";
    }
}