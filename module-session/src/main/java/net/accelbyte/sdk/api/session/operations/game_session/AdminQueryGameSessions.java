...
public class AdminQueryGameSessions extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("configurationName", this.configurationName == null ? null : Arrays.asList(this.configurationName));
        ...
        queryParams.put("isPersistent", this.isPersistent == null ? null : Arrays.asList(this.isPersistent));
    ...
    public AdminQueryGameSessionsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminQueryGameSessionsOpResponse response = new AdminQueryGameSessionsOpResponse();
