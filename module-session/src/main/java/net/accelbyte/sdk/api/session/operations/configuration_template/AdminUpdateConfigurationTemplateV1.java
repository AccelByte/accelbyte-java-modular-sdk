...
public class AdminUpdateConfigurationTemplateV1 extends Operation {
    ...
    */
    ...
    public AdminUpdateConfigurationTemplateV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateConfigurationTemplateV1OpResponse response = new AdminUpdateConfigurationTemplateV1OpResponse();
