...
import net.accelbyte.sdk.api.session.operation_responses.max_active.*;
...
public class MaxActive {
     ...
     */
    public AdminGetMemberActiveSessionOpResponse adminGetMemberActiveSession(AdminGetMemberActiveSession input) throws Exception {
     ...
     */
    public AdminReconcileMaxActiveSessionOpResponse adminReconcileMaxActiveSession(AdminReconcileMaxActiveSession input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
