...
public class PublicKickGameSessionMember extends Operation {
  ...
  public PublicKickGameSessionMember(
      String customBasePath, String memberId, String namespace, String sessionId) {
  ...
  public PublicKickGameSessionMemberOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicKickGameSessionMemberOpResponse response =
        new PublicKickGameSessionMemberOpResponse();
