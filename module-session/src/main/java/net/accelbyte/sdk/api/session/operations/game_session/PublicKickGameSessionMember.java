...
public class PublicKickGameSessionMember extends Operation {
     ...
     */
    private String path = "/session/v1/public/namespaces/{namespace}/gamesessions/{sessionId}/members/{memberId}/kick";
    ...
    */
    ...
    public PublicKickGameSessionMemberOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicKickGameSessionMemberOpResponse response = new PublicKickGameSessionMemberOpResponse();
