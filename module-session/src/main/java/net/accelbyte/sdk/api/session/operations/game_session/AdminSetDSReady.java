...
public class AdminSetDSReady extends Operation {
  ...
  public AdminSetDSReady(
      String customBasePath, String namespace, String sessionId, ApimodelsSetDSReadyRequest body) {
  ...
  public AdminSetDSReadyOpResponse parseResponse(int code, String contentType, InputStream payload)
