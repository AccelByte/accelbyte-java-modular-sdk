...
public class PublicPromoteGameSessionLeader extends Operation {
    ...
    */
    ...
    public PublicPromoteGameSessionLeaderOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicPromoteGameSessionLeaderOpResponse response = new PublicPromoteGameSessionLeaderOpResponse();
