...
import net.accelbyte.sdk.api.session.operation_responses.party.PublicQueryMyPartiesOpResponse;
...
public class PublicQueryMyParties extends Operation {
    ...
    */
    ...
    public PublicQueryMyPartiesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicQueryMyPartiesOpResponse response = new PublicQueryMyPartiesOpResponse();
