...
public class AdminDeleteUserSessionStorage extends Operation {
  ...
  @Deprecated
  public AdminDeleteUserSessionStorage(String customBasePath, String namespace, String sessionId) {
  ...
  public AdminDeleteUserSessionStorageOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminDeleteUserSessionStorageOpResponse response =
        new AdminDeleteUserSessionStorageOpResponse();
