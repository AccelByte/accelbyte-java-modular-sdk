...
public class PublicQueryGameSessionsByAttributes extends Operation {
  ...
  public PublicQueryGameSessionsByAttributesOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicQueryGameSessionsByAttributesOpResponse response =
        new PublicQueryGameSessionsByAttributesOpResponse();
