...
public class PublicUpdateInsertSessionStorageLeader extends Operation {
     ...
     */
    private String path = "/session/v1/public/namespaces/{namespace}/sessions/{sessionId}/storage/leader";
    ...
    */
    ...
    public PublicUpdateInsertSessionStorageLeaderOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicUpdateInsertSessionStorageLeaderOpResponse response = new PublicUpdateInsertSessionStorageLeaderOpResponse();
