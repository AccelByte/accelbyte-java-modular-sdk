...
public class LeaveGameSession extends Operation {
  ...
  @Deprecated
  public LeaveGameSession(String customBasePath, String namespace, String sessionId) {
  ...
  public LeaveGameSessionOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final LeaveGameSessionOpResponse response = new LeaveGameSessionOpResponse();
