...
public class PublicGameSessionInvite extends Operation {
    ...
    */
    ...
    public PublicGameSessionInviteOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGameSessionInviteOpResponse response = new PublicGameSessionInviteOpResponse();
