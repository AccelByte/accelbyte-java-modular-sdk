...
@Getter
@Setter
public class PublicUpdateGameSessionPasswordOpResponse extends ApiResponse {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.session.operations.game_session.PublicUpdateGameSessionPassword";
  }
}
