...
@Getter
@Setter
public class AdminCreateConfigurationAlertV1OpResponse extends ApiResponseWithData<ApimodelsConfigAlertResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.session.operations.configuration_template.AdminCreateConfigurationAlertV1";
    }
}