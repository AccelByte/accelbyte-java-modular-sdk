...
import net.accelbyte.sdk.api.session.operation_responses.party.PublicCreatePartyOpResponse;
...
public class PublicCreateParty extends Operation {
    ...
    */
    ...
    public PublicCreatePartyOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicCreatePartyOpResponse response = new PublicCreatePartyOpResponse();
