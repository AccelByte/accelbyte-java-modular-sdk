...
public class UpdateGameSessionBackfillTicketID extends Operation {
  ...
  public UpdateGameSessionBackfillTicketIDOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdateGameSessionBackfillTicketIDOpResponse response =
        new UpdateGameSessionBackfillTicketIDOpResponse();
