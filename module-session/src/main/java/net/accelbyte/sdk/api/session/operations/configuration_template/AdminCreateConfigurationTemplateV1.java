...
public class AdminCreateConfigurationTemplateV1 extends Operation {
    ...
    */
    ...
    public AdminCreateConfigurationTemplateV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminCreateConfigurationTemplateV1OpResponse response = new AdminCreateConfigurationTemplateV1OpResponse();
