...
import net.accelbyte.sdk.api.session.operation_responses.session_storage.AdminReadSessionStorageOpResponse;
...
public class AdminReadSessionStorage extends Operation {
    ...
    */
    ...
    public AdminReadSessionStorageOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminReadSessionStorageOpResponse response = new AdminReadSessionStorageOpResponse();
