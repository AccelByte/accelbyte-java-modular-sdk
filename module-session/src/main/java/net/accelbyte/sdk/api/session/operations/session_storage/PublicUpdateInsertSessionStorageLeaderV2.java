...
import net.accelbyte.sdk.api.session.operation_responses.session_storage.PublicUpdateInsertSessionStorageLeaderV2OpResponse;
 ...
 *
 * <p>Update partial Session Storage Leader. Performs selective merge with existing leader storage
 * data.
 *
...
@Getter
@Setter
public class PublicUpdateInsertSessionStorageLeaderV2 extends Operation {
  ...
  public PublicUpdateInsertSessionStorageLeaderV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicUpdateInsertSessionStorageLeaderV2OpResponse response =
        new PublicUpdateInsertSessionStorageLeaderV2OpResponse();
