...
public class AdminSyncDSMCConfiguration extends Operation {
  ...
  @Deprecated
  public AdminSyncDSMCConfiguration(String customBasePath, String namespace) {
  ...
  public AdminSyncDSMCConfigurationOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminSyncDSMCConfigurationOpResponse response =
        new AdminSyncDSMCConfigurationOpResponse();
