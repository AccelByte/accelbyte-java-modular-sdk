...
import net.accelbyte.sdk.api.session.operation_responses.configuration_template.AdminSyncDSMCConfigurationOpResponse;
...
public class AdminSyncDSMCConfiguration extends Operation {
    ...
    */
    ...
    public AdminSyncDSMCConfigurationOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminSyncDSMCConfigurationOpResponse response = new AdminSyncDSMCConfigurationOpResponse();
