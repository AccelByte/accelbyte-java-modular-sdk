...
public class AdminGetDSMCConfigurationDefault extends Operation {
    ...
    */
    ...
    public AdminGetDSMCConfigurationDefaultOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetDSMCConfigurationDefaultOpResponse response = new AdminGetDSMCConfigurationDefaultOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsDefaultDSMCConfig().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsDefaultDSMCConfig parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
