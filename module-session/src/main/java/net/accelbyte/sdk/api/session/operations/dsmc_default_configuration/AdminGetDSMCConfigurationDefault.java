...
public class AdminGetDSMCConfigurationDefault extends Operation {
  ...
  @Deprecated
  public AdminGetDSMCConfigurationDefault(String customBasePath) {
  ...
  public AdminGetDSMCConfigurationDefaultOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetDSMCConfigurationDefaultOpResponse response =
        new AdminGetDSMCConfigurationDefaultOpResponse();
