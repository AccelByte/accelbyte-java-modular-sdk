...
@Getter
@Setter
public class AdminUpdateDSInformationOpResponse extends ApiResponse {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.session.operations.game_session.AdminUpdateDSInformation";
  }
}
