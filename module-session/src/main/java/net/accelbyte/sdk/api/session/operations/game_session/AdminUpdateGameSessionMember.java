...
public class AdminUpdateGameSessionMember extends Operation {
     ...
     */
    private String path = "/session/v1/admin/namespaces/{namespace}/gamesessions/{sessionId}/members/{memberId}/status/{statusType}";
    ...
    */
    ...
    public AdminUpdateGameSessionMember(
            String customBasePath,            String memberId,
            String namespace,
            String sessionId,
            String statusType
    )
    ...
    public AdminUpdateGameSessionMemberOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateGameSessionMemberOpResponse response = new AdminUpdateGameSessionMemberOpResponse();
