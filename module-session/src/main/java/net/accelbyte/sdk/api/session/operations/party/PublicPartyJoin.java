...
import net.accelbyte.sdk.api.session.operation_responses.party.PublicPartyJoinOpResponse;
...
public class PublicPartyJoin extends Operation {
    ...
    */
    ...
    public PublicPartyJoinOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicPartyJoinOpResponse response = new PublicPartyJoinOpResponse();
