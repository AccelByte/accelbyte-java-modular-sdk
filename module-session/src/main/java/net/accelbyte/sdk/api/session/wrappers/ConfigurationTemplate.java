...
public class ConfigurationTemplate {
   ...
   */
  public AdminGetConfigurationAlertV1OpResponse adminGetConfigurationAlertV1(
   ...
   */
  public AdminUpdateConfigurationAlertV1OpResponse adminUpdateConfigurationAlertV1(
   ...
   */
  public AdminCreateConfigurationAlertV1OpResponse adminCreateConfigurationAlertV1(
   ...
   */
  public AdminDeleteConfigurationAlertV1OpResponse adminDeleteConfigurationAlertV1(
      AdminDeleteConfigurationAlertV1 input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminCreateConfigurationTemplateV1OpResponse adminCreateConfigurationTemplateV1(
   ...
   */
  public AdminGetAllConfigurationTemplatesV1OpResponse adminGetAllConfigurationTemplatesV1(
   ...
   */
  public AdminGetConfigurationTemplateV1OpResponse adminGetConfigurationTemplateV1(
   ...
   */
  public AdminUpdateConfigurationTemplateV1OpResponse adminUpdateConfigurationTemplateV1(
   ...
   */
  public AdminDeleteConfigurationTemplateV1OpResponse adminDeleteConfigurationTemplateV1(
      AdminDeleteConfigurationTemplateV1 input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
