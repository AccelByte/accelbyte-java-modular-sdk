...
public class AdminGetPlayerAttributes extends Operation {
    ...
    */
    ...
    public AdminGetPlayerAttributesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetPlayerAttributesOpResponse response = new AdminGetPlayerAttributesOpResponse();
