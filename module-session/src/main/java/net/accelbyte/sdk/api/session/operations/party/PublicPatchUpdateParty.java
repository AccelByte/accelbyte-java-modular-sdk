...
import net.accelbyte.sdk.api.session.operation_responses.party.PublicPatchUpdatePartyOpResponse;
...
public class PublicPatchUpdateParty extends Operation {
    ...
    */
    ...
    public PublicPatchUpdatePartyOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicPatchUpdatePartyOpResponse response = new PublicPatchUpdatePartyOpResponse();
