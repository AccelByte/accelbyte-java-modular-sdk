...
public class AdminUpdatePlatformCredentials extends Operation {
  ...
  public AdminUpdatePlatformCredentialsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminUpdatePlatformCredentialsOpResponse response =
        new AdminUpdatePlatformCredentialsOpResponse();
