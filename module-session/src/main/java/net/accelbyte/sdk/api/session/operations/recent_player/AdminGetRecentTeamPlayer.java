...
import net.accelbyte.sdk.api.session.operation_responses.recent_player.AdminGetRecentTeamPlayerOpResponse;
...
public class AdminGetRecentTeamPlayer extends Operation {
    ...
    */
    ...
    public AdminGetRecentTeamPlayerOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetRecentTeamPlayerOpResponse response = new AdminGetRecentTeamPlayerOpResponse();
