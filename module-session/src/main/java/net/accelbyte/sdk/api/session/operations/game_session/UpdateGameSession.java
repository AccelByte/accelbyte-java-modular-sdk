...
public class UpdateGameSession extends Operation {
    ...
    */
    ...
    public UpdateGameSessionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateGameSessionOpResponse response = new UpdateGameSessionOpResponse();
