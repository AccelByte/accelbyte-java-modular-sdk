...
import net.accelbyte.sdk.api.session.operation_responses.party.PublicPromotePartyLeaderOpResponse;
...
public class PublicPromotePartyLeader extends Operation {
    ...
    */
    ...
    public PublicPromotePartyLeaderOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicPromotePartyLeaderOpResponse response = new PublicPromotePartyLeaderOpResponse();
