...
import net.accelbyte.sdk.api.session.operation_responses.party.PublicGeneratePartyCodeOpResponse;
...
public class PublicGeneratePartyCode extends Operation {
    ...
    */
    ...
    public PublicGeneratePartyCodeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGeneratePartyCodeOpResponse response = new PublicGeneratePartyCodeOpResponse();
