...
import net.accelbyte.sdk.api.session.operation_responses.recent_player.PublicGetRecentTeamPlayerOpResponse;
...
public class PublicGetRecentTeamPlayer extends Operation {
    ...
    */
    ...
    public PublicGetRecentTeamPlayerOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetRecentTeamPlayerOpResponse response = new PublicGetRecentTeamPlayerOpResponse();
