...
public class AdminDeletePlatformCredentialsByPlatformId extends Operation {
  ...
  public AdminDeletePlatformCredentialsByPlatformIdOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminDeletePlatformCredentialsByPlatformIdOpResponse response =
        new AdminDeletePlatformCredentialsByPlatformIdOpResponse();
