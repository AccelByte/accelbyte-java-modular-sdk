...
public class PublicGetPlayerAttributes extends Operation {
    ...
    */
    ...
    public PublicGetPlayerAttributesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetPlayerAttributesOpResponse response = new PublicGetPlayerAttributesOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApimodelsPlayerAttributesResponseBody().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ApimodelsPlayerAttributesResponseBody parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
