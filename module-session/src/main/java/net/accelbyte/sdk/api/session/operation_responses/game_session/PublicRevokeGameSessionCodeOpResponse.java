...
@Getter
@Setter
public class PublicRevokeGameSessionCodeOpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.session.operations.game_session.PublicRevokeGameSessionCode";
    }
}