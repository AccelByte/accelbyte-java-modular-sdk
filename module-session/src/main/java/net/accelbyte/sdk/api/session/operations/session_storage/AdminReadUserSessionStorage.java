...
public class AdminReadUserSessionStorage extends Operation {
  ...
  public AdminReadUserSessionStorageOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminReadUserSessionStorageOpResponse response =
        new AdminReadUserSessionStorageOpResponse();
