...
public class PublicGetParty extends Operation {
  ...
  @Deprecated
  public PublicGetParty(String customBasePath, String namespace, String partyId) {
  ...
  public PublicGetPartyOpResponse parseResponse(int code, String contentType, InputStream payload)
