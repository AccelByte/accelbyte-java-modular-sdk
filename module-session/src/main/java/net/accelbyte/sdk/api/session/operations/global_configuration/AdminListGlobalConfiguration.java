...
public class AdminListGlobalConfiguration extends Operation {
  ...
  @Deprecated
  public AdminListGlobalConfiguration(String customBasePath) {
  ...
  public AdminListGlobalConfigurationOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminListGlobalConfigurationOpResponse response =
        new AdminListGlobalConfigurationOpResponse();
