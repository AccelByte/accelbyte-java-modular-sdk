...
import net.accelbyte.sdk.api.session.operation_responses.session_storage.PublicReadPartySessionStorageOpResponse;
...
public class PublicReadPartySessionStorage extends Operation {
  ...
  @Deprecated
  public PublicReadPartySessionStorage(String customBasePath, String namespace, String partyId) {
  ...
  public PublicReadPartySessionStorageOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicReadPartySessionStorageOpResponse response =
        new PublicReadPartySessionStorageOpResponse();
