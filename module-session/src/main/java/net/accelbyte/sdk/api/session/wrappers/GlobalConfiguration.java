...
public class GlobalConfiguration {
   ...
   */
  public AdminListGlobalConfigurationOpResponse adminListGlobalConfiguration(
   ...
   */
  public AdminUpdateGlobalConfigurationOpResponse adminUpdateGlobalConfiguration(
   ...
   */
  public AdminDeleteGlobalConfigurationOpResponse adminDeleteGlobalConfiguration(
      AdminDeleteGlobalConfiguration input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
