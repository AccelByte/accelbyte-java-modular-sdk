...
import net.accelbyte.sdk.api.session.operation_responses.recent_player.AdminGetRecentPlayerOpResponse;
...
public class AdminGetRecentPlayer extends Operation {
    ...
    */
    ...
    public AdminGetRecentPlayerOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetRecentPlayerOpResponse response = new AdminGetRecentPlayerOpResponse();
