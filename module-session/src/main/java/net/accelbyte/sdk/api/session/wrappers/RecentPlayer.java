...
public class RecentPlayer {
     ...
     */
    public AdminGetRecentPlayerOpResponse adminGetRecentPlayer(AdminGetRecentPlayer input) throws Exception {
     ...
     */
    public AdminGetRecentTeamPlayerOpResponse adminGetRecentTeamPlayer(AdminGetRecentTeamPlayer input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public PublicGetRecentPlayerOpResponse publicGetRecentPlayer(PublicGetRecentPlayer input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public PublicGetRecentTeamPlayerOpResponse publicGetRecentTeamPlayer(PublicGetRecentTeamPlayer input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
