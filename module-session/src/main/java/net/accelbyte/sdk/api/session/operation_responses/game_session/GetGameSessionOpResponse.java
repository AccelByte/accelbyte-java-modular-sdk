...
@Getter
@Setter
public class GetGameSessionOpResponse extends ApiResponseWithData<ApimodelsGameSessionResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.session.operations.game_session.GetGameSession";
  }
}
