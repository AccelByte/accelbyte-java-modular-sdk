...
public class JoinGameSession extends Operation {
    ...
    */
    ...
    public JoinGameSessionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final JoinGameSessionOpResponse response = new JoinGameSessionOpResponse();
