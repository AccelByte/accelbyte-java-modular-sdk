...
public class AdminGetPlatformCredentials extends Operation {
  ...
  public AdminGetPlatformCredentialsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetPlatformCredentialsOpResponse response =
        new AdminGetPlatformCredentialsOpResponse();
