...
public class AdminReconcileMaxActiveSession extends Operation {
  ...
  public AdminReconcileMaxActiveSessionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminReconcileMaxActiveSessionOpResponse response =
        new AdminReconcileMaxActiveSessionOpResponse();
