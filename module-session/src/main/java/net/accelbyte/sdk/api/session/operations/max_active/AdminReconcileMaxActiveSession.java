...
import net.accelbyte.sdk.api.session.operation_responses.max_active.AdminReconcileMaxActiveSessionOpResponse;
...
public class AdminReconcileMaxActiveSession extends Operation {
    ...
    */
    ...
    public AdminReconcileMaxActiveSessionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminReconcileMaxActiveSessionOpResponse response = new AdminReconcileMaxActiveSessionOpResponse();
