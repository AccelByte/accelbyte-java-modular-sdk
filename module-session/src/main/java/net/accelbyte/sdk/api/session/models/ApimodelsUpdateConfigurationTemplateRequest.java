...
public class ApimodelsUpdateConfigurationTemplateRequest extends Model {
    ...
    @JsonIgnore
    public ApimodelsUpdateConfigurationTemplateRequest createFromJson(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, this.getClass());
    }

    @JsonIgnore
    public List<ApimodelsUpdateConfigurationTemplateRequest> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ApimodelsUpdateConfigurationTemplateRequest>>() {});
    }
