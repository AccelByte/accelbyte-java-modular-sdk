...
public class ApimodelsGameSessionResponse extends Model {
    ...
    @JsonIgnore
    public List<ApimodelsGameSessionResponse> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ApimodelsGameSessionResponse>>() {});
    }
