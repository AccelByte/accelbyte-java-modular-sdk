...
import net.accelbyte.sdk.api.session.operation_responses.session_storage.PublicUpdateInsertPartySessionStorageReservedOpResponse;
...
public class PublicUpdateInsertPartySessionStorageReserved extends Operation {
  ...
  public PublicUpdateInsertPartySessionStorageReserved(
      String customBasePath, String namespace, String partyId, String userId, Map<String, ?> body) {
  ...
  public PublicUpdateInsertPartySessionStorageReservedOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicUpdateInsertPartySessionStorageReservedOpResponse response =
        new PublicUpdateInsertPartySessionStorageReservedOpResponse();
