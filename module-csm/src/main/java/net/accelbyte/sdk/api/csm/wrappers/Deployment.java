...
public class Deployment {
   ...
   */
  @Deprecated
  public CreateDeploymentV1OpResponse createDeploymentV1(CreateDeploymentV1 input)
      throws Exception {
   ...
   */
  @Deprecated
  public GetListOfDeploymentV1OpResponse getListOfDeploymentV1(GetListOfDeploymentV1 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  @Deprecated
  public DeleteDeploymentV1OpResponse deleteDeploymentV1(DeleteDeploymentV1 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
