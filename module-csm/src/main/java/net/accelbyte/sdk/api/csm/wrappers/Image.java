...
import net.accelbyte.sdk.api.csm.operation_responses.image.*;
...
public class Image {
     ...
     */
    @Deprecated
    public GetAppImageListV1OpResponse getAppImageListV1(GetAppImageListV1 input) throws Exception {
     ...
     */
    @Deprecated
    public DeleteAppImagesV1OpResponse deleteAppImagesV1(DeleteAppImagesV1 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
