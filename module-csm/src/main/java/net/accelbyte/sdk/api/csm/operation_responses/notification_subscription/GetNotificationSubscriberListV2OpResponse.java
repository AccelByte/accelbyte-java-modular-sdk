...
@Getter
@Setter
public class GetNotificationSubscriberListV2OpResponse extends ApiResponseWithData<ApimodelGetNotificationSubscriberListResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.csm.operations.notification_subscription.GetNotificationSubscriberListV2";
    }
}