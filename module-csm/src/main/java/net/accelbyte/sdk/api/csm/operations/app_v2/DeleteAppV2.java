...
public class DeleteAppV2 extends Operation {
  ...
  @Deprecated
  public DeleteAppV2(String customBasePath, String app, String namespace, String forced) {
    this.app = app;
  ...
  public DeleteAppV2OpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final DeleteAppV2OpResponse response = new DeleteAppV2OpResponse();
