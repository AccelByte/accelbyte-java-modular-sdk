...
@Getter
@Setter
public class BulkSaveSubscriptionAppNotificationV2OpResponse extends ApiResponseWithData<ApimodelGetNotificationSubscriberListResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.csm.operations.notification_subscription.BulkSaveSubscriptionAppNotificationV2";
    }
}