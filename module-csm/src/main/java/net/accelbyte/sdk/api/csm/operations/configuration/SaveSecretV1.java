...
public class SaveSecretV1 extends Operation {
    ...
    */
    ...
    public SaveSecretV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SaveSecretV1OpResponse response = new SaveSecretV1OpResponse();
