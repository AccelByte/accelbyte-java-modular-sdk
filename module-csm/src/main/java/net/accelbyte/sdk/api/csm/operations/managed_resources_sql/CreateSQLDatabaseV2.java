...
import net.accelbyte.sdk.api.csm.operation_responses.managed_resources_sql.CreateSQLDatabaseV2OpResponse;
...
@Getter
@Setter
public class CreateSQLDatabaseV2 extends Operation {
  ...
  private ApimodelCreateSQLAppDatabaseRequest body;
  ...
  @Override
  public ApimodelCreateSQLAppDatabaseRequest getBodyParams() {
    return this.body;
  }
  ...
  public CreateSQLDatabaseV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final CreateSQLDatabaseV2OpResponse response = new CreateSQLDatabaseV2OpResponse();
