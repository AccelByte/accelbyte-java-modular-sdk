...
public class Configuration {
   ...
   */
  @Deprecated
  public GetListOfSecretsV1OpResponse getListOfSecretsV1(GetListOfSecretsV1 input)
      throws Exception {
   ...
   */
  @Deprecated
  public GetListOfVariablesV1OpResponse getListOfVariablesV1(GetListOfVariablesV1 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
