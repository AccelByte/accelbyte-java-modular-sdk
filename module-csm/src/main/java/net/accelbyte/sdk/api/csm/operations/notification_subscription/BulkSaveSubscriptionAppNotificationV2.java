...
public class BulkSaveSubscriptionAppNotificationV2 extends Operation {
    ...
    */
    ...
    public BulkSaveSubscriptionAppNotificationV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final BulkSaveSubscriptionAppNotificationV2OpResponse response = new BulkSaveSubscriptionAppNotificationV2OpResponse();
