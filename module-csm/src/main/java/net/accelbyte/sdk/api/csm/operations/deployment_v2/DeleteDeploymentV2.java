...
public class DeleteDeploymentV2 extends Operation {
    ...
    */
    ...
    public DeleteDeploymentV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteDeploymentV2OpResponse response = new DeleteDeploymentV2OpResponse();
