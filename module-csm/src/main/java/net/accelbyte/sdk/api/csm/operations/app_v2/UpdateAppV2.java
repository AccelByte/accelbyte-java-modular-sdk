...
public class UpdateAppV2 extends Operation {
  ...
  @Deprecated
  public UpdateAppV2(
      String customBasePath, String app, String namespace, ApimodelUpdateAppV2Request body) {
    this.app = app;
  ...
  public UpdateAppV2OpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final UpdateAppV2OpResponse response = new UpdateAppV2OpResponse();
