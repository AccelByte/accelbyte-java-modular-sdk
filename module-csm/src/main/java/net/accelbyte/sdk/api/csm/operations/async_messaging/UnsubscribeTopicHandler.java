...
import net.accelbyte.sdk.api.csm.operation_responses.async_messaging.UnsubscribeTopicHandlerOpResponse;
...
public class UnsubscribeTopicHandler extends Operation {
  ...
  public UnsubscribeTopicHandler(
      String customBasePath, String app, String namespace, String topicName) {
    this.app = app;
  ...
  public UnsubscribeTopicHandlerOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UnsubscribeTopicHandlerOpResponse response = new UnsubscribeTopicHandlerOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ApimodelTopicSubscription().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 401) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public ApimodelTopicSubscription parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
