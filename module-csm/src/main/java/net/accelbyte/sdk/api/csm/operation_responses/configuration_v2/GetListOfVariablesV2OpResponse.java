...
@Getter
@Setter
public class GetListOfVariablesV2OpResponse extends ApiResponseWithData<ApimodelGetListOfConfigurationsV2Response> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.csm.operations.configuration_v2.GetListOfVariablesV2";
    }
}