...
public class CreateAppV1 extends Operation {
  ...
  @Deprecated
  public CreateAppV1(
      String customBasePath, String app, String namespace, GeneratedCreateAppV1Request body) {
    this.app = app;
  ...
  public CreateAppV1OpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final CreateAppV1OpResponse response = new CreateAppV1OpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new GeneratedCreateAppV1Response().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public GeneratedCreateAppV1Response parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
