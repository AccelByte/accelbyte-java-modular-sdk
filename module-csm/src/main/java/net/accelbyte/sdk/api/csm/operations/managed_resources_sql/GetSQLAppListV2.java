 ...
 * being modified and is not yet accessible (e.g., updating min/max ACU). - `failed` : The cluster
 * failed to provision or is in an error state and not accessible. - `stopping` : The cluster is in
 * the process of stopping and will soon become inaccessible. - `stopped` : The cluster is stopped
 * and not accessible. - `starting` : The cluster is transitioning from stopped to running, or is
 ...
 * configuring replica instances for multi-AZ deployment.
 */
@Getter
@Setter
