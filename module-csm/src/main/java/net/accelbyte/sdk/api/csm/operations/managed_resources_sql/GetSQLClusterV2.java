...
import net.accelbyte.sdk.api.csm.operation_responses.managed_resources_sql.GetSQLClusterV2OpResponse;
...
@Getter
@Setter
public class GetSQLClusterV2 extends Operation {
  ...
  @Deprecated
  public GetSQLClusterV2(String customBasePath, String namespace) {
  ...
  public GetSQLClusterV2OpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetSQLClusterV2OpResponse response = new GetSQLClusterV2OpResponse();
