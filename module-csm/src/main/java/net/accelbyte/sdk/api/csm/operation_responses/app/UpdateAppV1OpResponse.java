...
@Getter
@Setter
public class UpdateAppV1OpResponse extends ApiResponseWithData<GeneratedUpdateAppV1Response> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.csm.operations.app.UpdateAppV1";
  }
}
