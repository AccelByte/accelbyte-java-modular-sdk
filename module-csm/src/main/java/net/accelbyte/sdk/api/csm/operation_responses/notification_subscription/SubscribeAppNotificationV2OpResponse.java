...
@Getter
@Setter
public class SubscribeAppNotificationV2OpResponse extends ApiResponseWithData<ApimodelSubscribeNotificationResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.csm.operations.notification_subscription.SubscribeAppNotificationV2";
    }
}