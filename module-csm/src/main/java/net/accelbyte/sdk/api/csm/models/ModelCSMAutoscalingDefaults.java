...
public class ModelCSMAutoscalingDefaults extends Model {
    ...
    @JsonIgnore
    public List<ModelCSMAutoscalingDefaults> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelCSMAutoscalingDefaults>>() {});
    }
