...
@Getter
@Setter
public class UpdateVariableV2OpResponse extends ApiResponseWithData<ApimodelUpdateConfigurationV2Response> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.csm.operations.configuration_v2.UpdateVariableV2";
    }
}