...
public class GeneratedGetAppListV1Response extends Model {
    ...
    @JsonIgnore
    public List<GeneratedGetAppListV1Response> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<GeneratedGetAppListV1Response>>() {});
    }
