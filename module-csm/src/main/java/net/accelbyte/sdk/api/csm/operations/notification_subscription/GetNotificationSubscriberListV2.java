...
public class GetNotificationSubscriberListV2 extends Operation {
    ...
    */
    ...
    public GetNotificationSubscriberListV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetNotificationSubscriberListV2OpResponse response = new GetNotificationSubscriberListV2OpResponse();
