...
public class NotificationSubscription {
   ...
   */
  public GetNotificationSubscriberListV2OpResponse getNotificationSubscriberListV2(
   ...
   */
  public BulkSaveSubscriptionAppNotificationV2OpResponse bulkSaveSubscriptionAppNotificationV2(
   ...
   */
  public SubscribeAppNotificationV2OpResponse subscribeAppNotificationV2(
   ...
   */
  public GetSubscriptionV2HandlerOpResponse getSubscriptionV2Handler(GetSubscriptionV2Handler input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public SubscribeV2HandlerOpResponse subscribeV2Handler(SubscribeV2Handler input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public UnsubscribeV2HandlerOpResponse unsubscribeV2Handler(UnsubscribeV2Handler input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public DeleteSubscriptionAppNotificationByUserIDV2OpResponse
      deleteSubscriptionAppNotificationByUserIDV2(DeleteSubscriptionAppNotificationByUserIDV2 input)
          throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  @Deprecated
  public DeleteSubscriptionAppNotificationV2OpResponse deleteSubscriptionAppNotificationV2(
      DeleteSubscriptionAppNotificationV2 input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
