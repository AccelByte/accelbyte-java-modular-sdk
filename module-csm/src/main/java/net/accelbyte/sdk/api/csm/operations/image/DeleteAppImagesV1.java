...
public class DeleteAppImagesV1 extends Operation {
    ...
    */
    ...
    public DeleteAppImagesV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteAppImagesV1OpResponse response = new DeleteAppImagesV1OpResponse();
