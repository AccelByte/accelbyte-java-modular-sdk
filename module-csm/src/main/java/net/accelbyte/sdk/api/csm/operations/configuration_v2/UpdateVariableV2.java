...
public class UpdateVariableV2 extends Operation {
    ...
    */
    ...
    public UpdateVariableV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateVariableV2OpResponse response = new UpdateVariableV2OpResponse();
