...
public class UnsubscribeV2Handler extends Operation {
    ...
    */
    ...
    public UnsubscribeV2HandlerOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UnsubscribeV2HandlerOpResponse response = new UnsubscribeV2HandlerOpResponse();
