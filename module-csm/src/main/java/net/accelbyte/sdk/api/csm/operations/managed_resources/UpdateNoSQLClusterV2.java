...
import net.accelbyte.sdk.api.csm.operation_responses.managed_resources.UpdateNoSQLClusterV2OpResponse;
...
public class UpdateNoSQLClusterV2 extends Operation {
  ...
  public UpdateNoSQLClusterV2(
      String customBasePath, String namespace, NosqlresourceNoSQLResourceConfiguration body) {
  ...
  public UpdateNoSQLClusterV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdateNoSQLClusterV2OpResponse response = new UpdateNoSQLClusterV2OpResponse();
