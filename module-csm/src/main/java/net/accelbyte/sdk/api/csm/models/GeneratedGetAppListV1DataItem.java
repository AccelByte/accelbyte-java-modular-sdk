...
public class GeneratedGetAppListV1DataItem extends Model {
    ...
    @JsonIgnore
    public List<GeneratedGetAppListV1DataItem> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<GeneratedGetAppListV1DataItem>>() {});
    }
