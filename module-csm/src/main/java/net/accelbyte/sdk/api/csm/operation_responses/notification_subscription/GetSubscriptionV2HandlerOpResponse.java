...
@Getter
@Setter
public class GetSubscriptionV2HandlerOpResponse extends ApiResponseWithData<ApimodelGetNotificationSubscriberStatusResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.csm.operations.notification_subscription.GetSubscriptionV2Handler";
    }
}