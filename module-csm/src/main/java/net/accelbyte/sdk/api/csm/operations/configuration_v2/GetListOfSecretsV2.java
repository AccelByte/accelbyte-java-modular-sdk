...
public class GetListOfSecretsV2 extends Operation {
    ...
    */
    ...
    public GetListOfSecretsV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetListOfSecretsV2OpResponse response = new GetListOfSecretsV2OpResponse();
