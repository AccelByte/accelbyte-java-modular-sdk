...
public class SubscribeAppNotificationV2 extends Operation {
    ...
    */
    ...
    public SubscribeAppNotificationV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SubscribeAppNotificationV2OpResponse response = new SubscribeAppNotificationV2OpResponse();
