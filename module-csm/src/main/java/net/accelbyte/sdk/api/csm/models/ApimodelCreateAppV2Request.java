...
public class ApimodelCreateAppV2Request extends Model {
    ...
    @JsonIgnore
    public List<ApimodelCreateAppV2Request> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ApimodelCreateAppV2Request>>() {});
    }
