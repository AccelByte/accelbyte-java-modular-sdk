...
public class CreateAppV2 extends Operation {
  ...
  @Deprecated
  public CreateAppV2(
      String customBasePath, String app, String namespace, ApimodelCreateAppV2Request body) {
    this.app = app;
  ...
  public CreateAppV2OpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final CreateAppV2OpResponse response = new CreateAppV2OpResponse();
