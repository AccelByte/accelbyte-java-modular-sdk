...
public class DeleteSubscriptionAppNotificationV2 extends Operation {
  ...
  public DeleteSubscriptionAppNotificationV2(
      String customBasePath, String app, String namespace, String subscriptionId) {
    this.app = app;
  ...
  public DeleteSubscriptionAppNotificationV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final DeleteSubscriptionAppNotificationV2OpResponse response =
        new DeleteSubscriptionAppNotificationV2OpResponse();
