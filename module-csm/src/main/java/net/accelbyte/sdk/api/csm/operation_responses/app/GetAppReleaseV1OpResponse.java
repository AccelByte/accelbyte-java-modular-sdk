...
@Getter
@Setter
public class GetAppReleaseV1OpResponse extends ApiResponseWithData<GeneratedGetAppReleaseV1Response> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.csm.operations.app.GetAppReleaseV1";
    }
}