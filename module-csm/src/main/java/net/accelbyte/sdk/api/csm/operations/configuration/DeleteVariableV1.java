...
public class DeleteVariableV1 extends Operation {
  ...
  @Deprecated
  public DeleteVariableV1(String customBasePath, String app, String configId, String namespace) {
    this.app = app;
  ...
  public DeleteVariableV1OpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final DeleteVariableV1OpResponse response = new DeleteVariableV1OpResponse();
