...
public class DeleteAppImagesV2 extends Operation {
    ...
    */
    ...
    public DeleteAppImagesV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteAppImagesV2OpResponse response = new DeleteAppImagesV2OpResponse();
