...
public class GetListOfVariablesV1 extends Operation {
    ...
    */
    ...
    public GetListOfVariablesV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetListOfVariablesV1OpResponse response = new GetListOfVariablesV1OpResponse();
