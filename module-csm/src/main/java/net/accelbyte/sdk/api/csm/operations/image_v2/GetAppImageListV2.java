...
public class GetAppImageListV2 extends Operation {
    ...
    */
    ...
    public GetAppImageListV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetAppImageListV2OpResponse response = new GetAppImageListV2OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApimodelGetAppImageListV2Response().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 401) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ApimodelGetAppImageListV2Response parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
