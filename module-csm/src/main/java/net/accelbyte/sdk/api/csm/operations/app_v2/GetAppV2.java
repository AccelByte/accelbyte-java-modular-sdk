...
public class GetAppV2 extends Operation {
  ...
  @Deprecated
  public GetAppV2(String customBasePath, String app, String namespace) {
    this.app = app;
  ...
  public GetAppV2OpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetAppV2OpResponse response = new GetAppV2OpResponse();
