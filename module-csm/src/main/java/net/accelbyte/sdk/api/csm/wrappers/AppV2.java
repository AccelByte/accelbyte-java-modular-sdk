...
public class AppV2 {
   ...
   */
  public UpdateAppResourcesResourceLimitFormV2OpResponse updateAppResourcesResourceLimitFormV2(
      UpdateAppResourcesResourceLimitFormV2 input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
