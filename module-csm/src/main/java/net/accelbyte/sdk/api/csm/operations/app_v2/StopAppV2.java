...
public class StopAppV2 extends Operation {
  ...
  @Deprecated
  public StopAppV2(String customBasePath, String app, String namespace) {
    this.app = app;
  ...
  public StopAppV2OpResponse parseResponse(int code, String contentType, InputStream payload)
