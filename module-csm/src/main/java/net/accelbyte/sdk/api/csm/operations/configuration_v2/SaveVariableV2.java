...
public class SaveVariableV2 extends Operation {
    ...
    */
    ...
    public SaveVariableV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SaveVariableV2OpResponse response = new SaveVariableV2OpResponse();
