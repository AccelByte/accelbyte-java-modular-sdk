...
public class UpdateSecretV1 extends Operation {
    ...
    */
    ...
    public UpdateSecretV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateSecretV1OpResponse response = new UpdateSecretV1OpResponse();
