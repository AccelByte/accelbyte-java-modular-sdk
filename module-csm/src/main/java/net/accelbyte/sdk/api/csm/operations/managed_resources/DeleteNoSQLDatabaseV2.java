...
import net.accelbyte.sdk.api.csm.operation_responses.managed_resources.DeleteNoSQLDatabaseV2OpResponse;
...
public class DeleteNoSQLDatabaseV2 extends Operation {
  ...
  @Deprecated
  public DeleteNoSQLDatabaseV2(String customBasePath, String app, String namespace) {
    this.app = app;
  ...
  public DeleteNoSQLDatabaseV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final DeleteNoSQLDatabaseV2OpResponse response = new DeleteNoSQLDatabaseV2OpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ApimodelNoSQLDatabaseDeleteResponse().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public ApimodelNoSQLDatabaseDeleteResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
