...
public class DeleteSecretV2 extends Operation {
  ...
  @Deprecated
  public DeleteSecretV2(String customBasePath, String app, String configId, String namespace) {
    this.app = app;
  ...
  public DeleteSecretV2OpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final DeleteSecretV2OpResponse response = new DeleteSecretV2OpResponse();
