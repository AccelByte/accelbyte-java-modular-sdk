...
public class DeleteSecretV1 extends Operation {
  ...
  @Deprecated
  public DeleteSecretV1(String customBasePath, String app, String configId, String namespace) {
    this.app = app;
  ...
  public DeleteSecretV1OpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final DeleteSecretV1OpResponse response = new DeleteSecretV1OpResponse();
