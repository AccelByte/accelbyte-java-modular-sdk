...
@Getter
@Setter
public class UpdateAppDebugModeV4OpResponse extends ApiResponseWithData<ApimodelAppItem> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.csm.operations.app_v4.UpdateAppDebugModeV4";
  }
}
