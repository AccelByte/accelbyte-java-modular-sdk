...
public class DeploymentV2 {
   ...
   */
  public CreateDeploymentV2OpResponse createDeploymentV2(CreateDeploymentV2 input)
      throws Exception {
   ...
   */
  public GetListOfDeploymentV2OpResponse getListOfDeploymentV2(GetListOfDeploymentV2 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public DeleteDeploymentV2OpResponse deleteDeploymentV2(DeleteDeploymentV2 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
