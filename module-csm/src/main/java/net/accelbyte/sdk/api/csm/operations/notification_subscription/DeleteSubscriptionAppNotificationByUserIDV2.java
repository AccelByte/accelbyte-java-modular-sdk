...
public class DeleteSubscriptionAppNotificationByUserIDV2 extends Operation {
  ...
  public DeleteSubscriptionAppNotificationByUserIDV2(
      String customBasePath, String app, String namespace, String userId) {
    this.app = app;
  ...
  public DeleteSubscriptionAppNotificationByUserIDV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final DeleteSubscriptionAppNotificationByUserIDV2OpResponse response =
        new DeleteSubscriptionAppNotificationByUserIDV2OpResponse();
