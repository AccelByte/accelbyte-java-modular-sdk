...
public class DeleteSubscriptionAppNotificationByUserIDV2 extends Operation {
     ...
     */
    private String path = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/subscriptions/users/{userId}";
    ...
    */
    ...
    public DeleteSubscriptionAppNotificationByUserIDV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteSubscriptionAppNotificationByUserIDV2OpResponse response = new DeleteSubscriptionAppNotificationByUserIDV2OpResponse();
