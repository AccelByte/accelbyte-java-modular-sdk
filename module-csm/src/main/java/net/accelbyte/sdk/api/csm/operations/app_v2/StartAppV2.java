...
public class StartAppV2 extends Operation {
  ...
  @Deprecated
  public StartAppV2(String customBasePath, String app, String namespace) {
    this.app = app;
  ...
  public StartAppV2OpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final StartAppV2OpResponse response = new StartAppV2OpResponse();
