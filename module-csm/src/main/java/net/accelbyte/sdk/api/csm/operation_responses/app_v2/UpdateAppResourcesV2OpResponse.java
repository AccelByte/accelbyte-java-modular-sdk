...
@Getter
@Setter
public class UpdateAppResourcesV2OpResponse extends ApiResponseWithData<ApimodelAppItem> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.csm.operations.app_v2.UpdateAppResourcesV2";
  }
}
