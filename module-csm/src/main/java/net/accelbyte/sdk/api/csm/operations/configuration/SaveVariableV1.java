...
public class SaveVariableV1 extends Operation {
    ...
    */
    ...
    public SaveVariableV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SaveVariableV1OpResponse response = new SaveVariableV1OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new GeneratedSaveConfigurationV1Response().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public GeneratedSaveConfigurationV1Response parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
