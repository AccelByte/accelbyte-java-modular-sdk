...
public class GetDeploymentV2 extends Operation {
  ...
  @Deprecated
  public GetDeploymentV2(String customBasePath, String deploymentId, String namespace) {
  ...
  public GetDeploymentV2OpResponse parseResponse(int code, String contentType, InputStream payload)
