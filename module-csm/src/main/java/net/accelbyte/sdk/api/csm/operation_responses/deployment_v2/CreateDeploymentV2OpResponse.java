...
@Getter
@Setter
public class CreateDeploymentV2OpResponse extends ApiResponseWithData<ApimodelCreateDeploymentV2Response> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.csm.operations.deployment_v2.CreateDeploymentV2";
    }
}