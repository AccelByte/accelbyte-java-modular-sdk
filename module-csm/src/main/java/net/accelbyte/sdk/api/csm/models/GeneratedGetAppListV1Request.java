...
public class GeneratedGetAppListV1Request extends Model {
    ...
    @JsonIgnore
    public List<GeneratedGetAppListV1Request> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<GeneratedGetAppListV1Request>>() {});
    }
