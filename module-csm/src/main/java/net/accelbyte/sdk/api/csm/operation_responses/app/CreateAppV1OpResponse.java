...
@Getter
@Setter
public class CreateAppV1OpResponse extends ApiResponseWithData<GeneratedCreateAppV1Response> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.csm.operations.app.CreateAppV1";
    }
}