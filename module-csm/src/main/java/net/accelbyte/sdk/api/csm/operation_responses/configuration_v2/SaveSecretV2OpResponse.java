...
@Getter
@Setter
public class SaveSecretV2OpResponse extends ApiResponseWithData<ApimodelSaveConfigurationV2Response> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.csm.operations.configuration_v2.SaveSecretV2";
    }
}