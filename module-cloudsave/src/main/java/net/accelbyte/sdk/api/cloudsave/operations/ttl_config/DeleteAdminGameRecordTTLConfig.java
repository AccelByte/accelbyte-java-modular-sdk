...
public class DeleteAdminGameRecordTTLConfig extends Operation {
    ...
    */
    ...
    public DeleteAdminGameRecordTTLConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteAdminGameRecordTTLConfigOpResponse response = new DeleteAdminGameRecordTTLConfigOpResponse();
