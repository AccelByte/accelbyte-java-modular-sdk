...
public class AdminPutAdminPlayerRecordV1 extends Operation {
    ...
    */
    ...
    public AdminPutAdminPlayerRecordV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminPutAdminPlayerRecordV1OpResponse response = new AdminPutAdminPlayerRecordV1OpResponse();
