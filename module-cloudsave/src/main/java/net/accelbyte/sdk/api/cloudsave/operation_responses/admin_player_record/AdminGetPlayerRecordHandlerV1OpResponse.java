...
@Getter
@Setter
public class AdminGetPlayerRecordHandlerV1OpResponse extends ApiResponseWithData<ModelsPlayerRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_player_record.AdminGetPlayerRecordHandlerV1";
    }
}