...
@Getter
@Setter
public class PutGameRecordHandlerV1OpResponse extends ApiResponseWithData<ModelsGameRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.public_game_record.PutGameRecordHandlerV1";
    }
}