...
@Getter
@Setter
public class ListOtherPlayerPublicBinaryRecordsV1OpResponse extends ApiResponseWithData<ModelsListPlayerBinaryRecordsResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.public_player_binary_record.ListOtherPlayerPublicBinaryRecordsV1";
    }
}