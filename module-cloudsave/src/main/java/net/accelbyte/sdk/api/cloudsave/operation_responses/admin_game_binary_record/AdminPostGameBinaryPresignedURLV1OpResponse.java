...
@Getter
@Setter
public class AdminPostGameBinaryPresignedURLV1OpResponse extends ApiResponseWithData<ModelsUploadBinaryRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_game_binary_record.AdminPostGameBinaryPresignedURLV1";
    }
}