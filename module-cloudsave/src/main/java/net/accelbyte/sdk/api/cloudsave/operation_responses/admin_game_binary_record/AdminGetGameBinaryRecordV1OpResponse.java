...
@Getter
@Setter
public class AdminGetGameBinaryRecordV1OpResponse extends ApiResponseWithData<ModelsGameBinaryRecordAdminResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_game_binary_record.AdminGetGameBinaryRecordV1";
    }
}