...
@Getter
@Setter
public class PostPlayerBinaryRecordV1OpResponse extends ApiResponseWithData<ModelsUploadBinaryRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.public_player_binary_record.PostPlayerBinaryRecordV1";
    }
}