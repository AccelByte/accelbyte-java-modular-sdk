...
public class AdminPostPlayerRecordHandlerV1 extends Operation {
  ...
  public AdminPostPlayerRecordHandlerV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminPostPlayerRecordHandlerV1OpResponse response =
        new AdminPostPlayerRecordHandlerV1OpResponse();
