...
@Getter
@Setter
public class PostPlayerBinaryPresignedURLV1OpResponse extends ApiResponseWithData<ModelsUploadBinaryRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.public_player_binary_record.PostPlayerBinaryPresignedURLV1";
    }
}