...
public class CreatePluginConfig extends Operation {
    ...
    */
    ...
    public CreatePluginConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreatePluginConfigOpResponse response = new CreatePluginConfigOpResponse();
