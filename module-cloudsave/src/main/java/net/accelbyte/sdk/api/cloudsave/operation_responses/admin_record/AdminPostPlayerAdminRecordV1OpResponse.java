...
@Getter
@Setter
public class AdminPostPlayerAdminRecordV1OpResponse extends ApiResponseWithData<ModelsAdminPlayerRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_record.AdminPostPlayerAdminRecordV1";
    }
}