...
public class AdminPostPlayerBinaryRecordV1 extends Operation {
    ...
    */
    ...
    public AdminPostPlayerBinaryRecordV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminPostPlayerBinaryRecordV1OpResponse response = new AdminPostPlayerBinaryRecordV1OpResponse();
