...
public class AdminGetPlayerRecordSizeHandlerV1 extends Operation {
  ...
  public AdminGetPlayerRecordSizeHandlerV1(
      String customBasePath, String key, String namespace, String userId) {
    this.key = key;
  ...
  public AdminGetPlayerRecordSizeHandlerV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetPlayerRecordSizeHandlerV1OpResponse response =
        new AdminGetPlayerRecordSizeHandlerV1OpResponse();
