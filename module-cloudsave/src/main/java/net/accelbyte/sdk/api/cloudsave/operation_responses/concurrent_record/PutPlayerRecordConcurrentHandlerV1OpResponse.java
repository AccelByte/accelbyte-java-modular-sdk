...
@Getter
@Setter
public class PutPlayerRecordConcurrentHandlerV1OpResponse extends ApiResponseWithData<ModelsPlayerRecordConcurrentUpdateResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.concurrent_record.PutPlayerRecordConcurrentHandlerV1";
    }
}