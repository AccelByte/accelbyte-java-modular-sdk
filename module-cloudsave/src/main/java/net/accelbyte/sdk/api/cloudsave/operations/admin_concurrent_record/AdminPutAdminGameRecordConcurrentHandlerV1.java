...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_concurrent_record.AdminPutAdminGameRecordConcurrentHandlerV1OpResponse;
...
public class AdminPutAdminGameRecordConcurrentHandlerV1 extends Operation {
    ...
    */
    ...
    public AdminPutAdminGameRecordConcurrentHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminPutAdminGameRecordConcurrentHandlerV1OpResponse response = new AdminPutAdminGameRecordConcurrentHandlerV1OpResponse();
