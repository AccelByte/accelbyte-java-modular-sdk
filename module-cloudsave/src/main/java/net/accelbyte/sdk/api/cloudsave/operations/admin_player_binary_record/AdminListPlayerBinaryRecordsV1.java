...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_player_binary_record.AdminListPlayerBinaryRecordsV1OpResponse;
...
public class AdminListPlayerBinaryRecordsV1 extends Operation {
    ...
    */
    ...
    public AdminListPlayerBinaryRecordsV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminListPlayerBinaryRecordsV1OpResponse response = new AdminListPlayerBinaryRecordsV1OpResponse();
