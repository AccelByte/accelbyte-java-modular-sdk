...
@Getter
@Setter
public class BulkGetPlayerPublicRecordHandlerV1OpResponse extends ApiResponseWithData<ModelsBulkGetPlayerRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.public_player_record.BulkGetPlayerPublicRecordHandlerV1";
    }
}