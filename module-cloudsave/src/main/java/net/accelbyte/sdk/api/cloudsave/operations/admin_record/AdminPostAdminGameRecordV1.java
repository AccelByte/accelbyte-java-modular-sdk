...
public class AdminPostAdminGameRecordV1 extends Operation {
    ...
    */
    ...
    public AdminPostAdminGameRecordV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminPostAdminGameRecordV1OpResponse response = new AdminPostAdminGameRecordV1OpResponse();
