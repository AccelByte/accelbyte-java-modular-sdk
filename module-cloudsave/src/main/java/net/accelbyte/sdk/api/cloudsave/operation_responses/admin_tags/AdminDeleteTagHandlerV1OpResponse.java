...
@Getter
@Setter
public class AdminDeleteTagHandlerV1OpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_tags.AdminDeleteTagHandlerV1";
    }
}