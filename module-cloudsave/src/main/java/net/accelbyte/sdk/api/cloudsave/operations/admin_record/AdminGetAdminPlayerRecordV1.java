...
public class AdminGetAdminPlayerRecordV1 extends Operation {
  ...
  public AdminGetAdminPlayerRecordV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetAdminPlayerRecordV1OpResponse response =
        new AdminGetAdminPlayerRecordV1OpResponse();
