...
public class ListGameBinaryRecordsV1 extends Operation {
    ...
    */
    ...
    public ListGameBinaryRecordsV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ListGameBinaryRecordsV1OpResponse response = new ListGameBinaryRecordsV1OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsListGameBinaryRecordsResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsListGameBinaryRecordsResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
