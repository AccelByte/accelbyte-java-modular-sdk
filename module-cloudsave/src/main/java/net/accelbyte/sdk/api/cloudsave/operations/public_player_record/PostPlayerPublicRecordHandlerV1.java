...
public class PostPlayerPublicRecordHandlerV1 extends Operation {
  ...
  public PostPlayerPublicRecordHandlerV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PostPlayerPublicRecordHandlerV1OpResponse response =
        new PostPlayerPublicRecordHandlerV1OpResponse();
