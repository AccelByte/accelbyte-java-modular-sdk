...
public class AdminGetGameBinaryRecordV1 extends Operation {
    ...
    */
    ...
    public AdminGetGameBinaryRecordV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetGameBinaryRecordV1OpResponse response = new AdminGetGameBinaryRecordV1OpResponse();
