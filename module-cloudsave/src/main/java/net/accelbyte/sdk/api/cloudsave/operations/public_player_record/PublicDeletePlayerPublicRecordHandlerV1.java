...
public class PublicDeletePlayerPublicRecordHandlerV1 extends Operation {
  ...
  public PublicDeletePlayerPublicRecordHandlerV1(
      String customBasePath, String key, String namespace) {
    this.key = key;
  ...
  public PublicDeletePlayerPublicRecordHandlerV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicDeletePlayerPublicRecordHandlerV1OpResponse response =
        new PublicDeletePlayerPublicRecordHandlerV1OpResponse();
