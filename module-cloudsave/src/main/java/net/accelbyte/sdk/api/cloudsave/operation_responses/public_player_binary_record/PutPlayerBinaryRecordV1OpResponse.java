...
@Getter
@Setter
public class PutPlayerBinaryRecordV1OpResponse extends ApiResponseWithData<ModelsPlayerBinaryRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.public_player_binary_record.PutPlayerBinaryRecordV1";
    }
}