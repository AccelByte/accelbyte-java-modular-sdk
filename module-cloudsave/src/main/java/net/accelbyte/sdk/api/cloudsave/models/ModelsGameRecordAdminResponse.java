...
public class ModelsGameRecordAdminResponse extends Model {
    ...
    @JsonIgnore
    public List<ModelsGameRecordAdminResponse> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelsGameRecordAdminResponse>>() {});
    }
