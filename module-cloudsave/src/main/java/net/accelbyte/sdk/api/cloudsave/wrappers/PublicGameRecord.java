...
public class PublicGameRecord {
   ...
   */
  public GetGameRecordsBulkOpResponse getGameRecordsBulk(GetGameRecordsBulk input)
      throws Exception {
   ...
   */
  public GetGameRecordHandlerV1OpResponse getGameRecordHandlerV1(GetGameRecordHandlerV1 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public PutGameRecordHandlerV1OpResponse putGameRecordHandlerV1(PutGameRecordHandlerV1 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public PostGameRecordHandlerV1OpResponse postGameRecordHandlerV1(PostGameRecordHandlerV1 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public DeleteGameRecordHandlerV1OpResponse deleteGameRecordHandlerV1(
      DeleteGameRecordHandlerV1 input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
