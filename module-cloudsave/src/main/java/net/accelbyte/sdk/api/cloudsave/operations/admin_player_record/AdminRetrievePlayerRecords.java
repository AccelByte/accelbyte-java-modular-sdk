...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_player_record.AdminRetrievePlayerRecordsOpResponse;
...
public class AdminRetrievePlayerRecords extends Operation {
    ...
    */
    ...
    public AdminRetrievePlayerRecordsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminRetrievePlayerRecordsOpResponse response = new AdminRetrievePlayerRecordsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsListPlayerRecordKeysResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsListPlayerRecordKeysResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
