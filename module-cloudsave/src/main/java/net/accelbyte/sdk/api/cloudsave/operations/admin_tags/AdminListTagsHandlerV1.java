...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_tags.AdminListTagsHandlerV1OpResponse;
...
public class AdminListTagsHandlerV1 extends Operation {
    ...
    */
    ...
    public AdminListTagsHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminListTagsHandlerV1OpResponse response = new AdminListTagsHandlerV1OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsListTagsResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsListTagsResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
