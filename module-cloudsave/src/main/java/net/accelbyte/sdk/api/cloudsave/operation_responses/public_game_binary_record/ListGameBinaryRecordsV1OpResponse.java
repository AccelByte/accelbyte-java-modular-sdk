...
@Getter
@Setter
public class ListGameBinaryRecordsV1OpResponse extends ApiResponseWithData<ModelsListGameBinaryRecordsResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.public_game_binary_record.ListGameBinaryRecordsV1";
    }
}