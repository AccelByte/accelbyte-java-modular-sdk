...
@Getter
@Setter
public class RetrievePlayerRecordsOpResponse extends ApiResponseWithData<ModelsListPlayerRecordKeysResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.public_player_record.RetrievePlayerRecords";
    }
}