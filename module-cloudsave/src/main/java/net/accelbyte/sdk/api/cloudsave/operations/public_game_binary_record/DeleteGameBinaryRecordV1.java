...
public class DeleteGameBinaryRecordV1 extends Operation {
    ...
    */
    ...
    public DeleteGameBinaryRecordV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteGameBinaryRecordV1OpResponse response = new DeleteGameBinaryRecordV1OpResponse();
