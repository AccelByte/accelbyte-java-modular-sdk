...
public class AdminPutGameRecordConcurrentHandlerV1 extends Operation {
    ...
    */
    ...
    public AdminPutGameRecordConcurrentHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminPutGameRecordConcurrentHandlerV1OpResponse response = new AdminPutGameRecordConcurrentHandlerV1OpResponse();
