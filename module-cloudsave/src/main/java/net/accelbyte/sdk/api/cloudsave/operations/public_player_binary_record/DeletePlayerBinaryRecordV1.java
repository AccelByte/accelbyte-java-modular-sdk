...
import net.accelbyte.sdk.api.cloudsave.operation_responses.public_player_binary_record.DeletePlayerBinaryRecordV1OpResponse;
...
public class DeletePlayerBinaryRecordV1 extends Operation {
    ...
    */
    ...
    public DeletePlayerBinaryRecordV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeletePlayerBinaryRecordV1OpResponse response = new DeletePlayerBinaryRecordV1OpResponse();
