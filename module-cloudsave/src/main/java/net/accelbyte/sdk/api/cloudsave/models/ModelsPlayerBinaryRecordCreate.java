...
public class ModelsPlayerBinaryRecordCreate extends Model {
    ...
    @JsonIgnore
    public List<ModelsPlayerBinaryRecordCreate> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelsPlayerBinaryRecordCreate>>() {});
    }
