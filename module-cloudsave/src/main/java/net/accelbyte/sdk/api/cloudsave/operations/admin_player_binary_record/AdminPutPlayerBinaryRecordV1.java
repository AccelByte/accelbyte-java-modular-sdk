...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_player_binary_record.AdminPutPlayerBinaryRecordV1OpResponse;
...
public class AdminPutPlayerBinaryRecordV1 extends Operation {
    ...
    */
    ...
    public AdminPutPlayerBinaryRecordV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminPutPlayerBinaryRecordV1OpResponse response = new AdminPutPlayerBinaryRecordV1OpResponse();
