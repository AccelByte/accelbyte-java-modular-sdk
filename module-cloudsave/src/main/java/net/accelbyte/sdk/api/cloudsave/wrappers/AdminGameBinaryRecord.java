...
public class AdminGameBinaryRecord {
   ...
   */
  public AdminListGameBinaryRecordsV1OpResponse adminListGameBinaryRecordsV1(
   ...
   */
  public AdminPostGameBinaryRecordV1OpResponse adminPostGameBinaryRecordV1(
   ...
   */
  public AdminGetGameBinaryRecordV1OpResponse adminGetGameBinaryRecordV1(
   ...
   */
  public AdminPutGameBinaryRecordV1OpResponse adminPutGameBinaryRecordV1(
   ...
   */
  public AdminDeleteGameBinaryRecordV1OpResponse adminDeleteGameBinaryRecordV1(
      AdminDeleteGameBinaryRecordV1 input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminPutGameBinaryRecorMetadataV1OpResponse adminPutGameBinaryRecorMetadataV1(
   ...
   */
  public AdminPostGameBinaryPresignedURLV1OpResponse adminPostGameBinaryPresignedURLV1(
