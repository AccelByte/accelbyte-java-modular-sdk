...
import net.accelbyte.sdk.api.cloudsave.operation_responses.public_player_binary_record.PostPlayerBinaryPresignedURLV1OpResponse;
...
public class PostPlayerBinaryPresignedURLV1 extends Operation {
     ...
     */
    private String path = "/cloudsave/v1/namespaces/{namespace}/users/{userId}/binaries/{key}/presigned";
    ...
    */
    ...
    public PostPlayerBinaryPresignedURLV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PostPlayerBinaryPresignedURLV1OpResponse response = new PostPlayerBinaryPresignedURLV1OpResponse();
