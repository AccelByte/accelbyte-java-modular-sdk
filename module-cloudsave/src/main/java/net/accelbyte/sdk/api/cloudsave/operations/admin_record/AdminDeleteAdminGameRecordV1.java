...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_record.AdminDeleteAdminGameRecordV1OpResponse;
...
public class AdminDeleteAdminGameRecordV1 extends Operation {
    ...
    */
    ...
    public AdminDeleteAdminGameRecordV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDeleteAdminGameRecordV1OpResponse response = new AdminDeleteAdminGameRecordV1OpResponse();
