...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_player_record.ListPlayerRecordHandlerV1OpResponse;
...
public class ListPlayerRecordHandlerV1 extends Operation {
    ...
    */
    ...
    public ListPlayerRecordHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ListPlayerRecordHandlerV1OpResponse response = new ListPlayerRecordHandlerV1OpResponse();
