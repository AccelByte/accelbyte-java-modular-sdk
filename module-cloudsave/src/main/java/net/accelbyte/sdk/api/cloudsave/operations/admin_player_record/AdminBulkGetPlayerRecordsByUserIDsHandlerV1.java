...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_player_record.AdminBulkGetPlayerRecordsByUserIDsHandlerV1OpResponse;
...
public class AdminBulkGetPlayerRecordsByUserIDsHandlerV1 extends Operation {
    ...
    */
    ...
    public AdminBulkGetPlayerRecordsByUserIDsHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminBulkGetPlayerRecordsByUserIDsHandlerV1OpResponse response = new AdminBulkGetPlayerRecordsByUserIDsHandlerV1OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsBulkGetPlayerRecordResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsBulkGetPlayerRecordResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
