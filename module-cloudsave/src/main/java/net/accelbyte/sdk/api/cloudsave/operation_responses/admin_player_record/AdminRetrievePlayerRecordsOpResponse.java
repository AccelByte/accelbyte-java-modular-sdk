...
@Getter
@Setter
public class AdminRetrievePlayerRecordsOpResponse extends ApiResponseWithData<ModelsListPlayerRecordKeysResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_player_record.AdminRetrievePlayerRecords";
    }
}