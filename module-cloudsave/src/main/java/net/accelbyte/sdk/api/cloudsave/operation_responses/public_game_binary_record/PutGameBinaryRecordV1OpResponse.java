...
@Getter
@Setter
public class PutGameBinaryRecordV1OpResponse extends ApiResponseWithData<ModelsGameBinaryRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.public_game_binary_record.PutGameBinaryRecordV1";
    }
}