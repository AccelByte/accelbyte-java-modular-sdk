...
public class AdminConcurrentRecord {
   ...
   */
  public AdminPutAdminGameRecordConcurrentHandlerV1OpResponse
      adminPutAdminGameRecordConcurrentHandlerV1(AdminPutAdminGameRecordConcurrentHandlerV1 input)
          throws Exception {
   ...
   */
  public AdminPutGameRecordConcurrentHandlerV1OpResponse adminPutGameRecordConcurrentHandlerV1(
      AdminPutGameRecordConcurrentHandlerV1 input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminPutAdminPlayerRecordConcurrentHandlerV1OpResponse
   ...
   */
  public AdminPutPlayerRecordConcurrentHandlerV1OpResponse adminPutPlayerRecordConcurrentHandlerV1(
   ...
   */
  public AdminPutPlayerPublicRecordConcurrentHandlerV1OpResponse
