...
@Getter
@Setter
public class GetPluginConfigOpResponse extends ApiResponseWithData<ModelsPluginResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.plugin_config.GetPluginConfig";
    }
}