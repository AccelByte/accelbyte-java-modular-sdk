...
public class TTLConfig {
   ...
   */
  public DeleteAdminGameRecordTTLConfigOpResponse deleteAdminGameRecordTTLConfig(
      DeleteAdminGameRecordTTLConfig input) throws Exception {
   ...
   */
  public DeleteGameBinaryRecordTTLConfigOpResponse deleteGameBinaryRecordTTLConfig(
      DeleteGameBinaryRecordTTLConfig input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public DeleteGameRecordTTLConfigOpResponse deleteGameRecordTTLConfig(
      DeleteGameRecordTTLConfig input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
