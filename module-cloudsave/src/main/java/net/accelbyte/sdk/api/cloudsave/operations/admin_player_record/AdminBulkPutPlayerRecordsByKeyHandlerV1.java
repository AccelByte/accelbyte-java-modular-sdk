...
public class AdminBulkPutPlayerRecordsByKeyHandlerV1 extends Operation {
  ...
  public AdminBulkPutPlayerRecordsByKeyHandlerV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminBulkPutPlayerRecordsByKeyHandlerV1OpResponse response =
        new AdminBulkPutPlayerRecordsByKeyHandlerV1OpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(
          new ObjectMapper()
              .readValue(
                  json, new TypeReference<List<ModelsBulkUpdatePlayerRecordByKeyResponse>>() {}));
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
