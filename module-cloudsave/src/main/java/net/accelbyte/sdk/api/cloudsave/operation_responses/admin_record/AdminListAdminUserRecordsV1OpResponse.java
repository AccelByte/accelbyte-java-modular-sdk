...
@Getter
@Setter
public class AdminListAdminUserRecordsV1OpResponse extends ApiResponseWithData<ModelsListAdminPlayerRecordKeysResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_record.AdminListAdminUserRecordsV1";
    }
}