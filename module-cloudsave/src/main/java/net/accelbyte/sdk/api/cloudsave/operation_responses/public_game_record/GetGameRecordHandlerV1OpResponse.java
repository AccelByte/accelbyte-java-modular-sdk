...
@Getter
@Setter
public class GetGameRecordHandlerV1OpResponse extends ApiResponseWithData<ModelsGameRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.public_game_record.GetGameRecordHandlerV1";
    }
}