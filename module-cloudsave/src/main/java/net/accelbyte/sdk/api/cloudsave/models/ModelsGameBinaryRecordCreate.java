...
public class ModelsGameBinaryRecordCreate extends Model {
    ...
    @JsonIgnore
    public List<ModelsGameBinaryRecordCreate> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelsGameBinaryRecordCreate>>() {});
    }
