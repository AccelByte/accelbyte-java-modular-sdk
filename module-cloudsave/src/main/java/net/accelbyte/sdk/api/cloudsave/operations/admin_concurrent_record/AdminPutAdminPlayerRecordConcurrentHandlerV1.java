...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_concurrent_record.AdminPutAdminPlayerRecordConcurrentHandlerV1OpResponse;
...
public class AdminPutAdminPlayerRecordConcurrentHandlerV1 extends Operation {
     ...
     */
    private String path = "/cloudsave/v1/admin/namespaces/{namespace}/users/{userId}/concurrent/adminrecords/{key}";
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("responseBody", this.responseBody == null ? null : Arrays.asList(String.valueOf(this.responseBody)));
        return queryParams;
    }
    ...
    public AdminPutAdminPlayerRecordConcurrentHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminPutAdminPlayerRecordConcurrentHandlerV1OpResponse response = new AdminPutAdminPlayerRecordConcurrentHandlerV1OpResponse();
