...
@Getter
@Setter
public class AdminGetAdminPlayerRecordV1OpResponse extends ApiResponseWithData<ModelsAdminPlayerRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_record.AdminGetAdminPlayerRecordV1";
    }
}