...
@Getter
@Setter
public class AdminListAdminGameRecordV1OpResponse extends ApiResponseWithData<ModelsListAdminGameRecordKeysResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_record.AdminListAdminGameRecordV1";
    }
}