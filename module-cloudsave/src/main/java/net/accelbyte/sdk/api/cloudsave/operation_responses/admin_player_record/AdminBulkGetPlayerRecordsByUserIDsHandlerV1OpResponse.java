...
@Getter
@Setter
public class AdminBulkGetPlayerRecordsByUserIDsHandlerV1OpResponse extends ApiResponseWithData<ModelsBulkGetPlayerRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_player_record.AdminBulkGetPlayerRecordsByUserIDsHandlerV1";
    }
}