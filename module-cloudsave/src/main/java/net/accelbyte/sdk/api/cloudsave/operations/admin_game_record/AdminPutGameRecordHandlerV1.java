...
public class AdminPutGameRecordHandlerV1 extends Operation {
  ...
  public AdminPutGameRecordHandlerV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminPutGameRecordHandlerV1OpResponse response =
        new AdminPutGameRecordHandlerV1OpResponse();
