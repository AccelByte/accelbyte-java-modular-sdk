...
@Getter
@Setter
public class AdminBulkGetAdminPlayerRecordV1OpResponse extends ApiResponseWithData<ModelsBulkGetAdminPlayerRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_record.AdminBulkGetAdminPlayerRecordV1";
    }
}