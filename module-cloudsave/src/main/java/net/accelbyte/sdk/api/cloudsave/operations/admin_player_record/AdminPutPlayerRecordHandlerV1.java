...
public class AdminPutPlayerRecordHandlerV1 extends Operation {
  ...
  public AdminPutPlayerRecordHandlerV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminPutPlayerRecordHandlerV1OpResponse response =
        new AdminPutPlayerRecordHandlerV1OpResponse();
