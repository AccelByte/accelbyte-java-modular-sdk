...
public class AdminListGameBinaryRecordsV1 extends Operation {
    ...
    */
    ...
    public AdminListGameBinaryRecordsV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminListGameBinaryRecordsV1OpResponse response = new AdminListGameBinaryRecordsV1OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsListGameBinaryRecordsAdminResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsListGameBinaryRecordsAdminResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
