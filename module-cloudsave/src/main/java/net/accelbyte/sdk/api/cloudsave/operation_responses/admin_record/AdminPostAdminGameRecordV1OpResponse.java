...
@Getter
@Setter
public class AdminPostAdminGameRecordV1OpResponse extends ApiResponseWithData<ModelsAdminGameRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_record.AdminPostAdminGameRecordV1";
    }
}