...
@Getter
@Setter
public class BulkGetAdminPlayerRecordByUserIdsV1OpResponse extends ApiResponseWithData<ModelsBulkGetAdminPlayerRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_record.BulkGetAdminPlayerRecordByUserIdsV1";
    }
}