...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_player_record.AdminDeletePlayerPublicRecordHandlerV1OpResponse;
...
public class AdminDeletePlayerPublicRecordHandlerV1 extends Operation {
    ...
    */
    ...
    public AdminDeletePlayerPublicRecordHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDeletePlayerPublicRecordHandlerV1OpResponse response = new AdminDeletePlayerPublicRecordHandlerV1OpResponse();
