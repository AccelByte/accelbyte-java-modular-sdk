...
@Getter
@Setter
public class GetPlayerRecordsBulkHandlerV1OpResponse extends ApiResponseWithData<ModelsBulkGetPlayerRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.public_player_record.GetPlayerRecordsBulkHandlerV1";
    }
}