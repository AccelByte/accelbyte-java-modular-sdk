...
public class GetPlayerPublicRecordHandlerV1 extends Operation {
    ...
    */
    ...
    public GetPlayerPublicRecordHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetPlayerPublicRecordHandlerV1OpResponse response = new GetPlayerPublicRecordHandlerV1OpResponse();
