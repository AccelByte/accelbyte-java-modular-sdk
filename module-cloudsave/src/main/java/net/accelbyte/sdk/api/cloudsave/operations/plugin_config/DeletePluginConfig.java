...
public class DeletePluginConfig extends Operation {
    ...
    */
    ...
    public DeletePluginConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeletePluginConfigOpResponse response = new DeletePluginConfigOpResponse();
