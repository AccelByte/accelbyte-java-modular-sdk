...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_player_record.AdminPutPlayerPublicRecordHandlerV1OpResponse;
...
public class AdminPutPlayerPublicRecordHandlerV1 extends Operation {
    ...
    */
    ...
    public AdminPutPlayerPublicRecordHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminPutPlayerPublicRecordHandlerV1OpResponse response = new AdminPutPlayerPublicRecordHandlerV1OpResponse();
