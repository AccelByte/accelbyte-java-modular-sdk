...
public class AdminPutPlayerPublicRecordHandlerV1 extends Operation {
  ...
  public AdminPutPlayerPublicRecordHandlerV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminPutPlayerPublicRecordHandlerV1OpResponse response =
        new AdminPutPlayerPublicRecordHandlerV1OpResponse();
