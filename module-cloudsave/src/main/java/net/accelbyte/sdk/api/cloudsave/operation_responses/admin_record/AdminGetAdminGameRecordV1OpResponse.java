...
@Getter
@Setter
public class AdminGetAdminGameRecordV1OpResponse extends ApiResponseWithData<ModelsAdminGameRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_record.AdminGetAdminGameRecordV1";
    }
}