...
public class GetPlayerRecordHandlerV1 extends Operation {
    ...
    */
    ...
    public GetPlayerRecordHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetPlayerRecordHandlerV1OpResponse response = new GetPlayerRecordHandlerV1OpResponse();
