...
public class PostGameBinaryPresignedURLV1 extends Operation {
    ...
    */
    ...
    public PostGameBinaryPresignedURLV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PostGameBinaryPresignedURLV1OpResponse response = new PostGameBinaryPresignedURLV1OpResponse();
