...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_record.BulkGetAdminPlayerRecordByUserIdsV1OpResponse;
...
public class BulkGetAdminPlayerRecordByUserIdsV1 extends Operation {
    ...
    */
    ...
    public BulkGetAdminPlayerRecordByUserIdsV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final BulkGetAdminPlayerRecordByUserIdsV1OpResponse response = new BulkGetAdminPlayerRecordByUserIdsV1OpResponse();
