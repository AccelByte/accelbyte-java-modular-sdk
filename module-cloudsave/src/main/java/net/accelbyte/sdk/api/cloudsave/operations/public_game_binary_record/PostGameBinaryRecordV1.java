...
public class PostGameBinaryRecordV1 extends Operation {
    ...
    */
    ...
    public PostGameBinaryRecordV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PostGameBinaryRecordV1OpResponse response = new PostGameBinaryRecordV1OpResponse();
