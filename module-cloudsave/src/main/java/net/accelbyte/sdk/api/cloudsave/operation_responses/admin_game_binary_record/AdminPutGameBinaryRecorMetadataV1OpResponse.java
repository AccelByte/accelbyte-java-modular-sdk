...
@Getter
@Setter
public class AdminPutGameBinaryRecorMetadataV1OpResponse extends ApiResponseWithData<ModelsGameBinaryRecordAdminResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_game_binary_record.AdminPutGameBinaryRecorMetadataV1";
    }
}