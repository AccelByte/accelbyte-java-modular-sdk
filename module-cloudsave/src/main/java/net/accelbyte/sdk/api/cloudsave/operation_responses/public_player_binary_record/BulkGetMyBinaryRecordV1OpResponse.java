...
@Getter
@Setter
public class BulkGetMyBinaryRecordV1OpResponse extends ApiResponseWithData<ModelsBulkGetPlayerBinaryRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.public_player_binary_record.BulkGetMyBinaryRecordV1";
    }
}