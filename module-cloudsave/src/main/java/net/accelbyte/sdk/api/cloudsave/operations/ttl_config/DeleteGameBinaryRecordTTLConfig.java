...
public class DeleteGameBinaryRecordTTLConfig extends Operation {
    ...
    */
    ...
    public DeleteGameBinaryRecordTTLConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteGameBinaryRecordTTLConfigOpResponse response = new DeleteGameBinaryRecordTTLConfigOpResponse();
