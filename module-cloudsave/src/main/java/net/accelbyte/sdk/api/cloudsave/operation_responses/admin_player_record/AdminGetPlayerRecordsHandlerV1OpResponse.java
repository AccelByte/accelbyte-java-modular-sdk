...
@Getter
@Setter
public class AdminGetPlayerRecordsHandlerV1OpResponse extends ApiResponseWithData<ModelsBulkGetAdminPlayerRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_player_record.AdminGetPlayerRecordsHandlerV1";
    }
}