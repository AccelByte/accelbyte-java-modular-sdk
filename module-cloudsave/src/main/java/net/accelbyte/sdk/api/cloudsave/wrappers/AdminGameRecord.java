...
public class AdminGameRecord {
   ...
   */
  public ListGameRecordsHandlerV1OpResponse listGameRecordsHandlerV1(ListGameRecordsHandlerV1 input)
      throws Exception {
   ...
   */
  public AdminGetGameRecordHandlerV1OpResponse adminGetGameRecordHandlerV1(
   ...
   */
  public AdminPutGameRecordHandlerV1OpResponse adminPutGameRecordHandlerV1(
   ...
   */
  public AdminPostGameRecordHandlerV1OpResponse adminPostGameRecordHandlerV1(
   ...
   */
  public AdminDeleteGameRecordHandlerV1OpResponse adminDeleteGameRecordHandlerV1(
      AdminDeleteGameRecordHandlerV1 input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
