...
@Getter
@Setter
public class AdminGetPlayerRecordSizeHandlerV1OpResponse extends ApiResponseWithData<ModelsPlayerRecordSizeResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_player_record.AdminGetPlayerRecordSizeHandlerV1";
    }
}