...
public class AdminTags {
     ...
     */
    public AdminListTagsHandlerV1OpResponse adminListTagsHandlerV1(AdminListTagsHandlerV1 input) throws Exception {
     ...
     */
    public AdminPostTagHandlerV1OpResponse adminPostTagHandlerV1(AdminPostTagHandlerV1 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public AdminDeleteTagHandlerV1OpResponse adminDeleteTagHandlerV1(AdminDeleteTagHandlerV1 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
