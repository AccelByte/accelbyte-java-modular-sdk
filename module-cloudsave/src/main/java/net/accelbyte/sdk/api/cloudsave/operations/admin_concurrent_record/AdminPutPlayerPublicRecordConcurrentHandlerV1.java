...
public class AdminPutPlayerPublicRecordConcurrentHandlerV1 extends Operation {
  ...
  public AdminPutPlayerPublicRecordConcurrentHandlerV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminPutPlayerPublicRecordConcurrentHandlerV1OpResponse response =
        new AdminPutPlayerPublicRecordConcurrentHandlerV1OpResponse();
