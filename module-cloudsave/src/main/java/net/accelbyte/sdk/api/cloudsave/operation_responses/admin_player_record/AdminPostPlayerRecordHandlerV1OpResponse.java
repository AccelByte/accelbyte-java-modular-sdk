...
@Getter
@Setter
public class AdminPostPlayerRecordHandlerV1OpResponse extends ApiResponseWithData<ModelsPlayerRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_player_record.AdminPostPlayerRecordHandlerV1";
    }
}