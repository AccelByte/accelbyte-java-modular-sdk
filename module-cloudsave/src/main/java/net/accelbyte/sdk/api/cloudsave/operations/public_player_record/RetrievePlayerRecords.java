...
public class RetrievePlayerRecords extends Operation {
    ...
    */
    ...
    public RetrievePlayerRecordsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RetrievePlayerRecordsOpResponse response = new RetrievePlayerRecordsOpResponse();
