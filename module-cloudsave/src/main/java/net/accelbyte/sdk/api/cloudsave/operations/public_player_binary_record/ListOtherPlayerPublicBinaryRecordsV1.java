...
import net.accelbyte.sdk.api.cloudsave.operation_responses.public_player_binary_record.ListOtherPlayerPublicBinaryRecordsV1OpResponse;
...
public class ListOtherPlayerPublicBinaryRecordsV1 extends Operation {
    ...
    */
    ...
    public ListOtherPlayerPublicBinaryRecordsV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ListOtherPlayerPublicBinaryRecordsV1OpResponse response = new ListOtherPlayerPublicBinaryRecordsV1OpResponse();
