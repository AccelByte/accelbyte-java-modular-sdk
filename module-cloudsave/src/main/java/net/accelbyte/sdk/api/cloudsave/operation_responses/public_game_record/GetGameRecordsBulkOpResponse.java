...
@Getter
@Setter
public class GetGameRecordsBulkOpResponse extends ApiResponseWithData<ModelsBulkGetGameRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.public_game_record.GetGameRecordsBulk";
    }
}