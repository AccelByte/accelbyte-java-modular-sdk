...
@Getter
@Setter
public class ListMyBinaryRecordsV1OpResponse extends ApiResponseWithData<ModelsListPlayerBinaryRecordsResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.public_player_binary_record.ListMyBinaryRecordsV1";
    }
}