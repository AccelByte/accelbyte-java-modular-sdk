...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_player_record.AdminGetPlayerPublicRecordHandlerV1OpResponse;
...
public class AdminGetPlayerPublicRecordHandlerV1 extends Operation {
    ...
    */
    ...
    public AdminGetPlayerPublicRecordHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetPlayerPublicRecordHandlerV1OpResponse response = new AdminGetPlayerPublicRecordHandlerV1OpResponse();
