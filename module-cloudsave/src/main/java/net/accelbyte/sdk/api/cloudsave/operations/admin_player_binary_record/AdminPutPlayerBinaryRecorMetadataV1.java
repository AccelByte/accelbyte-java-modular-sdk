...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_player_binary_record.AdminPutPlayerBinaryRecorMetadataV1OpResponse;
...
public class AdminPutPlayerBinaryRecorMetadataV1 extends Operation {
     ...
     */
    private String path = "/cloudsave/v1/admin/namespaces/{namespace}/users/{userId}/binaries/{key}/metadata";
    ...
    */
    ...
    public AdminPutPlayerBinaryRecorMetadataV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminPutPlayerBinaryRecorMetadataV1OpResponse response = new AdminPutPlayerBinaryRecorMetadataV1OpResponse();
