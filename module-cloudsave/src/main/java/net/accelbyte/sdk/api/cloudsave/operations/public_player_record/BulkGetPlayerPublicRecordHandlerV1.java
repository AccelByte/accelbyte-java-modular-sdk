...
public class BulkGetPlayerPublicRecordHandlerV1 extends Operation {
    ...
    */
    ...
    public BulkGetPlayerPublicRecordHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final BulkGetPlayerPublicRecordHandlerV1OpResponse response = new BulkGetPlayerPublicRecordHandlerV1OpResponse();
