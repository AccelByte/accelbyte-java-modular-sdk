...
import net.accelbyte.sdk.api.cloudsave.operation_responses.public_player_binary_record.PostPlayerBinaryRecordV1OpResponse;
...
public class PostPlayerBinaryRecordV1 extends Operation {
    ...
    */
    ...
    public PostPlayerBinaryRecordV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PostPlayerBinaryRecordV1OpResponse response = new PostPlayerBinaryRecordV1OpResponse();
