...
@Getter
@Setter
public class CreatePluginConfigOpResponse extends ApiResponseWithData<ModelsPluginResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.cloudsave.operations.plugin_config.CreatePluginConfig";
  }
}
