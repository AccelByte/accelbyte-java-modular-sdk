...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_record.AdminBulkGetAdminPlayerRecordV1OpResponse;
...
public class AdminBulkGetAdminPlayerRecordV1 extends Operation {
     ...
     */
    private String path = "/cloudsave/v1/admin/namespaces/{namespace}/users/{userId}/adminrecords/bulk";
    ...
    */
    ...
    public AdminBulkGetAdminPlayerRecordV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminBulkGetAdminPlayerRecordV1OpResponse response = new AdminBulkGetAdminPlayerRecordV1OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsBulkGetAdminPlayerRecordResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsBulkGetAdminPlayerRecordResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
