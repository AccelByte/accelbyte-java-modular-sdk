...
public class AdminBulkGetAdminPlayerRecordV1 extends Operation {
  ...
  public AdminBulkGetAdminPlayerRecordV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminBulkGetAdminPlayerRecordV1OpResponse response =
        new AdminBulkGetAdminPlayerRecordV1OpResponse();
