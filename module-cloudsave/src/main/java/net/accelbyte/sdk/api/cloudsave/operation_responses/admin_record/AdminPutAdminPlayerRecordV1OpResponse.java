...
@Getter
@Setter
public class AdminPutAdminPlayerRecordV1OpResponse extends ApiResponseWithData<ModelsAdminPlayerRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_record.AdminPutAdminPlayerRecordV1";
    }
}