...
@Getter
@Setter
public class AdminBulkGetAdminGameRecordV1OpResponse extends ApiResponseWithData<ModelsBulkGetAdminGameRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_record.AdminBulkGetAdminGameRecordV1";
    }
}