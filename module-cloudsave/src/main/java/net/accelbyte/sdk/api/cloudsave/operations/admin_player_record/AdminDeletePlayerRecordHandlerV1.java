...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_player_record.AdminDeletePlayerRecordHandlerV1OpResponse;
...
public class AdminDeletePlayerRecordHandlerV1 extends Operation {
    ...
    */
    ...
    public AdminDeletePlayerRecordHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDeletePlayerRecordHandlerV1OpResponse response = new AdminDeletePlayerRecordHandlerV1OpResponse();
