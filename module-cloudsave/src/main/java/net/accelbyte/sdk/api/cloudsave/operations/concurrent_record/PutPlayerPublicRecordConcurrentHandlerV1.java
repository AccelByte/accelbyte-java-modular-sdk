...
public class PutPlayerPublicRecordConcurrentHandlerV1 extends Operation {
    ...
    */
    ...
    public PutPlayerPublicRecordConcurrentHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PutPlayerPublicRecordConcurrentHandlerV1OpResponse response = new PutPlayerPublicRecordConcurrentHandlerV1OpResponse();
