...
import net.accelbyte.sdk.api.cloudsave.operation_responses.public_game_record.DeleteGameRecordHandlerV1OpResponse;
...
public class DeleteGameRecordHandlerV1 extends Operation {
    ...
    */
    ...
    public DeleteGameRecordHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteGameRecordHandlerV1OpResponse response = new DeleteGameRecordHandlerV1OpResponse();
