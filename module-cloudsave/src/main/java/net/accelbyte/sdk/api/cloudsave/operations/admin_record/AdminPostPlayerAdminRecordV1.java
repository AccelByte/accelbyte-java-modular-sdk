...
public class AdminPostPlayerAdminRecordV1 extends Operation {
    ...
    */
    ...
    public AdminPostPlayerAdminRecordV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminPostPlayerAdminRecordV1OpResponse response = new AdminPostPlayerAdminRecordV1OpResponse();
