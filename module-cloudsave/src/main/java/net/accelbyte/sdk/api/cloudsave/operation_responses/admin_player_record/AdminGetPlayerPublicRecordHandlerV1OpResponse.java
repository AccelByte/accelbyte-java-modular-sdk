...
@Getter
@Setter
public class AdminGetPlayerPublicRecordHandlerV1OpResponse extends ApiResponseWithData<ModelsPlayerRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_player_record.AdminGetPlayerPublicRecordHandlerV1";
    }
}