...
public class CloudsaveErrors {
  ...
  public static ApiError error18004 =
      new ApiError("18004", "unable to retrieve list of key records");
  ...
  public static ApiError error18015 =
      new ApiError(
  ...
  public static ApiError error18023 =
      new ApiError("18023", "get action is forbidden on other user's record");
  ...
  public static ApiError error18035 =
      new ApiError("18035", "post action is forbidden on other user's record");
  ...
  public static ApiError error18052 =
      new ApiError(
  ...
  public static ApiError error18056 =
      new ApiError("18056", "precondition failed: record has changed");
  ...
  public static ApiError error18063 =
      new ApiError("18063", "put action is forbidden on other user's record");
  ...
  public static ApiError error18066 =
      new ApiError("18066", "precondition failed: record has changed");
  public static ApiError error18070 = new ApiError("18070", "unable to delete record");
  public static ApiError error18072 =
      new ApiError("18072", "delete action is forbidden on other user's record");
  ...
  public static ApiError error18103 =
      new ApiError("18103", "precondition failed: record has changed");
  public static ApiError error18113 = new ApiError("18113", "invalid request body");
  public static ApiError error18114 =
      new ApiError("18114", "unable to retrieve list of key records");
  ...
  public static ApiError error18126 =
      new ApiError("18126", "request record keys list exceed max size [%d]");
  public static ApiError error18128 = new ApiError("18128", "invalid request body");
  public static ApiError error18129 =
      new ApiError("18129", "request record keys list exceed max size [%d]");
  ...
  public static ApiError error18136 =
      new ApiError(
  ...
  public static ApiError error18146 =
      new ApiError(
  ...
  public static ApiError error18160 =
      new ApiError("18160", "unable to retrieve list of key records");
  ...
  public static ApiError error18169 =
      new ApiError("18169", "request record keys list exceed max size [%d]");
  ...
  public static ApiError error18175 =
      new ApiError("18175", "request record keys list exceed max size [%d]");
  ...
  public static ApiError error18180 =
      new ApiError("18180", "precondition failed: record has changed");
  ...
  public static ApiError error18183 =
      new ApiError("18183", "precondition failed: record has changed");
  ...
  public static ApiError error18201 =
      new ApiError("18201", "invalid record operator, expect [%s] but actual [%s]");
  ...
  public static ApiError error18345 =
      new ApiError("18345", "unable to retrieve list of key records");
  ...
  public static ApiError error18351 =
      new ApiError("18351", "request record keys list exceed max size [%d]");
