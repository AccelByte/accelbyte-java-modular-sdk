...
public class PutPlayerBinaryRecorMetadataV1 extends Operation {
     ...
     */
    private String path = "/cloudsave/v1/namespaces/{namespace}/users/{userId}/binaries/{key}/metadata";
    ...
    */
    ...
    public PutPlayerBinaryRecorMetadataV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PutPlayerBinaryRecorMetadataV1OpResponse response = new PutPlayerBinaryRecorMetadataV1OpResponse();
