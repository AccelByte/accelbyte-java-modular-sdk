...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_record.AdminGetAdminGameRecordV1OpResponse;
...
public class AdminGetAdminGameRecordV1 extends Operation {
    ...
    */
    ...
    public AdminGetAdminGameRecordV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetAdminGameRecordV1OpResponse response = new AdminGetAdminGameRecordV1OpResponse();
