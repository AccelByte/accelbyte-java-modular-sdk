...
public class UpdatePluginConfig extends Operation {
  ...
  @Deprecated
  public UpdatePluginConfig(String customBasePath, String namespace, ModelsPluginRequest body) {
  ...
  public UpdatePluginConfigOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdatePluginConfigOpResponse response = new UpdatePluginConfigOpResponse();
