...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_player_binary_record.AdminPostPlayerBinaryPresignedURLV1OpResponse;
...
public class AdminPostPlayerBinaryPresignedURLV1 extends Operation {
     ...
     */
    private String path = "/cloudsave/v1/admin/namespaces/{namespace}/users/{userId}/binaries/{key}/presigned";
    ...
    */
    ...
    public AdminPostPlayerBinaryPresignedURLV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminPostPlayerBinaryPresignedURLV1OpResponse response = new AdminPostPlayerBinaryPresignedURLV1OpResponse();
