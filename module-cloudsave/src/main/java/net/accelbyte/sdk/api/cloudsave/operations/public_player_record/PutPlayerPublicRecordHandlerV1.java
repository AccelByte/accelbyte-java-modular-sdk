...
public class PutPlayerPublicRecordHandlerV1 extends Operation {
    ...
    */
    ...
    public PutPlayerPublicRecordHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PutPlayerPublicRecordHandlerV1OpResponse response = new PutPlayerPublicRecordHandlerV1OpResponse();
