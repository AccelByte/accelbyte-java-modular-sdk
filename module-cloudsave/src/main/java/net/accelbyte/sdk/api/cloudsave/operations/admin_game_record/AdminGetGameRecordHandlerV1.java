...
public class AdminGetGameRecordHandlerV1 extends Operation {
  ...
  @Deprecated
  public AdminGetGameRecordHandlerV1(String customBasePath, String key, String namespace) {
    this.key = key;
  ...
  public AdminGetGameRecordHandlerV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetGameRecordHandlerV1OpResponse response =
        new AdminGetGameRecordHandlerV1OpResponse();
