...
public class AdminGetGameRecordHandlerV1 extends Operation {
    ...
    */
    ...
    public AdminGetGameRecordHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetGameRecordHandlerV1OpResponse response = new AdminGetGameRecordHandlerV1OpResponse();
