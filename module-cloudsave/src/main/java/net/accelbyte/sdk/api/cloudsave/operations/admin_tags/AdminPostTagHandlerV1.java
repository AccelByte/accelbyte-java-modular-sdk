...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_tags.AdminPostTagHandlerV1OpResponse;
...
public class AdminPostTagHandlerV1 extends Operation {
    ...
    */
    ...
    public AdminPostTagHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminPostTagHandlerV1OpResponse response = new AdminPostTagHandlerV1OpResponse();
