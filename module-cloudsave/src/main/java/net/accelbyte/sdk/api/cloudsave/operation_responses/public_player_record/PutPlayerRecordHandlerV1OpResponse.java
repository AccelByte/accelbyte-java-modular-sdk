...
@Getter
@Setter
public class PutPlayerRecordHandlerV1OpResponse extends ApiResponseWithData<ModelsPlayerRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.public_player_record.PutPlayerRecordHandlerV1";
    }
}