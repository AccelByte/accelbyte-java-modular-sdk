...
public class AdminPostGameBinaryRecordV1 extends Operation {
  ...
  public AdminPostGameBinaryRecordV1(
      String customBasePath, String namespace, ModelsGameBinaryRecordCreate body) {
  ...
  public AdminPostGameBinaryRecordV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminPostGameBinaryRecordV1OpResponse response =
        new AdminPostGameBinaryRecordV1OpResponse();
