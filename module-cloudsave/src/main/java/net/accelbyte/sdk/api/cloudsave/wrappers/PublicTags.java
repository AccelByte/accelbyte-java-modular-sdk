...
import net.accelbyte.sdk.api.cloudsave.operation_responses.public_tags.*;
...
public class PublicTags {
     ...
     */
    public PublicListTagsHandlerV1OpResponse publicListTagsHandlerV1(PublicListTagsHandlerV1 input) throws Exception {
