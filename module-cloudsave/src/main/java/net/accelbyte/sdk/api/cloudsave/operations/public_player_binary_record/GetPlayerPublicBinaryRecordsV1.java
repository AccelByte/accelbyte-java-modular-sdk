...
import net.accelbyte.sdk.api.cloudsave.operation_responses.public_player_binary_record.GetPlayerPublicBinaryRecordsV1OpResponse;
...
public class GetPlayerPublicBinaryRecordsV1 extends Operation {
    ...
    */
    ...
    public GetPlayerPublicBinaryRecordsV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetPlayerPublicBinaryRecordsV1OpResponse response = new GetPlayerPublicBinaryRecordsV1OpResponse();
