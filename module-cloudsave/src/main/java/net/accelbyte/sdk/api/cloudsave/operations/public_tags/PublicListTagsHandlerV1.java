...
public class PublicListTagsHandlerV1 extends Operation {
    ...
    */
    ...
    public PublicListTagsHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicListTagsHandlerV1OpResponse response = new PublicListTagsHandlerV1OpResponse();
