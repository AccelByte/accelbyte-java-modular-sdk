...
public class AdminPutPlayerRecordConcurrentHandlerV1 extends Operation {
  ...
  public AdminPutPlayerRecordConcurrentHandlerV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminPutPlayerRecordConcurrentHandlerV1OpResponse response =
        new AdminPutPlayerRecordConcurrentHandlerV1OpResponse();
