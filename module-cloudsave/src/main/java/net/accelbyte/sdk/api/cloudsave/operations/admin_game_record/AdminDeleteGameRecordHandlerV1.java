...
public class AdminDeleteGameRecordHandlerV1 extends Operation {
    ...
    */
    ...
    public AdminDeleteGameRecordHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDeleteGameRecordHandlerV1OpResponse response = new AdminDeleteGameRecordHandlerV1OpResponse();
