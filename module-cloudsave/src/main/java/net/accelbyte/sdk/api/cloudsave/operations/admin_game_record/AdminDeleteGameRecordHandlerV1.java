...
public class AdminDeleteGameRecordHandlerV1 extends Operation {
  ...
  @Deprecated
  public AdminDeleteGameRecordHandlerV1(String customBasePath, String key, String namespace) {
    this.key = key;
  ...
  public AdminDeleteGameRecordHandlerV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminDeleteGameRecordHandlerV1OpResponse response =
        new AdminDeleteGameRecordHandlerV1OpResponse();
