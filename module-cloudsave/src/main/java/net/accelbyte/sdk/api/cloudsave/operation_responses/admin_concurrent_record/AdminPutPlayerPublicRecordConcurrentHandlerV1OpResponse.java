...
@Getter
@Setter
public class AdminPutPlayerPublicRecordConcurrentHandlerV1OpResponse extends ApiResponseWithData<ModelsPlayerRecordConcurrentUpdateResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_concurrent_record.AdminPutPlayerPublicRecordConcurrentHandlerV1";
    }
}