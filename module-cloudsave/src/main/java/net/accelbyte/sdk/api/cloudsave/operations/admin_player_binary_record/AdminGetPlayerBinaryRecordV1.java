...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_player_binary_record.AdminGetPlayerBinaryRecordV1OpResponse;
...
public class AdminGetPlayerBinaryRecordV1 extends Operation {
    ...
    */
    ...
    public AdminGetPlayerBinaryRecordV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetPlayerBinaryRecordV1OpResponse response = new AdminGetPlayerBinaryRecordV1OpResponse();
