...
import net.accelbyte.sdk.api.cloudsave.operation_responses.public_game_record.GetGameRecordHandlerV1OpResponse;
...
public class GetGameRecordHandlerV1 extends Operation {
    ...
    */
    ...
    public GetGameRecordHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetGameRecordHandlerV1OpResponse response = new GetGameRecordHandlerV1OpResponse();
