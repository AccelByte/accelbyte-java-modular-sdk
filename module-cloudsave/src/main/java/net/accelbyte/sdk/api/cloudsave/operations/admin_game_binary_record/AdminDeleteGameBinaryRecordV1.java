...
public class AdminDeleteGameBinaryRecordV1 extends Operation {
    ...
    */
    ...
    public AdminDeleteGameBinaryRecordV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDeleteGameBinaryRecordV1OpResponse response = new AdminDeleteGameBinaryRecordV1OpResponse();
