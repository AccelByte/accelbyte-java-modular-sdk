...
public class AdminDeleteGameBinaryRecordV1 extends Operation {
  ...
  @Deprecated
  public AdminDeleteGameBinaryRecordV1(String customBasePath, String key, String namespace) {
    this.key = key;
  ...
  public AdminDeleteGameBinaryRecordV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminDeleteGameBinaryRecordV1OpResponse response =
        new AdminDeleteGameBinaryRecordV1OpResponse();
