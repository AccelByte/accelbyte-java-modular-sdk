...
import net.accelbyte.sdk.api.cloudsave.operation_responses.admin_player_record.AdminGetPlayerRecordHandlerV1OpResponse;
...
public class AdminGetPlayerRecordHandlerV1 extends Operation {
    ...
    */
    ...
    public AdminGetPlayerRecordHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetPlayerRecordHandlerV1OpResponse response = new AdminGetPlayerRecordHandlerV1OpResponse();
