...
public class PutGameRecordConcurrentHandlerV1 extends Operation {
    ...
    */
    ...
    public PutGameRecordConcurrentHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PutGameRecordConcurrentHandlerV1OpResponse response = new PutGameRecordConcurrentHandlerV1OpResponse();
