...
public class PutPlayerRecordHandlerV1 extends Operation {
    ...
    */
    ...
    public PutPlayerRecordHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PutPlayerRecordHandlerV1OpResponse response = new PutPlayerRecordHandlerV1OpResponse();
