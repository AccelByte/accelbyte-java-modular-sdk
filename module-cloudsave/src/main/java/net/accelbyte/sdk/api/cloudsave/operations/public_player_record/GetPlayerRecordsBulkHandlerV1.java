...
public class GetPlayerRecordsBulkHandlerV1 extends Operation {
    ...
    */
    ...
    public GetPlayerRecordsBulkHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetPlayerRecordsBulkHandlerV1OpResponse response = new GetPlayerRecordsBulkHandlerV1OpResponse();
