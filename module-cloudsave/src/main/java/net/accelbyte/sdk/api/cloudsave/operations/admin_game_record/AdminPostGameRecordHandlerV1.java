...
public class AdminPostGameRecordHandlerV1 extends Operation {
    ...
    */
    ...
    public AdminPostGameRecordHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminPostGameRecordHandlerV1OpResponse response = new AdminPostGameRecordHandlerV1OpResponse();
