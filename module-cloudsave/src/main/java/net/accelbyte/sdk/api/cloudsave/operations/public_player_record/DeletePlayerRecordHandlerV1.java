...
public class DeletePlayerRecordHandlerV1 extends Operation {
    ...
    */
    ...
    public DeletePlayerRecordHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeletePlayerRecordHandlerV1OpResponse response = new DeletePlayerRecordHandlerV1OpResponse();
