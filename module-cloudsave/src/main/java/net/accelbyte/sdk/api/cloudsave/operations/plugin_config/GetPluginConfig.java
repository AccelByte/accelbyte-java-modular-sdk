...
public class GetPluginConfig extends Operation {
  ...
  @Deprecated
  public GetPluginConfig(String customBasePath, String namespace) {
  ...
  public GetPluginConfigOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetPluginConfigOpResponse response = new GetPluginConfigOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ModelsPluginResponse().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 401) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public ModelsPluginResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
