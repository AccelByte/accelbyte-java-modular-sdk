...
public class AdminPostGameBinaryPresignedURLV1 extends Operation {
  ...
  public AdminPostGameBinaryPresignedURLV1(
      String customBasePath, String key, String namespace, ModelsUploadBinaryRecordRequest body) {
    this.key = key;
  ...
  public AdminPostGameBinaryPresignedURLV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminPostGameBinaryPresignedURLV1OpResponse response =
        new AdminPostGameBinaryPresignedURLV1OpResponse();
