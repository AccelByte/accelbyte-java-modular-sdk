...
public class PutGameBinaryRecordV1 extends Operation {
    ...
    */
    ...
    public PutGameBinaryRecordV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PutGameBinaryRecordV1OpResponse response = new PutGameBinaryRecordV1OpResponse();
