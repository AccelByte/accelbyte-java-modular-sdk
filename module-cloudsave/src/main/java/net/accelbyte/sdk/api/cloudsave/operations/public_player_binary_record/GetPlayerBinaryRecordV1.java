...
import net.accelbyte.sdk.api.cloudsave.operation_responses.public_player_binary_record.GetPlayerBinaryRecordV1OpResponse;
...
public class GetPlayerBinaryRecordV1 extends Operation {
    ...
    */
    ...
    public GetPlayerBinaryRecordV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetPlayerBinaryRecordV1OpResponse response = new GetPlayerBinaryRecordV1OpResponse();
