...
public class ConcurrentRecord {
   ...
   */
  public PutGameRecordConcurrentHandlerV1OpResponse putGameRecordConcurrentHandlerV1(
      PutGameRecordConcurrentHandlerV1 input) throws Exception {
   ...
   */
  public PutPlayerRecordConcurrentHandlerV1OpResponse putPlayerRecordConcurrentHandlerV1(
   ...
   */
  public PutPlayerPublicRecordConcurrentHandlerV1OpResponse
      putPlayerPublicRecordConcurrentHandlerV1(PutPlayerPublicRecordConcurrentHandlerV1 input)
          throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
