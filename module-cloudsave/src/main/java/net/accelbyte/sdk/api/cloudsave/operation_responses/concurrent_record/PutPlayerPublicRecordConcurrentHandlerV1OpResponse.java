...
@Getter
@Setter
public class PutPlayerPublicRecordConcurrentHandlerV1OpResponse extends ApiResponseWithData<ModelsPlayerRecordConcurrentUpdateResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.concurrent_record.PutPlayerPublicRecordConcurrentHandlerV1";
    }
}