...
public class ModelsAdminGameRecordResponse extends Model {
    ...
    @JsonIgnore
    public List<ModelsAdminGameRecordResponse> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelsAdminGameRecordResponse>>() {});
    }
