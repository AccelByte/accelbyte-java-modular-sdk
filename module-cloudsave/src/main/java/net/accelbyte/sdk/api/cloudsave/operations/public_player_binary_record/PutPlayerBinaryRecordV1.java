...
import net.accelbyte.sdk.api.cloudsave.operation_responses.public_player_binary_record.PutPlayerBinaryRecordV1OpResponse;
...
public class PutPlayerBinaryRecordV1 extends Operation {
    ...
    */
    ...
    public PutPlayerBinaryRecordV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PutPlayerBinaryRecordV1OpResponse response = new PutPlayerBinaryRecordV1OpResponse();
