...
@Getter
@Setter
public class AdminPutAdminGameRecordV1OpResponse extends ApiResponseWithData<ModelsAdminGameRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_record.AdminPutAdminGameRecordV1";
    }
}