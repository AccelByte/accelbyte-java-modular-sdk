...
public class AdminPostPlayerPublicRecordHandlerV1 extends Operation {
  ...
  public AdminPostPlayerPublicRecordHandlerV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminPostPlayerPublicRecordHandlerV1OpResponse response =
        new AdminPostPlayerPublicRecordHandlerV1OpResponse();
