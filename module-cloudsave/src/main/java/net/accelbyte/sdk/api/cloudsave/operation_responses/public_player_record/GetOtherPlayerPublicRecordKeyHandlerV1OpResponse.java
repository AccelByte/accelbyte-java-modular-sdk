...
@Getter
@Setter
public class GetOtherPlayerPublicRecordKeyHandlerV1OpResponse extends ApiResponseWithData<ModelsListPlayerRecordKeysResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.public_player_record.GetOtherPlayerPublicRecordKeyHandlerV1";
    }
}