...
public class DeleteGameRecordTTLConfig extends Operation {
    ...
    */
    ...
    public DeleteGameRecordTTLConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteGameRecordTTLConfigOpResponse response = new DeleteGameRecordTTLConfigOpResponse();
