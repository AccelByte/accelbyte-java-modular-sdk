...
@Getter
@Setter
public class AdminPostGameBinaryRecordV1OpResponse extends ApiResponseWithData<ModelsUploadBinaryRecordResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.cloudsave.operations.admin_game_binary_record.AdminPostGameBinaryRecordV1";
    }
}