...
public class GetOtherPlayerPublicRecordHandlerV1 extends Operation {
    ...
    */
    ...
    public GetOtherPlayerPublicRecordHandlerV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetOtherPlayerPublicRecordHandlerV1OpResponse response = new GetOtherPlayerPublicRecordHandlerV1OpResponse();
