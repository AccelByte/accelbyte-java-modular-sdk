...
public class AdminGeneratePersonalDataURL extends Operation {
    ...
    */
    ...
    public AdminGeneratePersonalDataURLOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGeneratePersonalDataURLOpResponse response = new AdminGeneratePersonalDataURLOpResponse();
