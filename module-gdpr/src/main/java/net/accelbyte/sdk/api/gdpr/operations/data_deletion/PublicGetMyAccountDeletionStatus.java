...
public class PublicGetMyAccountDeletionStatus extends Operation {
    ...
    */
    ...
    public PublicGetMyAccountDeletionStatusOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetMyAccountDeletionStatusOpResponse response = new PublicGetMyAccountDeletionStatusOpResponse();
