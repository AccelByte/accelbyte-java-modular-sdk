...
public class DataDeletion {
   ...
   */
  public AdminGetListDeletionDataRequestOpResponse adminGetListDeletionDataRequest(
   ...
   */
  public AdminGetUserAccountDeletionRequestOpResponse adminGetUserAccountDeletionRequest(
   ...
   */
  public AdminSubmitUserAccountDeletionRequestOpResponse adminSubmitUserAccountDeletionRequest(
   ...
   */
  public AdminCancelUserAccountDeletionRequestOpResponse adminCancelUserAccountDeletionRequest(
      AdminCancelUserAccountDeletionRequest input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public PublicSubmitUserAccountDeletionRequestOpResponse publicSubmitUserAccountDeletionRequest(
   ...
   */
  public PublicCancelUserAccountDeletionRequestOpResponse publicCancelUserAccountDeletionRequest(
      PublicCancelUserAccountDeletionRequest input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public PublicGetUserAccountDeletionStatusOpResponse publicGetUserAccountDeletionStatus(
