...
public class UpdateAdminEmailConfiguration extends Operation {
    ...
    */
    ...
    public UpdateAdminEmailConfigurationOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateAdminEmailConfigurationOpResponse response = new UpdateAdminEmailConfigurationOpResponse();
