...
public class PublicGetUserAccountDeletionStatus extends Operation {
  ...
  public PublicGetUserAccountDeletionStatusOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGetUserAccountDeletionStatusOpResponse response =
        new PublicGetUserAccountDeletionStatusOpResponse();
