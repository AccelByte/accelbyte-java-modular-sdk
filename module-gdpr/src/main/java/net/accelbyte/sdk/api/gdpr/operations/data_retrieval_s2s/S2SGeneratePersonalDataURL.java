...
public class S2SGeneratePersonalDataURL extends Operation {
  ...
  public S2SGeneratePersonalDataURL(
      String customBasePath, String namespace, String requestDate, String userId) {
  ...
  public S2SGeneratePersonalDataURLOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final S2SGeneratePersonalDataURLOpResponse response =
        new S2SGeneratePersonalDataURLOpResponse();
