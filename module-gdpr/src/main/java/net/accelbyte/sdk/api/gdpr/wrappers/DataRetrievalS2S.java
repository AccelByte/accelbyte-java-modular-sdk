...
public class DataRetrievalS2S {
     ...
     */
    public S2SGetListFinishedPersonalDataRequestOpResponse s2sGetListFinishedPersonalDataRequest(S2SGetListFinishedPersonalDataRequest input) throws Exception {
     ...
     */
    public S2SGetDataRequestByRequestIDOpResponse s2sGetDataRequestByRequestID(S2SGetDataRequestByRequestID input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public S2SRequestDataRetrievalOpResponse s2sRequestDataRetrieval(S2SRequestDataRetrieval input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public S2SGeneratePersonalDataURLOpResponse s2sGeneratePersonalDataURL(S2SGeneratePersonalDataURL input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
