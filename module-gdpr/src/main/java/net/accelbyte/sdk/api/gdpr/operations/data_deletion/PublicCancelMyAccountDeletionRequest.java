...
public class PublicCancelMyAccountDeletionRequest extends Operation {
    ...
    */
    ...
    public PublicCancelMyAccountDeletionRequestOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicCancelMyAccountDeletionRequestOpResponse response = new PublicCancelMyAccountDeletionRequestOpResponse();
