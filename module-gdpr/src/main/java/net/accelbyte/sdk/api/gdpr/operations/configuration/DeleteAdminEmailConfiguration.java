...
public class DeleteAdminEmailConfiguration extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("emails", this.emails == null ? null : this.emails.stream().map(i -> String.valueOf(i)).collect(java.util.stream.Collectors.toList()));
        return queryParams;
    }
    ...
    public DeleteAdminEmailConfigurationOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteAdminEmailConfigurationOpResponse response = new DeleteAdminEmailConfigurationOpResponse();
