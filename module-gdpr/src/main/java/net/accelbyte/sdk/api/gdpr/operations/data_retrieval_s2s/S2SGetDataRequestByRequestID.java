...
public class S2SGetDataRequestByRequestID extends Operation {
  ...
  @Deprecated
  public S2SGetDataRequestByRequestID(String customBasePath, String namespace, String requestId) {
  ...
  public S2SGetDataRequestByRequestIDOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final S2SGetDataRequestByRequestIDOpResponse response =
        new S2SGetDataRequestByRequestIDOpResponse();
