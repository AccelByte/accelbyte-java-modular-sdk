...
public class PublicCancelUserPersonalDataRequest extends Operation {
  ...
  public PublicCancelUserPersonalDataRequestOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicCancelUserPersonalDataRequestOpResponse response =
        new PublicCancelUserPersonalDataRequestOpResponse();
