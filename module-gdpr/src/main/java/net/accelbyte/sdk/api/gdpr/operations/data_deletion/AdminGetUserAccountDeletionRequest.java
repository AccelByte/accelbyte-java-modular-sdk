...
public class AdminGetUserAccountDeletionRequest extends Operation {
  ...
  public AdminGetUserAccountDeletionRequestOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetUserAccountDeletionRequestOpResponse response =
        new AdminGetUserAccountDeletionRequestOpResponse();
