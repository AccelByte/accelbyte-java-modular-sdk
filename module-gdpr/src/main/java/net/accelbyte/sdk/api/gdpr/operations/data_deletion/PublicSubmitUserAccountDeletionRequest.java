...
public class PublicSubmitUserAccountDeletionRequest extends Operation {
  ...
  public PublicSubmitUserAccountDeletionRequestOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicSubmitUserAccountDeletionRequestOpResponse response =
        new PublicSubmitUserAccountDeletionRequestOpResponse();
