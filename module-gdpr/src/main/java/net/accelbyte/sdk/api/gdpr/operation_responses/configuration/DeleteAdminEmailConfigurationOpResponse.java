...
@Getter
@Setter
public class DeleteAdminEmailConfigurationOpResponse extends ApiResponse {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.gdpr.operations.configuration.DeleteAdminEmailConfiguration";
  }
}
