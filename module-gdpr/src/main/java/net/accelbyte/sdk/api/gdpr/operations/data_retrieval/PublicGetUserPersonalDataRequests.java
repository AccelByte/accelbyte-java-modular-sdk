...
public class PublicGetUserPersonalDataRequests extends Operation {
  ...
  public PublicGetUserPersonalDataRequestsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGetUserPersonalDataRequestsOpResponse response =
        new PublicGetUserPersonalDataRequestsOpResponse();
