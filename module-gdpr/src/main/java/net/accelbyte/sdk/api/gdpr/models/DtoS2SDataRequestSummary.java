...
public class DtoS2SDataRequestSummary extends Model {
    ...
    @JsonIgnore
    public List<DtoS2SDataRequestSummary> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<DtoS2SDataRequestSummary>>() {});
    }
