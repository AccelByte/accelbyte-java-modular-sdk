...
public class PublicGeneratePersonalDataURL extends Operation {
  ...
  public PublicGeneratePersonalDataURLOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGeneratePersonalDataURLOpResponse response =
        new PublicGeneratePersonalDataURLOpResponse();
