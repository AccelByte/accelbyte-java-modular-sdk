...
import net.accelbyte.sdk.api.gdpr.operation_responses.data_retrieval.PublicGeneratePersonalDataURLOpResponse;
...
public class PublicGeneratePersonalDataURL extends Operation {
    ...
    */
    ...
    public PublicGeneratePersonalDataURLOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGeneratePersonalDataURLOpResponse response = new PublicGeneratePersonalDataURLOpResponse();
