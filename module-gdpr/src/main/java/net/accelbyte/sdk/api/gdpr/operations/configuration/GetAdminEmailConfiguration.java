...
import net.accelbyte.sdk.api.gdpr.operation_responses.configuration.GetAdminEmailConfigurationOpResponse;
...
public class GetAdminEmailConfiguration extends Operation {
    ...
    */
    ...
    public GetAdminEmailConfigurationOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetAdminEmailConfigurationOpResponse response = new GetAdminEmailConfigurationOpResponse();
