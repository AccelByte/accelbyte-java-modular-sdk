...
public class GetAdminEmailConfiguration extends Operation {
  ...
  @Deprecated
  public GetAdminEmailConfiguration(String customBasePath, String namespace) {
  ...
  public GetAdminEmailConfigurationOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetAdminEmailConfigurationOpResponse response =
        new GetAdminEmailConfigurationOpResponse();
