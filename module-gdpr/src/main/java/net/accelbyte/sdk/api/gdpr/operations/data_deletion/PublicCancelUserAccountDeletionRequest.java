...
public class PublicCancelUserAccountDeletionRequest extends Operation {
    ...
    */
    ...
    public PublicCancelUserAccountDeletionRequestOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicCancelUserAccountDeletionRequestOpResponse response = new PublicCancelUserAccountDeletionRequestOpResponse();
