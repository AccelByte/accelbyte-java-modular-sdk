...
import net.accelbyte.sdk.api.gdpr.operation_responses.data_retrieval_s2s.S2SGetListFinishedPersonalDataRequestOpResponse;
...
public class S2SGetListFinishedPersonalDataRequest extends Operation {
    ...
    */
    ...
    public S2SGetListFinishedPersonalDataRequestOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final S2SGetListFinishedPersonalDataRequestOpResponse response = new S2SGetListFinishedPersonalDataRequestOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new DtoListFinishedDataRequests().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public DtoListFinishedDataRequests parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
