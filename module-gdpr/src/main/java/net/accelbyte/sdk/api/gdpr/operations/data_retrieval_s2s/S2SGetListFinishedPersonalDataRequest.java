...
public class S2SGetListFinishedPersonalDataRequest extends Operation {
  ...
  public S2SGetListFinishedPersonalDataRequest(
      String customBasePath, String namespace, String end, String start) {
  ...
  public S2SGetListFinishedPersonalDataRequestOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final S2SGetListFinishedPersonalDataRequestOpResponse response =
        new S2SGetListFinishedPersonalDataRequestOpResponse();
