...
public class PlatformAccountClosureClient {
     ...
     */
    public AdminGetPlatformAccountClosureClientOpResponse adminGetPlatformAccountClosureClient(AdminGetPlatformAccountClosureClient input) throws Exception {
     ...
     */
    public AdminUpdatePlatformAccountClosureClientOpResponse adminUpdatePlatformAccountClosureClient(AdminUpdatePlatformAccountClosureClient input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public AdminDeletePlatformAccountClosureClientOpResponse adminDeletePlatformAccountClosureClient(AdminDeletePlatformAccountClosureClient input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
