...
public class AdminSubmitUserAccountDeletionRequest extends Operation {
  ...
  public AdminSubmitUserAccountDeletionRequestOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminSubmitUserAccountDeletionRequestOpResponse response =
        new AdminSubmitUserAccountDeletionRequestOpResponse();
