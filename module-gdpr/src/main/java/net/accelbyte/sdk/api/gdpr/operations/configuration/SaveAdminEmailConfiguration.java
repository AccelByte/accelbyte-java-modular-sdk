...
public class SaveAdminEmailConfiguration extends Operation {
    ...
    */
    ...
    public SaveAdminEmailConfigurationOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SaveAdminEmailConfigurationOpResponse response = new SaveAdminEmailConfigurationOpResponse();
