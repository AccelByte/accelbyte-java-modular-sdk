...
public class AdminCancelUserAccountDeletionRequest extends Operation {
  ...
  public AdminCancelUserAccountDeletionRequestOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminCancelUserAccountDeletionRequestOpResponse response =
        new AdminCancelUserAccountDeletionRequestOpResponse();
