...
public class DataDeletionS2S {
   ...
   */
  public S2SGetListFinishedAccountDeletionRequestOpResponse
      s2sGetListFinishedAccountDeletionRequest(S2SGetListFinishedAccountDeletionRequest input)
          throws Exception {
   ...
   */
  public S2SSubmitUserAccountDeletionRequestOpResponse s2sSubmitUserAccountDeletionRequest(
