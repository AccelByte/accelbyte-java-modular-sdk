...
import net.accelbyte.sdk.api.gdpr.operation_responses.data_retrieval.PublicRequestDataRetrievalOpResponse;
...
public class PublicRequestDataRetrieval extends Operation {
    ...
    */
    ...
    public PublicRequestDataRetrievalOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicRequestDataRetrievalOpResponse response = new PublicRequestDataRetrievalOpResponse();
