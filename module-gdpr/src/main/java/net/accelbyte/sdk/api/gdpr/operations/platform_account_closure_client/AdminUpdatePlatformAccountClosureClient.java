...
public class AdminUpdatePlatformAccountClosureClient extends Operation {
  ...
  public AdminUpdatePlatformAccountClosureClientOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminUpdatePlatformAccountClosureClientOpResponse response =
        new AdminUpdatePlatformAccountClosureClientOpResponse();
