...
@Getter
@Setter
public class ArtifactGetOpResponse extends ApiResponseWithData<ApiArtifactListResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.ams.operations.artifacts.ArtifactGet";
    }
}