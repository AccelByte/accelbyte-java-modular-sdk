...
public class ApiImageDeploymentProfile extends Model {
    ...
    @JsonIgnore
    public List<ApiImageDeploymentProfile> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ApiImageDeploymentProfile>>() {});
    }
