...
public class Development {
   ...
   */
  public DevelopmentServerConfigurationListOpResponse developmentServerConfigurationList(
   ...
   */
  public DevelopmentServerConfigurationCreateOpResponse developmentServerConfigurationCreate(
   ...
   */
  public DevelopmentServerConfigurationGetOpResponse developmentServerConfigurationGet(
   ...
   */
  public DevelopmentServerConfigurationDeleteOpResponse developmentServerConfigurationDelete(
      DevelopmentServerConfigurationDelete input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
