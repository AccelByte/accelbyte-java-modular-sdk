...
public class FleetDelete extends Operation {
  ...
  @Deprecated
  public FleetDelete(String customBasePath, String fleetID, String namespace) {
  ...
  public FleetDeleteOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final FleetDeleteOpResponse response = new FleetDeleteOpResponse();
