...
@Getter
@Setter
public class AdminAccountCreateOpResponse extends ApiResponseWithData<ApiAccountCreateResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.ams.operations.account.AdminAccountCreate";
  }
}
