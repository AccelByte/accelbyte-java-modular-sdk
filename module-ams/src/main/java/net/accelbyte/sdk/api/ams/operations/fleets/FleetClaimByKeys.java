...
public class FleetClaimByKeys extends Operation {
  ...
  public FleetClaimByKeysOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final FleetClaimByKeysOpResponse response = new FleetClaimByKeysOpResponse();
