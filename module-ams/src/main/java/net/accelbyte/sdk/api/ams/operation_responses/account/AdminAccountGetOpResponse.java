...
@Getter
@Setter
public class AdminAccountGetOpResponse extends ApiResponseWithData<ApiAccountResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.ams.operations.account.AdminAccountGet";
  }
}
