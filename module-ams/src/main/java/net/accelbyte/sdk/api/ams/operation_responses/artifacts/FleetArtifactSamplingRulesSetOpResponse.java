...
@Getter
@Setter
public class FleetArtifactSamplingRulesSetOpResponse extends ApiResponseWithData<ApiFleetArtifactsSampleRules> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.ams.operations.artifacts.FleetArtifactSamplingRulesSet";
    }
}