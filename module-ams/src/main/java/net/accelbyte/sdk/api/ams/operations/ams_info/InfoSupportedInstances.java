...
import net.accelbyte.sdk.api.ams.operation_responses.ams_info.InfoSupportedInstancesOpResponse;
...
public class InfoSupportedInstances extends Operation {
    ...
    */
    ...
    public InfoSupportedInstancesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final InfoSupportedInstancesOpResponse response = new InfoSupportedInstancesOpResponse();
