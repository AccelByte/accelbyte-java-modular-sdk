...
public class AdminAccountLink extends Operation {
  ...
  @Deprecated
  public AdminAccountLink(String customBasePath, String namespace, ApiAccountLinkRequest body) {
  ...
  public AdminAccountLinkOpResponse parseResponse(int code, String contentType, InputStream payload)
