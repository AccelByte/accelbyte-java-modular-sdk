...
import net.accelbyte.sdk.api.ams.operation_responses.images.ImageListOpResponse;
...
public class ImageList extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("isProtected", this.isProtected == null ? null : Arrays.asList(String.valueOf(this.isProtected)));
    ...
    public ImageListOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ImageListOpResponse response = new ImageListOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApiImageList().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 401) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ApiImageList parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
