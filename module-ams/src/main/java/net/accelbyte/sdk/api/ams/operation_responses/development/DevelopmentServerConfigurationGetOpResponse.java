...
@Getter
@Setter
public class DevelopmentServerConfigurationGetOpResponse extends ApiResponseWithData<ApiDevelopmentServerConfigurationGetResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.ams.operations.development.DevelopmentServerConfigurationGet";
    }
}