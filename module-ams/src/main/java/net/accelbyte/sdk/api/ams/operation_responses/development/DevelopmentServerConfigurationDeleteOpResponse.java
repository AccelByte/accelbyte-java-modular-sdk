...
@Getter
@Setter
public class DevelopmentServerConfigurationDeleteOpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.ams.operations.development.DevelopmentServerConfigurationDelete";
    }
}