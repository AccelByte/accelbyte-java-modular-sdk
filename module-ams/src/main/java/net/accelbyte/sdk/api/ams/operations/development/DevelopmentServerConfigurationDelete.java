...
public class DevelopmentServerConfigurationDelete extends Operation {
    ...
    */
    ...
    public DevelopmentServerConfigurationDeleteOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DevelopmentServerConfigurationDeleteOpResponse response = new DevelopmentServerConfigurationDeleteOpResponse();
