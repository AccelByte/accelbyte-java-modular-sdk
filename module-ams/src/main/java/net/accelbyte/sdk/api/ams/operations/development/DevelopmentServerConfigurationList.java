...
public class DevelopmentServerConfigurationList extends Operation {
    ...
    */
    ...
    public DevelopmentServerConfigurationListOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DevelopmentServerConfigurationListOpResponse response = new DevelopmentServerConfigurationListOpResponse();
