...
public class ApiArtifactUsageResponse extends Model {
    ...
    @JsonIgnore
    public List<ApiArtifactUsageResponse> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ApiArtifactUsageResponse>>() {});
    }
