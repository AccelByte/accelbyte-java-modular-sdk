...
import net.accelbyte.sdk.api.ams.operation_responses.images.ImagePatchOpResponse;
...
public class ImagePatch extends Operation {
  ...
  @Deprecated
  public ImagePatch(String customBasePath, String imageID, String namespace, ApiImageUpdate body) {
  ...
  public ImagePatchOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final ImagePatchOpResponse response = new ImagePatchOpResponse();
