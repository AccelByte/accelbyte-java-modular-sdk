...
public class Account {
     ...
     */
    public AdminAccountCreateOpResponse adminAccountCreate(AdminAccountCreate input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public AdminAccountLinkTokenGetOpResponse adminAccountLinkTokenGet(AdminAccountLinkTokenGet input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
