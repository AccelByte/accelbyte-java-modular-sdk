...
public class FleetArtifactSamplingRulesSet extends Operation {
     ...
     */
    private String path = "/ams/v1/admin/namespaces/{namespace}/fleets/{fleetID}/artifacts-sampling-rules";
    ...
    */
    ...
    public FleetArtifactSamplingRulesSetOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final FleetArtifactSamplingRulesSetOpResponse response = new FleetArtifactSamplingRulesSetOpResponse();
