...
public class AdminAccountGet extends Operation {
  ...
  @Deprecated
  public AdminAccountGet(String customBasePath, String namespace) {
  ...
  public AdminAccountGetOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final AdminAccountGetOpResponse response = new AdminAccountGetOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ApiAccountResponse().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 401) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public ApiAccountResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
