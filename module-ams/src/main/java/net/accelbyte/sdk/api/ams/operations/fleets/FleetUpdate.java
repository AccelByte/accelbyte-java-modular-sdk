...
public class FleetUpdate extends Operation {
  ...
  @Deprecated
  public FleetUpdate(
      String customBasePath, String fleetID, String namespace, ApiFleetParameters body) {
  ...
  public FleetUpdateOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final FleetUpdateOpResponse response = new FleetUpdateOpResponse();
