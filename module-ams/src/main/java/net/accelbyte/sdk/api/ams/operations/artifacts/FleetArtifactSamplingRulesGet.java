...
public class FleetArtifactSamplingRulesGet extends Operation {
    ...
    */
    ...
    public FleetArtifactSamplingRulesGetOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final FleetArtifactSamplingRulesGetOpResponse response = new FleetArtifactSamplingRulesGetOpResponse();
