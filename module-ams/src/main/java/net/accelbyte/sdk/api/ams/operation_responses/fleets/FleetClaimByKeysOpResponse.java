...
@Getter
@Setter
public class FleetClaimByKeysOpResponse extends ApiResponseWithData<ApiFleetClaimResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.ams.operations.fleets.FleetClaimByKeys";
    }
}