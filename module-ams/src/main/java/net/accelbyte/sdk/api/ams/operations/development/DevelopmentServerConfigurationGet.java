...
public class DevelopmentServerConfigurationGet extends Operation {
  ...
  public DevelopmentServerConfigurationGetOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final DevelopmentServerConfigurationGetOpResponse response =
        new DevelopmentServerConfigurationGetOpResponse();
