...
public class FleetClaimByID extends Operation {
    ...
    */
    ...
    public FleetClaimByIDOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final FleetClaimByIDOpResponse response = new FleetClaimByIDOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApiFleetClaimResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
