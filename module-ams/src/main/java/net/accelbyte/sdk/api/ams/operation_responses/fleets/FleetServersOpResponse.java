...
@Getter
@Setter
public class FleetServersOpResponse extends ApiResponseWithData<ApiFleetServersResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.ams.operations.fleets.FleetServers";
    }
}