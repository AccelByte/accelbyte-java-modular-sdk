...
public class FleetServerInfo extends Operation {
    ...
    */
    ...
    public FleetServerInfoOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final FleetServerInfoOpResponse response = new FleetServerInfoOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApiFleetServerInfoResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 401) {
            final String json = Helper.convertInputStreamToString(payload);
