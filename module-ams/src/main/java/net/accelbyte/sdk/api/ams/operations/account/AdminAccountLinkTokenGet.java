...
public class AdminAccountLinkTokenGet extends Operation {
    ...
    */
    ...
    public AdminAccountLinkTokenGetOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminAccountLinkTokenGetOpResponse response = new AdminAccountLinkTokenGetOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApiAccountLinkTokenResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 401) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ApiAccountLinkTokenResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
