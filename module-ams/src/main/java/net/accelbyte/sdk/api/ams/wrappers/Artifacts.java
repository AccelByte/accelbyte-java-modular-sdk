...
public class Artifacts {
   ...
   */
  public ArtifactBulkDeleteOpResponse artifactBulkDelete(ArtifactBulkDelete input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public FleetArtifactSamplingRulesGetOpResponse fleetArtifactSamplingRulesGet(
   ...
   */
  public FleetArtifactSamplingRulesSetOpResponse fleetArtifactSamplingRulesSet(
