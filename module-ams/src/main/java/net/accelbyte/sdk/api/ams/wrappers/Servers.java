...
public class Servers {
     ...
     */
    public FleetServerHistoryOpResponse fleetServerHistory(FleetServerHistory input) throws Exception {
     ...
     */
    public FleetServerConnectionInfoOpResponse fleetServerConnectionInfo(FleetServerConnectionInfo input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
