...
public class AccountGet extends Operation {
  ...
  @Deprecated
  public AccountGet(String customBasePath, String namespace) {
  ...
  public AccountGetOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final AccountGetOpResponse response = new AccountGetOpResponse();
