...
public class ImagesStorage extends Operation {
  ...
  @Deprecated
  public ImagesStorage(String customBasePath, String namespace) {
  ...
  public ImagesStorageOpResponse parseResponse(int code, String contentType, InputStream payload)
