...
@Getter
@Setter
public class FleetClaimByIDOpResponse extends ApiResponseWithData<ApiFleetClaimResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.ams.operations.fleets.FleetClaimByID";
  }
}
