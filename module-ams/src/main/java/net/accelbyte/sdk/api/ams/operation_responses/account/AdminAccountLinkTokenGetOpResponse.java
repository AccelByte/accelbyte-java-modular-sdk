...
@Getter
@Setter
public class AdminAccountLinkTokenGetOpResponse extends ApiResponseWithData<ApiAccountLinkTokenResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.ams.operations.account.AdminAccountLinkTokenGet";
    }
}