...
public class Images {
     ...
     */
    public ImageMarkForDeletionOpResponse imageMarkForDeletion(ImageMarkForDeletion input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public ImageUnmarkForDeletionOpResponse imageUnmarkForDeletion(ImageUnmarkForDeletion input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
