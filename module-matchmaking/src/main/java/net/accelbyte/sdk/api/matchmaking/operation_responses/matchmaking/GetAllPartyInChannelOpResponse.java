...
@Getter
@Setter
public class GetAllPartyInChannelOpResponse extends ApiResponseWithData<List<ModelsMatchingParty>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.matchmaking.operations.matchmaking.GetAllPartyInChannel";
    }
}