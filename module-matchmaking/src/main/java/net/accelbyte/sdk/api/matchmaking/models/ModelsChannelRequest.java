...
public class ModelsChannelRequest extends Model {
    ...
    public static class ModelsChannelRequestBuilder {
        ...
        public ModelsChannelRequestBuilder blockedPlayerOptionFromEnum(final BlockedPlayerOption blockedPlayerOption) {
            this.blockedPlayerOption = blockedPlayerOption.toString();
            return this;
        }
        ...
        public ModelsChannelRequestBuilder subGamemodeSelectionFromEnum(final SubGamemodeSelection subGamemodeSelection) {
            this.subGamemodeSelection = subGamemodeSelection.toString();
            return this;
        }
    }
