...
@Getter
@Setter
public class ImportChannelsOpResponse extends ApiResponseWithData<ModelsImportConfigResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.matchmaking.operations.matchmaking.ImportChannels";
  }
}
