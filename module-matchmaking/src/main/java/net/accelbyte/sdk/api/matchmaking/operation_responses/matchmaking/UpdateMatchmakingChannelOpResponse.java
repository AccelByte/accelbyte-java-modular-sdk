...
@Getter
@Setter
public class UpdateMatchmakingChannelOpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.matchmaking.operations.matchmaking.UpdateMatchmakingChannel";
    }
}