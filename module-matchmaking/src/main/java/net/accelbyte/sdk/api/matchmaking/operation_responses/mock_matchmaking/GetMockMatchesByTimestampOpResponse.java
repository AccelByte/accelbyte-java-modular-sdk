...
@Getter
@Setter
public class GetMockMatchesByTimestampOpResponse extends ApiResponseWithData<ModelsGetMockMatchesResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.matchmaking.operations.mock_matchmaking.GetMockMatchesByTimestamp";
    }
}