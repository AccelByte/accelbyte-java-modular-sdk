...
@Getter
@Setter
public class SearchSessionsOpResponse extends ApiResponseWithData<ServiceGetSessionHistorySearchResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.matchmaking.operations.matchmaking.SearchSessions";
    }
}