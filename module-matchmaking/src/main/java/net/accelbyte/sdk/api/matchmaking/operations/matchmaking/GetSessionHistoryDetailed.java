...
import net.accelbyte.sdk.api.matchmaking.operation_responses.matchmaking.GetSessionHistoryDetailedOpResponse;
...
public class GetSessionHistoryDetailed extends Operation {
  ...
  public GetSessionHistoryDetailedOpResponse parseResponse(
    ...
    if (code == 204) {
      ...
      response.setData(
          new ObjectMapper()
              .readValue(
                  json,
                  new TypeReference<List<ServiceGetSessionHistoryDetailedResponseItem>>() {}));
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public List<ServiceGetSessionHistoryDetailedResponseItem> parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
