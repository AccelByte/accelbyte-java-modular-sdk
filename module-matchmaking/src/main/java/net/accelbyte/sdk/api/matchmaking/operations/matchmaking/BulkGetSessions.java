...
import net.accelbyte.sdk.api.matchmaking.operation_responses.matchmaking.BulkGetSessionsOpResponse;
...
public class BulkGetSessions extends Operation {
    ...
    */
    ...
    public BulkGetSessionsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final BulkGetSessionsOpResponse response = new BulkGetSessionsOpResponse();
