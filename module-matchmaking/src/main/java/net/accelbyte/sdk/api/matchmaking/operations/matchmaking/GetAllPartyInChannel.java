...
public class GetAllPartyInChannel extends Operation {
  ...
  @Deprecated
  public GetAllPartyInChannel(String customBasePath, String channelName, String namespace) {
  ...
  public GetAllPartyInChannelOpResponse parseResponse(
    ...
    if (code == 204) {
      ...
      response.setSuccess(true);
      response.setData(
          new ObjectMapper().readValue(json, new TypeReference<List<ModelsMatchingParty>>() {}));
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
