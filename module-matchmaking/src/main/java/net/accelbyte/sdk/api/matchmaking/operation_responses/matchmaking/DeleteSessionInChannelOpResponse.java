...
@Getter
@Setter
public class DeleteSessionInChannelOpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.matchmaking.operations.matchmaking.DeleteSessionInChannel";
    }
}