...
public class AddUserIntoSessionInChannel extends Operation {
    ...
    */
    ...
    public AddUserIntoSessionInChannelOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AddUserIntoSessionInChannelOpResponse response = new AddUserIntoSessionInChannelOpResponse();
