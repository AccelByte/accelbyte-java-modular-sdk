...
@Getter
@Setter
public class ExportChannelsOpResponse extends ApiResponseWithData<InputStream> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.matchmaking.operations.matchmaking.ExportChannels";
    }
}