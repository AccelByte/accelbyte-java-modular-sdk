...
@Getter
@Setter
public class GetSessionHistoryDetailedOpResponse extends ApiResponseWithData<List<ServiceGetSessionHistoryDetailedResponseItem>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.matchmaking.operations.matchmaking.GetSessionHistoryDetailed";
    }
}