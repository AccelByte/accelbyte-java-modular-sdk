...
import net.accelbyte.sdk.api.matchmaking.operation_responses.matchmaking.GetAllSessionsInChannelOpResponse;
...
public class GetAllSessionsInChannel extends Operation {
    ...
    */
    ...
    public GetAllSessionsInChannelOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetAllSessionsInChannelOpResponse response = new GetAllSessionsInChannelOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<ModelsMatchmakingResult>>() {}));
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
