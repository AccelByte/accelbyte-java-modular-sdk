...
import net.accelbyte.sdk.api.matchmaking.operation_responses.matchmaking.SearchSessionsOpResponse;
...
public class SearchSessions extends Operation {
    ...
    */
    ...
    public SearchSessionsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SearchSessionsOpResponse response = new SearchSessionsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ServiceGetSessionHistorySearchResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ServiceGetSessionHistorySearchResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
