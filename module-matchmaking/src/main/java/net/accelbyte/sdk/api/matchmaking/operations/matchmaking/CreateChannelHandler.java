...
import net.accelbyte.sdk.api.matchmaking.operation_responses.matchmaking.CreateChannelHandlerOpResponse;
...
public class CreateChannelHandler extends Operation {
    ...
    */
    ...
    public CreateChannelHandlerOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreateChannelHandlerOpResponse response = new CreateChannelHandlerOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsCreateChannelResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsCreateChannelResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 201){
            final String json = Helper.convertInputStreamToString(payload);
