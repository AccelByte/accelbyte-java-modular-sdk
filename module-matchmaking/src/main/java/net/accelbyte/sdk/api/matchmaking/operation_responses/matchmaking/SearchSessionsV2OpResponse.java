...
@Getter
@Setter
public class SearchSessionsV2OpResponse extends ApiResponseWithData<ServiceGetSessionHistorySearchResponseV2> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.matchmaking.operations.matchmaking.SearchSessionsV2";
    }
}