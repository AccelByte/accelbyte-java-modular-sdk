...
@Getter
@Setter
public class GetAllMockTicketsOpResponse extends ApiResponseWithData<ModelsGetMockTicketsResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.matchmaking.operations.mock_matchmaking.GetAllMockTickets";
    }
}