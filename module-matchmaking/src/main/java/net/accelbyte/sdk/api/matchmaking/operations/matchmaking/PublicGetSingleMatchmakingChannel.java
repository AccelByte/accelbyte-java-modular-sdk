...
import net.accelbyte.sdk.api.matchmaking.operation_responses.matchmaking.PublicGetSingleMatchmakingChannelOpResponse;
...
public class PublicGetSingleMatchmakingChannel extends Operation {
    ...
    */
    ...
    public PublicGetSingleMatchmakingChannelOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetSingleMatchmakingChannelOpResponse response = new PublicGetSingleMatchmakingChannelOpResponse();
