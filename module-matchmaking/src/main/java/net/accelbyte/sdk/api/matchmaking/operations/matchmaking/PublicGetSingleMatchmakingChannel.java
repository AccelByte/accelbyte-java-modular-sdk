...
public class PublicGetSingleMatchmakingChannel extends Operation {
  ...
  public PublicGetSingleMatchmakingChannel(
      String customBasePath, String channelName, String namespace) {
  ...
  public PublicGetSingleMatchmakingChannelOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGetSingleMatchmakingChannelOpResponse response =
        new PublicGetSingleMatchmakingChannelOpResponse();
