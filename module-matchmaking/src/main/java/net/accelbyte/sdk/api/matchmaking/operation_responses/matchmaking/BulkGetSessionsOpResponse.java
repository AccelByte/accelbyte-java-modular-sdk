...
@Getter
@Setter
public class BulkGetSessionsOpResponse extends ApiResponseWithData<List<ModelsMatchmakingResult>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.matchmaking.operations.matchmaking.BulkGetSessions";
    }
}