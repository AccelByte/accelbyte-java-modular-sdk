...
@Getter
@Setter
public class GetAllPartyInAllChannelOpResponse extends ApiResponseWithData<Map<String, List<ModelsMatchingParty>>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.matchmaking.operations.matchmaking.GetAllPartyInAllChannel";
    }
}