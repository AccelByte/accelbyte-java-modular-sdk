...
@Getter
@Setter
public class GetAllMockMatchesOpResponse extends ApiResponseWithData<ModelsGetMockMatchesResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.matchmaking.operations.mock_matchmaking.GetAllMockMatches";
  }
}
