...
@Getter
@Setter
public class QuerySessionHandlerOpResponse extends ApiResponseWithData<ModelsMatchmakingResult> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.matchmaking.operations.matchmaking.QuerySessionHandler";
    }
}