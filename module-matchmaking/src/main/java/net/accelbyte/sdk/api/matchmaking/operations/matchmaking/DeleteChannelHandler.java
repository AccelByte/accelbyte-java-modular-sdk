...
public class DeleteChannelHandler extends Operation {
    ...
    */
    ...
    public DeleteChannelHandler(
            String customBasePath,            String channel,
            String namespace
    )
    {
    ...
    public DeleteChannelHandlerOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
