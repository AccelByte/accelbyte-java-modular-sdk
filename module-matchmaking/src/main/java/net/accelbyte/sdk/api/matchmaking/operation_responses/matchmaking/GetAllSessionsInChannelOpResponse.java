...
@Getter
@Setter
public class GetAllSessionsInChannelOpResponse extends ApiResponseWithData<List<ModelsMatchmakingResult>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.matchmaking.operations.matchmaking.GetAllSessionsInChannel";
    }
}