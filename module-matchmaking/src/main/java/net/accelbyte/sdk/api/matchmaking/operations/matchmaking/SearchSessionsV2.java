...
public class SearchSessionsV2 extends Operation {
    ...
    */
    ...
    public SearchSessionsV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SearchSessionsV2OpResponse response = new SearchSessionsV2OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ServiceGetSessionHistorySearchResponseV2().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ServiceGetSessionHistorySearchResponseV2 parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
