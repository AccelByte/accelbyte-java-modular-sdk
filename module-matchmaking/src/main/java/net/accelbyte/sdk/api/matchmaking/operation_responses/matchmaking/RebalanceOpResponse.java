...
@Getter
@Setter
public class RebalanceOpResponse extends ApiResponseWithData<ModelsRebalanceResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.matchmaking.operations.matchmaking.Rebalance";
  }
}
