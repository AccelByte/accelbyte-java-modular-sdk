...
public class UpdatePlayTimeWeight extends Operation {
    ...
    */
    ...
    public UpdatePlayTimeWeightOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdatePlayTimeWeightOpResponse response = new UpdatePlayTimeWeightOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsUpdatePlayerPlaytimeWeightResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsUpdatePlayerPlaytimeWeightResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
