...
public class HandlerV3Healthz extends Operation {
  ...
  @Deprecated
  public HandlerV3Healthz(String customBasePath) {
  ...
  public HandlerV3HealthzOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final HandlerV3HealthzOpResponse response = new HandlerV3HealthzOpResponse();
