...
public class DeleteUserFromSessionInChannel extends Operation {
  ...
  public DeleteUserFromSessionInChannel(
      String customBasePath, String channelName, String matchID, String namespace, String userID) {
  ...
  public DeleteUserFromSessionInChannelOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final DeleteUserFromSessionInChannelOpResponse response =
        new DeleteUserFromSessionInChannelOpResponse();
