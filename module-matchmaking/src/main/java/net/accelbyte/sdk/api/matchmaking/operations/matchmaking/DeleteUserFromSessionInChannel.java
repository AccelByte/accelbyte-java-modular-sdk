...
import net.accelbyte.sdk.api.matchmaking.operation_responses.matchmaking.DeleteUserFromSessionInChannelOpResponse;
...
public class DeleteUserFromSessionInChannel extends Operation {
    ...
    */
    ...
    public DeleteUserFromSessionInChannelOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteUserFromSessionInChannelOpResponse response = new DeleteUserFromSessionInChannelOpResponse();
