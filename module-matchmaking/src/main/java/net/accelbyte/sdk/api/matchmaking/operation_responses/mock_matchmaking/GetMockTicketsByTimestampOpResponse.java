...
@Getter
@Setter
public class GetMockTicketsByTimestampOpResponse extends ApiResponseWithData<ModelsGetMockTicketsResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.matchmaking.operations.mock_matchmaking.GetMockTicketsByTimestamp";
    }
}