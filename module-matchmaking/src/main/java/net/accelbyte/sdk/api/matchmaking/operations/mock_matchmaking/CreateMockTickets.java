...
import net.accelbyte.sdk.api.matchmaking.operation_responses.mock_matchmaking.CreateMockTicketsOpResponse;
...
public class CreateMockTickets extends Operation {
     ...
     */
    private String path = "/matchmaking/v1/admin/namespaces/{namespace}/channels/{channelName}/mocks/tickets";
    ...
    */
    ...
    public CreateMockTicketsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreateMockTicketsOpResponse response = new CreateMockTicketsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<ModelsMockTicket>>() {}));
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public List<ModelsMockTicket> parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 201){
            final String json = Helper.convertInputStreamToString(payload);
