...
public class CreateMockTickets extends Operation {
  ...
  public CreateMockTickets(
      String customBasePath, String channelName, String namespace, ModelsCreateMockTicket body) {
  ...
  public CreateMockTicketsOpResponse parseResponse(
    ...
    if (code == 204) {
      ...
      response.setSuccess(true);
      response.setData(
          new ObjectMapper().readValue(json, new TypeReference<List<ModelsMockTicket>>() {}));
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
