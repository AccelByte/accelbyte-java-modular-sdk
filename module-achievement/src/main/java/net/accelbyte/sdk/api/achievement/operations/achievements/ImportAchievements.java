...
import net.accelbyte.sdk.api.achievement.operation_responses.achievements.ImportAchievementsOpResponse;
...
public class ImportAchievements extends Operation {
  ...
  @Deprecated
  public ImportAchievements(String customBasePath, String namespace, File file, String strategy) {
  ...
  public ImportAchievementsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final ImportAchievementsOpResponse response = new ImportAchievementsOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ServiceImportConfigResponse().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 401) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public ServiceImportConfigResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
