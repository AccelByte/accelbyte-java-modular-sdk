...
public class ClaimGlobalAchievementReward extends Operation {
  ...
  public ClaimGlobalAchievementRewardOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final ClaimGlobalAchievementRewardOpResponse response =
        new ClaimGlobalAchievementRewardOpResponse();
