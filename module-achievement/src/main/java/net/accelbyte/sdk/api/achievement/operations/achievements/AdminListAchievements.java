...
import net.accelbyte.sdk.api.achievement.operation_responses.achievements.AdminListAchievementsOpResponse;
...
public class AdminListAchievements extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("global", this.global == null ? null : Arrays.asList(String.valueOf(this.global)));
    ...
    public AdminListAchievementsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminListAchievementsOpResponse response = new AdminListAchievementsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsPaginatedAchievementResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsPaginatedAchievementResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
