...
public class AdminListUserAchievements extends Operation {
    ...
    */
    ...
    public AdminListUserAchievementsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminListUserAchievementsOpResponse response = new AdminListUserAchievementsOpResponse();
