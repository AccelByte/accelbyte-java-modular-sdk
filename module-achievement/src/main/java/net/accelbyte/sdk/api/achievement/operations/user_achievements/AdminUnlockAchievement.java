...
public class AdminUnlockAchievement extends Operation {
    ...
    */
    ...
    public AdminUnlockAchievementOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUnlockAchievementOpResponse response = new AdminUnlockAchievementOpResponse();
