...
public class PublicListGlobalAchievements extends Operation {
  ...
  public PublicListGlobalAchievementsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicListGlobalAchievementsOpResponse response =
        new PublicListGlobalAchievementsOpResponse();
