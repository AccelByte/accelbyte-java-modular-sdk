...
import net.accelbyte.sdk.api.achievement.operation_responses.global_achievements.ListUserContributionsOpResponse;
...
public class ListUserContributions extends Operation {
    ...
    */
    ...
    public ListUserContributionsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ListUserContributionsOpResponse response = new ListUserContributionsOpResponse();
