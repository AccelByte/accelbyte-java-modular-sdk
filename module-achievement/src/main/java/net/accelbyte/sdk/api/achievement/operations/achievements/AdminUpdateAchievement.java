...
import net.accelbyte.sdk.api.achievement.operation_responses.achievements.AdminUpdateAchievementOpResponse;
...
public class AdminUpdateAchievement extends Operation {
    ...
    */
    ...
    public AdminUpdateAchievementOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateAchievementOpResponse response = new AdminUpdateAchievementOpResponse();
