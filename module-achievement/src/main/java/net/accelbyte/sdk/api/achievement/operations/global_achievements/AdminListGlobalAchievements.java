...
public class AdminListGlobalAchievements extends Operation {
  ...
  public AdminListGlobalAchievementsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminListGlobalAchievementsOpResponse response =
        new AdminListGlobalAchievementsOpResponse();
