...
import net.accelbyte.sdk.api.achievement.operation_responses.global_achievements.AdminListGlobalAchievementsOpResponse;
...
public class AdminListGlobalAchievements extends Operation {
    ...
    */
    ...
    public AdminListGlobalAchievementsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminListGlobalAchievementsOpResponse response = new AdminListGlobalAchievementsOpResponse();
