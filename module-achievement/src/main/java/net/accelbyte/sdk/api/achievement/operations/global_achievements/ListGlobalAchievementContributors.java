...
import net.accelbyte.sdk.api.achievement.operation_responses.global_achievements.ListGlobalAchievementContributorsOpResponse;
...
public class ListGlobalAchievementContributors extends Operation {
     ...
     */
    private String path = "/achievement/v1/public/namespaces/{namespace}/global/achievements/{achievementCode}/contributors";
    ...
    */
    ...
    public ListGlobalAchievementContributorsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ListGlobalAchievementContributorsOpResponse response = new ListGlobalAchievementContributorsOpResponse();
