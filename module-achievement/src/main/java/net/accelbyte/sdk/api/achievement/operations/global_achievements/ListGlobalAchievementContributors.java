...
public class ListGlobalAchievementContributors extends Operation {
  ...
  public ListGlobalAchievementContributorsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final ListGlobalAchievementContributorsOpResponse response =
        new ListGlobalAchievementContributorsOpResponse();
