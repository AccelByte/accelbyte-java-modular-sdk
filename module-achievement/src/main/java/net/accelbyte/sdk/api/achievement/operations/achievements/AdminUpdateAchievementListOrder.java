...
public class AdminUpdateAchievementListOrder extends Operation {
    ...
    */
    ...
    public AdminUpdateAchievementListOrderOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateAchievementListOrderOpResponse response = new AdminUpdateAchievementListOrderOpResponse();
