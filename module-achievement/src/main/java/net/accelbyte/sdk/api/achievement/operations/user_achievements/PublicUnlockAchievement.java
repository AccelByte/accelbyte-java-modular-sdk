...
public class PublicUnlockAchievement extends Operation {
    ...
    */
    ...
    public PublicUnlockAchievementOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicUnlockAchievementOpResponse response = new PublicUnlockAchievementOpResponse();
