...
public class ModelsUserContributionResponse extends Model {
    ...
    @JsonIgnore
    public List<ModelsUserContributionResponse> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelsUserContributionResponse>>() {});
    }
