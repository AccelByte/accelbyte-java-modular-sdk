...
import net.accelbyte.sdk.api.achievement.operation_responses.tags.PublicListTagsOpResponse;
...
public class PublicListTags extends Operation {
    ...
    */
    ...
    public PublicListTagsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicListTagsOpResponse response = new PublicListTagsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsPaginatedTagResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsPaginatedTagResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
