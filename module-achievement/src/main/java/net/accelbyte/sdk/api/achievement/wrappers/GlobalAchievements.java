...
public class GlobalAchievements {
   ...
   */
  public AdminListGlobalAchievementsOpResponse adminListGlobalAchievements(
   ...
   */
  public AdminListGlobalAchievementContributorsOpResponse adminListGlobalAchievementContributors(
   ...
   */
  public ResetGlobalAchievementOpResponse resetGlobalAchievement(ResetGlobalAchievement input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminListUserContributionsOpResponse adminListUserContributions(
   ...
   */
  public PublicListGlobalAchievementsOpResponse publicListGlobalAchievements(
   ...
   */
  public ListGlobalAchievementContributorsOpResponse listGlobalAchievementContributors(
   ...
   */
  public ListUserContributionsOpResponse listUserContributions(ListUserContributions input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public ClaimGlobalAchievementRewardOpResponse claimGlobalAchievementReward(
      ClaimGlobalAchievementReward input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
