...
public class AdminListGlobalAchievementContributors extends Operation {
     ...
     */
    private String path = "/achievement/v1/admin/namespaces/{namespace}/global/achievements/{achievementCode}/contributors";
    ...
    */
    ...
    public AdminListGlobalAchievementContributorsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminListGlobalAchievementContributorsOpResponse response = new AdminListGlobalAchievementContributorsOpResponse();
