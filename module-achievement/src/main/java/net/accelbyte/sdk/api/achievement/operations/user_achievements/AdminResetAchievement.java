...
public class AdminResetAchievement extends Operation {
     ...
     */
    private String path = "/achievement/v1/admin/namespaces/{namespace}/users/{userId}/achievements/{achievementCode}/reset";
    ...
    */
    ...
    public AdminResetAchievementOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminResetAchievementOpResponse response = new AdminResetAchievementOpResponse();
