...
import net.accelbyte.sdk.api.achievement.operation_responses.achievements.PublicListAchievementsOpResponse;
...
public class PublicListAchievements extends Operation {
    ...
    */
    ...
    public PublicListAchievementsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicListAchievementsOpResponse response = new PublicListAchievementsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsPublicAchievementsResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsPublicAchievementsResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
