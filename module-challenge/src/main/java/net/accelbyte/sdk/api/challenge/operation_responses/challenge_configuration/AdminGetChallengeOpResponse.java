...
@Getter
@Setter
public class AdminGetChallengeOpResponse extends ApiResponseWithData<ModelChallengeResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.challenge.operations.challenge_configuration.AdminGetChallenge";
    }
}