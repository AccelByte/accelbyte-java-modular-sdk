...
public class PlayerReward {
   ...
   */
  public AdminClaimUsersRewardsOpResponse adminClaimUsersRewards(AdminClaimUsersRewards input)
      throws Exception {
   ...
   */
  public AdminClaimUserRewardsByGoalCodeOpResponse adminClaimUserRewardsByGoalCode(
   ...
   */
  public AdminGetUserRewardsOpResponse adminGetUserRewards(AdminGetUserRewards input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminClaimUserRewardsOpResponse adminClaimUserRewards(AdminClaimUserRewards input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public PublicClaimUserRewardsByGoalCodeOpResponse publicClaimUserRewardsByGoalCode(
   ...
   */
  public PublicGetUserRewardsOpResponse publicGetUserRewards(PublicGetUserRewards input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public PublicClaimUserRewardsOpResponse publicClaimUserRewards(PublicClaimUserRewards input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
