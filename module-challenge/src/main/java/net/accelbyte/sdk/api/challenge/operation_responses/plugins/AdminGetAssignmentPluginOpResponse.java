...
@Getter
@Setter
public class AdminGetAssignmentPluginOpResponse extends ApiResponseWithData<ModelPluginAssignmentResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.challenge.operations.plugins.AdminGetAssignmentPlugin";
    }
}