...
@Getter
@Setter
public class AdminClaimUserRewardsOpResponse extends ApiResponseWithData<List<ModelUserReward>> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.challenge.operations.player_reward.AdminClaimUserRewards";
  }
}
