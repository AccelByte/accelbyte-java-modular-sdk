...
@Getter
@Setter
public class PublicGetPastUserProgressionOpResponse extends ApiResponseWithData<ModelUserProgressionResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.challenge.operations.challenge_progression.PublicGetPastUserProgression";
    }
}