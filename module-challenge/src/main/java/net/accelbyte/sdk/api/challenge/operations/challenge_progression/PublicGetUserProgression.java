...
import net.accelbyte.sdk.api.challenge.operation_responses.challenge_progression.PublicGetUserProgressionOpResponse;
...
public class PublicGetUserProgression extends Operation {
    ...
    */
    ...
    public PublicGetUserProgressionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetUserProgressionOpResponse response = new PublicGetUserProgressionOpResponse();
