...
public class AdminUpdateTiedChallengeSchedule extends Operation {
  ...
  public AdminUpdateTiedChallengeScheduleOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminUpdateTiedChallengeScheduleOpResponse response =
        new AdminUpdateTiedChallengeScheduleOpResponse();
