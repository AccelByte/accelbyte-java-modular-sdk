...
@Getter
@Setter
public class AdminRandomizeChallengeOpResponse extends ApiResponseWithData<List<ModelSchedule>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.challenge.operations.challenge_configuration.AdminRandomizeChallenge";
    }
}