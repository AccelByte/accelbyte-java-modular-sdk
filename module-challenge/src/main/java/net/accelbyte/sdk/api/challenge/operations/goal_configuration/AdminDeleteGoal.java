...
public class AdminDeleteGoal extends Operation {
  ...
  public AdminDeleteGoal(
      String customBasePath, String challengeCode, String code, String namespace) {
  ...
  public AdminDeleteGoalOpResponse parseResponse(int code, String contentType, InputStream payload)
