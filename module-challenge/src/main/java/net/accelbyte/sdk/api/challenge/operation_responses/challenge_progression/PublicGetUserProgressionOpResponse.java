...
@Getter
@Setter
public class PublicGetUserProgressionOpResponse extends ApiResponseWithData<ModelUserProgressionResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.challenge.operations.challenge_progression.PublicGetUserProgression";
    }
}