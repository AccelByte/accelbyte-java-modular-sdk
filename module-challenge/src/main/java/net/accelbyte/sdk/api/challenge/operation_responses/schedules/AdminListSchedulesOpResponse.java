...
@Getter
@Setter
public class AdminListSchedulesOpResponse extends ApiResponseWithData<ModelListSchedulesResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.challenge.operations.schedules.AdminListSchedules";
  }
}
