...
public class PublicClaimUserRewardsByGoalCode extends Operation {
  ...
  public PublicClaimUserRewardsByGoalCodeOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicClaimUserRewardsByGoalCodeOpResponse response =
        new PublicClaimUserRewardsByGoalCodeOpResponse();
