...
public class PublicClaimUserRewardsByGoalCode extends Operation {
     ...
     */
    private String path = "/challenge/v1/public/namespaces/{namespace}/users/me/challenges/{challengeCode}/rewards/claim";
    ...
    */
    ...
    public PublicClaimUserRewardsByGoalCodeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicClaimUserRewardsByGoalCodeOpResponse response = new PublicClaimUserRewardsByGoalCodeOpResponse();
