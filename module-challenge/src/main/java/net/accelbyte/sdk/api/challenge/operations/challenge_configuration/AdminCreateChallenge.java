 ...
 * null/empty. - repeatAfter: number of periods after which the challenge's goals repeat. Leave
 * empty if you don't want to repeat the challenge. - note: when repeatAfter is set, goals cannot
 * include the 'schedule' field when created via POST .../goals. Use PUT .../goals/{code}/slots to
 * assign each goal to a specific slot instead. - rotation: describe how long goals in a challenge
...
public class AdminCreateChallenge extends Operation {
  ...
  public AdminCreateChallengeOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminCreateChallengeOpResponse response = new AdminCreateChallengeOpResponse();
