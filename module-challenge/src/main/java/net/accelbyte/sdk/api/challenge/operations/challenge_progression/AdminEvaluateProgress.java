...
import net.accelbyte.sdk.api.challenge.operation_responses.challenge_progression.AdminEvaluateProgressOpResponse;
...
public class AdminEvaluateProgress extends Operation {
    ...
    */
    ...
    public AdminEvaluateProgressOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminEvaluateProgressOpResponse response = new AdminEvaluateProgressOpResponse();
