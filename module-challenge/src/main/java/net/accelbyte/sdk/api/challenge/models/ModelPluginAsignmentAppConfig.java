...
public class ModelPluginAsignmentAppConfig extends Model {
    ...
    @JsonIgnore
    public List<ModelPluginAsignmentAppConfig> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelPluginAsignmentAppConfig>>() {});
    }
