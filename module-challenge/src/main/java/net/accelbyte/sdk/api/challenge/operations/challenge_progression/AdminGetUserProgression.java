...
import net.accelbyte.sdk.api.challenge.operation_responses.challenge_progression.AdminGetUserProgressionOpResponse;
...
public class AdminGetUserProgression extends Operation {
     ...
     */
    private String path = "/challenge/v1/admin/namespaces/{namespace}/users/{userId}/progress/{challengeCode}";
    ...
    */
    ...
    public AdminGetUserProgressionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetUserProgressionOpResponse response = new AdminGetUserProgressionOpResponse();
