...
public class AdminGetChallenge extends Operation {
    ...
    */
    ...
    public AdminGetChallengeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetChallengeOpResponse response = new AdminGetChallengeOpResponse();
