...
public class Plugins {
   ...
   */
  public AdminGetAssignmentPluginOpResponse adminGetAssignmentPlugin(AdminGetAssignmentPlugin input)
      throws Exception {
   ...
   */
  public AdminUpdateAssignmentPluginOpResponse adminUpdateAssignmentPlugin(
   ...
   */
  public AdminCreateAssignmentPluginOpResponse adminCreateAssignmentPlugin(
   ...
   */
  public AdminDeleteAssignmentPluginOpResponse adminDeleteAssignmentPlugin(
      AdminDeleteAssignmentPlugin input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
