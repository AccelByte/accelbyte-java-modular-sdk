...
public class ModelClaimableUserReward extends Model {
    ...
    @JsonIgnore
    public List<ModelClaimableUserReward> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelClaimableUserReward>>() {});
    }
