...
@Getter
@Setter
public class AdminGetGoalsOpResponse extends ApiResponseWithData<ModelGetGoalsResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.challenge.operations.goal_configuration.AdminGetGoals";
  }
}
