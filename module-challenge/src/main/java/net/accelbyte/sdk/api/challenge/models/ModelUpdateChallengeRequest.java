...
public class ModelUpdateChallengeRequest extends Model {
    ...
    @JsonIgnore
    public List<ModelUpdateChallengeRequest> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelUpdateChallengeRequest>>() {});
    }
    ...
    public static class ModelUpdateChallengeRequestBuilder {
        ...
        public ModelUpdateChallengeRequestBuilder assignmentRuleFromEnum(final AssignmentRule assignmentRule) {
            this.assignmentRule = assignmentRule.toString();
            return this;
        }
        ...
        public ModelUpdateChallengeRequestBuilder goalsVisibilityFromEnum(final GoalsVisibility goalsVisibility) {
            this.goalsVisibility = goalsVisibility.toString();
            return this;
        }
