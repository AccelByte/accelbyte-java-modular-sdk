...
public class AdminGetActiveChallenges extends Operation {
    ...
    */
    ...
    public AdminGetActiveChallengesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetActiveChallengesOpResponse response = new AdminGetActiveChallengesOpResponse();
