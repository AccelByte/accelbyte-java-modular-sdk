...
@Getter
@Setter
public class AdminUpdateAssignmentPluginOpResponse extends ApiResponseWithData<ModelPluginAssignmentResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.challenge.operations.plugins.AdminUpdateAssignmentPlugin";
    }
}