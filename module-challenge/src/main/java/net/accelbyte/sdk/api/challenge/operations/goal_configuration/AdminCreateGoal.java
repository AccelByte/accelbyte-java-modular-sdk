...
public class AdminCreateGoal extends Operation {
  ...
  public AdminCreateGoal(
      String customBasePath, String challengeCode, String namespace, ModelCreateGoalRequest body) {
  ...
  public AdminCreateGoalOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final AdminCreateGoalOpResponse response = new AdminCreateGoalOpResponse();
