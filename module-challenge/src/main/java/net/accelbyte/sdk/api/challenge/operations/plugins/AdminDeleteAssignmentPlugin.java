...
public class AdminDeleteAssignmentPlugin extends Operation {
  ...
  @Deprecated
  public AdminDeleteAssignmentPlugin(String customBasePath, String namespace) {
  ...
  public AdminDeleteAssignmentPluginOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminDeleteAssignmentPluginOpResponse response =
        new AdminDeleteAssignmentPluginOpResponse();
