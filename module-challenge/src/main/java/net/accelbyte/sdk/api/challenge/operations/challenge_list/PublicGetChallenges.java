...
import net.accelbyte.sdk.api.challenge.operation_responses.challenge_list.PublicGetChallengesOpResponse;
...
@Getter
@Setter
public class PublicGetChallenges extends Operation {
  ...
  public PublicGetChallengesOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGetChallengesOpResponse response = new PublicGetChallengesOpResponse();
  ...
  */
  ...
  public static class PublicGetChallengesBuilder {
    private String sortBy;
    private String status;

    public PublicGetChallengesBuilder sortBy(final String sortBy) {
      this.sortBy = sortBy;
      return this;
    }

    public PublicGetChallengesBuilder sortByFromEnum(final SortBy sortBy) {
      this.sortBy = sortBy.toString();
      return this;
    }

    public PublicGetChallengesBuilder status(final String status) {
      this.status = status;
      return this;
    }

    public PublicGetChallengesBuilder statusFromEnum(final Status status) {
