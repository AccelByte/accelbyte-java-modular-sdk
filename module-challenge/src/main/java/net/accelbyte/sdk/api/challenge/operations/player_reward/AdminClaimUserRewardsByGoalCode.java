...
public class AdminClaimUserRewardsByGoalCode extends Operation {
  ...
  public AdminClaimUserRewardsByGoalCodeOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminClaimUserRewardsByGoalCodeOpResponse response =
        new AdminClaimUserRewardsByGoalCodeOpResponse();
