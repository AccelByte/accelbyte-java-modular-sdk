...
public class AdminClaimUserRewardsByGoalCode extends Operation {
     ...
     */
    private String path = "/challenge/v1/admin/namespaces/{namespace}/users/{userId}/challenges/{challengeCode}/rewards/claim";
    ...
    */
    ...
    public AdminClaimUserRewardsByGoalCodeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminClaimUserRewardsByGoalCodeOpResponse response = new AdminClaimUserRewardsByGoalCodeOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<ModelUserReward>>() {}));
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
            ...
            final String json = Helper.convertInputStreamToString(payload);
            response.setError422(new IamErrorResponse().createFromJson(json));
