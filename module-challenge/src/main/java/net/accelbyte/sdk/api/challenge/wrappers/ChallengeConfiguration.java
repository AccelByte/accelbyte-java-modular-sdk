...
public class ChallengeConfiguration {
   ...
   */
  public AdminGetChallengesOpResponse adminGetChallenges(AdminGetChallenges input)
      throws Exception {
   ...
   */
  public AdminCreateChallengeOpResponse adminCreateChallenge(AdminCreateChallenge input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminGetActiveChallengesOpResponse adminGetActiveChallenges(AdminGetActiveChallenges input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminUpdateChallengeOpResponse adminUpdateChallenge(AdminUpdateChallenge input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminDeleteChallengeOpResponse adminDeleteChallenge(AdminDeleteChallenge input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminRandomizeChallengeOpResponse adminRandomizeChallenge(AdminRandomizeChallenge input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminDeleteTiedChallengeOpResponse adminDeleteTiedChallenge(AdminDeleteTiedChallenge input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminUpdateTiedChallengeScheduleOpResponse adminUpdateTiedChallengeSchedule(
