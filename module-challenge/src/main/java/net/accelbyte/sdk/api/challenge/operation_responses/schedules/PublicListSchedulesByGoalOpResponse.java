...
@Getter
@Setter
public class PublicListSchedulesByGoalOpResponse
    extends ApiResponseWithData<ModelListScheduleByGoalResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.challenge.operations.schedules.PublicListSchedulesByGoal";
  }
}
