...
import net.accelbyte.sdk.api.challenge.operation_responses.challenge_progression.PublicEvaluateMyProgressOpResponse;
...
@Getter
@Setter
public class PublicEvaluateMyProgress extends Operation {
  ...
  public PublicEvaluateMyProgressOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicEvaluateMyProgressOpResponse response = new PublicEvaluateMyProgressOpResponse();
