...
public class AdminGetChallenges extends Operation {
    ...
    */
    ...
    public AdminGetChallengesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetChallengesOpResponse response = new AdminGetChallengesOpResponse();
