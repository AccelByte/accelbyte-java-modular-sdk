...
public class ModelPluginAssignmentResponse extends Model {
    ...
    @JsonIgnore
    public List<ModelPluginAssignmentResponse> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelPluginAssignmentResponse>>() {});
    }
