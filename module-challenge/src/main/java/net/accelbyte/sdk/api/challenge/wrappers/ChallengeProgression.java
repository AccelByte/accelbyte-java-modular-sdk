...
public class ChallengeProgression {
     ...
     */
    public AdminEvaluateProgressOpResponse adminEvaluateProgress(AdminEvaluateProgress input) throws Exception {
     ...
     */
    public AdminGetUserProgressionOpResponse adminGetUserProgression(AdminGetUserProgression input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public EvaluateMyProgressOpResponse evaluateMyProgress(EvaluateMyProgress input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public PublicGetUserProgressionOpResponse publicGetUserProgression(PublicGetUserProgression input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public PublicGetPastUserProgressionOpResponse publicGetPastUserProgression(PublicGetPastUserProgression input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
