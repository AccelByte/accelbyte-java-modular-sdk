...
@Getter
@Setter
public class AdminCreateChallengeOpResponse extends ApiResponseWithData<ModelChallengeResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.challenge.operations.challenge_configuration.AdminCreateChallenge";
    }
}