...
public class AdminUpdateGoals extends Operation {
    ...
    */
    ...
    public AdminUpdateGoalsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateGoalsOpResponse response = new AdminUpdateGoalsOpResponse();
