...
@Getter
@Setter
public class AdminDeleteAssignmentPluginOpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.challenge.operations.plugins.AdminDeleteAssignmentPlugin";
    }
}