...
public class AdminDeleteChallenge extends Operation {
    ...
    */
    ...
    public AdminDeleteChallengeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDeleteChallengeOpResponse response = new AdminDeleteChallengeOpResponse();
