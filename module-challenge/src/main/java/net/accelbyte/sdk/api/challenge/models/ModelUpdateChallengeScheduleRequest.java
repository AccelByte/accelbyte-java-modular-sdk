...
public class ModelUpdateChallengeScheduleRequest extends Model {
    ...
    @JsonIgnore
    public ModelUpdateChallengeScheduleRequest createFromJson(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, this.getClass());
    }

    @JsonIgnore
    public List<ModelUpdateChallengeScheduleRequest> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelUpdateChallengeScheduleRequest>>() {});
    }
