...
public class PublicGetUserRewards extends Operation {
    ...
    */
    ...
    public PublicGetUserRewardsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetUserRewardsOpResponse response = new PublicGetUserRewardsOpResponse();
