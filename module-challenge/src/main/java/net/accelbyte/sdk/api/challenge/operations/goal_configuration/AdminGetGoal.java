...
public class AdminGetGoal extends Operation {
  ...
  @Deprecated
  public AdminGetGoal(String customBasePath, String challengeCode, String code, String namespace) {
  ...
  public AdminGetGoalOpResponse parseResponse(int code, String contentType, InputStream payload)
