...
public class AdminDeleteTiedChallenge extends Operation {
     ...
     */
    private String path = "/challenge/v1/admin/namespaces/{namespace}/challenges/{challengeCode}/tied";
    ...
    */
    ...
    public AdminDeleteTiedChallengeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDeleteTiedChallengeOpResponse response = new AdminDeleteTiedChallengeOpResponse();
