...
public class PublicGetPastUserProgression extends Operation {
     ...
     */
    private String path = "/challenge/v1/public/namespaces/{namespace}/users/me/progress/{challengeCode}/index/{index}";
    ...
    */
    ...
    public PublicGetPastUserProgressionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetPastUserProgressionOpResponse response = new PublicGetPastUserProgressionOpResponse();
