...
public class PublicGeneratedUserUploadContentUrl implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.basic.operations.file_upload.PublicGeneratedUserUploadContentUrl operation =
                    net.accelbyte.sdk.api.basic.operations.file_upload.PublicGeneratedUserUploadContentUrl.builder()
                            ...
                            .fileType(fileType)
                            .build();
            final FileUploadUrlInfo response =
                    wrapper.publicGeneratedUserUploadContentUrl(operation).ensureSuccess();
