...
public class PublicReconcilePlayStationStore implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.iap.PublicReconcilePlayStationStore operation =
            ...
            final List<PlayStationReconcileResult> response =
                    wrapper.publicReconcilePlayStationStore(operation).ensureSuccess();
