...
public class GetUserLeaderboardRankingsAdminV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.user_data.GetUserLeaderboardRankingsAdminV1 operation =
            ...
            final ModelsGetAllUserLeaderboardsResp response =
                    wrapper.getUserLeaderboardRankingsAdminV1(operation).ensureSuccess();
