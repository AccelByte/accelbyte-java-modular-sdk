...
public class PublicBulkCreateUserStatItems implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.social.operations.user_statistic.PublicBulkCreateUserStatItems operation =
            ...
            final List<BulkStatOperationResult> response =
                    wrapper.publicBulkCreateUserStatItems(operation).ensureSuccess();
