...
public class PublicRequestDataRetrieval implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.gdpr.operations.data_retrieval.PublicRequestDataRetrieval operation =
            ...
            final ModelsDataRetrievalResponse response =
                    wrapper.publicRequestDataRetrieval(operation).ensureSuccess();
