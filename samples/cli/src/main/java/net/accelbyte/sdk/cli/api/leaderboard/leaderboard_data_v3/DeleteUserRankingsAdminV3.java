...
public class DeleteUserRankingsAdminV3 implements Callable<Integer> {
    ...
    @Option(names = {"--leaderboardCode"}, description = "leaderboardCode", split = ",")
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data_v3.DeleteUserRankingsAdminV3 operation =
                    net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data_v3.DeleteUserRankingsAdminV3.builder()
                            .namespace(namespace)
                            .userId(userId)
