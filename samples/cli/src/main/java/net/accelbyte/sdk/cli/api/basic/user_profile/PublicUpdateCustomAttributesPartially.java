...
public class PublicUpdateCustomAttributesPartially implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.basic.operations.user_profile.PublicUpdateCustomAttributesPartially operation =
            ...
            final Map<String, ?> response =
                    wrapper.publicUpdateCustomAttributesPartially(operation).ensureSuccess();
