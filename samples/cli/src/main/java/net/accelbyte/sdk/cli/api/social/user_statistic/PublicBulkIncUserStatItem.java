...
public class PublicBulkIncUserStatItem implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.social.operations.user_statistic.PublicBulkIncUserStatItem operation =
            ...
            final List<BulkStatOperationResult> response =
                    wrapper.publicBulkIncUserStatItem(operation).ensureSuccess();
