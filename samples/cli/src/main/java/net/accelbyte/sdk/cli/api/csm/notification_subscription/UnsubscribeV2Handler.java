...
public class UnsubscribeV2Handler implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.csm.operations.notification_subscription.UnsubscribeV2Handler operation =
                    net.accelbyte.sdk.api.csm.operations.notification_subscription.UnsubscribeV2Handler.builder()
                            .app(app)
                            .namespace(namespace)
                            .build();
