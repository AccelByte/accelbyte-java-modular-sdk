...
public class QueryCodes implements Callable<Integer> {
    ...
    @Option(names = {"--batchName"}, description = "batchName")
    String batchName;

    @Option(names = {"--batchNo"}, description = "batchNo", split = ",")
    ...
    @Option(names = {"--withBatchName"}, description = "withBatchName")
        ...
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.campaign.QueryCodes operation =
                    net.accelbyte.sdk.api.platform.operations.campaign.QueryCodes.builder()
                            ...
                            .build();
            final CodeInfoPagingSlicedResult response =
                    wrapper.queryCodes(operation).ensureSuccess();
