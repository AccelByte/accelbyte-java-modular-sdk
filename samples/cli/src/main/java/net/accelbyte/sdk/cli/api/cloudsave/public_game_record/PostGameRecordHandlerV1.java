...
public class PostGameRecordHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.public_game_record.PostGameRecordHandlerV1 operation =
                    net.accelbyte.sdk.api.cloudsave.operations.public_game_record.PostGameRecordHandlerV1.builder()
                            ...
                            .build();
            final ModelsGameRecordResponse response =
                    wrapper.postGameRecordHandlerV1(operation).ensureSuccess();
