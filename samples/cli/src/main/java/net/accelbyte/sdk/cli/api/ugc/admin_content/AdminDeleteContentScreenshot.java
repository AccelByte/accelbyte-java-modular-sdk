...
public class AdminDeleteContentScreenshot implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.ugc.operations.admin_content.AdminDeleteContentScreenshot operation =
                    net.accelbyte.sdk.api.ugc.operations.admin_content.AdminDeleteContentScreenshot.builder()
                            .contentId(contentId)
                            .namespace(namespace)
                            .screenshotId(screenshotId)
                            .build();
                    wrapper.adminDeleteContentScreenshot(operation).ensureSuccess();
