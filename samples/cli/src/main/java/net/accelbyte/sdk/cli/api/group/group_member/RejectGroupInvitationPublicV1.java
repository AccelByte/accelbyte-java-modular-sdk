...
public class RejectGroupInvitationPublicV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.group.operations.group_member.RejectGroupInvitationPublicV1 operation =
            ...
            final ModelsMemberRequestGroupResponseV1 response =
                    wrapper.rejectGroupInvitationPublicV1(operation).ensureSuccess();
