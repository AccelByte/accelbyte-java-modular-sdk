...
public class ProcessUserSubscriptionNotification implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.subscription.ProcessUserSubscriptionNotification operation =
                    net.accelbyte.sdk.api.platform.operations.subscription.ProcessUserSubscriptionNotification.builder()
                            ...
                            .build();
                    wrapper.processUserSubscriptionNotification(operation).ensureSuccess();
