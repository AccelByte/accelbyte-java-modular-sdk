...
public class RetrieveSinglePolicy implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.base_legal_policies_with_namespace.RetrieveSinglePolicy operation =
                    net.accelbyte.sdk.api.legal.operations.base_legal_policies_with_namespace.RetrieveSinglePolicy.builder()
                            .basePolicyId(basePolicyId)
                            .namespace(namespace)
                            .build();
            final RetrieveBasePolicyResponse response =
                    wrapper.retrieveSinglePolicy(operation).ensureSuccess();
