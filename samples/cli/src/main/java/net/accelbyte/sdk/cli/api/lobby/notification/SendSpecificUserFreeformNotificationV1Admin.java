...
public class SendSpecificUserFreeformNotificationV1Admin implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.lobby.operations.notification.SendSpecificUserFreeformNotificationV1Admin operation =
                    net.accelbyte.sdk.api.lobby.operations.notification.SendSpecificUserFreeformNotificationV1Admin.builder()
                            ...
                            .build();
                    wrapper.sendSpecificUserFreeformNotificationV1Admin(operation).ensureSuccess();
