...
public class PublicCancelUserPersonalDataRequest implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.gdpr.operations.data_retrieval.PublicCancelUserPersonalDataRequest operation =
                    net.accelbyte.sdk.api.gdpr.operations.data_retrieval.PublicCancelUserPersonalDataRequest.builder()
                            .namespace(namespace)
                            .requestDate(requestDate)
                            .userId(userId)
                            .build();
                    wrapper.publicCancelUserPersonalDataRequest(operation).ensureSuccess();
