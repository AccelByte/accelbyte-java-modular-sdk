...
public class DeleteTemplateLocalizationV1Admin implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.lobby.operations.notification.DeleteTemplateLocalizationV1Admin operation =
                    net.accelbyte.sdk.api.lobby.operations.notification.DeleteTemplateLocalizationV1Admin.builder()
                            .namespace(namespace)
                            .templateLanguage(templateLanguage)
                            .templateSlug(templateSlug)
                            .build();
                    wrapper.deleteTemplateLocalizationV1Admin(operation).ensureSuccess();
