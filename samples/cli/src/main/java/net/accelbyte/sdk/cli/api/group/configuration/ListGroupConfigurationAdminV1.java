...
public class ListGroupConfigurationAdminV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.group.operations.configuration.ListGroupConfigurationAdminV1 operation =
            ...
            final ModelsListConfigurationResponseV1 response =
                    wrapper.listGroupConfigurationAdminV1(operation).ensureSuccess();
