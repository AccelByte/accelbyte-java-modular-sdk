...
public class SendPartyTemplatedNotificationV1Admin implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.lobby.operations.notification.SendPartyTemplatedNotificationV1Admin operation =
                    net.accelbyte.sdk.api.lobby.operations.notification.SendPartyTemplatedNotificationV1Admin.builder()
                            ...
                            .build();
                    wrapper.sendPartyTemplatedNotificationV1Admin(operation).ensureSuccess();
