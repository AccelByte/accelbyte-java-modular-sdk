...
public class BulkCreateMockTickets implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.matchmaking.operations.mock_matchmaking.BulkCreateMockTickets operation =
                    net.accelbyte.sdk.api.matchmaking.operations.mock_matchmaking.BulkCreateMockTickets.builder()
                            .channelName(channelName)
                            .namespace(namespace)
                            .body(new ObjectMapper().readValue(body, new TypeReference<List<ModelsMatchingParty>>() {}))
                            .build();
                    wrapper.bulkCreateMockTickets(operation).ensureSuccess();
