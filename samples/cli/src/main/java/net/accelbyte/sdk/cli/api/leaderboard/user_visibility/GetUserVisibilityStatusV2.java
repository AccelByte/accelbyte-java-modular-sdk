...
public class GetUserVisibilityStatusV2 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.user_visibility.GetUserVisibilityStatusV2 operation =
            ...
            final ModelsGetUserVisibilityResponse response =
                    wrapper.getUserVisibilityStatusV2(operation).ensureSuccess();
