...
public class RetrieveLatestPoliciesByNamespaceAndCountryPublic implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.policies_with_namespace_v2.RetrieveLatestPoliciesByNamespaceAndCountryPublic operation =
                    net.accelbyte.sdk.api.legal.operations.policies_with_namespace_v2.RetrieveLatestPoliciesByNamespaceAndCountryPublic.builder()
                            .countryCode(countryCode)
                            .namespace(namespace)
                            .clientId(clientId)
                            .build();
            final List<RetrieveSimplePolicyPublicResponseV2> response =
                    wrapper.retrieveLatestPoliciesByNamespaceAndCountryPublic(operation).ensureSuccess();
