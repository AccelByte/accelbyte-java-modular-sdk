...
public class RejectGroupJoinRequestPublicV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.group.operations.group_member.RejectGroupJoinRequestPublicV1 operation =
            ...
            final ModelsMemberRequestGroupResponseV1 response =
                    wrapper.rejectGroupJoinRequestPublicV1(operation).ensureSuccess();
