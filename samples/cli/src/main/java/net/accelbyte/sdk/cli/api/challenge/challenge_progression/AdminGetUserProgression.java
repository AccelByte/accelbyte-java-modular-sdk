...
public class AdminGetUserProgression implements Callable<Integer> {
    ...
    @Option(names = {"--dateTime"}, description = "dateTime")
    String dateTime;
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.challenge.operations.challenge_progression.AdminGetUserProgression operation =
                    net.accelbyte.sdk.api.challenge.operations.challenge_progression.AdminGetUserProgression.builder()
            ...
            final ModelUserProgressionResponse response =
                    wrapper.adminGetUserProgression(operation).ensureSuccess();
