...
public class UpdateLeaderboardConfigurationAdminV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration.UpdateLeaderboardConfigurationAdminV1 operation =
            ...
            final ModelsGetLeaderboardConfigResp response =
                    wrapper.updateLeaderboardConfigurationAdminV1(operation).ensureSuccess();
