...
public class BatchDownloadServerLogs implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.dslogmanager.operations.all_terminated_servers.BatchDownloadServerLogs operation =
            ...
            final InputStream response =
                    wrapper.batchDownloadServerLogs(operation).ensureSuccess();
