...
public class AdminRetrieveEligibilities implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.admin_user_eligibilities.AdminRetrieveEligibilities operation =
            ...
            final RetrieveUserEligibilitiesIndirectResponse response =
                    wrapper.adminRetrieveEligibilities(operation).ensureSuccess();
