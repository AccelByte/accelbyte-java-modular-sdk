...
public class PublicGetUserGameProfiles implements Callable<Integer> {
    ...
    @Option(names = {"--userIds"}, description = "userIds", split = ",")
    List<String> userIds;
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.social.operations.game_profile.PublicGetUserGameProfiles operation =
                    net.accelbyte.sdk.api.social.operations.game_profile.PublicGetUserGameProfiles.builder()
                            .namespace(namespace)
                            .userIds(userIds)
                            .build();
            final List<UserGameProfiles> response =
                    wrapper.publicGetUserGameProfiles(operation).ensureSuccess();
