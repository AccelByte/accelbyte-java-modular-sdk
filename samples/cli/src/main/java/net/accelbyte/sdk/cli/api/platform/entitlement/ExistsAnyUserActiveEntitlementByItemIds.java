...
public class ExistsAnyUserActiveEntitlementByItemIds implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.entitlement.ExistsAnyUserActiveEntitlementByItemIds operation =
            ...
            final Ownership response =
                    wrapper.existsAnyUserActiveEntitlementByItemIds(operation).ensureSuccess();
