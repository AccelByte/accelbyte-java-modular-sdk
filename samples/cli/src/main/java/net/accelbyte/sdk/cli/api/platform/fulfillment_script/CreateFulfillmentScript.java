...
public class CreateFulfillmentScript implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.fulfillment_script.CreateFulfillmentScript operation =
            ...
            final FulfillmentScriptInfo response =
                    wrapper.createFulfillmentScript(operation).ensureSuccess();
