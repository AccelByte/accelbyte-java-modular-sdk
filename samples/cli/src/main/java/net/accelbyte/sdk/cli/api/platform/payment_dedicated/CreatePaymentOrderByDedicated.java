...
public class CreatePaymentOrderByDedicated implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.payment_dedicated.CreatePaymentOrderByDedicated operation =
                    net.accelbyte.sdk.api.platform.operations.payment_dedicated.CreatePaymentOrderByDedicated.builder()
                            ...
                            .build();
            final PaymentOrderCreateResult response =
                    wrapper.createPaymentOrderByDedicated(operation).ensureSuccess();
