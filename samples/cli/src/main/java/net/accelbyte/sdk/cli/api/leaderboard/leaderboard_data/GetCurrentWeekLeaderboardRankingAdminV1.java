...
public class GetCurrentWeekLeaderboardRankingAdminV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.GetCurrentWeekLeaderboardRankingAdminV1 operation =
            ...
            final ModelsGetLeaderboardRankingResp response =
                    wrapper.getCurrentWeekLeaderboardRankingAdminV1(operation).ensureSuccess();
