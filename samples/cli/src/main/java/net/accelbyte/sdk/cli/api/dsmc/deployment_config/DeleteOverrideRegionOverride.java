...
public class DeleteOverrideRegionOverride implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.dsmc.operations.deployment_config.DeleteOverrideRegionOverride operation =
            ...
            final ModelsDeploymentWithOverride response =
                    wrapper.deleteOverrideRegionOverride(operation).ensureSuccess();
