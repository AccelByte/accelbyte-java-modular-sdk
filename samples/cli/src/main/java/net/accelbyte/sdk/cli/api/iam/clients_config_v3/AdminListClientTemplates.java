...
public class AdminListClientTemplates implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.clients_config_v3.AdminListClientTemplates operation =
                    net.accelbyte.sdk.api.iam.operations.clients_config_v3.AdminListClientTemplates.builder()
                            .build();
            final ClientmodelListTemplatesResponse response =
                    wrapper.adminListClientTemplates(operation).ensureSuccess();
