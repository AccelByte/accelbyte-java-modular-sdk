...
public class CreateChannelHandler implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.matchmaking.operations.matchmaking.CreateChannelHandler operation =
                    net.accelbyte.sdk.api.matchmaking.operations.matchmaking.CreateChannelHandler.builder()
                            ...
                            .build();
            final ModelsCreateChannelResponse response =
                    wrapper.createChannelHandler(operation).ensureSuccess();
