...
public class PublicGetSingleMatchmakingChannel implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.matchmaking.operations.matchmaking.PublicGetSingleMatchmakingChannel operation =
                    net.accelbyte.sdk.api.matchmaking.operations.matchmaking.PublicGetSingleMatchmakingChannel.builder()
                            .channelName(channelName)
                            .namespace(namespace)
                            .build();
            final ModelsChannelV1 response =
                    wrapper.publicGetSingleMatchmakingChannel(operation).ensureSuccess();
