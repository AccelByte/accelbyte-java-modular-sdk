...
public class GetSingleMemberRoleAdminV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.group.operations.group_roles.GetSingleMemberRoleAdminV1 operation =
            ...
            final ModelsMemberRoleResponseV1 response =
                    wrapper.getSingleMemberRoleAdminV1(operation).ensureSuccess();
