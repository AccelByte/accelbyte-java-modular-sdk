...
public class CreateContentDirect implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.ugc.operations.public_content_legacy.CreateContentDirect operation =
                    net.accelbyte.sdk.api.ugc.operations.public_content_legacy.CreateContentDirect.builder()
                            .channelId(channelId)
                            .namespace(namespace)
                            .userId(userId)
            ...
            final ModelsCreateContentResponse response =
                    wrapper.createContentDirect(operation).ensureSuccess();
