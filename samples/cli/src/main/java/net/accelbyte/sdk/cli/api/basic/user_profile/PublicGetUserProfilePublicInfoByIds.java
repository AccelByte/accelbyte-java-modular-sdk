...
public class PublicGetUserProfilePublicInfoByIds implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.basic.operations.user_profile.PublicGetUserProfilePublicInfoByIds operation =
            ...
            final List<UserProfilePublicInfo> response =
                    wrapper.publicGetUserProfilePublicInfoByIds(operation).ensureSuccess();
