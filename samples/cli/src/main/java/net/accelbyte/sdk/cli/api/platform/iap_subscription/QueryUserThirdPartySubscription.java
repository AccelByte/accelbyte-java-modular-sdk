...
public class QueryUserThirdPartySubscription implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.iap_subscription.QueryUserThirdPartySubscription operation =
                    net.accelbyte.sdk.api.platform.operations.iap_subscription.QueryUserThirdPartySubscription.builder()
                            .namespace(namespace)
                            .userId(userId)
            ...
            final ThirdPartyUserSubscriptionPagingSlicedResult response =
                    wrapper.queryUserThirdPartySubscription(operation).ensureSuccess();
