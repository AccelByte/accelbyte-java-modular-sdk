...
public class UpdatePaymentCallbackConfig implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.payment_callback_config.UpdatePaymentCallbackConfig operation =
                    net.accelbyte.sdk.api.platform.operations.payment_callback_config.UpdatePaymentCallbackConfig.builder()
                            ...
                            .build();
            final PaymentCallbackConfigInfo response =
                    wrapper.updatePaymentCallbackConfig(operation).ensureSuccess();
