...
public class AdminFindExtensionCategoryList implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.reporting.operations.admin_extension_categories_and_auto_moderation_actions.AdminFindExtensionCategoryList operation =
                    net.accelbyte.sdk.api.reporting.operations.admin_extension_categories_and_auto_moderation_actions.AdminFindExtensionCategoryList.builder()
                            .order(order)
                            .sortBy(sortBy)
                            .build();
            final RestapiExtensionCategoryListApiResponse response =
                    wrapper.adminFindExtensionCategoryList(operation).ensureSuccess();
