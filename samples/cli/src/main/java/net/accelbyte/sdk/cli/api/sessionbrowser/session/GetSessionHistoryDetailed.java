...
public class GetSessionHistoryDetailed implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.sessionbrowser.operations.session.GetSessionHistoryDetailed operation =
                    net.accelbyte.sdk.api.sessionbrowser.operations.session.GetSessionHistoryDetailed.builder()
                            .matchID(matchID)
                            .namespace(namespace)
                            .build();
            final List<ModelsGetSessionHistoryDetailedResponseItem> response =
                    wrapper.getSessionHistoryDetailed(operation).ensureSuccess();
