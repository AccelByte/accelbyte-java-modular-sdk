...
public class DebugMatchedPaymentProviderConfig implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.payment_config.DebugMatchedPaymentProviderConfig operation =
            ...
            final PaymentProviderConfigInfo response =
                    wrapper.debugMatchedPaymentProviderConfig(operation).ensureSuccess();
