...
public class PublicNormalizePaymentReturnUrl implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.payment_station.PublicNormalizePaymentReturnUrl operation =
                    net.accelbyte.sdk.api.platform.operations.payment_station.PublicNormalizePaymentReturnUrl.builder()
                            ...
                            .returnUrl(returnUrl)
                            .build();
                    wrapper.publicNormalizePaymentReturnUrl(operation).ensureSuccess();
