...
public class QueryUserEntitlements implements Callable<Integer> {
    ...
    @Option(names = {"--collectionId"}, description = "collectionId")
    String collectionId;
    ...
    @Option(names = {"--features"}, description = "features", split = ",")
    List<String> features;

    @Option(names = {"--fuzzyMatchName"}, description = "fuzzyMatchName")
    Boolean fuzzyMatchName;

    @Option(names = {"--ignoreActiveDate"}, description = "ignoreActiveDate")
    ...
    public Integer call() {
        try {
            ...
            final EntitlementPagingSlicedResult response =
                    wrapper.queryUserEntitlements(operation).ensureSuccess();
