...
public class HardDeleteLeaderboardAdminV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration_v3.HardDeleteLeaderboardAdminV3 operation =
                    net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration_v3.HardDeleteLeaderboardAdminV3.builder()
