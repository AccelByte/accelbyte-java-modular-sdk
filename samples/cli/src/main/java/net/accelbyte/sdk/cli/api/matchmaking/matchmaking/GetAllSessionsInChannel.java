...
public class GetAllSessionsInChannel implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.matchmaking.operations.matchmaking.GetAllSessionsInChannel operation =
                    net.accelbyte.sdk.api.matchmaking.operations.matchmaking.GetAllSessionsInChannel.builder()
                            .channelName(channelName)
                            .namespace(namespace)
                            .build();
            final List<ModelsMatchmakingResult> response =
                    wrapper.getAllSessionsInChannel(operation).ensureSuccess();
