...
public class AdminGetInputValidations implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.input_validations.AdminGetInputValidations operation =
            ...
            final ModelInputValidationsResponse response =
                    wrapper.adminGetInputValidations(operation).ensureSuccess();
