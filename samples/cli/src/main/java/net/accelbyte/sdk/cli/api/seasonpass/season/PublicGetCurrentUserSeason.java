...
public class PublicGetCurrentUserSeason implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.seasonpass.operations.season.PublicGetCurrentUserSeason operation =
            ...
            final ClaimableUserSeasonInfo response =
                    wrapper.publicGetCurrentUserSeason(operation).ensureSuccess();
