...
public class UpdateThirdPartyLoginPlatformDomainV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.third_party_credential.UpdateThirdPartyLoginPlatformDomainV3 operation =
            ...
            final ModelPlatformDomainResponse response =
                    wrapper.updateThirdPartyLoginPlatformDomainV3(operation).ensureSuccess();
