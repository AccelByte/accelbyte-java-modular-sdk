...
public class PublicUpgradeHeadlessAccountWithVerificationCodeV4 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.users_v4.PublicUpgradeHeadlessAccountWithVerificationCodeV4 operation =
            ...
            final AccountUserResponseV4 response =
                    wrapper.publicUpgradeHeadlessAccountWithVerificationCodeV4(operation).ensureSuccess();
