...
public class PublicUpdateUserNamespaceSlotMetadata implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.social.operations.slot.PublicUpdateUserNamespaceSlotMetadata operation =
                    net.accelbyte.sdk.api.social.operations.slot.PublicUpdateUserNamespaceSlotMetadata.builder()
                            ...
                            .build();
            final SlotInfo response =
                    wrapper.publicUpdateUserNamespaceSlotMetadata(operation).ensureSuccess();
