...
public class CreateLocalizedPolicyVersion implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace.CreateLocalizedPolicyVersion operation =
                    net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace.CreateLocalizedPolicyVersion.builder()
                            .namespace(namespace)
