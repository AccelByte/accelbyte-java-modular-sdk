...
public class PublicGetUserAccountDeletionStatus implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.gdpr.operations.data_deletion.PublicGetUserAccountDeletionStatus operation =
            ...
            final ModelsDeletionStatus response =
                    wrapper.publicGetUserAccountDeletionStatus(operation).ensureSuccess();
