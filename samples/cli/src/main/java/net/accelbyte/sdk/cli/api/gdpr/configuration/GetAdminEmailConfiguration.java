...
public class GetAdminEmailConfiguration implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.gdpr.operations.configuration.GetAdminEmailConfiguration operation =
                    net.accelbyte.sdk.api.gdpr.operations.configuration.GetAdminEmailConfiguration.builder()
                            .namespace(namespace)
                            .build();
            final List<String> response =
                    wrapper.getAdminEmailConfiguration(operation).ensureSuccess();
