...
public class GetLeaderboardConfigurationsPublicV3 implements Callable<Integer> {
    ...
    private static final Logger log = LogManager.getLogger(GetLeaderboardConfigurationsPublicV3.class);
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration_v3.GetLeaderboardConfigurationsPublicV3 operation =
                    net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration_v3.GetLeaderboardConfigurationsPublicV3.builder()
                            .namespace(namespace)
                            .isDeleted(isDeleted)
                            .limit(limit)
                            .offset(offset)
