...
public class RetrieveThirdPartyLoginPlatformCredentialV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.third_party_credential.RetrieveThirdPartyLoginPlatformCredentialV3 operation =
            ...
            final ModelThirdPartyLoginPlatformCredentialResponse response =
                    wrapper.retrieveThirdPartyLoginPlatformCredentialV3(operation).ensureSuccess();
