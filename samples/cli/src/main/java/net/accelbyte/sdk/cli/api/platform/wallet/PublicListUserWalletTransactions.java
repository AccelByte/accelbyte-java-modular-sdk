...
public class PublicListUserWalletTransactions implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.wallet.PublicListUserWalletTransactions operation =
            ...
            final WalletTransactionPagingSlicedResult response =
                    wrapper.publicListUserWalletTransactions(operation).ensureSuccess();
