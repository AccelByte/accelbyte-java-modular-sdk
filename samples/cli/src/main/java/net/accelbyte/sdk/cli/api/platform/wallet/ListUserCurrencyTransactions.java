...
public class ListUserCurrencyTransactions implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.wallet.ListUserCurrencyTransactions operation =
            ...
            final WalletTransactionPagingSlicedResult response =
                    wrapper.listUserCurrencyTransactions(operation).ensureSuccess();
