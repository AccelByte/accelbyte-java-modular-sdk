...
public class AdminUpdateGameSessionMember implements Callable<Integer> {
    ...
    @Option(names = {"--statusType"}, description = "statusType")
    String statusType;
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.session.operations.game_session.AdminUpdateGameSessionMember operation =
                    net.accelbyte.sdk.api.session.operations.game_session.AdminUpdateGameSessionMember.builder()
                            .memberId(memberId)
                            .namespace(namespace)
                            .sessionId(sessionId)
