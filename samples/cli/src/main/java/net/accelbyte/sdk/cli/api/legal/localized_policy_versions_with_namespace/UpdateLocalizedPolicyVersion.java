...
public class UpdateLocalizedPolicyVersion implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace.UpdateLocalizedPolicyVersion operation =
                    net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace.UpdateLocalizedPolicyVersion.builder()
            ...
            final UpdateLocalizedPolicyVersionResponse response =
                    wrapper.updateLocalizedPolicyVersion(operation).ensureSuccess();
