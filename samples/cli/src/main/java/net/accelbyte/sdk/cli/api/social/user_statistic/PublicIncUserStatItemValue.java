...
public class PublicIncUserStatItemValue implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.social.operations.user_statistic.PublicIncUserStatItemValue operation =
                    net.accelbyte.sdk.api.social.operations.user_statistic.PublicIncUserStatItemValue.builder()
                            ...
                            .build();
            final StatItemIncResult response =
                    wrapper.publicIncUserStatItemValue(operation).ensureSuccess();
