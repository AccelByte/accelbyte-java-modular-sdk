...
public class DeletePlayerRecordHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.public_player_record.DeletePlayerRecordHandlerV1 operation =
                    net.accelbyte.sdk.api.cloudsave.operations.public_player_record.DeletePlayerRecordHandlerV1.builder()
                            .key(key)
                            .namespace(namespace)
                            .userId(userId)
                            .build();
                    wrapper.deletePlayerRecordHandlerV1(operation).ensureSuccess();
