...
public class PlatformTokenRefreshV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.o_auth2_0_extension.PlatformTokenRefreshV3 operation =
                    net.accelbyte.sdk.api.iam.operations.o_auth2_0_extension.PlatformTokenRefreshV3.builder()
                            .platformId(platformId)
                            .platformToken(platformToken != null ? platformToken : null)
                            .build();
            final OauthmodelPlatformTokenRefreshResponseV3 response =
                    wrapper.platformTokenRefreshV3(operation).ensureSuccess();
