...
public class HardDeleteLeaderboardAdminV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration.HardDeleteLeaderboardAdminV1 operation =
                    net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration.HardDeleteLeaderboardAdminV1.builder()
                            .leaderboardCode(leaderboardCode)
                            .namespace(namespace)
                            .build();
                    wrapper.hardDeleteLeaderboardAdminV1(operation).ensureSuccess();
