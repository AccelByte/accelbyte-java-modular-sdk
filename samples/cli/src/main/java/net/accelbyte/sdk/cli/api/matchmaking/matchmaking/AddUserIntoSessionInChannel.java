...
public class AddUserIntoSessionInChannel implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.matchmaking.operations.matchmaking.AddUserIntoSessionInChannel operation =
                    net.accelbyte.sdk.api.matchmaking.operations.matchmaking.AddUserIntoSessionInChannel.builder()
                            ...
                            .build();
                    wrapper.addUserIntoSessionInChannel(operation).ensureSuccess();
