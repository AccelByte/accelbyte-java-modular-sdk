...
public class RetrieveActiveOIDCClientsPublicV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.third_party_credential.RetrieveActiveOIDCClientsPublicV3 operation =
                    net.accelbyte.sdk.api.iam.operations.third_party_credential.RetrieveActiveOIDCClientsPublicV3.builder()
                            .namespace(namespace)
                            .clientId(clientId)
                            .build();
            final List<ModelPublicThirdPartyPlatformInfo> response =
                    wrapper.retrieveActiveOIDCClientsPublicV3(operation).ensureSuccess();
