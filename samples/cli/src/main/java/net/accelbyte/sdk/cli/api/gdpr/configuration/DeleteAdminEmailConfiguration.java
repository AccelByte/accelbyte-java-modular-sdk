...
public class DeleteAdminEmailConfiguration implements Callable<Integer> {
    ...
    @Option(names = {"--emails"}, description = "emails", split = ",")
    List<String> emails;
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.gdpr.operations.configuration.DeleteAdminEmailConfiguration operation =
                    net.accelbyte.sdk.api.gdpr.operations.configuration.DeleteAdminEmailConfiguration.builder()
                            .namespace(namespace)
                            .emails(emails)
                            .build();
