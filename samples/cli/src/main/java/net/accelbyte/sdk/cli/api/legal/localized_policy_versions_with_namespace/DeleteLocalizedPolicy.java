...
public class DeleteLocalizedPolicy implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace.DeleteLocalizedPolicy operation =
                    net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace.DeleteLocalizedPolicy.builder()
                            .localizedPolicyVersionId(localizedPolicyVersionId)
                            .namespace(namespace)
                            .build();
                    wrapper.deleteLocalizedPolicy(operation).ensureSuccess();
