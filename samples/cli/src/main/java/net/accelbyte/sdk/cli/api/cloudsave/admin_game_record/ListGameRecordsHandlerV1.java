...
public class ListGameRecordsHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.admin_game_record.ListGameRecordsHandlerV1 operation =
                    net.accelbyte.sdk.api.cloudsave.operations.admin_game_record.ListGameRecordsHandlerV1.builder()
                            ...
                            .offset(offset)
                            .build();
            final ModelsListGameRecordKeysResponse response =
                    wrapper.listGameRecordsHandlerV1(operation).ensureSuccess();
