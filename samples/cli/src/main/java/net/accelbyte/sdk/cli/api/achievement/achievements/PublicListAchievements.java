...
public class PublicListAchievements implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.achievement.operations.achievements.PublicListAchievements operation =
                    net.accelbyte.sdk.api.achievement.operations.achievements.PublicListAchievements.builder()
                            ...
                            .language(language)
                            .build();
            final ModelsPublicAchievementsResponse response =
                    wrapper.publicListAchievements(operation).ensureSuccess();
