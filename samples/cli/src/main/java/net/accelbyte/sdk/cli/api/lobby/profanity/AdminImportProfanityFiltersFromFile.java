...
public class AdminImportProfanityFiltersFromFile implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.lobby.operations.profanity.AdminImportProfanityFiltersFromFile operation =
                    net.accelbyte.sdk.api.lobby.operations.profanity.AdminImportProfanityFiltersFromFile.builder()
                            ...
                            .build();
                    wrapper.adminImportProfanityFiltersFromFile(operation).ensureSuccess();
