...
public class GenerateTokenByNewHeadlessAccountV4 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.o_auth2_0_v4.GenerateTokenByNewHeadlessAccountV4 operation =
                    net.accelbyte.sdk.api.iam.operations.o_auth2_0_v4.GenerateTokenByNewHeadlessAccountV4.builder()
            ...
            final OauthmodelTokenResponseV3 response =
                    wrapper.generateTokenByNewHeadlessAccountV4(operation).ensureSuccess();
