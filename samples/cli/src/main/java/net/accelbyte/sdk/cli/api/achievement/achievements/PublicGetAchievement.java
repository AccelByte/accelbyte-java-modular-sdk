...
public class PublicGetAchievement implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.achievement.operations.achievements.PublicGetAchievement operation =
                    net.accelbyte.sdk.api.achievement.operations.achievements.PublicGetAchievement.builder()
                            .achievementCode(achievementCode)
                            .namespace(namespace)
                            .language(language)
                            .build();
            final ModelsPublicAchievementResponse response =
                    wrapper.publicGetAchievement(operation).ensureSuccess();
