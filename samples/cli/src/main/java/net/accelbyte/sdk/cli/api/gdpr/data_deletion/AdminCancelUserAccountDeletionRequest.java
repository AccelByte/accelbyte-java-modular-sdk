...
public class AdminCancelUserAccountDeletionRequest implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.gdpr.operations.data_deletion.AdminCancelUserAccountDeletionRequest operation =
                    net.accelbyte.sdk.api.gdpr.operations.data_deletion.AdminCancelUserAccountDeletionRequest.builder()
                            .namespace(namespace)
                            .userId(userId)
                            .build();
                    wrapper.adminCancelUserAccountDeletionRequest(operation).ensureSuccess();
