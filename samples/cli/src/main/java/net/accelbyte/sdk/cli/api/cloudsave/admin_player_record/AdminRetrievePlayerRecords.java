...
public class AdminRetrievePlayerRecords implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.admin_player_record.AdminRetrievePlayerRecords operation =
            ...
            final ModelsListPlayerRecordKeysResponse response =
                    wrapper.adminRetrievePlayerRecords(operation).ensureSuccess();
