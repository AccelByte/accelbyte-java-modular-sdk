...
public class SingleAdminUpdateContentS3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.ugc.operations.admin_content.SingleAdminUpdateContentS3 operation =
            ...
            final ModelsCreateContentResponse response =
                    wrapper.singleAdminUpdateContentS3(operation).ensureSuccess();
