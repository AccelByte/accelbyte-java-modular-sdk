...
public class AdminDeletePlayerRecordHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.admin_player_record.AdminDeletePlayerRecordHandlerV1 operation =
                    net.accelbyte.sdk.api.cloudsave.operations.admin_player_record.AdminDeletePlayerRecordHandlerV1.builder()
                            .key(key)
                            .namespace(namespace)
                            .userId(userId)
                            .build();
                    wrapper.adminDeletePlayerRecordHandlerV1(operation).ensureSuccess();
