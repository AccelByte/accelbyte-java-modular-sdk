...
public class AdminReconcileMaxActiveSession implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.session.operations.max_active.AdminReconcileMaxActiveSession operation =
                    net.accelbyte.sdk.api.session.operations.max_active.AdminReconcileMaxActiveSession.builder()
                            .name(name)
                            .namespace(namespace)
                            .body(new ObjectMapper().readValue(body, ModelsRequestReconcileMaxActiveSession.class)) 
                            .build();
