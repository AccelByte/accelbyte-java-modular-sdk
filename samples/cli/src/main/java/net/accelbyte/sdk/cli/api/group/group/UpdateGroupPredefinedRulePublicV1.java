...
public class UpdateGroupPredefinedRulePublicV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.group.operations.group.UpdateGroupPredefinedRulePublicV1 operation =
            ...
            final ModelsGroupResponseV1 response =
                    wrapper.updateGroupPredefinedRulePublicV1(operation).ensureSuccess();
