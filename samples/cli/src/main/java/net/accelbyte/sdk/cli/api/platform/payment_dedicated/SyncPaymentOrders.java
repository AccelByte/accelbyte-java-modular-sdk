...
public class SyncPaymentOrders implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.payment_dedicated.SyncPaymentOrders operation =
                    net.accelbyte.sdk.api.platform.operations.payment_dedicated.SyncPaymentOrders.builder()
                            .nextEvaluatedKey(nextEvaluatedKey)
                            .end(end)
                            .start(start)
                            .build();
            final PaymentOrderSyncResult response =
                    wrapper.syncPaymentOrders(operation).ensureSuccess();
