...
public class PublicGetEntitlementOwnershipToken implements Callable<Integer> {
    ...
    @Option(names = {"--appIds"}, description = "appIds", split = ",")
    List<String> appIds;

    @Option(names = {"--itemIds"}, description = "itemIds", split = ",")
    List<String> itemIds;

    @Option(names = {"--skus"}, description = "skus", split = ",")
    List<String> skus;
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.entitlement.PublicGetEntitlementOwnershipToken operation =
                    net.accelbyte.sdk.api.platform.operations.entitlement.PublicGetEntitlementOwnershipToken.builder()
                            ...
                            .skus(skus)
                            .build();
            final OwnershipToken response =
                    wrapper.publicGetEntitlementOwnershipToken(operation).ensureSuccess();
