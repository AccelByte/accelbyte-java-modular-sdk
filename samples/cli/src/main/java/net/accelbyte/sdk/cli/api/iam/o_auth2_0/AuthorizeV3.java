...
public class AuthorizeV3 implements Callable<Integer> {
    ...
    @Option(names = {"--blockedPlatformId"}, description = "blockedPlatformId")
    ...
    @Option(names = {"--loginWebBased"}, description = "loginWebBased")
    Boolean loginWebBased;

    @Option(names = {"--nonce"}, description = "nonce")
    String nonce;
    ...
    @Option(names = {"--useRedirectUriAsLoginUrlWhenLocked"}, description = "useRedirectUriAsLoginUrlWhenLocked")
        ...
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.o_auth2_0.AuthorizeV3 operation =
                    net.accelbyte.sdk.api.iam.operations.o_auth2_0.AuthorizeV3.builder()
                            ...
                            .build();
                    wrapper.authorizeV3(operation).ensureSuccess();
