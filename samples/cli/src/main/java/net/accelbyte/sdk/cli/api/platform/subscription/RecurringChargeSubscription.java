...
public class RecurringChargeSubscription implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.subscription.RecurringChargeSubscription operation =
                    net.accelbyte.sdk.api.platform.operations.subscription.RecurringChargeSubscription.builder()
                            .namespace(namespace)
                            .subscriptionId(subscriptionId)
                            .build();
            final RecurringChargeResult response =
                    wrapper.recurringChargeSubscription(operation).ensureSuccess();
