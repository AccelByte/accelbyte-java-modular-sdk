...
public class DeleteUserRankingAdminV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.DeleteUserRankingAdminV1 operation =
                    net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.DeleteUserRankingAdminV1.builder()
                            .leaderboardCode(leaderboardCode)
                            .namespace(namespace)
                            .userId(userId)
                            .build();
                    wrapper.deleteUserRankingAdminV1(operation).ensureSuccess();
