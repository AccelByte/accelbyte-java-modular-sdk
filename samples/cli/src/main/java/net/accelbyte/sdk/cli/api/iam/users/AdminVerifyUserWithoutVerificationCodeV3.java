...
public class AdminVerifyUserWithoutVerificationCodeV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.users.AdminVerifyUserWithoutVerificationCodeV3 operation =
                    net.accelbyte.sdk.api.iam.operations.users.AdminVerifyUserWithoutVerificationCodeV3.builder()
                            .namespace(namespace)
                            .userId(userId)
                            .build();
                    wrapper.adminVerifyUserWithoutVerificationCodeV3(operation).ensureSuccess();
