...
public class ListAllQueue implements Callable<Integer> {
    ...
    @Option(names = {"--excludeUploading"}, description = "excludeUploading")
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.dsartifact.operations.artifact_upload_process_queue.ListAllQueue operation =
                    net.accelbyte.sdk.api.dsartifact.operations.artifact_upload_process_queue.ListAllQueue.builder()
                            .namespace(namespace)
            ...
            final ModelsListAllQueueResponse response =
                    wrapper.listAllQueue(operation).ensureSuccess();
