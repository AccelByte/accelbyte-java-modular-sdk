...
public class AdminChatHistory implements Callable<Integer> {
    ...
    @Option(names = {"--chatId"}, description = "chatId", split = ",")
    List<String> chatId;
    ...
    @Option(names = {"--topic"}, description = "topic", split = ",")
    List<String> topic;

    @Option(names = {"--unfiltered"}, description = "unfiltered")
    Boolean unfiltered;
    ...
    public Integer call() {
        try {
            ...
            final ModelsChatMessageWithPaginationResponse response =
                    wrapper.adminChatHistory(operation).ensureSuccess();
