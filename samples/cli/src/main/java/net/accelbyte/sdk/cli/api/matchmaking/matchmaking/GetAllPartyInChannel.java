...
public class GetAllPartyInChannel implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.matchmaking.operations.matchmaking.GetAllPartyInChannel operation =
                    net.accelbyte.sdk.api.matchmaking.operations.matchmaking.GetAllPartyInChannel.builder()
                            .channelName(channelName)
                            .namespace(namespace)
                            .build();
            final List<ModelsMatchingParty> response =
                    wrapper.getAllPartyInChannel(operation).ensureSuccess();
