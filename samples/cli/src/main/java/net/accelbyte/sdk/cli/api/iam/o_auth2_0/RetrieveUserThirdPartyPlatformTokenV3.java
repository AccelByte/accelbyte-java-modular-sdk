...
public class RetrieveUserThirdPartyPlatformTokenV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.o_auth2_0.RetrieveUserThirdPartyPlatformTokenV3 operation =
            ...
            final OauthmodelTokenThirdPartyResponse response =
                    wrapper.retrieveUserThirdPartyPlatformTokenV3(operation).ensureSuccess();
