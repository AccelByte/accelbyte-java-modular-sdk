...
public class GetActiveCustomGameSessions implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.sessionbrowser.operations.session.GetActiveCustomGameSessions operation =
            ...
            final ModelsActiveCustomGameResponse response =
                    wrapper.getActiveCustomGameSessions(operation).ensureSuccess();
