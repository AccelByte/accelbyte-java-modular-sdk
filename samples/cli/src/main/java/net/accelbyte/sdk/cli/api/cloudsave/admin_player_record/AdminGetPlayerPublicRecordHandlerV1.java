...
public class AdminGetPlayerPublicRecordHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.admin_player_record.AdminGetPlayerPublicRecordHandlerV1 operation =
            ...
            final ModelsPlayerRecordResponse response =
                    wrapper.adminGetPlayerPublicRecordHandlerV1(operation).ensureSuccess();
