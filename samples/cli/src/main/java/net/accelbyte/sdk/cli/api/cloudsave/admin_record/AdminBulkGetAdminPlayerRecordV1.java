...
public class AdminBulkGetAdminPlayerRecordV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.admin_record.AdminBulkGetAdminPlayerRecordV1 operation =
                    net.accelbyte.sdk.api.cloudsave.operations.admin_record.AdminBulkGetAdminPlayerRecordV1.builder()
                            .namespace(namespace)
                            .userId(userId)
                            .body(new ObjectMapper().readValue(body, ModelsBulkGetAdminPlayerRecordRequest.class)) 
                            .build();
