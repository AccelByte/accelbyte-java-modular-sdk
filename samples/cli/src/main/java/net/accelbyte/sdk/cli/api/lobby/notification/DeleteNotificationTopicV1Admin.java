...
public class DeleteNotificationTopicV1Admin implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.lobby.operations.notification.DeleteNotificationTopicV1Admin operation =
                    net.accelbyte.sdk.api.lobby.operations.notification.DeleteNotificationTopicV1Admin.builder()
                            .namespace(namespace)
                            .topicName(topicName)
                            .build();
                    wrapper.deleteNotificationTopicV1Admin(operation).ensureSuccess();
