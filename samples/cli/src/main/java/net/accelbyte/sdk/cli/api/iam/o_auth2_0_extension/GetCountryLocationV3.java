...
public class GetCountryLocationV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.o_auth2_0_extension.GetCountryLocationV3 operation =
                    net.accelbyte.sdk.api.iam.operations.o_auth2_0_extension.GetCountryLocationV3.builder()
                            .build();
            final OauthmodelCountryLocationResponse response =
                    wrapper.getCountryLocationV3(operation).ensureSuccess();
