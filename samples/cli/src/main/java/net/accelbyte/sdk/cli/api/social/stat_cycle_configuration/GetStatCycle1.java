...
public class GetStatCycle1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.social.operations.stat_cycle_configuration.GetStatCycle1 operation =
                    net.accelbyte.sdk.api.social.operations.stat_cycle_configuration.GetStatCycle1.builder()
                            .cycleId(cycleId)
                            .namespace(namespace)
                            .build();
            final StatCycleInfo response =
                    wrapper.getStatCycle1(operation).ensureSuccess();
