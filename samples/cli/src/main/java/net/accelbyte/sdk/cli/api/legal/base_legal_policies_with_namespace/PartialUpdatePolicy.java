...
public class PartialUpdatePolicy implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.base_legal_policies_with_namespace.PartialUpdatePolicy operation =
                    net.accelbyte.sdk.api.legal.operations.base_legal_policies_with_namespace.PartialUpdatePolicy.builder()
                            .basePolicyId(basePolicyId)
                            .namespace(namespace)
                            .body(new ObjectMapper().readValue(body, UpdateBasePolicyRequestV2.class)) 
                            .build();
            final UpdateBasePolicyResponse response =
                    wrapper.partialUpdatePolicy(operation).ensureSuccess();
