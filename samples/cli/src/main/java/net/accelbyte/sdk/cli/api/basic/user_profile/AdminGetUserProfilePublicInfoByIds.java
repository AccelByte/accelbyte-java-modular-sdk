...
public class AdminGetUserProfilePublicInfoByIds implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.basic.operations.user_profile.AdminGetUserProfilePublicInfoByIds operation =
            ...
            final List<UserProfilePublicInfo> response =
                    wrapper.adminGetUserProfilePublicInfoByIds(operation).ensureSuccess();
