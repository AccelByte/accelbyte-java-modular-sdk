...
public class GetActiveMatchmakingGameSessions implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.sessionbrowser.operations.session.GetActiveMatchmakingGameSessions operation =
            ...
            final ModelsActiveMatchmakingGameResponse response =
                    wrapper.getActiveMatchmakingGameSessions(operation).ensureSuccess();
