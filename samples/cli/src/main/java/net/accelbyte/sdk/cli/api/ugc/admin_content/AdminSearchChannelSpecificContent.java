...
public class AdminSearchChannelSpecificContent implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.ugc.operations.admin_content.AdminSearchChannelSpecificContent operation =
            ...
            final ModelsPaginatedContentDownloadResponse response =
                    wrapper.adminSearchChannelSpecificContent(operation).ensureSuccess();
