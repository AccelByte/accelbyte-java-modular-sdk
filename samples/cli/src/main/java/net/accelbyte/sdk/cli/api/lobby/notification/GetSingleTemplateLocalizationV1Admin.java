...
public class GetSingleTemplateLocalizationV1Admin implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.lobby.operations.notification.GetSingleTemplateLocalizationV1Admin operation =
                    net.accelbyte.sdk.api.lobby.operations.notification.GetSingleTemplateLocalizationV1Admin.builder()
                            .namespace(namespace)
                            .templateLanguage(templateLanguage)
                            .templateSlug(templateSlug)
                            .build();
            final ModelLocalization response =
                    wrapper.getSingleTemplateLocalizationV1Admin(operation).ensureSuccess();
