...
public class PutPlayerPublicRecordHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.public_player_record.PutPlayerPublicRecordHandlerV1 operation =
            ...
            final ModelsPlayerRecordResponse response =
                    wrapper.putPlayerPublicRecordHandlerV1(operation).ensureSuccess();
