...
public class GetUserRankingAdminV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data_v3.GetUserRankingAdminV3 operation =
                    net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data_v3.GetUserRankingAdminV3.builder()
                            .leaderboardCode(leaderboardCode)
                            .namespace(namespace)
                            .userId(userId)
                            .build();
            final ModelsUserRankingResponseV3 response =
                    wrapper.getUserRankingAdminV3(operation).ensureSuccess();
