...
public class GetPaymentPublicConfig implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.payment_station.GetPaymentPublicConfig operation =
            ...
            final Map<String, ?> response =
                    wrapper.getPaymentPublicConfig(operation).ensureSuccess();
