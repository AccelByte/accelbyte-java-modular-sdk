...
public class PublicGetUserEntitlementOwnershipBySku implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.entitlement.PublicGetUserEntitlementOwnershipBySku operation =
            ...
            final TimedOwnership response =
                    wrapper.publicGetUserEntitlementOwnershipBySku(operation).ensureSuccess();
