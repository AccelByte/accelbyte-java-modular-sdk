...
public class DeleteThirdPartyLoginPlatformDomainV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.third_party_credential.DeleteThirdPartyLoginPlatformDomainV3 operation =
                    net.accelbyte.sdk.api.iam.operations.third_party_credential.DeleteThirdPartyLoginPlatformDomainV3.builder()
                            ...
                            .build();
                    wrapper.deleteThirdPartyLoginPlatformDomainV3(operation).ensureSuccess();
