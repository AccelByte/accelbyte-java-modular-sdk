...
public class AddSSOLoginPlatformCredential implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.sso_credential.AddSSOLoginPlatformCredential operation =
            ...
            final ModelSSOPlatformCredentialResponse response =
                    wrapper.addSSOLoginPlatformCredential(operation).ensureSuccess();
