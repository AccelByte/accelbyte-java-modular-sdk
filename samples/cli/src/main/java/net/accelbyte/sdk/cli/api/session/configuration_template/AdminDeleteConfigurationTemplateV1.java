...
public class AdminDeleteConfigurationTemplateV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.session.operations.configuration_template.AdminDeleteConfigurationTemplateV1 operation =
                    net.accelbyte.sdk.api.session.operations.configuration_template.AdminDeleteConfigurationTemplateV1.builder()
                            .name(name)
                            .namespace(namespace)
                            .build();
                    wrapper.adminDeleteConfigurationTemplateV1(operation).ensureSuccess();
