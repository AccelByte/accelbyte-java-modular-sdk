...
public class AdminDownloadContentPreview implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.ugc.operations.admin_content.AdminDownloadContentPreview operation =
            ...
            final ModelsGetContentPreviewResponse response =
                    wrapper.adminDownloadContentPreview(operation).ensureSuccess();
