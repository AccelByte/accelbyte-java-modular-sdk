...
public class AdminGetUserAccountDeletionRequest implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.gdpr.operations.data_deletion.AdminGetUserAccountDeletionRequest operation =
                    net.accelbyte.sdk.api.gdpr.operations.data_deletion.AdminGetUserAccountDeletionRequest.builder()
                            .namespace(namespace)
                            .userId(userId)
                            .build();
            final ModelsDeletionData response =
                    wrapper.adminGetUserAccountDeletionRequest(operation).ensureSuccess();
