...
public class PublicRevokeGameSessionCode implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.session.operations.game_session.PublicRevokeGameSessionCode operation =
                    net.accelbyte.sdk.api.session.operations.game_session.PublicRevokeGameSessionCode.builder()
                            .namespace(namespace)
                            .sessionId(sessionId)
                            .build();
                    wrapper.publicRevokeGameSessionCode(operation).ensureSuccess();
