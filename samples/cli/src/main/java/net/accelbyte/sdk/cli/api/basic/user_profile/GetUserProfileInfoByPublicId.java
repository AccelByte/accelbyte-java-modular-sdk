...
public class GetUserProfileInfoByPublicId implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.basic.operations.user_profile.GetUserProfileInfoByPublicId operation =
                    net.accelbyte.sdk.api.basic.operations.user_profile.GetUserProfileInfoByPublicId.builder()
                            .namespace(namespace)
                            .publicId(publicId)
                            .build();
            final UserProfileInfo response =
                    wrapper.getUserProfileInfoByPublicId(operation).ensureSuccess();
