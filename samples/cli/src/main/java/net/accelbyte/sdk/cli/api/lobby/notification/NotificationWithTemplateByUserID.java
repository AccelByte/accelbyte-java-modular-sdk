...
public class NotificationWithTemplateByUserID implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.lobby.operations.notification.NotificationWithTemplateByUserID operation =
                    net.accelbyte.sdk.api.lobby.operations.notification.NotificationWithTemplateByUserID.builder()
                            ...
                            .build();
                    wrapper.notificationWithTemplateByUserID(operation).ensureSuccess();
