...
public class InitiateGroupConfigurationAdminV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.group.operations.configuration.InitiateGroupConfigurationAdminV1 operation =
            ...
            final ModelsCreateGroupConfigurationResponseV1 response =
                    wrapper.initiateGroupConfigurationAdminV1(operation).ensureSuccess();
