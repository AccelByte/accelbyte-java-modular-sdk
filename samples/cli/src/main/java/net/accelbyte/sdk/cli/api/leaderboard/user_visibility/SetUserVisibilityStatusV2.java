...
public class SetUserVisibilityStatusV2 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.user_visibility.SetUserVisibilityStatusV2 operation =
            ...
            final ModelsGetUserVisibilityResponse response =
                    wrapper.setUserVisibilityStatusV2(operation).ensureSuccess();
