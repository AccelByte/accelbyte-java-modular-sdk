...
public class PublicUpdateInsertSessionStorage implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.session.operations.session_storage.PublicUpdateInsertSessionStorage operation =
                    net.accelbyte.sdk.api.session.operations.session_storage.PublicUpdateInsertSessionStorage.builder()
                            .namespace(namespace)
                            .sessionId(sessionId)
                            .userId(userId)
            ...
            final Map<String, ?> response =
                    wrapper.publicUpdateInsertSessionStorage(operation).ensureSuccess();
