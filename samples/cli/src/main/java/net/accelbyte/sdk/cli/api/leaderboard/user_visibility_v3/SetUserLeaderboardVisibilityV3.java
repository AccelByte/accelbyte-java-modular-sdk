...
public class SetUserLeaderboardVisibilityV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.user_visibility_v3.SetUserLeaderboardVisibilityV3 operation =
                    net.accelbyte.sdk.api.leaderboard.operations.user_visibility_v3.SetUserLeaderboardVisibilityV3.builder()
