...
public class PublicGetAllMatchmakingChannel implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.matchmaking.operations.matchmaking.PublicGetAllMatchmakingChannel operation =
                    net.accelbyte.sdk.api.matchmaking.operations.matchmaking.PublicGetAllMatchmakingChannel.builder()
                            .namespace(namespace)
                            .build();
            final List<ModelsChannelV1> response =
                    wrapper.publicGetAllMatchmakingChannel(operation).ensureSuccess();
