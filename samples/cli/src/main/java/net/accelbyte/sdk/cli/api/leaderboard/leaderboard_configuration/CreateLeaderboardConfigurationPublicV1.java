...
public class CreateLeaderboardConfigurationPublicV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration.CreateLeaderboardConfigurationPublicV1 operation =
            ...
            final ModelsLeaderboardConfigReq response =
                    wrapper.createLeaderboardConfigurationPublicV1(operation).ensureSuccess();
