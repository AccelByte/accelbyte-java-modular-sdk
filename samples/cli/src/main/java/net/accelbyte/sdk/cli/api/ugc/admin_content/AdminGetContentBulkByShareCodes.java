...
public class AdminGetContentBulkByShareCodes implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.ugc.operations.admin_content.AdminGetContentBulkByShareCodes operation =
                    net.accelbyte.sdk.api.ugc.operations.admin_content.AdminGetContentBulkByShareCodes.builder()
                            .namespace(namespace)
            ...
            final List<ModelsContentDownloadResponse> response =
                    wrapper.adminGetContentBulkByShareCodes(operation).ensureSuccess();
