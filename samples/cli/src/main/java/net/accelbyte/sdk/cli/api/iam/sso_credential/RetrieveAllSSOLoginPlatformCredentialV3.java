...
public class RetrieveAllSSOLoginPlatformCredentialV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.sso_credential.RetrieveAllSSOLoginPlatformCredentialV3 operation =
            ...
            final List<ModelSSOPlatformCredentialResponse> response =
                    wrapper.retrieveAllSSOLoginPlatformCredentialV3(operation).ensureSuccess();
