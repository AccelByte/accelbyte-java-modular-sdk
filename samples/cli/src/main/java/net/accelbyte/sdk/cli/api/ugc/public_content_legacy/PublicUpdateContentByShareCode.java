...
public class PublicUpdateContentByShareCode implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.ugc.operations.public_content_legacy.PublicUpdateContentByShareCode operation =
                    net.accelbyte.sdk.api.ugc.operations.public_content_legacy.PublicUpdateContentByShareCode.builder()
                            .channelId(channelId)
                            .namespace(namespace)
                            .shareCode(shareCode)
                            .userId(userId)
            ...
            final ModelsCreateContentResponse response =
                    wrapper.publicUpdateContentByShareCode(operation).ensureSuccess();
