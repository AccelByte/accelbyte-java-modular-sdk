...
public class AdminUpdateProfileUpdateStrategyV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.profile_update_strategy.AdminUpdateProfileUpdateStrategyV3 operation =
                    net.accelbyte.sdk.api.iam.operations.profile_update_strategy.AdminUpdateProfileUpdateStrategyV3.builder()
                            .namespace(namespace)
                            .field(field)
                            .body(new ObjectMapper().readValue(body, ModelUpdateProfileUpdateStrategyConfigRequest.class)) 
                            .build();
            final ModelSimpleProfileUpdateStrategyConfigs response =
                    wrapper.adminUpdateProfileUpdateStrategyV3(operation).ensureSuccess();
