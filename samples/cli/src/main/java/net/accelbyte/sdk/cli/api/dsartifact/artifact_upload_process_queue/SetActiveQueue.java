...
public class SetActiveQueue implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.dsartifact.operations.artifact_upload_process_queue.SetActiveQueue operation =
                    net.accelbyte.sdk.api.dsartifact.operations.artifact_upload_process_queue.SetActiveQueue.builder()
                            .nodeIP(nodeIP)
                            .podName(podName)
                            .build();
                    wrapper.setActiveQueue(operation).ensureSuccess();
