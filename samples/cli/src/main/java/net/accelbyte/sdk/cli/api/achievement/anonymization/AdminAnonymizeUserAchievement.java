...
public class AdminAnonymizeUserAchievement implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.achievement.operations.anonymization.AdminAnonymizeUserAchievement operation =
                    net.accelbyte.sdk.api.achievement.operations.anonymization.AdminAnonymizeUserAchievement.builder()
                            .namespace(namespace)
                            .userId(userId)
                            .build();
                    wrapper.adminAnonymizeUserAchievement(operation).ensureSuccess();
