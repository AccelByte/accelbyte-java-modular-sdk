...
public class GetPrivateCustomAttributesInfo implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.basic.operations.user_profile.GetPrivateCustomAttributesInfo operation =
                    net.accelbyte.sdk.api.basic.operations.user_profile.GetPrivateCustomAttributesInfo.builder()
                            .namespace(namespace)
                            .userId(userId)
                            .build();
            final Map<String, ?> response =
                    wrapper.getPrivateCustomAttributesInfo(operation).ensureSuccess();
