...
public class AdminUnlockAchievement implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.achievement.operations.user_achievements.AdminUnlockAchievement operation =
                    net.accelbyte.sdk.api.achievement.operations.user_achievements.AdminUnlockAchievement.builder()
                            .achievementCode(achievementCode)
                            .namespace(namespace)
                            .userId(userId)
                            .build();
                    wrapper.adminUnlockAchievement(operation).ensureSuccess();
