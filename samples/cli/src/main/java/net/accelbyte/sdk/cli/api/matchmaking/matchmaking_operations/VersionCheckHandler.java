...
public class VersionCheckHandler implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.matchmaking.operations.matchmaking_operations.VersionCheckHandler operation =
                    net.accelbyte.sdk.api.matchmaking.operations.matchmaking_operations.VersionCheckHandler.builder()
                            .build();
                    wrapper.versionCheckHandler(operation).ensureSuccess();
