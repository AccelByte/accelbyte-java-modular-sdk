...
public class CreatePolicyUnderBasePolicy implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.base_legal_policies_with_namespace.CreatePolicyUnderBasePolicy operation =
                    net.accelbyte.sdk.api.legal.operations.base_legal_policies_with_namespace.CreatePolicyUnderBasePolicy.builder()
                            .basePolicyId(basePolicyId)
                            .namespace(namespace)
                            .body(new ObjectMapper().readValue(body, CreatePolicyRequest.class)) 
                            .build();
            final CreatePolicyResponse response =
                    wrapper.createPolicyUnderBasePolicy(operation).ensureSuccess();
