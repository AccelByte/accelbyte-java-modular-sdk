...
public class AdminListUserAchievements implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.achievement.operations.user_achievements.AdminListUserAchievements operation =
                    net.accelbyte.sdk.api.achievement.operations.user_achievements.AdminListUserAchievements.builder()
                            .namespace(namespace)
                            .userId(userId)
                            .limit(limit)
                            .offset(offset)
