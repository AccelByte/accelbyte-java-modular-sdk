...
public class CreatePolicy implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.base_legal_policies_with_namespace.CreatePolicy operation =
                    net.accelbyte.sdk.api.legal.operations.base_legal_policies_with_namespace.CreatePolicy.builder()
                            .namespace(namespace)
                            .body(new ObjectMapper().readValue(body, CreateBasePolicyRequestV2.class)) 
                            .build();
            final CreateBasePolicyResponse response =
                    wrapper.createPolicy(operation).ensureSuccess();
