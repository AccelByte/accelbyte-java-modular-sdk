...
public class RetrieveAllPolicyTypes implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.base_legal_policies_with_namespace.RetrieveAllPolicyTypes operation =
                    net.accelbyte.sdk.api.legal.operations.base_legal_policies_with_namespace.RetrieveAllPolicyTypes.builder()
                            .namespace(namespace)
                            .offset(offset)
                            .limit(limit)
                            .build();
            final List<RetrievePolicyTypeResponse> response =
                    wrapper.retrieveAllPolicyTypes(operation).ensureSuccess();
