...
public class AdminQueryParties implements Callable<Integer> {
    ...
    @Option(names = {"--configurationName"}, description = "configurationName")
    String configurationName;

    @Option(names = {"--fromTime"}, description = "fromTime")
    String fromTime;

    @Option(names = {"--isSoftDeleted"}, description = "isSoftDeleted")
    String isSoftDeleted;

    @Option(names = {"--joinability"}, description = "joinability")
    String joinability;

    @Option(names = {"--key"}, description = "key")
    String key;

    @Option(names = {"--leaderID"}, description = "leaderID")
    String leaderID;

    @Option(names = {"--limit"}, description = "limit")
    Integer limit;

    @Option(names = {"--memberID"}, description = "memberID")
    String memberID;

    @Option(names = {"--memberStatus"}, description = "memberStatus")
    String memberStatus;
    ...
    @Option(names = {"--toTime"}, description = "toTime")
    String toTime;

    @Option(names = {"--value"}, description = "value")
    String value;
        ...
        try {
            ...
            final net.accelbyte.sdk.api.session.operations.party.AdminQueryParties operation =
                    net.accelbyte.sdk.api.session.operations.party.AdminQueryParties.builder()
                            ...
                            .value(value)
                            .build();
            final ApimodelsPartyQueryResponse response =
                    wrapper.adminQueryParties(operation).ensureSuccess();
