...
public class GetHealthcheckInfo implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.matchmaking.operations.matchmaking_operations.GetHealthcheckInfo operation =
                    net.accelbyte.sdk.api.matchmaking.operations.matchmaking_operations.GetHealthcheckInfo.builder()
                            .build();
                    wrapper.getHealthcheckInfo(operation).ensureSuccess();
