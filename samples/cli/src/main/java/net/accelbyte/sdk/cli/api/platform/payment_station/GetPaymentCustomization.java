...
public class GetPaymentCustomization implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.payment_station.GetPaymentCustomization operation =
                    net.accelbyte.sdk.api.platform.operations.payment_station.GetPaymentCustomization.builder()
                            ...
                            .region(region)
                            .build();
            final Customization response =
                    wrapper.getPaymentCustomization(operation).ensureSuccess();
