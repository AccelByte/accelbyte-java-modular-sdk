...
public class GetXboxEntitlementOwnership implements Callable<Integer> {
    ...
    @Option(names = {"--productSku"}, description = "productSku")
    String productSku;
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.platform.GetXboxEntitlementOwnership operation =
                    net.accelbyte.sdk.api.platform.operations.platform.GetXboxEntitlementOwnership.builder()
                            .namespace(namespace)
