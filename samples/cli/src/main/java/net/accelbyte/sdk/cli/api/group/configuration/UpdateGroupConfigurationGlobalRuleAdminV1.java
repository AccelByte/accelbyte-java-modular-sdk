...
public class UpdateGroupConfigurationGlobalRuleAdminV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.group.operations.configuration.UpdateGroupConfigurationGlobalRuleAdminV1 operation =
            ...
            final ModelsUpdateGroupConfigurationResponseV1 response =
                    wrapper.updateGroupConfigurationGlobalRuleAdminV1(operation).ensureSuccess();
