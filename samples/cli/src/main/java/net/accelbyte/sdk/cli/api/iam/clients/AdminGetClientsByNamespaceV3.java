...
public class AdminGetClientsByNamespaceV3 implements Callable<Integer> {
    ...
    @Option(names = {"--clientName"}, description = "clientName")
    String clientName;

    @Option(names = {"--clientType"}, description = "clientType")
    String clientType;
        ...
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.clients.AdminGetClientsByNamespaceV3 operation =
                    net.accelbyte.sdk.api.iam.operations.clients.AdminGetClientsByNamespaceV3.builder()
                            ...
                            .build();
            final ClientmodelClientsV3Response response =
                    wrapper.adminGetClientsByNamespaceV3(operation).ensureSuccess();
