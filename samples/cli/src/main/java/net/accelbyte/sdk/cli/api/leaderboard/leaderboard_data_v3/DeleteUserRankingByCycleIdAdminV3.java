...
public class DeleteUserRankingByCycleIdAdminV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data_v3.DeleteUserRankingByCycleIdAdminV3 operation =
                    net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data_v3.DeleteUserRankingByCycleIdAdminV3.builder()
                            .cycleId(cycleId)
                            .leaderboardCode(leaderboardCode)
                            .namespace(namespace)
                            .userId(userId)
                            .build();
                    wrapper.deleteUserRankingByCycleIdAdminV3(operation).ensureSuccess();
