...
public class SetDefaultPolicy1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace.SetDefaultPolicy1 operation =
                    net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace.SetDefaultPolicy1.builder()
                            .localizedPolicyVersionId(localizedPolicyVersionId)
                            .namespace(namespace)
                            .build();
                    wrapper.setDefaultPolicy1(operation).ensureSuccess();
