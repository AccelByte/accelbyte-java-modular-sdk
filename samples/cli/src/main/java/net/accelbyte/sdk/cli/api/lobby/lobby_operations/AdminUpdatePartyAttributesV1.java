...
public class AdminUpdatePartyAttributesV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.lobby.operations.lobby_operations.AdminUpdatePartyAttributesV1 operation =
                    net.accelbyte.sdk.api.lobby.operations.lobby_operations.AdminUpdatePartyAttributesV1.builder()
                            ...
                            .build();
            final ModelsPartyData response =
                    wrapper.adminUpdatePartyAttributesV1(operation).ensureSuccess();
