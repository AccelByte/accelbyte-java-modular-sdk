...
public class DeleteGameBinaryRecordTTLConfig implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.ttl_config.DeleteGameBinaryRecordTTLConfig operation =
                    net.accelbyte.sdk.api.cloudsave.operations.ttl_config.DeleteGameBinaryRecordTTLConfig.builder()
                            .key(key)
                            .namespace(namespace)
                            .build();
                    wrapper.deleteGameBinaryRecordTTLConfig(operation).ensureSuccess();
