...
public class BulkGetGameBinaryRecordV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.public_game_binary_record.BulkGetGameBinaryRecordV1 operation =
                    net.accelbyte.sdk.api.cloudsave.operations.public_game_binary_record.BulkGetGameBinaryRecordV1.builder()
                            .namespace(namespace)
            ...
            final ModelsBulkGetGameBinaryRecordResponse response =
                    wrapper.bulkGetGameBinaryRecordV1(operation).ensureSuccess();
