...
public class UpdateGroupCustomAttributesPublicV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.group.operations.group.UpdateGroupCustomAttributesPublicV1 operation =
            ...
            final ModelsGroupResponseV1 response =
                    wrapper.updateGroupCustomAttributesPublicV1(operation).ensureSuccess();
