...
public class QueryFulfillmentHistories implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.fulfillment.QueryFulfillmentHistories operation =
            ...
            final FulfillmentHistoryPagingSlicedResult response =
                    wrapper.queryFulfillmentHistories(operation).ensureSuccess();
