...
public class AdminUploadXBoxCertificate implements Callable<Integer> {
    ...
    @Option(names = {"--certname"}, description = "certname")
    String certname;
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.session.operations.certificate.AdminUploadXBoxCertificate operation =
                    net.accelbyte.sdk.api.session.operations.certificate.AdminUploadXBoxCertificate.builder()
                            .namespace(namespace)
            ...
            final ModelsPlatformCredentials response =
                    wrapper.adminUploadXBoxCertificate(operation).ensureSuccess();
