    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.match2.operations.config.AdminGetAllConfigV1 operation =
                    net.accelbyte.sdk.api.match2.operations.config.AdminGetAllConfigV1.builder()
                            .build();
            final ApiNamespaceConfigList response =
                    wrapper.adminGetAllConfigV1(operation).ensureSuccess();
