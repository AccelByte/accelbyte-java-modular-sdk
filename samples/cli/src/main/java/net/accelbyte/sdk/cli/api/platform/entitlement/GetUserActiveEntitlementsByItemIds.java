...
public class GetUserActiveEntitlementsByItemIds implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.entitlement.GetUserActiveEntitlementsByItemIds operation =
                    net.accelbyte.sdk.api.platform.operations.entitlement.GetUserActiveEntitlementsByItemIds.builder()
                            .namespace(namespace)
                            .userId(userId)
                            .ids(ids)
                            .platform(platform)
            ...
            final List<EntitlementInfo> response =
                    wrapper.getUserActiveEntitlementsByItemIds(operation).ensureSuccess();
