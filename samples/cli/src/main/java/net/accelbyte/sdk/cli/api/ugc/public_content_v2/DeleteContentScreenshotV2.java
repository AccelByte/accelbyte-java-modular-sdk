...
public class DeleteContentScreenshotV2 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.ugc.operations.public_content_v2.DeleteContentScreenshotV2 operation =
                    net.accelbyte.sdk.api.ugc.operations.public_content_v2.DeleteContentScreenshotV2.builder()
                            .contentId(contentId)
                            .namespace(namespace)
