...
public class AdminPutGameRecordConcurrentHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.admin_concurrent_record.AdminPutGameRecordConcurrentHandlerV1 operation =
                    net.accelbyte.sdk.api.cloudsave.operations.admin_concurrent_record.AdminPutGameRecordConcurrentHandlerV1.builder()
                            ...
                            .build();
                    wrapper.adminPutGameRecordConcurrentHandlerV1(operation).ensureSuccess();
