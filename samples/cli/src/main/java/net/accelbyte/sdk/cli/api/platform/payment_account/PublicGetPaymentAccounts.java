...
public class PublicGetPaymentAccounts implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.payment_account.PublicGetPaymentAccounts operation =
            ...
            final List<net.accelbyte.sdk.api.platform.models.PaymentAccount> response =
                    wrapper.publicGetPaymentAccounts(operation).ensureSuccess();
