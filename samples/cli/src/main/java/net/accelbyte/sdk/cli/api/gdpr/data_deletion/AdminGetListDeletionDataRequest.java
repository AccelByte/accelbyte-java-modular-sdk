...
public class AdminGetListDeletionDataRequest implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.gdpr.operations.data_deletion.AdminGetListDeletionDataRequest operation =
            ...
            final ModelsListDeletionDataResponse response =
                    wrapper.adminGetListDeletionDataRequest(operation).ensureSuccess();
