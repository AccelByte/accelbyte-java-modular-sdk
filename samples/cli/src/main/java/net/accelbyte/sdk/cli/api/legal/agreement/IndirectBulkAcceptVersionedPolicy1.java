...
public class IndirectBulkAcceptVersionedPolicy1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.agreement.IndirectBulkAcceptVersionedPolicy1 operation =
            ...
            final AcceptAgreementResponse response =
                    wrapper.indirectBulkAcceptVersionedPolicy1(operation).ensureSuccess();
