...
public class TokenGrantV4 implements Callable<Integer> {
    ...
    @Option(names = {"--clientSecret"}, description = "clientSecret")
    String clientSecret;
    ...
    @Option(names = {"--extendNamespace"}, description = "extendNamespace")
    String extendNamespace;

    @Option(names = {"--extendExp"}, description = "extendExp")
    Boolean extendExp;

    @Option(names = {"--loginQueueTicket"}, description = "loginQueueTicket")
        ...
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.o_auth2_0_v4.TokenGrantV4 operation =
                    net.accelbyte.sdk.api.iam.operations.o_auth2_0_v4.TokenGrantV4.builder()
                            ...
                            .build();
            final OauthmodelTokenWithDeviceCookieResponseV3 response =
                    wrapper.tokenGrantV4(operation).ensureSuccess();
