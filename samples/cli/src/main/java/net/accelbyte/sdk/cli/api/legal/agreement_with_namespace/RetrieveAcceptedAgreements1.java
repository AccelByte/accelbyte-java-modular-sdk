...
public class RetrieveAcceptedAgreements1 implements Callable<Integer> {
    ...
    @Option(names = {"--excludeOtherNamespacesPolicies"}, description = "excludeOtherNamespacesPolicies")
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.agreement_with_namespace.RetrieveAcceptedAgreements1 operation =
                    net.accelbyte.sdk.api.legal.operations.agreement_with_namespace.RetrieveAcceptedAgreements1.builder()
                            .namespace(namespace)
                            .userId(userId)
                            .excludeOtherNamespacesPolicies(excludeOtherNamespacesPolicies)
                            .build();
            final List<RetrieveAcceptedAgreementResponse> response =
                    wrapper.retrieveAcceptedAgreements1(operation).ensureSuccess();
