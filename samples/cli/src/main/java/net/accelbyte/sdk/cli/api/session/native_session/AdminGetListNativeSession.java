...
public class AdminGetListNativeSession implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.session.operations.native_session.AdminGetListNativeSession operation =
                    net.accelbyte.sdk.api.session.operations.native_session.AdminGetListNativeSession.builder()
                            .namespace(namespace)
                            .limit(limit)
                            .offset(offset)
                            .order(order)
            ...
            final ApimodelsNativeSessionPagingResponse response =
                    wrapper.adminGetListNativeSession(operation).ensureSuccess();
