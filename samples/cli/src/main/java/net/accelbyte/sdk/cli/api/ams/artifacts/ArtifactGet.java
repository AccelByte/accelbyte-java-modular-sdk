...
public class ArtifactGet implements Callable<Integer> {
    ...
    @Option(names = {"--artifactType"}, description = "artifactType")
    String artifactType;
    ...
    @Option(names = {"--fleetID"}, description = "fleetID")
    String fleetID;

    @Option(names = {"--imageID"}, description = "imageID")
    String imageID;

    @Option(names = {"--maxSize"}, description = "maxSize")
    Integer maxSize;

    @Option(names = {"--minSize"}, description = "minSize")
    Integer minSize;
    ...
    @Option(names = {"--serverId"}, description = "serverId")
    String serverId;
        ...
        try {
            ...
            final net.accelbyte.sdk.api.ams.operations.artifacts.ArtifactGet operation =
                    net.accelbyte.sdk.api.ams.operations.artifacts.ArtifactGet.builder()
                            ...
                            .status(status)
                            .build();
            final ApiArtifactListResponse response =
                    wrapper.artifactGet(operation).ensureSuccess();
