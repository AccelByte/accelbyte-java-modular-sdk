...
public class GetTotalActiveSession implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.sessionbrowser.operations.session.GetTotalActiveSession operation =
                    net.accelbyte.sdk.api.sessionbrowser.operations.session.GetTotalActiveSession.builder()
                            .namespace(namespace)
                            .sessionType(sessionType)
                            .build();
            final ModelsCountActiveSessionResponse response =
                    wrapper.getTotalActiveSession(operation).ensureSuccess();
