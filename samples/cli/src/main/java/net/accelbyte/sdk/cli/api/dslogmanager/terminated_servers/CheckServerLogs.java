...
public class CheckServerLogs implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.dslogmanager.operations.terminated_servers.CheckServerLogs operation =
                    net.accelbyte.sdk.api.dslogmanager.operations.terminated_servers.CheckServerLogs.builder()
                            .namespace(namespace)
                            .podName(podName)
                            .build();
            final ModelsLogFileStatus response =
                    wrapper.checkServerLogs(operation).ensureSuccess();
