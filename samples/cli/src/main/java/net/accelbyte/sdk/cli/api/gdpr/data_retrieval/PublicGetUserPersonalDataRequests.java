...
public class PublicGetUserPersonalDataRequests implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.gdpr.operations.data_retrieval.PublicGetUserPersonalDataRequests operation =
            ...
            final ModelsUserPersonalDataResponse response =
                    wrapper.publicGetUserPersonalDataRequests(operation).ensureSuccess();
