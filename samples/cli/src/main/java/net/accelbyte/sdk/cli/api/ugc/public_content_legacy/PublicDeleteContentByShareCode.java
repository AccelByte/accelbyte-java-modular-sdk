...
public class PublicDeleteContentByShareCode implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.ugc.operations.public_content_legacy.PublicDeleteContentByShareCode operation =
                    net.accelbyte.sdk.api.ugc.operations.public_content_legacy.PublicDeleteContentByShareCode.builder()
                            .channelId(channelId)
                            .namespace(namespace)
                            .shareCode(shareCode)
                            .userId(userId)
