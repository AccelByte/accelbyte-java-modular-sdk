...
public class UpdateAdminEmailConfiguration implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.gdpr.operations.configuration.UpdateAdminEmailConfiguration operation =
                    net.accelbyte.sdk.api.gdpr.operations.configuration.UpdateAdminEmailConfiguration.builder()
                            .namespace(namespace)
                            .body(new ObjectMapper().readValue(body, new TypeReference<List<String>>() {}))
                            .build();
                    wrapper.updateAdminEmailConfiguration(operation).ensureSuccess();
