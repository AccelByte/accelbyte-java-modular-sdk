...
public class AddThirdPartyLoginPlatformCredentialV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.third_party_credential.AddThirdPartyLoginPlatformCredentialV3 operation =
            ...
            final ModelThirdPartyLoginPlatformCredentialResponse response =
                    wrapper.addThirdPartyLoginPlatformCredentialV3(operation).ensureSuccess();
