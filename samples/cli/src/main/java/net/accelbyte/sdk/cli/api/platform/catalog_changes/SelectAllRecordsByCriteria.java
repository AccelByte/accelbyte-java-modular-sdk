...
public class SelectAllRecordsByCriteria implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.catalog_changes.SelectAllRecordsByCriteria operation =
                    net.accelbyte.sdk.api.platform.operations.catalog_changes.SelectAllRecordsByCriteria.builder()
                            .namespace(namespace)
                            .storeId(storeId)
                            .action(action)
                            .itemSku(itemSku)
                            ...
                            .build();
                    wrapper.selectAllRecordsByCriteria(operation).ensureSuccess();
