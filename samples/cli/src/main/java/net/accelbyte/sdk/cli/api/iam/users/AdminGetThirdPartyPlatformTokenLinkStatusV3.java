...
public class AdminGetThirdPartyPlatformTokenLinkStatusV3 implements Callable<Integer> {
    ...
    private static final Logger log = LogManager.getLogger(AdminGetThirdPartyPlatformTokenLinkStatusV3.class);
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.users.AdminGetThirdPartyPlatformTokenLinkStatusV3 operation =
                    net.accelbyte.sdk.api.iam.operations.users.AdminGetThirdPartyPlatformTokenLinkStatusV3.builder()
                            .namespace(namespace)
            ...
            final ModelTokenThirdPartyLinkStatusResponse response =
                    wrapper.adminGetThirdPartyPlatformTokenLinkStatusV3(operation).ensureSuccess();
