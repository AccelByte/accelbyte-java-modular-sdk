...
public class GetStatCycles1 implements Callable<Integer> {
    ...
    @Option(names = {"--cycleType"}, description = "cycleType")
    String cycleType;
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.social.operations.stat_cycle_configuration.GetStatCycles1 operation =
                    net.accelbyte.sdk.api.social.operations.stat_cycle_configuration.GetStatCycles1.builder()
                            .namespace(namespace)
                            .cycleType(cycleType)
                            .limit(limit)
                            .name(name)
                            ...
                            .status(status)
                            .build();
            final StatCyclePagingSlicedResult response =
                    wrapper.getStatCycles1(operation).ensureSuccess();
