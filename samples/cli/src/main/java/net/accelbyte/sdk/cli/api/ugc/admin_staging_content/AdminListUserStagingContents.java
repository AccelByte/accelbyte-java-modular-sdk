...
public class AdminListUserStagingContents implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.ugc.operations.admin_staging_content.AdminListUserStagingContents operation =
                    net.accelbyte.sdk.api.ugc.operations.admin_staging_content.AdminListUserStagingContents.builder()
                            .namespace(namespace)
                            .userId(userId)
                            .limit(limit)
                            .offset(offset)
