...
public class SearchChannelSpecificContent implements Callable<Integer> {
    ...
    @Option(names = {"--ishidden"}, description = "ishidden")
    String ishidden;
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.ugc.operations.public_content_legacy.SearchChannelSpecificContent operation =
                    net.accelbyte.sdk.api.ugc.operations.public_content_legacy.SearchChannelSpecificContent.builder()
                            .channelId(channelId)
                            .namespace(namespace)
                            .creator(creator)
                            .ishidden(ishidden)
            ...
            final ModelsPaginatedContentDownloadResponse response =
                    wrapper.searchChannelSpecificContent(operation).ensureSuccess();
