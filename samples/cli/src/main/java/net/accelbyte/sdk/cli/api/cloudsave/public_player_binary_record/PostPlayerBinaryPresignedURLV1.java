...
public class PostPlayerBinaryPresignedURLV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.public_player_binary_record.PostPlayerBinaryPresignedURLV1 operation =
                    net.accelbyte.sdk.api.cloudsave.operations.public_player_binary_record.PostPlayerBinaryPresignedURLV1.builder()
                            .key(key)
                            .namespace(namespace)
                            .userId(userId)
