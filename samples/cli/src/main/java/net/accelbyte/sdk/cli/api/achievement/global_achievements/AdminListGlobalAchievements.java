...
public class AdminListGlobalAchievements implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.achievement.operations.global_achievements.AdminListGlobalAchievements operation =
                    net.accelbyte.sdk.api.achievement.operations.global_achievements.AdminListGlobalAchievements.builder()
                            .namespace(namespace)
