...
public class SimultaneousLoginV3 implements Callable<Integer> {
    ...
    @Option(names = {"--simultaneousPlatform"}, description = "simultaneousPlatform")
    String simultaneousPlatform;

    @Option(names = {"--simultaneousTicket"}, description = "simultaneousTicket")
    String simultaneousTicket;

    @Option(names = {"--nativePlatform"}, description = "nativePlatform")
    String nativePlatform;

    @Option(names = {"--nativePlatformTicket"}, description = "nativePlatformTicket")
    ...
    public Integer call() {
        try {
            ...
            final OauthmodelTokenResponseV3 response =
                    wrapper.simultaneousLoginV3(operation).ensureSuccess();
