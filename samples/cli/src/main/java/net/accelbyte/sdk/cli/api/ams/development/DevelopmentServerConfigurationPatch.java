...
public class DevelopmentServerConfigurationPatch implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.ams.operations.development.DevelopmentServerConfigurationPatch operation =
                    net.accelbyte.sdk.api.ams.operations.development.DevelopmentServerConfigurationPatch.builder()
                            .developmentServerConfigID(developmentServerConfigID)
                            .namespace(namespace)
                            .body(new ObjectMapper().readValue(body, ApiDevelopmentServerConfigurationUpdateRequest.class)) 
                            .build();
