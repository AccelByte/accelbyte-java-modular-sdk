...
public class UploadRevocationPluginConfigCertV2 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.service_plugin_config.UploadRevocationPluginConfigCertV2 operation =
                    net.accelbyte.sdk.api.platform.operations.service_plugin_config.UploadRevocationPluginConfigCertV2.builder()
                            .namespace(namespace)
                            .file(file != null ? file : null)
                            .build();
            final RevocationPluginConfigInfo response =
                    wrapper.uploadRevocationPluginConfigCertV2(operation).ensureSuccess();
