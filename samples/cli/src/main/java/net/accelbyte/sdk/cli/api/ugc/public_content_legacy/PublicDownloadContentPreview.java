...
public class PublicDownloadContentPreview implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.ugc.operations.public_content_legacy.PublicDownloadContentPreview operation =
                    net.accelbyte.sdk.api.ugc.operations.public_content_legacy.PublicDownloadContentPreview.builder()
                            .contentId(contentId)
                            .namespace(namespace)
                            .build();
            final ModelsGetContentPreviewResponse response =
                    wrapper.publicDownloadContentPreview(operation).ensureSuccess();
