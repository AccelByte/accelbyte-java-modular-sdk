...
public class PublicQueryUserStatItems2 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.social.operations.user_statistic.PublicQueryUserStatItems2 operation =
            ...
            final List<ADTOObjectForUserStatItemValue> response =
                    wrapper.publicQueryUserStatItems2(operation).ensureSuccess();
