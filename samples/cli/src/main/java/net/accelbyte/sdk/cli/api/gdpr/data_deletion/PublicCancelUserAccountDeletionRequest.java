...
public class PublicCancelUserAccountDeletionRequest implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.gdpr.operations.data_deletion.PublicCancelUserAccountDeletionRequest operation =
                    net.accelbyte.sdk.api.gdpr.operations.data_deletion.PublicCancelUserAccountDeletionRequest.builder()
                            .namespace(namespace)
                            .userId(userId)
                            .build();
                    wrapper.publicCancelUserAccountDeletionRequest(operation).ensureSuccess();
