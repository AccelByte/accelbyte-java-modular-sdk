...
public class AdminPutGameRecordHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.admin_game_record.AdminPutGameRecordHandlerV1 operation =
            ...
            final ModelsGameRecordAdminResponse response =
                    wrapper.adminPutGameRecordHandlerV1(operation).ensureSuccess();
