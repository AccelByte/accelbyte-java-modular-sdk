...
public class GetGroupJoinRequestPublicV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.group.operations.member_request.GetGroupJoinRequestPublicV1 operation =
            ...
            final ModelsGetMemberRequestsListResponseV1 response =
                    wrapper.getGroupJoinRequestPublicV1(operation).ensureSuccess();
