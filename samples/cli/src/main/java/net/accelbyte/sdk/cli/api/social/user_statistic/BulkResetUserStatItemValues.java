...
public class BulkResetUserStatItemValues implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.social.operations.user_statistic.BulkResetUserStatItemValues operation =
            ...
            final List<BulkStatOperationResult> response =
                    wrapper.bulkResetUserStatItemValues(operation).ensureSuccess();
