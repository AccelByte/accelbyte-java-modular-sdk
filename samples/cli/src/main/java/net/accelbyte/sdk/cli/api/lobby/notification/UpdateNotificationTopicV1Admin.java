...
public class UpdateNotificationTopicV1Admin implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.lobby.operations.notification.UpdateNotificationTopicV1Admin operation =
                    net.accelbyte.sdk.api.lobby.operations.notification.UpdateNotificationTopicV1Admin.builder()
                            ...
                            .build();
                    wrapper.updateNotificationTopicV1Admin(operation).ensureSuccess();
