...
public class GetPlayerPublicRecordHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.public_player_record.GetPlayerPublicRecordHandlerV1 operation =
            ...
            final ModelsPlayerRecordResponse response =
                    wrapper.getPlayerPublicRecordHandlerV1(operation).ensureSuccess();
