...
public class PlatformAuthenticationV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.o_auth2_0_extension.PlatformAuthenticationV3 operation =
                    net.accelbyte.sdk.api.iam.operations.o_auth2_0_extension.PlatformAuthenticationV3.builder()
                            ...
                            .state(state)
                            .build();
                    wrapper.platformAuthenticationV3(operation).ensureSuccess();
