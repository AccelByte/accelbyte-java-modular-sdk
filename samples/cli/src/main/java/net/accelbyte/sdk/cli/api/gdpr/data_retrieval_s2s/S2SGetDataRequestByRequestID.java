...
public class S2SGetDataRequestByRequestID implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.gdpr.operations.data_retrieval_s2s.S2SGetDataRequestByRequestID operation =
                    net.accelbyte.sdk.api.gdpr.operations.data_retrieval_s2s.S2SGetDataRequestByRequestID.builder()
                            .namespace(namespace)
                            .requestId(requestId)
                            .build();
            final DtoS2SDataRequestSummary response =
                    wrapper.s2sGetDataRequestByRequestID(operation).ensureSuccess();
