...
public class AdminResetAchievement implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.achievement.operations.user_achievements.AdminResetAchievement operation =
                    net.accelbyte.sdk.api.achievement.operations.user_achievements.AdminResetAchievement.builder()
                            .achievementCode(achievementCode)
                            .namespace(namespace)
                            .userId(userId)
                            .build();
                    wrapper.adminResetAchievement(operation).ensureSuccess();
