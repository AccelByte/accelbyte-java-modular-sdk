...
public class DeleteGroupPredefinedRulePublicV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.group.operations.group.DeleteGroupPredefinedRulePublicV1 operation =
                    net.accelbyte.sdk.api.group.operations.group.DeleteGroupPredefinedRulePublicV1.builder()
                            .allowedAction(allowedAction)
                            .groupId(groupId)
                            .namespace(namespace)
                            .build();
                    wrapper.deleteGroupPredefinedRulePublicV1(operation).ensureSuccess();
