...
public class RetrieveLocalizedPolicyVersions implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace.RetrieveLocalizedPolicyVersions operation =
                    net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace.RetrieveLocalizedPolicyVersions.builder()
                            .namespace(namespace)
                            .policyVersionId(policyVersionId)
                            .build();
            final List<RetrieveLocalizedPolicyVersionResponse> response =
                    wrapper.retrieveLocalizedPolicyVersions(operation).ensureSuccess();
