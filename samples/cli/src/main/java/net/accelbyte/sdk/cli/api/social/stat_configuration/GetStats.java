...
public class GetStats implements Callable<Integer> {
    ...
    @Option(names = {"--cycleIds"}, description = "cycleIds")
    String cycleIds;

    @Option(names = {"--isGlobal"}, description = "isGlobal")
    Boolean isGlobal;
        ...
        try {
            ...
            final net.accelbyte.sdk.api.social.operations.stat_configuration.GetStats operation =
                    net.accelbyte.sdk.api.social.operations.stat_configuration.GetStats.builder()
                            ...
                            .offset(offset)
                            .build();
            final StatPagingSlicedResult response =
                    wrapper.getStats(operation).ensureSuccess();
