...
public class ImportStoreByCSV implements Callable<Integer> {
    ...
    @Option(names = {"--display"}, description = "display")
    File display;

    @Option(names = {"--item"}, description = "item")
    File item;

    @Option(names = {"--notes"}, description = "notes")
    String notes;

    @Option(names = {"--section"}, description = "section")
    File section;
        ...
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.store.ImportStoreByCSV operation =
                    net.accelbyte.sdk.api.platform.operations.store.ImportStoreByCSV.builder()
                            ...
                            .build();
            final ImportStoreResult response =
                    wrapper.importStoreByCSV(operation).ensureSuccess();
