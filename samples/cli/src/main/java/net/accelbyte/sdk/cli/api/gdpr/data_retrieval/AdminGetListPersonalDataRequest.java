...
public class AdminGetListPersonalDataRequest implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.gdpr.operations.data_retrieval.AdminGetListPersonalDataRequest operation =
            ...
            final ModelsListPersonalDataResponse response =
                    wrapper.adminGetListPersonalDataRequest(operation).ensureSuccess();
