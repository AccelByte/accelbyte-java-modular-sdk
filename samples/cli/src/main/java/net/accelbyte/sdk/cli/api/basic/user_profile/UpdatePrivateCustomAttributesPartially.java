...
public class UpdatePrivateCustomAttributesPartially implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.basic.operations.user_profile.UpdatePrivateCustomAttributesPartially operation =
            ...
            final Map<String, ?> response =
                    wrapper.updatePrivateCustomAttributesPartially(operation).ensureSuccess();
