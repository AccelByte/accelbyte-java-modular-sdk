...
public class PublicGetInputValidations implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.input_validations.PublicGetInputValidations operation =
            ...
            final ModelInputValidationsPublicResponse response =
                    wrapper.publicGetInputValidations(operation).ensureSuccess();
