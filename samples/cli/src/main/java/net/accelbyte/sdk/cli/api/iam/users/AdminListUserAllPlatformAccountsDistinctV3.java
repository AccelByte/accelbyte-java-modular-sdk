...
public class AdminListUserAllPlatformAccountsDistinctV3 implements Callable<Integer> {
    ...
    private static final Logger log = LogManager.getLogger(AdminListUserAllPlatformAccountsDistinctV3.class);
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.users.AdminListUserAllPlatformAccountsDistinctV3 operation =
                    net.accelbyte.sdk.api.iam.operations.users.AdminListUserAllPlatformAccountsDistinctV3.builder()
                            .namespace(namespace)
                            .userId(userId)
                            .build();
            final AccountcommonDistinctPlatformResponseV3 response =
                    wrapper.adminListUserAllPlatformAccountsDistinctV3(operation).ensureSuccess();
