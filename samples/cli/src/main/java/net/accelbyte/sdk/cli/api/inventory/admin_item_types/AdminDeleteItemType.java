...
public class AdminDeleteItemType implements Callable<Integer> {
    ...
    @Option(names = {"--itemTypeName"}, description = "itemTypeName")
    String itemTypeName;
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.inventory.operations.admin_item_types.AdminDeleteItemType operation =
                    net.accelbyte.sdk.api.inventory.operations.admin_item_types.AdminDeleteItemType.builder()
                            .itemTypeName(itemTypeName)
                            .namespace(namespace)
                            .build();
                    wrapper.adminDeleteItemType(operation).ensureSuccess();
