...
public class PublicDownloadUserOrderReceipt implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.order.PublicDownloadUserOrderReceipt operation =
            ...
            final InputStream response =
                    wrapper.publicDownloadUserOrderReceipt(operation).ensureSuccess();
