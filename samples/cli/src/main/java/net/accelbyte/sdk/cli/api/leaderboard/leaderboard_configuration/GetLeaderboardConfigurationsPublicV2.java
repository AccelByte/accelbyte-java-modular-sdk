...
public class GetLeaderboardConfigurationsPublicV2 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration.GetLeaderboardConfigurationsPublicV2 operation =
            ...
            final V2GetAllLeaderboardConfigsPublicResp response =
                    wrapper.getLeaderboardConfigurationsPublicV2(operation).ensureSuccess();
