...
public class GetGroupInvitationRequestPublicV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.group.operations.member_request.GetGroupInvitationRequestPublicV1 operation =
            ...
            final ModelsGetMemberRequestsListResponseV1 response =
                    wrapper.getGroupInvitationRequestPublicV1(operation).ensureSuccess();
