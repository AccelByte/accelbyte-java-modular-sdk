...
public class ResetStatCycle implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.social.operations.stat_cycle_configuration.ResetStatCycle operation =
                    net.accelbyte.sdk.api.social.operations.stat_cycle_configuration.ResetStatCycle.builder()
                            .cycleId(cycleId)
                            .namespace(namespace)
                            .build();
                    wrapper.resetStatCycle(operation).ensureSuccess();
