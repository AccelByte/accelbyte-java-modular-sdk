...
public class AdminPutPlayerPublicRecordConcurrentHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.admin_concurrent_record.AdminPutPlayerPublicRecordConcurrentHandlerV1 operation =
            ...
            final ModelsPlayerRecordConcurrentUpdateResponse response =
                    wrapper.adminPutPlayerPublicRecordConcurrentHandlerV1(operation).ensureSuccess();
