...
public class AcceptGroupJoinRequestPublicV2 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.group.operations.group_member.AcceptGroupJoinRequestPublicV2 operation =
                    net.accelbyte.sdk.api.group.operations.group_member.AcceptGroupJoinRequestPublicV2.builder()
                            .groupId(groupId)
                            .namespace(namespace)
                            .userId(userId)
                            .build();
            final ModelsMemberRequestGroupResponseV1 response =
                    wrapper.acceptGroupJoinRequestPublicV2(operation).ensureSuccess();
