...
public class BulkFetchOrDefaultStatItems implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.social.operations.user_statistic.BulkFetchOrDefaultStatItems operation =
            ...
            final List<ADTOObjectForUserStatItemValue> response =
                    wrapper.bulkFetchOrDefaultStatItems(operation).ensureSuccess();
