...
public class AdminCancelUserPersonalDataRequest implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.gdpr.operations.data_retrieval.AdminCancelUserPersonalDataRequest operation =
                    net.accelbyte.sdk.api.gdpr.operations.data_retrieval.AdminCancelUserPersonalDataRequest.builder()
                            .namespace(namespace)
                            .requestDate(requestDate)
                            .userId(userId)
                            .build();
                    wrapper.adminCancelUserPersonalDataRequest(operation).ensureSuccess();
