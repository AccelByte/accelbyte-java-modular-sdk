...
public class AdminDeletePlayFeatureFlag implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.match2.operations.play_feature_flag.AdminDeletePlayFeatureFlag operation =
                    net.accelbyte.sdk.api.match2.operations.play_feature_flag.AdminDeletePlayFeatureFlag.builder()
                            .namespace(namespace)
                            .build();
                    wrapper.adminDeletePlayFeatureFlag(operation).ensureSuccess();
