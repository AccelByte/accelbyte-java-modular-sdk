...
public class PublicGetProfileAttribute implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.social.operations.game_profile.PublicGetProfileAttribute operation =
                    net.accelbyte.sdk.api.social.operations.game_profile.PublicGetProfileAttribute.builder()
                            ...
                            .userId(userId)
                            .build();
            final Attribute response =
                    wrapper.publicGetProfileAttribute(operation).ensureSuccess();
