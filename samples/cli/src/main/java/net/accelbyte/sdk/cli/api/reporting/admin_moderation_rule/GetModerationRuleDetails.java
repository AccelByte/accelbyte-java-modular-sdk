...
public class GetModerationRuleDetails implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.reporting.operations.admin_moderation_rule.GetModerationRuleDetails operation =
                    net.accelbyte.sdk.api.reporting.operations.admin_moderation_rule.GetModerationRuleDetails.builder()
                            .namespace(namespace)
                            .ruleId(ruleId)
                            .build();
            final RestapiModerationRuleResponse response =
                    wrapper.getModerationRuleDetails(operation).ensureSuccess();
