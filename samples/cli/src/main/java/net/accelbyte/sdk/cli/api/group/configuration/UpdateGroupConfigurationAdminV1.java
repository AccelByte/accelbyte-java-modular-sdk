...
public class UpdateGroupConfigurationAdminV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.group.operations.configuration.UpdateGroupConfigurationAdminV1 operation =
            ...
            final ModelsUpdateGroupConfigurationResponseV1 response =
                    wrapper.updateGroupConfigurationAdminV1(operation).ensureSuccess();
