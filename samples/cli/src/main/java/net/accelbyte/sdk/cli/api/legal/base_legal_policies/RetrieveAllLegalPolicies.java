...
public class RetrieveAllLegalPolicies implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.base_legal_policies.RetrieveAllLegalPolicies operation =
            ...
            final List<RetrieveBasePolicyResponse> response =
                    wrapper.retrieveAllLegalPolicies(operation).ensureSuccess();
