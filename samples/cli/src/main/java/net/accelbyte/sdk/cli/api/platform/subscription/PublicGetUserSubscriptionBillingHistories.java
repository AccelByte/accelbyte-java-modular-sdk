...
public class PublicGetUserSubscriptionBillingHistories implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.subscription.PublicGetUserSubscriptionBillingHistories operation =
            ...
            final BillingHistoryPagingSlicedResult response =
                    wrapper.publicGetUserSubscriptionBillingHistories(operation).ensureSuccess();
