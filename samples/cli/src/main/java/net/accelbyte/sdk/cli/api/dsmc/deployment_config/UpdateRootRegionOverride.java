...
public class UpdateRootRegionOverride implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.dsmc.operations.deployment_config.UpdateRootRegionOverride operation =
            ...
            final ModelsDeploymentWithOverride response =
                    wrapper.updateRootRegionOverride(operation).ensureSuccess();
