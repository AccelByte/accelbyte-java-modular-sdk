...
public class PlatformSubscribeSubscription implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.subscription.PlatformSubscribeSubscription operation =
            ...
            final SubscriptionInfo response =
                    wrapper.platformSubscribeSubscription(operation).ensureSuccess();
