...
public class PublicGetMyEntitlementOwnershipBySku implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.entitlement.PublicGetMyEntitlementOwnershipBySku operation =
            ...
            final TimedOwnership response =
                    wrapper.publicGetMyEntitlementOwnershipBySku(operation).ensureSuccess();
