...
public class AdminGetArchivedLeaderboardRankingDataV1Handler implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.AdminGetArchivedLeaderboardRankingDataV1Handler operation =
            ...
            final List<ModelsArchiveLeaderboardSignedURLResponse> response =
                    wrapper.adminGetArchivedLeaderboardRankingDataV1Handler(operation).ensureSuccess();
