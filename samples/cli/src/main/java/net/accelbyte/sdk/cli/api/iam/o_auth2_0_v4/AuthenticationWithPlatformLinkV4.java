...
public class AuthenticationWithPlatformLinkV4 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.o_auth2_0_v4.AuthenticationWithPlatformLinkV4 operation =
                    net.accelbyte.sdk.api.iam.operations.o_auth2_0_v4.AuthenticationWithPlatformLinkV4.builder()
