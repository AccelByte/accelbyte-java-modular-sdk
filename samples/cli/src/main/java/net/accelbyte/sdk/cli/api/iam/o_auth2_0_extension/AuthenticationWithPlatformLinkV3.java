...
public class AuthenticationWithPlatformLinkV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.o_auth2_0_extension.AuthenticationWithPlatformLinkV3 operation =
            ...
            final OauthmodelTokenResponseV3 response =
                    wrapper.authenticationWithPlatformLinkV3(operation).ensureSuccess();
