...
public class AdminListUserIDByPlatformUserIDsV3 implements Callable<Integer> {
    ...
    @Option(names = {"--rawPID"}, description = "rawPID")
    Boolean rawPID;

    @Option(names = {"--rawPUID"}, description = "rawPUID")
    Boolean rawPUID;
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.users.AdminListUserIDByPlatformUserIDsV3 operation =
                    net.accelbyte.sdk.api.iam.operations.users.AdminListUserIDByPlatformUserIDsV3.builder()
                            .namespace(namespace)
            ...
            final AccountcommonUserPlatforms response =
                    wrapper.adminListUserIDByPlatformUserIDsV3(operation).ensureSuccess();
