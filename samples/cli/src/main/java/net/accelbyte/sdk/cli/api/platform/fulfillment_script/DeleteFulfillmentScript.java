...
public class DeleteFulfillmentScript implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.fulfillment_script.DeleteFulfillmentScript operation =
                    net.accelbyte.sdk.api.platform.operations.fulfillment_script.DeleteFulfillmentScript.builder()
                            .id(id)
                            .build();
                    wrapper.deleteFulfillmentScript(operation).ensureSuccess();
