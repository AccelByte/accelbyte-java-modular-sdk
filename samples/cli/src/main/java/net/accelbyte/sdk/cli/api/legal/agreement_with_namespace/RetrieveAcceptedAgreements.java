...
public class RetrieveAcceptedAgreements implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.agreement_with_namespace.RetrieveAcceptedAgreements operation =
                    net.accelbyte.sdk.api.legal.operations.agreement_with_namespace.RetrieveAcceptedAgreements.builder()
                            .namespace(namespace)
                            .userId(userId)
                            .excludeOtherNamespacesPolicies(excludeOtherNamespacesPolicies)
                            .build();
            final List<RetrieveAcceptedAgreementResponse> response =
                    wrapper.retrieveAcceptedAgreements(operation).ensureSuccess();
