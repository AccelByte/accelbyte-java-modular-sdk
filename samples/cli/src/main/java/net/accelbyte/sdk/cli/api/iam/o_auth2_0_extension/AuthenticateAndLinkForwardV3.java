...
public class AuthenticateAndLinkForwardV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.o_auth2_0_extension.AuthenticateAndLinkForwardV3 operation =
                    net.accelbyte.sdk.api.iam.operations.o_auth2_0_extension.AuthenticateAndLinkForwardV3.builder()
                            ...
                            .build();
                    wrapper.authenticateAndLinkForwardV3(operation).ensureSuccess();
