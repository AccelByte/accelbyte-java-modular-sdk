...
public class PublicSubmitUserAccountDeletionRequest implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.gdpr.operations.data_deletion.PublicSubmitUserAccountDeletionRequest operation =
            ...
            final ModelsRequestDeleteResponse response =
                    wrapper.publicSubmitUserAccountDeletionRequest(operation).ensureSuccess();
