...
public class ListAllTerminatedServers implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.dslogmanager.operations.all_terminated_servers.ListAllTerminatedServers operation =
            ...
            final ModelsListTerminatedServersResponse response =
                    wrapper.listAllTerminatedServers(operation).ensureSuccess();
