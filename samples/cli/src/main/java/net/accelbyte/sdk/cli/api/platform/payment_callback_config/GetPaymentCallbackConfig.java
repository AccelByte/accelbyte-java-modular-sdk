...
public class GetPaymentCallbackConfig implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.payment_callback_config.GetPaymentCallbackConfig operation =
            ...
            final PaymentCallbackConfigInfo response =
                    wrapper.getPaymentCallbackConfig(operation).ensureSuccess();
