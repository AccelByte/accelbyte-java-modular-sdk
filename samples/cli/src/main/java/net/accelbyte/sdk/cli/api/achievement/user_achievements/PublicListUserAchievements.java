...
public class PublicListUserAchievements implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.achievement.operations.user_achievements.PublicListUserAchievements operation =
                    net.accelbyte.sdk.api.achievement.operations.user_achievements.PublicListUserAchievements.builder()
                            .namespace(namespace)
                            .userId(userId)
                            .limit(limit)
                            .offset(offset)
            ...
            final ModelsPaginatedUserAchievementResponse response =
                    wrapper.publicListUserAchievements(operation).ensureSuccess();
