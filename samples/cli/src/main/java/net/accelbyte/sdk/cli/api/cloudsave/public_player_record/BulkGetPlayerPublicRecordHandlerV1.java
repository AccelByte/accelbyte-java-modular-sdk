...
public class BulkGetPlayerPublicRecordHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.public_player_record.BulkGetPlayerPublicRecordHandlerV1 operation =
            ...
            final ModelsBulkGetPlayerRecordResponse response =
                    wrapper.bulkGetPlayerPublicRecordHandlerV1(operation).ensureSuccess();
