...
public class UpdatePlayTimeWeight implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.matchmaking.operations.social_matchmaking.UpdatePlayTimeWeight operation =
            ...
            final ModelsUpdatePlayerPlaytimeWeightResponse response =
                    wrapper.updatePlayTimeWeight(operation).ensureSuccess();
