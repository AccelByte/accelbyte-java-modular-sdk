...
public class RetrieveSingleLocalizedPolicyVersion1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace.RetrieveSingleLocalizedPolicyVersion1 operation =
                    net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace.RetrieveSingleLocalizedPolicyVersion1.builder()
                            .localizedPolicyVersionId(localizedPolicyVersionId)
                            .namespace(namespace)
                            .build();
            final RetrieveLocalizedPolicyVersionResponse response =
                    wrapper.retrieveSingleLocalizedPolicyVersion1(operation).ensureSuccess();
