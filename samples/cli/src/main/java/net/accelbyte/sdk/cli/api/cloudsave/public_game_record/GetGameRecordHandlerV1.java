...
public class GetGameRecordHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.public_game_record.GetGameRecordHandlerV1 operation =
            ...
            final ModelsGameRecordResponse response =
                    wrapper.getGameRecordHandlerV1(operation).ensureSuccess();
