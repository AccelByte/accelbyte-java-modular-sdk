...
public class ResetGlobalAchievement implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.achievement.operations.global_achievements.ResetGlobalAchievement operation =
                    net.accelbyte.sdk.api.achievement.operations.global_achievements.ResetGlobalAchievement.builder()
