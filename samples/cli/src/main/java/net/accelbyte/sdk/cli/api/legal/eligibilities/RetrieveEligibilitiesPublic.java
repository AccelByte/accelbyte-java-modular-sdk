...
public class RetrieveEligibilitiesPublic implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.eligibilities.RetrieveEligibilitiesPublic operation =
            ...
            final List<RetrieveUserEligibilitiesResponse> response =
                    wrapper.retrieveEligibilitiesPublic(operation).ensureSuccess();
