...
public class AdminUpsertPlayFeatureFlag implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.match2.operations.play_feature_flag.AdminUpsertPlayFeatureFlag operation =
                    net.accelbyte.sdk.api.match2.operations.play_feature_flag.AdminUpsertPlayFeatureFlag.builder()
                            .namespace(namespace)
                            .body(new ObjectMapper().readValue(body, ModelsPlayFeatureFlag.class)) 
                            .build();
            final ModelsPlayFeatureFlag response =
                    wrapper.adminUpsertPlayFeatureFlag(operation).ensureSuccess();
