...
public class CreateRootRegionOverride implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.dsmc.operations.deployment_config.CreateRootRegionOverride operation =
            ...
            final ModelsDeploymentWithOverride response =
                    wrapper.createRootRegionOverride(operation).ensureSuccess();
