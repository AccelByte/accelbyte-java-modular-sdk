...
public class GetCurrentWeekLeaderboardRankingPublicV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.GetCurrentWeekLeaderboardRankingPublicV1 operation =
            ...
            final ModelsGetLeaderboardRankingResp response =
                    wrapper.getCurrentWeekLeaderboardRankingPublicV1(operation).ensureSuccess();
