...
public class GetUserGroupInformationPublicV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.group.operations.group_member.GetUserGroupInformationPublicV1 operation =
            ...
            final ModelsGetUserGroupInformationResponseV1 response =
                    wrapper.getUserGroupInformationPublicV1(operation).ensureSuccess();
