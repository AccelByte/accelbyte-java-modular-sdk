...
public class PutGameRecordHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.public_game_record.PutGameRecordHandlerV1 operation =
            ...
            final ModelsGameRecordResponse response =
                    wrapper.putGameRecordHandlerV1(operation).ensureSuccess();
