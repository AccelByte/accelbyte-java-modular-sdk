...
public class DownloadServerArtifacts implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.dsartifact.operations.download_server_artifact.DownloadServerArtifacts operation =
                    net.accelbyte.sdk.api.dsartifact.operations.download_server_artifact.DownloadServerArtifacts.builder()
                            .namespace(namespace)
                            .podName(podName)
                            .build();
                    wrapper.downloadServerArtifacts(operation).ensureSuccess();
