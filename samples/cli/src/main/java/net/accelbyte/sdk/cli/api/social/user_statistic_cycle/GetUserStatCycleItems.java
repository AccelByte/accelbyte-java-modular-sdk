...
public class GetUserStatCycleItems implements Callable<Integer> {
    ...
    @Option(names = {"--isPublic"}, description = "isPublic")
    Boolean isPublic;
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.social.operations.user_statistic_cycle.GetUserStatCycleItems operation =
                    net.accelbyte.sdk.api.social.operations.user_statistic_cycle.GetUserStatCycleItems.builder()
                            .cycleId(cycleId)
                            .namespace(namespace)
                            .userId(userId)
                            .isPublic(isPublic)
            ...
            final UserStatCycleItemPagingSlicedResult response =
                    wrapper.getUserStatCycleItems(operation).ensureSuccess();
