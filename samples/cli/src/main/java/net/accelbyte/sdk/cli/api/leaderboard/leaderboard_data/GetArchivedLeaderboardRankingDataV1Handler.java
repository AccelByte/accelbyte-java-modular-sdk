...
public class GetArchivedLeaderboardRankingDataV1Handler implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.GetArchivedLeaderboardRankingDataV1Handler operation =
            ...
            final List<ModelsArchiveLeaderboardSignedURLResponse> response =
                    wrapper.getArchivedLeaderboardRankingDataV1Handler(operation).ensureSuccess();
