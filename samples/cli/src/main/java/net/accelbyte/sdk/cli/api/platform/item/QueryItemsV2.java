...
public class QueryItemsV2 implements Callable<Integer> {
    ...
    @Option(names = {"--includeSubCategoryItem"}, description = "includeSubCategoryItem")
    Boolean includeSubCategoryItem;

    @Option(names = {"--itemName"}, description = "itemName")
    String itemName;

    @Option(names = {"--itemStatus"}, description = "itemStatus")
    String itemStatus;

    @Option(names = {"--itemType"}, description = "itemType", split = ",")
    ...
    @Option(names = {"--sectionExclusive"}, description = "sectionExclusive")
    Boolean sectionExclusive;

    @Option(names = {"--sortBy"}, description = "sortBy", split = ",")
    List<String> sortBy;
        ...
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.item.QueryItemsV2 operation =
                    net.accelbyte.sdk.api.platform.operations.item.QueryItemsV2.builder()
                            ...
                            .withTotal(withTotal)
                            .build();
            final FullItemPagingResult response =
                    wrapper.queryItemsV2(operation).ensureSuccess();
