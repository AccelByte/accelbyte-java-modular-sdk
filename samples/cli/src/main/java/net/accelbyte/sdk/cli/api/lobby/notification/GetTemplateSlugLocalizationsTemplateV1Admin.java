...
public class GetTemplateSlugLocalizationsTemplateV1Admin implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.lobby.operations.notification.GetTemplateSlugLocalizationsTemplateV1Admin operation =
            ...
            final ModelGetAllNotificationTemplateSlugResp response =
                    wrapper.getTemplateSlugLocalizationsTemplateV1Admin(operation).ensureSuccess();
