...
public class RefundPaymentOrderByDedicated implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.payment_dedicated.RefundPaymentOrderByDedicated operation =
                    net.accelbyte.sdk.api.platform.operations.payment_dedicated.RefundPaymentOrderByDedicated.builder()
                            ...
                            .build();
            final PaymentOrderRefundResult response =
                    wrapper.refundPaymentOrderByDedicated(operation).ensureSuccess();
