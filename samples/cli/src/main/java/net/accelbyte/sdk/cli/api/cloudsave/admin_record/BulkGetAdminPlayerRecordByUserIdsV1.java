...
public class BulkGetAdminPlayerRecordByUserIdsV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.admin_record.BulkGetAdminPlayerRecordByUserIdsV1 operation =
                    net.accelbyte.sdk.api.cloudsave.operations.admin_record.BulkGetAdminPlayerRecordByUserIdsV1.builder()
                            .key(key)
                            .namespace(namespace)
                            .body(new ObjectMapper().readValue(body, ModelsBulkUserIDsRequest.class)) 
                            .build();
            final ModelsBulkGetAdminPlayerRecordResponse response =
                    wrapper.bulkGetAdminPlayerRecordByUserIdsV1(operation).ensureSuccess();
