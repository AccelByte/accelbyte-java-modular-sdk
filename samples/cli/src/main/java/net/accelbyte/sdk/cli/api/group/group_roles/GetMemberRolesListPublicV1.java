...
public class GetMemberRolesListPublicV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.group.operations.group_roles.GetMemberRolesListPublicV1 operation =
            ...
            final ModelsGetMemberRolesListResponseV1 response =
                    wrapper.getMemberRolesListPublicV1(operation).ensureSuccess();
