...
public class AdminListUsersStatItems implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.social.operations.user_statistic.AdminListUsersStatItems operation =
                    net.accelbyte.sdk.api.social.operations.user_statistic.AdminListUsersStatItems.builder()
                            .namespace(namespace)
                            .userId(userId)
            ...
            final List<ADTOObjectForUserStatItemValue> response =
                    wrapper.adminListUsersStatItems(operation).ensureSuccess();
