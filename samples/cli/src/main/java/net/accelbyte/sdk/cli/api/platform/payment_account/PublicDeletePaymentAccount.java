...
public class PublicDeletePaymentAccount implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.payment_account.PublicDeletePaymentAccount operation =
                    net.accelbyte.sdk.api.platform.operations.payment_account.PublicDeletePaymentAccount.builder()
                            ...
                            .userId(userId)
                            .build();
                    wrapper.publicDeletePaymentAccount(operation).ensureSuccess();
