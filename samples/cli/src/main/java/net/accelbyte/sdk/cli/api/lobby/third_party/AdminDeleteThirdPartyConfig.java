...
public class AdminDeleteThirdPartyConfig implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.lobby.operations.third_party.AdminDeleteThirdPartyConfig operation =
                    net.accelbyte.sdk.api.lobby.operations.third_party.AdminDeleteThirdPartyConfig.builder()
                            .namespace(namespace)
                            .build();
                    wrapper.adminDeleteThirdPartyConfig(operation).ensureSuccess();
            return 0;
