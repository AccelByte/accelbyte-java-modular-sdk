...
public class DeleteUserRankingPublicV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.DeleteUserRankingPublicV1 operation =
                    net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.DeleteUserRankingPublicV1.builder()
                            .leaderboardCode(leaderboardCode)
                            .namespace(namespace)
                            .userId(userId)
                            .build();
                    wrapper.deleteUserRankingPublicV1(operation).ensureSuccess();
