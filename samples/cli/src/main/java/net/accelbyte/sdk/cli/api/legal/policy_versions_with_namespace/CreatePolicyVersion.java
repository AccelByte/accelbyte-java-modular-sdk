...
public class CreatePolicyVersion implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.policy_versions_with_namespace.CreatePolicyVersion operation =
                    net.accelbyte.sdk.api.legal.operations.policy_versions_with_namespace.CreatePolicyVersion.builder()
                            .namespace(namespace)
                            .policyId(policyId)
                            .body(new ObjectMapper().readValue(body, CreatePolicyVersionRequest.class)) 
                            .build();
            final CreatePolicyVersionResponse response =
                    wrapper.createPolicyVersion(operation).ensureSuccess();
