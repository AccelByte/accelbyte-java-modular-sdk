...
public class AdminQueryBackfill implements Callable<Integer> {
    ...
    @Option(names = {"--isActive"}, description = "isActive")
    Boolean isActive;
    ...
    @Option(names = {"--playerID"}, description = "playerID")
    String playerID;
        ...
        try {
            ...
            final net.accelbyte.sdk.api.match2.operations.backfill.AdminQueryBackfill operation =
                    net.accelbyte.sdk.api.match2.operations.backfill.AdminQueryBackfill.builder()
                            ...
                            .toTime(toTime)
                            .build();
            final ApiListBackfillQueryResponse response =
                    wrapper.adminQueryBackfill(operation).ensureSuccess();
