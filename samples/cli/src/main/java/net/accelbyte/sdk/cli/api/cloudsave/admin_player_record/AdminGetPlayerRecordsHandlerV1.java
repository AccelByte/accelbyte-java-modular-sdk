...
public class AdminGetPlayerRecordsHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.admin_player_record.AdminGetPlayerRecordsHandlerV1 operation =
                    net.accelbyte.sdk.api.cloudsave.operations.admin_player_record.AdminGetPlayerRecordsHandlerV1.builder()
                            .namespace(namespace)
                            .userId(userId)
