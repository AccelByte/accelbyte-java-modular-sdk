...
public class UpdateMemberRolePermissionAdminV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.group.operations.group_roles.UpdateMemberRolePermissionAdminV1 operation =
            ...
            final ModelsMemberRoleResponseV1 response =
                    wrapper.updateMemberRolePermissionAdminV1(operation).ensureSuccess();
