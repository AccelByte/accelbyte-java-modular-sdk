...
public class RequestTargetTokenResponseV4 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.o_auth2_0_v4.RequestTargetTokenResponseV4 operation =
                    net.accelbyte.sdk.api.iam.operations.o_auth2_0_v4.RequestTargetTokenResponseV4.builder()
                            .additionalData(additionalData != null ? additionalData : null)
                            .code(code != null ? code : null)
                            .build();
            final OauthmodelTokenResponseV3 response =
                    wrapper.requestTargetTokenResponseV4(operation).ensureSuccess();
