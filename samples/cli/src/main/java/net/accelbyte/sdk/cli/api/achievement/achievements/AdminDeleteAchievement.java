...
public class AdminDeleteAchievement implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.achievement.operations.achievements.AdminDeleteAchievement operation =
                    net.accelbyte.sdk.api.achievement.operations.achievements.AdminDeleteAchievement.builder()
                            .achievementCode(achievementCode)
                            .namespace(namespace)
                            .build();
                    wrapper.adminDeleteAchievement(operation).ensureSuccess();
