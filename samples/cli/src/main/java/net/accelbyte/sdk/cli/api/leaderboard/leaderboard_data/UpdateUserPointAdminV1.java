...
public class UpdateUserPointAdminV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.UpdateUserPointAdminV1 operation =
            ...
            final ModelsUpdateUserPointAdminV1Response response =
                    wrapper.updateUserPointAdminV1(operation).ensureSuccess();
