...
public class DeleteGroupConfigurationV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.group.operations.configuration.DeleteGroupConfigurationV1 operation =
                    net.accelbyte.sdk.api.group.operations.configuration.DeleteGroupConfigurationV1.builder()
                            .configurationCode(configurationCode)
                            .namespace(namespace)
                            .build();
                    wrapper.deleteGroupConfigurationV1(operation).ensureSuccess();
