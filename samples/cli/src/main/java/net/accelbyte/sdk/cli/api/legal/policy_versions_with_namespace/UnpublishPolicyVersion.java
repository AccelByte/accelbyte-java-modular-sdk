...
public class UnpublishPolicyVersion implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.policy_versions_with_namespace.UnpublishPolicyVersion operation =
                    net.accelbyte.sdk.api.legal.operations.policy_versions_with_namespace.UnpublishPolicyVersion.builder()
                            .namespace(namespace)
                            .policyVersionId(policyVersionId)
                            .build();
                    wrapper.unpublishPolicyVersion(operation).ensureSuccess();
