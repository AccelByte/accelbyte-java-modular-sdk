...
public class PublicGetUnpaidPaymentOrder implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.payment_station.PublicGetUnpaidPaymentOrder operation =
                    net.accelbyte.sdk.api.platform.operations.payment_station.PublicGetUnpaidPaymentOrder.builder()
                            .namespace(namespace)
                            .paymentOrderNo(paymentOrderNo)
                            .build();
            final PaymentOrderDetails response =
                    wrapper.publicGetUnpaidPaymentOrder(operation).ensureSuccess();
