...
public class GetUserEntitlementOwnershipByItemId implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.entitlement.GetUserEntitlementOwnershipByItemId operation =
            ...
            final TimedOwnership response =
                    wrapper.getUserEntitlementOwnershipByItemId(operation).ensureSuccess();
