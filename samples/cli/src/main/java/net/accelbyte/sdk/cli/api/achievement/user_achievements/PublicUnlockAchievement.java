...
public class PublicUnlockAchievement implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.achievement.operations.user_achievements.PublicUnlockAchievement operation =
                    net.accelbyte.sdk.api.achievement.operations.user_achievements.PublicUnlockAchievement.builder()
                            .achievementCode(achievementCode)
                            .namespace(namespace)
                            .userId(userId)
                            .build();
                    wrapper.publicUnlockAchievement(operation).ensureSuccess();
