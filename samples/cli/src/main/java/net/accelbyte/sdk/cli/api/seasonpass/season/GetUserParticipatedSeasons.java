...
public class GetUserParticipatedSeasons implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.seasonpass.operations.season.GetUserParticipatedSeasons operation =
            ...
            final ListUserSeasonInfoPagingSlicedResult response =
                    wrapper.getUserParticipatedSeasons(operation).ensureSuccess();
