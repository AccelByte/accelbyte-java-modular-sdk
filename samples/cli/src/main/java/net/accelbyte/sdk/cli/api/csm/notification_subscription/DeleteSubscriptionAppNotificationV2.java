...
public class DeleteSubscriptionAppNotificationV2 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.csm.operations.notification_subscription.DeleteSubscriptionAppNotificationV2 operation =
                    net.accelbyte.sdk.api.csm.operations.notification_subscription.DeleteSubscriptionAppNotificationV2.builder()
                            .app(app)
                            .namespace(namespace)
                            .subscriptionId(subscriptionId)
                            .build();
                    wrapper.deleteSubscriptionAppNotificationV2(operation).ensureSuccess();
