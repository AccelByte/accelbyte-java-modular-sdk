...
public class AdminDeleteConfigPermissionsByGroup implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.clients_config_v3.AdminDeleteConfigPermissionsByGroup operation =
                    net.accelbyte.sdk.api.iam.operations.clients_config_v3.AdminDeleteConfigPermissionsByGroup.builder()
                            .forceDelete(forceDelete)
                            .body(new ObjectMapper().readValue(body, ClientmodelPermissionSetDeleteGroupRequest.class)) 
                            .build();
                    wrapper.adminDeleteConfigPermissionsByGroup(operation).ensureSuccess();
