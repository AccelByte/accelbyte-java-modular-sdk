...
public class GetSingleMatchmakingChannel implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.matchmaking.operations.matchmaking.GetSingleMatchmakingChannel operation =
            ...
            final ModelsChannelV1 response =
                    wrapper.getSingleMatchmakingChannel(operation).ensureSuccess();
