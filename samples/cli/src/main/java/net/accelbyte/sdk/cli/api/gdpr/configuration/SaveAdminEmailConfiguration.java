...
public class SaveAdminEmailConfiguration implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.gdpr.operations.configuration.SaveAdminEmailConfiguration operation =
                    net.accelbyte.sdk.api.gdpr.operations.configuration.SaveAdminEmailConfiguration.builder()
                            .namespace(namespace)
                            .body(new ObjectMapper().readValue(body, new TypeReference<List<String>>() {}))
                            .build();
                    wrapper.saveAdminEmailConfiguration(operation).ensureSuccess();
