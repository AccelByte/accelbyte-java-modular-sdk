...
public class QueryPaymentProviderConfig implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.payment_config.QueryPaymentProviderConfig operation =
            ...
            final PaymentProviderConfigPagingSlicedResult response =
                    wrapper.queryPaymentProviderConfig(operation).ensureSuccess();
