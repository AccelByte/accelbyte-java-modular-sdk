...
@Command(name = "publicWebReauthPlatform", mixinStandardHelpOptions = true)
public class PublicWebReauthPlatform implements Callable<Integer> {

    private static final Logger log = LogManager.getLogger(PublicWebReauthPlatform.class);
    ...
    @Option(names = {"--operation"}, description = "operation")
    String operation;
    ...
    public static void main(String[] args) {
        int exitCode = new CommandLine(new PublicWebReauthPlatform()).execute(args);
