...
public class DeleteUserRankingByLeaderboardCodeAdminV1 implements Callable<Integer> {
    ...
    private static final Logger log = LogManager.getLogger(DeleteUserRankingByLeaderboardCodeAdminV1.class);
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.DeleteUserRankingByLeaderboardCodeAdminV1 operation =
                    net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.DeleteUserRankingByLeaderboardCodeAdminV1.builder()
                            .leaderboardCode(leaderboardCode)
                            .namespace(namespace)
                            .build();
                    wrapper.deleteUserRankingByLeaderboardCodeAdminV1(operation).ensureSuccess();
