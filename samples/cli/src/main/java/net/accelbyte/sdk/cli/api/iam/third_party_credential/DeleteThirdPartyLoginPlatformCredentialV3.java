...
public class DeleteThirdPartyLoginPlatformCredentialV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.third_party_credential.DeleteThirdPartyLoginPlatformCredentialV3 operation =
                    net.accelbyte.sdk.api.iam.operations.third_party_credential.DeleteThirdPartyLoginPlatformCredentialV3.builder()
                            .namespace(namespace)
                            .platformId(platformId)
                            .build();
                    wrapper.deleteThirdPartyLoginPlatformCredentialV3(operation).ensureSuccess();
