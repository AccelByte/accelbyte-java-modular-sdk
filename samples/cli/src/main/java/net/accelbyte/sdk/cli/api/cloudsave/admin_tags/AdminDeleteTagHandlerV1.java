...
public class AdminDeleteTagHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.admin_tags.AdminDeleteTagHandlerV1 operation =
                    net.accelbyte.sdk.api.cloudsave.operations.admin_tags.AdminDeleteTagHandlerV1.builder()
                            .namespace(namespace)
                            .tag(tag)
                            .build();
                    wrapper.adminDeleteTagHandlerV1(operation).ensureSuccess();
