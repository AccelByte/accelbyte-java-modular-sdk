...
public class AdminPutPlayerRecordHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.admin_player_record.AdminPutPlayerRecordHandlerV1 operation =
            ...
            final ModelsPlayerRecordResponse response =
                    wrapper.adminPutPlayerRecordHandlerV1(operation).ensureSuccess();
