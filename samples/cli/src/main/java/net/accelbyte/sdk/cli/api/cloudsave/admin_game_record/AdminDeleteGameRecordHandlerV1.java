...
public class AdminDeleteGameRecordHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.admin_game_record.AdminDeleteGameRecordHandlerV1 operation =
                    net.accelbyte.sdk.api.cloudsave.operations.admin_game_record.AdminDeleteGameRecordHandlerV1.builder()
                            .key(key)
                            .namespace(namespace)
                            .build();
                    wrapper.adminDeleteGameRecordHandlerV1(operation).ensureSuccess();
