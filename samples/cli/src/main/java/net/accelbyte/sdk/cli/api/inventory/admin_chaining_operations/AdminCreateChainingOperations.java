...
public class AdminCreateChainingOperations implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.inventory.operations.admin_chaining_operations.AdminCreateChainingOperations operation =
                    net.accelbyte.sdk.api.inventory.operations.admin_chaining_operations.AdminCreateChainingOperations.builder()
                            .namespace(namespace)
                            .body(new ObjectMapper().readValue(body, ApimodelsChainingOperationReq.class)) 
                            .build();
            final ApimodelsChainingOperationResp response =
                    wrapper.adminCreateChainingOperations(operation).ensureSuccess();
