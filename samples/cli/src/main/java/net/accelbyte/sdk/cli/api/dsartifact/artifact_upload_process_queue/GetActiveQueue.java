...
public class GetActiveQueue implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.dsartifact.operations.artifact_upload_process_queue.GetActiveQueue operation =
                    net.accelbyte.sdk.api.dsartifact.operations.artifact_upload_process_queue.GetActiveQueue.builder()
                            .nodeIP(nodeIP)
                            .build();
            final ModelsQueue response =
                    wrapper.getActiveQueue(operation).ensureSuccess();
