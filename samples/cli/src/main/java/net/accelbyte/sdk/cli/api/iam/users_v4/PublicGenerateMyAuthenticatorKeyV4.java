...
public class PublicGenerateMyAuthenticatorKeyV4 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.users_v4.PublicGenerateMyAuthenticatorKeyV4 operation =
            ...
            final ModelAuthenticatorKeyResponseV4 response =
                    wrapper.publicGenerateMyAuthenticatorKeyV4(operation).ensureSuccess();
