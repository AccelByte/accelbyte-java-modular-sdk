...
public class PublishPolicyVersion1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.policy_versions_with_namespace.PublishPolicyVersion1 operation =
                    net.accelbyte.sdk.api.legal.operations.policy_versions_with_namespace.PublishPolicyVersion1.builder()
                            .namespace(namespace)
                            .policyVersionId(policyVersionId)
                            .shouldNotify(shouldNotify)
                            .build();
                    wrapper.publishPolicyVersion1(operation).ensureSuccess();
