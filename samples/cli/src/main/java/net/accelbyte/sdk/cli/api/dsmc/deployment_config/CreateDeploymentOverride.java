...
public class CreateDeploymentOverride implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.dsmc.operations.deployment_config.CreateDeploymentOverride operation =
            ...
            final ModelsDeploymentWithOverride response =
                    wrapper.createDeploymentOverride(operation).ensureSuccess();
