...
public class GetNotificationTopicV1Admin implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.lobby.operations.notification.GetNotificationTopicV1Admin operation =
            ...
            final ModelNotificationTopicResponseV1 response =
                    wrapper.getNotificationTopicV1Admin(operation).ensureSuccess();
