...
public class GetCurrentSeasonLeaderboardRankingAdminV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.GetCurrentSeasonLeaderboardRankingAdminV1 operation =
            ...
            final ModelsGetLeaderboardRankingResp response =
                    wrapper.getCurrentSeasonLeaderboardRankingAdminV1(operation).ensureSuccess();
