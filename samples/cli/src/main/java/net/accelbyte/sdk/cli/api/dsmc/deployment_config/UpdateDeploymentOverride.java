...
public class UpdateDeploymentOverride implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.dsmc.operations.deployment_config.UpdateDeploymentOverride operation =
            ...
            final ModelsDeploymentWithOverride response =
                    wrapper.updateDeploymentOverride(operation).ensureSuccess();
