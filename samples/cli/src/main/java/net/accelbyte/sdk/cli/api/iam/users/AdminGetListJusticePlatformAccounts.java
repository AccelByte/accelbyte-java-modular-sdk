...
public class AdminGetListJusticePlatformAccounts implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.users.AdminGetListJusticePlatformAccounts operation =
            ...
            final List<ModelGetUserMapping> response =
                    wrapper.adminGetListJusticePlatformAccounts(operation).ensureSuccess();
