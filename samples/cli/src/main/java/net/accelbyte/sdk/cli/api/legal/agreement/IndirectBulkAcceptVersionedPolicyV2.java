...
public class IndirectBulkAcceptVersionedPolicyV2 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.agreement.IndirectBulkAcceptVersionedPolicyV2 operation =
            ...
            final AcceptAgreementResponse response =
                    wrapper.indirectBulkAcceptVersionedPolicyV2(operation).ensureSuccess();
