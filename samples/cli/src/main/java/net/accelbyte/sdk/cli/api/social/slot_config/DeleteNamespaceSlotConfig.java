...
public class DeleteNamespaceSlotConfig implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.social.operations.slot_config.DeleteNamespaceSlotConfig operation =
                    net.accelbyte.sdk.api.social.operations.slot_config.DeleteNamespaceSlotConfig.builder()
                            .namespace(namespace)
                            .build();
                    wrapper.deleteNamespaceSlotConfig(operation).ensureSuccess();
