...
public class PublicGetPaymentMethods implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.payment_station.PublicGetPaymentMethods operation =
            ...
            final List<PaymentMethod> response =
                    wrapper.publicGetPaymentMethods(operation).ensureSuccess();
