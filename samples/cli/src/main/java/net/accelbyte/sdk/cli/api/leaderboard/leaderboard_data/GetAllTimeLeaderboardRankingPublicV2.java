...
public class GetAllTimeLeaderboardRankingPublicV2 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.GetAllTimeLeaderboardRankingPublicV2 operation =
            ...
            final V2GetPublicLeaderboardRankingResponse response =
                    wrapper.getAllTimeLeaderboardRankingPublicV2(operation).ensureSuccess();
