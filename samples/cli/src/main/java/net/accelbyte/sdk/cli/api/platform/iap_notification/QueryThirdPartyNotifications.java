...
public class QueryThirdPartyNotifications implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.iap_notification.QueryThirdPartyNotifications operation =
                    net.accelbyte.sdk.api.platform.operations.iap_notification.QueryThirdPartyNotifications.builder()
                            .namespace(namespace)
                            .endDate(endDate)
            ...
            final NotificationPagingSlicedResult response =
                    wrapper.queryThirdPartyNotifications(operation).ensureSuccess();
