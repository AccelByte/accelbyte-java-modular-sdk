...
public class AdminDeleteAllUserContents implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.ugc.operations.anonymization.AdminDeleteAllUserContents operation =
                    net.accelbyte.sdk.api.ugc.operations.anonymization.AdminDeleteAllUserContents.builder()
                            .namespace(namespace)
                            .userId(userId)
                            .build();
                    wrapper.adminDeleteAllUserContents(operation).ensureSuccess();
