...
public class CreateArchivedLeaderboardRankingDataV1Handler implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.CreateArchivedLeaderboardRankingDataV1Handler operation =
                    net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.CreateArchivedLeaderboardRankingDataV1Handler.builder()
                            ...
                            .build();
                    wrapper.createArchivedLeaderboardRankingDataV1Handler(operation).ensureSuccess();
