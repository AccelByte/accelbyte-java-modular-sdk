...
public class PublicGetDescendantCategories implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.category.PublicGetDescendantCategories operation =
                    net.accelbyte.sdk.api.platform.operations.category.PublicGetDescendantCategories.builder()
                            ...
                            .storeId(storeId)
                            .build();
            final List<CategoryInfo> response =
                    wrapper.publicGetDescendantCategories(operation).ensureSuccess();
