...
public class CheckUserSubscriptionSubscribableByItemId implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.subscription.CheckUserSubscriptionSubscribableByItemId operation =
            ...
            final Subscribable response =
                    wrapper.checkUserSubscriptionSubscribableByItemId(operation).ensureSuccess();
