...
public class RetrieveAllThirdPartyLoginPlatformCredentialV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.third_party_credential.RetrieveAllThirdPartyLoginPlatformCredentialV3 operation =
            ...
            final List<ModelThirdPartyLoginPlatformCredentialResponse> response =
                    wrapper.retrieveAllThirdPartyLoginPlatformCredentialV3(operation).ensureSuccess();
