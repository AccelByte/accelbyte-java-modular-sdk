...
public class PublicGetPlayerBlockedPlayersV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.lobby.operations.player.PublicGetPlayerBlockedPlayersV1 operation =
            ...
            final ModelsGetAllPlayerBlockedUsersResponse response =
                    wrapper.publicGetPlayerBlockedPlayersV1(operation).ensureSuccess();
