...
public class DeleteActiveQueue implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.dsartifact.operations.artifact_upload_process_queue.DeleteActiveQueue operation =
                    net.accelbyte.sdk.api.dsartifact.operations.artifact_upload_process_queue.DeleteActiveQueue.builder()
                            .nodeIP(nodeIP)
                            .build();
                    wrapper.deleteActiveQueue(operation).ensureSuccess();
