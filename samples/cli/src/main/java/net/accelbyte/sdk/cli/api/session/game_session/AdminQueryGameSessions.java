...
public class AdminQueryGameSessions implements Callable<Integer> {
    ...
    @Option(names = {"--dsPodName"}, description = "dsPodName")
    String dsPodName;
    ...
    @Option(names = {"--isPersistent"}, description = "isPersistent")
    String isPersistent;
    ...
    @Option(names = {"--statusV2"}, description = "statusV2")
    String statusV2;
    ...
    public Integer call() {
        try {
            ...
            final ApimodelsGameSessionQueryResponse response =
                    wrapper.adminQueryGameSessions(operation).ensureSuccess();
