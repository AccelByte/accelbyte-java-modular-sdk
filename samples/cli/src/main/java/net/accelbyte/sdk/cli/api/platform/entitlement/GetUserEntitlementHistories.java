...
public class GetUserEntitlementHistories implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.entitlement.GetUserEntitlementHistories operation =
                    net.accelbyte.sdk.api.platform.operations.entitlement.GetUserEntitlementHistories.builder()
                            .entitlementId(entitlementId)
                            .namespace(namespace)
                            .userId(userId)
                            .build();
            final List<EntitlementHistoryInfo> response =
                    wrapper.getUserEntitlementHistories(operation).ensureSuccess();
