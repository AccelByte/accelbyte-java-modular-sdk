...
public class DeleteBulkLeaderboardConfigurationAdminV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration.DeleteBulkLeaderboardConfigurationAdminV1 operation =
            ...
            final ModelsDeleteBulkLeaderboardsResp response =
                    wrapper.deleteBulkLeaderboardConfigurationAdminV1(operation).ensureSuccess();
