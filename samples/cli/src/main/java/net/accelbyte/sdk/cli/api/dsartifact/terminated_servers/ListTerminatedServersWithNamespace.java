...
public class ListTerminatedServersWithNamespace implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.dsartifact.operations.terminated_servers.ListTerminatedServersWithNamespace operation =
                    net.accelbyte.sdk.api.dsartifact.operations.terminated_servers.ListTerminatedServersWithNamespace.builder()
                            .namespace(namespace)
