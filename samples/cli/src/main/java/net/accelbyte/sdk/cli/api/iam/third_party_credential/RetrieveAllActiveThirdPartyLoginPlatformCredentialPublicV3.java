...
public class RetrieveAllActiveThirdPartyLoginPlatformCredentialPublicV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.third_party_credential.RetrieveAllActiveThirdPartyLoginPlatformCredentialPublicV3 operation =
            ...
            final List<ModelPublicThirdPartyPlatformInfo> response =
                    wrapper.retrieveAllActiveThirdPartyLoginPlatformCredentialPublicV3(operation).ensureSuccess();
