...
public class RetrieveSingleLocalizedPolicyVersion implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace.RetrieveSingleLocalizedPolicyVersion operation =
                    net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace.RetrieveSingleLocalizedPolicyVersion.builder()
                            .localizedPolicyVersionId(localizedPolicyVersionId)
                            .namespace(namespace)
                            .build();
            final RetrieveLocalizedPolicyVersionResponse response =
                    wrapper.retrieveSingleLocalizedPolicyVersion(operation).ensureSuccess();
