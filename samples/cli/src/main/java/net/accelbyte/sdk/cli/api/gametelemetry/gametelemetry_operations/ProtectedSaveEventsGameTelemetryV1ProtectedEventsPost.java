...
public class ProtectedSaveEventsGameTelemetryV1ProtectedEventsPost implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.gametelemetry.operations.gametelemetry_operations.ProtectedSaveEventsGameTelemetryV1ProtectedEventsPost operation =
                    net.accelbyte.sdk.api.gametelemetry.operations.gametelemetry_operations.ProtectedSaveEventsGameTelemetryV1ProtectedEventsPost.builder()
                            ...
                            .build();
                    wrapper.protectedSaveEventsGameTelemetryV1ProtectedEventsPost(operation).ensureSuccess();
