...
public class GetLeaderboardConfigurationsAdminV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration.GetLeaderboardConfigurationsAdminV1 operation =
            ...
            final ModelsGetAllLeaderboardConfigsResp response =
                    wrapper.getLeaderboardConfigurationsAdminV1(operation).ensureSuccess();
