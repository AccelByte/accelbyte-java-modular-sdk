...
public class UpdateFulfillmentScript implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.fulfillment_script.UpdateFulfillmentScript operation =
                    net.accelbyte.sdk.api.platform.operations.fulfillment_script.UpdateFulfillmentScript.builder()
                            ...
                            .build();
            final FulfillmentScriptInfo response =
                    wrapper.updateFulfillmentScript(operation).ensureSuccess();
