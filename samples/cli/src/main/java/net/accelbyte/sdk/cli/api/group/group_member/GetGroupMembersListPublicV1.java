...
public class GetGroupMembersListPublicV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.group.operations.group_member.GetGroupMembersListPublicV1 operation =
            ...
            final ModelsGetGroupMemberListResponseV1 response =
                    wrapper.getGroupMembersListPublicV1(operation).ensureSuccess();
