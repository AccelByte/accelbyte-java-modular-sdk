...
public class AdminQueryGameSessionsByAttributes implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.session.operations.game_session.AdminQueryGameSessionsByAttributes operation =
                    net.accelbyte.sdk.api.session.operations.game_session.AdminQueryGameSessionsByAttributes.builder()
                            .namespace(namespace)
                            .body(new ObjectMapper().readValue(body, new TypeReference<Map<String, ?>>() {}))
                            .build();
            final ApimodelsGameSessionQueryResponse response =
                    wrapper.adminQueryGameSessionsByAttributes(operation).ensureSuccess();
