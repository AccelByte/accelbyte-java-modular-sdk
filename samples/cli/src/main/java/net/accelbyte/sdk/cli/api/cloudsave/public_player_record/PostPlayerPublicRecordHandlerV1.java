...
public class PostPlayerPublicRecordHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.public_player_record.PostPlayerPublicRecordHandlerV1 operation =
            ...
            final ModelsPlayerRecordResponse response =
                    wrapper.postPlayerPublicRecordHandlerV1(operation).ensureSuccess();
