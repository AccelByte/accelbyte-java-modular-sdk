...
public class GetGlobalStatItemByStatCode implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.social.operations.global_statistic.GetGlobalStatItemByStatCode operation =
                    net.accelbyte.sdk.api.social.operations.global_statistic.GetGlobalStatItemByStatCode.builder()
                            .namespace(namespace)
                            .statCode(statCode)
                            .build();
            final GlobalStatItemInfo response =
                    wrapper.getGlobalStatItemByStatCode(operation).ensureSuccess();
