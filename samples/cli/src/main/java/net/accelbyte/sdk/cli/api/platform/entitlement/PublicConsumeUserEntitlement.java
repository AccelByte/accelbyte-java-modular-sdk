...
public class PublicConsumeUserEntitlement implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.entitlement.PublicConsumeUserEntitlement operation =
                    net.accelbyte.sdk.api.platform.operations.entitlement.PublicConsumeUserEntitlement.builder()
                            ...
                            .build();
            final EntitlementDecrementResult response =
                    wrapper.publicConsumeUserEntitlement(operation).ensureSuccess();
