...
public class DeleteContentScreenshot implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.ugc.operations.public_content_legacy.DeleteContentScreenshot operation =
                    net.accelbyte.sdk.api.ugc.operations.public_content_legacy.DeleteContentScreenshot.builder()
                            .contentId(contentId)
                            .namespace(namespace)
                            .screenshotId(screenshotId)
                            .userId(userId)
                            .build();
                    wrapper.deleteContentScreenshot(operation).ensureSuccess();
