...
public class PlatformAuthenticateSAMLV3Handler implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.sso_saml_2_0.PlatformAuthenticateSAMLV3Handler operation =
                    net.accelbyte.sdk.api.iam.operations.sso_saml_2_0.PlatformAuthenticateSAMLV3Handler.builder()
                            ...
                            .state(state)
                            .build();
                    wrapper.platformAuthenticateSAMLV3Handler(operation).ensureSuccess();
