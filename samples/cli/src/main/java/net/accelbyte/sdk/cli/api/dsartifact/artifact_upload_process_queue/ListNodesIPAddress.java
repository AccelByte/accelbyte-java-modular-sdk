...
public class ListNodesIPAddress implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.dsartifact.operations.artifact_upload_process_queue.ListNodesIPAddress operation =
                    net.accelbyte.sdk.api.dsartifact.operations.artifact_upload_process_queue.ListNodesIPAddress.builder()
                            .limit(limit)
                            .next(next)
                            .nodeIP(nodeIP)
                            .previous(previous)
