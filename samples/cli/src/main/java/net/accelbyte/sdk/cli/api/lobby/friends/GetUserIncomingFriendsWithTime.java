...
public class GetUserIncomingFriendsWithTime implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.lobby.operations.friends.GetUserIncomingFriendsWithTime operation =
                    net.accelbyte.sdk.api.lobby.operations.friends.GetUserIncomingFriendsWithTime.builder()
                            .namespace(namespace)
                            .limit(limit)
                            .offset(offset)
                            .build();
