...
public class UploadContentScreenshot implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.ugc.operations.public_content_legacy.UploadContentScreenshot operation =
                    net.accelbyte.sdk.api.ugc.operations.public_content_legacy.UploadContentScreenshot.builder()
                            .contentId(contentId)
                            .namespace(namespace)
                            .userId(userId)
            ...
            final ModelsCreateScreenshotResponse response =
                    wrapper.uploadContentScreenshot(operation).ensureSuccess();
