...
public class GetLeaderboardConfigurationAdminV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration.GetLeaderboardConfigurationAdminV1 operation =
            ...
            final ModelsGetLeaderboardConfigResp response =
                    wrapper.getLeaderboardConfigurationAdminV1(operation).ensureSuccess();
