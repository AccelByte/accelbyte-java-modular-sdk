...
public class PublicBulkIncUserStatItemValue implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.social.operations.user_statistic.PublicBulkIncUserStatItemValue operation =
            ...
            final List<BulkStatOperationResult> response =
                    wrapper.publicBulkIncUserStatItemValue(operation).ensureSuccess();
