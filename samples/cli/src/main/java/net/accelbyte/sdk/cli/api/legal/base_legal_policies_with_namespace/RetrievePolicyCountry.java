...
public class RetrievePolicyCountry implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.base_legal_policies_with_namespace.RetrievePolicyCountry operation =
                    net.accelbyte.sdk.api.legal.operations.base_legal_policies_with_namespace.RetrievePolicyCountry.builder()
                            .basePolicyId(basePolicyId)
                            .countryCode(countryCode)
                            .namespace(namespace)
                            .build();
            final RetrievePolicyResponse response =
                    wrapper.retrievePolicyCountry(operation).ensureSuccess();
