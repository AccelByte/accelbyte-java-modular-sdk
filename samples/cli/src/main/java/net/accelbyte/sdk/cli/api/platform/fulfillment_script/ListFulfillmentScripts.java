...
public class ListFulfillmentScripts implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.fulfillment_script.ListFulfillmentScripts operation =
                    net.accelbyte.sdk.api.platform.operations.fulfillment_script.ListFulfillmentScripts.builder()
                            .build();
            final List<FulfillmentScriptInfo> response =
                    wrapper.listFulfillmentScripts(operation).ensureSuccess();
