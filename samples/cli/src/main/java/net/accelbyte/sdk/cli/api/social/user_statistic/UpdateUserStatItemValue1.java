...
public class UpdateUserStatItemValue1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.social.operations.user_statistic.UpdateUserStatItemValue1 operation =
            ...
            final StatItemIncResult response =
                    wrapper.updateUserStatItemValue1(operation).ensureSuccess();
