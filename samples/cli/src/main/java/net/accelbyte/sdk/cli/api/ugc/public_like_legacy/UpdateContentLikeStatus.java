...
public class UpdateContentLikeStatus implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.ugc.operations.public_like_legacy.UpdateContentLikeStatus operation =
                    net.accelbyte.sdk.api.ugc.operations.public_like_legacy.UpdateContentLikeStatus.builder()
                            .contentId(contentId)
                            .namespace(namespace)
                            .body(new ObjectMapper().readValue(body, ModelsContentLikeRequest.class)) 
                            .build();
            final ModelsContentLikeResponse response =
                    wrapper.updateContentLikeStatus(operation).ensureSuccess();
