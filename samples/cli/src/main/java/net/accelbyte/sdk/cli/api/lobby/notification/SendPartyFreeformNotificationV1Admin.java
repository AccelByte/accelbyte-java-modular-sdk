...
public class SendPartyFreeformNotificationV1Admin implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.lobby.operations.notification.SendPartyFreeformNotificationV1Admin operation =
                    net.accelbyte.sdk.api.lobby.operations.notification.SendPartyFreeformNotificationV1Admin.builder()
                            ...
                            .build();
                    wrapper.sendPartyFreeformNotificationV1Admin(operation).ensureSuccess();
