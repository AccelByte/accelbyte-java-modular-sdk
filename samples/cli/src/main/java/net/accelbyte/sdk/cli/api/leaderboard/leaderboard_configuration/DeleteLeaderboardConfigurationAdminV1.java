...
public class DeleteLeaderboardConfigurationAdminV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration.DeleteLeaderboardConfigurationAdminV1 operation =
                    net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration.DeleteLeaderboardConfigurationAdminV1.builder()
                            ...
                            .namespace(namespace)
                            .build();
                    wrapper.deleteLeaderboardConfigurationAdminV1(operation).ensureSuccess();
