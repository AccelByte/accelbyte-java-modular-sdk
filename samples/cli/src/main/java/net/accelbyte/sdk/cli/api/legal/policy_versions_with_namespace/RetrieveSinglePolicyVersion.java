...
public class RetrieveSinglePolicyVersion implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.policy_versions_with_namespace.RetrieveSinglePolicyVersion operation =
                    net.accelbyte.sdk.api.legal.operations.policy_versions_with_namespace.RetrieveSinglePolicyVersion.builder()
                            .namespace(namespace)
                            .policyId(policyId)
                            .versionId(versionId)
                            .build();
            final List<RetrievePolicyVersionResponse> response =
                    wrapper.retrieveSinglePolicyVersion(operation).ensureSuccess();
