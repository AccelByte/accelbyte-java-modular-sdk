...
public class SyncOculusConsumableEntitlements implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.iap.SyncOculusConsumableEntitlements operation =
                    net.accelbyte.sdk.api.platform.operations.iap.SyncOculusConsumableEntitlements.builder()
                            .namespace(namespace)
                            .userId(userId)
                            .build();
            final List<OculusReconcileResult> response =
                    wrapper.syncOculusConsumableEntitlements(operation).ensureSuccess();
