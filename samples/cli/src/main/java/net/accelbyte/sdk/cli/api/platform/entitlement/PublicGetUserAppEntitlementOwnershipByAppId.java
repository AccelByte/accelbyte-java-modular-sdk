...
public class PublicGetUserAppEntitlementOwnershipByAppId implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.entitlement.PublicGetUserAppEntitlementOwnershipByAppId operation =
            ...
            final Ownership response =
                    wrapper.publicGetUserAppEntitlementOwnershipByAppId(operation).ensureSuccess();
