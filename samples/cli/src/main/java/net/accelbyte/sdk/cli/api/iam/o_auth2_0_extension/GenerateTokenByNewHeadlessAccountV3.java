...
public class GenerateTokenByNewHeadlessAccountV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.o_auth2_0_extension.GenerateTokenByNewHeadlessAccountV3 operation =
            ...
            final OauthmodelTokenResponseV3 response =
                    wrapper.generateTokenByNewHeadlessAccountV3(operation).ensureSuccess();
