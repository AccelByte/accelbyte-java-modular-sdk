...
public class DeleteSubscriptionAppNotificationV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.csm.operations.notification_subscription_v3.DeleteSubscriptionAppNotificationV3 operation =
                    net.accelbyte.sdk.api.csm.operations.notification_subscription_v3.DeleteSubscriptionAppNotificationV3.builder()
                            .app(app)
                            .namespace(namespace)
                            .emailAddress(emailAddress)
                            .userId(userId)
                            .build();
                    wrapper.deleteSubscriptionAppNotificationV3(operation).ensureSuccess();
