...
public class AdminGetAllPlayerSessionAttribute implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.lobby.operations.player.AdminGetAllPlayerSessionAttribute operation =
            ...
            final ModelsGetAllPlayerSessionAttributeResponse response =
                    wrapper.adminGetAllPlayerSessionAttribute(operation).ensureSuccess();
