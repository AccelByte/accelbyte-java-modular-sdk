...
public class PostPlayerRecordHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.public_player_record.PostPlayerRecordHandlerV1 operation =
            ...
            final ModelsPlayerRecordResponse response =
                    wrapper.postPlayerRecordHandlerV1(operation).ensureSuccess();
