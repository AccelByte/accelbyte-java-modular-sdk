...
public class DeleteNotificationTemplateSlugV1Admin implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.lobby.operations.notification.DeleteNotificationTemplateSlugV1Admin operation =
                    net.accelbyte.sdk.api.lobby.operations.notification.DeleteNotificationTemplateSlugV1Admin.builder()
                            .namespace(namespace)
                            .templateSlug(templateSlug)
                            .build();
                    wrapper.deleteNotificationTemplateSlugV1Admin(operation).ensureSuccess();
