...
public class AdminUpdateConfigurationAlertV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.session.operations.configuration_template.AdminUpdateConfigurationAlertV1 operation =
                    net.accelbyte.sdk.api.session.operations.configuration_template.AdminUpdateConfigurationAlertV1.builder()
                            .namespace(namespace)
