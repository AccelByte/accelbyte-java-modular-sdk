...
public class GetAllNotificationTemplatesV1Admin implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.lobby.operations.notification.GetAllNotificationTemplatesV1Admin operation =
            ...
            final List<ModelNotificationTemplateResponse> response =
                    wrapper.getAllNotificationTemplatesV1Admin(operation).ensureSuccess();
