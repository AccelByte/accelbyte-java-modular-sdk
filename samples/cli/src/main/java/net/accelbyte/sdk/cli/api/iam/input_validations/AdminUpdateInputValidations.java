...
public class AdminUpdateInputValidations implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.input_validations.AdminUpdateInputValidations operation =
                    net.accelbyte.sdk.api.iam.operations.input_validations.AdminUpdateInputValidations.builder()
                            ...
                            .build();
                    wrapper.adminUpdateInputValidations(operation).ensureSuccess();
