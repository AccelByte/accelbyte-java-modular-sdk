...
public class PublicGetMyAppEntitlementOwnershipByAppId implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.entitlement.PublicGetMyAppEntitlementOwnershipByAppId operation =
            ...
            final Ownership response =
                    wrapper.publicGetMyAppEntitlementOwnershipByAppId(operation).ensureSuccess();
