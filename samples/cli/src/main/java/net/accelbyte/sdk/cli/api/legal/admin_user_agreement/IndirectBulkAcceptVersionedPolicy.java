...
public class IndirectBulkAcceptVersionedPolicy implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.admin_user_agreement.IndirectBulkAcceptVersionedPolicy operation =
            ...
            final AcceptAgreementResponse response =
                    wrapper.indirectBulkAcceptVersionedPolicy(operation).ensureSuccess();
