...
public class PublicGetInputValidationByField implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.input_validations.PublicGetInputValidationByField operation =
                    net.accelbyte.sdk.api.iam.operations.input_validations.PublicGetInputValidationByField.builder()
                            .field(field)
                            .build();
            final ModelInputValidationConfigVersion response =
                    wrapper.publicGetInputValidationByField(operation).ensureSuccess();
