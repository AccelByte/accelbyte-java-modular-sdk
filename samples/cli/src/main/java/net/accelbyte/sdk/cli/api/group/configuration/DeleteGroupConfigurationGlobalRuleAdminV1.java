...
public class DeleteGroupConfigurationGlobalRuleAdminV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.group.operations.configuration.DeleteGroupConfigurationGlobalRuleAdminV1 operation =
            ...
            final ModelsUpdateGroupConfigurationResponseV1 response =
                    wrapper.deleteGroupConfigurationGlobalRuleAdminV1(operation).ensureSuccess();
