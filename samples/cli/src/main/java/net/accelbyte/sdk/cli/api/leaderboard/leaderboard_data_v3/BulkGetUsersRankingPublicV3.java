...
public class BulkGetUsersRankingPublicV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data_v3.BulkGetUsersRankingPublicV3 operation =
                    net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data_v3.BulkGetUsersRankingPublicV3.builder()
                            .leaderboardCode(leaderboardCode)
                            .namespace(namespace)
                            .body(new ObjectMapper().readValue(body, ModelsBulkUserIDsRequest.class)) 
                            .build();
            final ModelsBulkUserRankingResponseV3 response =
                    wrapper.bulkGetUsersRankingPublicV3(operation).ensureSuccess();
