...
public class InitiateExportAgreementsToCSV implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.agreement_with_namespace.InitiateExportAgreementsToCSV operation =
                    net.accelbyte.sdk.api.legal.operations.agreement_with_namespace.InitiateExportAgreementsToCSV.builder()
                            .namespace(namespace)
                            .end(end)
            ...
            final InitiateExportAgreementsToCSVResponse response =
                    wrapper.initiateExportAgreementsToCSV(operation).ensureSuccess();
