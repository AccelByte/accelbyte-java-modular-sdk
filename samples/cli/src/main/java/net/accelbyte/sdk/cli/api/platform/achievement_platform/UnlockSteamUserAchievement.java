...
public class UnlockSteamUserAchievement implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.achievement_platform.UnlockSteamUserAchievement operation =
                    net.accelbyte.sdk.api.platform.operations.achievement_platform.UnlockSteamUserAchievement.builder()
                            ...
                            .build();
                    wrapper.unlockSteamUserAchievement(operation).ensureSuccess();
