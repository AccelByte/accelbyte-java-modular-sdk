...
public class AdminSubmitUserAccountDeletionRequest implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.gdpr.operations.data_deletion.AdminSubmitUserAccountDeletionRequest operation =
            ...
            final ModelsRequestDeleteResponse response =
                    wrapper.adminSubmitUserAccountDeletionRequest(operation).ensureSuccess();
