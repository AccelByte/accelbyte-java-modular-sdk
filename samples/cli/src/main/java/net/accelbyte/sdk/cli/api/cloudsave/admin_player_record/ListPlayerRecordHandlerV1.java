...
public class ListPlayerRecordHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.admin_player_record.ListPlayerRecordHandlerV1 operation =
            ...
            final ModelsListPlayerRecordKeysResponse response =
                    wrapper.listPlayerRecordHandlerV1(operation).ensureSuccess();
