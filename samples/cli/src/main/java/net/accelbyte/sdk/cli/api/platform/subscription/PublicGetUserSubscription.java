...
public class PublicGetUserSubscription implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.subscription.PublicGetUserSubscription operation =
            ...
            final SubscriptionInfo response =
                    wrapper.publicGetUserSubscription(operation).ensureSuccess();
