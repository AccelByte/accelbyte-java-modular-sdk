...
public class RetrieveAllActiveThirdPartyLoginPlatformCredentialV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.third_party_credential.RetrieveAllActiveThirdPartyLoginPlatformCredentialV3 operation =
            ...
            final List<ModelThirdPartyLoginPlatformCredentialResponse> response =
                    wrapper.retrieveAllActiveThirdPartyLoginPlatformCredentialV3(operation).ensureSuccess();
