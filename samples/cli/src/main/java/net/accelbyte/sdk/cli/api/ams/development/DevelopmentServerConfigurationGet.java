...
public class DevelopmentServerConfigurationGet implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.ams.operations.development.DevelopmentServerConfigurationGet operation =
                    net.accelbyte.sdk.api.ams.operations.development.DevelopmentServerConfigurationGet.builder()
                            .developmentServerConfigID(developmentServerConfigID)
                            .namespace(namespace)
                            .build();
            final ApiDevelopmentServerConfigurationGetResponse response =
                    wrapper.developmentServerConfigurationGet(operation).ensureSuccess();
