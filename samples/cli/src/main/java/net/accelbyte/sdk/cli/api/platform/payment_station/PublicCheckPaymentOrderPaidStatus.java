...
public class PublicCheckPaymentOrderPaidStatus implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.payment_station.PublicCheckPaymentOrderPaidStatus operation =
                    net.accelbyte.sdk.api.platform.operations.payment_station.PublicCheckPaymentOrderPaidStatus.builder()
                            .namespace(namespace)
                            .paymentOrderNo(paymentOrderNo)
                            .build();
            final PaymentOrderPaidResult response =
                    wrapper.publicCheckPaymentOrderPaidStatus(operation).ensureSuccess();
