...
public class AdminRequestDataRetrieval implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.gdpr.operations.data_retrieval.AdminRequestDataRetrieval operation =
            ...
            final ModelsDataRetrievalResponse response =
                    wrapper.adminRequestDataRetrieval(operation).ensureSuccess();
