...
public class DeleteSSOLoginPlatformCredentialV3 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.sso_credential.DeleteSSOLoginPlatformCredentialV3 operation =
                    net.accelbyte.sdk.api.iam.operations.sso_credential.DeleteSSOLoginPlatformCredentialV3.builder()
                            .namespace(namespace)
                            .platformId(platformId)
                            .build();
                    wrapper.deleteSSOLoginPlatformCredentialV3(operation).ensureSuccess();
