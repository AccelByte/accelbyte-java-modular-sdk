...
public class UpdatePolicyVersion implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.policy_versions_with_namespace.UpdatePolicyVersion operation =
                    net.accelbyte.sdk.api.legal.operations.policy_versions_with_namespace.UpdatePolicyVersion.builder()
                            .namespace(namespace)
                            .policyVersionId(policyVersionId)
                            .body(new ObjectMapper().readValue(body, UpdatePolicyVersionRequest.class)) 
                            .build();
            final UpdatePolicyVersionResponse response =
                    wrapper.updatePolicyVersion(operation).ensureSuccess();
