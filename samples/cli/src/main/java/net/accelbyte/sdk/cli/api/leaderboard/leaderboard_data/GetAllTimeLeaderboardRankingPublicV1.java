...
public class GetAllTimeLeaderboardRankingPublicV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.GetAllTimeLeaderboardRankingPublicV1 operation =
            ...
            final ModelsGetLeaderboardRankingResp response =
                    wrapper.getAllTimeLeaderboardRankingPublicV1(operation).ensureSuccess();
