...
public class PublicQueryUserSubscriptions implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.subscription.PublicQueryUserSubscriptions operation =
            ...
            final SubscriptionPagingSlicedResult response =
                    wrapper.publicQueryUserSubscriptions(operation).ensureSuccess();
