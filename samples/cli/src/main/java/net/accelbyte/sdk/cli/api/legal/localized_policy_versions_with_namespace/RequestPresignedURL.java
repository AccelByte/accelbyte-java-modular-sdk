...
public class RequestPresignedURL implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace.RequestPresignedURL operation =
                    net.accelbyte.sdk.api.legal.operations.localized_policy_versions_with_namespace.RequestPresignedURL.builder()
            ...
            final UploadLocalizedPolicyVersionAttachmentResponse response =
                    wrapper.requestPresignedURL(operation).ensureSuccess();
