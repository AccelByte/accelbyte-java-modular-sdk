...
public class AdminResetInputValidations implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.iam.operations.input_validations.AdminResetInputValidations operation =
                    net.accelbyte.sdk.api.iam.operations.input_validations.AdminResetInputValidations.builder()
                            .field(field)
                            .build();
                    wrapper.adminResetInputValidations(operation).ensureSuccess();
