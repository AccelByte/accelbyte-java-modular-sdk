...
public class PublicSearchContent implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.ugc.operations.public_content_legacy.PublicSearchContent operation =
                    net.accelbyte.sdk.api.ugc.operations.public_content_legacy.PublicSearchContent.builder()
                            .namespace(namespace)
                            .creator(creator)
                            .ishidden(ishidden)
            ...
            final ModelsPaginatedContentDownloadResponse response =
                    wrapper.publicSearchContent(operation).ensureSuccess();
