...
public class CreateGroupConfigurationAdminV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.group.operations.configuration.CreateGroupConfigurationAdminV1 operation =
            ...
            final ModelsCreateGroupConfigurationResponseV1 response =
                    wrapper.createGroupConfigurationAdminV1(operation).ensureSuccess();
