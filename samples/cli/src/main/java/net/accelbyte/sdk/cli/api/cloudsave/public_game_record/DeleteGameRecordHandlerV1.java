...
public class DeleteGameRecordHandlerV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.cloudsave.operations.public_game_record.DeleteGameRecordHandlerV1 operation =
                    net.accelbyte.sdk.api.cloudsave.operations.public_game_record.DeleteGameRecordHandlerV1.builder()
                            .key(key)
                            .namespace(namespace)
                            .build();
                    wrapper.deleteGameRecordHandlerV1(operation).ensureSuccess();
