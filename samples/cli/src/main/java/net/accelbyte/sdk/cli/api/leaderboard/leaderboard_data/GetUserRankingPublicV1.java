...
public class GetUserRankingPublicV1 implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.GetUserRankingPublicV1 operation =
                    net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.GetUserRankingPublicV1.builder()
                            ...
                            .build();
            final ModelsUserRankingResponse response =
                    wrapper.getUserRankingPublicV1(operation).ensureSuccess();
