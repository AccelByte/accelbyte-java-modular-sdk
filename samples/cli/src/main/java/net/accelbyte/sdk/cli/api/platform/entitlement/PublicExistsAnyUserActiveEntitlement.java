...
public class PublicExistsAnyUserActiveEntitlement implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            final net.accelbyte.sdk.api.platform.operations.entitlement.PublicExistsAnyUserActiveEntitlement operation =
            ...
            final Ownership response =
                    wrapper.publicExistsAnyUserActiveEntitlement(operation).ensureSuccess();
