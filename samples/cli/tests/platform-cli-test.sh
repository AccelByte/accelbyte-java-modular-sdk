...
./ng net.accelbyte.sdk.cli.Main platform bulkCredit \
    --namespace "$AB_NAMESPACE" \
    --body '[{"creditRequest": {"amount": 36, "expireAt": "1992-05-21T00:00:00Z", "origin": "Xbox", "reason": "RPcnG89rnNW1Yjfn", "source": "GIFT"}, "currencyCode": "lY4DnYRxY8ZhHeb0", "userIds": ["LpToj9rgr5RffM5J", "XvPdzEpDln04F8BQ", "CaPFDjrSotKnpJWA"]}, {"creditRequest": {"amount": 20, "expireAt": "1980-07-30T00:00:00Z", "origin": "Nintendo", "reason": "iNJtqXltZF6aSRmH", "source": "SELL_BACK"}, "currencyCode": "fkStOqdXqhDMQ6tB", "userIds": ["LljC7gcT3M1DArk4", "KMHK5fbqioeoRIpl", "L80aXFY7SQkym9Kv"]}, {"creditRequest": {"amount": 96, "expireAt": "1985-10-18T00:00:00Z", "origin": "Twitch", "reason": "ruU4uIXBZsEYogFW", "source": "GIFT"}, "currencyCode": "o6M11LLZWKgWxn9Y", "userIds": ["QzzKdFg7N7piT8Vc", "33ZIUrIkfmdXVvaP", "L16HQdtAneXGgxNg"]}]' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main platform bulkDebit \
    --namespace "$AB_NAMESPACE" \
    --body '[{"currencyCode": "rXLZnuMNpKEIs3GC", "request": {"allowOverdraft": true, "amount": 75, "balanceOrigin": "Epic", "reason": "7tkJWFpHt7MdKu9X"}, "userIds": ["wn5GHJDGatrYOMO9", "7mMuBXPDKCriRKzT", "1CYEjX867n9PT9fR"]}, {"currencyCode": "Z7TXAVRnUVbxEJcK", "request": {"allowOverdraft": true, "amount": 69, "balanceOrigin": "Other", "reason": "64EwhQfxFKIOGT1W"}, "userIds": ["KSmLoA0ILaESC1GJ", "3zQJoQLTAlW75icI", "XsoBwqh0TQXa2j7v"]}, {"currencyCode": "KUpXazsFrmaGNoi3", "request": {"allowOverdraft": true, "amount": 86, "balanceOrigin": "Other", "reason": "TgWotLNz0u8ySxA0"}, "userIds": ["2y0DY1E1SMK9oA4v", "K56dsYI5SKV5pDAN", "yrjz4q7e0EJnADXC"]}]' \
    > test.out 2>&1
