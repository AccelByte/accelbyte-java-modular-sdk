...
./ng net.accelbyte.sdk.cli.Main sessionbrowser adminQuerySession \
    ...
    --gameMode 'BiKrPIzt' \
    --gameVersion 'B8HeWpVk' \
    --joinable 'ImBFvXWH' \
    --limit '33' \
    --matchExist '5ImGF1L8' \
    --matchId 'Vc9thIdq' \
    --offset '11' \
    --serverStatus 'td6wo1VW' \
    --userId 'ELhiswFC' \
    --sessionType '1ut5VtBH' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main sessionbrowser userQuerySession \
    --namespace "$AB_NAMESPACE" \
    --gameMode 'fvMXMbs8' \
    --gameVersion '2uBi7ER3' \
    --joinable '9YlhOhuN' \
    --limit '33' \
    --matchExist 'tLknR9FI' \
    --matchId 'unuT7DXM' \
    --offset '94' \
    --serverStatus 'xVeYVj5E' \
    --userId 'T0ljoO4P' \
    --sessionType '9E5c9Lkv' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main sessionbrowser createSession \
    --namespace "$AB_NAMESPACE" \
    --body '{"game_session_setting": {"allow_join_in_progress": false, "current_internal_player": 13, "current_player": 36, "map_name": "vbSuYCLE", "max_internal_player": 41, "max_player": 48, "mode": "hS935Nqu", "num_bot": 2, "password": "XuWrmUXo", "settings": {"luZqZxIr": {}, "fbW6UIbp": {}, "GGN407kC": {}}}, "game_version": "96V2JndC", "namespace": "5BgG8ICC", "session_type": "VpcSro09", "username": "Gcfjm1zv"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main sessionbrowser addPlayerToSession \
    --namespace "$AB_NAMESPACE" \
    --sessionID 'WPTV9yGX' \
    --body '{"as_spectator": false, "user_id": "DnkcmD3u"}' \
    > test.out 2>&1
