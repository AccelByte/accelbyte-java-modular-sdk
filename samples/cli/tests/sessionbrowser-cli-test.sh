...
./ng net.accelbyte.sdk.cli.Main sessionbrowser adminQuerySession \
    ...
    --gameMode 'XtqXmbVx' \
    --gameVersion 'ARFVcltz' \
    --joinable 'SyFP79bL' \
    --limit '24' \
    --matchExist 'FGa2lKlf' \
    --matchId '7qSPaaGk' \
    --offset '67' \
    --serverStatus '8IlaWDZR' \
    --userId 'k2g4DP3x' \
    --sessionType 'pG1KHwSz' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main sessionbrowser userQuerySession \
    --namespace "$AB_NAMESPACE" \
    --gameMode 'OXnAvkh9' \
    --gameVersion 'dxYTDgdG' \
    --joinable '5Saz8bGr' \
    --limit '1' \
    --matchExist 'MkueAXYB' \
    --matchId 'lC4ue3gy' \
    --offset '67' \
    --serverStatus 'hLhkYwEW' \
    --userId 'fllDVCjU' \
    --sessionType 'DaVtKlGe' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main sessionbrowser createSession \
    --namespace "$AB_NAMESPACE" \
    --body '{"game_session_setting": {"allow_join_in_progress": true, "current_internal_player": 5, "current_player": 89, "map_name": "ji7clCe9", "max_internal_player": 67, "max_player": 7, "mode": "fTsK1CJK", "num_bot": 28, "password": "60fcsG6i", "settings": {"xjbsTqTW": {}, "WjV53tvy": {}, "efNmdzvo": {}}}, "game_version": "2vsfoemB", "namespace": "IL5gIclB", "session_type": "OasvP9Bf", "username": "6jUkHmdm"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main sessionbrowser addPlayerToSession \
    --namespace "$AB_NAMESPACE" \
    --sessionID 'oNmihkPW' \
    --body '{"as_spectator": true, "user_id": "Ye0vN235"}' \
    > test.out 2>&1
