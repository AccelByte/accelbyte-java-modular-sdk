...
./ng net.accelbyte.sdk.cli.Main sessionbrowser adminQuerySession \
    ...
    --gameMode 'q2sJ6YO3' \
    --gameVersion 'zcNN6aG2' \
    --joinable 'Ub1rc4kj' \
    --limit '57' \
    --matchExist 'IYmGysev' \
    --matchId 'RBWdNuPO' \
    --offset '0' \
    --serverStatus 'Dr2cu7cU' \
    --userId '07CjSDPr' \
    --sessionType 'umuobWqd' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main sessionbrowser userQuerySession \
    --namespace "$AB_NAMESPACE" \
    --gameMode '8mZY5jxx' \
    --gameVersion 'v5LT1uoB' \
    --joinable 'fMkID1vF' \
    --limit '50' \
    --matchExist '5PtjFWAy' \
    --matchId 'w3p8jWX1' \
    --offset '74' \
    --serverStatus 'Na3X9SN8' \
    --userId 'iApfqtI6' \
    --sessionType '5EkKy53x' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main sessionbrowser createSession \
    --namespace "$AB_NAMESPACE" \
    --body '{"game_session_setting": {"allow_join_in_progress": false, "current_internal_player": 27, "current_player": 40, "map_name": "hsoDK2kO", "max_internal_player": 39, "max_player": 91, "mode": "gcZ8RVBE", "num_bot": 19, "password": "Qj2afcoq", "settings": {"QP7JpcbI": {}, "5eCGUjB3": {}, "zm0bYo0o": {}}}, "game_version": "Mjzq5sPt", "namespace": "utJHThqi", "session_type": "vtNLpJIq", "username": "TYz5YMJU"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main sessionbrowser addPlayerToSession \
    --namespace "$AB_NAMESPACE" \
    --sessionID 'eMGbRdEb' \
    --body '{"as_spectator": true, "user_id": "iSGY0CVA"}' \
    > test.out 2>&1
