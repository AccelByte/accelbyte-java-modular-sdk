...
./ng net.accelbyte.sdk.cli.Main sessionbrowser adminQuerySession \
    ...
    --gameMode '3PLhZJ2z' \
    --gameVersion 'yN9av4oK' \
    --joinable '95IkdCSB' \
    --limit '69' \
    --matchExist 'lhc2v6Fs' \
    --matchId 'ke4lUZEi' \
    --offset '88' \
    --serverStatus 'Y97AYInc' \
    --userId 'KjWyxDF1' \
    --sessionType 'Ow2B2IdI' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main sessionbrowser userQuerySession \
    --namespace "$AB_NAMESPACE" \
    --gameMode 'SlXVJ1pN' \
    --gameVersion 'gKxOR0By' \
    --joinable 'vvY8mOsn' \
    --limit '3' \
    --matchExist 'ODDnOffT' \
    --matchId 'beiS4UJ5' \
    --offset '61' \
    --serverStatus 'xJSU3jVZ' \
    --userId 'omNSZjPZ' \
    --sessionType 'BzoiJoTN' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main sessionbrowser createSession \
    --namespace "$AB_NAMESPACE" \
    --body '{"game_session_setting": {"allow_join_in_progress": false, "current_internal_player": 40, "current_player": 75, "map_name": "Pjy6Cdtm", "max_internal_player": 82, "max_player": 23, "mode": "mIKm5sMf", "num_bot": 45, "password": "7GqMHkEo", "settings": {"8zmPDA8d": {}, "gy5VJGze": {}, "gRtIYQ0e": {}}}, "game_version": "fwBwRrUT", "namespace": "WI2JiMWY", "session_type": "wdnAvRtp", "username": "2abhm9q2"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main sessionbrowser addPlayerToSession \
    --namespace "$AB_NAMESPACE" \
    --sessionID 'm0BsIaCR' \
    --body '{"as_spectator": false, "user_id": "GckR4iOZ"}' \
    > test.out 2>&1
