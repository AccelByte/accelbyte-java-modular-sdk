...
./ng net.accelbyte.sdk.cli.Main social updateStat \
    ...
    --body '{"cycleIds": ["m1MiaI1mX2tJoARt", "LVd3DlhLuIpomM8s", "iOG4UcqsuGKHhMRW"], "defaultValue": 0.06079653984735289, "description": "bBe7udsMrok0WvGY", "ignoreAdditionalDataOnValueRejected": false, "isPublic": false, "name": "WjLfFmteue9nzJ6f", "tags": ["H24T805tVg8JqU0j", "ZpjvsugAOS7u8RiW", "yerCSa8SRgwsAj1i"]}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main social createStat1 \
    --namespace "$AB_NAMESPACE" \
    --body '{"cycleIds": ["rKt2ecozL0TOg54v", "CE48L5oLF6M4lNa4", "dNQrmsApRA6HX3Rw"], "defaultValue": 0.5734890418300337, "description": "UMSHNgqRqCV7usam", "ignoreAdditionalDataOnValueRejected": true, "incrementOnly": true, "isPublic": false, "maximum": 0.16524676040011177, "minimum": 0.833758698680912, "name": "lOX9Sfo95HgXqKhT", "setAsGlobal": false, "setBy": "SERVER", "statCode": "kLOsp0LZ5njN86Hl", "tags": ["q2LgkQuaS7RBx3vi", "VyW9dD1kOmvrAejc", "8kUXzt6bSc6bWvgp"]}' \
    > test.out 2>&1
