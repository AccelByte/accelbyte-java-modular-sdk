...
./ng net.accelbyte.sdk.cli.Main social createStat1 \
    --namespace "$AB_NAMESPACE" \
    --body '{"cycleIds": ["dNQrmsApRA6HX3Rw", "CE48L5oLF6M4lNa4", "rKt2ecozL0TOg54v"], "defaultValue": 0.5734890418300337, "description": "UMSHNgqRqCV7usam", "ignoreAdditionalDataOnValueRejected": true, "incrementOnly": true, "isPublic": false, "maximum": 0.16524676040011177, "minimum": 0.833758698680912, "name": "lOX9Sfo95HgXqKhT", "setAsGlobal": false, "setBy": "SERVER", "statCode": "kLOsp0LZ5njN86Hl", "tags": ["VyW9dD1kOmvrAejc", "8kUXzt6bSc6bWvgp", "q2LgkQuaS7RBx3vi"]}' \
    > test.out 2>&1
