...
./ng net.accelbyte.sdk.cli.Main leaderboard createLeaderboardConfigurationAdminV1 \
    --namespace "$AB_NAMESPACE" \
    --body '{"daily": {"resetTime": "YpOJ4rJT"}, "descending": false, "iconURL": "rL4LL09n", "leaderboardCode": "vL49g0Xq", "monthly": {"resetDate": 33, "resetTime": "Fv5W7uxb"}, "name": "NvtLwDrI", "seasonPeriod": 63, "startTime": "3rKfBmLP", "statCode": "QCEnedWK", "weekly": {"resetDay": 53, "resetTime": "7ffIqzYc"}}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard createArchivedLeaderboardRankingDataV1Handler \
    --namespace "$AB_NAMESPACE" \
    --body '{"leaderboardCodes": ["jEn6GIc9", "DBxbA1Vu", "e1LNLh1S"], "limit": 93, "slug": "DDYh8ubx"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard updateLeaderboardConfigurationAdminV1 \
    --leaderboardCode 'ZOfhtdf0' \
    --namespace "$AB_NAMESPACE" \
    --body '{"daily": {"resetTime": "I0wRJfx2"}, "descending": false, "iconURL": "FQlOdwNI", "monthly": {"resetDate": 68, "resetTime": "4lnbnAuk"}, "name": "Fm7H8I9E", "seasonPeriod": 68, "startTime": "SBLuRAsJ", "statCode": "Dv6IzZLc", "weekly": {"resetDay": 48, "resetTime": "CgsVC078"}}' \
    > test.out 2>&1
eval_tap $? 8 'UpdateLeaderboardConfigurationAdminV1' test.out

#- 9 DeleteLeaderboardConfigurationAdminV1
./ng net.accelbyte.sdk.cli.Main leaderboard deleteLeaderboardConfigurationAdminV1 \
    --leaderboardCode 'HDh0e4EI' \
    --namespace "$AB_NAMESPACE" \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard updateUserPointAdminV1 \
    --leaderboardCode '8PeobmEz' \
    --namespace "$AB_NAMESPACE" \
    --userId 'TmuXcz40' \
    --body '{"inc": 0.13090575032425067, "latestValue": 0.2159910713882386}' \
    > test.out 2>&1
eval_tap $? 17 'UpdateUserPointAdminV1' test.out

#- 18 DeleteUserRankingAdminV1
./ng net.accelbyte.sdk.cli.Main leaderboard deleteUserRankingAdminV1 \
    --leaderboardCode 'RsZTTXjk' \
    --namespace "$AB_NAMESPACE" \
    --userId 'zNJOTDMA' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard deleteUserRankingsAdminV1 \
    --namespace "$AB_NAMESPACE" \
    --userId '8sFxlv7q' \
    --leaderboardCode 'qsR5eVaP,ZTpHGzhM,YV2gJpIC' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard createLeaderboardConfigurationPublicV1 \
    --namespace "$AB_NAMESPACE" \
    --body '{"daily": {"resetTime": "8KPSUxye"}, "descending": true, "iconURL": "v6ypZUya", "leaderboardCode": "nEGn4P5i", "monthly": {"resetDate": 50, "resetTime": "RuEHcTPV"}, "name": "Hf11cJ8H", "seasonPeriod": 1, "startTime": "OIyNF9XB", "statCode": "hhQ7ndvV", "weekly": {"resetDay": 29, "resetTime": "Y077TGU8"}}' \
    > test.out 2>&1
eval_tap $? 24 'CreateLeaderboardConfigurationPublicV1' test.out

#- 25 GetAllTimeLeaderboardRankingPublicV1
./ng net.accelbyte.sdk.cli.Main leaderboard getAllTimeLeaderboardRankingPublicV1 \
    --leaderboardCode 'odVocz8d' \
    --namespace "$AB_NAMESPACE" \
    --limit '98' \
    --offset '15' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard createLeaderboardConfigurationAdminV3 \
    --namespace "$AB_NAMESPACE" \
    --body '{"allTime": false, "cycleIds": ["MIYQtRmm", "SnvXzrv9", "toJLnJuv"], "descending": true, "description": "QVv3SEgo", "iconURL": "PXlqegLV", "leaderboardCode": "cM85Ssgm", "name": "2nVpgLrn", "statCode": "oRWEJsnB"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard updateLeaderboardConfigurationAdminV3 \
    --leaderboardCode 'eN6XR9hz' \
    --namespace "$AB_NAMESPACE" \
    --body '{"allTime": false, "cycleIds": ["sfgnydN9", "HCBxlGUH", "vj4sqRZU"], "descending": false, "description": "irf99Xd6", "iconURL": "b0Q8XO2r", "name": "BX17xOlV"}' \
    > test.out 2>&1
eval_tap $? 43 'UpdateLeaderboardConfigurationAdminV3' test.out

#- 44 DeleteLeaderboardConfigurationAdminV3
./ng net.accelbyte.sdk.cli.Main leaderboard deleteLeaderboardConfigurationAdminV3 \
    --leaderboardCode 'w7gYAm9v' \
    --namespace "$AB_NAMESPACE" \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard deleteUserRankingsAdminV3 \
    --namespace "$AB_NAMESPACE" \
    --userId 'qQkt7eom' \
    --leaderboardCode 'p9A3Fwi5,92Ibu0Yx,oXCEAU5o' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard bulkGetUsersRankingPublicV3 \
    --leaderboardCode '0qMr1hxb' \
    --namespace "$AB_NAMESPACE" \
    --previousVersion '63' \
    --body '{"userIds": ["s78Cg3I6", "dFCS45Hi", "ItPTXspv"]}' \
    > test.out 2>&1
