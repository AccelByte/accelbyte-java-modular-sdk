...
./ng net.accelbyte.sdk.cli.Main leaderboard createLeaderboardConfigurationAdminV1 \
    --namespace "$AB_NAMESPACE" \
    --body '{"daily": {"resetTime": "xSjIkICt"}, "descending": false, "iconURL": "foxHULiG", "leaderboardCode": "CcC5l3Rx", "monthly": {"resetDate": 2, "resetTime": "tSEFf1Q9"}, "name": "PzJFPdym", "seasonPeriod": 17, "startTime": "PjCKfXQB", "statCode": "lsBeZT08", "weekly": {"resetDay": 63, "resetTime": "gUzDQeT3"}}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard createArchivedLeaderboardRankingDataV1Handler \
    --namespace "$AB_NAMESPACE" \
    --body '{"leaderboardCodes": ["shULLR5I", "xPBJulm1", "tLX14MqB"], "limit": 87, "slug": "REDhoU4Q"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard updateLeaderboardConfigurationAdminV1 \
    --leaderboardCode '9EO2uzrp' \
    --namespace "$AB_NAMESPACE" \
    --body '{"daily": {"resetTime": "znrcWa8z"}, "descending": true, "iconURL": "jY7pJ1jg", "monthly": {"resetDate": 19, "resetTime": "Xo9cwiZ6"}, "name": "gbh9aJJR", "seasonPeriod": 77, "startTime": "DvUHF3iY", "statCode": "6NkpRJqZ", "weekly": {"resetDay": 64, "resetTime": "9n5vBfcF"}}' \
    > test.out 2>&1
eval_tap $? 8 'UpdateLeaderboardConfigurationAdminV1' test.out

#- 9 DeleteLeaderboardConfigurationAdminV1
./ng net.accelbyte.sdk.cli.Main leaderboard deleteLeaderboardConfigurationAdminV1 \
    --leaderboardCode 'DJRPHNkg' \
    --namespace "$AB_NAMESPACE" \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard updateUserPointAdminV1 \
    --leaderboardCode 'TPbDIrlT' \
    --namespace "$AB_NAMESPACE" \
    --userId 'dHEJs4Cq' \
    --body '{"inc": 0.8504263406904771, "latestValue": 0.7486034543654498}' \
    > test.out 2>&1
eval_tap $? 17 'UpdateUserPointAdminV1' test.out

#- 18 DeleteUserRankingAdminV1
./ng net.accelbyte.sdk.cli.Main leaderboard deleteUserRankingAdminV1 \
    --leaderboardCode 'MLmHYbRx' \
    --namespace "$AB_NAMESPACE" \
    --userId 'zkrgIYS7' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard deleteUserRankingsAdminV1 \
    --namespace "$AB_NAMESPACE" \
    --userId 'smEASiN8' \
    --leaderboardCode 'QAWcTELV,WKxkROdo,h4kWc2gK' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard createLeaderboardConfigurationPublicV1 \
    --namespace "$AB_NAMESPACE" \
    --body '{"daily": {"resetTime": "0qcrGhGv"}, "descending": false, "iconURL": "Rcm44RYD", "leaderboardCode": "pMXawKTS", "monthly": {"resetDate": 38, "resetTime": "S0iO0PGQ"}, "name": "Bx5vaUr2", "seasonPeriod": 20, "startTime": "pJxmhAvd", "statCode": "pwo6qkFb", "weekly": {"resetDay": 3, "resetTime": "k48cb2Mx"}}' \
    > test.out 2>&1
eval_tap $? 24 'CreateLeaderboardConfigurationPublicV1' test.out

#- 25 GetAllTimeLeaderboardRankingPublicV1
./ng net.accelbyte.sdk.cli.Main leaderboard getAllTimeLeaderboardRankingPublicV1 \
    --leaderboardCode '8bfnikT0' \
    --namespace "$AB_NAMESPACE" \
    --limit '67' \
    --offset '73' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard createLeaderboardConfigurationAdminV3 \
    --namespace "$AB_NAMESPACE" \
    --body '{"allTime": true, "cycleIds": ["8uPn3nGT", "tftglpVJ", "rJo1QY0w"], "descending": true, "description": "kAKhnOrg", "enableServerHiddenFilter": true, "iconURL": "10niOoS8", "leaderboardCode": "ahlRSql9", "name": "1JkSWyVI", "statCode": "H275IZpj"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard updateLeaderboardConfigurationAdminV3 \
    --leaderboardCode 'jhRzDzHC' \
    --namespace "$AB_NAMESPACE" \
    --body '{"allTime": true, "cycleIds": ["ON4muyLc", "JkMmfdLi", "D1oKvcnM"], "descending": false, "description": "G9VpbsJX", "enableServerHiddenFilter": true, "iconURL": "pcg8c1w3", "name": "v509UxKt"}' \
    > test.out 2>&1
eval_tap $? 43 'UpdateLeaderboardConfigurationAdminV3' test.out

#- 44 DeleteLeaderboardConfigurationAdminV3
./ng net.accelbyte.sdk.cli.Main leaderboard deleteLeaderboardConfigurationAdminV3 \
    --leaderboardCode 'jf3Z032g' \
    --namespace "$AB_NAMESPACE" \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard deleteUserRankingsAdminV3 \
    --namespace "$AB_NAMESPACE" \
    --userId 'R9Ai9351' \
    --leaderboardCode 'bHqI6Qtd,XfuK3bZB,JY732eAP' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard bulkGetUsersRankingPublicV3 \
    --leaderboardCode '25rPLsUT' \
    --namespace "$AB_NAMESPACE" \
    --previousVersion '87' \
    --body '{"userIds": ["ra1N1Snf", "sYw6KPOv", "DT2AMBKM"]}' \
    > test.out 2>&1
