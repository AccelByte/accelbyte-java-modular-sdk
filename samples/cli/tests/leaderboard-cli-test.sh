...
./ng net.accelbyte.sdk.cli.Main leaderboard createLeaderboardConfigurationAdminV1 \
    --namespace "$AB_NAMESPACE" \
    --body '{"daily": {"resetTime": "yFVTHzIK"}, "descending": true, "iconURL": "UD0g9fX6", "leaderboardCode": "vEx5Lq5L", "monthly": {"resetDate": 72, "resetTime": "AeVjFSwq"}, "name": "X8hksj71", "seasonPeriod": 34, "startTime": "kM1k4dIZ", "statCode": "Uk9QfWtI", "weekly": {"resetDay": 45, "resetTime": "UdsZvRpQ"}}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard createArchivedLeaderboardRankingDataV1Handler \
    --namespace "$AB_NAMESPACE" \
    --body '{"leaderboardCodes": ["t3YA13SV", "FLyrH0yd", "ohCG5EIr"], "limit": 75, "slug": "crsKZRD5"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard updateLeaderboardConfigurationAdminV1 \
    --leaderboardCode '86jZ8oqM' \
    --namespace "$AB_NAMESPACE" \
    --body '{"daily": {"resetTime": "SSAoC4Rz"}, "descending": true, "iconURL": "eCOuZssh", "monthly": {"resetDate": 10, "resetTime": "zw23YZuW"}, "name": "kZxweGNB", "seasonPeriod": 73, "startTime": "JVbAOEE2", "statCode": "buPa9YmR", "weekly": {"resetDay": 41, "resetTime": "0lEUj5GH"}}' \
    > test.out 2>&1
eval_tap $? 8 'UpdateLeaderboardConfigurationAdminV1' test.out

#- 9 DeleteLeaderboardConfigurationAdminV1
./ng net.accelbyte.sdk.cli.Main leaderboard deleteLeaderboardConfigurationAdminV1 \
    --leaderboardCode 'IEHsXyvM' \
    --namespace "$AB_NAMESPACE" \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard updateUserPointAdminV1 \
    --leaderboardCode 'gY5wfIxf' \
    --namespace "$AB_NAMESPACE" \
    --userId '8TUEWPUB' \
    --body '{"inc": 0.1732274067976891, "latestValue": 0.12605420617600138}' \
    > test.out 2>&1
eval_tap $? 17 'UpdateUserPointAdminV1' test.out

#- 18 DeleteUserRankingAdminV1
./ng net.accelbyte.sdk.cli.Main leaderboard deleteUserRankingAdminV1 \
    --leaderboardCode 'F3Aou4JX' \
    --namespace "$AB_NAMESPACE" \
    --userId 'XwvArVXp' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard deleteUserRankingsAdminV1 \
    --namespace "$AB_NAMESPACE" \
    --userId 'HnnUoHoa' \
    --leaderboardCode 'q8gYjEJT,RO4Jmi4Y,zkBEPuDR' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard createLeaderboardConfigurationPublicV1 \
    --namespace "$AB_NAMESPACE" \
    --body '{"daily": {"resetTime": "vWF3sVrR"}, "descending": false, "iconURL": "itR0b8Ze", "leaderboardCode": "H4XFVNlQ", "monthly": {"resetDate": 27, "resetTime": "Aao7zlLA"}, "name": "VkcfKNpL", "seasonPeriod": 45, "startTime": "Gu9k1QOc", "statCode": "cUJu9SxU", "weekly": {"resetDay": 53, "resetTime": "ZLanDOAU"}}' \
    > test.out 2>&1
eval_tap $? 24 'CreateLeaderboardConfigurationPublicV1' test.out

#- 25 GetAllTimeLeaderboardRankingPublicV1
./ng net.accelbyte.sdk.cli.Main leaderboard getAllTimeLeaderboardRankingPublicV1 \
    --leaderboardCode 'A1Bxrptn' \
    --namespace "$AB_NAMESPACE" \
    --limit '79' \
    --offset '31' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard createLeaderboardConfigurationAdminV3 \
    --namespace "$AB_NAMESPACE" \
    --body '{"allTime": true, "cycleIds": ["Ngml5K0O", "RzkUJQT0", "qaJXz1hY"], "descending": true, "description": "w592ulju", "iconURL": "zZWuyxKR", "leaderboardCode": "JptEer7Y", "name": "JWWeRMXM", "statCode": "1M2I1Cji"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard updateLeaderboardConfigurationAdminV3 \
    --leaderboardCode 'yKofUHVX' \
    --namespace "$AB_NAMESPACE" \
    --body '{"allTime": true, "cycleIds": ["PkjsR3yQ", "DNPgOmiC", "PiQVHznh"], "descending": true, "description": "1fh0lZob", "iconURL": "hBz6rKbI", "name": "VrHXGzrh"}' \
    > test.out 2>&1
eval_tap $? 43 'UpdateLeaderboardConfigurationAdminV3' test.out

#- 44 DeleteLeaderboardConfigurationAdminV3
./ng net.accelbyte.sdk.cli.Main leaderboard deleteLeaderboardConfigurationAdminV3 \
    --leaderboardCode 'iPpnCwA2' \
    --namespace "$AB_NAMESPACE" \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard deleteUserRankingsAdminV3 \
    --namespace "$AB_NAMESPACE" \
    --userId 'qfF9aXCa' \
    --leaderboardCode 'VFWRF9tV,nOiS2zTq,gFMZ5B1M' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard bulkGetUsersRankingPublicV3 \
    --leaderboardCode 'LoXe72f4' \
    --namespace "$AB_NAMESPACE" \
    --previousVersion '70' \
    --body '{"userIds": ["neBoFIVr", "NQr2mkfq", "WrxO3eBa"]}' \
    > test.out 2>&1
