...
./ng net.accelbyte.sdk.cli.Main leaderboard createLeaderboardConfigurationAdminV1 \
    --namespace "$AB_NAMESPACE" \
    --body '{"daily": {"resetTime": "TVse3wdY"}, "descending": false, "iconURL": "7TG3BPav", "leaderboardCode": "ql7iO7va", "monthly": {"resetDate": 24, "resetTime": "WUU78Qv6"}, "name": "SlFzLBbz", "seasonPeriod": 18, "startTime": "2aGcem3B", "statCode": "KXTbsqb4", "weekly": {"resetDay": 68, "resetTime": "3OPRnow5"}}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard createArchivedLeaderboardRankingDataV1Handler \
    --namespace "$AB_NAMESPACE" \
    --body '{"leaderboardCodes": ["f3K6YNRe", "ATSAW8VS", "v5PGvqob"], "limit": 54, "slug": "wLiduFQe"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard updateLeaderboardConfigurationAdminV1 \
    --leaderboardCode 'SeECkG6h' \
    --namespace "$AB_NAMESPACE" \
    --body '{"daily": {"resetTime": "pCS4MaXB"}, "descending": false, "iconURL": "NUQlzmRZ", "monthly": {"resetDate": 57, "resetTime": "PUhjklba"}, "name": "qdRDXzSA", "seasonPeriod": 77, "startTime": "7udS07UH", "statCode": "xocxxAov", "weekly": {"resetDay": 31, "resetTime": "wOKpbGjZ"}}' \
    > test.out 2>&1
eval_tap $? 8 'UpdateLeaderboardConfigurationAdminV1' test.out

#- 9 DeleteLeaderboardConfigurationAdminV1
./ng net.accelbyte.sdk.cli.Main leaderboard deleteLeaderboardConfigurationAdminV1 \
    --leaderboardCode 'jWMOABfB' \
    --namespace "$AB_NAMESPACE" \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard updateUserPointAdminV1 \
    --leaderboardCode 'IoAHXxUw' \
    --namespace "$AB_NAMESPACE" \
    --userId 'Wpk1K5MM' \
    --body '{"inc": 0.47417715094420354, "latestValue": 0.7798312629571369}' \
    > test.out 2>&1
eval_tap $? 17 'UpdateUserPointAdminV1' test.out

#- 18 DeleteUserRankingAdminV1
./ng net.accelbyte.sdk.cli.Main leaderboard deleteUserRankingAdminV1 \
    --leaderboardCode '1HIEtfWr' \
    --namespace "$AB_NAMESPACE" \
    --userId 'zdMsUJrn' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard deleteUserRankingsAdminV1 \
    --namespace "$AB_NAMESPACE" \
    --userId '7tfgMqdZ' \
    --leaderboardCode 'L7KsBqFJ,GPQhrTpG,NiI3cIcd' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard createLeaderboardConfigurationPublicV1 \
    --namespace "$AB_NAMESPACE" \
    --body '{"daily": {"resetTime": "kJ7OTtaH"}, "descending": true, "iconURL": "fT0Lldtw", "leaderboardCode": "E78VfdEV", "monthly": {"resetDate": 72, "resetTime": "OshaA3N9"}, "name": "VIuDQgyZ", "seasonPeriod": 61, "startTime": "yudbe5Tm", "statCode": "8pxzB3cf", "weekly": {"resetDay": 99, "resetTime": "l46X8r9G"}}' \
    > test.out 2>&1
eval_tap $? 24 'CreateLeaderboardConfigurationPublicV1' test.out

#- 25 GetAllTimeLeaderboardRankingPublicV1
./ng net.accelbyte.sdk.cli.Main leaderboard getAllTimeLeaderboardRankingPublicV1 \
    --leaderboardCode 'Zr2wQQv7' \
    --namespace "$AB_NAMESPACE" \
    --limit '78' \
    --offset '49' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard createLeaderboardConfigurationAdminV3 \
    --namespace "$AB_NAMESPACE" \
    --body '{"allTime": false, "cycleIds": ["X26zHUYy", "0RtrZtZh", "mm0i9sPD"], "descending": true, "description": "bc3Aakpz", "iconURL": "53UyVr1C", "leaderboardCode": "84Zf4GF3", "name": "0D6Juzq1", "statCode": "QbX6dcoK"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard updateLeaderboardConfigurationAdminV3 \
    --leaderboardCode 'rQOp0436' \
    --namespace "$AB_NAMESPACE" \
    --body '{"allTime": false, "cycleIds": ["oPsPiKuN", "DevUEx3z", "Bb5VvP0O"], "descending": false, "description": "eQoV6wmA", "iconURL": "sZ0HD3E7", "name": "bvdWWpKE"}' \
    > test.out 2>&1
eval_tap $? 43 'UpdateLeaderboardConfigurationAdminV3' test.out

#- 44 DeleteLeaderboardConfigurationAdminV3
./ng net.accelbyte.sdk.cli.Main leaderboard deleteLeaderboardConfigurationAdminV3 \
    --leaderboardCode 'WPzG1f05' \
    --namespace "$AB_NAMESPACE" \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard deleteUserRankingsAdminV3 \
    --namespace "$AB_NAMESPACE" \
    --userId 'i0edTFpG' \
    --leaderboardCode 'aWVkLeu1,T9dzD4yV,0hZaD5Bl' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard bulkGetUsersRankingPublicV3 \
    --leaderboardCode 'Yd6W8uKV' \
    --namespace "$AB_NAMESPACE" \
    --body '{"userIds": ["mDuGb2H4", "6N29ngiF", "BEJpOu7p"]}' \
    > test.out 2>&1
