...
./ng net.accelbyte.sdk.cli.Main leaderboard createLeaderboardConfigurationAdminV1 \
    --namespace "$AB_NAMESPACE" \
    --body '{"daily": {"resetTime": "kIqqqOlu"}, "descending": true, "iconURL": "INw30WTj", "leaderboardCode": "krNXykOc", "monthly": {"resetDate": 48, "resetTime": "yRVsglYG"}, "name": "mfhYbth3", "seasonPeriod": 6, "startTime": "2tugvKzR", "statCode": "h26Dkwcx", "weekly": {"resetDay": 71, "resetTime": "JsVcLA9Y"}}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard createArchivedLeaderboardRankingDataV1Handler \
    --namespace "$AB_NAMESPACE" \
    --body '{"leaderboardCodes": ["0BtoDvLR", "buQxne15", "aT8NkqEi"], "limit": 85, "slug": "i9lCvrln"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard updateLeaderboardConfigurationAdminV1 \
    --leaderboardCode '1duogLVg' \
    --namespace "$AB_NAMESPACE" \
    --body '{"daily": {"resetTime": "8r604VBP"}, "descending": true, "iconURL": "tCeSLuvE", "monthly": {"resetDate": 99, "resetTime": "qc9yCOM2"}, "name": "2oRl45Xf", "seasonPeriod": 49, "startTime": "C3XEwvWL", "statCode": "VHHYNCQl", "weekly": {"resetDay": 24, "resetTime": "D5ynhWRI"}}' \
    > test.out 2>&1
eval_tap $? 8 'UpdateLeaderboardConfigurationAdminV1' test.out

#- 9 DeleteLeaderboardConfigurationAdminV1
./ng net.accelbyte.sdk.cli.Main leaderboard deleteLeaderboardConfigurationAdminV1 \
    --leaderboardCode 'VzA8hQEa' \
    --namespace "$AB_NAMESPACE" \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard updateUserPointAdminV1 \
    --leaderboardCode 'BHmSTQYJ' \
    --namespace "$AB_NAMESPACE" \
    --userId 'SV75g6NH' \
    --body '{"inc": 0.5157894974121552, "latestValue": 0.7297289487907566}' \
    > test.out 2>&1
eval_tap $? 17 'UpdateUserPointAdminV1' test.out

#- 18 DeleteUserRankingAdminV1
./ng net.accelbyte.sdk.cli.Main leaderboard deleteUserRankingAdminV1 \
    --leaderboardCode '1ffKjkeu' \
    --namespace "$AB_NAMESPACE" \
    --userId 'ieDiTDbL' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard deleteUserRankingsAdminV1 \
    --namespace "$AB_NAMESPACE" \
    --userId 'P2ItObB0' \
    --leaderboardCode 'ZLvNOsn9,jJ1Tzuxw,pOP76RFp' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard createLeaderboardConfigurationPublicV1 \
    --namespace "$AB_NAMESPACE" \
    --body '{"daily": {"resetTime": "Twpke3qJ"}, "descending": false, "iconURL": "tnL3AdpZ", "leaderboardCode": "BMAifinx", "monthly": {"resetDate": 60, "resetTime": "GIprAuGp"}, "name": "OU6YWOGP", "seasonPeriod": 62, "startTime": "iNJ9rVIL", "statCode": "Gm8XtL7R", "weekly": {"resetDay": 38, "resetTime": "3CAneCBS"}}' \
    > test.out 2>&1
eval_tap $? 24 'CreateLeaderboardConfigurationPublicV1' test.out

#- 25 GetAllTimeLeaderboardRankingPublicV1
./ng net.accelbyte.sdk.cli.Main leaderboard getAllTimeLeaderboardRankingPublicV1 \
    --leaderboardCode 'tB6eUi65' \
    --namespace "$AB_NAMESPACE" \
    --limit '37' \
    --offset '24' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard createLeaderboardConfigurationAdminV3 \
    --namespace "$AB_NAMESPACE" \
    --body '{"allTime": false, "cycleIds": ["rF8LRIEp", "Xi85FtDC", "LmLDNgCB"], "descending": true, "description": "JgUBcs1h", "iconURL": "S7Cx3kBK", "leaderboardCode": "LASaTuEm", "name": "lgbXrJ5e", "statCode": "DaSv19ZY"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard updateLeaderboardConfigurationAdminV3 \
    --leaderboardCode 'HtNpI1ww' \
    --namespace "$AB_NAMESPACE" \
    --body '{"allTime": true, "cycleIds": ["aqZJpITf", "sCR0OnJL", "kDzY3irf"], "descending": true, "description": "QqyOx2Uu", "iconURL": "3crham7F", "name": "7I9ITwGM"}' \
    > test.out 2>&1
eval_tap $? 43 'UpdateLeaderboardConfigurationAdminV3' test.out

#- 44 DeleteLeaderboardConfigurationAdminV3
./ng net.accelbyte.sdk.cli.Main leaderboard deleteLeaderboardConfigurationAdminV3 \
    --leaderboardCode '23VF3b2h' \
    --namespace "$AB_NAMESPACE" \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard deleteUserRankingsAdminV3 \
    --namespace "$AB_NAMESPACE" \
    --userId 'WSjZMEOu' \
    --leaderboardCode 'cU8s4oCu,LWfP2one,OzYM3FxY' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard bulkGetUsersRankingPublicV3 \
    --leaderboardCode 'GKCa4e8Q' \
    --namespace "$AB_NAMESPACE" \
    --previousVersion '78' \
    --body '{"userIds": ["VKBpKM39", "9MyUd3mK", "ECyMFmVU"]}' \
    > test.out 2>&1
