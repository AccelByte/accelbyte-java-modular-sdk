...
./ng net.accelbyte.sdk.cli.Main leaderboard createLeaderboardConfigurationAdminV1 \
    --namespace "$AB_NAMESPACE" \
    --body '{"daily": {"resetTime": "i9QoE2oK"}, "descending": false, "iconURL": "jY2WxaYv", "leaderboardCode": "PxNtuv00", "monthly": {"resetDate": 88, "resetTime": "APx3Smk2"}, "name": "aXT3QwOm", "seasonPeriod": 83, "startTime": "ITefIKVX", "statCode": "D4WyUIF4", "weekly": {"resetDay": 72, "resetTime": "6uGPCfSu"}}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard createArchivedLeaderboardRankingDataV1Handler \
    --namespace "$AB_NAMESPACE" \
    --body '{"leaderboardCodes": ["bnTYFMWv", "bHA3ZZPO", "ziBZwwZq"], "limit": 74, "slug": "4gyOq7ea"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard updateLeaderboardConfigurationAdminV1 \
    --leaderboardCode '6J15SmO4' \
    --namespace "$AB_NAMESPACE" \
    --body '{"daily": {"resetTime": "g3BRqUHG"}, "descending": false, "iconURL": "V5HXYs03", "monthly": {"resetDate": 68, "resetTime": "eZCzRKLv"}, "name": "Sl633ZRE", "seasonPeriod": 74, "startTime": "ltLql7c8", "statCode": "YuPO9cdV", "weekly": {"resetDay": 64, "resetTime": "mGnb1Dnt"}}' \
    > test.out 2>&1
eval_tap $? 8 'UpdateLeaderboardConfigurationAdminV1' test.out

#- 9 DeleteLeaderboardConfigurationAdminV1
./ng net.accelbyte.sdk.cli.Main leaderboard deleteLeaderboardConfigurationAdminV1 \
    --leaderboardCode 'UA4NTuhN' \
    --namespace "$AB_NAMESPACE" \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard updateUserPointAdminV1 \
    --leaderboardCode '3mI2vsUI' \
    --namespace "$AB_NAMESPACE" \
    --userId 'n2qWdoOd' \
    --body '{"inc": 0.21789740720078754, "latestValue": 0.5382932160447642}' \
    > test.out 2>&1
eval_tap $? 17 'UpdateUserPointAdminV1' test.out

#- 18 DeleteUserRankingAdminV1
./ng net.accelbyte.sdk.cli.Main leaderboard deleteUserRankingAdminV1 \
    --leaderboardCode 'WHljOScv' \
    --namespace "$AB_NAMESPACE" \
    --userId '4cClQT8L' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard deleteUserRankingsAdminV1 \
    --namespace "$AB_NAMESPACE" \
    --userId '9DkILstZ' \
    --leaderboardCode '1GadAq0r,buPUljAa,4A7OWycv' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard createLeaderboardConfigurationPublicV1 \
    --namespace "$AB_NAMESPACE" \
    --body '{"daily": {"resetTime": "TvEU54k5"}, "descending": true, "iconURL": "LVL7oA38", "leaderboardCode": "LlRvaeRT", "monthly": {"resetDate": 42, "resetTime": "6wc0ph4K"}, "name": "dwC3dWbM", "seasonPeriod": 3, "startTime": "X4AWgVDJ", "statCode": "vLyocusl", "weekly": {"resetDay": 65, "resetTime": "i3hSh9KO"}}' \
    > test.out 2>&1
eval_tap $? 24 'CreateLeaderboardConfigurationPublicV1' test.out

#- 25 GetAllTimeLeaderboardRankingPublicV1
./ng net.accelbyte.sdk.cli.Main leaderboard getAllTimeLeaderboardRankingPublicV1 \
    --leaderboardCode 'OPkG1l7p' \
    --namespace "$AB_NAMESPACE" \
    --limit '52' \
    --offset '33' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard createLeaderboardConfigurationAdminV3 \
    --namespace "$AB_NAMESPACE" \
    --body '{"allTime": true, "cycleIds": ["MhXm3TGs", "nuSOUZlm", "VMoEw9kl"], "descending": true, "description": "QByxTUMM", "iconURL": "HFkH7bag", "leaderboardCode": "7LqvoGsH", "name": "DX6huxVa", "statCode": "wFgZO3Br"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard updateLeaderboardConfigurationAdminV3 \
    --leaderboardCode 'OjuYghe4' \
    --namespace "$AB_NAMESPACE" \
    --body '{"allTime": false, "cycleIds": ["ALo1p8D5", "KGBrcfje", "OASHeXrA"], "descending": true, "description": "Lzjp0gGr", "iconURL": "Exj01RLd", "name": "H24RYcs0"}' \
    > test.out 2>&1
eval_tap $? 43 'UpdateLeaderboardConfigurationAdminV3' test.out

#- 44 DeleteLeaderboardConfigurationAdminV3
./ng net.accelbyte.sdk.cli.Main leaderboard deleteLeaderboardConfigurationAdminV3 \
    --leaderboardCode 'jliU7nvm' \
    --namespace "$AB_NAMESPACE" \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard deleteUserRankingsAdminV3 \
    --namespace "$AB_NAMESPACE" \
    --userId 'v3N2wPE3' \
    --leaderboardCode 'xKkD5qSI,QezBFsZr,PjpJi07c' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main leaderboard bulkGetUsersRankingPublicV3 \
    --leaderboardCode 'n8J6Bqff' \
    --namespace "$AB_NAMESPACE" \
    --body '{"userIds": ["FhdoLCAs", "z9VXWE19", "rpjAiKlT"]}' \
    > test.out 2>&1
