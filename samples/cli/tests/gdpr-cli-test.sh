...
./ng net.accelbyte.sdk.cli.Main gdpr updateAdminEmailConfiguration \
    --namespace "$AB_NAMESPACE" \
    --body '["qm1EPFhe", "dfTXricP", "a5GVmKCI"]' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main gdpr saveAdminEmailConfiguration \
    --namespace "$AB_NAMESPACE" \
    --body '["uNnUeOea", "KQop7XB4", "ZcD6dt1o"]' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main gdpr deleteAdminEmailConfiguration \
    --namespace "$AB_NAMESPACE" \
    --emails 'LveXEzmL,nCAZFawh,gIZIypUL' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main gdpr adminValidateXboxBPCertFile \
    --namespace "$AB_NAMESPACE" \
    --body '{"bpCert": "NcwKlvkU", "password": "0MWJz68h"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main gdpr adminUpdatePlatformAccountClosureClient \
    --namespace "$AB_NAMESPACE" \
    --platform 'jBMIgfq9' \
    --body '{"bpCert": "CJAOm5sJ", "bpCertFileName": "AW6BK3cw", "clientId": "Xur6UjFF", "password": "GP1PkBpE", "publisherKey": "OgcEfQuN", "sandboxId": "a0i3ptQZ", "secret": "81E2MyTS"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main gdpr adminMockPlatformAccountClosureData \
    --namespace "$AB_NAMESPACE" \
    --platform '4zZbeaxb' \
    --body '{"platformUserId": "A8BxcGcE", "sandbox": "f5UrY1oz", "startImmediately": true}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main gdpr adminUpdateServicesConfiguration \
    --namespace "$AB_NAMESPACE" \
    --body '{"services": [{"extendConfig": {"appName": "anHhWokm", "namespace": "g3K9z9F4"}, "id": "aWTe6MZk", "serviceConfig": {"protocol": "EVENT", "skipAck": true, "url": "Tz9v5V2c"}, "type": "EXTEND"}, {"extendConfig": {"appName": "AuzOdSgh", "namespace": "iv72oQPc"}, "id": "qBYVfesQ", "serviceConfig": {"protocol": "EVENT", "skipAck": false, "url": "1absocip"}, "type": "SERVICE"}, {"extendConfig": {"appName": "hW5WCJW0", "namespace": "m31cJ9dd"}, "id": "UpduwFLA", "serviceConfig": {"protocol": "EVENT", "skipAck": true, "url": "veiLB553"}, "type": "SERVICE"}]}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main gdpr adminUpdatePlatformAccountClosureServicesConfiguration \
    --namespace "$AB_NAMESPACE" \
    --body '{"services": [{"extendConfig": {"appName": "u3JpajoY", "namespace": "hBLER80X"}, "id": "OvDclvOH", "serviceConfig": {"protocol": "GRPC", "skipAck": true, "url": "eNPxKLN3"}, "type": "EXTEND"}, {"extendConfig": {"appName": "9YJy6PXq", "namespace": "yAXl3Gu9"}, "id": "V1f70btZ", "serviceConfig": {"protocol": "GRPC", "skipAck": true, "url": "mNpauLMn"}, "type": "EXTEND"}, {"extendConfig": {"appName": "l8jamejB", "namespace": "zeTfjHFG"}, "id": "L7TLBPI9", "serviceConfig": {"protocol": "EVENT", "skipAck": false, "url": "8iF5BMWG"}, "type": "EXTEND"}]}' \
    > test.out 2>&1
