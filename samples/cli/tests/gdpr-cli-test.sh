...
./ng net.accelbyte.sdk.cli.Main gdpr updateAdminEmailConfiguration \
    --namespace "$AB_NAMESPACE" \
    --body '["KcVw5dSQ", "yBygyTez", "eYN2m42d"]' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main gdpr saveAdminEmailConfiguration \
    --namespace "$AB_NAMESPACE" \
    --body '["0wq3EXTk", "ljsePPTm", "tyKu5dVK"]' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main gdpr deleteAdminEmailConfiguration \
    --namespace "$AB_NAMESPACE" \
    --emails '2Wn3YHnZ,HEgdFxBH,8zHqCpWL' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main gdpr adminValidateXboxBPCertFile \
    --namespace "$AB_NAMESPACE" \
    --body '{"bpCert": "f4tmGh5P", "password": "5UacTAtZ"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main gdpr adminUpdatePlatformAccountClosureClient \
    --namespace "$AB_NAMESPACE" \
    --platform 'Ahq06OBd' \
    --body '{"bpCert": "3IggnGHe", "bpCertFileName": "YgPauu6s", "clientId": "5CKKm5zc", "password": "3Bejjjsu", "publisherKey": "49mmrK5Z", "sandboxId": "zbd6X4ws", "secret": "1Hl1N0mo"}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main gdpr adminMockPlatformAccountClosureData \
    --namespace "$AB_NAMESPACE" \
    --platform '62YSjbxX' \
    --body '{"platformUserId": "ocklW605", "sandbox": "CgHbW1ng", "startImmediately": true}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main gdpr adminUpdateServicesConfiguration \
    --namespace "$AB_NAMESPACE" \
    --body '{"services": [{"extendConfig": {"appName": "931Z1mtw", "namespace": "PzDk2Qqf"}, "id": "onvoPtOJ", "package": "22n2YsCb", "serviceConfig": {"protocol": "EVENT", "skipAck": true, "url": "kuMkK8B4"}, "type": "EXTEND"}, {"extendConfig": {"appName": "cSywLPbX", "namespace": "ygUc96ol"}, "id": "RH6UIwn9", "package": "Ld0KLAh2", "serviceConfig": {"protocol": "EVENT", "skipAck": true, "url": "aDoenlgu"}, "type": "EXTEND"}, {"extendConfig": {"appName": "Y3cFgYWG", "namespace": "vqB5oEN8"}, "id": "yhdigG4y", "package": "IMhp7Vvu", "serviceConfig": {"protocol": "EVENT", "skipAck": true, "url": "ulpExbS5"}, "type": "SERVICE"}]}' \
    > test.out 2>&1
...
./ng net.accelbyte.sdk.cli.Main gdpr adminUpdatePlatformAccountClosureServicesConfiguration \
    --namespace "$AB_NAMESPACE" \
    --body '{"services": [{"extendConfig": {"appName": "VwX7iWSP", "namespace": "kmUOuU5E"}, "id": "UqSJ0wxQ", "package": "2fSMImJb", "serviceConfig": {"protocol": "EVENT", "skipAck": true, "url": "nkDJQW0i"}, "type": "EXTEND"}, {"extendConfig": {"appName": "3J8zy6uO", "namespace": "3MW9yj0k"}, "id": "zUUjTy3H", "package": "4VyCfY6g", "serviceConfig": {"protocol": "EVENT", "skipAck": true, "url": "VxxWpJwh"}, "type": "EXTEND"}, {"extendConfig": {"appName": "RCubDtex", "namespace": "a2g6QuMp"}, "id": "FiK8oU10", "package": "ZlRIKLvl", "serviceConfig": {"protocol": "EVENT", "skipAck": false, "url": "urlXPxx1"}, "type": "SERVICE"}]}' \
    > test.out 2>&1
