...
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: friendsStatusResponse\nid: lK59fHbJ\nactivity: [F9IozeWc,9CfXjGwC,Bu6DHGeN]\navailability: [rhpLmTTO,EAmB1wMN,AzyPlYhj]\ncode: 66\nfriendIds: [ffaRIlMx,HmgJ5Ftq,Jgw4fSwY]\nlastSeenAt: [1979-11-27T00:00:00Z,1983-03-13T00:00:00Z,1989-04-07T00:00:00Z]' -u \
    > test.out 2>&1
