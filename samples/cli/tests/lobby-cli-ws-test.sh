...
./ng net.accelbyte.sdk.cli.Main lobbyWebsocket -m $'type: friendsStatusResponse\nid: 685K2imf\nactivity: [1zi86AxU,VNPUU3bl,oOm2PRad]\navailability: [96EyRY8S,CnFIQjii,u839JduS]\ncode: 12\nfriendIds: [I2CUXAdU,pilC6Mn9,Zt1HHPY3]\nlastSeenAt: [1977-05-10T00:00:00Z,1983-07-20T00:00:00Z,1977-03-06T00:00:00Z]' -u \
    > test.out 2>&1
