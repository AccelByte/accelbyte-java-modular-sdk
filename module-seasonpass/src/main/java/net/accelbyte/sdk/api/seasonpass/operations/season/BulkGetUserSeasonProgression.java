...
public class BulkGetUserSeasonProgression extends Operation {
  ...
  public BulkGetUserSeasonProgression(
      String customBasePath, String namespace, BulkUserProgressionRequest body) {
  ...
  public BulkGetUserSeasonProgressionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final BulkGetUserSeasonProgressionOpResponse response =
        new BulkGetUserSeasonProgressionOpResponse();
    ...
    if (code == 204) {
      ...
      response.setSuccess(true);
      response.setData(
          new ObjectMapper().readValue(json, new TypeReference<List<UserSeasonSummary>>() {}));
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public List<UserSeasonSummary> parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
