...
public class CreateSeason extends Operation {
  ...
  @Deprecated
  public CreateSeason(String customBasePath, String namespace, SeasonCreate body) {
  ...
  public CreateSeasonOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final CreateSeasonOpResponse response = new CreateSeasonOpResponse();
