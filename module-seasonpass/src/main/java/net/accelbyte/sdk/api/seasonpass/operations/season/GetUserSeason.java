...
public class GetUserSeason extends Operation {
  ...
  @Deprecated
  public GetUserSeason(String customBasePath, String namespace, String seasonId, String userId) {
  ...
  public GetUserSeasonOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetUserSeasonOpResponse response = new GetUserSeasonOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ClaimableUserSeasonInfo().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public ClaimableUserSeasonInfo parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
