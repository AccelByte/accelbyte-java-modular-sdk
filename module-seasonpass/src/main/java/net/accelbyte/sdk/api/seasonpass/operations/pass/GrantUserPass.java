...
import net.accelbyte.sdk.api.seasonpass.operation_responses.pass.GrantUserPassOpResponse;
...
public class GrantUserPass extends Operation {
  ...
  @Deprecated
  public GrantUserPass(String customBasePath, String namespace, String userId, UserPassGrant body) {
  ...
  public GrantUserPassOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GrantUserPassOpResponse response = new GrantUserPassOpResponse();
