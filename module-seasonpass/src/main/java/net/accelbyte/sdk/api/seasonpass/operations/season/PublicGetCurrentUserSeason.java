...
public class PublicGetCurrentUserSeason extends Operation {
    ...
    */
    ...
    public PublicGetCurrentUserSeasonOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetCurrentUserSeasonOpResponse response = new PublicGetCurrentUserSeasonOpResponse();
