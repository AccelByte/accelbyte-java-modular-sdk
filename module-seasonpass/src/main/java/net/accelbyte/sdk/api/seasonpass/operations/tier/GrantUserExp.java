...
import net.accelbyte.sdk.api.seasonpass.operation_responses.tier.GrantUserExpOpResponse;
...
public class GrantUserExp extends Operation {
  ...
  @Deprecated
  public GrantUserExp(String customBasePath, String namespace, String userId, UserExpGrant body) {
  ...
  public GrantUserExpOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GrantUserExpOpResponse response = new GrantUserExpOpResponse();
