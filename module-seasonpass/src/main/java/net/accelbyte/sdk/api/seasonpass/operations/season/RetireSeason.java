...
public class RetireSeason extends Operation {
  ...
  @Deprecated
  public RetireSeason(String customBasePath, String namespace, String seasonId, Boolean force) {
  ...
  public RetireSeasonOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final RetireSeasonOpResponse response = new RetireSeasonOpResponse();
