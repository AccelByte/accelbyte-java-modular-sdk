...
public class ResetUserSeason extends Operation {
  ...
  @Deprecated
  public ResetUserSeason(String customBasePath, String namespace, String userId) {
  ...
  public ResetUserSeasonOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final ResetUserSeasonOpResponse response = new ResetUserSeasonOpResponse();
