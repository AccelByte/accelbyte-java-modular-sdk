...
import net.accelbyte.sdk.api.seasonpass.operation_responses.pass.GetPassOpResponse;
...
public class GetPass extends Operation {
    ...
    */
    ...
    public GetPassOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetPassOpResponse response = new GetPassOpResponse();
