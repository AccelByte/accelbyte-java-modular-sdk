...
public class DeleteSeason extends Operation {
  ...
  @Deprecated
  public DeleteSeason(String customBasePath, String namespace, String seasonId) {
  ...
  public DeleteSeasonOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final DeleteSeasonOpResponse response = new DeleteSeasonOpResponse();
