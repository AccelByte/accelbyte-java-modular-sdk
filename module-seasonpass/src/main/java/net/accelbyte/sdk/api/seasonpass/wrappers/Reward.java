...
public class Reward {
   ...
   */
  public PublicClaimUserRewardOpResponse publicClaimUserReward(PublicClaimUserReward input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public PublicBulkClaimUserRewardsOpResponse publicBulkClaimUserRewards(
      PublicBulkClaimUserRewards input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
