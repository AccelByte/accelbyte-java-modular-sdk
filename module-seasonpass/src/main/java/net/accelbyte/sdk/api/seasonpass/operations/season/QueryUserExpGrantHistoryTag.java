...
public class QueryUserExpGrantHistoryTag extends Operation {
    ...
    */
    ...
    public QueryUserExpGrantHistoryTagOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryUserExpGrantHistoryTagOpResponse response = new QueryUserExpGrantHistoryTagOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ReasonTagsResult().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ReasonTagsResult parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
