...
import net.accelbyte.sdk.api.seasonpass.operation_responses.tier.DeleteTierOpResponse;
...
public class DeleteTier extends Operation {
    ...
    */
    ...
    public DeleteTierOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteTierOpResponse response = new DeleteTierOpResponse();
