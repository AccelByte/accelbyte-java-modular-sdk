...
public class PublicGetCurrentSeason extends Operation {
    ...
    */
    ...
    public PublicGetCurrentSeasonOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetCurrentSeasonOpResponse response = new PublicGetCurrentSeasonOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new LocalizedSeasonInfo().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public LocalizedSeasonInfo parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
