...
public class SeasonpassErrors
{
    ...
    public static ApiError error49121 = new ApiError("49121", "Default language [{language}] required in localizations");
    ...
    public static ApiError error49141 = new ApiError("49141", "Tier item does not exist in the store of namespace [{namespace}]");
    public static ApiError error49142 = new ApiError("49142", "Pass item does not exist in the store of namespace [{namespace}]");
    public static ApiError error49143 = new ApiError("49143", "Season [{seasonId}] does not exist in namespace [{namespace}]");
    ...
    public static ApiError error49173 = new ApiError("49173", "Reward [{code}] already exists in the season");
    public static ApiError error49174 = new ApiError("49174", "Pass [{code}] already exists in the season");
    public static ApiError error49175 = new ApiError("49175", "Published season already exists in namespace [{namespace}]");
    ...
    public static ApiError error49189 = new ApiError("49189", "Duplicate season name [{name}] for publishing in namespace [{namespace}]");
}