...
public class UpdateSeason extends Operation {
  ...
  @Deprecated
  public UpdateSeason(String customBasePath, String namespace, String seasonId, SeasonUpdate body) {
  ...
  public UpdateSeasonOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final UpdateSeasonOpResponse response = new UpdateSeasonOpResponse();
