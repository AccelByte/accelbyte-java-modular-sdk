...
public class GetSeason extends Operation {
  ...
  @Deprecated
  public GetSeason(String customBasePath, String namespace, String seasonId) {
  ...
  public GetSeasonOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetSeasonOpResponse response = new GetSeasonOpResponse();
