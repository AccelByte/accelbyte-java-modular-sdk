...
public class PublicBulkClaimUserRewards extends Operation {
    ...
    */
    ...
    public PublicBulkClaimUserRewardsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicBulkClaimUserRewardsOpResponse response = new PublicBulkClaimUserRewardsOpResponse();
