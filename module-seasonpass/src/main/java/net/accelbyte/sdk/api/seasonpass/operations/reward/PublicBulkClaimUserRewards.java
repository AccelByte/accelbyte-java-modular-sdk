...
public class PublicBulkClaimUserRewards extends Operation {
  ...
  @Deprecated
  public PublicBulkClaimUserRewards(String customBasePath, String namespace, String userId) {
  ...
  public PublicBulkClaimUserRewardsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicBulkClaimUserRewardsOpResponse response =
        new PublicBulkClaimUserRewardsOpResponse();
