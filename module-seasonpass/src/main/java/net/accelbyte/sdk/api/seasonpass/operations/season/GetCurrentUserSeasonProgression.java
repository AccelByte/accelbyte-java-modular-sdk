...
public class GetCurrentUserSeasonProgression extends Operation {
  ...
  public GetCurrentUserSeasonProgressionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetCurrentUserSeasonProgressionOpResponse response =
        new GetCurrentUserSeasonProgressionOpResponse();
