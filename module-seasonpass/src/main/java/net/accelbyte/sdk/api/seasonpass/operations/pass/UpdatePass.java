...
import net.accelbyte.sdk.api.seasonpass.operation_responses.pass.UpdatePassOpResponse;
...
public class UpdatePass extends Operation {
  ...
  @Deprecated
  public UpdatePass(
      String customBasePath, String code, String namespace, String seasonId, PassUpdate body) {
    this.code = code;
  ...
  public UpdatePassOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final UpdatePassOpResponse response = new UpdatePassOpResponse();
