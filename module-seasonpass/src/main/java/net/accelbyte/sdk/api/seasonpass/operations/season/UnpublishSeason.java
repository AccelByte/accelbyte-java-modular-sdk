...
public class UnpublishSeason extends Operation {
  ...
  @Deprecated
  public UnpublishSeason(String customBasePath, String namespace, String seasonId, Boolean force) {
  ...
  public UnpublishSeasonOpResponse parseResponse(int code, String contentType, InputStream payload)
