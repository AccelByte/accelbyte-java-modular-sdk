...
import net.accelbyte.sdk.api.platform.operation_responses.payment_config.UpdateCheckoutConfigOpResponse;
...
public class UpdateCheckoutConfig extends Operation {
    ...
    */
    ...
    public UpdateCheckoutConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateCheckoutConfigOpResponse response = new UpdateCheckoutConfigOpResponse();
