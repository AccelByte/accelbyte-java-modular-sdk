...
public class GetUserEntitlementOwnershipByItemIds extends Operation {
  ...
  public GetUserEntitlementOwnershipByItemIds(
      String customBasePath, String namespace, String userId, List<String> ids, String platform) {
  ...
  public GetUserEntitlementOwnershipByItemIdsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetUserEntitlementOwnershipByItemIdsOpResponse response =
        new GetUserEntitlementOwnershipByItemIdsOpResponse();
