...
public class FulFillItemPayload extends Model {
    ...
    public static class FulFillItemPayloadBuilder {
        ...
        public FulFillItemPayloadBuilder entitlementOriginFromEnum(final EntitlementOrigin entitlementOrigin) {
            this.entitlementOrigin = entitlementOrigin.toString();
            return this;
        }
        ...
        public FulFillItemPayloadBuilder itemIdentityTypeFromEnum(final ItemIdentityType itemIdentityType) {
            this.itemIdentityType = itemIdentityType.toString();
            return this;
        }
    }
