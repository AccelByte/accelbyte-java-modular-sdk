...
public class PublicCheckPaymentOrderPaidStatus extends Operation {
    ...
    */
    ...
    public PublicCheckPaymentOrderPaidStatusOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicCheckPaymentOrderPaidStatusOpResponse response = new PublicCheckPaymentOrderPaidStatusOpResponse();
