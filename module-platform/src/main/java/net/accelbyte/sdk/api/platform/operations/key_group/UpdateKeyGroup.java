...
import net.accelbyte.sdk.api.platform.operation_responses.key_group.UpdateKeyGroupOpResponse;
...
public class UpdateKeyGroup extends Operation {
    ...
    */
    ...
    public UpdateKeyGroupOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateKeyGroupOpResponse response = new UpdateKeyGroupOpResponse();
