...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.ExistsAnyUserActiveEntitlementByItemIdsOpResponse;
...
public class ExistsAnyUserActiveEntitlementByItemIds extends Operation {
    ...
    */
    ...
    public ExistsAnyUserActiveEntitlementByItemIdsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ExistsAnyUserActiveEntitlementByItemIdsOpResponse response = new ExistsAnyUserActiveEntitlementByItemIdsOpResponse();
