...
import net.accelbyte.sdk.api.platform.operation_responses.payment_config.UpdateStripeConfigOpResponse;
...
public class UpdateStripeConfig extends Operation {
    ...
    */
    ...
    public UpdateStripeConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateStripeConfigOpResponse response = new UpdateStripeConfigOpResponse();
