...
public class PublicRedeemCode extends Operation {
  ...
  public PublicRedeemCode(
      String customBasePath, String namespace, String userId, FulfillCodeRequest body) {
  ...
  public PublicRedeemCodeOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final PublicRedeemCodeOpResponse response = new PublicRedeemCodeOpResponse();
    ...
    if (code == 204) {
      ...
      final String json = Helper.convertInputStreamToString(payload);
      response.setError429(new ErrorEntity().createFromJson(json));
