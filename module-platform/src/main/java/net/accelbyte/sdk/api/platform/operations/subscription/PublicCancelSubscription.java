...
public class PublicCancelSubscription extends Operation {
    ...
    */
    ...
    public PublicCancelSubscriptionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicCancelSubscriptionOpResponse response = new PublicCancelSubscriptionOpResponse();
