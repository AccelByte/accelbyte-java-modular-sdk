...
public class CreateItemTypeConfig extends Operation {
    ...
    */
    ...
    public CreateItemTypeConfig(
            String customBasePath,            ItemTypeConfigCreate body
    )
    {
        this.body = body;
    ...
    public CreateItemTypeConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreateItemTypeConfigOpResponse response = new CreateItemTypeConfigOpResponse();
