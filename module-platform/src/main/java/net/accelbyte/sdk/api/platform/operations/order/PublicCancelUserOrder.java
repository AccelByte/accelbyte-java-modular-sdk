...
public class PublicCancelUserOrder extends Operation {
    ...
    */
    ...
    public PublicCancelUserOrderOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicCancelUserOrderOpResponse response = new PublicCancelUserOrderOpResponse();
