...
public class PublicExistsAnyMyActiveEntitlement extends Operation {
    ...
    */
    ...
    public PublicExistsAnyMyActiveEntitlementOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicExistsAnyMyActiveEntitlementOpResponse response = new PublicExistsAnyMyActiveEntitlementOpResponse();
