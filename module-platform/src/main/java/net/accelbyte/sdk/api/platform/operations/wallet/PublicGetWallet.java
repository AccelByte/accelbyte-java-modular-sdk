...
public class PublicGetWallet extends Operation {
  ...
  public PublicGetWallet(
      String customBasePath, String currencyCode, String namespace, String userId) {
  ...
  public PublicGetWalletOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final PublicGetWalletOpResponse response = new PublicGetWalletOpResponse();
