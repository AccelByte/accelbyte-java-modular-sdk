...
public class PublicGetMyAppEntitlementOwnershipByAppId extends Operation {
    ...
    */
    ...
    public PublicGetMyAppEntitlementOwnershipByAppIdOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetMyAppEntitlementOwnershipByAppIdOpResponse response = new PublicGetMyAppEntitlementOwnershipByAppIdOpResponse();
