...
public class DeletePlatformDLCConfig extends Operation {
    ...
    */
    ...
    public DeletePlatformDLCConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeletePlatformDLCConfigOpResponse response = new DeletePlatformDLCConfigOpResponse();
