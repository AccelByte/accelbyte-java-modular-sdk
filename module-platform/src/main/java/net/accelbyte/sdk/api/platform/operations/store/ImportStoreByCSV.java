...
public class ImportStoreByCSV extends Operation {
    ...
    */
    ...
    public ImportStoreByCSVOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ImportStoreByCSVOpResponse response = new ImportStoreByCSVOpResponse();
