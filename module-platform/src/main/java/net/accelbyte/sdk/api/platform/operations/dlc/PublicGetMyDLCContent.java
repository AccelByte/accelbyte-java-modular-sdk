...
public class PublicGetMyDLCContent extends Operation {
    ...
    */
    ...
    public PublicGetMyDLCContent(
            String customBasePath,            Boolean includeAllNamespaces,
            String type
    )
    {
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("includeAllNamespaces", this.includeAllNamespaces == null ? null : Arrays.asList(String.valueOf(this.includeAllNamespaces)));
    ...
    public PublicGetMyDLCContentOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetMyDLCContentOpResponse response = new PublicGetMyDLCContentOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new SimpleUserDLCRewardContentsResponse().createFromJson(json));
            response.setSuccess(true);
        }
    ...
    /*
    public SimpleUserDLCRewardContentsResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
