...
public class UploadSectionPluginConfigCert extends Operation {
  ...
  public UploadSectionPluginConfigCertOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UploadSectionPluginConfigCertOpResponse response =
        new UploadSectionPluginConfigCertOpResponse();
