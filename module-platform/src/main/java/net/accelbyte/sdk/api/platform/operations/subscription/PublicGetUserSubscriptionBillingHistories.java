...
public class PublicGetUserSubscriptionBillingHistories extends Operation {
    ...
    */
    ...
    public PublicGetUserSubscriptionBillingHistoriesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetUserSubscriptionBillingHistoriesOpResponse response = new PublicGetUserSubscriptionBillingHistoriesOpResponse();
