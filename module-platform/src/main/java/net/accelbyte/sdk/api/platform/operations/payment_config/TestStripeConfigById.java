...
import net.accelbyte.sdk.api.platform.operation_responses.payment_config.TestStripeConfigByIdOpResponse;
...
public class TestStripeConfigById extends Operation {
    ...
    */
    ...
    public TestStripeConfigByIdOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final TestStripeConfigByIdOpResponse response = new TestStripeConfigByIdOpResponse();
