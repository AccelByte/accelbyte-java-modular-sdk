...
public class SearchItems extends Operation {
    ...
    */
    ...
    public SearchItemsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SearchItemsOpResponse response = new SearchItemsOpResponse();
