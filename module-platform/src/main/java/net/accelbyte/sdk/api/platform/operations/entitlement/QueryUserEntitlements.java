...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.QueryUserEntitlementsOpResponse;
...
public class QueryUserEntitlements extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("collectionId", this.collectionId == null ? null : Arrays.asList(this.collectionId));
        ...
        queryParams.put("features", this.features == null ? null : this.features.stream().map(i -> String.valueOf(i)).collect(java.util.stream.Collectors.toList()));
        queryParams.put("fuzzyMatchName", this.fuzzyMatchName == null ? null : Arrays.asList(String.valueOf(this.fuzzyMatchName)));
        queryParams.put("ignoreActiveDate", this.ignoreActiveDate == null ? null : Arrays.asList(String.valueOf(this.ignoreActiveDate)));
        queryParams.put("itemId", this.itemId == null ? null : this.itemId.stream().map(i -> String.valueOf(i)).collect(java.util.stream.Collectors.toList()));
    ...
    public QueryUserEntitlementsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryUserEntitlementsOpResponse response = new QueryUserEntitlementsOpResponse();
