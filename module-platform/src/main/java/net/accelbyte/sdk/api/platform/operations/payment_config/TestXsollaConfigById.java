...
import net.accelbyte.sdk.api.platform.operation_responses.payment_config.TestXsollaConfigByIdOpResponse;
...
public class TestXsollaConfigById extends Operation {
    ...
    */
    ...
    public TestXsollaConfigByIdOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final TestXsollaConfigByIdOpResponse response = new TestXsollaConfigByIdOpResponse();
