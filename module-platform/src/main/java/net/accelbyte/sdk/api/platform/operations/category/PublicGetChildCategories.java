...
import net.accelbyte.sdk.api.platform.operation_responses.category.PublicGetChildCategoriesOpResponse;
...
public class PublicGetChildCategories extends Operation {
    ...
    */
    ...
    public PublicGetChildCategoriesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetChildCategoriesOpResponse response = new PublicGetChildCategoriesOpResponse();
