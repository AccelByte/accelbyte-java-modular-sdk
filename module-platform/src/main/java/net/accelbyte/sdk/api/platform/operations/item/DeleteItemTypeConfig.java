...
public class DeleteItemTypeConfig extends Operation {
    ...
    */
    ...
    public DeleteItemTypeConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteItemTypeConfigOpResponse response = new DeleteItemTypeConfigOpResponse();
