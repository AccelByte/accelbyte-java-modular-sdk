...
public class QueryPaymentOrders extends Operation {
    ...
    */
    ...
    public QueryPaymentOrdersOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryPaymentOrdersOpResponse response = new QueryPaymentOrdersOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new PaymentOrderPagingSlicedResult().createFromJson(json));
            response.setSuccess(true);
        }
