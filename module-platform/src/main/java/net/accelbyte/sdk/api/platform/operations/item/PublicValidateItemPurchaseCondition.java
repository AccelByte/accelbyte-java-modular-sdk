...
public class PublicValidateItemPurchaseCondition extends Operation {
  ...
  public PublicValidateItemPurchaseConditionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicValidateItemPurchaseConditionOpResponse response =
        new PublicValidateItemPurchaseConditionOpResponse();
