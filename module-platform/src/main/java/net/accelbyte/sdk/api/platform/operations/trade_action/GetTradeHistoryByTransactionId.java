...
public class GetTradeHistoryByTransactionId extends Operation {
    ...
    */
    ...
    public GetTradeHistoryByTransactionIdOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetTradeHistoryByTransactionIdOpResponse response = new GetTradeHistoryByTransactionIdOpResponse();
