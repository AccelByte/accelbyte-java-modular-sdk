...
public class ListUserWalletTransactions extends Operation {
    ...
    */
    ...
    public ListUserWalletTransactionsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ListUserWalletTransactionsOpResponse response = new ListUserWalletTransactionsOpResponse();
