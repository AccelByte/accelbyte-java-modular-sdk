...
public class QueryFulfillments extends Operation {
    ...
    */
    ...
    public QueryFulfillmentsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryFulfillmentsOpResponse response = new QueryFulfillmentsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new FulfillmentPagingSlicedResult().createFromJson(json));
            response.setSuccess(true);
        }
    ...
    /*
    public FulfillmentPagingSlicedResult parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
