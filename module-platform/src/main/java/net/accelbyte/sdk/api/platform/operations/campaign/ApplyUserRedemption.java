...
import net.accelbyte.sdk.api.platform.operation_responses.campaign.ApplyUserRedemptionOpResponse;
...
public class ApplyUserRedemption extends Operation {
  ...
  public ApplyUserRedemption(
      String customBasePath, String namespace, String userId, RedeemRequest body) {
  ...
  public ApplyUserRedemptionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final ApplyUserRedemptionOpResponse response = new ApplyUserRedemptionOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new RedeemResult().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 404) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public RedeemResult parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
