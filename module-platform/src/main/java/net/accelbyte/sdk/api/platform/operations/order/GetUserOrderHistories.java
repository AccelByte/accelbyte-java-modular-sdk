...
public class GetUserOrderHistories extends Operation {
    ...
    */
    ...
    public GetUserOrderHistoriesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserOrderHistoriesOpResponse response = new GetUserOrderHistoriesOpResponse();
