...
public class PublicGetUserAppEntitlementByAppId extends Operation {
  ...
  public PublicGetUserAppEntitlementByAppIdOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGetUserAppEntitlementByAppIdOpResponse response =
        new PublicGetUserAppEntitlementByAppIdOpResponse();
