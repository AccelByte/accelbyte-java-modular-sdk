...
public class PublicGetItemBySku extends Operation {
    ...
    */
    ...
    public PublicGetItemBySkuOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetItemBySkuOpResponse response = new PublicGetItemBySkuOpResponse();
