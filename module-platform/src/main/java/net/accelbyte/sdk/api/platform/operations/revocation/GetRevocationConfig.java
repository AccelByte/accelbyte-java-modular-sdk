...
import net.accelbyte.sdk.api.platform.operation_responses.revocation.GetRevocationConfigOpResponse;
...
public class GetRevocationConfig extends Operation {
  ...
  @Deprecated
  public GetRevocationConfig(String customBasePath, String namespace) {
  ...
  public GetRevocationConfigOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetRevocationConfigOpResponse response = new GetRevocationConfigOpResponse();
