...
@Getter
@Setter
public class CreateSectionOpResponse extends ApiResponseWithData<FullSectionInfo> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.platform.operations.section.CreateSection";
    }
}