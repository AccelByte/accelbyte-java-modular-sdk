...
public class GetUserActiveEntitlementsByItemIds extends Operation {
  ...
  public GetUserActiveEntitlementsByItemIdsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetUserActiveEntitlementsByItemIdsOpResponse response =
        new GetUserActiveEntitlementsByItemIdsOpResponse();
