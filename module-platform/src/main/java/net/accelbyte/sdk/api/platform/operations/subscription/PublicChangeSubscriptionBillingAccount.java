...
public class PublicChangeSubscriptionBillingAccount extends Operation {
  ...
  public PublicChangeSubscriptionBillingAccountOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicChangeSubscriptionBillingAccountOpResponse response =
        new PublicChangeSubscriptionBillingAccountOpResponse();
