...
public class TestXsollaConfig extends Operation {
    ...
    */
    ...
    public TestXsollaConfig(
            String customBasePath,            XsollaConfig body
    )
    {
        this.body = body;
    ...
    public TestXsollaConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
