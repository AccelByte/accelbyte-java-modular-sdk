...
@Getter
@Setter
public class CreateCategoryOpResponse extends ApiResponseWithData<FullCategoryInfo> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.platform.operations.category.CreateCategory";
  }
}
