...
public class UpdatePlatformDLCConfig extends Operation {
    ...
    */
    ...
    public UpdatePlatformDLCConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdatePlatformDLCConfigOpResponse response = new UpdatePlatformDLCConfigOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new PlatformDLCConfigInfo().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 422) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public PlatformDLCConfigInfo parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
