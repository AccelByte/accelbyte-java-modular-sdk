...
public class PublicListCurrencies extends Operation {
    ...
    */
    ...
    public PublicListCurrenciesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicListCurrenciesOpResponse response = new PublicListCurrenciesOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<CurrencyInfo>>() {}));
        }
