...
public class UpdateItemTypeConfig extends Operation {
    ...
    */
    ...
    public UpdateItemTypeConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateItemTypeConfigOpResponse response = new UpdateItemTypeConfigOpResponse();
