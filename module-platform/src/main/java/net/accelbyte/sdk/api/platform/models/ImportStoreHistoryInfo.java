...
public class ImportStoreHistoryInfo extends Model {
    ...
    @JsonIgnore
    public List<ImportStoreHistoryInfo> createFromJsonList(String json) throws JsonProcessingException {
    ...
    public static class ImportStoreHistoryInfoBuilder {
        ...
        public ImportStoreHistoryInfoBuilder importFileFormatFromEnum(final ImportFileFormat importFileFormat) {
            this.importFileFormat = importFileFormat.toString();
            return this;
        }
    }
