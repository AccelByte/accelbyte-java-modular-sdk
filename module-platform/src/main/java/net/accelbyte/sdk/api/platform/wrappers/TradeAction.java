...
public class TradeAction {
   ...
   */
  public GetTradeHistoryByCriteriaOpResponse getTradeHistoryByCriteria(
      GetTradeHistoryByCriteria input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public GetTradeHistoryByTransactionIdOpResponse getTradeHistoryByTransactionId(
