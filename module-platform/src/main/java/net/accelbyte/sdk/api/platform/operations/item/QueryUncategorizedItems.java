...
public class QueryUncategorizedItems extends Operation {
    ...
    */
    ...
    public QueryUncategorizedItemsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryUncategorizedItemsOpResponse response = new QueryUncategorizedItemsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new FullItemPagingSlicedResult().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 404) {
            final String json = Helper.convertInputStreamToString(payload);
