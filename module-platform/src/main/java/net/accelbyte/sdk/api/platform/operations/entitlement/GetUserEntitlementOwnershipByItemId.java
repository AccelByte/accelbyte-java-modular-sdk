...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.GetUserEntitlementOwnershipByItemIdOpResponse;
...
public class GetUserEntitlementOwnershipByItemId extends Operation {
    ...
    */
    ...
    public GetUserEntitlementOwnershipByItemIdOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserEntitlementOwnershipByItemIdOpResponse response = new GetUserEntitlementOwnershipByItemIdOpResponse();
