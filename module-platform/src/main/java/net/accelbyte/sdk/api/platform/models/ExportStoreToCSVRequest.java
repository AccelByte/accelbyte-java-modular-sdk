...
public class ExportStoreToCSVRequest extends Model {
    ...
    @JsonIgnore
    public List<ExportStoreToCSVRequest> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ExportStoreToCSVRequest>>() {});
    }
