...
public class Fulfillment {
   ...
   */
  public QueryFulfillmentHistoriesOpResponse queryFulfillmentHistories(
   ...
   */
  public PreCheckFulfillItemOpResponse preCheckFulfillItem(PreCheckFulfillItem input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public RetryFulfillItemsV3OpResponse retryFulfillItemsV3(RetryFulfillItemsV3 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   * @see RevokeItemsV3
   */
  public RevokeItemsV3OpResponse revokeItemsV3(RevokeItemsV3 input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
