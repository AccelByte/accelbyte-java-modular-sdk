...
public class GetAggregatePaymentProviders extends Operation {
  ...
  @Deprecated
  public GetAggregatePaymentProviders(String customBasePath) {
  ...
  public GetAggregatePaymentProvidersOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetAggregatePaymentProvidersOpResponse response =
        new GetAggregatePaymentProvidersOpResponse();
