...
import net.accelbyte.sdk.api.platform.operation_responses.payment_config.GetAggregatePaymentProvidersOpResponse;
...
public class GetAggregatePaymentProviders extends Operation {
    ...
    */
    ...
    public GetAggregatePaymentProvidersOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetAggregatePaymentProvidersOpResponse response = new GetAggregatePaymentProvidersOpResponse();
