...
public class CreatePaymentProviderConfig extends Operation {
    ...
    */
    ...
    public CreatePaymentProviderConfig(
            String customBasePath,            PaymentProviderConfigEdit body
    )
    {
        this.body = body;
    ...
    public CreatePaymentProviderConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreatePaymentProviderConfigOpResponse response = new CreatePaymentProviderConfigOpResponse();
