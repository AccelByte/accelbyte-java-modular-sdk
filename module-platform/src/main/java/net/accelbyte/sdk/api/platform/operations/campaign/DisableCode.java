...
import net.accelbyte.sdk.api.platform.operation_responses.campaign.DisableCodeOpResponse;
...
public class DisableCode extends Operation {
  ...
  public DisableCodeOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final DisableCodeOpResponse response = new DisableCodeOpResponse();
