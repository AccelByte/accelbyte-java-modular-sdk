...
public class ExportStore extends Operation {
  ...
  @Deprecated
  public ExportStore(String customBasePath, String namespace, String storeId) {
  ...
  public ExportStoreOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final ExportStoreOpResponse response = new ExportStoreOpResponse();
