...
import net.accelbyte.sdk.api.platform.operation_responses.revocation.UpdateRevocationConfigOpResponse;
...
public class UpdateRevocationConfig extends Operation {
    ...
    */
    ...
    public UpdateRevocationConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateRevocationConfigOpResponse response = new UpdateRevocationConfigOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new RevocationConfigInfo().createFromJson(json));
            response.setSuccess(true);
        }
