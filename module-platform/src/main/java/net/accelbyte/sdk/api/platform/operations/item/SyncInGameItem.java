...
public class SyncInGameItem extends Operation {
  ...
  public SyncInGameItem(
      String customBasePath, String namespace, String storeId, InGameItemSync body) {
  ...
  public SyncInGameItemOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final SyncInGameItemOpResponse response = new SyncInGameItemOpResponse();
