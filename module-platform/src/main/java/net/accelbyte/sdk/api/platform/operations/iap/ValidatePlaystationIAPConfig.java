...
import net.accelbyte.sdk.api.platform.operation_responses.iap.ValidatePlaystationIAPConfigOpResponse;
...
public class ValidatePlaystationIAPConfig extends Operation {
    ...
    */
    ...
    public ValidatePlaystationIAPConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ValidatePlaystationIAPConfigOpResponse response = new ValidatePlaystationIAPConfigOpResponse();
