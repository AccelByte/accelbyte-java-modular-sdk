...
public class ValidatePlaystationIAPConfig extends Operation {
  ...
  public ValidatePlaystationIAPConfig(
      String customBasePath, String namespace, PlaystationIAPConfigRequest body) {
  ...
  public ValidatePlaystationIAPConfigOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final ValidatePlaystationIAPConfigOpResponse response =
        new ValidatePlaystationIAPConfigOpResponse();
