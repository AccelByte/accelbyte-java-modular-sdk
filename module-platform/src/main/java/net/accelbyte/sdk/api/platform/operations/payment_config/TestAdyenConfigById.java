...
import net.accelbyte.sdk.api.platform.operation_responses.payment_config.TestAdyenConfigByIdOpResponse;
...
public class TestAdyenConfigById extends Operation {
    ...
    */
    ...
    public TestAdyenConfigByIdOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final TestAdyenConfigByIdOpResponse response = new TestAdyenConfigByIdOpResponse();
