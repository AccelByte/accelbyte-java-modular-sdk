...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.GetUserEntitlementBySkuOpResponse;
...
public class GetUserEntitlementBySku extends Operation {
    ...
    */
    ...
    public GetUserEntitlementBySkuOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserEntitlementBySkuOpResponse response = new GetUserEntitlementBySkuOpResponse();
