...
public class QueryThirdPartySubscription extends Operation {
    ...
    */
    ...
    public QueryThirdPartySubscriptionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryThirdPartySubscriptionOpResponse response = new QueryThirdPartySubscriptionOpResponse();
