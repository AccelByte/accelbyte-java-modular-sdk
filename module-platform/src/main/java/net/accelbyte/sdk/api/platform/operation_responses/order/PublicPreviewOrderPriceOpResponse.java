...
@Getter
@Setter
public class PublicPreviewOrderPriceOpResponse extends ApiResponseWithData<OrderDiscountPreviewResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.platform.operations.order.PublicPreviewOrderPrice";
    }
}