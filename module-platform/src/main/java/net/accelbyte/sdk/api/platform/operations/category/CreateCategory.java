...
import net.accelbyte.sdk.api.platform.operation_responses.category.CreateCategoryOpResponse;
...
public class CreateCategory extends Operation {
  ...
  public CreateCategory(
      String customBasePath, String namespace, String storeId, CategoryCreate body) {
  ...
  public CreateCategoryOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final CreateCategoryOpResponse response = new CreateCategoryOpResponse();
