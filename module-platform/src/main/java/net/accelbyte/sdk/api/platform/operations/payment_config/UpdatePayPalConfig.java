...
import net.accelbyte.sdk.api.platform.operation_responses.payment_config.UpdatePayPalConfigOpResponse;
...
public class UpdatePayPalConfig extends Operation {
    ...
    */
    ...
    public UpdatePayPalConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdatePayPalConfigOpResponse response = new UpdatePayPalConfigOpResponse();
