...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.PublicQueryUserEntitlementsByAppTypeOpResponse;
...
public class PublicQueryUserEntitlementsByAppType extends Operation {
    ...
    */
    ...
    public PublicQueryUserEntitlementsByAppTypeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicQueryUserEntitlementsByAppTypeOpResponse response = new PublicQueryUserEntitlementsByAppTypeOpResponse();
