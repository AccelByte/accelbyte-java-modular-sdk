...
import net.accelbyte.sdk.api.platform.operation_responses.campaign.QueryRedeemHistoryOpResponse;
...
public class QueryRedeemHistory extends Operation {
    ...
    */
    ...
    public QueryRedeemHistoryOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryRedeemHistoryOpResponse response = new QueryRedeemHistoryOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new RedeemHistoryPagingSlicedResult().createFromJson(json));
            response.setSuccess(true);
        }
