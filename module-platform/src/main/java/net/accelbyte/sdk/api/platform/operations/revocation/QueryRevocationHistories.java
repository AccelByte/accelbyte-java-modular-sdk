...
import net.accelbyte.sdk.api.platform.operation_responses.revocation.QueryRevocationHistoriesOpResponse;
...
public class QueryRevocationHistories extends Operation {
    ...
    */
    ...
    public QueryRevocationHistoriesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryRevocationHistoriesOpResponse response = new QueryRevocationHistoriesOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new RevocationHistoryPagingSlicedResult().createFromJson(json));
            response.setSuccess(true);
        }
