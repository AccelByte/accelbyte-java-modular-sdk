...
import net.accelbyte.sdk.api.platform.operation_responses.trade_action.GetTradeHistoryByCriteriaOpResponse;
...
public class GetTradeHistoryByCriteria extends Operation {
    ...
    */
    ...
    public GetTradeHistoryByCriteriaOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetTradeHistoryByCriteriaOpResponse response = new GetTradeHistoryByCriteriaOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new TradeActionPagingSlicedResult().createFromJson(json));
            response.setSuccess(true);
        }
    ...
    /*
    public TradeActionPagingSlicedResult parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
