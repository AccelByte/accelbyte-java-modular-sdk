...
import net.accelbyte.sdk.api.platform.operation_responses.category.PublicGetDescendantCategoriesOpResponse;
...
public class PublicGetDescendantCategories extends Operation {
    ...
    */
    ...
    public PublicGetDescendantCategoriesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetDescendantCategoriesOpResponse response = new PublicGetDescendantCategoriesOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<CategoryInfo>>() {}));
        }
    ...
    /*
    public List<CategoryInfo> parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
