...
public class ListUserCurrencyTransactions extends Operation {
  ...
  public ListUserCurrencyTransactionsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final ListUserCurrencyTransactionsOpResponse response =
        new ListUserCurrencyTransactionsOpResponse();
