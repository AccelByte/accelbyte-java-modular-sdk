...
public class PublicGetUserAppEntitlementOwnershipByAppId extends Operation {
  ...
  public PublicGetUserAppEntitlementOwnershipByAppIdOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGetUserAppEntitlementOwnershipByAppIdOpResponse response =
        new PublicGetUserAppEntitlementOwnershipByAppIdOpResponse();
