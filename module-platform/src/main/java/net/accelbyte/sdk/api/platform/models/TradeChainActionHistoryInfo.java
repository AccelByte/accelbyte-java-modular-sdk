...
public class TradeChainActionHistoryInfo extends Model {
    ...
    @JsonIgnore
    public List<TradeChainActionHistoryInfo> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<TradeChainActionHistoryInfo>>() {});
    }
