...
import net.accelbyte.sdk.api.platform.operation_responses.campaign.GetCampaignOpResponse;
...
public class GetCampaign extends Operation {
    ...
    */
    ...
    public GetCampaignOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetCampaignOpResponse response = new GetCampaignOpResponse();
