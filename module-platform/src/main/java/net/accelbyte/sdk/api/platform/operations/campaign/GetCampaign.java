...
public class GetCampaign extends Operation {
  ...
  @Deprecated
  public GetCampaign(String customBasePath, String campaignId, String namespace) {
  ...
  public GetCampaignOpResponse parseResponse(int code, String contentType, InputStream payload)
