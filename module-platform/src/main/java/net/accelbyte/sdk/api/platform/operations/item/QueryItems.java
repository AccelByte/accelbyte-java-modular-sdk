...
public class QueryItems extends Operation {
    ...
    */
    ...
    public QueryItemsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryItemsOpResponse response = new QueryItemsOpResponse();
