...
public class CatalogChanges {
   ...
   */
  public SelectAllRecordsByCriteriaOpResponse selectAllRecordsByCriteria(
      SelectAllRecordsByCriteria input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public UnselectAllRecordsOpResponse unselectAllRecords(UnselectAllRecords input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
