...
public class QueryFulfillmentHistories extends Operation {
    ...
    */
    ...
    public QueryFulfillmentHistoriesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryFulfillmentHistoriesOpResponse response = new QueryFulfillmentHistoriesOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new FulfillmentHistoryPagingSlicedResult().createFromJson(json));
            response.setSuccess(true);
        }
