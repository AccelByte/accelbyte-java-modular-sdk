...
public class EntitlementDecrementResult extends Model {
    ...
    @JsonIgnore
    public List<EntitlementDecrementResult> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<EntitlementDecrementResult>>() {});
    }
