...
public class GetStatistic extends Operation {
    ...
    */
    ...
    public GetStatisticOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetStatisticOpResponse response = new GetStatisticOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new CatalogChangeStatistics().createFromJson(json));
            response.setSuccess(true);
        }
