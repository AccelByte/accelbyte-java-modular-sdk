...
public class UnselectRecord extends Operation {
  ...
  @Deprecated
  public UnselectRecord(String customBasePath, String changeId, String namespace, String storeId) {
  ...
  public UnselectRecordOpResponse parseResponse(int code, String contentType, InputStream payload)
