...
public class DurableEntitlementRevocationConfig extends Model {
    ...
    @JsonIgnore
    public DurableEntitlementRevocationConfig createFromJson(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, this.getClass());
    }

    @JsonIgnore
    public List<DurableEntitlementRevocationConfig> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<DurableEntitlementRevocationConfig>>() {});
    }
