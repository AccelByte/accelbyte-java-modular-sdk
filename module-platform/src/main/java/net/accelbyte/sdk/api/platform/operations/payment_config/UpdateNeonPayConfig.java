...
import net.accelbyte.sdk.api.platform.operation_responses.payment_config.UpdateNeonPayConfigOpResponse;
...
public class UpdateNeonPayConfig extends Operation {
    ...
    */
    ...
    public UpdateNeonPayConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateNeonPayConfigOpResponse response = new UpdateNeonPayConfigOpResponse();
