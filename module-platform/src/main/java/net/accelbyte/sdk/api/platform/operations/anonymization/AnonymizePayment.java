...
public class AnonymizePayment extends Operation {
  ...
  @Deprecated
  public AnonymizePayment(String customBasePath, String namespace, String userId) {
  ...
  public AnonymizePaymentOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final AnonymizePaymentOpResponse response = new AnonymizePaymentOpResponse();
