...
import net.accelbyte.sdk.api.platform.operation_responses.reward.QueryRewards1OpResponse;
...
public class QueryRewards1 extends Operation {
    ...
    */
    ...
    public QueryRewards1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryRewards1OpResponse response = new QueryRewards1OpResponse();
