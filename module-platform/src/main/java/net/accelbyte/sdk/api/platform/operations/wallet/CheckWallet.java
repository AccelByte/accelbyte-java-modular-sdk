...
public class CheckWallet extends Operation {
  ...
  @Deprecated
  public CheckWallet(
      String customBasePath, String currencyCode, String namespace, String userId, String origin) {
  ...
  public CheckWalletOpResponse parseResponse(int code, String contentType, InputStream payload)
