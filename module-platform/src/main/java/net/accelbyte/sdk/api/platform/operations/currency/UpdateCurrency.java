...
public class UpdateCurrency extends Operation {
  ...
  public UpdateCurrency(
      String customBasePath, String currencyCode, String namespace, CurrencyUpdate body) {
  ...
  public UpdateCurrencyOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final UpdateCurrencyOpResponse response = new UpdateCurrencyOpResponse();
