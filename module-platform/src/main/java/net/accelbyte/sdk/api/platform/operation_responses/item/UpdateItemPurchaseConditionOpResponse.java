...
@Getter
@Setter
public class UpdateItemPurchaseConditionOpResponse extends ApiResponseWithData<FullItemInfo> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.platform.operations.item.UpdateItemPurchaseCondition";
  }
}
