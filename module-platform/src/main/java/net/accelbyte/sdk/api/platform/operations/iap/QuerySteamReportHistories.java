...
public class QuerySteamReportHistories extends Operation {
  ...
  public QuerySteamReportHistoriesOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final QuerySteamReportHistoriesOpResponse response = new QuerySteamReportHistoriesOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new SteamReportInfoPagingSlicedResult().createFromJson(json));
      response.setSuccess(true);
    }
  ...
  /*
  public SteamReportInfoPagingSlicedResult parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
