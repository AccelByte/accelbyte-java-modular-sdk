...
public class SelectAllRecordsByCriteria extends Operation {
     ...
     */
    private String path = "/platform/admin/namespaces/{namespace}/stores/{storeId}/catalogChanges/selectAllByCriteria";
    ...
    */
    ...
    public SelectAllRecordsByCriteriaOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SelectAllRecordsByCriteriaOpResponse response = new SelectAllRecordsByCriteriaOpResponse();
