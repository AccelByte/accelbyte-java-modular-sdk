...
@Getter
@Setter
public class UpdateCategoryOpResponse extends ApiResponseWithData<FullCategoryInfo> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.platform.operations.category.UpdateCategory";
    }
}