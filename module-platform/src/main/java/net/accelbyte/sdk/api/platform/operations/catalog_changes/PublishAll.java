...
public class PublishAll extends Operation {
    ...
    */
    ...
    public PublishAllOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublishAllOpResponse response = new PublishAllOpResponse();
