...
import net.accelbyte.sdk.api.platform.operation_responses.iap.QueryUserIAPOrdersOpResponse;
...
public class QueryUserIAPOrders extends Operation {
    ...
    */
    ...
    public QueryUserIAPOrdersOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryUserIAPOrdersOpResponse response = new QueryUserIAPOrdersOpResponse();
