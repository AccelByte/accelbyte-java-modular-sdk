...
public class PublicGetUserEntitlementsByIds extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("availablePlatformOnly", this.availablePlatformOnly == null ? null : Arrays.asList(String.valueOf(this.availablePlatformOnly)));
    ...
    public PublicGetUserEntitlementsByIdsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetUserEntitlementsByIdsOpResponse response = new PublicGetUserEntitlementsByIdsOpResponse();
