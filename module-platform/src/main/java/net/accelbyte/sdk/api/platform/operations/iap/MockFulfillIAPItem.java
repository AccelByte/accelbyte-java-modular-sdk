...
import net.accelbyte.sdk.api.platform.operation_responses.iap.MockFulfillIAPItemOpResponse;
...
public class MockFulfillIAPItem extends Operation {
    ...
    */
    ...
    public MockFulfillIAPItemOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final MockFulfillIAPItemOpResponse response = new MockFulfillIAPItemOpResponse();
