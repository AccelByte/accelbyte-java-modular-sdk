...
import net.accelbyte.sdk.api.platform.operation_responses.payment_config.DebugMatchedPaymentProviderConfigOpResponse;
...
public class DebugMatchedPaymentProviderConfig extends Operation {
    ...
    */
    ...
    public DebugMatchedPaymentProviderConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DebugMatchedPaymentProviderConfigOpResponse response = new DebugMatchedPaymentProviderConfigOpResponse();
