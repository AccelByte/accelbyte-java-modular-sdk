...
public class SteamAchievementUpdateRequest extends Model {
    ...
    @JsonIgnore
    public List<SteamAchievementUpdateRequest> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<SteamAchievementUpdateRequest>>() {});
    }
