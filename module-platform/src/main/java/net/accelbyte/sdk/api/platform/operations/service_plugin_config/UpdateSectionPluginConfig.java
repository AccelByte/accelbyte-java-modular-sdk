...
import net.accelbyte.sdk.api.platform.operation_responses.service_plugin_config.UpdateSectionPluginConfigOpResponse;
...
public class UpdateSectionPluginConfig extends Operation {
    ...
    */
    ...
    public UpdateSectionPluginConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateSectionPluginConfigOpResponse response = new UpdateSectionPluginConfigOpResponse();
