...
public class FixedPeriodRotationConfig extends Model {
    ...
    @JsonIgnore
    public List<FixedPeriodRotationConfig> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<FixedPeriodRotationConfig>>() {});
    }
