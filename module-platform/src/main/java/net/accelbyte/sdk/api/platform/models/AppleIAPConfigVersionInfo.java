...
public class AppleIAPConfigVersionInfo extends Model {
    ...
    @JsonIgnore
    public List<AppleIAPConfigVersionInfo> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<AppleIAPConfigVersionInfo>>() {});
    }
