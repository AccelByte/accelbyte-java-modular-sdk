...
public class PublicQueryUserSubscriptions extends Operation {
  ...
  public PublicQueryUserSubscriptionsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicQueryUserSubscriptionsOpResponse response =
        new PublicQueryUserSubscriptionsOpResponse();
