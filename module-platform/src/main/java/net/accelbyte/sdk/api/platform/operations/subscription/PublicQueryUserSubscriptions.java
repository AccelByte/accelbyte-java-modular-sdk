...
public class PublicQueryUserSubscriptions extends Operation {
    ...
    */
    ...
    public PublicQueryUserSubscriptionsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicQueryUserSubscriptionsOpResponse response = new PublicQueryUserSubscriptionsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new SubscriptionPagingSlicedResult().createFromJson(json));
            response.setSuccess(true);
        }
