...
public class GetLocaleItemBySku extends Operation {
    ...
    */
    ...
    public GetLocaleItemBySkuOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetLocaleItemBySkuOpResponse response = new GetLocaleItemBySkuOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new PopulatedItemInfo().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 404) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public PopulatedItemInfo parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
