...
public class QueryUserSubscriptions extends Operation {
    ...
    */
    ...
    public QueryUserSubscriptionsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryUserSubscriptionsOpResponse response = new QueryUserSubscriptionsOpResponse();
