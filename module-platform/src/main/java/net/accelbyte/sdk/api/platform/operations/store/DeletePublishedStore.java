...
public class DeletePublishedStore extends Operation {
    ...
    */
    ...
    public DeletePublishedStoreOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeletePublishedStoreOpResponse response = new DeletePublishedStoreOpResponse();
