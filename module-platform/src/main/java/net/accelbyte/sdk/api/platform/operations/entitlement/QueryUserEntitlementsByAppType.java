...
public class QueryUserEntitlementsByAppType extends Operation {
    ...
    */
    ...
    public QueryUserEntitlementsByAppTypeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryUserEntitlementsByAppTypeOpResponse response = new QueryUserEntitlementsByAppTypeOpResponse();
