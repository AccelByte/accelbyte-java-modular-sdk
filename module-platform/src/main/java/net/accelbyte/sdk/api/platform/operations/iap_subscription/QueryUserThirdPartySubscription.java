...
public class QueryUserThirdPartySubscription extends Operation {
  ...
  public QueryUserThirdPartySubscriptionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final QueryUserThirdPartySubscriptionOpResponse response =
        new QueryUserThirdPartySubscriptionOpResponse();
