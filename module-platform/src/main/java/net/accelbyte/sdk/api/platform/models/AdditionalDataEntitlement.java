...
public class AdditionalDataEntitlement extends Model {
    ...
    @JsonIgnore
    public List<AdditionalDataEntitlement> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<AdditionalDataEntitlement>>() {});
    }
