...
public class DeleteRewardConditionRecord extends Operation {
    ...
    */
    ...
    public DeleteRewardConditionRecordOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteRewardConditionRecordOpResponse response = new DeleteRewardConditionRecordOpResponse();
