...
public class MockXblClawbackEvent extends Operation {
    ...
    */
    ...
    public MockXblClawbackEventOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final MockXblClawbackEventOpResponse response = new MockXblClawbackEventOpResponse();
