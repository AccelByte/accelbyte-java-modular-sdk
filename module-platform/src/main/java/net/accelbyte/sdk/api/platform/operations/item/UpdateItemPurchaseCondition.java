...
public class UpdateItemPurchaseCondition extends Operation {
    ...
    */
    ...
    public UpdateItemPurchaseConditionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateItemPurchaseConditionOpResponse response = new UpdateItemPurchaseConditionOpResponse();
