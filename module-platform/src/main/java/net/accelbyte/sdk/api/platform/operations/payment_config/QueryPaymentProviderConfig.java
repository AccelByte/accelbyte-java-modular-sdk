...
public class QueryPaymentProviderConfig extends Operation {
    ...
    */
    ...
    public QueryPaymentProviderConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryPaymentProviderConfigOpResponse response = new QueryPaymentProviderConfigOpResponse();
