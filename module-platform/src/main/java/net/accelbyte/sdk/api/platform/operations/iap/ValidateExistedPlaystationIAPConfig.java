...
import net.accelbyte.sdk.api.platform.operation_responses.iap.ValidateExistedPlaystationIAPConfigOpResponse;
...
public class ValidateExistedPlaystationIAPConfig extends Operation {
    ...
    */
    ...
    public ValidateExistedPlaystationIAPConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ValidateExistedPlaystationIAPConfigOpResponse response = new ValidateExistedPlaystationIAPConfigOpResponse();
