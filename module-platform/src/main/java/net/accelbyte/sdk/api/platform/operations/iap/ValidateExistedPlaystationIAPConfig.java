...
public class ValidateExistedPlaystationIAPConfig extends Operation {
  ...
  @Deprecated
  public ValidateExistedPlaystationIAPConfig(String customBasePath, String namespace) {
  ...
  public ValidateExistedPlaystationIAPConfigOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final ValidateExistedPlaystationIAPConfigOpResponse response =
        new ValidateExistedPlaystationIAPConfigOpResponse();
