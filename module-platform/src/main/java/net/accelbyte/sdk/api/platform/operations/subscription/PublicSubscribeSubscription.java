...
public class PublicSubscribeSubscription extends Operation {
  ...
  public PublicSubscribeSubscription(
      String customBasePath, String namespace, String userId, SubscribeRequest body) {
  ...
  public PublicSubscribeSubscriptionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicSubscribeSubscriptionOpResponse response =
        new PublicSubscribeSubscriptionOpResponse();
