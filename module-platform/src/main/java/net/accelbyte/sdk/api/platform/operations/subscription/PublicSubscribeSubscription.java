...
public class PublicSubscribeSubscription extends Operation {
    ...
    */
    ...
    public PublicSubscribeSubscriptionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicSubscribeSubscriptionOpResponse response = new PublicSubscribeSubscriptionOpResponse();
