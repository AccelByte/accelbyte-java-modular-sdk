...
public class GetUserSubscriptionActivities extends Operation {
    ...
    */
    ...
    public GetUserSubscriptionActivitiesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserSubscriptionActivitiesOpResponse response = new GetUserSubscriptionActivitiesOpResponse();
