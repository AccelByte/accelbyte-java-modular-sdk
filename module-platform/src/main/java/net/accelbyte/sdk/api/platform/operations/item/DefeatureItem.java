...
public class DefeatureItem extends Operation {
    ...
    */
    ...
    public DefeatureItem(
            String customBasePath,            String feature,
            String itemId,
            String namespace,
            String storeId
    )
    ...
    public DefeatureItemOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
