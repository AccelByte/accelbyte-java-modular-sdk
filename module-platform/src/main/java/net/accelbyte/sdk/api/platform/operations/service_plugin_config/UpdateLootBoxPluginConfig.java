...
import net.accelbyte.sdk.api.platform.operation_responses.service_plugin_config.UpdateLootBoxPluginConfigOpResponse;
...
public class UpdateLootBoxPluginConfig extends Operation {
    ...
    */
    ...
    public UpdateLootBoxPluginConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateLootBoxPluginConfigOpResponse response = new UpdateLootBoxPluginConfigOpResponse();
