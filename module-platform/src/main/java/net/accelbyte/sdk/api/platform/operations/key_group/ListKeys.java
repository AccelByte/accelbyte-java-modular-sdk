...
import net.accelbyte.sdk.api.platform.operation_responses.key_group.ListKeysOpResponse;
...
public class ListKeys extends Operation {
    ...
    */
    ...
    @Deprecated
    public ListKeys(
            String customBasePath,            String keyGroupId,
            String namespace,
            Integer limit,
            Integer offset,
            String status
    ...
    public ListKeysOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ListKeysOpResponse response = new ListKeysOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new KeyPagingSliceResult().createFromJson(json));
            response.setSuccess(true);
        }
    ...
    /*
    public KeyPagingSliceResult parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
