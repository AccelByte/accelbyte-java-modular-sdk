...
public class BulkEntitlementRevokeResult extends Model {
    ...
    @JsonIgnore
    public List<BulkEntitlementRevokeResult> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<BulkEntitlementRevokeResult>>() {});
    }
