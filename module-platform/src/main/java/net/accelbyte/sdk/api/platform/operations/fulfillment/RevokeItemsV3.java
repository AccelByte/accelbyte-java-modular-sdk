...
public class RevokeItemsV3 extends Operation {
  ...
  public RevokeItemsV3OpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final RevokeItemsV3OpResponse response = new RevokeItemsV3OpResponse();
