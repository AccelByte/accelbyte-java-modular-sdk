...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.PublicGetMyEntitlementOwnershipBySkuOpResponse;
...
public class PublicGetMyEntitlementOwnershipBySku extends Operation {
    ...
    */
    ...
    public PublicGetMyEntitlementOwnershipBySkuOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetMyEntitlementOwnershipBySkuOpResponse response = new PublicGetMyEntitlementOwnershipBySkuOpResponse();
