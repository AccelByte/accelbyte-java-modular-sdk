...
public class GetUserSubscription extends Operation {
    ...
    */
    ...
    public GetUserSubscriptionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserSubscriptionOpResponse response = new GetUserSubscriptionOpResponse();
