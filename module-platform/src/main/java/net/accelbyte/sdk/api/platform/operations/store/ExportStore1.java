...
public class ExportStore1 extends Operation {
    ...
    */
    ...
    public ExportStore1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
