...
import net.accelbyte.sdk.api.platform.operation_responses.invoice.*;
...
public class Invoice {
     ...
     */
    public DownloadInvoiceDetailsOpResponse downloadInvoiceDetails(DownloadInvoiceDetails input) throws Exception {
     ...
     */
    public GenerateInvoiceSummaryOpResponse generateInvoiceSummary(GenerateInvoiceSummary input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
