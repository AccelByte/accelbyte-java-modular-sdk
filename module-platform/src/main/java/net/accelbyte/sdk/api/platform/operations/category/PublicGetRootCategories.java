...
import net.accelbyte.sdk.api.platform.operation_responses.category.PublicGetRootCategoriesOpResponse;
...
public class PublicGetRootCategories extends Operation {
    ...
    */
    ...
    public PublicGetRootCategoriesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetRootCategoriesOpResponse response = new PublicGetRootCategoriesOpResponse();
