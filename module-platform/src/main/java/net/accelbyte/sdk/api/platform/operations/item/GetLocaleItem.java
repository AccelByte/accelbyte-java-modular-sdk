...
public class GetLocaleItem extends Operation {
    ...
    */
    ...
    public GetLocaleItemOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetLocaleItemOpResponse response = new GetLocaleItemOpResponse();
