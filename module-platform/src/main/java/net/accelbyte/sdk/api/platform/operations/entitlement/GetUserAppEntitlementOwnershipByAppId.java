...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.GetUserAppEntitlementOwnershipByAppIdOpResponse;
...
public class GetUserAppEntitlementOwnershipByAppId extends Operation {
    ...
    */
    ...
    public GetUserAppEntitlementOwnershipByAppIdOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserAppEntitlementOwnershipByAppIdOpResponse response = new GetUserAppEntitlementOwnershipByAppIdOpResponse();
