...
public class GetUserAppEntitlementOwnershipByAppId extends Operation {
  ...
  public GetUserAppEntitlementOwnershipByAppId(
      String customBasePath, String namespace, String userId, String appId) {
  ...
  public GetUserAppEntitlementOwnershipByAppIdOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetUserAppEntitlementOwnershipByAppIdOpResponse response =
        new GetUserAppEntitlementOwnershipByAppIdOpResponse();
