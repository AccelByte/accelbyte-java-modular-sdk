...
public class SearchItemTypeConfig extends Operation {
    ...
    */
    ...
    public SearchItemTypeConfig(
            String customBasePath,            String clazz,
            String itemType
    )
    {
        this.clazz = clazz;
    ...
    public SearchItemTypeConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
