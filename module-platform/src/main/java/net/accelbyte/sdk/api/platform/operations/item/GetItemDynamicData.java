...
public class GetItemDynamicData extends Operation {
    ...
    */
    ...
    public GetItemDynamicDataOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetItemDynamicDataOpResponse response = new GetItemDynamicDataOpResponse();
