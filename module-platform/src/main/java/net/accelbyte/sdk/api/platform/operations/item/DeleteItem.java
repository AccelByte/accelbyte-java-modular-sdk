...
public class DeleteItem extends Operation {
    ...
    */
    ...
    public DeleteItemOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteItemOpResponse response = new DeleteItemOpResponse();
