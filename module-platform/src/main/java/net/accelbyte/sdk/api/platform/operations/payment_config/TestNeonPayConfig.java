...
import net.accelbyte.sdk.api.platform.operation_responses.payment_config.TestNeonPayConfigOpResponse;
...
public class TestNeonPayConfig extends Operation {
    ...
    */
    ...
    public TestNeonPayConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final TestNeonPayConfigOpResponse response = new TestNeonPayConfigOpResponse();
