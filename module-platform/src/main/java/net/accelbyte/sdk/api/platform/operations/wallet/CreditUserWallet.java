...
public class CreditUserWallet extends Operation {
  ...
  public CreditUserWalletOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final CreditUserWalletOpResponse response = new CreditUserWalletOpResponse();
