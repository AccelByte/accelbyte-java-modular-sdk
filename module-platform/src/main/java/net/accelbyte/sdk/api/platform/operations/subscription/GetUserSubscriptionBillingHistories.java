...
public class GetUserSubscriptionBillingHistories extends Operation {
  ...
  public GetUserSubscriptionBillingHistoriesOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetUserSubscriptionBillingHistoriesOpResponse response =
        new GetUserSubscriptionBillingHistoriesOpResponse();
