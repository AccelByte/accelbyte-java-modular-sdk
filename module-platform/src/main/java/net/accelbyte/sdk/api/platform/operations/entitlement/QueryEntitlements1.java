...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.QueryEntitlements1OpResponse;
...
public class QueryEntitlements1 extends Operation {
    ...
    */
    ...
    public QueryEntitlements1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryEntitlements1OpResponse response = new QueryEntitlements1OpResponse();
    ...
    */
    ...
    public static class QueryEntitlements1Builder {
        ...
        public QueryEntitlements1Builder entitlementClazzFromEnum(final EntitlementClazz entitlementClazz) {
