...
public class DisableItem extends Operation {
    ...
    */
    ...
    public DisableItemOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DisableItemOpResponse response = new DisableItemOpResponse();
