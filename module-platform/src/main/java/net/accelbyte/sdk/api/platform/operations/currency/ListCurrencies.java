...
public class ListCurrencies extends Operation {
    ...
    */
    ...
    public ListCurrenciesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ListCurrenciesOpResponse response = new ListCurrenciesOpResponse();
