...
public class DLC {
   ...
   */
  public UpdateDLCItemConfigOpResponse updateDLCItemConfig(UpdateDLCItemConfig input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public DeleteDLCItemConfigOpResponse deleteDLCItemConfig(DeleteDLCItemConfig input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public GetPlatformDLCConfigOpResponse getPlatformDLCConfig(GetPlatformDLCConfig input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public UpdatePlatformDLCConfigOpResponse updatePlatformDLCConfig(UpdatePlatformDLCConfig input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public DeletePlatformDLCConfigOpResponse deletePlatformDLCConfig(DeletePlatformDLCConfig input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public GetUserDLCByPlatformOpResponse getUserDLCByPlatform(GetUserDLCByPlatform input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public GeDLCDurableRewardShortMapOpResponse geDLCDurableRewardShortMap(
      GeDLCDurableRewardShortMap input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public PublicSyncPsnDlcInventoryOpResponse publicSyncPsnDlcInventory(
      PublicSyncPsnDlcInventory input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public PublicSyncPsnDlcInventoryWithMultipleServiceLabelsOpResponse
   ...
   */
  public PublicGetMyDLCContentOpResponse publicGetMyDLCContent(PublicGetMyDLCContent input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
