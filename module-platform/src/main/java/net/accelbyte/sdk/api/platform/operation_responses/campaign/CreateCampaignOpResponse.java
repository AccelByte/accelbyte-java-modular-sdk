...
@Getter
@Setter
public class CreateCampaignOpResponse extends ApiResponseWithData<CampaignInfo> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.platform.operations.campaign.CreateCampaign";
    }
}