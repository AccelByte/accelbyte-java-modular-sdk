...
public class SectionPluginConfigUpdate extends Model {
    ...
    @JsonIgnore
    public List<SectionPluginConfigUpdate> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<SectionPluginConfigUpdate>>() {});
    }
