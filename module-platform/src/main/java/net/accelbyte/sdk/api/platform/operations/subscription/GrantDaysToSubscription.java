...
public class GrantDaysToSubscription extends Operation {
    ...
    */
    ...
    public GrantDaysToSubscriptionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GrantDaysToSubscriptionOpResponse response = new GrantDaysToSubscriptionOpResponse();
