...
public class GetPlatformEntitlementConfig extends Operation {
  ...
  @Deprecated
  public GetPlatformEntitlementConfig(String customBasePath, String namespace, String platform) {
  ...
  public GetPlatformEntitlementConfigOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetPlatformEntitlementConfigOpResponse response =
        new GetPlatformEntitlementConfigOpResponse();
