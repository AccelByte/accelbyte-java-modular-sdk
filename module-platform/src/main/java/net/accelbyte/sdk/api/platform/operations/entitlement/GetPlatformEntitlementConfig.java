...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.GetPlatformEntitlementConfigOpResponse;
...
public class GetPlatformEntitlementConfig extends Operation {
     ...
     */
    private String path = "/platform/admin/namespaces/{namespace}/platforms/{platform}/entitlement/config";
    ...
    */
    ...
    public GetPlatformEntitlementConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetPlatformEntitlementConfigOpResponse response = new GetPlatformEntitlementConfigOpResponse();
