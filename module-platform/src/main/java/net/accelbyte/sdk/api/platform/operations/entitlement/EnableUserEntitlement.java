...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.EnableUserEntitlementOpResponse;
...
public class EnableUserEntitlement extends Operation {
    ...
    */
    ...
    public EnableUserEntitlementOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final EnableUserEntitlementOpResponse response = new EnableUserEntitlementOpResponse();
