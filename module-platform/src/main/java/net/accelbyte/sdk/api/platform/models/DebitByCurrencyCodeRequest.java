...
public class DebitByCurrencyCodeRequest extends Model {
    ...
    public List<DebitByCurrencyCodeRequest> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<DebitByCurrencyCodeRequest>>() {});
    }
    ...
    public static class DebitByCurrencyCodeRequestBuilder {
        ...
        public DebitByCurrencyCodeRequestBuilder balanceOriginFromEnum(final BalanceOrigin balanceOrigin) {
            this.balanceOrigin = balanceOrigin.toString();
            return this;
        }
        ...
        public DebitByCurrencyCodeRequestBuilder balanceSourceFromEnum(final BalanceSource balanceSource) {
            this.balanceSource = balanceSource.toString();
            return this;
        }
    }
