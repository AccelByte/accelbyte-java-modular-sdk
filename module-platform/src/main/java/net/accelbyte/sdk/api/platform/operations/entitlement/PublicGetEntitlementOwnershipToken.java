...
public class PublicGetEntitlementOwnershipToken extends Operation {
  ...
  public PublicGetEntitlementOwnershipTokenOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGetEntitlementOwnershipTokenOpResponse response =
        new PublicGetEntitlementOwnershipTokenOpResponse();
