...
public class ListFulfillmentScripts extends Operation {
  ...
  @Deprecated
  public ListFulfillmentScripts(String customBasePath) {
  ...
  public ListFulfillmentScriptsOpResponse parseResponse(
    ...
    if (code == 204) {
      ...
      response.setSuccess(true);
      response.setData(
          new ObjectMapper().readValue(json, new TypeReference<List<FulfillmentScriptInfo>>() {}));
    }
