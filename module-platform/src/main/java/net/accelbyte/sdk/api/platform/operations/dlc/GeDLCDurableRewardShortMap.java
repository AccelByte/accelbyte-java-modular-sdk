...
public class GeDLCDurableRewardShortMap extends Operation {
    ...
    */
    ...
    public GeDLCDurableRewardShortMapOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GeDLCDurableRewardShortMapOpResponse response = new GeDLCDurableRewardShortMapOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new DLCConfigRewardShortInfo().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 404) {
            final String json = Helper.convertInputStreamToString(payload);
