...
public class TestAliPayConfig extends Operation {
  ...
  @Deprecated
  public TestAliPayConfig(String customBasePath, Boolean sandbox, AliPayConfig body) {
  ...
  public TestAliPayConfigOpResponse parseResponse(int code, String contentType, InputStream payload)
