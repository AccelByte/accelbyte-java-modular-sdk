...
public class GetThirdPartyPlatformSubscriptionOwnershipByProductId extends Operation {
     ...
     */
    private String path = "/platform/admin/namespaces/{namespace}/users/{userId}/iap/subscriptions/platforms/{platform}/ownership/byProductId";
    ...
    */
    ...
    public GetThirdPartyPlatformSubscriptionOwnershipByProductIdOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetThirdPartyPlatformSubscriptionOwnershipByProductIdOpResponse response = new GetThirdPartyPlatformSubscriptionOwnershipByProductIdOpResponse();
    ...
    */
    ...
    public static class GetThirdPartyPlatformSubscriptionOwnershipByProductIdBuilder {
        ...
        public GetThirdPartyPlatformSubscriptionOwnershipByProductIdBuilder platform(final String platform) {
            this.platform = platform;
            return this;
        }

        public GetThirdPartyPlatformSubscriptionOwnershipByProductIdBuilder platformFromEnum(final Platform platform) {
