...
public class CreateCurrency extends Operation {
  ...
  @Deprecated
  public CreateCurrency(String customBasePath, String namespace, CurrencyCreate body) {
  ...
  public CreateCurrencyOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final CreateCurrencyOpResponse response = new CreateCurrencyOpResponse();
