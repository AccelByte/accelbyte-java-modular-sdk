...
public class GetUserOrder extends Operation {
  ...
  @Deprecated
  public GetUserOrder(String customBasePath, String namespace, String orderNo, String userId) {
  ...
  public GetUserOrderOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetUserOrderOpResponse response = new GetUserOrderOpResponse();
