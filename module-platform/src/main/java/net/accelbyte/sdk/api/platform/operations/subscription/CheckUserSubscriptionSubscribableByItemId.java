...
public class CheckUserSubscriptionSubscribableByItemId extends Operation {
    ...
    */
    ...
    public CheckUserSubscriptionSubscribableByItemIdOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CheckUserSubscriptionSubscribableByItemIdOpResponse response = new CheckUserSubscriptionSubscribableByItemIdOpResponse();
