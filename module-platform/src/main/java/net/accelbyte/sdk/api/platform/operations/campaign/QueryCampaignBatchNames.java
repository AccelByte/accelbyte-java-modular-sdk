...
public class QueryCampaignBatchNames extends Operation {
    ...
    */
    ...
    public QueryCampaignBatchNamesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<CampaignBatchNameInfo>>() {}));
        }
