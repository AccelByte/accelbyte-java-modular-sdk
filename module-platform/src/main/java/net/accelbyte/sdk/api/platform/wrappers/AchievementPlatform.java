...
public class AchievementPlatform {
     ...
     */
    public UnlockSteamUserAchievementOpResponse unlockSteamUserAchievement(UnlockSteamUserAchievement input) throws Exception {
     ...
     */
    public GetXblUserAchievementsOpResponse getXblUserAchievements(GetXblUserAchievements input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public UpdateXblUserAchievementOpResponse updateXblUserAchievement(UpdateXblUserAchievement input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
