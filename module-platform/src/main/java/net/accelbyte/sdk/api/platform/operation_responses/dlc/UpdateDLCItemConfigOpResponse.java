...
@Getter
@Setter
public class UpdateDLCItemConfigOpResponse extends ApiResponseWithData<DLCItemConfigInfo> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.platform.operations.dlc.UpdateDLCItemConfig";
    }
}