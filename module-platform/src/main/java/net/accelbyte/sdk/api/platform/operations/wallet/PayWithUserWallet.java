...
public class PayWithUserWallet extends Operation {
    ...
    */
    ...
    public PayWithUserWalletOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PayWithUserWalletOpResponse response = new PayWithUserWalletOpResponse();
