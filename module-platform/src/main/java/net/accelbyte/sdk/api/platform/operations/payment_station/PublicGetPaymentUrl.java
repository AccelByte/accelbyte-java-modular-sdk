...
import net.accelbyte.sdk.api.platform.operation_responses.payment_station.PublicGetPaymentUrlOpResponse;
...
public class PublicGetPaymentUrl extends Operation {
  ...
  public PublicGetPaymentUrlOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGetPaymentUrlOpResponse response = new PublicGetPaymentUrlOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new PaymentUrl().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public PaymentUrl parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
