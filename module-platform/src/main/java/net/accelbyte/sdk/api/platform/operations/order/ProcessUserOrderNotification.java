...
public class ProcessUserOrderNotification extends Operation {
    ...
    */
    ...
    public ProcessUserOrderNotificationOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ProcessUserOrderNotificationOpResponse response = new ProcessUserOrderNotificationOpResponse();
