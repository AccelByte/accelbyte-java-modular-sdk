...
public class UpdateApp extends Operation {
  ...
  @Deprecated
  public UpdateApp(
      String customBasePath, String itemId, String namespace, String storeId, AppUpdate body) {
    this.itemId = itemId;
  ...
  public UpdateAppOpResponse parseResponse(int code, String contentType, InputStream payload)
