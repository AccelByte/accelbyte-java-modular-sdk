...
public class DeletePaymentProviderConfig extends Operation {
    ...
    */
    ...
    public DeletePaymentProviderConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeletePaymentProviderConfigOpResponse response = new DeletePaymentProviderConfigOpResponse();
