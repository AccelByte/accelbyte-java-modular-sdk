...
public class PublicSearchItems extends Operation {
    ...
    */
    ...
    public PublicSearchItemsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicSearchItemsOpResponse response = new PublicSearchItemsOpResponse();
