...
public class CheckBalance extends Operation {
     ...
     */
    private String path = "/platform/admin/namespaces/{namespace}/users/{userId}/wallets/{currencyCode}/balanceCheck";
    ...
    */
    ...
    public CheckBalanceOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CheckBalanceOpResponse response = new CheckBalanceOpResponse();
