...
public class GetPlatformWalletConfig extends Operation {
    ...
    */
    ...
    public GetPlatformWalletConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetPlatformWalletConfigOpResponse response = new GetPlatformWalletConfigOpResponse();
