...
public class GetItemByAppId extends Operation {
  ...
  public GetItemByAppId(
      String customBasePath, String namespace, Boolean activeOnly, String storeId, String appId) {
  ...
  public GetItemByAppIdOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetItemByAppIdOpResponse response = new GetItemByAppIdOpResponse();
