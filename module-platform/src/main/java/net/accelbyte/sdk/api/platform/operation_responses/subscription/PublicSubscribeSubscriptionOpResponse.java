...
@Getter
@Setter
public class PublicSubscribeSubscriptionOpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.platform.operations.subscription.PublicSubscribeSubscription";
    }
}