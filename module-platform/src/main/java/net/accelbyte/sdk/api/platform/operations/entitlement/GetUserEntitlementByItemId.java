...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.GetUserEntitlementByItemIdOpResponse;
...
public class GetUserEntitlementByItemId extends Operation {
    ...
    */
    ...
    public GetUserEntitlementByItemIdOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserEntitlementByItemIdOpResponse response = new GetUserEntitlementByItemIdOpResponse();
