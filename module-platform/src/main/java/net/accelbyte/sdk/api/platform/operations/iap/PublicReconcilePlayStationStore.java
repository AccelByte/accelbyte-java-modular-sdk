...
public class PublicReconcilePlayStationStore extends Operation {
  ...
  public PublicReconcilePlayStationStoreOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicReconcilePlayStationStoreOpResponse response =
        new PublicReconcilePlayStationStoreOpResponse();
