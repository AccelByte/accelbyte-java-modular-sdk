...
import net.accelbyte.sdk.api.platform.operation_responses.iap.PublicReconcilePlayStationStoreOpResponse;
...
public class PublicReconcilePlayStationStore extends Operation {
    ...
    */
    ...
    public PublicReconcilePlayStationStoreOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicReconcilePlayStationStoreOpResponse response = new PublicReconcilePlayStationStoreOpResponse();
