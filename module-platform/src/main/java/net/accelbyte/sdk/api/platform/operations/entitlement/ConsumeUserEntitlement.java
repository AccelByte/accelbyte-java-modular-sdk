...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.ConsumeUserEntitlementOpResponse;
...
public class ConsumeUserEntitlement extends Operation {
    ...
    */
    ...
    public ConsumeUserEntitlementOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ConsumeUserEntitlementOpResponse response = new ConsumeUserEntitlementOpResponse();
