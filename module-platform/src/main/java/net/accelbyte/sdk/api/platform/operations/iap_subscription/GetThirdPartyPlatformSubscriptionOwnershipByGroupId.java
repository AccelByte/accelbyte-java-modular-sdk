...
public class GetThirdPartyPlatformSubscriptionOwnershipByGroupId extends Operation {
  ...
  public GetThirdPartyPlatformSubscriptionOwnershipByGroupId(
      String customBasePath, String namespace, String platform, String userId, String groupId) {
  ...
  public GetThirdPartyPlatformSubscriptionOwnershipByGroupIdOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetThirdPartyPlatformSubscriptionOwnershipByGroupIdOpResponse response =
        new GetThirdPartyPlatformSubscriptionOwnershipByGroupIdOpResponse();
