...
public class GetThirdPartyPlatformSubscriptionOwnershipByGroupId extends Operation {
     ...
     */
    private String path = "/platform/admin/namespaces/{namespace}/users/{userId}/iap/subscriptions/platforms/{platform}/ownership/byGroupId";
    ...
    */
    ...
    public GetThirdPartyPlatformSubscriptionOwnershipByGroupIdOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetThirdPartyPlatformSubscriptionOwnershipByGroupIdOpResponse response = new GetThirdPartyPlatformSubscriptionOwnershipByGroupIdOpResponse();
    ...
    */
    ...
    public static class GetThirdPartyPlatformSubscriptionOwnershipByGroupIdBuilder {
        ...
        public GetThirdPartyPlatformSubscriptionOwnershipByGroupIdBuilder platform(final String platform) {
            this.platform = platform;
            return this;
        }

        public GetThirdPartyPlatformSubscriptionOwnershipByGroupIdBuilder platformFromEnum(final Platform platform) {
