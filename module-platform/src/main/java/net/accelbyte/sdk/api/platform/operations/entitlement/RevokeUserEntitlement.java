...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.RevokeUserEntitlementOpResponse;
...
public class RevokeUserEntitlement extends Operation {
    ...
    */
    ...
    public RevokeUserEntitlementOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RevokeUserEntitlementOpResponse response = new RevokeUserEntitlementOpResponse();
