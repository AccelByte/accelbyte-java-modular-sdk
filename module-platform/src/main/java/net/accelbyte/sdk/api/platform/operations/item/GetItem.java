...
public class GetItem extends Operation {
  ...
  @Deprecated
  public GetItem(
      String customBasePath, String itemId, String namespace, Boolean activeOnly, String storeId) {
    this.itemId = itemId;
  ...
  public GetItemOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetItemOpResponse response = new GetItemOpResponse();
