...
public class PublicSyncPsnDlcInventoryWithMultipleServiceLabels extends Operation {
     ...
     */
    private String path = "/platform/public/namespaces/{namespace}/users/{userId}/dlc/psn/sync/multiServiceLabels";
    ...
    */
    ...
    public PublicSyncPsnDlcInventoryWithMultipleServiceLabelsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicSyncPsnDlcInventoryWithMultipleServiceLabelsOpResponse response = new PublicSyncPsnDlcInventoryWithMultipleServiceLabelsOpResponse();
