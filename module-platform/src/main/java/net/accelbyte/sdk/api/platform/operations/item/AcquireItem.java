...
public class AcquireItem extends Operation {
  ...
  @Deprecated
  public AcquireItem(
      String customBasePath, String itemId, String namespace, ItemAcquireRequest body) {
    this.itemId = itemId;
  ...
  public AcquireItemOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final AcquireItemOpResponse response = new AcquireItemOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ItemAcquireResult().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 404) {
      final String json = Helper.convertInputStreamToString(payload);
