...
import net.accelbyte.sdk.api.platform.operation_responses.campaign.CreateCampaignOpResponse;
...
public class CreateCampaign extends Operation {
  ...
  @Deprecated
  public CreateCampaign(String customBasePath, String namespace, CampaignCreate body) {
  ...
  public CreateCampaignOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final CreateCampaignOpResponse response = new CreateCampaignOpResponse();
