...
import net.accelbyte.sdk.api.platform.operation_responses.category.PublicGetCategoryOpResponse;
...
public class PublicGetCategory extends Operation {
    ...
    */
    ...
    public PublicGetCategoryOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetCategoryOpResponse response = new PublicGetCategoryOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new CategoryInfo().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 404) {
            final String json = Helper.convertInputStreamToString(payload);
