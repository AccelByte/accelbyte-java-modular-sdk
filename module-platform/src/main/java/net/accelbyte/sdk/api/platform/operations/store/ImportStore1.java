...
public class ImportStore1 extends Operation {
  ...
  @Deprecated
  public ImportStore1(
      String customBasePath, String namespace, String storeId, Boolean strictMode, File file) {
  ...
  public ImportStore1OpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final ImportStore1OpResponse response = new ImportStore1OpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ImportStoreResult().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
