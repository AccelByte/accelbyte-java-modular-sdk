...
public class DebitUserWalletByCurrencyCode extends Operation {
  ...
  public DebitUserWalletByCurrencyCodeOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final DebitUserWalletByCurrencyCodeOpResponse response =
        new DebitUserWalletByCurrencyCodeOpResponse();
