...
public class PublicUserEntitlementHistory extends Operation {
  ...
  public PublicUserEntitlementHistoryOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicUserEntitlementHistoryOpResponse response =
        new PublicUserEntitlementHistoryOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(
          new ObjectMapper()
              .readValue(
                  json, new TypeReference<List<UserEntitlementHistoryPagingSlicedResult>>() {}));
    }
