...
import net.accelbyte.sdk.api.platform.operation_responses.iap.UpdateAppleIAPConfigOpResponse;
...
public class UpdateAppleIAPConfig extends Operation {
  ...
  @Deprecated
  public UpdateAppleIAPConfig(String customBasePath, String namespace, AppleIAPConfigRequest body) {
  ...
  public UpdateAppleIAPConfigOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdateAppleIAPConfigOpResponse response = new UpdateAppleIAPConfigOpResponse();
