...
public class RevokeUserEntitlementByUseCount extends Operation {
  ...
  public RevokeUserEntitlementByUseCountOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final RevokeUserEntitlementByUseCountOpResponse response =
        new RevokeUserEntitlementByUseCountOpResponse();
