...
public class OculusReconcileResult extends Model {
    ...
    @JsonIgnore
    public List<OculusReconcileResult> createFromJsonList(String json) throws JsonProcessingException {
    ...
    public static class OculusReconcileResultBuilder {
        ...
        public OculusReconcileResultBuilder iapOrderStatusFromEnum(final IapOrderStatus iapOrderStatus) {
            this.iapOrderStatus = iapOrderStatus.toString();
            return this;
        }
        ...
        public OculusReconcileResultBuilder itemIdentityTypeFromEnum(final ItemIdentityType itemIdentityType) {
            this.itemIdentityType = itemIdentityType.toString();
            return this;
        }
    }
