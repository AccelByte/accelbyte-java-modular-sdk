...
public class GetUserDLC extends Operation {
  ...
  public GetUserDLCOpResponse parseResponse(int code, String contentType, InputStream payload)
    ...
    if (code == 204) {
      ...
      response.setSuccess(true);
      response.setData(
          new ObjectMapper().readValue(json, new TypeReference<List<UserDLCRecord>>() {}));
    }
