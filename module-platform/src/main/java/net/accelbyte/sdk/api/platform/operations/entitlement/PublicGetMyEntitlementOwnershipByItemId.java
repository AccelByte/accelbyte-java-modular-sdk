...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.PublicGetMyEntitlementOwnershipByItemIdOpResponse;
...
public class PublicGetMyEntitlementOwnershipByItemId extends Operation {
    ...
    */
    ...
    public PublicGetMyEntitlementOwnershipByItemIdOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetMyEntitlementOwnershipByItemIdOpResponse response = new PublicGetMyEntitlementOwnershipByItemIdOpResponse();
