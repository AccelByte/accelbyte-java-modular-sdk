...
public class PublicGetMyEntitlementOwnershipByItemId extends Operation {
  ...
  public PublicGetMyEntitlementOwnershipByItemId(
      String customBasePath, String namespace, String entitlementClazz, String itemId) {
  ...
  public PublicGetMyEntitlementOwnershipByItemIdOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGetMyEntitlementOwnershipByItemIdOpResponse response =
        new PublicGetMyEntitlementOwnershipByItemIdOpResponse();
