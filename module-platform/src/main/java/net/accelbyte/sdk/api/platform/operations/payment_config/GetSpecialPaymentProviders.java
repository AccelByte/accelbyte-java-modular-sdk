...
public class GetSpecialPaymentProviders extends Operation {
    ...
    */
    ...
    public GetSpecialPaymentProvidersOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetSpecialPaymentProvidersOpResponse response = new GetSpecialPaymentProvidersOpResponse();
