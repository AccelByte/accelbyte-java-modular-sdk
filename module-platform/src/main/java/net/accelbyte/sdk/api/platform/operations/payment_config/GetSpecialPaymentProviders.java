...
import net.accelbyte.sdk.api.platform.operation_responses.payment_config.GetSpecialPaymentProvidersOpResponse;
...
public class GetSpecialPaymentProviders extends Operation {
  ...
  @Deprecated
  public GetSpecialPaymentProviders(String customBasePath) {
  ...
  public GetSpecialPaymentProvidersOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetSpecialPaymentProvidersOpResponse response =
        new GetSpecialPaymentProvidersOpResponse();
