...
import net.accelbyte.sdk.api.platform.operation_responses.payment_dedicated.CreatePaymentOrderByDedicatedOpResponse;
...
public class CreatePaymentOrderByDedicated extends Operation {
    ...
    */
    ...
    public CreatePaymentOrderByDedicatedOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreatePaymentOrderByDedicatedOpResponse response = new CreatePaymentOrderByDedicatedOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new PaymentOrderCreateResult().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public PaymentOrderCreateResult parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 201){
            final String json = Helper.convertInputStreamToString(payload);
