...
public class CreatePaymentOrderByDedicated extends Operation {
  ...
  public CreatePaymentOrderByDedicated(
      String customBasePath, String namespace, ExternalPaymentOrderCreate body) {
  ...
  public CreatePaymentOrderByDedicatedOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final CreatePaymentOrderByDedicatedOpResponse response =
        new CreatePaymentOrderByDedicatedOpResponse();
