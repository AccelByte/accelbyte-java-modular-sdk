...
public class PlatformSubscribeSubscription extends Operation {
  ...
  public PlatformSubscribeSubscription(
      String customBasePath, String namespace, String userId, PlatformSubscribeRequest body) {
  ...
  public PlatformSubscribeSubscriptionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PlatformSubscribeSubscriptionOpResponse response =
        new PlatformSubscribeSubscriptionOpResponse();
