...
public class PlatformSubscribeSubscription extends Operation {
    ...
    */
    ...
    public PlatformSubscribeSubscriptionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PlatformSubscribeSubscriptionOpResponse response = new PlatformSubscribeSubscriptionOpResponse();
