...
public class PublicExistsAnyUserActiveEntitlement extends Operation {
  ...
  public PublicExistsAnyUserActiveEntitlementOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicExistsAnyUserActiveEntitlementOpResponse response =
        new PublicExistsAnyUserActiveEntitlementOpResponse();
