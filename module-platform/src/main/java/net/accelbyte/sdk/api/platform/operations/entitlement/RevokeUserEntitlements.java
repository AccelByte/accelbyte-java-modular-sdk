...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.RevokeUserEntitlementsOpResponse;
...
public class RevokeUserEntitlements extends Operation {
    ...
    */
    ...
    public RevokeUserEntitlementsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RevokeUserEntitlementsOpResponse response = new RevokeUserEntitlementsOpResponse();
