...
import net.accelbyte.sdk.api.platform.operation_responses.view.PublicListViewsOpResponse;
...
public class PublicListViews extends Operation {
  ...
  public PublicListViews(
      String customBasePath, String namespace, String userId, String language, String storeId) {
  ...
  public PublicListViewsOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final PublicListViewsOpResponse response = new PublicListViewsOpResponse();
    ...
    if (code == 204) {
      ...
      response.setSuccess(true);
      response.setData(new ObjectMapper().readValue(json, new TypeReference<List<ViewInfo>>() {}));
    }
