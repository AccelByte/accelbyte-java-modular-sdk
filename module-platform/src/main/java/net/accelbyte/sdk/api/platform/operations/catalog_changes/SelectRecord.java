...
public class SelectRecord extends Operation {
  ...
  @Deprecated
  public SelectRecord(String customBasePath, String changeId, String namespace, String storeId) {
  ...
  public SelectRecordOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final SelectRecordOpResponse response = new SelectRecordOpResponse();
