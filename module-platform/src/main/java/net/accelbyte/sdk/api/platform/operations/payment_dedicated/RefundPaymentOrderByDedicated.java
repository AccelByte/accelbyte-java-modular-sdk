...
public class RefundPaymentOrderByDedicated extends Operation {
  ...
  public RefundPaymentOrderByDedicated(
      String customBasePath, String namespace, String paymentOrderNo, PaymentOrderRefund body) {
  ...
  public RefundPaymentOrderByDedicatedOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final RefundPaymentOrderByDedicatedOpResponse response =
        new RefundPaymentOrderByDedicatedOpResponse();
