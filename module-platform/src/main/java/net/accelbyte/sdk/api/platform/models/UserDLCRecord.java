...
public class UserDLCRecord extends Model {
    ...
    @JsonIgnore
    public void setEntitlementOriginSyncStatusFromEnum(final EntitlementOriginSyncStatus entitlementOriginSyncStatus) {
    ...
    public static class UserDLCRecordBuilder {
        ...
        public UserDLCRecordBuilder entitlementOriginSyncStatus(final String entitlementOriginSyncStatus) {
            this.entitlementOriginSyncStatus = entitlementOriginSyncStatus;
            return this;
        }

        public UserDLCRecordBuilder entitlementOriginSyncStatusFromEnum(final EntitlementOriginSyncStatus entitlementOriginSyncStatus) {
            this.entitlementOriginSyncStatus = entitlementOriginSyncStatus.toString();
            return this;
        }
