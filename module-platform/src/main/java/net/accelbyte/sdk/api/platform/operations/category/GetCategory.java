...
import net.accelbyte.sdk.api.platform.operation_responses.category.GetCategoryOpResponse;
...
public class GetCategory extends Operation {
  ...
  @Deprecated
  public GetCategory(String customBasePath, String categoryPath, String namespace, String storeId) {
  ...
  public GetCategoryOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetCategoryOpResponse response = new GetCategoryOpResponse();
