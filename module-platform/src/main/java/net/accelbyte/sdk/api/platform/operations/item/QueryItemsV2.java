...
public class QueryItemsV2 extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("itemType", this.itemType == null ? null : this.itemType.stream().map(i -> String.valueOf(i)).collect(java.util.stream.Collectors.toList()));
    ...
    public QueryItemsV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
