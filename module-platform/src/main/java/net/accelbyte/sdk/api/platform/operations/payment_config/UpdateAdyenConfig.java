...
import net.accelbyte.sdk.api.platform.operation_responses.payment_config.UpdateAdyenConfigOpResponse;
...
public class UpdateAdyenConfig extends Operation {
    ...
    */
    ...
    public UpdateAdyenConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateAdyenConfigOpResponse response = new UpdateAdyenConfigOpResponse();
