...
public class EnableUserWallet extends Operation {
  ...
  @Deprecated
  public EnableUserWallet(String customBasePath, String namespace, String userId, String walletId) {
  ...
  public EnableUserWalletOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final EnableUserWalletOpResponse response = new EnableUserWalletOpResponse();
