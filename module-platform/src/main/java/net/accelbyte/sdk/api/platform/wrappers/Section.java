...
public class Section {
     ...
     */
    public PurgeExpiredSectionOpResponse purgeExpiredSection(PurgeExpiredSection input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public PublicListActiveSectionsOpResponse publicListActiveSections(PublicListActiveSections input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
