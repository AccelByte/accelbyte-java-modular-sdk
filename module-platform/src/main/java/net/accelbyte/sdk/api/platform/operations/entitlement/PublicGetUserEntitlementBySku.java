...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.PublicGetUserEntitlementBySkuOpResponse;
...
public class PublicGetUserEntitlementBySku extends Operation {
    ...
    */
    ...
    public PublicGetUserEntitlementBySkuOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetUserEntitlementBySkuOpResponse response = new PublicGetUserEntitlementBySkuOpResponse();
