...
public class ProcessUserSubscriptionNotification extends Operation {
  ...
  public ProcessUserSubscriptionNotificationOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final ProcessUserSubscriptionNotificationOpResponse response =
        new ProcessUserSubscriptionNotificationOpResponse();
