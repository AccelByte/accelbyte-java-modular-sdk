...
public class PublicGetMyWallet extends Operation {
    ...
    */
    ...
    public PublicGetMyWalletOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetMyWalletOpResponse response = new PublicGetMyWalletOpResponse();
