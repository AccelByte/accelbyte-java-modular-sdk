...
public class QuerySubscriptions extends Operation {
    ...
    */
    ...
    public QuerySubscriptionsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QuerySubscriptionsOpResponse response = new QuerySubscriptionsOpResponse();
