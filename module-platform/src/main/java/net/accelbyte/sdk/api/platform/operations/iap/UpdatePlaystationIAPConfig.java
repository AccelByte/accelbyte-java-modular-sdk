...
import net.accelbyte.sdk.api.platform.operation_responses.iap.UpdatePlaystationIAPConfigOpResponse;
...
public class UpdatePlaystationIAPConfig extends Operation {
    ...
    */
    ...
    public UpdatePlaystationIAPConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdatePlaystationIAPConfigOpResponse response = new UpdatePlaystationIAPConfigOpResponse();
