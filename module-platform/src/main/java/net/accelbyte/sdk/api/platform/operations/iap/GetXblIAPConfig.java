...
import net.accelbyte.sdk.api.platform.operation_responses.iap.GetXblIAPConfigOpResponse;
...
public class GetXblIAPConfig extends Operation {
  ...
  @Deprecated
  public GetXblIAPConfig(String customBasePath, String namespace) {
  ...
  public GetXblIAPConfigOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetXblIAPConfigOpResponse response = new GetXblIAPConfigOpResponse();
