...
public class QueryIAPClawbackHistory extends Operation {
    ...
    */
    ...
    public QueryIAPClawbackHistoryOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryIAPClawbackHistoryOpResponse response = new QueryIAPClawbackHistoryOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new IAPClawbackPagingSlicedResult().createFromJson(json));
            response.setSuccess(true);
        }
