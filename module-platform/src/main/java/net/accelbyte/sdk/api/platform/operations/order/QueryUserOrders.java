...
public class QueryUserOrders extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("discounted", this.discounted == null ? null : Arrays.asList(String.valueOf(this.discounted)));
    ...
    public QueryUserOrdersOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryUserOrdersOpResponse response = new QueryUserOrdersOpResponse();
