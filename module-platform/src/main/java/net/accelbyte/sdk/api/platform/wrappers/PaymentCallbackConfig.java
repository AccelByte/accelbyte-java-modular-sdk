...
public class PaymentCallbackConfig {
     ...
     */
    public GetPaymentCallbackConfigOpResponse getPaymentCallbackConfig(GetPaymentCallbackConfig input) throws Exception {
     ...
     */
    public UpdatePaymentCallbackConfigOpResponse updatePaymentCallbackConfig(UpdatePaymentCallbackConfig input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
