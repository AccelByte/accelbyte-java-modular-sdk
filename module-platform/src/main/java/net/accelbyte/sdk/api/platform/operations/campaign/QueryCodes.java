...
public class QueryCodes extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("withBatchName", this.withBatchName == null ? null : Arrays.asList(String.valueOf(this.withBatchName)));
        return queryParams;
    }
    ...
    public QueryCodesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
