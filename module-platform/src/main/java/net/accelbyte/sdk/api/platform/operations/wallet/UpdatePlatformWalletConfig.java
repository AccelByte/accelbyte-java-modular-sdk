...
public class UpdatePlatformWalletConfig extends Operation {
  ...
  public UpdatePlatformWalletConfig(
      String customBasePath, String namespace, String platform, PlatformWalletConfigUpdate body) {
  ...
  public UpdatePlatformWalletConfigOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdatePlatformWalletConfigOpResponse response =
        new UpdatePlatformWalletConfigOpResponse();
