...
public class PublicListUserWalletTransactions extends Operation {
  ...
  public PublicListUserWalletTransactionsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicListUserWalletTransactionsOpResponse response =
        new PublicListUserWalletTransactionsOpResponse();
