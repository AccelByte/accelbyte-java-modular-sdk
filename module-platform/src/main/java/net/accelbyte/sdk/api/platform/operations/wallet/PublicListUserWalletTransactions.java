...
public class PublicListUserWalletTransactions extends Operation {
    ...
    */
    ...
    public PublicListUserWalletTransactionsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicListUserWalletTransactionsOpResponse response = new PublicListUserWalletTransactionsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new WalletTransactionPagingSlicedResult().createFromJson(json));
            response.setSuccess(true);
        }
