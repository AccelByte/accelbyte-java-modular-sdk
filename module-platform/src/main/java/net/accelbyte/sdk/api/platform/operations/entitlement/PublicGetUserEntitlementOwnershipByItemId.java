...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.PublicGetUserEntitlementOwnershipByItemIdOpResponse;
...
public class PublicGetUserEntitlementOwnershipByItemId extends Operation {
    ...
    */
    ...
    public PublicGetUserEntitlementOwnershipByItemIdOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetUserEntitlementOwnershipByItemIdOpResponse response = new PublicGetUserEntitlementOwnershipByItemIdOpResponse();
