...
public class RevokeFulfillmentV2Result extends Model {
    ...
    @JsonIgnore
    public List<RevokeFulfillmentV2Result> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<RevokeFulfillmentV2Result>>() {});
    }
