...
public class RefundOrder extends Operation {
  ...
  @Deprecated
  public RefundOrder(
      String customBasePath, String namespace, String orderNo, OrderRefundCreate body) {
  ...
  public RefundOrderOpResponse parseResponse(int code, String contentType, InputStream payload)
