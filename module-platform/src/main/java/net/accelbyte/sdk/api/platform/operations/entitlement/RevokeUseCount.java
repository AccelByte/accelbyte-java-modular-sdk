...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.RevokeUseCountOpResponse;
...
public class RevokeUseCount extends Operation {
    ...
    */
    ...
    public RevokeUseCountOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RevokeUseCountOpResponse response = new RevokeUseCountOpResponse();
