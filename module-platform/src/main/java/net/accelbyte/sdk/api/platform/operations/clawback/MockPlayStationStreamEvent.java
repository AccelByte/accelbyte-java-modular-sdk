...
public class MockPlayStationStreamEvent extends Operation {
  ...
  @Deprecated
  public MockPlayStationStreamEvent(String customBasePath, String namespace, StreamEvent body) {
  ...
  public MockPlayStationStreamEventOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final MockPlayStationStreamEventOpResponse response =
        new MockPlayStationStreamEventOpResponse();
