...
public class PublicGetEstimatedPrice extends Operation {
    ...
    */
    ...
    public PublicGetEstimatedPriceOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetEstimatedPriceOpResponse response = new PublicGetEstimatedPriceOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<EstimatedPriceInfo>>() {}));
        }
        else if (code == 404) {
            final String json = Helper.convertInputStreamToString(payload);
