...
public class UpdatePlatformEntitlementConfig extends Operation {
    ...
    */
    ...
    public UpdatePlatformEntitlementConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdatePlatformEntitlementConfigOpResponse response = new UpdatePlatformEntitlementConfigOpResponse();
