...
import net.accelbyte.sdk.api.platform.operation_responses.iap.SyncOculusSubscriptionsOpResponse;
...
public class SyncOculusSubscriptions extends Operation {
  ...
  public SyncOculusSubscriptionsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final SyncOculusSubscriptionsOpResponse response = new SyncOculusSubscriptionsOpResponse();
