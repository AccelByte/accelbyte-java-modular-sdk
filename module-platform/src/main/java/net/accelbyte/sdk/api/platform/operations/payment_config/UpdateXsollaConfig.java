...
import net.accelbyte.sdk.api.platform.operation_responses.payment_config.UpdateXsollaConfigOpResponse;
...
public class UpdateXsollaConfig extends Operation {
  ...
  @Deprecated
  public UpdateXsollaConfig(String customBasePath, String id, Boolean validate, XsollaConfig body) {
    this.id = id;
  ...
  public UpdateXsollaConfigOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdateXsollaConfigOpResponse response = new UpdateXsollaConfigOpResponse();
