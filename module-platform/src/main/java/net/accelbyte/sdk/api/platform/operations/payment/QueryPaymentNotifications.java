...
public class QueryPaymentNotifications extends Operation {
    ...
    */
    ...
    public QueryPaymentNotificationsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryPaymentNotificationsOpResponse response = new QueryPaymentNotificationsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new PaymentNotificationPagingSlicedResult().createFromJson(json));
            response.setSuccess(true);
        }
