...
public class CreateStore extends Operation {
  ...
  @Deprecated
  public CreateStore(String customBasePath, String namespace, StoreCreate body) {
  ...
  public CreateStoreOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final CreateStoreOpResponse response = new CreateStoreOpResponse();
