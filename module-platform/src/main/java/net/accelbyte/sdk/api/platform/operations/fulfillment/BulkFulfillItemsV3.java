...
import net.accelbyte.sdk.api.platform.operation_responses.fulfillment.BulkFulfillItemsV3OpResponse;
...
public class BulkFulfillItemsV3 extends Operation {
  ...
  public BulkFulfillItemsV3(
      String customBasePath, String namespace, String userId, List<FulfillmentV3Request> body) {
  ...
  public BulkFulfillItemsV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final BulkFulfillItemsV3OpResponse response = new BulkFulfillItemsV3OpResponse();
    ...
    if (code == 204) {
      ...
      response.setSuccess(true);
      response.setData(
          new ObjectMapper().readValue(json, new TypeReference<List<FulfillmentV2Result>>() {}));
    }
  ...
  /*
  public List<FulfillmentV2Result> parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
