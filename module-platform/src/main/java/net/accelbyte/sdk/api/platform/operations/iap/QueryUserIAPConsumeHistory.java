...
import net.accelbyte.sdk.api.platform.operation_responses.iap.QueryUserIAPConsumeHistoryOpResponse;
...
public class QueryUserIAPConsumeHistory extends Operation {
    ...
    */
    ...
    public QueryUserIAPConsumeHistoryOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryUserIAPConsumeHistoryOpResponse response = new QueryUserIAPConsumeHistoryOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new IAPConsumeHistoryPagingSlicedResult().createFromJson(json));
            response.setSuccess(true);
        }
