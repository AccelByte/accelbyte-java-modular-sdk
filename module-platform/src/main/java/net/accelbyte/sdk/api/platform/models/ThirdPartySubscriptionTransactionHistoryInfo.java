...
public class ThirdPartySubscriptionTransactionHistoryInfo extends Model {
    ...
    @JsonIgnore
    public ThirdPartySubscriptionTransactionHistoryInfo createFromJson(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, this.getClass());
    }

    @JsonIgnore
    public List<ThirdPartySubscriptionTransactionHistoryInfo> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ThirdPartySubscriptionTransactionHistoryInfo>>() {});
    }
