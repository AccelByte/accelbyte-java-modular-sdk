...
public class FulfillmentActionHistory extends Model {
    ...
    @JsonIgnore
    public List<FulfillmentActionHistory> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<FulfillmentActionHistory>>() {});
    }
