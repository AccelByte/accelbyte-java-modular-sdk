...
public class PublicGetItemDynamicData extends Operation {
    ...
    */
    ...
    public PublicGetItemDynamicDataOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetItemDynamicDataOpResponse response = new PublicGetItemDynamicDataOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ItemDynamicDataInfo().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 404) {
            final String json = Helper.convertInputStreamToString(payload);
