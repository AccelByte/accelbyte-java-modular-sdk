...
public class CountOfPurchasedItem extends Operation {
    ...
    */
    ...
    public CountOfPurchasedItemOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CountOfPurchasedItemOpResponse response = new CountOfPurchasedItemOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new PurchasedItemCount().createFromJson(json));
            response.setSuccess(true);
        }
    ...
    /*
    public PurchasedItemCount parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
