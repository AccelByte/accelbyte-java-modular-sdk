...
import net.accelbyte.sdk.api.platform.operation_responses.iap_notification.QueryThirdPartyNotificationsOpResponse;
...
public class QueryThirdPartyNotifications extends Operation {
    ...
    */
    ...
    public QueryThirdPartyNotificationsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryThirdPartyNotificationsOpResponse response = new QueryThirdPartyNotificationsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new NotificationPagingSlicedResult().createFromJson(json));
            response.setSuccess(true);
        }
    ...
    /*
    public NotificationPagingSlicedResult parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
