...
public class QueryThirdPartyNotifications extends Operation {
  ...
  public QueryThirdPartyNotificationsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final QueryThirdPartyNotificationsOpResponse response =
        new QueryThirdPartyNotificationsOpResponse();
