...
public class GetUserDLCByPlatform extends Operation {
  ...
  @Deprecated
  public GetUserDLCByPlatform(String customBasePath, String namespace, String userId, String type) {
  ...
  public GetUserDLCByPlatformOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetUserDLCByPlatformOpResponse response = new GetUserDLCByPlatformOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new UserDLC().createFromJson(json));
      response.setSuccess(true);
    }
  ...
  /*
  public UserDLC parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
