...
import net.accelbyte.sdk.api.platform.operation_responses.payment_config.TestPayPalConfigByIdOpResponse;
...
public class TestPayPalConfigById extends Operation {
    ...
    */
    ...
    public TestPayPalConfigByIdOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final TestPayPalConfigByIdOpResponse response = new TestPayPalConfigByIdOpResponse();
