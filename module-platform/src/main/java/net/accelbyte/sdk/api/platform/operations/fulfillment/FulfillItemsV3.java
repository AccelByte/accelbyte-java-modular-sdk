...
public class FulfillItemsV3 extends Operation {
  ...
  public FulfillItemsV3OpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final FulfillItemsV3OpResponse response = new FulfillItemsV3OpResponse();
