...
public class ValidateItemPurchaseCondition extends Operation {
  ...
  public ValidateItemPurchaseConditionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final ValidateItemPurchaseConditionOpResponse response =
        new ValidateItemPurchaseConditionOpResponse();
