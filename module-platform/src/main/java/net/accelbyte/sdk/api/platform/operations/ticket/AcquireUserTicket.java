...
import net.accelbyte.sdk.api.platform.operation_responses.ticket.AcquireUserTicketOpResponse;
...
public class AcquireUserTicket extends Operation {
    ...
    */
    ...
    public AcquireUserTicket(
            String customBasePath,            String boothName,
            String namespace,
            String userId,
    ...
    public AcquireUserTicketOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AcquireUserTicketOpResponse response = new AcquireUserTicketOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new TicketAcquireResult().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 404) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public TicketAcquireResult parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
