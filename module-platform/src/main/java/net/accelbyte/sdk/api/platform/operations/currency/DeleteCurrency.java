...
public class DeleteCurrency extends Operation {
  ...
  @Deprecated
  public DeleteCurrency(String customBasePath, String currencyCode, String namespace) {
  ...
  public DeleteCurrencyOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final DeleteCurrencyOpResponse response = new DeleteCurrencyOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new CurrencyInfo().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 404) {
      final String json = Helper.convertInputStreamToString(payload);
