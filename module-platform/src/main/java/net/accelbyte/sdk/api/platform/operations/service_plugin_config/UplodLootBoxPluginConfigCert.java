...
public class UplodLootBoxPluginConfigCert extends Operation {
     ...
     */
    private String path = "/platform/admin/namespaces/{namespace}/catalog/plugins/lootbox/customConfig/cert";
    ...
    */
    ...
    public UplodLootBoxPluginConfigCertOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UplodLootBoxPluginConfigCertOpResponse response = new UplodLootBoxPluginConfigCertOpResponse();
