...
import net.accelbyte.sdk.api.platform.operation_responses.session_platform.RegisterXblSessionsOpResponse;
...
public class RegisterXblSessions extends Operation {
    ...
    */
    ...
    public RegisterXblSessionsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RegisterXblSessionsOpResponse response = new RegisterXblSessionsOpResponse();
