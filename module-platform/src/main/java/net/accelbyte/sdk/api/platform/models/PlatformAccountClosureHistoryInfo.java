...
public class PlatformAccountClosureHistoryInfo extends Model {
    ...
    @JsonIgnore
    public PlatformAccountClosureHistoryInfo createFromJson(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, this.getClass());
    }

    @JsonIgnore
    public List<PlatformAccountClosureHistoryInfo> createFromJsonList(String json) throws JsonProcessingException {
    ...
    public static class PlatformAccountClosureHistoryInfoBuilder {
        ...
        public PlatformAccountClosureHistoryInfoBuilder progressionFromEnum(final Progression progression) {
            this.progression = progression.toString();
            return this;
        }
    }
