...
public class DownloadCSVTemplates extends Operation {
    ...
    */
    ...
    public DownloadCSVTemplatesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DownloadCSVTemplatesOpResponse response = new DownloadCSVTemplatesOpResponse();
