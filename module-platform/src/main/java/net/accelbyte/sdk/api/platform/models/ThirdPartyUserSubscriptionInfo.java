...
public class ThirdPartyUserSubscriptionInfo extends Model {
    ...
    @JsonIgnore
    public List<ThirdPartyUserSubscriptionInfo> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ThirdPartyUserSubscriptionInfo>>() {});
    }
