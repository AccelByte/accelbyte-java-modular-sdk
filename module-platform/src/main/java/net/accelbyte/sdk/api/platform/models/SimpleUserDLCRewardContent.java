...
public class SimpleUserDLCRewardContent extends Model {
    ...
    @JsonIgnore
    public List<SimpleUserDLCRewardContent> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<SimpleUserDLCRewardContent>>() {});
    }
