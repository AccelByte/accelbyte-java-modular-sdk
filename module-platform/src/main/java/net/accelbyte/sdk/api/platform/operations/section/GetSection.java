...
public class GetSection extends Operation {
  ...
  @Deprecated
  public GetSection(String customBasePath, String namespace, String sectionId, String storeId) {
  ...
  public GetSectionOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetSectionOpResponse response = new GetSectionOpResponse();
