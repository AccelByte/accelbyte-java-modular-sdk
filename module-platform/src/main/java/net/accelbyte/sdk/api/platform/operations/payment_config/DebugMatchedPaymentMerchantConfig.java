...
public class DebugMatchedPaymentMerchantConfig extends Operation {
    ...
    */
    ...
    public DebugMatchedPaymentMerchantConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DebugMatchedPaymentMerchantConfigOpResponse response = new DebugMatchedPaymentMerchantConfigOpResponse();
