...
public class UpdatePaymentDomainWhitelistConfig extends Operation {
  ...
  public UpdatePaymentDomainWhitelistConfig(
      String customBasePath, String namespace, PaymentDomainWhitelistConfigEdit body) {
  ...
  public UpdatePaymentDomainWhitelistConfigOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdatePaymentDomainWhitelistConfigOpResponse response =
        new UpdatePaymentDomainWhitelistConfigOpResponse();
