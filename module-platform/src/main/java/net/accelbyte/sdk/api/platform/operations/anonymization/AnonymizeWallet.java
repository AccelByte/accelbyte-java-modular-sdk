...
public class AnonymizeWallet extends Operation {
  ...
  @Deprecated
  public AnonymizeWallet(String customBasePath, String namespace, String userId) {
  ...
  public AnonymizeWalletOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final AnonymizeWalletOpResponse response = new AnonymizeWalletOpResponse();
