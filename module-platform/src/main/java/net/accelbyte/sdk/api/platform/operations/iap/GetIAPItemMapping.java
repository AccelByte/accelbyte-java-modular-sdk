...
import net.accelbyte.sdk.api.platform.operation_responses.iap.GetIAPItemMappingOpResponse;
...
public class GetIAPItemMapping extends Operation {
    ...
    */
    ...
    public GetIAPItemMappingOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetIAPItemMappingOpResponse response = new GetIAPItemMappingOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new IAPItemMappingInfo().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 404) {
            final String json = Helper.convertInputStreamToString(payload);
