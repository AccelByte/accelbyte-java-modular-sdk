...
public class UpdateItem extends Operation {
  ...
  @Deprecated
  public UpdateItem(
      String customBasePath, String itemId, String namespace, String storeId, ItemUpdate body) {
    this.itemId = itemId;
  ...
  public UpdateItemOpResponse parseResponse(int code, String contentType, InputStream payload)
