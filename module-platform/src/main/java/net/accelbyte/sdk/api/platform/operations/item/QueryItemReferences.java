...
import net.accelbyte.sdk.api.platform.operation_responses.item.QueryItemReferencesOpResponse;
...
public class QueryItemReferences extends Operation {
  ...
  public QueryItemReferencesOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final QueryItemReferencesOpResponse response = new QueryItemReferencesOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ItemDependency().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 404) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public ItemDependency parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
