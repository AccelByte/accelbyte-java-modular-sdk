...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.ExistsAnyUserActiveEntitlementOpResponse;
...
public class ExistsAnyUserActiveEntitlement extends Operation {
    ...
    */
    ...
    public ExistsAnyUserActiveEntitlementOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ExistsAnyUserActiveEntitlementOpResponse response = new ExistsAnyUserActiveEntitlementOpResponse();
