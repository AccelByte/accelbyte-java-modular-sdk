...
public class DLCConfigRewardShortInfo extends Model {
    ...
    @JsonIgnore
    public List<DLCConfigRewardShortInfo> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<DLCConfigRewardShortInfo>>() {});
    }
