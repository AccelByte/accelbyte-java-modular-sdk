...
@Getter
@Setter
public class AdminCreateUserOrderOpResponse extends ApiResponseWithData<OrderInfo> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.platform.operations.order.AdminCreateUserOrder";
  }
}
