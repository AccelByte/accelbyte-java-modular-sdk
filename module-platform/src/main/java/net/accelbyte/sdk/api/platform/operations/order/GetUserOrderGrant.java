...
public class GetUserOrderGrant extends Operation {
  ...
  @Deprecated
  public GetUserOrderGrant(String customBasePath, String namespace, String orderNo, String userId) {
  ...
  public GetUserOrderGrantOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetUserOrderGrantOpResponse response = new GetUserOrderGrantOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new OrderGrantInfo().createFromJson(json));
      response.setSuccess(true);
    }
  ...
  /*
  public OrderGrantInfo parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
