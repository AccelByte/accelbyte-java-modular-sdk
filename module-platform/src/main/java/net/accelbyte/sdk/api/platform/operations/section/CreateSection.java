...
public class CreateSection extends Operation {
  ...
  public CreateSection(
      String customBasePath, String namespace, String storeId, SectionCreate body) {
  ...
  public CreateSectionOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final CreateSectionOpResponse response = new CreateSectionOpResponse();
