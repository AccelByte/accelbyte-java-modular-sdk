...
public class EnableItem extends Operation {
  ...
  @Deprecated
  public EnableItem(String customBasePath, String itemId, String namespace, String storeId) {
    this.itemId = itemId;
  ...
  public EnableItemOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final EnableItemOpResponse response = new EnableItemOpResponse();
