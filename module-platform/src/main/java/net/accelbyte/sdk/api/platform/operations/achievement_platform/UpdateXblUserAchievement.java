...
public class UpdateXblUserAchievement extends Operation {
    ...
    */
    ...
    public UpdateXblUserAchievementOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateXblUserAchievementOpResponse response = new UpdateXblUserAchievementOpResponse();
