...
public class EntitlementPrechekResult extends Model {
    ...
    @JsonIgnore
    public List<EntitlementPrechekResult> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<EntitlementPrechekResult>>() {});
    }
