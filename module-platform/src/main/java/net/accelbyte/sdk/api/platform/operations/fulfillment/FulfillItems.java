...
public class FulfillItems extends Operation {
     ...
     */
    private String path = "/platform/v2/admin/namespaces/{namespace}/users/{userId}/fulfillments/{transactionId}";
    ...
    */
    ...
    public FulfillItemsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final FulfillItemsOpResponse response = new FulfillItemsOpResponse();
