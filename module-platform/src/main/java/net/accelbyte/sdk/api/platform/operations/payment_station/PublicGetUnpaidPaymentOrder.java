...
public class PublicGetUnpaidPaymentOrder extends Operation {
  ...
  public PublicGetUnpaidPaymentOrderOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGetUnpaidPaymentOrderOpResponse response =
        new PublicGetUnpaidPaymentOrderOpResponse();
