...
public class AnonymizeOrder extends Operation {
  ...
  @Deprecated
  public AnonymizeOrder(String customBasePath, String namespace, String userId) {
  ...
  public AnonymizeOrderOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final AnonymizeOrderOpResponse response = new AnonymizeOrderOpResponse();
