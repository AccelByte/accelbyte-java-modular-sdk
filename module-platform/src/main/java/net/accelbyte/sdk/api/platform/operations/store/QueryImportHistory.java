...
public class QueryImportHistory extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("success", this.success == null ? null : Arrays.asList(String.valueOf(this.success)));
        return queryParams;
    }
    ...
    public QueryImportHistoryOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryImportHistoryOpResponse response = new QueryImportHistoryOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ImportStoreHistoryPagingResult().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ImportStoreHistoryPagingResult parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
