...
import net.accelbyte.sdk.api.platform.operation_responses.payment_config.TestPayPalConfigOpResponse;
...
public class TestPayPalConfig extends Operation {
  ...
  @Deprecated
  public TestPayPalConfig(String customBasePath, Boolean sandbox, PayPalConfig body) {
  ...
  public TestPayPalConfigOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final TestPayPalConfigOpResponse response = new TestPayPalConfigOpResponse();
