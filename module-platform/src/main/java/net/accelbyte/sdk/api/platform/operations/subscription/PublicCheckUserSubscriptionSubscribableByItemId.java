...
public class PublicCheckUserSubscriptionSubscribableByItemId extends Operation {
    ...
    */
    ...
    public PublicCheckUserSubscriptionSubscribableByItemIdOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicCheckUserSubscriptionSubscribableByItemIdOpResponse response = new PublicCheckUserSubscriptionSubscribableByItemIdOpResponse();
