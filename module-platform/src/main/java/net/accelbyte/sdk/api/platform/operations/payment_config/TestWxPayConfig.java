...
import net.accelbyte.sdk.api.platform.operation_responses.payment_config.TestWxPayConfigOpResponse;
...
public class TestWxPayConfig extends Operation {
    ...
    */
    ...
    public TestWxPayConfig(
            String customBasePath,            WxPayConfigRequest body
    )
    {
        this.body = body;
    ...
    public TestWxPayConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final TestWxPayConfigOpResponse response = new TestWxPayConfigOpResponse();
