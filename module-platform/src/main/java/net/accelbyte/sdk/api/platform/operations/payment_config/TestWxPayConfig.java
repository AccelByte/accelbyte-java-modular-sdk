...
public class TestWxPayConfig extends Operation {
  ...
  @Deprecated
  public TestWxPayConfig(String customBasePath, WxPayConfigRequest body) {
    this.body = body;
  ...
  public TestWxPayConfigOpResponse parseResponse(int code, String contentType, InputStream payload)
