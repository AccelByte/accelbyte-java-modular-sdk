...
import net.accelbyte.sdk.api.platform.operation_responses.service_plugin_config.UploadRevocationPluginConfigCertV2OpResponse;
...
public class UploadRevocationPluginConfigCertV2 extends Operation {
  ...
  @Deprecated
  public UploadRevocationPluginConfigCertV2(String customBasePath, String namespace, File file) {
  ...
  public UploadRevocationPluginConfigCertV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UploadRevocationPluginConfigCertV2OpResponse response =
        new UploadRevocationPluginConfigCertV2OpResponse();
