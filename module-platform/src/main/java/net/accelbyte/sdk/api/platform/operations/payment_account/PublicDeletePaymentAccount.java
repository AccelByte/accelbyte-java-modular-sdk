...
public class PublicDeletePaymentAccount extends Operation {
    ...
    */
    ...
    public PublicDeletePaymentAccountOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicDeletePaymentAccountOpResponse response = new PublicDeletePaymentAccountOpResponse();
