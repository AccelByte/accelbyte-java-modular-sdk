...
public class CreateItem extends Operation {
  ...
  @Deprecated
  public CreateItem(String customBasePath, String namespace, String storeId, ItemCreate body) {
  ...
  public CreateItemOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final CreateItemOpResponse response = new CreateItemOpResponse();
