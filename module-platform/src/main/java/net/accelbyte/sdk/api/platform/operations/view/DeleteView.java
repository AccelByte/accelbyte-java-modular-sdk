...
public class DeleteView extends Operation {
  ...
  @Deprecated
  public DeleteView(String customBasePath, String namespace, String viewId, String storeId) {
  ...
  public DeleteViewOpResponse parseResponse(int code, String contentType, InputStream payload)
