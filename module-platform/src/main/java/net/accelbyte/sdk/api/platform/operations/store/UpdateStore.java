...
public class UpdateStore extends Operation {
  ...
  @Deprecated
  public UpdateStore(String customBasePath, String namespace, String storeId, StoreUpdate body) {
  ...
  public UpdateStoreOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final UpdateStoreOpResponse response = new UpdateStoreOpResponse();
