...
public class GetUserWallet extends Operation {
  ...
  @Deprecated
  public GetUserWallet(String customBasePath, String namespace, String userId, String walletId) {
  ...
  public GetUserWalletOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetUserWalletOpResponse response = new GetUserWalletOpResponse();
