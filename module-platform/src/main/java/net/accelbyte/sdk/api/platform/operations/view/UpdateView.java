...
import net.accelbyte.sdk.api.platform.operation_responses.view.UpdateViewOpResponse;
...
public class UpdateView extends Operation {
  ...
  @Deprecated
  public UpdateView(
      String customBasePath, String namespace, String viewId, String storeId, ViewUpdate body) {
  ...
  public UpdateViewOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final UpdateViewOpResponse response = new UpdateViewOpResponse();
