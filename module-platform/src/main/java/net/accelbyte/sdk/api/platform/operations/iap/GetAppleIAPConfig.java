...
import net.accelbyte.sdk.api.platform.operation_responses.iap.GetAppleIAPConfigOpResponse;
...
public class GetAppleIAPConfig extends Operation {
    ...
    */
    ...
    public GetAppleIAPConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetAppleIAPConfigOpResponse response = new GetAppleIAPConfigOpResponse();
