...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.PublicConsumeUserEntitlementOpResponse;
...
public class PublicConsumeUserEntitlement extends Operation {
    ...
    */
    ...
    public PublicConsumeUserEntitlementOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicConsumeUserEntitlementOpResponse response = new PublicConsumeUserEntitlementOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new EntitlementDecrementResult().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
