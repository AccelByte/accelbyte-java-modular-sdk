...
public class PublicConsumeUserEntitlement extends Operation {
  ...
  public PublicConsumeUserEntitlementOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicConsumeUserEntitlementOpResponse response =
        new PublicConsumeUserEntitlementOpResponse();
