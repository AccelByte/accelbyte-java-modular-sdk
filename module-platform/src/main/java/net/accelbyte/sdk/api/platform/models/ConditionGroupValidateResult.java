...
public class ConditionGroupValidateResult extends Model {
    ...
    @JsonIgnore
    public List<ConditionGroupValidateResult> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ConditionGroupValidateResult>>() {});
    }
