...
public class GetPaymentOrder extends Operation {
  ...
  @Deprecated
  public GetPaymentOrder(String customBasePath, String namespace, String paymentOrderNo) {
  ...
  public GetPaymentOrderOpResponse parseResponse(int code, String contentType, InputStream payload)
