...
public class RollbackPublishedStore extends Operation {
    ...
    */
    ...
    public RollbackPublishedStoreOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RollbackPublishedStoreOpResponse response = new RollbackPublishedStoreOpResponse();
