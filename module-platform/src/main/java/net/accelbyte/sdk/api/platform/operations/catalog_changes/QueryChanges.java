...
public class QueryChanges extends Operation {
    ...
    */
    ...
    public QueryChangesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryChangesOpResponse response = new QueryChangesOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new CatalogChangePagingResult().createFromJson(json));
            response.setSuccess(true);
        }
    ...
    /*
    public CatalogChangePagingResult parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
