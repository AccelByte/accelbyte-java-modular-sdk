...
public class RefundUserPaymentOrder extends Operation {
    ...
    */
    ...
    public RefundUserPaymentOrderOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RefundUserPaymentOrderOpResponse response = new RefundUserPaymentOrderOpResponse();
