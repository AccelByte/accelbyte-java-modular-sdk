...
import net.accelbyte.sdk.api.platform.operation_responses.payment_config.TestAdyenConfigOpResponse;
...
public class TestAdyenConfig extends Operation {
    ...
    */
    ...
    public TestAdyenConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final TestAdyenConfigOpResponse response = new TestAdyenConfigOpResponse();
