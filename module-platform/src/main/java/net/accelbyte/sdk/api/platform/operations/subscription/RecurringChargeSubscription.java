...
public class RecurringChargeSubscription extends Operation {
    ...
    */
    ...
    public RecurringChargeSubscriptionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RecurringChargeSubscriptionOpResponse response = new RecurringChargeSubscriptionOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new RecurringChargeResult().createFromJson(json));
            response.setSuccess(true);
        }
