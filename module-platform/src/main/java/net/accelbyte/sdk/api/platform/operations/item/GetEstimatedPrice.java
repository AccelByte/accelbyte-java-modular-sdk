...
public class GetEstimatedPrice extends Operation {
    ...
    */
    ...
    public GetEstimatedPriceOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetEstimatedPriceOpResponse response = new GetEstimatedPriceOpResponse();
