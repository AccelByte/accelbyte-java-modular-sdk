...
import net.accelbyte.sdk.api.platform.operation_responses.key_group.GetKeyGroupOpResponse;
...
public class GetKeyGroup extends Operation {
    ...
    */
    ...
    public GetKeyGroupOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetKeyGroupOpResponse response = new GetKeyGroupOpResponse();
