...
public class FeatureItem extends Operation {
    ...
    */
    ...
    public FeatureItemOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final FeatureItemOpResponse response = new FeatureItemOpResponse();
