...
public class GetPaymentOrderChargeStatus extends Operation {
    ...
    */
    ...
    public GetPaymentOrderChargeStatusOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetPaymentOrderChargeStatusOpResponse response = new GetPaymentOrderChargeStatusOpResponse();
