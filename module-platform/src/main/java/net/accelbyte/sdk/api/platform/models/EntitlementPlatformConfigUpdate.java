...
public class EntitlementPlatformConfigUpdate extends Model {
    ...
    @JsonIgnore
    public void setAllowedPlatformOriginsFromEnum(final List<AllowedPlatformOrigins> allowedPlatformOrigins) {
    ...
    @JsonIgnore
    public EntitlementPlatformConfigUpdate createFromJson(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, this.getClass());
    }

    @JsonIgnore
    public List<EntitlementPlatformConfigUpdate> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<EntitlementPlatformConfigUpdate>>() {});
    }
    ...
    public static class EntitlementPlatformConfigUpdateBuilder {
        ...
        public EntitlementPlatformConfigUpdateBuilder allowedPlatformOrigins(final List<String> allowedPlatformOrigins) {
            this.allowedPlatformOrigins = allowedPlatformOrigins;
            return this;
        }

        public EntitlementPlatformConfigUpdateBuilder allowedPlatformOriginsFromEnum(final List<AllowedPlatformOrigins> allowedPlatformOrigins) {
            ArrayList<String> en = new ArrayList<String>();
            for(AllowedPlatformOrigins e : allowedPlatformOrigins) en.add(e.toString());
            this.allowedPlatformOrigins = en;
            return this;
