...
public class PublicNormalizePaymentReturnUrl extends Operation {
  ...
  public PublicNormalizePaymentReturnUrlOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicNormalizePaymentReturnUrlOpResponse response =
        new PublicNormalizePaymentReturnUrlOpResponse();
