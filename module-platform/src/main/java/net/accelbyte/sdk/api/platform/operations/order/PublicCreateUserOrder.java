...
public class PublicCreateUserOrder extends Operation {
    ...
    */
    ...
    public PublicCreateUserOrderOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicCreateUserOrderOpResponse response = new PublicCreateUserOrderOpResponse();
