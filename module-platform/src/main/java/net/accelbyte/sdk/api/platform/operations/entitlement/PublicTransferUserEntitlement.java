...
public class PublicTransferUserEntitlement extends Operation {
  ...
  public PublicTransferUserEntitlementOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicTransferUserEntitlementOpResponse response =
        new PublicTransferUserEntitlementOpResponse();
