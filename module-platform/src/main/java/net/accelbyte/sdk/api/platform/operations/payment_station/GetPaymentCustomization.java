...
import net.accelbyte.sdk.api.platform.operation_responses.payment_station.GetPaymentCustomizationOpResponse;
...
public class GetPaymentCustomization extends Operation {
    ...
    */
    ...
    public GetPaymentCustomizationOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetPaymentCustomizationOpResponse response = new GetPaymentCustomizationOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new Customization().createFromJson(json));
            response.setSuccess(true);
        }
    ...
    /*
    public Customization parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
