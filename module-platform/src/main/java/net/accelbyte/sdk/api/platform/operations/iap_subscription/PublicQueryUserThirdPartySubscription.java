...
public class PublicQueryUserThirdPartySubscription extends Operation {
  ...
  public PublicQueryUserThirdPartySubscriptionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicQueryUserThirdPartySubscriptionOpResponse response =
        new PublicQueryUserThirdPartySubscriptionOpResponse();
