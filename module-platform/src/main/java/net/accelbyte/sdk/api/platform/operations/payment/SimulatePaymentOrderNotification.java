...
public class SimulatePaymentOrderNotification extends Operation {
    ...
    */
    ...
    public SimulatePaymentOrderNotificationOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SimulatePaymentOrderNotificationOpResponse response = new SimulatePaymentOrderNotificationOpResponse();
