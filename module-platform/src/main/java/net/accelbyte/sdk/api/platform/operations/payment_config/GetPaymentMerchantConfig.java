...
import net.accelbyte.sdk.api.platform.operation_responses.payment_config.GetPaymentMerchantConfigOpResponse;
...
public class GetPaymentMerchantConfig extends Operation {
    ...
    */
    ...
    public GetPaymentMerchantConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetPaymentMerchantConfigOpResponse response = new GetPaymentMerchantConfigOpResponse();
