...
public class UnlockSteamUserAchievement extends Operation {
    ...
    */
    ...
    public UnlockSteamUserAchievementOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UnlockSteamUserAchievementOpResponse response = new UnlockSteamUserAchievementOpResponse();
