...
public class GetPublishedStore extends Operation {
    ...
    */
    ...
    public GetPublishedStoreOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetPublishedStoreOpResponse response = new GetPublishedStoreOpResponse();
