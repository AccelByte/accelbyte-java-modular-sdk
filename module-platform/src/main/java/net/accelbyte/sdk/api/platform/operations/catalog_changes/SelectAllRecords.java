...
public class SelectAllRecords extends Operation {
  ...
  @Deprecated
  public SelectAllRecords(String customBasePath, String namespace, String storeId) {
  ...
  public SelectAllRecordsOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final SelectAllRecordsOpResponse response = new SelectAllRecordsOpResponse();
