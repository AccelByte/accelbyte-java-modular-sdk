...
public class PublicGetPaymentAccounts extends Operation {
  ...
  @Deprecated
  public PublicGetPaymentAccounts(String customBasePath, String namespace, String userId) {
  ...
  public PublicGetPaymentAccountsOpResponse parseResponse(
    ...
    if (code == 204) {
      ...
      response.setSuccess(true);
      response.setData(
          new ObjectMapper().readValue(json, new TypeReference<List<PaymentAccount>>() {}));
    }
