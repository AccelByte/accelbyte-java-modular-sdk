...
public class ListBasicItemsByFeatures extends Operation {
    ...
    */
    ...
    public ListBasicItemsByFeaturesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ListBasicItemsByFeaturesOpResponse response = new ListBasicItemsByFeaturesOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<BasicItem>>() {}));
        }
