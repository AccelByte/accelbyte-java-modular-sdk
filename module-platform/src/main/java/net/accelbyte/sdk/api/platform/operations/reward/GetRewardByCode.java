...
import net.accelbyte.sdk.api.platform.operation_responses.reward.GetRewardByCodeOpResponse;
...
public class GetRewardByCode extends Operation {
  ...
  @Deprecated
  public GetRewardByCode(String customBasePath, String namespace, String rewardCode) {
  ...
  public GetRewardByCodeOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetRewardByCodeOpResponse response = new GetRewardByCodeOpResponse();
