...
public class PublicDownloadUserOrderReceipt extends Operation {
    ...
    */
    ...
    public PublicDownloadUserOrderReceiptOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicDownloadUserOrderReceiptOpResponse response = new PublicDownloadUserOrderReceiptOpResponse();
