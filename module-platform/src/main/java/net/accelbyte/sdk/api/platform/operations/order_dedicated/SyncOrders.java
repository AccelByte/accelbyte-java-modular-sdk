...
public class SyncOrders extends Operation {
    ...
    */
    ...
    @Deprecated
    public SyncOrders(
            String customBasePath,            String nextEvaluatedKey,
            String end,
            String start
    )
    {
    ...
    public SyncOrdersOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
