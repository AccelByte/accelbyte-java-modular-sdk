...
import net.accelbyte.sdk.api.platform.operation_responses.order_dedicated.SyncOrdersOpResponse;
...
public class SyncOrders extends Operation {
  ...
  @Deprecated
  public SyncOrders(String customBasePath, String nextEvaluatedKey, String end, String start) {
  ...
  public SyncOrdersOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final SyncOrdersOpResponse response = new SyncOrdersOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new OrderSyncResult().createFromJson(json));
      response.setSuccess(true);
    }
