...
public class PaymentAccount {
   ...
   */
  public PublicGetPaymentAccountsOpResponse publicGetPaymentAccounts(PublicGetPaymentAccounts input)
      throws Exception {
   ...
   */
  public PublicDeletePaymentAccountOpResponse publicDeletePaymentAccount(
      PublicDeletePaymentAccount input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
