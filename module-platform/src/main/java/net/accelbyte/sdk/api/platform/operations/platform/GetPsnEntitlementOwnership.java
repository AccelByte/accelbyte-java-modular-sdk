...
import net.accelbyte.sdk.api.platform.operation_responses.platform.GetPsnEntitlementOwnershipOpResponse;
...
public class GetPsnEntitlementOwnership extends Operation {
     ...
     */
    private String path = "/platform/admin/namespaces/{namespace}/platforms/psn/entitlements/{entitlementLabel}/ownership";
    ...
    */
    ...
    public GetPsnEntitlementOwnership(
            String customBasePath,            String entitlementLabel,
            String namespace,
    ...
    public GetPsnEntitlementOwnershipOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetPsnEntitlementOwnershipOpResponse response = new GetPsnEntitlementOwnershipOpResponse();
