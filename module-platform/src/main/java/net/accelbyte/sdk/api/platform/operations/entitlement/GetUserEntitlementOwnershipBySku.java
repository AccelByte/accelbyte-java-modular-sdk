...
import net.accelbyte.sdk.api.platform.operation_responses.entitlement.GetUserEntitlementOwnershipBySkuOpResponse;
...
public class GetUserEntitlementOwnershipBySku extends Operation {
    ...
    */
    ...
    public GetUserEntitlementOwnershipBySkuOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserEntitlementOwnershipBySkuOpResponse response = new GetUserEntitlementOwnershipBySkuOpResponse();
