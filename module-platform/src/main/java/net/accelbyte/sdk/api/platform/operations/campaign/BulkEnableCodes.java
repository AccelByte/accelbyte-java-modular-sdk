...
import net.accelbyte.sdk.api.platform.operation_responses.campaign.BulkEnableCodesOpResponse;
...
public class BulkEnableCodes extends Operation {
    ...
    */
    ...
    public BulkEnableCodes(
            String customBasePath,            String campaignId,
            String namespace,
            String batchName,
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("batchNo", this.batchNo == null ? null : this.batchNo.stream().map(i -> String.valueOf(i)).collect(java.util.stream.Collectors.toList()));
        return queryParams;
    }
    ...
    public BulkEnableCodesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final BulkEnableCodesOpResponse response = new BulkEnableCodesOpResponse();
