...
public class Ticket {
   ...
   */
  public DecreaseTicketSaleOpResponse decreaseTicketSale(DecreaseTicketSale input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public IncreaseTicketSaleOpResponse increaseTicketSale(IncreaseTicketSale input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
