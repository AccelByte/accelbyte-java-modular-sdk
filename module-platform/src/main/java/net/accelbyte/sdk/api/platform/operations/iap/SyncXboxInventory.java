...
public class SyncXboxInventory extends Operation {
  ...
  public SyncXboxInventory(
      String customBasePath, String namespace, String userId, XblReconcileRequest body) {
  ...
  public SyncXboxInventoryOpResponse parseResponse(
    ...
    if (code == 204) {
      ...
      response.setSuccess(true);
      response.setData(
          new ObjectMapper().readValue(json, new TypeReference<List<XblReconcileResult>>() {}));
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
