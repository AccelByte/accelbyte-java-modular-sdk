...
import net.accelbyte.sdk.api.platform.operation_responses.iap.SyncXboxInventoryOpResponse;
...
public class SyncXboxInventory extends Operation {
    ...
    */
    ...
    public SyncXboxInventoryOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SyncXboxInventoryOpResponse response = new SyncXboxInventoryOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<XblReconcileResult>>() {}));
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
