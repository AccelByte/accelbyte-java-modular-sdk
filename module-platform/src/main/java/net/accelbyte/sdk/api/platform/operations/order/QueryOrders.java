...
public class QueryOrders extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("orderNos", this.orderNos == null ? null : this.orderNos.stream().map(i -> String.valueOf(i)).collect(java.util.stream.Collectors.toList()));
    ...
    public QueryOrdersOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryOrdersOpResponse response = new QueryOrdersOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new OrderPagingResult().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 422) {
            final String json = Helper.convertInputStreamToString(payload);
