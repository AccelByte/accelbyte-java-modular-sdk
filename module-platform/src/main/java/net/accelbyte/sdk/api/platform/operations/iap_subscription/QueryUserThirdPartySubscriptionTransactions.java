...
public class QueryUserThirdPartySubscriptionTransactions extends Operation {
     ...
     */
    private String path = "/platform/admin/namespaces/{namespace}/users/{userId}/iap/subscriptions/transactions";
    ...
    */
    ...
    public QueryUserThirdPartySubscriptionTransactionsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryUserThirdPartySubscriptionTransactionsOpResponse response = new QueryUserThirdPartySubscriptionTransactionsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ThirdPartySubscriptionTransactionPagingSlicedResult().createFromJson(json));
            response.setSuccess(true);
        }
    ...
    */
    ...
    public static class QueryUserThirdPartySubscriptionTransactionsBuilder {
        ...
        public QueryUserThirdPartySubscriptionTransactionsBuilder platformFromEnum(final Platform platform) {
