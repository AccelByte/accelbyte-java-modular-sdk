...
public class UploadRevocationPluginConfigCert extends Operation {
  ...
  @Deprecated
  public UploadRevocationPluginConfigCert(String customBasePath, String namespace, File file) {
  ...
  public UploadRevocationPluginConfigCertOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UploadRevocationPluginConfigCertOpResponse response =
        new UploadRevocationPluginConfigCertOpResponse();
