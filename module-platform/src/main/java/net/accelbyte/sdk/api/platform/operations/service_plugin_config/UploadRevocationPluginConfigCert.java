...
import net.accelbyte.sdk.api.platform.operation_responses.service_plugin_config.UploadRevocationPluginConfigCertOpResponse;
...
public class UploadRevocationPluginConfigCert extends Operation {
     ...
     */
    private String path = "/platform/admin/namespaces/{namespace}/revocation/plugins/revocation/revocation/customConfig/cert";
    ...
    */
    ...
    public UploadRevocationPluginConfigCertOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UploadRevocationPluginConfigCertOpResponse response = new UploadRevocationPluginConfigCertOpResponse();
