...
public class PublicGetUserOrder extends Operation {
    ...
    */
    ...
    public PublicGetUserOrderOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetUserOrderOpResponse response = new PublicGetUserOrderOpResponse();
