...
public class Commit extends Operation {
  ...
  @Deprecated
  public Commit(String customBasePath, String namespace, TradeChainedActionCommitRequest body) {
  ...
  public CommitOpResponse parseResponse(int code, String contentType, InputStream payload)
