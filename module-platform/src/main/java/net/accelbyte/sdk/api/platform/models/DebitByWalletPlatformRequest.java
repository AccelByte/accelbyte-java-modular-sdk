...
public class DebitByWalletPlatformRequest extends Model {
    ...
    @JsonIgnore
    public List<DebitByWalletPlatformRequest> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<DebitByWalletPlatformRequest>>() {});
    }
    ...
    public static class DebitByWalletPlatformRequestBuilder {
        ...
        public DebitByWalletPlatformRequestBuilder debitBalanceSourceFromEnum(final DebitBalanceSource debitBalanceSource) {
            this.debitBalanceSource = debitBalanceSource.toString();
            return this;
        }
        ...
        public DebitByWalletPlatformRequestBuilder walletPlatformFromEnum(final WalletPlatform walletPlatform) {
            this.walletPlatform = walletPlatform.toString();
            return this;
        }
    }
