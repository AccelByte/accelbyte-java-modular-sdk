...
@Getter
@Setter
public class GetUserRankingAdminV1OpResponse extends ApiResponseWithData<ModelsUserRankingResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.GetUserRankingAdminV1";
    }
}