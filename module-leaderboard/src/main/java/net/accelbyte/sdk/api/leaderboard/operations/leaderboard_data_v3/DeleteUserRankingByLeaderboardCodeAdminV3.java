...
import net.accelbyte.sdk.api.leaderboard.operation_responses.leaderboard_data_v3.DeleteUserRankingByLeaderboardCodeAdminV3OpResponse;
...
public class DeleteUserRankingByLeaderboardCodeAdminV3 extends Operation {
     ...
     */
    private String path = "/leaderboard/v3/admin/namespaces/{namespace}/leaderboards/{leaderboardCode}/reset";
    ...
    */
    ...
    public DeleteUserRankingByLeaderboardCodeAdminV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteUserRankingByLeaderboardCodeAdminV3OpResponse response = new DeleteUserRankingByLeaderboardCodeAdminV3OpResponse();
