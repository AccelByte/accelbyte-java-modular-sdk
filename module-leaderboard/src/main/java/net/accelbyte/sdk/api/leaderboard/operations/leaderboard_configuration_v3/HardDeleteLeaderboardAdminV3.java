...
public class HardDeleteLeaderboardAdminV3 extends Operation {
  ...
  public HardDeleteLeaderboardAdminV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final HardDeleteLeaderboardAdminV3OpResponse response =
        new HardDeleteLeaderboardAdminV3OpResponse();
