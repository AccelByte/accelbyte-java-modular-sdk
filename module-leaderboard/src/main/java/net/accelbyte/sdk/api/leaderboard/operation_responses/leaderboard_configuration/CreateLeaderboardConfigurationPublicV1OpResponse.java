...
@Getter
@Setter
public class CreateLeaderboardConfigurationPublicV1OpResponse extends ApiResponseWithData<ModelsLeaderboardConfigReq> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration.CreateLeaderboardConfigurationPublicV1";
    }
}