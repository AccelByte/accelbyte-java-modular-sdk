...
@Getter
@Setter
public class DeleteBulkLeaderboardConfigurationAdminV1OpResponse extends ApiResponseWithData<ModelsDeleteBulkLeaderboardsResp> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration.DeleteBulkLeaderboardConfigurationAdminV1";
    }
}