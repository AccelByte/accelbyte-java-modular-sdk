...
@Getter
@Setter
public class GetTodayLeaderboardRankingAdminV1OpResponse extends ApiResponseWithData<ModelsGetLeaderboardRankingResp> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.GetTodayLeaderboardRankingAdminV1";
    }
}