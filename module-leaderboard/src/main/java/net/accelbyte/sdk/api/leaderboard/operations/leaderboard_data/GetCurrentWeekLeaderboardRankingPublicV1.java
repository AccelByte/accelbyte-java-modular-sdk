...
public class GetCurrentWeekLeaderboardRankingPublicV1 extends Operation {
    ...
    */
    ...
    public GetCurrentWeekLeaderboardRankingPublicV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetCurrentWeekLeaderboardRankingPublicV1OpResponse response = new GetCurrentWeekLeaderboardRankingPublicV1OpResponse();
