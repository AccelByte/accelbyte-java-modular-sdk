...
public class GetAllTimeLeaderboardRankingAdminV1 extends Operation {
    ...
    */
    ...
    public GetAllTimeLeaderboardRankingAdminV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetAllTimeLeaderboardRankingAdminV1OpResponse response = new GetAllTimeLeaderboardRankingAdminV1OpResponse();
