...
public class GetAllTimeLeaderboardRankingPublicV2 extends Operation {
    ...
    */
    ...
    public GetAllTimeLeaderboardRankingPublicV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetAllTimeLeaderboardRankingPublicV2OpResponse response = new GetAllTimeLeaderboardRankingPublicV2OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new V2GetPublicLeaderboardRankingResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public V2GetPublicLeaderboardRankingResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
