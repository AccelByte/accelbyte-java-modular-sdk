...
public class UserVisibility {
   ...
   */
  public GetUserVisibilityStatusV2OpResponse getUserVisibilityStatusV2(
      GetUserVisibilityStatusV2 input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public SetUserLeaderboardVisibilityStatusV2OpResponse setUserLeaderboardVisibilityStatusV2(
   ...
   */
  public SetUserVisibilityStatusV2OpResponse setUserVisibilityStatusV2(
      SetUserVisibilityStatusV2 input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
