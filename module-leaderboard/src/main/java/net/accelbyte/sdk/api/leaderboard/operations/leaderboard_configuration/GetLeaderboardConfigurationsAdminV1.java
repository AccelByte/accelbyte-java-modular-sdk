...
public class GetLeaderboardConfigurationsAdminV1 extends Operation {
    ...
    */
    ...
    public GetLeaderboardConfigurationsAdminV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetLeaderboardConfigurationsAdminV1OpResponse response = new GetLeaderboardConfigurationsAdminV1OpResponse();
