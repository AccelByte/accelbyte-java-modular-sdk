...
public class UserVisibilityV3 {
     ...
     */
    public GetUserVisibilityStatusV3OpResponse getUserVisibilityStatusV3(GetUserVisibilityStatusV3 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public SetUserLeaderboardVisibilityV3OpResponse setUserLeaderboardVisibilityV3(SetUserLeaderboardVisibilityV3 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public SetUserVisibilityV3OpResponse setUserVisibilityV3(SetUserVisibilityV3 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
