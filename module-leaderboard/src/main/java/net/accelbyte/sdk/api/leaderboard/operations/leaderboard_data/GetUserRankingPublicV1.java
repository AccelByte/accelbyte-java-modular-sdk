...
public class GetUserRankingPublicV1 extends Operation {
    ...
    */
    ...
    public GetUserRankingPublicV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserRankingPublicV1OpResponse response = new GetUserRankingPublicV1OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsUserRankingResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 401) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsUserRankingResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
