...
public class LeaderboardConfiguration {
   ...
   */
  public GetLeaderboardConfigurationsAdminV1OpResponse getLeaderboardConfigurationsAdminV1(
   ...
   */
  public CreateLeaderboardConfigurationAdminV1OpResponse createLeaderboardConfigurationAdminV1(
   ...
   */
  public DeleteBulkLeaderboardConfigurationAdminV1OpResponse
      deleteBulkLeaderboardConfigurationAdminV1(DeleteBulkLeaderboardConfigurationAdminV1 input)
          throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public GetLeaderboardConfigurationAdminV1OpResponse getLeaderboardConfigurationAdminV1(
   ...
   */
  public UpdateLeaderboardConfigurationAdminV1OpResponse updateLeaderboardConfigurationAdminV1(
   ...
   */
  public DeleteLeaderboardConfigurationAdminV1OpResponse deleteLeaderboardConfigurationAdminV1(
      DeleteLeaderboardConfigurationAdminV1 input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public HardDeleteLeaderboardAdminV1OpResponse hardDeleteLeaderboardAdminV1(
      HardDeleteLeaderboardAdminV1 input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public GetLeaderboardConfigurationsPublicV1OpResponse getLeaderboardConfigurationsPublicV1(
   ...
   */
  public CreateLeaderboardConfigurationPublicV1OpResponse createLeaderboardConfigurationPublicV1(
   ...
   */
  public GetLeaderboardConfigurationsPublicV2OpResponse getLeaderboardConfigurationsPublicV2(
