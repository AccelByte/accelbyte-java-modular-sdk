...
@Getter
@Setter
public class AdminGetArchivedLeaderboardRankingDataV1HandlerOpResponse extends ApiResponseWithData<List<ModelsArchiveLeaderboardSignedURLResponse>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.AdminGetArchivedLeaderboardRankingDataV1Handler";
    }
}