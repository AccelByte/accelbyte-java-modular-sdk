...
public class DeleteAllUserRankingByCycleIdAdminV3 extends Operation {
  ...
  public DeleteAllUserRankingByCycleIdAdminV3(
      String customBasePath, String cycleId, String leaderboardCode, String namespace) {
  ...
  public DeleteAllUserRankingByCycleIdAdminV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final DeleteAllUserRankingByCycleIdAdminV3OpResponse response =
        new DeleteAllUserRankingByCycleIdAdminV3OpResponse();
