...
@Getter
@Setter
public class GetCurrentSeasonLeaderboardRankingAdminV1OpResponse extends ApiResponseWithData<ModelsGetLeaderboardRankingResp> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.GetCurrentSeasonLeaderboardRankingAdminV1";
    }
}