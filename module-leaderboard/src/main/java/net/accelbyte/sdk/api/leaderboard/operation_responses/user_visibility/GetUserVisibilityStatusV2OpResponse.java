...
@Getter
@Setter
public class GetUserVisibilityStatusV2OpResponse extends ApiResponseWithData<ModelsGetUserVisibilityResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.user_visibility.GetUserVisibilityStatusV2";
    }
}