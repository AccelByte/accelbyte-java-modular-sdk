...
import net.accelbyte.sdk.api.leaderboard.operation_responses.leaderboard_configuration.CreateLeaderboardConfigurationAdminV1OpResponse;
...
public class CreateLeaderboardConfigurationAdminV1 extends Operation {
    ...
    */
    ...
    public CreateLeaderboardConfigurationAdminV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreateLeaderboardConfigurationAdminV1OpResponse response = new CreateLeaderboardConfigurationAdminV1OpResponse();
