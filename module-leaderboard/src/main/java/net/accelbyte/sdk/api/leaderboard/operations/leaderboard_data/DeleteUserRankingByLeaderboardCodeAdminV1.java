...
public class DeleteUserRankingByLeaderboardCodeAdminV1 extends Operation {
     ...
     */
    private String path = "/leaderboard/v1/admin/namespaces/{namespace}/leaderboards/{leaderboardCode}/reset";
    ...
    */
    ...
    public DeleteUserRankingByLeaderboardCodeAdminV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteUserRankingByLeaderboardCodeAdminV1OpResponse response = new DeleteUserRankingByLeaderboardCodeAdminV1OpResponse();
