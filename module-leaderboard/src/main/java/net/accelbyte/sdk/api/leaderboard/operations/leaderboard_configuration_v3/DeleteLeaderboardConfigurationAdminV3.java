...
public class DeleteLeaderboardConfigurationAdminV3 extends Operation {
    ...
    */
    ...
    public DeleteLeaderboardConfigurationAdminV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteLeaderboardConfigurationAdminV3OpResponse response = new DeleteLeaderboardConfigurationAdminV3OpResponse();
