...
import net.accelbyte.sdk.api.leaderboard.operation_responses.leaderboard_configuration.DeleteLeaderboardConfigurationAdminV1OpResponse;
...
public class DeleteLeaderboardConfigurationAdminV1 extends Operation {
    ...
    */
    ...
    public DeleteLeaderboardConfigurationAdminV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteLeaderboardConfigurationAdminV1OpResponse response = new DeleteLeaderboardConfigurationAdminV1OpResponse();
