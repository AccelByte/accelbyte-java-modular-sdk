...
public class SetUserLeaderboardVisibilityStatusV2 extends Operation {
  ...
  public SetUserLeaderboardVisibilityStatusV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final SetUserLeaderboardVisibilityStatusV2OpResponse response =
        new SetUserLeaderboardVisibilityStatusV2OpResponse();
