...
@Getter
@Setter
public class SetUserVisibilityV3OpResponse extends ApiResponseWithData<ModelsGetUserVisibilityResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.user_visibility_v3.SetUserVisibilityV3";
    }
}