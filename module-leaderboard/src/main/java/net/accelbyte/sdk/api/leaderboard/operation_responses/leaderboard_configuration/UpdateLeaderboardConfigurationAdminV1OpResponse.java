...
@Getter
@Setter
public class UpdateLeaderboardConfigurationAdminV1OpResponse extends ApiResponseWithData<ModelsGetLeaderboardConfigResp> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration.UpdateLeaderboardConfigurationAdminV1";
    }
}