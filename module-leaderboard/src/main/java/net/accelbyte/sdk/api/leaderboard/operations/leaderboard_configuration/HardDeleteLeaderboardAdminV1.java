...
import net.accelbyte.sdk.api.leaderboard.operation_responses.leaderboard_configuration.HardDeleteLeaderboardAdminV1OpResponse;
...
public class HardDeleteLeaderboardAdminV1 extends Operation {
     ...
     */
    private String path = "/leaderboard/v1/admin/namespaces/{namespace}/leaderboards/{leaderboardCode}/hard";
    ...
    */
    ...
    public HardDeleteLeaderboardAdminV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final HardDeleteLeaderboardAdminV1OpResponse response = new HardDeleteLeaderboardAdminV1OpResponse();
