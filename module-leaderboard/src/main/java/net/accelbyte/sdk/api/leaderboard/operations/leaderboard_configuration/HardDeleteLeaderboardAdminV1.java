...
public class HardDeleteLeaderboardAdminV1 extends Operation {
  ...
  public HardDeleteLeaderboardAdminV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final HardDeleteLeaderboardAdminV1OpResponse response =
        new HardDeleteLeaderboardAdminV1OpResponse();
