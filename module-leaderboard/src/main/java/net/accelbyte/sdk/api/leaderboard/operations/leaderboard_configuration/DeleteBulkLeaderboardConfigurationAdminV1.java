...
import net.accelbyte.sdk.api.leaderboard.operation_responses.leaderboard_configuration.DeleteBulkLeaderboardConfigurationAdminV1OpResponse;
...
public class DeleteBulkLeaderboardConfigurationAdminV1 extends Operation {
    ...
    */
    ...
    public DeleteBulkLeaderboardConfigurationAdminV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteBulkLeaderboardConfigurationAdminV1OpResponse response = new DeleteBulkLeaderboardConfigurationAdminV1OpResponse();
