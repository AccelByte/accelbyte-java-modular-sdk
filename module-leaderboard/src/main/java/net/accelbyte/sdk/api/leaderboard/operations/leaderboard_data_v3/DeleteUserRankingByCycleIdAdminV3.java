...
import net.accelbyte.sdk.api.leaderboard.operation_responses.leaderboard_data_v3.DeleteUserRankingByCycleIdAdminV3OpResponse;
...
public class DeleteUserRankingByCycleIdAdminV3 extends Operation {
     ...
     */
    private String path = "/leaderboard/v3/admin/namespaces/{namespace}/leaderboards/{leaderboardCode}/cycles/{cycleId}/users/{userId}";
    ...
    */
    ...
    public DeleteUserRankingByCycleIdAdminV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteUserRankingByCycleIdAdminV3OpResponse response = new DeleteUserRankingByCycleIdAdminV3OpResponse();
