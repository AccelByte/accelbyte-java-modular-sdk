...
@Getter
@Setter
public class GetAllTimeLeaderboardRankingPublicV2OpResponse extends ApiResponseWithData<V2GetPublicLeaderboardRankingResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.GetAllTimeLeaderboardRankingPublicV2";
    }
}