...
@Getter
@Setter
public class GetLeaderboardConfigurationsAdminV3OpResponse extends ApiResponseWithData<ModelsGetAllLeaderboardConfigsRespV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration_v3.GetLeaderboardConfigurationsAdminV3";
    }
}