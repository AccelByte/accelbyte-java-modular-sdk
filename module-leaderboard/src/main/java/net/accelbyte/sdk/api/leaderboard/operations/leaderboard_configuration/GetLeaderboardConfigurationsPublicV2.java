...
public class GetLeaderboardConfigurationsPublicV2 extends Operation {
  ...
  public GetLeaderboardConfigurationsPublicV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetLeaderboardConfigurationsPublicV2OpResponse response =
        new GetLeaderboardConfigurationsPublicV2OpResponse();
