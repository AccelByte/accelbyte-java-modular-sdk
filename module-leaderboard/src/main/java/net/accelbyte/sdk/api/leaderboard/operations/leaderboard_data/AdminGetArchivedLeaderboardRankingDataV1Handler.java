...
public class AdminGetArchivedLeaderboardRankingDataV1Handler extends Operation {
    ...
    */
    ...
    public AdminGetArchivedLeaderboardRankingDataV1HandlerOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetArchivedLeaderboardRankingDataV1HandlerOpResponse response = new AdminGetArchivedLeaderboardRankingDataV1HandlerOpResponse();
