...
import net.accelbyte.sdk.api.leaderboard.operation_responses.leaderboard_configuration.GetLeaderboardConfigurationAdminV1OpResponse;
...
public class GetLeaderboardConfigurationAdminV1 extends Operation {
    ...
    */
    ...
    public GetLeaderboardConfigurationAdminV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetLeaderboardConfigurationAdminV1OpResponse response = new GetLeaderboardConfigurationAdminV1OpResponse();
