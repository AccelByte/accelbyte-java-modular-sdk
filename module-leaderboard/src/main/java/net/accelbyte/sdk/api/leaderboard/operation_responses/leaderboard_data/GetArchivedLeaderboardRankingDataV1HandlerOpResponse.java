...
@Getter
@Setter
public class GetArchivedLeaderboardRankingDataV1HandlerOpResponse extends ApiResponseWithData<List<ModelsArchiveLeaderboardSignedURLResponse>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.GetArchivedLeaderboardRankingDataV1Handler";
    }
}