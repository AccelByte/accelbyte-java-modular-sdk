...
@Getter
@Setter
public class GetLeaderboardConfigurationPublicV3OpResponse extends ApiResponseWithData<ModelsGetLeaderboardConfigPublicRespV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration_v3.GetLeaderboardConfigurationPublicV3";
    }
}