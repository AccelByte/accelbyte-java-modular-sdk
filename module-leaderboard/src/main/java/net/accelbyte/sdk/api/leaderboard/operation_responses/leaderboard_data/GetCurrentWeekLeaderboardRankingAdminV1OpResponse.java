...
@Getter
@Setter
public class GetCurrentWeekLeaderboardRankingAdminV1OpResponse extends ApiResponseWithData<ModelsGetLeaderboardRankingResp> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.GetCurrentWeekLeaderboardRankingAdminV1";
    }
}