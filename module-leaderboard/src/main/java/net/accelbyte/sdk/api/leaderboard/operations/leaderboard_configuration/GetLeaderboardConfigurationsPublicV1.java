...
public class GetLeaderboardConfigurationsPublicV1 extends Operation {
  ...
  public GetLeaderboardConfigurationsPublicV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetLeaderboardConfigurationsPublicV1OpResponse response =
        new GetLeaderboardConfigurationsPublicV1OpResponse();
