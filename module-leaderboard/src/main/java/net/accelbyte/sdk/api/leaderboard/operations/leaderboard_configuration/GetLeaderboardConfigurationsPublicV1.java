...
import net.accelbyte.sdk.api.leaderboard.operation_responses.leaderboard_configuration.GetLeaderboardConfigurationsPublicV1OpResponse;
...
public class GetLeaderboardConfigurationsPublicV1 extends Operation {
    ...
    */
    ...
    public GetLeaderboardConfigurationsPublicV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetLeaderboardConfigurationsPublicV1OpResponse response = new GetLeaderboardConfigurationsPublicV1OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsGetAllLeaderboardConfigsPublicResp().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsGetAllLeaderboardConfigsPublicResp parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
