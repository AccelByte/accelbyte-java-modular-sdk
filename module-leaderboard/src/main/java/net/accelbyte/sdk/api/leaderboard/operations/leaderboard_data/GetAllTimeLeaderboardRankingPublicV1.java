...
public class GetAllTimeLeaderboardRankingPublicV1 extends Operation {
    ...
    */
    ...
    public GetAllTimeLeaderboardRankingPublicV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetAllTimeLeaderboardRankingPublicV1OpResponse response = new GetAllTimeLeaderboardRankingPublicV1OpResponse();
