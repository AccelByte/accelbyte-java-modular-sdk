...
@Getter
@Setter
public class GetLeaderboardConfigurationsAdminV1OpResponse extends ApiResponseWithData<ModelsGetAllLeaderboardConfigsResp> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration.GetLeaderboardConfigurationsAdminV1";
    }
}