...
public class UpdateLeaderboardConfigurationAdminV1 extends Operation {
  ...
  public UpdateLeaderboardConfigurationAdminV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdateLeaderboardConfigurationAdminV1OpResponse response =
        new UpdateLeaderboardConfigurationAdminV1OpResponse();
