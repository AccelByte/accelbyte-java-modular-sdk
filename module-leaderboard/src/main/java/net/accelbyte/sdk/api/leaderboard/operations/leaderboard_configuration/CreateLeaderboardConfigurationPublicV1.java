...
import net.accelbyte.sdk.api.leaderboard.operation_responses.leaderboard_configuration.CreateLeaderboardConfigurationPublicV1OpResponse;
...
public class CreateLeaderboardConfigurationPublicV1 extends Operation {
    ...
    */
    ...
    public CreateLeaderboardConfigurationPublicV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreateLeaderboardConfigurationPublicV1OpResponse response = new CreateLeaderboardConfigurationPublicV1OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsLeaderboardConfigReq().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsLeaderboardConfigReq parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 201){
            final String json = Helper.convertInputStreamToString(payload);
