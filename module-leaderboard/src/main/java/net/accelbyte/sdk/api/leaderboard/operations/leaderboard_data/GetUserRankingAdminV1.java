...
public class GetUserRankingAdminV1 extends Operation {
    ...
    */
    ...
    public GetUserRankingAdminV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserRankingAdminV1OpResponse response = new GetUserRankingAdminV1OpResponse();
