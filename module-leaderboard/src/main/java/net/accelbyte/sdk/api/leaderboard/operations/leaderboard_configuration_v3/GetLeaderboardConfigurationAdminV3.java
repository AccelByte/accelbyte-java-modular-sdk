...
import net.accelbyte.sdk.api.leaderboard.operation_responses.leaderboard_configuration_v3.GetLeaderboardConfigurationAdminV3OpResponse;
...
public class GetLeaderboardConfigurationAdminV3 extends Operation {
    ...
    */
    ...
    public GetLeaderboardConfigurationAdminV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetLeaderboardConfigurationAdminV3OpResponse response = new GetLeaderboardConfigurationAdminV3OpResponse();
