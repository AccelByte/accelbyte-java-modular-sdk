...
@Getter
@Setter
public class SetUserLeaderboardVisibilityStatusV2OpResponse extends ApiResponseWithData<ModelsGetUserVisibilityResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.user_visibility.SetUserLeaderboardVisibilityStatusV2";
    }
}