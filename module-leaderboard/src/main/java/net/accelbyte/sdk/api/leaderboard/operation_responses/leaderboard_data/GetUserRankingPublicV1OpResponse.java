...
@Getter
@Setter
public class GetUserRankingPublicV1OpResponse extends ApiResponseWithData<ModelsUserRankingResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.leaderboard_data.GetUserRankingPublicV1";
    }
}