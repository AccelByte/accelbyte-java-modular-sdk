...
public class DeleteUserRankingPublicV1 extends Operation {
    ...
    */
    ...
    public DeleteUserRankingPublicV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteUserRankingPublicV1OpResponse response = new DeleteUserRankingPublicV1OpResponse();
