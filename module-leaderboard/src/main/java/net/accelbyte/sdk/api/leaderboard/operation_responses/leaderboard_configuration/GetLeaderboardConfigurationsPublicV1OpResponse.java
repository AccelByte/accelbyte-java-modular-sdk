...
@Getter
@Setter
public class GetLeaderboardConfigurationsPublicV1OpResponse extends ApiResponseWithData<ModelsGetAllLeaderboardConfigsPublicResp> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration.GetLeaderboardConfigurationsPublicV1";
    }
}