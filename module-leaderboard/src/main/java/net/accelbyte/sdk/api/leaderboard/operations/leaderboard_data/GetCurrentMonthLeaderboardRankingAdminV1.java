...
public class GetCurrentMonthLeaderboardRankingAdminV1 extends Operation {
    ...
    */
    ...
    public GetCurrentMonthLeaderboardRankingAdminV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetCurrentMonthLeaderboardRankingAdminV1OpResponse response = new GetCurrentMonthLeaderboardRankingAdminV1OpResponse();
