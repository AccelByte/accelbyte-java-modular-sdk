...
import net.accelbyte.sdk.api.leaderboard.operation_responses.leaderboard_configuration_v3.UpdateLeaderboardConfigurationAdminV3OpResponse;
...
public class UpdateLeaderboardConfigurationAdminV3 extends Operation {
     ...
     */
    private String path = "/leaderboard/v3/admin/namespaces/{namespace}/leaderboards/{leaderboardCode}";
    ...
    */
    ...
    public UpdateLeaderboardConfigurationAdminV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateLeaderboardConfigurationAdminV3OpResponse response = new UpdateLeaderboardConfigurationAdminV3OpResponse();
