...
@Getter
@Setter
public class UpdateLeaderboardConfigurationAdminV3OpResponse extends ApiResponseWithData<ModelsGetLeaderboardConfigRespV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.leaderboard_configuration_v3.UpdateLeaderboardConfigurationAdminV3";
    }
}