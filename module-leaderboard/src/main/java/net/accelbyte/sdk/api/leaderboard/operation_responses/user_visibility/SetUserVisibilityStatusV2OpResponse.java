...
@Getter
@Setter
public class SetUserVisibilityStatusV2OpResponse extends ApiResponseWithData<ModelsGetUserVisibilityResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.user_visibility.SetUserVisibilityStatusV2";
    }
}