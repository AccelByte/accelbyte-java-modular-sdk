...
public class LeaderboardErrors {
  ...
  public static ApiError error71132 =
      new ApiError("71132", "leaderboard configuration already exist");
  ...
  public static ApiError error71237 =
      new ApiError("71237", "leaderboard ranking not created for inactive leaderboard");
  ...
  public static ApiError error71243 =
      new ApiError("71243", "cycle doesn't belong to the stat code");
