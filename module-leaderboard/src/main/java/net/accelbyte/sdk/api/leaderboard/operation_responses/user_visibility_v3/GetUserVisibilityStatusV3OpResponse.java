...
@Getter
@Setter
public class GetUserVisibilityStatusV3OpResponse extends ApiResponseWithData<ModelsGetUserVisibilityResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.leaderboard.operations.user_visibility_v3.GetUserVisibilityStatusV3";
    }
}