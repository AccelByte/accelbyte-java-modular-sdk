...
@Getter
@Setter
public class QueryTotalMatchmakingCanceledOpResponse extends ApiResponseWithData<ApimodelsXRayCanceledMatchmakingTicketQueryResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryTotalMatchmakingCanceled";
    }
}