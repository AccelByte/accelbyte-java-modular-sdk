...
public class QueryTotalMatchmakingCreated extends Operation {
    ...
    */
    ...
    public QueryTotalMatchmakingCreatedOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryTotalMatchmakingCreatedOpResponse response = new QueryTotalMatchmakingCreatedOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApimodelsXRayCreatedMatchmakingTicketQueryResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
