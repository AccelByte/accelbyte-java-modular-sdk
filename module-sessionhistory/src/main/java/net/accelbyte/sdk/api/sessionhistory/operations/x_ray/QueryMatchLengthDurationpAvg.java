...
public class QueryMatchLengthDurationpAvg extends Operation {
    ...
    */
    ...
    public QueryMatchLengthDurationpAvgOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryMatchLengthDurationpAvgOpResponse response = new QueryMatchLengthDurationpAvgOpResponse();
