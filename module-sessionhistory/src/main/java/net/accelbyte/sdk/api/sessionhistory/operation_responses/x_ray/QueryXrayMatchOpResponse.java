...
@Getter
@Setter
public class QueryXrayMatchOpResponse extends ApiResponseWithData<ApimodelsXRayMatchesQueryResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryXrayMatch";
    }
}