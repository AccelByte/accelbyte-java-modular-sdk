...
@Getter
@Setter
public class QueryDetailTickMatchPoolMatchesOpResponse extends ApiResponseWithData<ApimodelsXRayMatchPoolPodTickMatchResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryDetailTickMatchPoolMatches";
    }
}