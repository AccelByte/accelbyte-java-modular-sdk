...
@Getter
@Setter
public class QueryMatchLengthDurationp99OpResponse extends ApiResponseWithData<ApimodelsXRayMatchLengthDurationQueryResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryMatchLengthDurationp99";
    }
}