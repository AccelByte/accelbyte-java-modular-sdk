...
public class QueryXrayMatch extends Operation {
    ...
    */
    ...
    public QueryXrayMatchOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryXrayMatchOpResponse response = new QueryXrayMatchOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApimodelsXRayMatchesQueryResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
