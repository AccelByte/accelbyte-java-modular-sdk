...
public class QueryMatchHistories extends Operation {
    ...
    */
    ...
    public QueryMatchHistoriesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryMatchHistoriesOpResponse response = new QueryMatchHistoriesOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApimodelsXRayMatchHistorQueryResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
