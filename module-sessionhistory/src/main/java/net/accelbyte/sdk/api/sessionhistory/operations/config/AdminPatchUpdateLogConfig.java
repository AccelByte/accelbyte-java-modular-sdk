...
import net.accelbyte.sdk.api.sessionhistory.operation_responses.config.AdminPatchUpdateLogConfigOpResponse;
...
public class AdminPatchUpdateLogConfig extends Operation {
    ...
    */
    ...
    public AdminPatchUpdateLogConfig(
            String customBasePath,            LogconfigConfiguration body
    )
    {
        this.body = body;
    ...
    public AdminPatchUpdateLogConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
