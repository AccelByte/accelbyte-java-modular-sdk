...
@Getter
@Setter
public class QueryTotalMatchmakingExpiredOpResponse extends ApiResponseWithData<ApimodelsXRayExpiredMatchmakingTicketQueryResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryTotalMatchmakingExpired";
    }
}