...
public class QueryDetailTickMatchPoolTicket extends Operation {
    ...
    */
    ...
    public QueryDetailTickMatchPoolTicketOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryDetailTickMatchPoolTicketOpResponse response = new QueryDetailTickMatchPoolTicketOpResponse();
