...
public class QueryDetailTickMatchPoolMatches extends Operation {
  ...
  public QueryDetailTickMatchPoolMatchesOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final QueryDetailTickMatchPoolMatchesOpResponse response =
        new QueryDetailTickMatchPoolMatchesOpResponse();
