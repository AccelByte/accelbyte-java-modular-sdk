...
public class QueryDetailTickMatchPoolMatches extends Operation {
    ...
    */
    ...
    public QueryDetailTickMatchPoolMatchesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryDetailTickMatchPoolMatchesOpResponse response = new QueryDetailTickMatchPoolMatchesOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApimodelsXRayMatchPoolPodTickMatchResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
