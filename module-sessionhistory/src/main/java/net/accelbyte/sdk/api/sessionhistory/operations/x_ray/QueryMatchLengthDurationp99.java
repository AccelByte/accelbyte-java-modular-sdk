...
public class QueryMatchLengthDurationp99 extends Operation {
    ...
    */
    ...
    public QueryMatchLengthDurationp99OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryMatchLengthDurationp99OpResponse response = new QueryMatchLengthDurationp99OpResponse();
