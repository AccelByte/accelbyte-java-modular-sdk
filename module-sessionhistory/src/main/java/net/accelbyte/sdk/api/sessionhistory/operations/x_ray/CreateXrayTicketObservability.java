...
public class CreateXrayTicketObservability extends Operation {
    ...
    */
    ...
    public CreateXrayTicketObservabilityOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreateXrayTicketObservabilityOpResponse response = new CreateXrayTicketObservabilityOpResponse();
