...
@Getter
@Setter
public class QueryTotalMatchmakingCreatedOpResponse extends ApiResponseWithData<ApimodelsXRayCreatedMatchmakingTicketQueryResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryTotalMatchmakingCreated";
    }
}