...
public class AdminTicketDetailGetByTicketID extends Operation {
  ...
  @Deprecated
  public AdminTicketDetailGetByTicketID(String customBasePath, String namespace, String ticketId) {
  ...
  public AdminTicketDetailGetByTicketIDOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminTicketDetailGetByTicketIDOpResponse response =
        new AdminTicketDetailGetByTicketIDOpResponse();
