...
@Getter
@Setter
public class QueryAcquiringDSOpResponse extends ApiResponseWithData<ApimodelsXRayAcquiringDsQueryResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryAcquiringDS";
    }
}