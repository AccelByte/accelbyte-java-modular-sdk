...
@Getter
@Setter
public class QueryTotalMatchmakingMatchTicketOpResponse extends ApiResponseWithData<ApimodelsXRayMatchMatchmakingTicketQueryResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryTotalMatchmakingMatchTicket";
    }
}