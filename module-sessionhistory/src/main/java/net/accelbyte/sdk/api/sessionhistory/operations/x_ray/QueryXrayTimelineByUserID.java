...
public class QueryXrayTimelineByUserID extends Operation {
    ...
    */
    ...
    public QueryXrayTimelineByUserIDOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryXrayTimelineByUserIDOpResponse response = new QueryXrayTimelineByUserIDOpResponse();
