...
public class AdminQueryPartyDetail extends Operation {
    ...
    */
    ...
    public AdminQueryPartyDetailOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminQueryPartyDetailOpResponse response = new AdminQueryPartyDetailOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApimodelsPartyDetailQueryResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
