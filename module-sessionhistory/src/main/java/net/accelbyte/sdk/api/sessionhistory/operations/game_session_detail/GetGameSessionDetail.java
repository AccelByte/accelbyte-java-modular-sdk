...
public class GetGameSessionDetail extends Operation {
    ...
    */
    ...
    public GetGameSessionDetailOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetGameSessionDetailOpResponse response = new GetGameSessionDetailOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApimodelsGameSessionDetail().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
