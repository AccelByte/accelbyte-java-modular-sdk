...
@Getter
@Setter
public class QueryDetailTickMatchPoolTicketOpResponse extends ApiResponseWithData<ApimodelsXRayMatchPoolPodTickTicketResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryDetailTickMatchPoolTicket";
    }
}