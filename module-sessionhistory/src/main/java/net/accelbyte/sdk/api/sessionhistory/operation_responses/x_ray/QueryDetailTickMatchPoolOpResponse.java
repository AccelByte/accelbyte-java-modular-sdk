...
@Getter
@Setter
public class QueryDetailTickMatchPoolOpResponse extends ApiResponseWithData<ApimodelsXRayMatchPoolPodTickQueryResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryDetailTickMatchPool";
    }
}