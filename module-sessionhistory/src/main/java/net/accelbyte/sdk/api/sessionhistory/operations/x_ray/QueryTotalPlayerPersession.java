...
public class QueryTotalPlayerPersession extends Operation {
    ...
    */
    ...
    public QueryTotalPlayerPersessionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryTotalPlayerPersessionOpResponse response = new QueryTotalPlayerPersessionOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApimodelsXRayTotalPlayerPersessionAVGQueryResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
