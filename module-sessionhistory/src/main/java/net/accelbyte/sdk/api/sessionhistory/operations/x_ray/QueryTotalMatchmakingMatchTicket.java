...
public class QueryTotalMatchmakingMatchTicket extends Operation {
  ...
  public QueryTotalMatchmakingMatchTicketOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final QueryTotalMatchmakingMatchTicketOpResponse response =
        new QueryTotalMatchmakingMatchTicketOpResponse();
