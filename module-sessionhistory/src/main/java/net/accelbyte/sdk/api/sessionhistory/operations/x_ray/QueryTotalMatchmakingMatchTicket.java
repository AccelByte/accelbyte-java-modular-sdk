...
public class QueryTotalMatchmakingMatchTicket extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("matchPool", this.matchPool == null ? null : this.matchPool.stream().map(i -> String.valueOf(i)).collect(java.util.stream.Collectors.toList()));
    ...
    public QueryTotalMatchmakingMatchTicketOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryTotalMatchmakingMatchTicketOpResponse response = new QueryTotalMatchmakingMatchTicketOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApimodelsXRayMatchMatchmakingTicketQueryResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
