...
@Getter
@Setter
public class QueryMatchTicketHistoriesOpResponse extends ApiResponseWithData<ApimodelsXRayMatchTicketHistoryQueryResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryMatchTicketHistories";
    }
}