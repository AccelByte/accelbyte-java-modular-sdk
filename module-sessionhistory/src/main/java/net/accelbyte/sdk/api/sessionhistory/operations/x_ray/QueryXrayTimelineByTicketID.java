...
public class QueryXrayTimelineByTicketID extends Operation {
  ...
  public QueryXrayTimelineByTicketIDOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final QueryXrayTimelineByTicketIDOpResponse response =
        new QueryXrayTimelineByTicketIDOpResponse();
