...
public class QueryXrayTimelineByTicketID extends Operation {
    ...
    */
    ...
    public QueryXrayTimelineByTicketIDOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryXrayTimelineByTicketIDOpResponse response = new QueryXrayTimelineByTicketIDOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApimodelsXRayTicketQueryResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
