...
public class AdminQueryGameSessionDetail extends Operation {
    ...
    */
    ...
    public AdminQueryGameSessionDetailOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminQueryGameSessionDetailOpResponse response = new AdminQueryGameSessionDetailOpResponse();
