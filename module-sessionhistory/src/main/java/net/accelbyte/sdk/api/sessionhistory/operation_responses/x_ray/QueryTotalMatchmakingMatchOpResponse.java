...
@Getter
@Setter
public class QueryTotalMatchmakingMatchOpResponse extends ApiResponseWithData<ApimodelsXRayMatchMatchmakingQueryResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryTotalMatchmakingMatch";
    }
}