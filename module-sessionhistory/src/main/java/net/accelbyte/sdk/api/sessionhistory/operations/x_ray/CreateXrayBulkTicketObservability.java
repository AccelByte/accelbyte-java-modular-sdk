...
public class CreateXrayBulkTicketObservability extends Operation {
    ...
    */
    ...
    public CreateXrayBulkTicketObservabilityOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreateXrayBulkTicketObservabilityOpResponse response = new CreateXrayBulkTicketObservabilityOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApimodelsXRayBulkTicketObservabilityResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ApimodelsXRayBulkTicketObservabilityResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
