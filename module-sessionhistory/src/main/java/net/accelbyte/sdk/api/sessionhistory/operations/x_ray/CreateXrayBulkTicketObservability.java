...
public class CreateXrayBulkTicketObservability extends Operation {
  ...
  public CreateXrayBulkTicketObservability(
      String customBasePath, String namespace, ApimodelsXRayBulkTicketObservabilityRequest body) {
  ...
  public CreateXrayBulkTicketObservabilityOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final CreateXrayBulkTicketObservabilityOpResponse response =
        new CreateXrayBulkTicketObservabilityOpResponse();
