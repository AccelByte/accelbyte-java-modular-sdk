...
@Getter
@Setter
public class QueryTotalPlayerPersessionOpResponse extends ApiResponseWithData<ApimodelsXRayTotalPlayerPersessionAVGQueryResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryTotalPlayerPersession";
    }
}