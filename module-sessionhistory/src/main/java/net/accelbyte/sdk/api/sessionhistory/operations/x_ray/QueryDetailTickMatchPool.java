...
public class QueryDetailTickMatchPool extends Operation {
    ...
    */
    ...
    public QueryDetailTickMatchPoolOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final QueryDetailTickMatchPoolOpResponse response = new QueryDetailTickMatchPoolOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApimodelsXRayMatchPoolPodTickQueryResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
