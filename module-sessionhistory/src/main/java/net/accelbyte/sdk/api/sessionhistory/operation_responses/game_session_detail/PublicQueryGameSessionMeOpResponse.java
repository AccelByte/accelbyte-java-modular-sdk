...
@Getter
@Setter
public class PublicQueryGameSessionMeOpResponse extends ApiResponseWithData<ApimodelsGameSessionDetailQueryResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionhistory.operations.game_session_detail.PublicQueryGameSessionMe";
    }
}