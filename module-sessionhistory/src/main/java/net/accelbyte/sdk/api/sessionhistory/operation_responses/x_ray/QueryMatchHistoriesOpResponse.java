...
@Getter
@Setter
public class QueryMatchHistoriesOpResponse extends ApiResponseWithData<ApimodelsXRayMatchHistorQueryResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryMatchHistories";
    }
}