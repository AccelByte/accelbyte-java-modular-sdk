...
@Getter
@Setter
public class QueryXrayMatchPoolOpResponse extends ApiResponseWithData<ApimodelsXRayMatchPoolQueryResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryXrayMatchPool";
    }
}