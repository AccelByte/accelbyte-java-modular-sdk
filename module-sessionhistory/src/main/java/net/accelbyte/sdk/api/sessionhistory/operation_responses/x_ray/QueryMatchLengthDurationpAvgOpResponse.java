...
@Getter
@Setter
public class QueryMatchLengthDurationpAvgOpResponse extends ApiResponseWithData<ApimodelsXRayMatchLengthDurationQueryResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryMatchLengthDurationpAvg";
    }
}