...
public class AdminGetMatchmakingDetailByTicketID extends Operation {
  ...
  public AdminGetMatchmakingDetailByTicketID(
      String customBasePath, String namespace, String ticketId) {
  ...
  public AdminGetMatchmakingDetailByTicketIDOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetMatchmakingDetailByTicketIDOpResponse response =
        new AdminGetMatchmakingDetailByTicketIDOpResponse();
