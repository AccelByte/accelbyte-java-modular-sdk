...
public class XRay {
   ...
   */
  public QueryXrayMatchPoolOpResponse queryXrayMatchPool(QueryXrayMatchPool input)
      throws Exception {
   ...
   */
  public QueryDetailTickMatchPoolOpResponse queryDetailTickMatchPool(QueryDetailTickMatchPool input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public QueryDetailTickMatchPoolMatchesOpResponse queryDetailTickMatchPoolMatches(
   ...
   */
  public QueryDetailTickMatchPoolTicketOpResponse queryDetailTickMatchPoolTicket(
   ...
   */
  public QueryMatchHistoriesOpResponse queryMatchHistories(QueryMatchHistories input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public QueryMatchTicketHistoriesOpResponse queryMatchTicketHistories(
   ...
   */
  public QueryAcquiringDSWaitTimeAvgOpResponse queryAcquiringDSWaitTimeAvg(
   ...
   */
  public QueryMatchLengthDurationpAvgOpResponse queryMatchLengthDurationpAvg(
   ...
   */
  public QueryMatchLengthDurationp99OpResponse queryMatchLengthDurationp99(
   ...
   */
  public QueryTotalActiveSessionOpResponse queryTotalActiveSession(QueryTotalActiveSession input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public QueryTotalMatchmakingMatchOpResponse queryTotalMatchmakingMatch(
   ...
   */
  public QueryTotalPlayerPersessionOpResponse queryTotalPlayerPersession(
   ...
   */
  public QueryTotalMatchmakingCanceledOpResponse queryTotalMatchmakingCanceled(
   ...
   */
  public QueryTotalMatchmakingCreatedOpResponse queryTotalMatchmakingCreated(
   ...
   */
  public QueryTotalMatchmakingExpiredOpResponse queryTotalMatchmakingExpired(
   ...
   */
  public QueryTotalMatchmakingMatchTicketOpResponse queryTotalMatchmakingMatchTicket(
   ...
   */
  public QueryXrayTimelineByTicketIDOpResponse queryXrayTimelineByTicketID(
   ...
   */
  public QueryXrayTimelineByUserIDOpResponse queryXrayTimelineByUserID(
      QueryXrayTimelineByUserID input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
