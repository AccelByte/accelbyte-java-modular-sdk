...
@Getter
@Setter
public class QueryTotalActiveSessionOpResponse extends ApiResponseWithData<ApimodelsXRayTotalActiveSessionQueryResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryTotalActiveSession";
    }
}