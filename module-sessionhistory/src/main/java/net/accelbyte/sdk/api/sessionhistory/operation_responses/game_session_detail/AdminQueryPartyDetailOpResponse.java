...
@Getter
@Setter
public class AdminQueryPartyDetailOpResponse extends ApiResponseWithData<ApimodelsPartyDetailQueryResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionhistory.operations.game_session_detail.AdminQueryPartyDetail";
    }
}