...
@Getter
@Setter
public class QueryAcquiringDSWaitTimeAvgOpResponse extends ApiResponseWithData<ApimodelsXRayAcquiringDsWaitTimeQueryResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.sessionhistory.operations.x_ray.QueryAcquiringDSWaitTimeAvg";
    }
}