...
public class AdminQueryTicketDetail extends Operation {
    ...
    */
    ...
    public AdminQueryTicketDetailOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminQueryTicketDetailOpResponse response = new AdminQueryTicketDetailOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApimodelsTicketDetailQueryResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
