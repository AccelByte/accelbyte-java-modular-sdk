...
public class GetSingleTemplateLocalizationV1Admin extends Operation {
    ...
    */
    ...
    public GetSingleTemplateLocalizationV1AdminOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetSingleTemplateLocalizationV1AdminOpResponse response = new GetSingleTemplateLocalizationV1AdminOpResponse();
