...
@Getter
@Setter
public class GetGameTemplateOpResponse extends ApiResponseWithData<List<ModelTemplateResponse>> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.lobby.operations.admin.GetGameTemplate";
  }
}
