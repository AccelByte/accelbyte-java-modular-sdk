...
@Getter
@Setter
public class CreateNotificationTemplateV1AdminOpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.notification.CreateNotificationTemplateV1Admin";
    }
}