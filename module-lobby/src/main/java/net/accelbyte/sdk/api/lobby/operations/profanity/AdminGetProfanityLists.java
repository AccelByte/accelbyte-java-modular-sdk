...
import net.accelbyte.sdk.api.lobby.operation_responses.profanity.AdminGetProfanityListsOpResponse;
...
public class AdminGetProfanityLists extends Operation {
    ...
    */
    ...
    public AdminGetProfanityListsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetProfanityListsOpResponse response = new AdminGetProfanityListsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<ModelsAdminGetProfanityListsListResponse>>() {}));
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public List<ModelsAdminGetProfanityListsListResponse> parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
