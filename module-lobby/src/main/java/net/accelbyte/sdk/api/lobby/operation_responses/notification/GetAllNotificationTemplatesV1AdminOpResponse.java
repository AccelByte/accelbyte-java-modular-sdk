...
@Getter
@Setter
public class GetAllNotificationTemplatesV1AdminOpResponse extends ApiResponseWithData<List<ModelNotificationTemplateResponse>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.notification.GetAllNotificationTemplatesV1Admin";
    }
}