...
@Getter
@Setter
public class AdminDeleteProfanityFilterOpResponse extends ApiResponseWithData<List<ModelsProfanityFilter>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.profanity.AdminDeleteProfanityFilter";
    }
}