...
public class GetNotificationTopicV1Admin extends Operation {
    ...
    */
    ...
    public GetNotificationTopicV1AdminOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetNotificationTopicV1AdminOpResponse response = new GetNotificationTopicV1AdminOpResponse();
