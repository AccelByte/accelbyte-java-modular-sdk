...
public class GetUserIncomingFriendsWithTime extends Operation {
    ...
    */
    ...
    public GetUserIncomingFriendsWithTimeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserIncomingFriendsWithTimeOpResponse response = new GetUserIncomingFriendsWithTimeOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<ModelLoadIncomingFriendsWithTimeResponse>>() {}));
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
