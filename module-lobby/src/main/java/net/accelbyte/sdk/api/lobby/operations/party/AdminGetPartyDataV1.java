...
public class AdminGetPartyDataV1 extends Operation {
    ...
    */
    ...
    public AdminGetPartyDataV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetPartyDataV1OpResponse response = new AdminGetPartyDataV1OpResponse();
