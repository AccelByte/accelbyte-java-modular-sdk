...
@Getter
@Setter
public class FreeFormNotificationByUserIDOpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.notification.FreeFormNotificationByUserID";
    }
}