...
import net.accelbyte.sdk.api.lobby.operation_responses.friends.UserUnfriendRequestOpResponse;
...
public class UserUnfriendRequest extends Operation {
    ...
    */
    ...
    public UserUnfriendRequestOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UserUnfriendRequestOpResponse response = new UserUnfriendRequestOpResponse();
