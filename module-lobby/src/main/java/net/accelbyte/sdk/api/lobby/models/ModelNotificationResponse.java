...
public class ModelNotificationResponse extends Model {
    ...
    @JsonIgnore
    public List<ModelNotificationResponse> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelNotificationResponse>>() {});
    }
