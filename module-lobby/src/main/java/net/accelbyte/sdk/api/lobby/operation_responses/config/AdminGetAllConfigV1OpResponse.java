...
@Getter
@Setter
public class AdminGetAllConfigV1OpResponse extends ApiResponseWithData<ModelsConfigList> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.lobby.operations.config.AdminGetAllConfigV1";
  }
}
