...
@Getter
@Setter
public class UserGetFriendshipStatusOpResponse extends ApiResponseWithData<ModelUserGetFriendshipStatusResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.friends.UserGetFriendshipStatus";
    }
}