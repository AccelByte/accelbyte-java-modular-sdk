...
import net.accelbyte.sdk.api.lobby.operation_responses.profanity.AdminSetProfanityRuleForNamespaceOpResponse;
...
public class AdminSetProfanityRuleForNamespace extends Operation {
    ...
    */
    ...
    public AdminSetProfanityRuleForNamespaceOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminSetProfanityRuleForNamespaceOpResponse response = new AdminSetProfanityRuleForNamespaceOpResponse();
