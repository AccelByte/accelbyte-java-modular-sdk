...
public class SendUsersFreeformNotificationV1Admin extends Operation {
  ...
  public SendUsersFreeformNotificationV1Admin(
      String customBasePath, String namespace, ModelFreeFormNotificationRequestV1 body) {
  ...
  public SendUsersFreeformNotificationV1AdminOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final SendUsersFreeformNotificationV1AdminOpResponse response =
        new SendUsersFreeformNotificationV1AdminOpResponse();
