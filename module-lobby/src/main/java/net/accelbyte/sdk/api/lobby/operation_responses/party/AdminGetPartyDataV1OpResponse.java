...
@Getter
@Setter
public class AdminGetPartyDataV1OpResponse extends ApiResponseWithData<ModelsPartyData> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.lobby.operations.party.AdminGetPartyDataV1";
  }
}
