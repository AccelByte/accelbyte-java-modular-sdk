...
@Getter
@Setter
public class AdminGetPlayerBlockedPlayersV1OpResponse extends ApiResponseWithData<ModelsGetAllPlayerBlockedUsersResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.player.AdminGetPlayerBlockedPlayersV1";
    }
}