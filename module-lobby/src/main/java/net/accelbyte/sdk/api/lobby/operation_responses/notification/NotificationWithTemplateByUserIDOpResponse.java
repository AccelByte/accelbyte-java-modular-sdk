...
@Getter
@Setter
public class NotificationWithTemplateByUserIDOpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.notification.NotificationWithTemplateByUserID";
    }
}