...
public class DeleteNotificationTopicV1Admin extends Operation {
  ...
  public DeleteNotificationTopicV1AdminOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final DeleteNotificationTopicV1AdminOpResponse response =
        new DeleteNotificationTopicV1AdminOpResponse();
