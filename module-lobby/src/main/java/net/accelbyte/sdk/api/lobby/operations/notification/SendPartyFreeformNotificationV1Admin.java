...
public class SendPartyFreeformNotificationV1Admin extends Operation {
    ...
    */
    ...
    public SendPartyFreeformNotificationV1AdminOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SendPartyFreeformNotificationV1AdminOpResponse response = new SendPartyFreeformNotificationV1AdminOpResponse();
