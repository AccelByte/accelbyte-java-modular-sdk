...
@Getter
@Setter
public class AdminDebugProfanityFiltersOpResponse extends ApiResponseWithData<List<ModelsProfanityFilter>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.profanity.AdminDebugProfanityFilters";
    }
}