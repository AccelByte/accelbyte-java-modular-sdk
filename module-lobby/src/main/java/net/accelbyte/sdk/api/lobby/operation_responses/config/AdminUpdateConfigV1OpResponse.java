...
@Getter
@Setter
public class AdminUpdateConfigV1OpResponse extends ApiResponseWithData<ModelsConfigReq> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.config.AdminUpdateConfigV1";
    }
}