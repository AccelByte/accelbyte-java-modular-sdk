...
@Getter
@Setter
public class AdminGetPlayerSessionAttributeOpResponse extends ApiResponseWithData<ModelsGetPlayerSessionAttributeResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.player.AdminGetPlayerSessionAttribute";
    }
}