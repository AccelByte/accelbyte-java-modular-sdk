...
public class PublicGetPlayerBlockedByPlayersV1 extends Operation {
    ...
    */
    ...
    public PublicGetPlayerBlockedByPlayersV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetPlayerBlockedByPlayersV1OpResponse response = new PublicGetPlayerBlockedByPlayersV1OpResponse();
