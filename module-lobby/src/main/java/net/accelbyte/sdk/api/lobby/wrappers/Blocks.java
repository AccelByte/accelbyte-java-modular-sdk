...
import net.accelbyte.sdk.api.lobby.operation_responses.blocks.*;
...
public class Blocks {
     ...
     */
    public SyncNativeBlockedUserOpResponse syncNativeBlockedUser(SyncNativeBlockedUser input) throws Exception {
