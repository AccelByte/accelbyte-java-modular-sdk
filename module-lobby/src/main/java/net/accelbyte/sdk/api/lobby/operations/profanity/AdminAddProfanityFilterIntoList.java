...
public class AdminAddProfanityFilterIntoList extends Operation {
  ...
  public AdminAddProfanityFilterIntoListOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminAddProfanityFilterIntoListOpResponse response =
        new AdminAddProfanityFilterIntoListOpResponse();
