...
import net.accelbyte.sdk.api.lobby.operation_responses.presence.*;
...
public class Presence {
     ...
     */
    public UsersPresenceHandlerV1OpResponse usersPresenceHandlerV1(UsersPresenceHandlerV1 input) throws Exception {
     ...
     */
    public UsersPresenceHandlerV2OpResponse usersPresenceHandlerV2(UsersPresenceHandlerV2 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
