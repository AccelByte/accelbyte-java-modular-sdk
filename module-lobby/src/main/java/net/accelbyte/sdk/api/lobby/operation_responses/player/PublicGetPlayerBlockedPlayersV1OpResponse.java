...
@Getter
@Setter
public class PublicGetPlayerBlockedPlayersV1OpResponse extends ApiResponseWithData<ModelsGetAllPlayerBlockedUsersResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.player.PublicGetPlayerBlockedPlayersV1";
    }
}