...
@Getter
@Setter
public class GetTopicByTopicNameOpResponse extends ApiResponseWithData<ModelNotificationTopicResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.notification.GetTopicByTopicName";
    }
}