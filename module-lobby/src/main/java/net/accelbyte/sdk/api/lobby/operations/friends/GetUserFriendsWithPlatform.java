...
import net.accelbyte.sdk.api.lobby.operation_responses.friends.GetUserFriendsWithPlatformOpResponse;
...
public class GetUserFriendsWithPlatform extends Operation {
    ...
    */
    ...
    public GetUserFriendsWithPlatformOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserFriendsWithPlatformOpResponse response = new GetUserFriendsWithPlatformOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelListBulkUserPlatformsResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelListBulkUserPlatformsResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
