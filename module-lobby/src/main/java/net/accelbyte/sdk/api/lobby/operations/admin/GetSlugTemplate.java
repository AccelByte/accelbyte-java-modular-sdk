...
import net.accelbyte.sdk.api.lobby.operation_responses.admin.GetSlugTemplateOpResponse;
...
public class GetSlugTemplate extends Operation {
    ...
    */
    ...
    public GetSlugTemplateOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetSlugTemplateOpResponse response = new GetSlugTemplateOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelTemplateLocalizationResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelTemplateLocalizationResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
