...
import net.accelbyte.sdk.api.lobby.operation_responses.admin.AdminDeleteGlobalConfigOpResponse;
...
public class AdminDeleteGlobalConfig extends Operation {
    ...
    */
    ...
    public AdminDeleteGlobalConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDeleteGlobalConfigOpResponse response = new AdminDeleteGlobalConfigOpResponse();
