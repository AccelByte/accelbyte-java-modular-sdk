...
public class PublishTemplateLocalizationV1Admin extends Operation {
    ...
    */
    ...
    public PublishTemplateLocalizationV1AdminOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublishTemplateLocalizationV1AdminOpResponse response = new PublishTemplateLocalizationV1AdminOpResponse();
