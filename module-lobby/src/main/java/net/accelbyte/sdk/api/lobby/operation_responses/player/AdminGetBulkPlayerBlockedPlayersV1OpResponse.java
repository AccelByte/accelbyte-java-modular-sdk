...
@Getter
@Setter
public class AdminGetBulkPlayerBlockedPlayersV1OpResponse extends ApiResponseWithData<ModelsGetBulkAllPlayerBlockedUsersResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.player.AdminGetBulkPlayerBlockedPlayersV1";
    }
}