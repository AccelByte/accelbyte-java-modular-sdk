...
import net.accelbyte.sdk.api.lobby.operation_responses.friends.SyncNativeFriendsOpResponse;
...
public class SyncNativeFriends extends Operation {
    ...
    */
    ...
    public SyncNativeFriendsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SyncNativeFriendsOpResponse response = new SyncNativeFriendsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<ModelNativeFriendSyncResponse>>() {}));
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public List<ModelNativeFriendSyncResponse> parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
