...
public class GetTemplateSlugLocalizationsTemplateV1Admin extends Operation {
    ...
    */
    ...
    public GetTemplateSlugLocalizationsTemplateV1AdminOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetTemplateSlugLocalizationsTemplateV1AdminOpResponse response = new GetTemplateSlugLocalizationsTemplateV1AdminOpResponse();
