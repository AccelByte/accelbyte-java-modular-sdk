...
import net.accelbyte.sdk.api.lobby.operation_responses.friends.GetUserOutgoingFriendsOpResponse;
...
public class GetUserOutgoingFriends extends Operation {
    ...
    */
    ...
    public GetUserOutgoingFriendsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserOutgoingFriendsOpResponse response = new GetUserOutgoingFriendsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<ModelGetUserOutgoingFriendsResponse>>() {}));
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public List<ModelGetUserOutgoingFriendsResponse> parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
