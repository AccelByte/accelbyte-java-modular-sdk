...
public class AdminGetPlayerBlockedByPlayersV1 extends Operation {
    ...
    */
    ...
    public AdminGetPlayerBlockedByPlayersV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetPlayerBlockedByPlayersV1OpResponse response = new AdminGetPlayerBlockedByPlayersV1OpResponse();
