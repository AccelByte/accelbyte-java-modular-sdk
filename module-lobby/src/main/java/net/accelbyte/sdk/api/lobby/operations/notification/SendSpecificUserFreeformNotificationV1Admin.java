...
public class SendSpecificUserFreeformNotificationV1Admin extends Operation {
  ...
  public SendSpecificUserFreeformNotificationV1AdminOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final SendSpecificUserFreeformNotificationV1AdminOpResponse response =
        new SendSpecificUserFreeformNotificationV1AdminOpResponse();
