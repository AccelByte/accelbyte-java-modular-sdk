...
public class GetTopicByNamespace extends Operation {
    ...
    */
    ...
    public GetTopicByNamespaceOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetTopicByNamespaceOpResponse response = new GetTopicByNamespaceOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelTopicByNamespacesResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 401) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelTopicByNamespacesResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
