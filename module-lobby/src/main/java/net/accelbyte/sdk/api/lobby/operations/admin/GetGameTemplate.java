...
import net.accelbyte.sdk.api.lobby.operation_responses.admin.GetGameTemplateOpResponse;
...
public class GetGameTemplate extends Operation {
  ...
  @Deprecated
  public GetGameTemplate(String customBasePath, String namespace) {
  ...
  public GetGameTemplateOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetGameTemplateOpResponse response = new GetGameTemplateOpResponse();
    ...
    if (code == 204) {
      ...
      response.setSuccess(true);
      response.setData(
          new ObjectMapper().readValue(json, new TypeReference<List<ModelTemplateResponse>>() {}));
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public List<ModelTemplateResponse> parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
