...
import net.accelbyte.sdk.api.lobby.operation_responses.config.AdminImportConfigV1OpResponse;
...
public class AdminImportConfigV1 extends Operation {
    ...
    */
    ...
    public AdminImportConfigV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminImportConfigV1OpResponse response = new AdminImportConfigV1OpResponse();
