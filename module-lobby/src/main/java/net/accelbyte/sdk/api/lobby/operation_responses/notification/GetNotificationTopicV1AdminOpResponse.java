...
@Getter
@Setter
public class GetNotificationTopicV1AdminOpResponse extends ApiResponseWithData<ModelNotificationTopicResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.notification.GetNotificationTopicV1Admin";
    }
}