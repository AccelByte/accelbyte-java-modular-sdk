...
@Getter
@Setter
public class AdminGetProfanityRuleOpResponse extends ApiResponseWithData<ModelsProfanityRule> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.lobby.operations.profanity.AdminGetProfanityRule";
  }
}
