...
@Getter
@Setter
public class AdminAddProfanityFilterIntoListOpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.profanity.AdminAddProfanityFilterIntoList";
    }
}