...
public class AdminUpdatePartyAttributesV1 extends Operation {
  ...
  public AdminUpdatePartyAttributesV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminUpdatePartyAttributesV1OpResponse response =
        new AdminUpdatePartyAttributesV1OpResponse();
