...
public class AdminGetProfanityListFiltersV1 extends Operation {
  ...
  public AdminGetProfanityListFiltersV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetProfanityListFiltersV1OpResponse response =
        new AdminGetProfanityListFiltersV1OpResponse();
