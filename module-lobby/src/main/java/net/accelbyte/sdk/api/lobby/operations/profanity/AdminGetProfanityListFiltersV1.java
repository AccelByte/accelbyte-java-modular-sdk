...
import net.accelbyte.sdk.api.lobby.operation_responses.profanity.AdminGetProfanityListFiltersV1OpResponse;
...
public class AdminGetProfanityListFiltersV1 extends Operation {
    ...
    */
    ...
    public AdminGetProfanityListFiltersV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetProfanityListFiltersV1OpResponse response = new AdminGetProfanityListFiltersV1OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsAdminGetProfanityListFiltersV1Response().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsAdminGetProfanityListFiltersV1Response parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
