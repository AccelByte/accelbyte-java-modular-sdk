...
public class AdminGetUserPartyV1 extends Operation {
    ...
    */
    ...
    public AdminGetUserPartyV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetUserPartyV1OpResponse response = new AdminGetUserPartyV1OpResponse();
