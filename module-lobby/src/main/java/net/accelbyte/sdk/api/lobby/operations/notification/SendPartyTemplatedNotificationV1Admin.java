...
public class SendPartyTemplatedNotificationV1Admin extends Operation {
    ...
    */
    ...
    public SendPartyTemplatedNotificationV1AdminOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SendPartyTemplatedNotificationV1AdminOpResponse response = new SendPartyTemplatedNotificationV1AdminOpResponse();
