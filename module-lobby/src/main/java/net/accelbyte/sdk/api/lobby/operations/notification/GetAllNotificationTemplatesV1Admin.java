...
public class GetAllNotificationTemplatesV1Admin extends Operation {
  ...
  @Deprecated
  public GetAllNotificationTemplatesV1Admin(String customBasePath, String namespace) {
  ...
  public GetAllNotificationTemplatesV1AdminOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetAllNotificationTemplatesV1AdminOpResponse response =
        new GetAllNotificationTemplatesV1AdminOpResponse();
