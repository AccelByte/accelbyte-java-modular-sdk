...
import net.accelbyte.sdk.api.lobby.operation_responses.friends.UserRejectFriendRequestOpResponse;
...
public class UserRejectFriendRequest extends Operation {
    ...
    */
    ...
    public UserRejectFriendRequestOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UserRejectFriendRequestOpResponse response = new UserRejectFriendRequestOpResponse();
