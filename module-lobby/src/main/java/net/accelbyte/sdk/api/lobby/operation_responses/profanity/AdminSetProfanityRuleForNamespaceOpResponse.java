...
@Getter
@Setter
public class AdminSetProfanityRuleForNamespaceOpResponse extends ApiResponse {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.lobby.operations.profanity.AdminSetProfanityRuleForNamespace";
  }
}
