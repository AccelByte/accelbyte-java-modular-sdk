...
@Getter
@Setter
public class PublicGetPartyDataV1OpResponse extends ApiResponseWithData<ModelsPartyData> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.lobby.operations.party.PublicGetPartyDataV1";
  }
}
