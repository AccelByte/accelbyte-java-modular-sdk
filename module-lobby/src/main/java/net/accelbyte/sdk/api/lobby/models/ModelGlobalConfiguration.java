...
public class ModelGlobalConfiguration extends Model {
    ...
    @JsonIgnore
    public List<ModelGlobalConfiguration> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelGlobalConfiguration>>() {});
    }
