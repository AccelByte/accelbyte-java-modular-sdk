...
@Getter
@Setter
public class GetUserFriendsWithPlatformOpResponse extends ApiResponseWithData<ModelListBulkUserPlatformsResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.friends.GetUserFriendsWithPlatform";
    }
}