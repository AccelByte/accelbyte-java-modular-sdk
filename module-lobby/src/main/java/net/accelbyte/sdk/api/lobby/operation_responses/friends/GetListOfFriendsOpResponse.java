...
@Getter
@Setter
public class GetListOfFriendsOpResponse extends ApiResponseWithData<ModelGetFriendsResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.lobby.operations.friends.GetListOfFriends";
  }
}
