...
@Getter
@Setter
public class GetOutgoingFriendRequestsOpResponse extends ApiResponseWithData<ModelLoadOutgoingFriendsWithTimeResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.friends.GetOutgoingFriendRequests";
    }
}