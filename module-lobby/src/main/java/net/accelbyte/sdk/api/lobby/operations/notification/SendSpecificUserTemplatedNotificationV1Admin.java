...
public class SendSpecificUserTemplatedNotificationV1Admin extends Operation {
    ...
    */
    ...
    public SendSpecificUserTemplatedNotificationV1AdminOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SendSpecificUserTemplatedNotificationV1AdminOpResponse response = new SendSpecificUserTemplatedNotificationV1AdminOpResponse();
