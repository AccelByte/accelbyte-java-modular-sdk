...
@Getter
@Setter
public class GetUserOutgoingFriendsWithTimeOpResponse extends ApiResponseWithData<List<ModelLoadOutgoingFriendsWithTimeResponse>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.friends.GetUserOutgoingFriendsWithTime";
    }
}