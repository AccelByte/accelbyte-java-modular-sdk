...
public class UpdateLocalizationTemplate extends Operation {
    ...
    */
    ...
    public UpdateLocalizationTemplateOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateLocalizationTemplateOpResponse response = new UpdateLocalizationTemplateOpResponse();
