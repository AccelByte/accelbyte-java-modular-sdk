...
@Getter
@Setter
public class GetAllNotificationTopicsV1AdminOpResponse extends ApiResponseWithData<ModelGetAllNotificationTopicsResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.notification.GetAllNotificationTopicsV1Admin";
    }
}