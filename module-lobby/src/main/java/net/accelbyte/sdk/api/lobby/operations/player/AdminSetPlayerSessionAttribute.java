...
public class AdminSetPlayerSessionAttribute extends Operation {
    ...
    */
    ...
    public AdminSetPlayerSessionAttributeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminSetPlayerSessionAttributeOpResponse response = new AdminSetPlayerSessionAttributeOpResponse();
