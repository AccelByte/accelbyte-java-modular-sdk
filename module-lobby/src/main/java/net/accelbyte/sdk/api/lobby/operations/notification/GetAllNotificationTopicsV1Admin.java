...
public class GetAllNotificationTopicsV1Admin extends Operation {
  ...
  public GetAllNotificationTopicsV1AdminOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetAllNotificationTopicsV1AdminOpResponse response =
        new GetAllNotificationTopicsV1AdminOpResponse();
