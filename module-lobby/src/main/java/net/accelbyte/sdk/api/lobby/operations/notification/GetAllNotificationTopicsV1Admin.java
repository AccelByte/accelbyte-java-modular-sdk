...
public class GetAllNotificationTopicsV1Admin extends Operation {
    ...
    */
    ...
    public GetAllNotificationTopicsV1AdminOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetAllNotificationTopicsV1AdminOpResponse response = new GetAllNotificationTopicsV1AdminOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelGetAllNotificationTopicsResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 401) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelGetAllNotificationTopicsResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
