...
import net.accelbyte.sdk.api.lobby.operation_responses.profanity.AdminGetProfanityRuleOpResponse;
...
public class AdminGetProfanityRule extends Operation {
    ...
    */
    ...
    public AdminGetProfanityRuleOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetProfanityRuleOpResponse response = new AdminGetProfanityRuleOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsProfanityRule().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsProfanityRule parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
