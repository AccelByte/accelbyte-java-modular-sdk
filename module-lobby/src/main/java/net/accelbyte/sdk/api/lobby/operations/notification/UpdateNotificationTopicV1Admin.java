 ...
 *
 * <p>Update notification topic information by topic name. Topic name must be uppercase alphabets
 * and underscores only, no spaces or special characters (e.g. TOPIC_TEST).
 */
@Getter
@Setter
public class UpdateNotificationTopicV1Admin extends Operation {
  ...
  public UpdateNotificationTopicV1Admin(
      String customBasePath, String namespace, String topicName, ModelUpdateTopicRequest body) {
  ...
  public UpdateNotificationTopicV1AdminOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdateNotificationTopicV1AdminOpResponse response =
        new UpdateNotificationTopicV1AdminOpResponse();
