...
public class UpdateNotificationTopicV1Admin extends Operation {
    ...
    */
    ...
    public UpdateNotificationTopicV1AdminOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateNotificationTopicV1AdminOpResponse response = new UpdateNotificationTopicV1AdminOpResponse();
