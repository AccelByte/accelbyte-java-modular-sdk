...
@Getter
@Setter
public class AdminGetConfigV1OpResponse extends ApiResponseWithData<ModelsConfigReq> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.config.AdminGetConfigV1";
    }
}