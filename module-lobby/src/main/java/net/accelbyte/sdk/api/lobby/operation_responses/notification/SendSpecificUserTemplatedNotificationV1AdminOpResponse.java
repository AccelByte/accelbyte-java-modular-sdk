...
@Getter
@Setter
public class SendSpecificUserTemplatedNotificationV1AdminOpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.notification.SendSpecificUserTemplatedNotificationV1Admin";
    }
}