...
public class NotificationWithTemplateByUserID extends Operation {
  ...
  public NotificationWithTemplateByUserIDOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final NotificationWithTemplateByUserIDOpResponse response =
        new NotificationWithTemplateByUserIDOpResponse();
