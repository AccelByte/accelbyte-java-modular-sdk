...
@Getter
@Setter
public class GetLocalizationTemplateOpResponse extends ApiResponseWithData<ModelTemplateLocalization> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.admin.GetLocalizationTemplate";
    }
}