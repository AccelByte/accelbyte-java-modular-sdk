...
import net.accelbyte.sdk.api.lobby.operation_responses.config.AdminGetAllConfigV1OpResponse;
...
public class AdminGetAllConfigV1 extends Operation {
  ...
  public AdminGetAllConfigV1OpResponse parseResponse(
    ...
    if (code == 204) {
      ...
      response.setData(new ModelsConfigList().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
