...
public class PublicUpdatePartyAttributesV1 extends Operation {
    ...
    */
    ...
    public PublicUpdatePartyAttributesV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicUpdatePartyAttributesV1OpResponse response = new PublicUpdatePartyAttributesV1OpResponse();
