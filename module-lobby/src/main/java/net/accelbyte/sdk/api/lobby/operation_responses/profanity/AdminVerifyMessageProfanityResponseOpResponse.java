...
@Getter
@Setter
public class AdminVerifyMessageProfanityResponseOpResponse extends ApiResponseWithData<ModelsAdminVerifyMessageProfanityResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.profanity.AdminVerifyMessageProfanityResponse";
    }
}