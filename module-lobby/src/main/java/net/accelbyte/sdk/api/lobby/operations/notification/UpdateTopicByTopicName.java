...
public class UpdateTopicByTopicName extends Operation {
    ...
    */
    ...
    public UpdateTopicByTopicNameOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateTopicByTopicNameOpResponse response = new UpdateTopicByTopicNameOpResponse();
