...
public class Player {
   ...
   */
  public AdminGetBulkPlayerBlockedPlayersV1OpResponse adminGetBulkPlayerBlockedPlayersV1(
   ...
   */
  @Deprecated
  public AdminGetAllPlayerSessionAttributeOpResponse adminGetAllPlayerSessionAttribute(
   ...
   */
  @Deprecated
  public AdminSetPlayerSessionAttributeOpResponse adminSetPlayerSessionAttribute(
      AdminSetPlayerSessionAttribute input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  @Deprecated
  public AdminGetPlayerSessionAttributeOpResponse adminGetPlayerSessionAttribute(
   ...
   */
  public AdminGetPlayerBlockedPlayersV1OpResponse adminGetPlayerBlockedPlayersV1(
   ...
   */
  public AdminGetPlayerBlockedByPlayersV1OpResponse adminGetPlayerBlockedByPlayersV1(
   ...
   */
  public AdminBulkBlockPlayersV1OpResponse adminBulkBlockPlayersV1(AdminBulkBlockPlayersV1 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminBulkUnblockPlayersV1OpResponse adminBulkUnblockPlayersV1(
      AdminBulkUnblockPlayersV1 input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public PublicPlayerBlockPlayersV1OpResponse publicPlayerBlockPlayersV1(
      PublicPlayerBlockPlayersV1 input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public PublicGetPlayerBlockedPlayersV1OpResponse publicGetPlayerBlockedPlayersV1(
   ...
   */
  public PublicGetPlayerBlockedByPlayersV1OpResponse publicGetPlayerBlockedByPlayersV1(
   ...
   */
  public PublicUnblockPlayerV1OpResponse publicUnblockPlayerV1(PublicUnblockPlayerV1 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
