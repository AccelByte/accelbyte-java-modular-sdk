...
@Getter
@Setter
public class SyncNativeFriendsOpResponse extends ApiResponseWithData<List<ModelNativeFriendSyncResponse>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.friends.SyncNativeFriends";
    }
}