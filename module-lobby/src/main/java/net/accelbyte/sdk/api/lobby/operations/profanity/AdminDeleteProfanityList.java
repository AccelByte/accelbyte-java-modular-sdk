...
import net.accelbyte.sdk.api.lobby.operation_responses.profanity.AdminDeleteProfanityListOpResponse;
...
public class AdminDeleteProfanityList extends Operation {
    ...
    */
    ...
    public AdminDeleteProfanityListOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDeleteProfanityListOpResponse response = new AdminDeleteProfanityListOpResponse();
