...
@Getter
@Setter
public class GetSingleTemplateLocalizationV1AdminOpResponse extends ApiResponseWithData<ModelLocalization> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.notification.GetSingleTemplateLocalizationV1Admin";
    }
}