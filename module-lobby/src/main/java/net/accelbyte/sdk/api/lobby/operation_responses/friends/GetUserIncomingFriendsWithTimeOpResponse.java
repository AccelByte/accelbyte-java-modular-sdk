...
@Getter
@Setter
public class GetUserIncomingFriendsWithTimeOpResponse extends ApiResponseWithData<List<ModelLoadIncomingFriendsWithTimeResponse>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.friends.GetUserIncomingFriendsWithTime";
    }
}