...
@Getter
@Setter
public class GetTopicByNamespaceOpResponse extends ApiResponseWithData<ModelTopicByNamespacesResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.notification.GetTopicByNamespace";
    }
}