...
import net.accelbyte.sdk.api.lobby.operation_responses.admin.DeleteTemplateLocalizationOpResponse;
...
public class DeleteTemplateLocalization extends Operation {
    ...
    */
    ...
    public DeleteTemplateLocalizationOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteTemplateLocalizationOpResponse response = new DeleteTemplateLocalizationOpResponse();
