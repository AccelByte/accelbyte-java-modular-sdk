...
@Getter
@Setter
public class AdminGetProfanityListsOpResponse extends ApiResponseWithData<List<ModelsAdminGetProfanityListsListResponse>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.profanity.AdminGetProfanityLists";
    }
}