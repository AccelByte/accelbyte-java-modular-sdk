...
import net.accelbyte.sdk.api.lobby.operation_responses.profanity.AdminImportProfanityFiltersFromFileOpResponse;
...
public class AdminImportProfanityFiltersFromFile extends Operation {
    ...
    */
    ...
    public AdminImportProfanityFiltersFromFileOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminImportProfanityFiltersFromFileOpResponse response = new AdminImportProfanityFiltersFromFileOpResponse();
