...
public class AdminImportProfanityFiltersFromFile extends Operation {
  ...
  public AdminImportProfanityFiltersFromFile(
      String customBasePath, String list, String namespace, List<Integer> body) {
    this.list = list;
  ...
  public AdminImportProfanityFiltersFromFileOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminImportProfanityFiltersFromFileOpResponse response =
        new AdminImportProfanityFiltersFromFileOpResponse();
