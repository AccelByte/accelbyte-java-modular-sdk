...
public class AdminGetPlayerSessionAttribute extends Operation {
  ...
  public AdminGetPlayerSessionAttribute(
      String customBasePath, String attribute, String namespace, String userId) {
  ...
  public AdminGetPlayerSessionAttributeOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetPlayerSessionAttributeOpResponse response =
        new AdminGetPlayerSessionAttributeOpResponse();
