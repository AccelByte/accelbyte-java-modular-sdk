...
public class AddFriendsWithoutConfirmation extends Operation {
  ...
  public AddFriendsWithoutConfirmation(
      String customBasePath, String namespace, String userId, ModelBulkFriendsRequest body) {
  ...
  public AddFriendsWithoutConfirmationOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AddFriendsWithoutConfirmationOpResponse response =
        new AddFriendsWithoutConfirmationOpResponse();
