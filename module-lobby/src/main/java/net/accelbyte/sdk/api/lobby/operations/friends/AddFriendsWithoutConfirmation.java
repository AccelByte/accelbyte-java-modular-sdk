...
import net.accelbyte.sdk.api.lobby.operation_responses.friends.AddFriendsWithoutConfirmationOpResponse;
...
public class AddFriendsWithoutConfirmation extends Operation {
    ...
    */
    ...
    public AddFriendsWithoutConfirmationOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AddFriendsWithoutConfirmationOpResponse response = new AddFriendsWithoutConfirmationOpResponse();
