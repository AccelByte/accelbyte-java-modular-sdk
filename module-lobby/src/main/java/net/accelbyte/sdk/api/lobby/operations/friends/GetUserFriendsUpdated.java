...
import net.accelbyte.sdk.api.lobby.operation_responses.friends.GetUserFriendsUpdatedOpResponse;
...
public class GetUserFriendsUpdated extends Operation {
    ...
    */
    ...
    public GetUserFriendsUpdatedOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserFriendsUpdatedOpResponse response = new GetUserFriendsUpdatedOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<ModelGetUserFriendsResponse>>() {}));
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public List<ModelGetUserFriendsResponse> parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
