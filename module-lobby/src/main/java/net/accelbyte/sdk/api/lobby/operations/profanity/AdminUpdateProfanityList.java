...
import net.accelbyte.sdk.api.lobby.operation_responses.profanity.AdminUpdateProfanityListOpResponse;
...
public class AdminUpdateProfanityList extends Operation {
    ...
    */
    ...
    public AdminUpdateProfanityListOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateProfanityListOpResponse response = new AdminUpdateProfanityListOpResponse();
