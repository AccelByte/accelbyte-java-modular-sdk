...
@Getter
@Setter
public class GetUserFriendsUpdatedOpResponse extends ApiResponseWithData<List<ModelGetUserFriendsResponse>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.friends.GetUserFriendsUpdated";
    }
}