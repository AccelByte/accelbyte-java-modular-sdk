...
@Getter
@Setter
public class UserRequestFriendOpResponse extends ApiResponse {
    ...
    private RestapiErrorResponseV1 error422 = null;

    private RestapiErrorResponseV1 error500 = null;


    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.friends.UserRequestFriend";
    }
}