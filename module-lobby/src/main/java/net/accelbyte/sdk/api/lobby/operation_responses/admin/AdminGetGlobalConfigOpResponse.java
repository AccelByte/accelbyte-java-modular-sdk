...
@Getter
@Setter
public class AdminGetGlobalConfigOpResponse extends ApiResponseWithData<ModelGlobalConfiguration> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.admin.AdminGetGlobalConfig";
    }
}