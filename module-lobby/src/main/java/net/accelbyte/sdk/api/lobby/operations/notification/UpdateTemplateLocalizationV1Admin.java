...
public class UpdateTemplateLocalizationV1Admin extends Operation {
    ...
    */
    ...
    public UpdateTemplateLocalizationV1AdminOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateTemplateLocalizationV1AdminOpResponse response = new UpdateTemplateLocalizationV1AdminOpResponse();
