...
@Getter
@Setter
public class AdminGetPlayerBlockedByPlayersV1OpResponse extends ApiResponseWithData<ModelsGetAllPlayerBlockedByUsersResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.player.AdminGetPlayerBlockedByPlayersV1";
    }
}