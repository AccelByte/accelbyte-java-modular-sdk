...
@Getter
@Setter
public class AdminGetUserPartyV1OpResponse extends ApiResponseWithData<ModelsPartyData> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.lobby.operations.party.AdminGetUserPartyV1";
  }
}
