...
import net.accelbyte.sdk.api.lobby.operation_responses.third_party.AdminUpdateThirdPartyConfigOpResponse;
...
public class AdminUpdateThirdPartyConfig extends Operation {
    ...
    */
    ...
    public AdminUpdateThirdPartyConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateThirdPartyConfigOpResponse response = new AdminUpdateThirdPartyConfigOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsUpdateConfigResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsUpdateConfigResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
