...
public class AdminUpdateThirdPartyConfig extends Operation {
  ...
  public AdminUpdateThirdPartyConfig(
      String customBasePath, String namespace, ModelsUpdateConfigRequest body) {
  ...
  public AdminUpdateThirdPartyConfigOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminUpdateThirdPartyConfigOpResponse response =
        new AdminUpdateThirdPartyConfigOpResponse();
