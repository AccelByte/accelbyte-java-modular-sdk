...
@Getter
@Setter
public class CreateTopicOpResponse extends ApiResponse {
    ...
    private RestapiErrorResponseBody error409 = null;


    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.notification.CreateTopic";
    }
}