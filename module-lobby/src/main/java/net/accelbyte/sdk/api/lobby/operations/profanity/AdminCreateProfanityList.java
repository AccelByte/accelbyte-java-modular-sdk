...
import net.accelbyte.sdk.api.lobby.operation_responses.profanity.AdminCreateProfanityListOpResponse;
...
public class AdminCreateProfanityList extends Operation {
    ...
    */
    ...
    public AdminCreateProfanityListOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminCreateProfanityListOpResponse response = new AdminCreateProfanityListOpResponse();
