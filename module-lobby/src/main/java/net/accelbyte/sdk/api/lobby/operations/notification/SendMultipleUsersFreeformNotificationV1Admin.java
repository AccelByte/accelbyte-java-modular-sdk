...
public class SendMultipleUsersFreeformNotificationV1Admin extends Operation {
  ...
  public SendMultipleUsersFreeformNotificationV1Admin(
      String customBasePath, String namespace, ModelBulkUsersFreeFormNotificationRequestV1 body) {
  ...
  public SendMultipleUsersFreeformNotificationV1AdminOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final SendMultipleUsersFreeformNotificationV1AdminOpResponse response =
        new SendMultipleUsersFreeformNotificationV1AdminOpResponse();
