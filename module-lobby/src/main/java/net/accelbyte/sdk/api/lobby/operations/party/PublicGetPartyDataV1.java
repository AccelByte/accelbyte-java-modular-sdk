...
public class PublicGetPartyDataV1 extends Operation {
    ...
    */
    ...
    public PublicGetPartyDataV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetPartyDataV1OpResponse response = new PublicGetPartyDataV1OpResponse();
