...
import net.accelbyte.sdk.api.lobby.operation_responses.friends.AdminListFriendsOfFriendsOpResponse;
...
public class AdminListFriendsOfFriends extends Operation {
    ...
    */
    ...
    public AdminListFriendsOfFriendsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminListFriendsOfFriendsOpResponse response = new AdminListFriendsOfFriendsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelFriendshipConnectionResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
