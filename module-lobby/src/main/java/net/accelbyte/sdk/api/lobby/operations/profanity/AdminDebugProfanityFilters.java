...
import net.accelbyte.sdk.api.lobby.operation_responses.profanity.AdminDebugProfanityFiltersOpResponse;
...
public class AdminDebugProfanityFilters extends Operation {
    ...
    */
    ...
    public AdminDebugProfanityFiltersOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDebugProfanityFiltersOpResponse response = new AdminDebugProfanityFiltersOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<ModelsProfanityFilter>>() {}));
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public List<ModelsProfanityFilter> parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
