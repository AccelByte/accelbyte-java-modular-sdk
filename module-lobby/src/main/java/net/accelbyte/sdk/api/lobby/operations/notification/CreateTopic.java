...
public class CreateTopic extends Operation {
  ...
  @Deprecated
  public CreateTopic(String customBasePath, String namespace, ModelCreateTopicRequest body) {
  ...
  public CreateTopicOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final CreateTopicOpResponse response = new CreateTopicOpResponse();
    ...
    if (code == 204) {
      ...
      final String json = Helper.convertInputStreamToString(payload);
      response.setError409(new RestapiErrorResponseBody().createFromJson(json));
