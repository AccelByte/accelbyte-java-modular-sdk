...
public class Config {
   ...
   */
  public AdminExportConfigV1OpResponse adminExportConfigV1(AdminExportConfigV1 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminImportConfigV1OpResponse adminImportConfigV1(AdminImportConfigV1 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
