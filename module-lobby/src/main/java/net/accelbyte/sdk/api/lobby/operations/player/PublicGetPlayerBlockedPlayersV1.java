...
import net.accelbyte.sdk.api.lobby.operation_responses.player.PublicGetPlayerBlockedPlayersV1OpResponse;
...
public class PublicGetPlayerBlockedPlayersV1 extends Operation {
    ...
    */
    ...
    public PublicGetPlayerBlockedPlayersV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetPlayerBlockedPlayersV1OpResponse response = new PublicGetPlayerBlockedPlayersV1OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsGetAllPlayerBlockedUsersResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsGetAllPlayerBlockedUsersResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
