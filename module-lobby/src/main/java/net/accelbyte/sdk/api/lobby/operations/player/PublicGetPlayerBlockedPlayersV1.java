...
public class PublicGetPlayerBlockedPlayersV1 extends Operation {
  ...
  public PublicGetPlayerBlockedPlayersV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGetPlayerBlockedPlayersV1OpResponse response =
        new PublicGetPlayerBlockedPlayersV1OpResponse();
