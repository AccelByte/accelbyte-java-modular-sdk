...
@Getter
@Setter
public class PublicGetPlayerBlockedByPlayersV1OpResponse extends ApiResponseWithData<ModelsGetAllPlayerBlockedByUsersResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.player.PublicGetPlayerBlockedByPlayersV1";
    }
}