...
public class GetMyNotifications extends Operation {
    ...
    */
    ...
    public GetMyNotificationsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetMyNotificationsOpResponse response = new GetMyNotificationsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelNotificationResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
