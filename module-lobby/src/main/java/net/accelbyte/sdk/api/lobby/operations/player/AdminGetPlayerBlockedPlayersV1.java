...
public class AdminGetPlayerBlockedPlayersV1 extends Operation {
  ...
  @Deprecated
  public AdminGetPlayerBlockedPlayersV1(String customBasePath, String namespace, String userId) {
  ...
  public AdminGetPlayerBlockedPlayersV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetPlayerBlockedPlayersV1OpResponse response =
        new AdminGetPlayerBlockedPlayersV1OpResponse();
