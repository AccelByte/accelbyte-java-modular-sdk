...
import net.accelbyte.sdk.api.lobby.operation_responses.player.AdminGetPlayerBlockedPlayersV1OpResponse;
...
public class AdminGetPlayerBlockedPlayersV1 extends Operation {
    ...
    */
    ...
    public AdminGetPlayerBlockedPlayersV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetPlayerBlockedPlayersV1OpResponse response = new AdminGetPlayerBlockedPlayersV1OpResponse();
