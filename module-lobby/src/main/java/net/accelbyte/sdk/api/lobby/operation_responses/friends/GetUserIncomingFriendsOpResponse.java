...
@Getter
@Setter
public class GetUserIncomingFriendsOpResponse extends ApiResponseWithData<List<ModelGetUserIncomingFriendsResponse>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.lobby.operations.friends.GetUserIncomingFriends";
    }
}