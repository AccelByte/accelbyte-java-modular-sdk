...
public class DeleteNotificationTemplateSlugV1Admin extends Operation {
  ...
  public DeleteNotificationTemplateSlugV1Admin(
      String customBasePath, String namespace, String templateSlug) {
  ...
  public DeleteNotificationTemplateSlugV1AdminOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final DeleteNotificationTemplateSlugV1AdminOpResponse response =
        new DeleteNotificationTemplateSlugV1AdminOpResponse();
