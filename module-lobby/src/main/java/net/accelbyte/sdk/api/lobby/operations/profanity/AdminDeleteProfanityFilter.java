...
public class AdminDeleteProfanityFilter extends Operation {
  ...
  public AdminDeleteProfanityFilterOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminDeleteProfanityFilterOpResponse response =
        new AdminDeleteProfanityFilterOpResponse();
    ...
    if (code == 204) {
      ...
      response.setSuccess(true);
      response.setData(
          new ObjectMapper().readValue(json, new TypeReference<List<ModelsProfanityFilter>>() {}));
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
