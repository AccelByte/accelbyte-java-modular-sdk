...
import net.accelbyte.sdk.api.lobby.operation_responses.profanity.AdminDeleteProfanityFilterOpResponse;
...
public class AdminDeleteProfanityFilter extends Operation {
    ...
    */
    ...
    public AdminDeleteProfanityFilterOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDeleteProfanityFilterOpResponse response = new AdminDeleteProfanityFilterOpResponse();
