...
public class AdminUpdateGlobalConfig extends Operation {
    ...
    */
    ...
    public AdminUpdateGlobalConfig(
            String customBasePath,            ModelPutGlobalConfigurationRequest body
    )
    {
        this.body = body;
    ...
    public AdminUpdateGlobalConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
