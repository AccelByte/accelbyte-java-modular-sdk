...
public class UpdateGroupPredefinedRulePublicV2 extends Operation {
  ...
  public UpdateGroupPredefinedRulePublicV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdateGroupPredefinedRulePublicV2OpResponse response =
        new UpdateGroupPredefinedRulePublicV2OpResponse();
