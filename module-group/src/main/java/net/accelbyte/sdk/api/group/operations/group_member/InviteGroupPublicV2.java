...
import net.accelbyte.sdk.api.group.operation_responses.group_member.InviteGroupPublicV2OpResponse;
...
public class InviteGroupPublicV2 extends Operation {
     ...
     */
    private String path = "/group/v2/public/namespaces/{namespace}/users/{userId}/groups/{groupId}/invite";
    ...
    */
    ...
    public InviteGroupPublicV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final InviteGroupPublicV2OpResponse response = new InviteGroupPublicV2OpResponse();
