...
@Getter
@Setter
public class GetGroupListPublicV1OpResponse extends ApiResponseWithData<ModelsGetGroupsListResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group.GetGroupListPublicV1";
    }
}