...
@Getter
@Setter
public class LeaveGroupPublicV1OpResponse extends ApiResponseWithData<ModelsLeaveGroupResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_member.LeaveGroupPublicV1";
    }
}