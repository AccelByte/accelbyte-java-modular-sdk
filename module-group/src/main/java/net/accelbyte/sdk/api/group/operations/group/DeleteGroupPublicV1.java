...
public class DeleteGroupPublicV1 extends Operation {
    ...
    */
    ...
    public DeleteGroupPublicV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteGroupPublicV1OpResponse response = new DeleteGroupPublicV1OpResponse();
