...
import net.accelbyte.sdk.api.group.operation_responses.group_member.CancelGroupJoinRequestV1OpResponse;
...
public class CancelGroupJoinRequestV1 extends Operation {
    ...
    */
    ...
    public CancelGroupJoinRequestV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CancelGroupJoinRequestV1OpResponse response = new CancelGroupJoinRequestV1OpResponse();
