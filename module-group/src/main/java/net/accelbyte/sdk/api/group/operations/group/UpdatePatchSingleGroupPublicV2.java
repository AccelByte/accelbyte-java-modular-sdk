...
public class UpdatePatchSingleGroupPublicV2 extends Operation {
  ...
  public UpdatePatchSingleGroupPublicV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdatePatchSingleGroupPublicV2OpResponse response =
        new UpdatePatchSingleGroupPublicV2OpResponse();
