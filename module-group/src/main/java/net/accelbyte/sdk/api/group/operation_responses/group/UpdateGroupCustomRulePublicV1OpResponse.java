...
@Getter
@Setter
public class UpdateGroupCustomRulePublicV1OpResponse extends ApiResponseWithData<ModelsGroupResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group.UpdateGroupCustomRulePublicV1";
    }
}