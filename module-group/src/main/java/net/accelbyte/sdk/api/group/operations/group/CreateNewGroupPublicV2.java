...
public class CreateNewGroupPublicV2 extends Operation {
    ...
    */
    ...
    public CreateNewGroupPublicV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreateNewGroupPublicV2OpResponse response = new CreateNewGroupPublicV2OpResponse();
