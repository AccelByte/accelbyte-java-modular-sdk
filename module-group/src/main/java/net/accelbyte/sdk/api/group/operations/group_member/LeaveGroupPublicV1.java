...
import net.accelbyte.sdk.api.group.operation_responses.group_member.LeaveGroupPublicV1OpResponse;
...
public class LeaveGroupPublicV1 extends Operation {
    ...
    */
    ...
    public LeaveGroupPublicV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final LeaveGroupPublicV1OpResponse response = new LeaveGroupPublicV1OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsLeaveGroupResponseV1().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsLeaveGroupResponseV1 parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
