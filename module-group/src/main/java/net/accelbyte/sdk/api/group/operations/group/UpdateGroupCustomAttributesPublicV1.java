...
public class UpdateGroupCustomAttributesPublicV1 extends Operation {
  ...
  public UpdateGroupCustomAttributesPublicV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdateGroupCustomAttributesPublicV1OpResponse response =
        new UpdateGroupCustomAttributesPublicV1OpResponse();
