...
public class UpdateGroupConfigurationGlobalRuleAdminV1 extends Operation {
  ...
  public UpdateGroupConfigurationGlobalRuleAdminV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdateGroupConfigurationGlobalRuleAdminV1OpResponse response =
        new UpdateGroupConfigurationGlobalRuleAdminV1OpResponse();
