...
@Getter
@Setter
public class UpdateMemberRolePermissionAdminV1OpResponse extends ApiResponseWithData<ModelsMemberRoleResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_roles.UpdateMemberRolePermissionAdminV1";
    }
}