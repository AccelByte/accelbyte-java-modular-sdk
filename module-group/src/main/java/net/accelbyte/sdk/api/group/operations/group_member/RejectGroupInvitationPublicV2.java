...
public class RejectGroupInvitationPublicV2 extends Operation {
  ...
  @Deprecated
  public RejectGroupInvitationPublicV2(String customBasePath, String groupId, String namespace) {
  ...
  public RejectGroupInvitationPublicV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final RejectGroupInvitationPublicV2OpResponse response =
        new RejectGroupInvitationPublicV2OpResponse();
