...
@Getter
@Setter
public class GetGroupJoinRequestPublicV1OpResponse extends ApiResponseWithData<ModelsGetMemberRequestsListResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.member_request.GetGroupJoinRequestPublicV1";
    }
}