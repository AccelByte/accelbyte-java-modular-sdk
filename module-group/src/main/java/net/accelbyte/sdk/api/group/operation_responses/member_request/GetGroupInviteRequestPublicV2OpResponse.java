...
@Getter
@Setter
public class GetGroupInviteRequestPublicV2OpResponse extends ApiResponseWithData<ModelsGetMemberRequestsListResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.member_request.GetGroupInviteRequestPublicV2";
    }
}