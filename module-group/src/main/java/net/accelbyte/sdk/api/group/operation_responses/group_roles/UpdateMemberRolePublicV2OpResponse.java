...
@Getter
@Setter
public class UpdateMemberRolePublicV2OpResponse extends ApiResponseWithData<ModelsGetUserGroupInformationResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_roles.UpdateMemberRolePublicV2";
    }
}