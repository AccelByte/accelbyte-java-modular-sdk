...
public class GetGroupJoinRequestPublicV2 extends Operation {
    ...
    */
    ...
    public GetGroupJoinRequestPublicV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetGroupJoinRequestPublicV2OpResponse response = new GetGroupJoinRequestPublicV2OpResponse();
