...
public class InitiateGroupConfigurationAdminV1 extends Operation {
    ...
    */
    ...
    public InitiateGroupConfigurationAdminV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final InitiateGroupConfigurationAdminV1OpResponse response = new InitiateGroupConfigurationAdminV1OpResponse();
