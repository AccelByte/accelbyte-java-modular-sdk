...
@Getter
@Setter
public class UpdateGroupPredefinedRulePublicV1OpResponse extends ApiResponseWithData<ModelsGroupResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group.UpdateGroupPredefinedRulePublicV1";
    }
}