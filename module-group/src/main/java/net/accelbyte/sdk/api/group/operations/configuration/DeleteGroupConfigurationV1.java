...
public class DeleteGroupConfigurationV1 extends Operation {
    ...
    */
    ...
    public DeleteGroupConfigurationV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteGroupConfigurationV1OpResponse response = new DeleteGroupConfigurationV1OpResponse();
