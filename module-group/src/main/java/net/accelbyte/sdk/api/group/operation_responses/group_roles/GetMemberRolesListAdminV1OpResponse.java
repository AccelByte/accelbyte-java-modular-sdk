...
@Getter
@Setter
public class GetMemberRolesListAdminV1OpResponse extends ApiResponseWithData<ModelsGetMemberRolesListResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_roles.GetMemberRolesListAdminV1";
    }
}