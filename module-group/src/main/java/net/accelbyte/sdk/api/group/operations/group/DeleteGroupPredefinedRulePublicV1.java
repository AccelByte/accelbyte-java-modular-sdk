...
public class DeleteGroupPredefinedRulePublicV1 extends Operation {
    ...
    */
    ...
    public DeleteGroupPredefinedRulePublicV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteGroupPredefinedRulePublicV1OpResponse response = new DeleteGroupPredefinedRulePublicV1OpResponse();
