...
import net.accelbyte.sdk.api.group.operation_responses.group_member.KickGroupMemberPublicV1OpResponse;
...
public class KickGroupMemberPublicV1 extends Operation {
  ...
  @Deprecated
  public KickGroupMemberPublicV1(String customBasePath, String namespace, String userId) {
  ...
  public KickGroupMemberPublicV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final KickGroupMemberPublicV1OpResponse response = new KickGroupMemberPublicV1OpResponse();
