...
@Getter
@Setter
public class GetSingleMemberRoleAdminV1OpResponse extends ApiResponseWithData<ModelsMemberRoleResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_roles.GetSingleMemberRoleAdminV1";
    }
}