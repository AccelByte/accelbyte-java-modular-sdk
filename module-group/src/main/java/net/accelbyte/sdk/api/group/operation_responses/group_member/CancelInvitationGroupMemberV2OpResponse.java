...
@Getter
@Setter
public class CancelInvitationGroupMemberV2OpResponse extends ApiResponseWithData<ModelsCancelInvitationGroupResponseV2> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_member.CancelInvitationGroupMemberV2";
    }
}