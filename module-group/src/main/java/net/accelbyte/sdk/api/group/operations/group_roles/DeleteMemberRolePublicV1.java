...
import net.accelbyte.sdk.api.group.operation_responses.group_roles.DeleteMemberRolePublicV1OpResponse;
...
public class DeleteMemberRolePublicV1 extends Operation {
    ...
    */
    ...
    public DeleteMemberRolePublicV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteMemberRolePublicV1OpResponse response = new DeleteMemberRolePublicV1OpResponse();
