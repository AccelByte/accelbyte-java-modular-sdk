...
import net.accelbyte.sdk.api.group.operation_responses.group_member.LeaveGroupPublicV2OpResponse;
...
public class LeaveGroupPublicV2 extends Operation {
    ...
    */
    ...
    public LeaveGroupPublicV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final LeaveGroupPublicV2OpResponse response = new LeaveGroupPublicV2OpResponse();
