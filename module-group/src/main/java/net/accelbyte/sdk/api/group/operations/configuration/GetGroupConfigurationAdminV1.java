...
public class GetGroupConfigurationAdminV1 extends Operation {
    ...
    */
    ...
    public GetGroupConfigurationAdminV1(
            String customBasePath,            String configurationCode,
            String namespace
    )
    {
    ...
    public GetGroupConfigurationAdminV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetGroupConfigurationAdminV1OpResponse response = new GetGroupConfigurationAdminV1OpResponse();
