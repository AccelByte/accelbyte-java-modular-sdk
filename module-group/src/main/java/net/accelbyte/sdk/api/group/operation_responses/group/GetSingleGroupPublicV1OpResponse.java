...
@Getter
@Setter
public class GetSingleGroupPublicV1OpResponse extends ApiResponseWithData<ModelsGroupResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group.GetSingleGroupPublicV1";
    }
}