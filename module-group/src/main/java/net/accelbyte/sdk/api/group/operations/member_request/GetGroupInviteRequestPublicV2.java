...
public class GetGroupInviteRequestPublicV2 extends Operation {
    ...
    */
    ...
    public GetGroupInviteRequestPublicV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetGroupInviteRequestPublicV2OpResponse response = new GetGroupInviteRequestPublicV2OpResponse();
