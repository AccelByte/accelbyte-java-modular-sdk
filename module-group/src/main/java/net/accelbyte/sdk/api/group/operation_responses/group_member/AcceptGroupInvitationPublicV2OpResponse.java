...
@Getter
@Setter
public class AcceptGroupInvitationPublicV2OpResponse extends ApiResponseWithData<ModelsMemberRequestGroupResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_member.AcceptGroupInvitationPublicV2";
    }
}