...
import net.accelbyte.sdk.api.group.operation_responses.group_member.AcceptGroupJoinRequestPublicV1OpResponse;
...
public class AcceptGroupJoinRequestPublicV1 extends Operation {
  ...
  @Deprecated
  public AcceptGroupJoinRequestPublicV1(String customBasePath, String namespace, String userId) {
  ...
  public AcceptGroupJoinRequestPublicV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AcceptGroupJoinRequestPublicV1OpResponse response =
        new AcceptGroupJoinRequestPublicV1OpResponse();
