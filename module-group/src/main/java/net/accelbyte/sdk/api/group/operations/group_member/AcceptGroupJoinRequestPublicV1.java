...
public class AcceptGroupJoinRequestPublicV1 extends Operation {
    ...
    */
    ...
    public AcceptGroupJoinRequestPublicV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AcceptGroupJoinRequestPublicV1OpResponse response = new AcceptGroupJoinRequestPublicV1OpResponse();
