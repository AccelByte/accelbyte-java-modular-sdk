...
@Getter
@Setter
public class GetMemberRolesListPublicV1OpResponse extends ApiResponseWithData<ModelsGetMemberRolesListResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_roles.GetMemberRolesListPublicV1";
    }
}