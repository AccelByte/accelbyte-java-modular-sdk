...
import net.accelbyte.sdk.api.group.operation_responses.group_roles.GetSingleMemberRoleAdminV1OpResponse;
...
public class GetSingleMemberRoleAdminV1 extends Operation {
    ...
    */
    ...
    public GetSingleMemberRoleAdminV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetSingleMemberRoleAdminV1OpResponse response = new GetSingleMemberRoleAdminV1OpResponse();
