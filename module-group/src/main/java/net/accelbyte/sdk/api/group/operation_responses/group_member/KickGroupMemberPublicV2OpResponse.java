...
@Getter
@Setter
public class KickGroupMemberPublicV2OpResponse extends ApiResponseWithData<ModelsKickGroupMemberResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_member.KickGroupMemberPublicV2";
    }
}