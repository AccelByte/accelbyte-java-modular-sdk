...
public class CreateGroupConfigurationAdminV1 extends Operation {
    ...
    */
    ...
    public CreateGroupConfigurationAdminV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreateGroupConfigurationAdminV1OpResponse response = new CreateGroupConfigurationAdminV1OpResponse();
