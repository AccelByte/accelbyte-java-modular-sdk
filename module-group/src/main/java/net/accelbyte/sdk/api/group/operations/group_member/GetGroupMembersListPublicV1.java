...
import net.accelbyte.sdk.api.group.operation_responses.group_member.GetGroupMembersListPublicV1OpResponse;
...
public class GetGroupMembersListPublicV1 extends Operation {
    ...
    */
    ...
    public GetGroupMembersListPublicV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetGroupMembersListPublicV1OpResponse response = new GetGroupMembersListPublicV1OpResponse();
