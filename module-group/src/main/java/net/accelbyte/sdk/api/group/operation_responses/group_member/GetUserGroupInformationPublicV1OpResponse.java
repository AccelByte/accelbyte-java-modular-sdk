...
@Getter
@Setter
public class GetUserGroupInformationPublicV1OpResponse extends ApiResponseWithData<ModelsGetUserGroupInformationResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_member.GetUserGroupInformationPublicV1";
    }
}