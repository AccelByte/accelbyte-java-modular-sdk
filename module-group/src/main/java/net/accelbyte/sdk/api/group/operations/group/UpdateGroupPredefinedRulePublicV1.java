...
public class UpdateGroupPredefinedRulePublicV1 extends Operation {
  ...
  public UpdateGroupPredefinedRulePublicV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdateGroupPredefinedRulePublicV1OpResponse response =
        new UpdateGroupPredefinedRulePublicV1OpResponse();
