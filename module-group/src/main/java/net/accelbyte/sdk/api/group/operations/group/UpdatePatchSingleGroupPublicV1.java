...
public class UpdatePatchSingleGroupPublicV1 extends Operation {
  ...
  public UpdatePatchSingleGroupPublicV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdatePatchSingleGroupPublicV1OpResponse response =
        new UpdatePatchSingleGroupPublicV1OpResponse();
