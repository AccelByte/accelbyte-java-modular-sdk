...
public class GetGroupJoinRequestPublicV1 extends Operation {
    ...
    */
    ...
    public GetGroupJoinRequestPublicV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetGroupJoinRequestPublicV1OpResponse response = new GetGroupJoinRequestPublicV1OpResponse();
