...
public class DeleteGroupAdminV1 extends Operation {
    ...
    */
    ...
    public DeleteGroupAdminV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteGroupAdminV1OpResponse response = new DeleteGroupAdminV1OpResponse();
