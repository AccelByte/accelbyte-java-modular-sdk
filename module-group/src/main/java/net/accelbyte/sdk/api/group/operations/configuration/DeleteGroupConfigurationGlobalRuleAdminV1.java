...
public class DeleteGroupConfigurationGlobalRuleAdminV1 extends Operation {
    ...
    */
    ...
    public DeleteGroupConfigurationGlobalRuleAdminV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteGroupConfigurationGlobalRuleAdminV1OpResponse response = new DeleteGroupConfigurationGlobalRuleAdminV1OpResponse();
