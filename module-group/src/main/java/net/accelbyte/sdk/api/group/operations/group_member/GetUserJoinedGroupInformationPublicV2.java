...
import net.accelbyte.sdk.api.group.operation_responses.group_member.GetUserJoinedGroupInformationPublicV2OpResponse;
...
public class GetUserJoinedGroupInformationPublicV2 extends Operation {
    ...
    */
    ...
    public GetUserJoinedGroupInformationPublicV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserJoinedGroupInformationPublicV2OpResponse response = new GetUserJoinedGroupInformationPublicV2OpResponse();
