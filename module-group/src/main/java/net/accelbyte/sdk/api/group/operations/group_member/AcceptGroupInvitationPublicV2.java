...
public class AcceptGroupInvitationPublicV2 extends Operation {
    ...
    */
    ...
    public AcceptGroupInvitationPublicV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AcceptGroupInvitationPublicV2OpResponse response = new AcceptGroupInvitationPublicV2OpResponse();
