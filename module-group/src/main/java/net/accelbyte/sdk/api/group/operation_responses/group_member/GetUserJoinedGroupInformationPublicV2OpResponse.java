...
@Getter
@Setter
public class GetUserJoinedGroupInformationPublicV2OpResponse extends ApiResponseWithData<ModelsGetGroupMemberListResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_member.GetUserJoinedGroupInformationPublicV2";
    }
}