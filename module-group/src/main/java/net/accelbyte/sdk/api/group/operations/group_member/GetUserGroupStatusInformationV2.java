...
public class GetUserGroupStatusInformationV2 extends Operation {
     ...
     */
    private String path = "/group/v2/public/namespaces/{namespace}/users/{userId}/groups/{groupId}/status";
    ...
    */
    ...
    public GetUserGroupStatusInformationV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserGroupStatusInformationV2OpResponse response = new GetUserGroupStatusInformationV2OpResponse();
