...
@Getter
@Setter
public class GetListGroupByIDsAdminV2OpResponse extends ApiResponseWithData<ModelsGetGroupsResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group.GetListGroupByIDsAdminV2";
    }
}