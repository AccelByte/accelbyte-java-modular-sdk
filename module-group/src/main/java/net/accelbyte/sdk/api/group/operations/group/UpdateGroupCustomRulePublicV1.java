...
public class UpdateGroupCustomRulePublicV1 extends Operation {
    ...
    */
    ...
    public UpdateGroupCustomRulePublicV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateGroupCustomRulePublicV1OpResponse response = new UpdateGroupCustomRulePublicV1OpResponse();
