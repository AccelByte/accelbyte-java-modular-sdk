...
public class RejectGroupJoinRequestPublicV1 extends Operation {
    ...
    */
    ...
    public RejectGroupJoinRequestPublicV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RejectGroupJoinRequestPublicV1OpResponse response = new RejectGroupJoinRequestPublicV1OpResponse();
