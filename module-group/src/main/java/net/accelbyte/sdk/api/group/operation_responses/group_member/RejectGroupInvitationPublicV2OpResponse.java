...
@Getter
@Setter
public class RejectGroupInvitationPublicV2OpResponse extends ApiResponseWithData<ModelsMemberRequestGroupResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_member.RejectGroupInvitationPublicV2";
    }
}