...
import net.accelbyte.sdk.api.group.operation_responses.group_roles.UpdateMemberRolePublicV2OpResponse;
...
public class UpdateMemberRolePublicV2 extends Operation {
     ...
     */
    private String path = "/group/v2/public/namespaces/{namespace}/roles/{memberRoleId}/groups/{groupId}/members";
    ...
    */
    ...
    public UpdateMemberRolePublicV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateMemberRolePublicV2OpResponse response = new UpdateMemberRolePublicV2OpResponse();
