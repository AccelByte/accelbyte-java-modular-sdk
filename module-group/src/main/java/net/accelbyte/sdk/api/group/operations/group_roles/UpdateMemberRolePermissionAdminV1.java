...
public class UpdateMemberRolePermissionAdminV1 extends Operation {
    ...
    */
    ...
    public UpdateMemberRolePermissionAdminV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateMemberRolePermissionAdminV1OpResponse response = new UpdateMemberRolePermissionAdminV1OpResponse();
