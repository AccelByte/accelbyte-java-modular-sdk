...
public class GetGroupInvitationRequestPublicV1 extends Operation {
    ...
    */
    ...
    public GetGroupInvitationRequestPublicV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetGroupInvitationRequestPublicV1OpResponse response = new GetGroupInvitationRequestPublicV1OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsGetMemberRequestsListResponseV1().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsGetMemberRequestsListResponseV1 parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
