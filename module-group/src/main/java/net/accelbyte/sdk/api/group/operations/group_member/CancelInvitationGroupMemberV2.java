...
public class CancelInvitationGroupMemberV2 extends Operation {
  ...
  public CancelInvitationGroupMemberV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final CancelInvitationGroupMemberV2OpResponse response =
        new CancelInvitationGroupMemberV2OpResponse();
