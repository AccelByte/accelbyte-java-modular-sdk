...
@Getter
@Setter
public class GetSingleGroupAdminV1OpResponse extends ApiResponseWithData<ModelsGroupResponseV1> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.group.operations.group.GetSingleGroupAdminV1";
  }
}
