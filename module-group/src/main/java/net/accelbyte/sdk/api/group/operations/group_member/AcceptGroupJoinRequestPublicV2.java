...
import net.accelbyte.sdk.api.group.operation_responses.group_member.AcceptGroupJoinRequestPublicV2OpResponse;
...
public class AcceptGroupJoinRequestPublicV2 extends Operation {
     ...
     */
    private String path = "/group/v2/public/namespaces/{namespace}/users/{userId}/groups/{groupId}/join/accept";
    ...
    */
    ...
    public AcceptGroupJoinRequestPublicV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AcceptGroupJoinRequestPublicV2OpResponse response = new AcceptGroupJoinRequestPublicV2OpResponse();
