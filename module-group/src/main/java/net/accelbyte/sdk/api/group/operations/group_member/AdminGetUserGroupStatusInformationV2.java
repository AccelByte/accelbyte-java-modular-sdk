...
public class AdminGetUserGroupStatusInformationV2 extends Operation {
  ...
  public AdminGetUserGroupStatusInformationV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetUserGroupStatusInformationV2OpResponse response =
        new AdminGetUserGroupStatusInformationV2OpResponse();
