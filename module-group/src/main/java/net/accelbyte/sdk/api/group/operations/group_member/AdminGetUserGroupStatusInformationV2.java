...
import net.accelbyte.sdk.api.group.operation_responses.group_member.AdminGetUserGroupStatusInformationV2OpResponse;
...
public class AdminGetUserGroupStatusInformationV2 extends Operation {
     ...
     */
    private String path = "/group/v2/admin/namespaces/{namespace}/users/{userId}/groups/{groupId}/status";
    ...
    */
    ...
    public AdminGetUserGroupStatusInformationV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetUserGroupStatusInformationV2OpResponse response = new AdminGetUserGroupStatusInformationV2OpResponse();
