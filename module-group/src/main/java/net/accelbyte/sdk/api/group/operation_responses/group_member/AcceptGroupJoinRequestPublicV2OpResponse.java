...
@Getter
@Setter
public class AcceptGroupJoinRequestPublicV2OpResponse extends ApiResponseWithData<ModelsMemberRequestGroupResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_member.AcceptGroupJoinRequestPublicV2";
    }
}