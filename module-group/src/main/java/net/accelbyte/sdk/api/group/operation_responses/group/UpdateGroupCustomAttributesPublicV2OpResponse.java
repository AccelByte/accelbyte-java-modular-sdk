...
@Getter
@Setter
public class UpdateGroupCustomAttributesPublicV2OpResponse extends ApiResponseWithData<ModelsGroupResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group.UpdateGroupCustomAttributesPublicV2";
    }
}