...
public class UpdateGroupCustomAttributesPublicV2 extends Operation {
     ...
     */
    private String path = "/group/v2/public/namespaces/{namespace}/groups/{groupId}/attributes/custom";
    ...
    */
    ...
    public UpdateGroupCustomAttributesPublicV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateGroupCustomAttributesPublicV2OpResponse response = new UpdateGroupCustomAttributesPublicV2OpResponse();
