...
public class UpdateGroupCustomRulePublicV2 extends Operation {
    ...
    */
    ...
    public UpdateGroupCustomRulePublicV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateGroupCustomRulePublicV2OpResponse response = new UpdateGroupCustomRulePublicV2OpResponse();
