...
@Getter
@Setter
public class UpdatePutSingleGroupPublicV2OpResponse extends ApiResponseWithData<ModelsGroupResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group.UpdatePutSingleGroupPublicV2";
    }
}