...
import net.accelbyte.sdk.api.group.operation_responses.group_member.JoinGroupV1OpResponse;
...
public class JoinGroupV1 extends Operation {
  ...
  @Deprecated
  public JoinGroupV1(String customBasePath, String groupId, String namespace) {
  ...
  public JoinGroupV1OpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final JoinGroupV1OpResponse response = new JoinGroupV1OpResponse();
