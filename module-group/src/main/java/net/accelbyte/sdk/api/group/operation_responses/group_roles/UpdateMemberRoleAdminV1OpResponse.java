...
@Getter
@Setter
public class UpdateMemberRoleAdminV1OpResponse extends ApiResponseWithData<ModelsMemberRoleResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_roles.UpdateMemberRoleAdminV1";
    }
}