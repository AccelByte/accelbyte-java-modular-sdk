...
public class AcceptGroupInvitationPublicV1 extends Operation {
    ...
    */
    ...
    public AcceptGroupInvitationPublicV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AcceptGroupInvitationPublicV1OpResponse response = new AcceptGroupInvitationPublicV1OpResponse();
