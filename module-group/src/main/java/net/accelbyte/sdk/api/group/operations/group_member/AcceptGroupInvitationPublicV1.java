...
import net.accelbyte.sdk.api.group.operation_responses.group_member.AcceptGroupInvitationPublicV1OpResponse;
...
public class AcceptGroupInvitationPublicV1 extends Operation {
  ...
  @Deprecated
  public AcceptGroupInvitationPublicV1(String customBasePath, String groupId, String namespace) {
  ...
  public AcceptGroupInvitationPublicV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AcceptGroupInvitationPublicV1OpResponse response =
        new AcceptGroupInvitationPublicV1OpResponse();
