...
@Getter
@Setter
public class JoinGroupV1OpResponse extends ApiResponseWithData<ModelsJoinGroupResponseV1> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.group.operations.group_member.JoinGroupV1";
  }
}
