...
@Getter
@Setter
public class RejectGroupJoinRequestPublicV1OpResponse extends ApiResponseWithData<ModelsMemberRequestGroupResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_member.RejectGroupJoinRequestPublicV1";
    }
}