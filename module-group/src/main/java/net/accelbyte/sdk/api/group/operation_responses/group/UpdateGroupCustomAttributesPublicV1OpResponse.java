...
@Getter
@Setter
public class UpdateGroupCustomAttributesPublicV1OpResponse extends ApiResponseWithData<ModelsGroupResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group.UpdateGroupCustomAttributesPublicV1";
    }
}