...
@Getter
@Setter
public class GetUserGroupInformationPublicV2OpResponse extends ApiResponseWithData<ModelsGetGroupMemberListResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_member.GetUserGroupInformationPublicV2";
    }
}