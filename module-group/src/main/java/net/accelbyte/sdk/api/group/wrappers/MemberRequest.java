...
public class MemberRequest {
   ...
   */
  public GetGroupJoinRequestPublicV1OpResponse getGroupJoinRequestPublicV1(
   ...
   */
  public GetGroupInvitationRequestPublicV1OpResponse getGroupInvitationRequestPublicV1(
   ...
   */
  public GetGroupInviteRequestPublicV2OpResponse getGroupInviteRequestPublicV2(
   ...
   */
  public GetGroupJoinRequestPublicV2OpResponse getGroupJoinRequestPublicV2(
   ...
   */
  public GetMyGroupJoinRequestV2OpResponse getMyGroupJoinRequestV2(GetMyGroupJoinRequestV2 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
