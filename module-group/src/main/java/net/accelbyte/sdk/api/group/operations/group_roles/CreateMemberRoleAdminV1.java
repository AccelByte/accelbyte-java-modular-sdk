...
import net.accelbyte.sdk.api.group.operation_responses.group_roles.CreateMemberRoleAdminV1OpResponse;
...
public class CreateMemberRoleAdminV1 extends Operation {
    ...
    */
    ...
    public CreateMemberRoleAdminV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreateMemberRoleAdminV1OpResponse response = new CreateMemberRoleAdminV1OpResponse();
