...
@Getter
@Setter
public class GetGroupListAdminV1OpResponse extends ApiResponseWithData<ModelsGetGroupsListResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group.GetGroupListAdminV1";
    }
}