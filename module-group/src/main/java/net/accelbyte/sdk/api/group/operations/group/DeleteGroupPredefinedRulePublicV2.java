...
public class DeleteGroupPredefinedRulePublicV2 extends Operation {
     ...
     */
    private String path = "/group/v2/public/namespaces/{namespace}/groups/{groupId}/rules/defined/{allowedAction}";
    ...
    */
    ...
    public DeleteGroupPredefinedRulePublicV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteGroupPredefinedRulePublicV2OpResponse response = new DeleteGroupPredefinedRulePublicV2OpResponse();
