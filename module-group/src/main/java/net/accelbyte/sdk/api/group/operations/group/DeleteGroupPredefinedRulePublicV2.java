...
public class DeleteGroupPredefinedRulePublicV2 extends Operation {
  ...
  public DeleteGroupPredefinedRulePublicV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final DeleteGroupPredefinedRulePublicV2OpResponse response =
        new DeleteGroupPredefinedRulePublicV2OpResponse();
