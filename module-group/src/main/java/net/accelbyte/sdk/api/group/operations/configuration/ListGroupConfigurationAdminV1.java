...
public class ListGroupConfigurationAdminV1 extends Operation {
    ...
    */
    ...
    public ListGroupConfigurationAdminV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ListGroupConfigurationAdminV1OpResponse response = new ListGroupConfigurationAdminV1OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsListConfigurationResponseV1().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsListConfigurationResponseV1 parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
