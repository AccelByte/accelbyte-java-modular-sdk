...
public class ListGroupConfigurationAdminV1 extends Operation {
  ...
  public ListGroupConfigurationAdminV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final ListGroupConfigurationAdminV1OpResponse response =
        new ListGroupConfigurationAdminV1OpResponse();
