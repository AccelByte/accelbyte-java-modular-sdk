...
import net.accelbyte.sdk.api.group.operation_responses.group_member.GetUserGroupInformationPublicV1OpResponse;
...
public class GetUserGroupInformationPublicV1 extends Operation {
  ...
  @Deprecated
  public GetUserGroupInformationPublicV1(String customBasePath, String namespace, String userId) {
  ...
  public GetUserGroupInformationPublicV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetUserGroupInformationPublicV1OpResponse response =
        new GetUserGroupInformationPublicV1OpResponse();
