...
public class GetUserGroupInformationPublicV1 extends Operation {
    ...
    */
    ...
    public GetUserGroupInformationPublicV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserGroupInformationPublicV1OpResponse response = new GetUserGroupInformationPublicV1OpResponse();
