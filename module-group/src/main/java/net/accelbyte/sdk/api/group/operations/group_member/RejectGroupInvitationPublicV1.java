...
import net.accelbyte.sdk.api.group.operation_responses.group_member.RejectGroupInvitationPublicV1OpResponse;
...
public class RejectGroupInvitationPublicV1 extends Operation {
    ...
    */
    ...
    public RejectGroupInvitationPublicV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RejectGroupInvitationPublicV1OpResponse response = new RejectGroupInvitationPublicV1OpResponse();
