...
public class RejectGroupInvitationPublicV1 extends Operation {
  ...
  @Deprecated
  public RejectGroupInvitationPublicV1(String customBasePath, String groupId, String namespace) {
  ...
  public RejectGroupInvitationPublicV1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final RejectGroupInvitationPublicV1OpResponse response =
        new RejectGroupInvitationPublicV1OpResponse();
