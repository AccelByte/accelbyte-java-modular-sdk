...
public class GetSingleGroupAdminV1 extends Operation {
    ...
    */
    ...
    public GetSingleGroupAdminV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetSingleGroupAdminV1OpResponse response = new GetSingleGroupAdminV1OpResponse();
