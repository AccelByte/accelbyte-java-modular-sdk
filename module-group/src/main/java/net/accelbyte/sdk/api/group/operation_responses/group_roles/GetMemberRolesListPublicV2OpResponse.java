...
@Getter
@Setter
public class GetMemberRolesListPublicV2OpResponse extends ApiResponseWithData<ModelsGetMemberRolesListResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_roles.GetMemberRolesListPublicV2";
    }
}