...
public class GetUserGroupInformationPublicV2 extends Operation {
  ...
  public GetUserGroupInformationPublicV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetUserGroupInformationPublicV2OpResponse response =
        new GetUserGroupInformationPublicV2OpResponse();
