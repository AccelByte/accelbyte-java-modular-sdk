...
@Getter
@Setter
public class CreateNewGroupPublicV1OpResponse extends ApiResponseWithData<ModelsGroupResponseV1> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.group.operations.group.CreateNewGroupPublicV1";
  }
}
