...
public class DeleteGroupPublicV2 extends Operation {
    ...
    */
    ...
    public DeleteGroupPublicV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteGroupPublicV2OpResponse response = new DeleteGroupPublicV2OpResponse();
