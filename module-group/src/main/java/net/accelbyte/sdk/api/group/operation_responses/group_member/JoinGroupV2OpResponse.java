...
@Getter
@Setter
public class JoinGroupV2OpResponse extends ApiResponseWithData<ModelsJoinGroupResponseV1> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.group.operations.group_member.JoinGroupV2";
  }
}
