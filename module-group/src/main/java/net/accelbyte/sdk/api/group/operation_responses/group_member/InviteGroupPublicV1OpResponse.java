...
@Getter
@Setter
public class InviteGroupPublicV1OpResponse extends ApiResponseWithData<ModelsUserInvitationResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_member.InviteGroupPublicV1";
    }
}