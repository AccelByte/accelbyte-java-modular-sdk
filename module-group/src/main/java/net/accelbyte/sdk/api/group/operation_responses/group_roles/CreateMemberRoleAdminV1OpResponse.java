...
@Getter
@Setter
public class CreateMemberRoleAdminV1OpResponse extends ApiResponseWithData<ModelsMemberRoleResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_roles.CreateMemberRoleAdminV1";
    }
}