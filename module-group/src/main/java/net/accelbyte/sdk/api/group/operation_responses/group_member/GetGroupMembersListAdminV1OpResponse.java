...
@Getter
@Setter
public class GetGroupMembersListAdminV1OpResponse extends ApiResponseWithData<ModelsGetGroupMemberListResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_member.GetGroupMembersListAdminV1";
    }
}