...
public class UpdateSingleGroupV1 extends Operation {
    ...
    */
    ...
    public UpdateSingleGroupV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateSingleGroupV1OpResponse response = new UpdateSingleGroupV1OpResponse();
