...
public class GetGroupListPublicV1 extends Operation {
    ...
    */
    ...
    public GetGroupListPublicV1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetGroupListPublicV1OpResponse response = new GetGroupListPublicV1OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsGetGroupsListResponseV1().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsGetGroupsListResponseV1 parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
