...
@Getter
@Setter
public class UpdateGroupPredefinedRulePublicV2OpResponse extends ApiResponseWithData<ModelsGroupResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group.UpdateGroupPredefinedRulePublicV2";
    }
}