...
@Getter
@Setter
public class UpdateMemberRolePublicV1OpResponse extends ApiResponseWithData<ModelsGetUserGroupInformationResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group_roles.UpdateMemberRolePublicV1";
    }
}