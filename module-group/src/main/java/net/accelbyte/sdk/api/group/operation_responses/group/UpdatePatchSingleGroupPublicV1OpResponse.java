...
@Getter
@Setter
public class UpdatePatchSingleGroupPublicV1OpResponse extends ApiResponseWithData<ModelsGroupResponseV1> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.group.operations.group.UpdatePatchSingleGroupPublicV1";
    }
}