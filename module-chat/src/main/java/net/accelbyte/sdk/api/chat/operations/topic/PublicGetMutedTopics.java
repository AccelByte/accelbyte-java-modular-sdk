...
public class PublicGetMutedTopics extends Operation {
    ...
    */
    ...
    public PublicGetMutedTopicsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetMutedTopicsOpResponse response = new PublicGetMutedTopicsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<ApiMutedTopicResponse>>() {}));
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
