...
@Getter
@Setter
public class AdminChatHistoryOpResponse extends ApiResponseWithData<ModelsChatMessageWithPaginationResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.chat.operations.topic.AdminChatHistory";
    }
}