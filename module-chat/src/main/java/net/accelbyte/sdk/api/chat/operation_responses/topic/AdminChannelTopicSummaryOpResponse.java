...
@Getter
@Setter
public class AdminChannelTopicSummaryOpResponse extends ApiResponseWithData<ModelsChannelTopicSummaryResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.chat.operations.topic.AdminChannelTopicSummary";
    }
}