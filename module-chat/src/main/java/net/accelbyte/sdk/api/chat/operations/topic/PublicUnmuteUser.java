...
public class PublicUnmuteUser extends Operation {
  ...
  public PublicUnmuteUser(
      String customBasePath, String namespace, String topic, ApiUnmuteUserRequest body) {
  ...
  public PublicUnmuteUserOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final PublicUnmuteUserOpResponse response = new PublicUnmuteUserOpResponse();
