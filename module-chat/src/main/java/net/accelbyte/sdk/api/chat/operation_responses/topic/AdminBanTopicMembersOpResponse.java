...
@Getter
@Setter
public class AdminBanTopicMembersOpResponse extends ApiResponseWithData<ModelsBanTopicMemberResult> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.chat.operations.topic.AdminBanTopicMembers";
    }
}