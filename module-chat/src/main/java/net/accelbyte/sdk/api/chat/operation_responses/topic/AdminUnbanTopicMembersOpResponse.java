...
@Getter
@Setter
public class AdminUnbanTopicMembersOpResponse extends ApiResponseWithData<ModelsUnbanTopicMemberResult> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.chat.operations.topic.AdminUnbanTopicMembers";
    }
}