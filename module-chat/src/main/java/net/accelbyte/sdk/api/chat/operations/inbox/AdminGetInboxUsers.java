...
public class AdminGetInboxUsers extends Operation {
    ...
    */
    ...
    public AdminGetInboxUsers(
            String customBasePath,            String inbox,
            String namespace,
            Integer limit,
            Integer offset,
            String status,
    ...
    public AdminGetInboxUsersOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetInboxUsersOpResponse response = new AdminGetInboxUsersOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsGetInboxUsersResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
