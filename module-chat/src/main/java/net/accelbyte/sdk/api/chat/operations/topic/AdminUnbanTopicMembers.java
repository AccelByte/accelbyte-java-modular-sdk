...
public class AdminUnbanTopicMembers extends Operation {
    ...
    */
    ...
    public AdminUnbanTopicMembersOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUnbanTopicMembersOpResponse response = new AdminUnbanTopicMembersOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsUnbanTopicMemberResult().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
