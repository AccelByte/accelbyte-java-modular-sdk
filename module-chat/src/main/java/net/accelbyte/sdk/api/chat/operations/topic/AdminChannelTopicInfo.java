...
public class AdminChannelTopicInfo extends Operation {
    ...
    */
    ...
    public AdminChannelTopicInfoOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminChannelTopicInfoOpResponse response = new AdminChannelTopicInfoOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsChannelTopicResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
