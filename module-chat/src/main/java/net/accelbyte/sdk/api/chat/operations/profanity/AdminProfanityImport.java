...
public class AdminProfanityImport extends Operation {
    ...
    */
    ...
    public AdminProfanityImportOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminProfanityImportOpResponse response = new AdminProfanityImportOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsDictionaryImportResult().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
