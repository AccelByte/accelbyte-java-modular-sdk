...
import net.accelbyte.sdk.api.chat.operation_responses.moderation.AdminGetChatSnapshotOpResponse;
...
public class AdminGetChatSnapshot extends Operation {
    ...
    */
    ...
    public AdminGetChatSnapshotOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetChatSnapshotOpResponse response = new AdminGetChatSnapshotOpResponse();
