...
@Getter
@Setter
public class AdminChannelTopicInfoOpResponse extends ApiResponseWithData<ModelsChannelTopicResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.chat.operations.topic.AdminChannelTopicInfo";
    }
}