...
public class AdminFilterChatMessage extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("detail", this.detail == null ? null : Arrays.asList(String.valueOf(this.detail)));
        return queryParams;
    }
    ...
    public AdminFilterChatMessageOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminFilterChatMessageOpResponse response = new AdminFilterChatMessageOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsMessageResultWithAttributes().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsMessageResultWithAttributes parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
