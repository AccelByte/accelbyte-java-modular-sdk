...
@Getter
@Setter
public class AdminTopicListOpResponse extends ApiResponseWithData<List<ModelsTopicResponse>> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.chat.operations.topic.AdminTopicList";
  }
}
