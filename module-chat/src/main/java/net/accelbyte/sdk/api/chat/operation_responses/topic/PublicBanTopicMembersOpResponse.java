...
@Getter
@Setter
public class PublicBanTopicMembersOpResponse extends ApiResponseWithData<ModelsPublicBanTopicMembersResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.chat.operations.topic.PublicBanTopicMembers";
    }
}