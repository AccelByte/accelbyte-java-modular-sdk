...
public class AdminSendChat extends Operation {
  ...
  public AdminSendChat(
      String customBasePath, String namespace, String topic, ApiSendChatParams body) {
  ...
  public AdminSendChatOpResponse parseResponse(int code, String contentType, InputStream payload)
