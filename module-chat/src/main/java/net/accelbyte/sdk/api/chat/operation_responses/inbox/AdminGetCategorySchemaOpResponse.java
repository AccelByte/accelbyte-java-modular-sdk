...
@Getter
@Setter
public class AdminGetCategorySchemaOpResponse extends ApiResponseWithData<ModelsJSONSchemaType> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.chat.operations.inbox.AdminGetCategorySchema";
  }
}
