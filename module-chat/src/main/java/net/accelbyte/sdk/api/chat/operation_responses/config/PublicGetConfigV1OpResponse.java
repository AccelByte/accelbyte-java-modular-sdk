...
@Getter
@Setter
public class PublicGetConfigV1OpResponse extends ApiResponseWithData<ModelsPublicConfigResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.chat.operations.config.PublicGetConfigV1";
    }
}