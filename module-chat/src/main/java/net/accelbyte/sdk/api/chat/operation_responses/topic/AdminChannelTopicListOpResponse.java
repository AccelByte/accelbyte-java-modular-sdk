...
@Getter
@Setter
public class AdminChannelTopicListOpResponse extends ApiResponseWithData<ModelsChannelTopicWithPaginationResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.chat.operations.topic.AdminChannelTopicList";
    }
}