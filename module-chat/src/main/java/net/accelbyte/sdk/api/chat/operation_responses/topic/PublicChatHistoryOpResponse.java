...
@Getter
@Setter
public class PublicChatHistoryOpResponse extends ApiResponseWithData<List<ModelsChatMessageResponse>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.chat.operations.topic.PublicChatHistory";
    }
}