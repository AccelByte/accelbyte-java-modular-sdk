...
@Getter
@Setter
public class AdminProfanityCreateOpResponse extends ApiResponseWithData<ModelsDictionary> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.chat.operations.profanity.AdminProfanityCreate";
    }
}