...
public class AdminRemoveTopicMember extends Operation {
    ...
    */
    ...
    public AdminRemoveTopicMemberOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminRemoveTopicMemberOpResponse response = new AdminRemoveTopicMemberOpResponse();
