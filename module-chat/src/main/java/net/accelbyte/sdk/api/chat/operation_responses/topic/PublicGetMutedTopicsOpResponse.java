...
@Getter
@Setter
public class PublicGetMutedTopicsOpResponse extends ApiResponseWithData<List<ApiMutedTopicResponse>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.chat.operations.topic.PublicGetMutedTopics";
    }
}