...
@Getter
@Setter
public class AdminProfanityUpdateOpResponse extends ApiResponseWithData<ModelsDictionary> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.chat.operations.profanity.AdminProfanityUpdate";
  }
}
