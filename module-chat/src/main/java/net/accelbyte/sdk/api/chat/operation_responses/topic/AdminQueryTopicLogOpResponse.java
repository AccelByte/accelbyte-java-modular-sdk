...
@Getter
@Setter
public class AdminQueryTopicLogOpResponse extends ApiResponseWithData<ModelsTopicLogWithPaginationResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.chat.operations.topic.AdminQueryTopicLog";
    }
}