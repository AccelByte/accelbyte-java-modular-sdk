...
public class AdminTopicMembers extends Operation {
    ...
    */
    ...
    public AdminTopicMembersOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminTopicMembersOpResponse response = new AdminTopicMembersOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsTopicMemberWithPaginationResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
