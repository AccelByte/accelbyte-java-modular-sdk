...
public class AdminQueryTopicLog extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("topicIds", this.topicIds == null ? null : this.topicIds.stream().map(i -> String.valueOf(i)).collect(java.util.stream.Collectors.toList()));
    ...
    public AdminQueryTopicLogOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminQueryTopicLogOpResponse response = new AdminQueryTopicLogOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsTopicLogWithPaginationResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
