...
public class AdminSendInboxMessage extends Operation {
    ...
    */
    ...
    public AdminSendInboxMessage(
            String customBasePath,            String messageId,
            String namespace,
    ...
    public AdminSendInboxMessageOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminSendInboxMessageOpResponse response = new AdminSendInboxMessageOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsSendInboxMessageResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
