...
public class AdminQueryTopic extends Operation {
    ...
    */
    ...
    public AdminQueryTopicOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminQueryTopicOpResponse response = new AdminQueryTopicOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<ModelsTopicInfo>>() {}));
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
