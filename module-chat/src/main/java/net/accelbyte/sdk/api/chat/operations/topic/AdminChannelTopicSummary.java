...
public class AdminChannelTopicSummary extends Operation {
    ...
    */
    ...
    public AdminChannelTopicSummaryOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminChannelTopicSummaryOpResponse response = new AdminChannelTopicSummaryOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsChannelTopicSummaryResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
