...
@Getter
@Setter
public class AdminTopicChatHistoryOpResponse extends ApiResponseWithData<ModelsChatMessageWithPaginationResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.chat.operations.topic.AdminTopicChatHistory";
    }
}