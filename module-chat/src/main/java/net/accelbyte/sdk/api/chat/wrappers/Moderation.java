...
public class Moderation {
   ...
   */
  public AdminGetChatSnapshotOpResponse adminGetChatSnapshot(AdminGetChatSnapshot input)
      throws Exception {
   ...
   */
  public AdminDeleteChatSnapshotOpResponse adminDeleteChatSnapshot(AdminDeleteChatSnapshot input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public PublicGetChatSnapshotOpResponse publicGetChatSnapshot(PublicGetChatSnapshot input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
