...
@Getter
@Setter
public class AdminTopicMembersOpResponse extends ApiResponseWithData<ModelsTopicMemberWithPaginationResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.chat.operations.topic.AdminTopicMembers";
    }
}