...
public class PublicChatHistory extends Operation {
    ...
    */
    ...
    public PublicChatHistoryOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicChatHistoryOpResponse response = new PublicChatHistoryOpResponse();
