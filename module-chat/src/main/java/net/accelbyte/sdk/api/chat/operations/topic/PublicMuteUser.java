...
public class PublicMuteUser extends Operation {
  ...
  public PublicMuteUser(
      String customBasePath, String namespace, String topic, ApiMuteUserRequest body) {
  ...
  public PublicMuteUserOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final PublicMuteUserOpResponse response = new PublicMuteUserOpResponse();
