...
public class AdminProfanityDelete extends Operation {
    ...
    */
    ...
    public AdminProfanityDeleteOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminProfanityDeleteOpResponse response = new AdminProfanityDeleteOpResponse();
