...
public class AdminChatHistory extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("chatId", this.chatId == null ? null : this.chatId.stream().map(i -> String.valueOf(i)).collect(java.util.stream.Collectors.toList()));
        ...
        queryParams.put("topic", this.topic == null ? null : this.topic.stream().map(i -> String.valueOf(i)).collect(java.util.stream.Collectors.toList()));
        queryParams.put("unfiltered", this.unfiltered == null ? null : Arrays.asList(String.valueOf(this.unfiltered)));
        return queryParams;
    }
    ...
    public AdminChatHistoryOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
