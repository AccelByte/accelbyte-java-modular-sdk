...
public class AdminProfanityCreateBulk extends Operation {
    ...
    */
    ...
    public AdminProfanityCreateBulkOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminProfanityCreateBulkOpResponse response = new AdminProfanityCreateBulkOpResponse();
