...
public class AdminProfanityUpdate extends Operation {
  ...
  public AdminProfanityUpdate(
      String customBasePath, String id, String namespace, ModelsDictionaryUpdateRequest body) {
    this.id = id;
  ...
  public AdminProfanityUpdateOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminProfanityUpdateOpResponse response = new AdminProfanityUpdateOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ModelsDictionary().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
