...
@Getter
@Setter
public class AdminSendChatOpResponse extends ApiResponseWithData<List<ModelsChatMessageResponse>> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.chat.operations.topic.AdminSendChat";
  }
}
