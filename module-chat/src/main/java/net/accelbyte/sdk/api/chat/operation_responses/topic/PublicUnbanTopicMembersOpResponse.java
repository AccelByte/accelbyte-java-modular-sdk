...
@Getter
@Setter
public class PublicUnbanTopicMembersOpResponse extends ApiResponseWithData<ModelsPublicUnbanTopicMembersResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.chat.operations.topic.PublicUnbanTopicMembers";
    }
}