...
@Getter
@Setter
public class AdminFilterChatMessageOpResponse extends ApiResponseWithData<ModelsMessageResultWithAttributes> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.chat.operations.topic.AdminFilterChatMessage";
    }
}