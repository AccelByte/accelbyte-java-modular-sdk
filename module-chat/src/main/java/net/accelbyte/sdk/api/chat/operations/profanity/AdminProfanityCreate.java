...
public class AdminProfanityCreate extends Operation {
  ...
  public AdminProfanityCreate(
      String customBasePath, String namespace, ModelsDictionaryInsertRequest body) {
  ...
  public AdminProfanityCreateOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminProfanityCreateOpResponse response = new AdminProfanityCreateOpResponse();
