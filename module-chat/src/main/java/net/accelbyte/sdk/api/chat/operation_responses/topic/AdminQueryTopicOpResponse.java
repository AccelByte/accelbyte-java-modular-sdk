...
@Getter
@Setter
public class AdminQueryTopicOpResponse extends ApiResponseWithData<List<ModelsTopicInfo>> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.chat.operations.topic.AdminQueryTopic";
  }
}
