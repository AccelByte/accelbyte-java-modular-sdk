...
public class AdminDeleteChat extends Operation {
  ...
  @Deprecated
  public AdminDeleteChat(String customBasePath, String chatId, String namespace, String topic) {
    this.chatId = chatId;
  ...
  public AdminDeleteChatOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final AdminDeleteChatOpResponse response = new AdminDeleteChatOpResponse();
