...
public class AdminDeleteInboxCategory extends Operation {
    ...
    */
    ...
    public AdminDeleteInboxCategoryOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDeleteInboxCategoryOpResponse response = new AdminDeleteInboxCategoryOpResponse();
