...
@Getter
@Setter
public class AdminGetConfigV1OpResponse extends ApiResponseWithData<ModelsConfigResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.chat.operations.config.AdminGetConfigV1";
    }
}