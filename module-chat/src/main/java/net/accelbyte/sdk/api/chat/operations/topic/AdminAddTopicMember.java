...
public class AdminAddTopicMember extends Operation {
    ...
    */
    ...
    public AdminAddTopicMemberOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminAddTopicMemberOpResponse response = new AdminAddTopicMemberOpResponse();
