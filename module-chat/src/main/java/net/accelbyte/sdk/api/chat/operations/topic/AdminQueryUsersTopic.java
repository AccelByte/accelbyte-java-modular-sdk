...
public class AdminQueryUsersTopic extends Operation {
    ...
    */
    ...
    public AdminQueryUsersTopicOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminQueryUsersTopicOpResponse response = new AdminQueryUsersTopicOpResponse();
