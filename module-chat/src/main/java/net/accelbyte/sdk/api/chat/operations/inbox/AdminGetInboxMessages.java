...
public class AdminGetInboxMessages extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("messageId", this.messageId == null ? null : this.messageId.stream().map(i -> String.valueOf(i)).collect(java.util.stream.Collectors.toList()));
    ...
    public AdminGetInboxMessagesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetInboxMessagesOpResponse response = new AdminGetInboxMessagesOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsGetInboxMessagesResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
