...
public class DeleteBackfill extends Operation {
  ...
  @Deprecated
  public DeleteBackfill(String customBasePath, String backfillID, String namespace) {
  ...
  public DeleteBackfillOpResponse parseResponse(int code, String contentType, InputStream payload)
