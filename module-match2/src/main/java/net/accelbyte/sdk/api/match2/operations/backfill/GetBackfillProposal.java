...
public class GetBackfillProposal extends Operation {
    ...
    */
    ...
    public GetBackfillProposalOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetBackfillProposalOpResponse response = new GetBackfillProposalOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApiBackfillProposalResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ApiBackfillProposalResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
