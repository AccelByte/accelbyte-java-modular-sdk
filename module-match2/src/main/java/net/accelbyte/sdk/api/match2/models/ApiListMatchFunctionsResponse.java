...
public class ApiListMatchFunctionsResponse extends Model {
    ...
    @JsonIgnore
    public List<ApiListMatchFunctionsResponse> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ApiListMatchFunctionsResponse>>() {});
    }
