...
public class RuleSetDetails extends Operation {
  ...
  @Deprecated
  public RuleSetDetails(String customBasePath, String namespace, String ruleset) {
  ...
  public RuleSetDetailsOpResponse parseResponse(int code, String contentType, InputStream payload)
