...
@Getter
@Setter
public class UpdateMatchPoolOpResponse extends ApiResponseWithData<ApiMatchPool> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.match2.operations.match_pools.UpdateMatchPool";
  }
}
