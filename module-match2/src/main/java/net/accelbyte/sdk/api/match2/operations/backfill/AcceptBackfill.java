...
public class AcceptBackfill extends Operation {
  ...
  public AcceptBackfill(
      String customBasePath, String backfillID, String namespace, ApiBackFillAcceptRequest body) {
  ...
  public AcceptBackfillOpResponse parseResponse(int code, String contentType, InputStream payload)
