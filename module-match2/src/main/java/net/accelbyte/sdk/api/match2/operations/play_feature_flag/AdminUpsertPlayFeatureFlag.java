...
import net.accelbyte.sdk.api.match2.operation_responses.play_feature_flag.AdminUpsertPlayFeatureFlagOpResponse;
...
public class AdminUpsertPlayFeatureFlag extends Operation {
  ...
  public AdminUpsertPlayFeatureFlag(
      String customBasePath, String namespace, ModelsPlayFeatureFlag body) {
  ...
  public AdminUpsertPlayFeatureFlagOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminUpsertPlayFeatureFlagOpResponse response =
        new AdminUpsertPlayFeatureFlagOpResponse();
