...
public class RejectBackfill extends Operation {
  ...
  public RejectBackfill(
      String customBasePath, String backfillID, String namespace, ApiBackFillRejectRequest body) {
  ...
  public RejectBackfillOpResponse parseResponse(int code, String contentType, InputStream payload)
