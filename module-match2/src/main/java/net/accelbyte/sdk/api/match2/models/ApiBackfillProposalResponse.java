...
public class ApiBackfillProposalResponse extends Model {
    ...
    @JsonIgnore
    public List<ApiBackfillProposalResponse> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ApiBackfillProposalResponse>>() {});
    }
