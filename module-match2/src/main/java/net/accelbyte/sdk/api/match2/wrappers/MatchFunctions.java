...
public class MatchFunctions {
     ...
     */
    public CreateMatchFunctionOpResponse createMatchFunction(CreateMatchFunction input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public UpdateMatchFunctionOpResponse updateMatchFunction(UpdateMatchFunction input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public DeleteMatchFunctionOpResponse deleteMatchFunction(DeleteMatchFunction input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
