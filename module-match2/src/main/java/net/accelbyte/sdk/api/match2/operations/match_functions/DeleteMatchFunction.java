...
public class DeleteMatchFunction extends Operation {
    ...
    */
    ...
    public DeleteMatchFunctionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteMatchFunctionOpResponse response = new DeleteMatchFunctionOpResponse();
