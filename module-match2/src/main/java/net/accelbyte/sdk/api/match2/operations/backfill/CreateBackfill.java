...
public class CreateBackfill extends Operation {
  ...
  @Deprecated
  public CreateBackfill(String customBasePath, String namespace, ApiBackFillCreateRequest body) {
  ...
  public CreateBackfillOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final CreateBackfillOpResponse response = new CreateBackfillOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ApiBackfillCreateResponse().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public ApiBackfillCreateResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 201){
          final String json = Helper.convertInputStreamToString(payload);
