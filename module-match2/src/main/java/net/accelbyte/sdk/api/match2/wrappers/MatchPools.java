...
public class MatchPools {
   ...
   */
  public PostMatchErrorMetricOpResponse postMatchErrorMetric(PostMatchErrorMetric input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminGetMatchPoolTicketsOpResponse adminGetMatchPoolTickets(AdminGetMatchPoolTickets input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public PublicGetPlayerMetricOpResponse publicGetPlayerMetric(PublicGetPlayerMetric input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
