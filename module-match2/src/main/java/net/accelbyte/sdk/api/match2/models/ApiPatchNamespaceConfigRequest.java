...
public class ApiPatchNamespaceConfigRequest extends Model {
    ...
    @JsonIgnore
    public List<ApiPatchNamespaceConfigRequest> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ApiPatchNamespaceConfigRequest>>() {});
    }
