...
public class MatchTicketDetails extends Operation {
    ...
    */
    ...
    public MatchTicketDetailsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final MatchTicketDetailsOpResponse response = new MatchTicketDetailsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApiMatchTicketStatus().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 401) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ApiMatchTicketStatus parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
