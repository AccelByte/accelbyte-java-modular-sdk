...
public class UpdateMatchFunction extends Operation {
    ...
    */
    ...
    public UpdateMatchFunctionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateMatchFunctionOpResponse response = new UpdateMatchFunctionOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ApiMatchFunctionConfig().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ApiMatchFunctionConfig parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
