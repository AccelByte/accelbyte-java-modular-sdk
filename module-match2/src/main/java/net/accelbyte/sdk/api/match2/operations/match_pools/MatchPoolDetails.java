...
public class MatchPoolDetails extends Operation {
  ...
  @Deprecated
  public MatchPoolDetails(String customBasePath, String namespace, String pool) {
  ...
  public MatchPoolDetailsOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final MatchPoolDetailsOpResponse response = new MatchPoolDetailsOpResponse();
