...
public class MatchmakerMatchTicketRecord extends Model {
    ...
    @JsonIgnore
    public List<MatchmakerMatchTicketRecord> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<MatchmakerMatchTicketRecord>>() {});
    }
