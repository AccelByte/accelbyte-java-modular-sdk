...
public class ApiListMatchPoolsResponse extends Model {
    ...
    @JsonIgnore
    public List<ApiListMatchPoolsResponse> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ApiListMatchPoolsResponse>>() {});
    }
