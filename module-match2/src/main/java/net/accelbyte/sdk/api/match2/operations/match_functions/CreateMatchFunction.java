...
public class CreateMatchFunction extends Operation {
    ...
    */
    ...
    public CreateMatchFunctionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreateMatchFunctionOpResponse response = new CreateMatchFunctionOpResponse();
