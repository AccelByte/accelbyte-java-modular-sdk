...
NOTE: Avoid using both `OnDemandTokenRefreshRepository` and `BackgroundTokenRefreshRepository` together, as it introduces unnecessary overhead and may lead to unexpected behavior.
