...
import net.accelbyte.sdk.api.loginqueue.operation_responses.admin_v1.AdminGetConfigurationOpResponse;
...
public class AdminGetConfiguration extends Operation {
  ...
  @Deprecated
  public AdminGetConfiguration(String customBasePath, String namespace) {
  ...
  public AdminGetConfigurationOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetConfigurationOpResponse response = new AdminGetConfigurationOpResponse();
