...
import net.accelbyte.sdk.api.qosm.operation_responses.public_.ListServerPerNamespaceOpResponse;
...
public class ListServerPerNamespace extends Operation {
    ...
    */
    ...
    public ListServerPerNamespaceOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ListServerPerNamespaceOpResponse response = new ListServerPerNamespaceOpResponse();
