...
public class Heartbeat extends Operation {
    ...
    */
    ...
    @Deprecated
    public Heartbeat(
            String customBasePath,            ModelsHeartbeatRequest body
    )
    {
        this.body = body;
    ...
    public HeartbeatOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
