...
public class SetServerAlias extends Operation {
  ...
  @Deprecated
  public SetServerAlias(String customBasePath, String region, ModelsSetAliasRequest body) {
    this.region = region;
    this.body = body;
  ...
  public SetServerAliasOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final SetServerAliasOpResponse response = new SetServerAliasOpResponse();
