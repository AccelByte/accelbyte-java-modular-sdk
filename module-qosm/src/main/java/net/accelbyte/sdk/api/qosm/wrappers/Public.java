...
public class Public {
    ...
    public Public(RequestRunner sdk){
        this.sdk = sdk;
        String configCustomBasePath = sdk.getSdkConfiguration().getConfigRepository().getCustomServiceBasePath("qosm");
     ...
     */
    public ListServerPerNamespaceOpResponse listServerPerNamespace(ListServerPerNamespace input) throws Exception {
