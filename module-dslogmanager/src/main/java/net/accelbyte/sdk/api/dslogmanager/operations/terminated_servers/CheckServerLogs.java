...
public class CheckServerLogs extends Operation {
    ...
    */
    ...
    public CheckServerLogsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CheckServerLogsOpResponse response = new CheckServerLogsOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsLogFileStatus().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 404) {
            final String json = Helper.convertInputStreamToString(payload);
