...
public class BatchDownloadServerLogs extends Operation {
    ...
    */
    ...
    public BatchDownloadServerLogs(
            String customBasePath,            ModelsBatchDownloadLogsRequest body
    )
    {
        this.body = body;
    ...
    public BatchDownloadServerLogsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
