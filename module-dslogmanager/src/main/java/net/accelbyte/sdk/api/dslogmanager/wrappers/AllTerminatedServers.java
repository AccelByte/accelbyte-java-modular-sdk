...
import net.accelbyte.sdk.api.dslogmanager.operation_responses.all_terminated_servers.*;
...
public class AllTerminatedServers {
     ...
     */
    public BatchDownloadServerLogsOpResponse batchDownloadServerLogs(BatchDownloadServerLogs input) throws Exception {
     ...
     */
    public ListMetadataServersOpResponse listMetadataServers(ListMetadataServers input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public ListAllTerminatedServersOpResponse listAllTerminatedServers(ListAllTerminatedServers input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
