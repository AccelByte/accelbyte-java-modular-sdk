...
public class ListAllTerminatedServers extends Operation {
    ...
    */
    ...
    public ListAllTerminatedServersOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ListAllTerminatedServersOpResponse response = new ListAllTerminatedServersOpResponse();
