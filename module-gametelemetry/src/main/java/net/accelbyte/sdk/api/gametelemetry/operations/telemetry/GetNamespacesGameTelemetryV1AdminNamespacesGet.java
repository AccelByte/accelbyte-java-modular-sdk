...
public class GetNamespacesGameTelemetryV1AdminNamespacesGet extends Operation {
  ...
  @Deprecated
  public GetNamespacesGameTelemetryV1AdminNamespacesGet(String customBasePath) {
  ...
  public GetNamespacesGameTelemetryV1AdminNamespacesGetOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetNamespacesGameTelemetryV1AdminNamespacesGetOpResponse response =
        new GetNamespacesGameTelemetryV1AdminNamespacesGetOpResponse();
