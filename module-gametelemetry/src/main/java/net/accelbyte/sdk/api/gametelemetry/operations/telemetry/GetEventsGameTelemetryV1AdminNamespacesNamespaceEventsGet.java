...
public class GetEventsGameTelemetryV1AdminNamespacesNamespaceEventsGet extends Operation {
  ...
  public GetEventsGameTelemetryV1AdminNamespacesNamespaceEventsGetOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetEventsGameTelemetryV1AdminNamespacesNamespaceEventsGetOpResponse response =
        new GetEventsGameTelemetryV1AdminNamespacesNamespaceEventsGetOpResponse();
