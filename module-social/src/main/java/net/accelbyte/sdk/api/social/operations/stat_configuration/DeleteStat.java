...
public class DeleteStat extends Operation {
    ...
    */
    ...
    public DeleteStatOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteStatOpResponse response = new DeleteStatOpResponse();
