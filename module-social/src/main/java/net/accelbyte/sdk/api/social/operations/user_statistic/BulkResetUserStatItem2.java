...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.BulkResetUserStatItem2OpResponse;
...
public class BulkResetUserStatItem2 extends Operation {
    ...
    */
    ...
    public BulkResetUserStatItem2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final BulkResetUserStatItem2OpResponse response = new BulkResetUserStatItem2OpResponse();
