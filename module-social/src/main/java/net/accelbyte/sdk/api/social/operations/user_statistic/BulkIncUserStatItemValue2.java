...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.BulkIncUserStatItemValue2OpResponse;
...
public class BulkIncUserStatItemValue2 extends Operation {
    ...
    */
    ...
    public BulkIncUserStatItemValue2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final BulkIncUserStatItemValue2OpResponse response = new BulkIncUserStatItemValue2OpResponse();
