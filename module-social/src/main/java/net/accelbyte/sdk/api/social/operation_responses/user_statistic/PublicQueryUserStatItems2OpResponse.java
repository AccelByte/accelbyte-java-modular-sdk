...
@Getter
@Setter
public class PublicQueryUserStatItems2OpResponse extends ApiResponseWithData<List<ADTOObjectForUserStatItemValue>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.user_statistic.PublicQueryUserStatItems2";
    }
}