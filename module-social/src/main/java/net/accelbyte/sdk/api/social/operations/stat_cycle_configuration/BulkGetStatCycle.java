...
public class BulkGetStatCycle extends Operation {
  ...
  public BulkGetStatCycleOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final BulkGetStatCycleOpResponse response = new BulkGetStatCycleOpResponse();
