...
@Getter
@Setter
public class UpdateUserStatItemValueOpResponse extends ApiResponseWithData<StatItemIncResult> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.user_statistic.UpdateUserStatItemValue";
    }
}