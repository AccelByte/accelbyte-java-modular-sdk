...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.BulkUpdateUserStatItemV2OpResponse;
...
public class BulkUpdateUserStatItemV2 extends Operation {
    ...
    */
    ...
    public BulkUpdateUserStatItemV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final BulkUpdateUserStatItemV2OpResponse response = new BulkUpdateUserStatItemV2OpResponse();
