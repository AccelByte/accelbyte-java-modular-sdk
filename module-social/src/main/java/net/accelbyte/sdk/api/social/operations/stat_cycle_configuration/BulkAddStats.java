...
public class BulkAddStats extends Operation {
  ...
  @Deprecated
  public BulkAddStats(
      String customBasePath, String cycleId, String namespace, BulkCycleStatsAdd body) {
  ...
  public BulkAddStatsOpResponse parseResponse(int code, String contentType, InputStream payload)
