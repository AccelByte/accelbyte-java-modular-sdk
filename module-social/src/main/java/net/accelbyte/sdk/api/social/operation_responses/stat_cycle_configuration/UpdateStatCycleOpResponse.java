...
@Getter
@Setter
public class UpdateStatCycleOpResponse extends ApiResponseWithData<StatCycleInfo> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.stat_cycle_configuration.UpdateStatCycle";
    }
}