...
@Getter
@Setter
public class PublicCreateUserStatItemOpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.user_statistic.PublicCreateUserStatItem";
    }
}