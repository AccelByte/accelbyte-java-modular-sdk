...
public class ImportStatCycle extends Operation {
    ...
    */
    ...
    public ImportStatCycleOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ImportStatCycleOpResponse response = new ImportStatCycleOpResponse();
