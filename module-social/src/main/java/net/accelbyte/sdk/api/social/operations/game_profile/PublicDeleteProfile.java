...
public class PublicDeleteProfile extends Operation {
    ...
    */
    ...
    public PublicDeleteProfileOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicDeleteProfileOpResponse response = new PublicDeleteProfileOpResponse();
