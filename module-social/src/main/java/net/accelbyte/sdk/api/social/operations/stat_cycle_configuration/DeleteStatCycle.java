...
public class DeleteStatCycle extends Operation {
    ...
    */
    ...
    public DeleteStatCycleOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteStatCycleOpResponse response = new DeleteStatCycleOpResponse();
