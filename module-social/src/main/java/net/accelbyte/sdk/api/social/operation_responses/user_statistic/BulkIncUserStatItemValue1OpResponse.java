...
@Getter
@Setter
public class BulkIncUserStatItemValue1OpResponse extends ApiResponseWithData<List<BulkStatOperationResult>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.user_statistic.BulkIncUserStatItemValue1";
    }
}