...
@Getter
@Setter
public class GetStatItemsOpResponse extends ApiResponseWithData<StatItemValuePagingSlicedResult> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.user_statistic.GetStatItems";
    }
}