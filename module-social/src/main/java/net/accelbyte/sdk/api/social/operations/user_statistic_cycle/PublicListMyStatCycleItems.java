...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic_cycle.PublicListMyStatCycleItemsOpResponse;
...
public class PublicListMyStatCycleItems extends Operation {
     ...
     */
    private String path = "/social/v1/public/namespaces/{namespace}/users/me/statCycles/{cycleId}/statCycleitems";
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("statCodes", this.statCodes == null ? null : this.statCodes.stream().map(i -> String.valueOf(i)).collect(java.util.stream.Collectors.toList()));
        return queryParams;
    }
    ...
    public PublicListMyStatCycleItemsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicListMyStatCycleItemsOpResponse response = new PublicListMyStatCycleItemsOpResponse();
