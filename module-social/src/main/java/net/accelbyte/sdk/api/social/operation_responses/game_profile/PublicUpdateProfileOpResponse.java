...
@Getter
@Setter
public class PublicUpdateProfileOpResponse extends ApiResponseWithData<GameProfileInfo> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.social.operations.game_profile.PublicUpdateProfile";
  }
}
