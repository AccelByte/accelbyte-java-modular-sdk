...
public class GetStatCycles extends Operation {
    ...
    */
    ...
    public GetStatCyclesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetStatCyclesOpResponse response = new GetStatCyclesOpResponse();
