...
@Getter
@Setter
public class UpdateUserStatItemValue1OpResponse extends ApiResponseWithData<StatItemIncResult> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.user_statistic.UpdateUserStatItemValue1";
    }
}