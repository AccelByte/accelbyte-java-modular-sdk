...
@Getter
@Setter
public class PublicBulkIncUserStatItemValueOpResponse extends ApiResponseWithData<List<BulkStatOperationResult>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.user_statistic.PublicBulkIncUserStatItemValue";
    }
}