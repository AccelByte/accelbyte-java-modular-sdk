...
public class ExportStats extends Operation {
  ...
  @Deprecated
  public ExportStats(String customBasePath, String namespace) {
  ...
  public ExportStatsOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final ExportStatsOpResponse response = new ExportStatsOpResponse();
