...
public class GetStat extends Operation {
    ...
    */
    ...
    public GetStatOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetStatOpResponse response = new GetStatOpResponse();
