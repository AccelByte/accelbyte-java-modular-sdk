...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.AdminListUsersStatItemsOpResponse;
...
public class AdminListUsersStatItems extends Operation {
    ...
    */
    ...
    public AdminListUsersStatItemsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminListUsersStatItemsOpResponse response = new AdminListUsersStatItemsOpResponse();
