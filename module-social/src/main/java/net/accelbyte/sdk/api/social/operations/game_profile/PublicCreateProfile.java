...
import net.accelbyte.sdk.api.social.operation_responses.game_profile.PublicCreateProfileOpResponse;
...
public class PublicCreateProfile extends Operation {
    ...
    */
    ...
    public PublicCreateProfileOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicCreateProfileOpResponse response = new PublicCreateProfileOpResponse();
