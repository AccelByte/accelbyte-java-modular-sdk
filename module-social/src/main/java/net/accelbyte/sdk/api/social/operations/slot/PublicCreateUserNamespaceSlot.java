...
public class PublicCreateUserNamespaceSlot extends Operation {
  ...
  public PublicCreateUserNamespaceSlotOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicCreateUserNamespaceSlotOpResponse response =
        new PublicCreateUserNamespaceSlotOpResponse();
