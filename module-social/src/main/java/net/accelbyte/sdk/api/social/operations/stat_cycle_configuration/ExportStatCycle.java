...
public class ExportStatCycle extends Operation {
  ...
  @Deprecated
  public ExportStatCycle(String customBasePath, String namespace) {
  ...
  public ExportStatCycleOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final ExportStatCycleOpResponse response = new ExportStatCycleOpResponse();
