...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.DeleteUserStatItems1OpResponse;
...
public class DeleteUserStatItems1 extends Operation {
    ...
    */
    ...
    public DeleteUserStatItems1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteUserStatItems1OpResponse response = new DeleteUserStatItems1OpResponse();
