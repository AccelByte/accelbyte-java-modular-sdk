...
@Getter
@Setter
public class BulkIncUserStatItem1OpResponse extends ApiResponseWithData<List<BulkStatOperationResult>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.user_statistic.BulkIncUserStatItem1";
    }
}