...
@Getter
@Setter
public class PublicUpdateAttributeOpResponse extends ApiResponseWithData<GameProfileInfo> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.social.operations.game_profile.PublicUpdateAttribute";
  }
}
