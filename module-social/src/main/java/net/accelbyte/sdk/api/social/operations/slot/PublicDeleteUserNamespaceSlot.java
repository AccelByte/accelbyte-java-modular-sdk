...
public class PublicDeleteUserNamespaceSlot extends Operation {
  ...
  public PublicDeleteUserNamespaceSlot(
      String customBasePath, String namespace, String slotId, String userId) {
  ...
  public PublicDeleteUserNamespaceSlotOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicDeleteUserNamespaceSlotOpResponse response =
        new PublicDeleteUserNamespaceSlotOpResponse();
