...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.BulkCreateUserStatItemsOpResponse;
...
public class BulkCreateUserStatItems extends Operation {
    ...
    */
    ...
    public BulkCreateUserStatItemsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final BulkCreateUserStatItemsOpResponse response = new BulkCreateUserStatItemsOpResponse();
