...
public class SlotConfig {
   ...
   */
  @Deprecated
  public GetNamespaceSlotConfigOpResponse getNamespaceSlotConfig(GetNamespaceSlotConfig input)
      throws Exception {
   ...
   */
  @Deprecated
  public UpdateNamespaceSlotConfigOpResponse updateNamespaceSlotConfig(
      UpdateNamespaceSlotConfig input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  @Deprecated
  public DeleteNamespaceSlotConfigOpResponse deleteNamespaceSlotConfig(
      DeleteNamespaceSlotConfig input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  @Deprecated
  public UpdateUserSlotConfigOpResponse updateUserSlotConfig(UpdateUserSlotConfig input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  @Deprecated
  public DeleteUserSlotConfigOpResponse deleteUserSlotConfig(DeleteUserSlotConfig input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
