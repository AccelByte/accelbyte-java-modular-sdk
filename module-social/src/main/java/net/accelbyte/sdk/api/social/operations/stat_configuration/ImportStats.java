...
public class ImportStats extends Operation {
  ...
  @Deprecated
  public ImportStats(String customBasePath, String namespace, Boolean replaceExisting, File file) {
  ...
  public ImportStatsOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final ImportStatsOpResponse response = new ImportStatsOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new StatImportInfo().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public StatImportInfo parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 201){
          final String json = Helper.convertInputStreamToString(payload);
