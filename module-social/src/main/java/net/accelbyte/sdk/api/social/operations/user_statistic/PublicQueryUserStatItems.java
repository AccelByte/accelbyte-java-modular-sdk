...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.PublicQueryUserStatItemsOpResponse;
...
public class PublicQueryUserStatItems extends Operation {
    ...
    */
    ...
    public PublicQueryUserStatItemsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicQueryUserStatItemsOpResponse response = new PublicQueryUserStatItemsOpResponse();
