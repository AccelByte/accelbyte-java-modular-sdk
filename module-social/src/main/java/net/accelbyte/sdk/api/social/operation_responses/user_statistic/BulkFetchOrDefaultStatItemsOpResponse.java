...
@Getter
@Setter
public class BulkFetchOrDefaultStatItemsOpResponse extends ApiResponseWithData<List<ADTOObjectForUserStatItemValue>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.user_statistic.BulkFetchOrDefaultStatItems";
    }
}