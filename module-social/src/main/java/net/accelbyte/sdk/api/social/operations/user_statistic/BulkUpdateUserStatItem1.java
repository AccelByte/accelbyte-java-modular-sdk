...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.BulkUpdateUserStatItem1OpResponse;
...
public class BulkUpdateUserStatItem1 extends Operation {
    ...
    */
    ...
    public BulkUpdateUserStatItem1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final BulkUpdateUserStatItem1OpResponse response = new BulkUpdateUserStatItem1OpResponse();
