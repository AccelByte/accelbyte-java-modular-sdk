...
import net.accelbyte.sdk.api.social.operation_responses.game_profile.PublicGetProfileOpResponse;
...
public class PublicGetProfile extends Operation {
    ...
    */
    ...
    public PublicGetProfileOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetProfileOpResponse response = new PublicGetProfileOpResponse();
