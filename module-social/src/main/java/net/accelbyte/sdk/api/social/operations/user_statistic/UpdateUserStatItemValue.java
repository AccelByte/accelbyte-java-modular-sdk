...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.UpdateUserStatItemValueOpResponse;
...
public class UpdateUserStatItemValue extends Operation {
    ...
    */
    ...
    public UpdateUserStatItemValueOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateUserStatItemValueOpResponse response = new UpdateUserStatItemValueOpResponse();
