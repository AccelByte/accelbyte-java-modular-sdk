...
public class GetStats extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("isGlobal", this.isGlobal == null ? null : Arrays.asList(String.valueOf(this.isGlobal)));
    ...
    public GetStatsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetStatsOpResponse response = new GetStatsOpResponse();
