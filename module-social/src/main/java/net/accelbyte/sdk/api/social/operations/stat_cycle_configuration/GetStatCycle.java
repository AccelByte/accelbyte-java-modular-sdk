...
public class GetStatCycle extends Operation {
  ...
  @Deprecated
  public GetStatCycle(String customBasePath, String cycleId, String namespace) {
  ...
  public GetStatCycleOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetStatCycleOpResponse response = new GetStatCycleOpResponse();
