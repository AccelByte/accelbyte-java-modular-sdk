...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.BulkGetOrDefaultByUserIdOpResponse;
...
public class BulkGetOrDefaultByUserId extends Operation {
     ...
     */
    private String path = "/social/v2/admin/namespaces/{namespace}/users/{userId}/statitems/value/bulk/getOrDefault";
    ...
    */
    ...
    public BulkGetOrDefaultByUserIdOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final BulkGetOrDefaultByUserIdOpResponse response = new BulkGetOrDefaultByUserIdOpResponse();
