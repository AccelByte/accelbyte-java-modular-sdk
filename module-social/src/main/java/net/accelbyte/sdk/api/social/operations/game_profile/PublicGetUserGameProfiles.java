...
import net.accelbyte.sdk.api.social.operation_responses.game_profile.PublicGetUserGameProfilesOpResponse;
...
public class PublicGetUserGameProfiles extends Operation {
    ...
    */
    ...
    public PublicGetUserGameProfilesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetUserGameProfilesOpResponse response = new PublicGetUserGameProfilesOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<UserGameProfiles>>() {}));
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public List<UserGameProfiles> parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
