...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.ResetUserStatItemValueOpResponse;
...
public class ResetUserStatItemValue extends Operation {
    ...
    */
    ...
    public ResetUserStatItemValueOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ResetUserStatItemValueOpResponse response = new ResetUserStatItemValueOpResponse();
