...
public class GameProfile {
     ...
     */
    public PublicGetUserGameProfilesOpResponse publicGetUserGameProfiles(PublicGetUserGameProfiles input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public PublicGetUserProfilesOpResponse publicGetUserProfiles(PublicGetUserProfiles input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public PublicCreateProfileOpResponse publicCreateProfile(PublicCreateProfile input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public PublicUpdateProfileOpResponse publicUpdateProfile(PublicUpdateProfile input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public PublicDeleteProfileOpResponse publicDeleteProfile(PublicDeleteProfile input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public PublicGetProfileAttributeOpResponse publicGetProfileAttribute(PublicGetProfileAttribute input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public PublicUpdateAttributeOpResponse publicUpdateAttribute(PublicUpdateAttribute input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
