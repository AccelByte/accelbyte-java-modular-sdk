...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.CreateUserStatItemOpResponse;
...
public class CreateUserStatItem extends Operation {
    ...
    */
    ...
    public CreateUserStatItemOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreateUserStatItemOpResponse response = new CreateUserStatItemOpResponse();
