...
public class PublicUpdateUserNamespaceSlotMetadata extends Operation {
    ...
    */
    ...
    public PublicUpdateUserNamespaceSlotMetadataOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicUpdateUserNamespaceSlotMetadataOpResponse response = new PublicUpdateUserNamespaceSlotMetadataOpResponse();
