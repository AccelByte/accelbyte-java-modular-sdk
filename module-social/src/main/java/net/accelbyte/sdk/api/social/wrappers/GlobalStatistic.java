...
public class GlobalStatistic {
   ...
   */
  public GetGlobalStatItemsOpResponse getGlobalStatItems(GetGlobalStatItems input)
      throws Exception {
   ...
   */
  public GetGlobalStatItemByStatCodeOpResponse getGlobalStatItemByStatCode(
      GetGlobalStatItemByStatCode input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public GetGlobalStatItems1OpResponse getGlobalStatItems1(GetGlobalStatItems1 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public GetGlobalStatItemByStatCode1OpResponse getGlobalStatItemByStatCode1(
      GetGlobalStatItemByStatCode1 input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
