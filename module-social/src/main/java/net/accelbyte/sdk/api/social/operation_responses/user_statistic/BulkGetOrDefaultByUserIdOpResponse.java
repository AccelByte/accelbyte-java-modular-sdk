...
@Getter
@Setter
public class BulkGetOrDefaultByUserIdOpResponse extends ApiResponseWithData<List<ADTOObjectForUserStatItemValue>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.user_statistic.BulkGetOrDefaultByUserId";
    }
}