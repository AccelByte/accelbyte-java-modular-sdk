...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.GetUserStatItemsOpResponse;
...
public class GetUserStatItems extends Operation {
    ...
    */
    ...
    public GetUserStatItemsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserStatItemsOpResponse response = new GetUserStatItemsOpResponse();
