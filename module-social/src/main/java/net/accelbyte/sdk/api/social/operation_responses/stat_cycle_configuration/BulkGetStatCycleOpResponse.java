...
@Getter
@Setter
public class BulkGetStatCycleOpResponse extends ApiResponseWithData<BulkStatCycleResult> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.stat_cycle_configuration.BulkGetStatCycle";
    }
}