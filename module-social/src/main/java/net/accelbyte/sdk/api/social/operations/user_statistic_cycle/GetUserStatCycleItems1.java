...
public class GetUserStatCycleItems1 extends Operation {
     ...
     */
    private String path = "/social/v1/public/namespaces/{namespace}/users/{userId}/statCycles/{cycleId}/statCycleitems";
    ...
    */
    ...
    public GetUserStatCycleItems1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
