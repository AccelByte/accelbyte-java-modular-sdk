...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.PublicQueryUserStatItems1OpResponse;
...
public class PublicQueryUserStatItems1 extends Operation {
    ...
    */
    ...
    public PublicQueryUserStatItems1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicQueryUserStatItems1OpResponse response = new PublicQueryUserStatItems1OpResponse();
