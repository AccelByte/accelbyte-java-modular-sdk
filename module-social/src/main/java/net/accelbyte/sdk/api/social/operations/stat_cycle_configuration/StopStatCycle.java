...
public class StopStatCycle extends Operation {
  ...
  @Deprecated
  public StopStatCycle(String customBasePath, String cycleId, String namespace) {
  ...
  public StopStatCycleOpResponse parseResponse(int code, String contentType, InputStream payload)
