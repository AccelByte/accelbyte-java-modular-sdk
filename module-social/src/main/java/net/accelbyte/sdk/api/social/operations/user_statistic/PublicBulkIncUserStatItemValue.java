...
public class PublicBulkIncUserStatItemValue extends Operation {
  ...
  public PublicBulkIncUserStatItemValueOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicBulkIncUserStatItemValueOpResponse response =
        new PublicBulkIncUserStatItemValueOpResponse();
