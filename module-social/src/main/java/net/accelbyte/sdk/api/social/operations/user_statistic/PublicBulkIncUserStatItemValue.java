...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.PublicBulkIncUserStatItemValueOpResponse;
...
public class PublicBulkIncUserStatItemValue extends Operation {
    ...
    */
    ...
    public PublicBulkIncUserStatItemValueOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicBulkIncUserStatItemValueOpResponse response = new PublicBulkIncUserStatItemValueOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<BulkStatOperationResult>>() {}));
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public List<BulkStatOperationResult> parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
