...
public class UserStatisticCycle {
     ...
     */
    public GetUserStatCycleItemsOpResponse getUserStatCycleItems(GetUserStatCycleItems input) throws Exception {
     ...
     */
    public PublicListMyStatCycleItemsOpResponse publicListMyStatCycleItems(PublicListMyStatCycleItems input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public GetUserStatCycleItems1OpResponse getUserStatCycleItems1(GetUserStatCycleItems1 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
