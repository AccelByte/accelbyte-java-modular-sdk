...
@Getter
@Setter
public class IncUserStatItemValueOpResponse extends ApiResponseWithData<StatItemIncResult> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.social.operations.user_statistic.IncUserStatItemValue";
  }
}
