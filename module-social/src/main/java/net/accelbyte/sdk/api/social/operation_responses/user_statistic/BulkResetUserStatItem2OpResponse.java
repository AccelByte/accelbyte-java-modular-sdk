...
@Getter
@Setter
public class BulkResetUserStatItem2OpResponse extends ApiResponseWithData<List<BulkStatOperationResult>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.user_statistic.BulkResetUserStatItem2";
    }
}