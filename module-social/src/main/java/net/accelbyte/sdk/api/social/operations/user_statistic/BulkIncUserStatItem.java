...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.BulkIncUserStatItemOpResponse;
...
public class BulkIncUserStatItem extends Operation {
    ...
    */
    ...
    public BulkIncUserStatItemOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final BulkIncUserStatItemOpResponse response = new BulkIncUserStatItemOpResponse();
