...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.BulkUpdateUserStatItem2OpResponse;
...
public class BulkUpdateUserStatItem2 extends Operation {
    ...
    */
    ...
    public BulkUpdateUserStatItem2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final BulkUpdateUserStatItem2OpResponse response = new BulkUpdateUserStatItem2OpResponse();
