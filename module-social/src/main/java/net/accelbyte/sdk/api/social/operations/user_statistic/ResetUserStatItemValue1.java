...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.ResetUserStatItemValue1OpResponse;
...
public class ResetUserStatItemValue1 extends Operation {
    ...
    */
    ...
    public ResetUserStatItemValue1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ResetUserStatItemValue1OpResponse response = new ResetUserStatItemValue1OpResponse();
