...
public class PublicIncUserStatItemValue extends Operation {
    ...
    */
    ...
    public PublicIncUserStatItemValueOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicIncUserStatItemValueOpResponse response = new PublicIncUserStatItemValueOpResponse();
