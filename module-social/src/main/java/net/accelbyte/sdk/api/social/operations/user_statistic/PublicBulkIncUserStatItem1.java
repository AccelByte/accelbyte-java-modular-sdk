...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.PublicBulkIncUserStatItem1OpResponse;
...
public class PublicBulkIncUserStatItem1 extends Operation {
    ...
    */
    ...
    public PublicBulkIncUserStatItem1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicBulkIncUserStatItem1OpResponse response = new PublicBulkIncUserStatItem1OpResponse();
