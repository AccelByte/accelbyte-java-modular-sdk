...
public class PublicBulkIncUserStatItem1 extends Operation {
  ...
  public PublicBulkIncUserStatItem1(
      String customBasePath, String namespace, String userId, List<BulkStatItemInc> body) {
  ...
  public PublicBulkIncUserStatItem1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicBulkIncUserStatItem1OpResponse response =
        new PublicBulkIncUserStatItem1OpResponse();
