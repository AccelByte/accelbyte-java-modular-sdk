...
public class GetStatCycle1 extends Operation {
  ...
  @Deprecated
  public GetStatCycle1(String customBasePath, String cycleId, String namespace) {
  ...
  public GetStatCycle1OpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetStatCycle1OpResponse response = new GetStatCycle1OpResponse();
