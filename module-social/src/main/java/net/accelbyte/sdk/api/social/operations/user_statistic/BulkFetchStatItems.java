...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.BulkFetchStatItemsOpResponse;
...
public class BulkFetchStatItems extends Operation {
  ...
  public BulkFetchStatItems(
      String customBasePath, String namespace, String statCode, String userIds) {
  ...
  public BulkFetchStatItemsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final BulkFetchStatItemsOpResponse response = new BulkFetchStatItemsOpResponse();
    ...
    if (code == 204) {
      ...
      response.setSuccess(true);
      response.setData(
          new ObjectMapper().readValue(json, new TypeReference<List<UserStatItemInfo>>() {}));
    } else if (code == 401) {
      final String json = Helper.convertInputStreamToString(payload);
