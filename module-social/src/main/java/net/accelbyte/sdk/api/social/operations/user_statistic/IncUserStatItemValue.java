...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.IncUserStatItemValueOpResponse;
...
public class IncUserStatItemValue extends Operation {
    ...
    */
    ...
    public IncUserStatItemValueOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final IncUserStatItemValueOpResponse response = new IncUserStatItemValueOpResponse();
