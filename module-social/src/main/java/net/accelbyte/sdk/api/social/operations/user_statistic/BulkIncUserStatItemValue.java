...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.BulkIncUserStatItemValueOpResponse;
...
public class BulkIncUserStatItemValue extends Operation {
    ...
    */
    ...
    public BulkIncUserStatItemValueOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final BulkIncUserStatItemValueOpResponse response = new BulkIncUserStatItemValueOpResponse();
