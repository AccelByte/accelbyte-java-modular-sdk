...
public class UpdateStat extends Operation {
  ...
  @Deprecated
  public UpdateStat(String customBasePath, String namespace, String statCode, StatUpdate body) {
  ...
  public UpdateStatOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final UpdateStatOpResponse response = new UpdateStatOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new StatInfo().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public StatInfo parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
