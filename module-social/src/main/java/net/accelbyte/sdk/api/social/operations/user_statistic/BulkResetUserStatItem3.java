...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.BulkResetUserStatItem3OpResponse;
...
public class BulkResetUserStatItem3 extends Operation {
    ...
    */
    ...
    public BulkResetUserStatItem3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final BulkResetUserStatItem3OpResponse response = new BulkResetUserStatItem3OpResponse();
