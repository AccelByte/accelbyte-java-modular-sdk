...
@Getter
@Setter
public class BulkIncUserStatItemValue2OpResponse extends ApiResponseWithData<List<BulkStatOperationResult>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.user_statistic.BulkIncUserStatItemValue2";
    }
}