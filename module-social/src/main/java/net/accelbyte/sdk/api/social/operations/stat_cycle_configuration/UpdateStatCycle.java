...
public class UpdateStatCycle extends Operation {
  ...
  public UpdateStatCycle(
      String customBasePath, String cycleId, String namespace, StatCycleUpdate body) {
  ...
  public UpdateStatCycleOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final UpdateStatCycleOpResponse response = new UpdateStatCycleOpResponse();
