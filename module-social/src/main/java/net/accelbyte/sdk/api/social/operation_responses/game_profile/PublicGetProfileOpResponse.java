...
@Getter
@Setter
public class PublicGetProfileOpResponse extends ApiResponseWithData<GameProfileInfo> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.social.operations.game_profile.PublicGetProfile";
  }
}
