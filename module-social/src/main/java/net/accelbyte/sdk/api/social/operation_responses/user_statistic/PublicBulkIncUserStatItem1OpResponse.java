...
@Getter
@Setter
public class PublicBulkIncUserStatItem1OpResponse extends ApiResponseWithData<List<BulkStatOperationResult>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.user_statistic.PublicBulkIncUserStatItem1";
    }
}