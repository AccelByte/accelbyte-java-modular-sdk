...
import net.accelbyte.sdk.api.social.operation_responses.game_profile.GetProfileOpResponse;
...
public class GetProfile extends Operation {
  ...
  @Deprecated
  public GetProfile(String customBasePath, String namespace, String profileId, String userId) {
  ...
  public GetProfileOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetProfileOpResponse response = new GetProfileOpResponse();
