...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.PublicBulkIncUserStatItemOpResponse;
...
public class PublicBulkIncUserStatItem extends Operation {
    ...
    */
    ...
    public PublicBulkIncUserStatItemOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicBulkIncUserStatItemOpResponse response = new PublicBulkIncUserStatItemOpResponse();
