...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic_cycle.GetUserStatCycleItemsOpResponse;
...
public class GetUserStatCycleItems extends Operation {
     ...
     */
    private String path = "/social/v1/admin/namespaces/{namespace}/users/{userId}/statCycles/{cycleId}/statCycleitems";
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("isPublic", this.isPublic == null ? null : Arrays.asList(String.valueOf(this.isPublic)));
    ...
    public GetUserStatCycleItemsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserStatCycleItemsOpResponse response = new GetUserStatCycleItemsOpResponse();
