...
@Getter
@Setter
public class GetUserProfilesOpResponse extends ApiResponseWithData<List<GameProfileHeader>> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.social.operations.game_profile.GetUserProfiles";
  }
}
