...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.PublicIncUserStatItemOpResponse;
...
public class PublicIncUserStatItem extends Operation {
    ...
    */
    ...
    public PublicIncUserStatItemOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicIncUserStatItemOpResponse response = new PublicIncUserStatItemOpResponse();
