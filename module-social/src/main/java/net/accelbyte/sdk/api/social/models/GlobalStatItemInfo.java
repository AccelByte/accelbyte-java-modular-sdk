...
public class GlobalStatItemInfo extends Model {
    ...
    @JsonIgnore
    public void setGlobalAggregationMethodFromEnum(final GlobalAggregationMethod globalAggregationMethod) {
    ...
    public static class GlobalStatItemInfoBuilder {
        ...
        public GlobalStatItemInfoBuilder globalAggregationMethodFromEnum(final GlobalAggregationMethod globalAggregationMethod) {
            this.globalAggregationMethod = globalAggregationMethod.toString();
            return this;
        }
    }
