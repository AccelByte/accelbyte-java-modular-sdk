...
import net.accelbyte.sdk.api.social.operation_responses.slot.GetSlotDataOpResponse;
...
public class GetSlotData extends Operation {
    ...
    */
    ...
    public GetSlotDataOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetSlotDataOpResponse response = new GetSlotDataOpResponse();
