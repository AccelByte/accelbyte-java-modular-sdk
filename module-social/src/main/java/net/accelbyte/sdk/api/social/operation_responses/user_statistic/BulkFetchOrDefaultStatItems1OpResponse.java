...
@Getter
@Setter
public class BulkFetchOrDefaultStatItems1OpResponse extends ApiResponseWithData<List<ADTOObjectForUserStatItemValue>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.user_statistic.BulkFetchOrDefaultStatItems1";
    }
}