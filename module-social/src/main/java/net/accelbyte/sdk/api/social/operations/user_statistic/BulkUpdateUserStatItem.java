...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.BulkUpdateUserStatItemOpResponse;
...
public class BulkUpdateUserStatItem extends Operation {
    ...
    */
    ...
    public BulkUpdateUserStatItemOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final BulkUpdateUserStatItemOpResponse response = new BulkUpdateUserStatItemOpResponse();
