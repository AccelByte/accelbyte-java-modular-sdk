...
@Getter
@Setter
public class BulkIncUserStatItemValueOpResponse extends ApiResponseWithData<List<BulkStatOperationResult>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.user_statistic.BulkIncUserStatItemValue";
    }
}