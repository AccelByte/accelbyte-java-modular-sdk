...
@Getter
@Setter
public class PublicQueryUserStatItems1OpResponse extends ApiResponseWithData<List<ADTOObjectForUserStatItemValue>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.user_statistic.PublicQueryUserStatItems1";
    }
}