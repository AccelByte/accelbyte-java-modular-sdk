...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.PublicListMyStatItemsOpResponse;
...
public class PublicListMyStatItems extends Operation {
    ...
    */
    ...
    public PublicListMyStatItemsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicListMyStatItemsOpResponse response = new PublicListMyStatItemsOpResponse();
