...
@Getter
@Setter
public class PublicQueryUserStatItemsOpResponse extends ApiResponseWithData<UserStatItemPagingSlicedResult> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.user_statistic.PublicQueryUserStatItems";
    }
}