...
@Getter
@Setter
public class ImportStatCycleOpResponse extends ApiResponseWithData<StatImportInfo> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.social.operations.stat_cycle_configuration.ImportStatCycle";
  }
}
