...
public class BulkFetchOrDefaultStatItems1 extends Operation {
  ...
  public BulkFetchOrDefaultStatItems1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final BulkFetchOrDefaultStatItems1OpResponse response =
        new BulkFetchOrDefaultStatItems1OpResponse();
