...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.PublicCreateUserStatItemOpResponse;
...
public class PublicCreateUserStatItem extends Operation {
    ...
    */
    ...
    public PublicCreateUserStatItemOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicCreateUserStatItemOpResponse response = new PublicCreateUserStatItemOpResponse();
