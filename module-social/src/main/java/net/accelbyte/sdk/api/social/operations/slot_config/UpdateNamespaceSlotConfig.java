...
import net.accelbyte.sdk.api.social.operation_responses.slot_config.UpdateNamespaceSlotConfigOpResponse;
...
public class UpdateNamespaceSlotConfig extends Operation {
  ...
  @Deprecated
  public UpdateNamespaceSlotConfig(String customBasePath, String namespace, SlotConfigUpdate body) {
  ...
  public UpdateNamespaceSlotConfigOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdateNamespaceSlotConfigOpResponse response = new UpdateNamespaceSlotConfigOpResponse();
