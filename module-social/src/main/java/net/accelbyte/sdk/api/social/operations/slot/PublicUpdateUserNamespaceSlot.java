...
public class PublicUpdateUserNamespaceSlot extends Operation {
    ...
    */
    ...
    public PublicUpdateUserNamespaceSlotOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicUpdateUserNamespaceSlotOpResponse response = new PublicUpdateUserNamespaceSlotOpResponse();
