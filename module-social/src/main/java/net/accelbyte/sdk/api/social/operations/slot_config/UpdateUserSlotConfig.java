...
import net.accelbyte.sdk.api.social.operation_responses.slot_config.UpdateUserSlotConfigOpResponse;
...
public class UpdateUserSlotConfig extends Operation {
    ...
    */
    ...
    public UpdateUserSlotConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateUserSlotConfigOpResponse response = new UpdateUserSlotConfigOpResponse();
