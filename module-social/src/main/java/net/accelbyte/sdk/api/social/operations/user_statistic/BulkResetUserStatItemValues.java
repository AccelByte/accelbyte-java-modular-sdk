...
public class BulkResetUserStatItemValues extends Operation {
  ...
  public BulkResetUserStatItemValuesOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final BulkResetUserStatItemValuesOpResponse response =
        new BulkResetUserStatItemValuesOpResponse();
