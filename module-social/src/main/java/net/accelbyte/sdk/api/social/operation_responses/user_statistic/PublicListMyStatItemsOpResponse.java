...
@Getter
@Setter
public class PublicListMyStatItemsOpResponse extends ApiResponseWithData<UserStatItemPagingSlicedResult> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.user_statistic.PublicListMyStatItems";
    }
}