...
public class BulkFetchOrDefaultStatItems extends Operation {
  ...
  public BulkFetchOrDefaultStatItemsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final BulkFetchOrDefaultStatItemsOpResponse response =
        new BulkFetchOrDefaultStatItemsOpResponse();
