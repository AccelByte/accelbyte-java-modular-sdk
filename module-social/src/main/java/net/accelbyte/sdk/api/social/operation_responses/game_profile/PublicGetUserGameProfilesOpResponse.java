...
@Getter
@Setter
public class PublicGetUserGameProfilesOpResponse extends ApiResponseWithData<List<UserGameProfiles>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.game_profile.PublicGetUserGameProfiles";
    }
}