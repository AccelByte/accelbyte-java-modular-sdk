...
@Getter
@Setter
public class PublicIncUserStatItemOpResponse extends ApiResponseWithData<StatItemIncResult> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.user_statistic.PublicIncUserStatItem";
    }
}