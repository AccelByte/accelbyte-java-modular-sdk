...
import net.accelbyte.sdk.api.social.operation_responses.slot_config.DeleteUserSlotConfigOpResponse;
...
public class DeleteUserSlotConfig extends Operation {
    ...
    */
    ...
    public DeleteUserSlotConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteUserSlotConfigOpResponse response = new DeleteUserSlotConfigOpResponse();
