...
@Getter
@Setter
public class ExportStatCycleOpResponse extends ApiResponseWithData<InputStream> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.social.operations.stat_cycle_configuration.ExportStatCycle";
    }
}