...
import net.accelbyte.sdk.api.social.operation_responses.user_statistic.BulkResetUserStatItemOpResponse;
...
public class BulkResetUserStatItem extends Operation {
    ...
    */
    ...
    public BulkResetUserStatItemOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final BulkResetUserStatItemOpResponse response = new BulkResetUserStatItemOpResponse();
