...
public class CreateStat extends Operation {
  ...
  @Deprecated
  public CreateStat(String customBasePath, String namespace, StatCreate body) {
  ...
  public CreateStatOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final CreateStatOpResponse response = new CreateStatOpResponse();
