...
| `/chat/v1/admin/inbox/namespaces/{namespace}/list/topic/kafka` | GET | AdminListKafkaTopic | [AdminListKafkaTopic](../../module-chat/src/main/java/net/accelbyte/sdk/api/chat/operations/inbox/AdminListKafkaTopic.java) | [AdminListKafkaTopic](../../samples/cli/src/main/java/net/accelbyte/sdk/cli/api/chat/inbox/AdminListKafkaTopic.java) |
...
| `models.GetListTopicKafkaResponse` | [ModelsGetListTopicKafkaResponse](../../module-chat/src/main/java/net/accelbyte/sdk/api/chat/models/ModelsGetListTopicKafkaResponse.java) |
