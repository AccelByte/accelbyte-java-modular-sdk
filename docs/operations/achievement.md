...
| `/achievement/v1/admin/namespaces/{namespace}/users/{userId}/achievements/batchQuery` | POST | AdminBatchQueryUserAchievements | [AdminBatchQueryUserAchievements](../../module-achievement/src/main/java/net/accelbyte/sdk/api/achievement/operations/user_achievements/AdminBatchQueryUserAchievements.java) | [AdminBatchQueryUserAchievements](../../samples/cli/src/main/java/net/accelbyte/sdk/cli/api/achievement/user_achievements/AdminBatchQueryUserAchievements.java) |
...
| `models.BatchQueryUserAchievementRequest` | [ModelsBatchQueryUserAchievementRequest](../../module-achievement/src/main/java/net/accelbyte/sdk/api/achievement/models/ModelsBatchQueryUserAchievementRequest.java) |
