...
public class DownloadServerArtifact {
   ...
   */
  public DownloadServerArtifactsOpResponse downloadServerArtifacts(DownloadServerArtifacts input)
      throws Exception {
   ...
   */
  public CheckServerArtifactOpResponse checkServerArtifact(CheckServerArtifact input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
