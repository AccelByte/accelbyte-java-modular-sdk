...
public class GetActiveQueue extends Operation {
    ...
    */
    ...
    public GetActiveQueue(
            String customBasePath,            String nodeIP
    )
    {
        this.nodeIP = nodeIP;
    ...
    public GetActiveQueueOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetActiveQueueOpResponse response = new GetActiveQueueOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsQueue().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsQueue parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
