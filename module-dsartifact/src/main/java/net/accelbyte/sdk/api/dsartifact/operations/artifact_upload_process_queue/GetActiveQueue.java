...
public class GetActiveQueue extends Operation {
  ...
  @Deprecated
  public GetActiveQueue(String customBasePath, String nodeIP) {
    this.nodeIP = nodeIP;
  ...
  public GetActiveQueueOpResponse parseResponse(int code, String contentType, InputStream payload)
