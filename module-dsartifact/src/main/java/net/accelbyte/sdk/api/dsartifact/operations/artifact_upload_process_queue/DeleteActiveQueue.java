...
public class DeleteActiveQueue extends Operation {
    ...
    */
    ...
    public DeleteActiveQueueOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteActiveQueueOpResponse response = new DeleteActiveQueueOpResponse();
