...
public class DeleteNodeByID extends Operation {
    ...
    */
    ...
    public DeleteNodeByIDOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteNodeByIDOpResponse response = new DeleteNodeByIDOpResponse();
