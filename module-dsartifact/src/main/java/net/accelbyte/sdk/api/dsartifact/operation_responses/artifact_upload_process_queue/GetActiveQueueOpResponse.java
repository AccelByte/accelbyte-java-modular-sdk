...
@Getter
@Setter
public class GetActiveQueueOpResponse extends ApiResponseWithData<ModelsQueue> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.dsartifact.operations.artifact_upload_process_queue.GetActiveQueue";
  }
}
