...
public class SetActiveQueue extends Operation {
    ...
    */
    ...
    public SetActiveQueueOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SetActiveQueueOpResponse response = new SetActiveQueueOpResponse();
