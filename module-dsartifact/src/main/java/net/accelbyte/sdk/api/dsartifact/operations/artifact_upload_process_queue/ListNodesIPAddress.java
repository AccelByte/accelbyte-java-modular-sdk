...
public class ListNodesIPAddress extends Operation {
    ...
    */
    ...
    public ListNodesIPAddressOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ListNodesIPAddressOpResponse response = new ListNodesIPAddressOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsListNodesIPAddress().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsListNodesIPAddress parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
