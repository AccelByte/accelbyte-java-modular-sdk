...
public class ListQueue extends Operation {
  ...
  @Deprecated
  public ListQueue(
      String customBasePath, Integer limit, String next, String previous, String nodeIP) {
    this.limit = limit;
    this.next = next;
  ...
  public ListQueueOpResponse parseResponse(int code, String contentType, InputStream payload)
