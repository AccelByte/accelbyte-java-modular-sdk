...
import net.accelbyte.sdk.api.dsartifact.operation_responses.all_terminated_servers.*;
...
public class AllTerminatedServers {
   ...
   */
  public ListTerminatedServersOpResponse listTerminatedServers(ListTerminatedServers input)
      throws Exception {
