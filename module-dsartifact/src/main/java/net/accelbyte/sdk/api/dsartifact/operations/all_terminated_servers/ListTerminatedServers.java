...
public class ListTerminatedServers extends Operation {
    ...
    */
    ...
    public ListTerminatedServersOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ListTerminatedServersOpResponse response = new ListTerminatedServersOpResponse();
