...
@Getter
@Setter
public class SetActiveQueueOpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.dsartifact.operations.artifact_upload_process_queue.SetActiveQueue";
    }
}