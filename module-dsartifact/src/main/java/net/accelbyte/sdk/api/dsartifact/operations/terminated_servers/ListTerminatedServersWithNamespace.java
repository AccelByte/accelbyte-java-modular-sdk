...
public class ListTerminatedServersWithNamespace extends Operation {
  ...
  public ListTerminatedServersWithNamespaceOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final ListTerminatedServersWithNamespaceOpResponse response =
        new ListTerminatedServersWithNamespaceOpResponse();
