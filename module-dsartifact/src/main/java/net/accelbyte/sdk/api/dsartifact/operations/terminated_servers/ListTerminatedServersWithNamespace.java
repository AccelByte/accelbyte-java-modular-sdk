...
import net.accelbyte.sdk.api.dsartifact.operation_responses.terminated_servers.ListTerminatedServersWithNamespaceOpResponse;
...
public class ListTerminatedServersWithNamespace extends Operation {
    ...
    */
    ...
    public ListTerminatedServersWithNamespaceOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ListTerminatedServersWithNamespaceOpResponse response = new ListTerminatedServersWithNamespaceOpResponse();
