...
public class AccelByteSDK implements RequestRunner {
  ...
  public HttpResponse runRequest(Operation operation) throws Exception {
    ...
    if (configRepository.isClientInfoHeader()) {
      ...
      final String moduleInformation = SDKInfo.getInstance().getModuleInformation();
        ...
        new CacheLoader<RoleCacheKey, List<Permission>>() {
          ...
          public List<Permission> load(RoleCacheKey key) throws Exception {
            ...
            final AdminGetRoleNamespacePermissionV3 param = AdminGetRoleNamespacePermissionV3.builder()
              ...
              .build();
            final ModelRolePermissionResponseV3 getRoleV3Result = oRoleConfigWrapper
              .adminGetRoleNamespacePermissionV3(param)
              .ensureSuccess();
