...
@Log
public class BackgroundTokenRefreshRepository extends OnDemandTokenRefreshRepository {
    ...
    public static BackgroundTokenRefreshRepository createDefault() {
        final BackgroundTokenRefreshOptions opts = BackgroundTokenRefreshOptions.getDefault();
        return new BackgroundTokenRefreshRepository(opts);
    }
