...
public class AdminCreateJusticeUser extends Operation {
    ...
    */
    ...
    public AdminCreateJusticeUserOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminCreateJusticeUserOpResponse response = new AdminCreateJusticeUserOpResponse();
