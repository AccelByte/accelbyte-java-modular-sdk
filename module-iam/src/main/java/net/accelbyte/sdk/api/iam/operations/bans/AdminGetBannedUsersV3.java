...
import net.accelbyte.sdk.api.iam.operation_responses.bans.AdminGetBannedUsersV3OpResponse;
...
public class AdminGetBannedUsersV3 extends Operation {
    ...
    */
    ...
    public AdminGetBannedUsersV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetBannedUsersV3OpResponse response = new AdminGetBannedUsersV3OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelGetUserBanV3Response().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 401) {
            final String json = Helper.convertInputStreamToString(payload);
