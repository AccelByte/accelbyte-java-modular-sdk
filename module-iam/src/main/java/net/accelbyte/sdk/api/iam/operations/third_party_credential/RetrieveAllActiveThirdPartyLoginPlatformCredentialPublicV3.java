...
public class RetrieveAllActiveThirdPartyLoginPlatformCredentialPublicV3 extends Operation {
    ...
    */
    ...
    public RetrieveAllActiveThirdPartyLoginPlatformCredentialPublicV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RetrieveAllActiveThirdPartyLoginPlatformCredentialPublicV3OpResponse response = new RetrieveAllActiveThirdPartyLoginPlatformCredentialPublicV3OpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<ModelPublicThirdPartyPlatformInfo>>() {}));
        }
        else if (code == 401) {
            final String json = Helper.convertInputStreamToString(payload);
