...
public class UserAuthenticationV3 extends Operation {
    ...
    */
    ...
    public UserAuthenticationV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UserAuthenticationV3OpResponse response = new UserAuthenticationV3OpResponse();
