...
public class Bans {
   ...
   */
  public AdminGetBansTypeV3OpResponse adminGetBansTypeV3(AdminGetBansTypeV3 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminGetListBanReasonV3OpResponse adminGetListBanReasonV3(AdminGetListBanReasonV3 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminGetBannedUsersV3OpResponse adminGetBannedUsersV3(AdminGetBannedUsersV3 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminBanUserBulkV3OpResponse adminBanUserBulkV3(AdminBanUserBulkV3 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminUnbanUserBulkV3OpResponse adminUnbanUserBulkV3(AdminUnbanUserBulkV3 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminGetBansTypeWithNamespaceV3OpResponse adminGetBansTypeWithNamespaceV3(
      AdminGetBansTypeWithNamespaceV3 input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
