...
import net.accelbyte.sdk.api.iam.operation_responses.devices_v4.AdminGetDeviceBanV4OpResponse;
...
public class AdminGetDeviceBanV4 extends Operation {
    ...
    */
    ...
    public AdminGetDeviceBanV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetDeviceBanV4OpResponse response = new AdminGetDeviceBanV4OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelDeviceBanResponseV4().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
