...
@Getter
@Setter
public class AdminCreateJusticeUserOpResponse extends ApiResponseWithData<ModelCreateJusticeUserResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminCreateJusticeUser";
    }
}