...
@Getter
@Setter
public class GetRoleManagersOpResponse extends ApiResponseWithData<ModelRoleManagersResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.roles.GetRoleManagers";
  }
}
