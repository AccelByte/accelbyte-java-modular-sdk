...
public class LoginAllowlist {
   ...
   */
  public AdminGetLoginAllowlistV3OpResponse adminGetLoginAllowlistV3(AdminGetLoginAllowlistV3 input)
      throws Exception {
   ...
   */
  public AdminUpdateLoginAllowlistV3OpResponse adminUpdateLoginAllowlistV3(
      AdminUpdateLoginAllowlistV3 input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
