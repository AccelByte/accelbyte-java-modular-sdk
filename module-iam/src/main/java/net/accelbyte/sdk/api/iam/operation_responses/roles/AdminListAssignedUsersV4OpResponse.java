...
@Getter
@Setter
public class AdminListAssignedUsersV4OpResponse extends ApiResponseWithData<ModelListAssignedUsersV4Response> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.roles.AdminListAssignedUsersV4";
    }
}