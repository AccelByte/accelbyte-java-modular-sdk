...
@Getter
@Setter
public class GetUserByPlatformUserIDOpResponse extends ApiResponseWithData<ModelPublicUserResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.GetUserByPlatformUserID";
    }
}