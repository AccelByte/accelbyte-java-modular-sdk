 ...
 * _/iam/v3/public/namespaces/{namespace}/users/{userId}/logins/histories [GET]_** - **Substitute
 * endpoint: _/iam/v3/admin/namespaces/{namespace}/users/{userId}/logins/histories [GET]_**
 *
 * <p>Notes: - Retrieves the first page of the data if 'after' and 'before' parameters is empty. -
 * The maximum value of the limit is 100 and the minimum value of the limit is 1. - Retrieves the
 * next page of the data if we provide 'after' parameters with valid Unix timestamp. - Retrieves the
 * previous page of the data if we provide 'before' parameter with valid data Unix timestamp.
 *
 * @deprecated
 */
@Deprecated
...
public class GetUserLoginHistories extends Operation {
  ...
  public GetUserLoginHistoriesOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetUserLoginHistoriesOpResponse response = new GetUserLoginHistoriesOpResponse();
