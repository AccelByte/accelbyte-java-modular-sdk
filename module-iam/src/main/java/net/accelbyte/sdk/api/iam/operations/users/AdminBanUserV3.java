...
public class AdminBanUserV3 extends Operation {
  ...
  public AdminBanUserV3(
      String customBasePath, String namespace, String userId, ModelBanCreateRequest body) {
  ...
  public AdminBanUserV3OpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final AdminBanUserV3OpResponse response = new AdminBanUserV3OpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ModelUserBanResponseV3().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
