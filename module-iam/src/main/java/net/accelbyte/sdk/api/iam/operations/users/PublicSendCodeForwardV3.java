...
public class PublicSendCodeForwardV3 extends Operation {
  ...
  @Deprecated
  public PublicSendCodeForwardV3(String customBasePath, ModelSendVerificationCodeRequestV3 body) {
    this.body = body;
  ...
  public PublicSendCodeForwardV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicSendCodeForwardV3OpResponse response = new PublicSendCodeForwardV3OpResponse();
