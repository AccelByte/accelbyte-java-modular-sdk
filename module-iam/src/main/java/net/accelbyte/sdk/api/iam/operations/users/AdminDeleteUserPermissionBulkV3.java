...
public class AdminDeleteUserPermissionBulkV3 extends Operation {
  ...
  public AdminDeleteUserPermissionBulkV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminDeleteUserPermissionBulkV3OpResponse response =
        new AdminDeleteUserPermissionBulkV3OpResponse();
