...
public class AdminUpdateCountryAgeRestrictionV3 extends Operation {
    ...
    */
    ...
    public AdminUpdateCountryAgeRestrictionV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateCountryAgeRestrictionV3OpResponse response = new AdminUpdateCountryAgeRestrictionV3OpResponse();
