...
public class ModelDeviceBanResponseV4 extends Model {
    ...
    @JsonIgnore
    public List<ModelDeviceBanResponseV4> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelDeviceBanResponseV4>>() {});
    }
