...
@Getter
@Setter
public class PublicUpdateUserEmailAddressV4OpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.PublicUpdateUserEmailAddressV4";
    }
}