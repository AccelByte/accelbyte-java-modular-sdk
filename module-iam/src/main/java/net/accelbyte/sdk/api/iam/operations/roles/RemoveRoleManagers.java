...
import net.accelbyte.sdk.api.iam.operation_responses.roles.RemoveRoleManagersOpResponse;
 ...
 * _/iam/v3/admin/roles/{roleId}/managers [DELETE]_**
 *
 * @deprecated
 */
@Deprecated
...
public class RemoveRoleManagers extends Operation {
  ...
  @Deprecated
  public RemoveRoleManagers(String customBasePath, String roleId, ModelRoleManagersRequest body) {
    this.roleId = roleId;
    this.body = body;
  ...
  public RemoveRoleManagersOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final RemoveRoleManagersOpResponse response = new RemoveRoleManagersOpResponse();
