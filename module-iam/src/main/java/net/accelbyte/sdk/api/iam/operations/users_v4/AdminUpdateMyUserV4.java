...
public class AdminUpdateMyUserV4 extends Operation {
    ...
    */
    ...
    public AdminUpdateMyUserV4(
            String customBasePath,            ModelUserUpdateRequestV3 body
    )
    {
        this.body = body;
    ...
    public AdminUpdateMyUserV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
