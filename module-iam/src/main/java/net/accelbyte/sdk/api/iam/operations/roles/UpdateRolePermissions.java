...
import net.accelbyte.sdk.api.iam.operation_responses.roles.UpdateRolePermissionsOpResponse;
...
public class UpdateRolePermissions extends Operation {
    ...
    */
    ...
    public UpdateRolePermissionsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateRolePermissionsOpResponse response = new UpdateRolePermissionsOpResponse();
