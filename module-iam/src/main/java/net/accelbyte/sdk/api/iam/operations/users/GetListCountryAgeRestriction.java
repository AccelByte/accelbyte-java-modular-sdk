 ...
 * _/iam/v3/admin/namespaces/{namespace}/agerestrictions/countries [GET]_**
 *
 * @deprecated
 */
@Deprecated
...
public class GetListCountryAgeRestriction extends Operation {
  ...
  @Deprecated
  public GetListCountryAgeRestriction(String customBasePath, String namespace) {
  ...
  public GetListCountryAgeRestrictionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetListCountryAgeRestrictionOpResponse response =
        new GetListCountryAgeRestrictionOpResponse();
