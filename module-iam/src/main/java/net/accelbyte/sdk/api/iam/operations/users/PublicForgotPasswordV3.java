...
public class PublicForgotPasswordV3 extends Operation {
    ...
    */
    ...
    public PublicForgotPasswordV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicForgotPasswordV3OpResponse response = new PublicForgotPasswordV3OpResponse();
