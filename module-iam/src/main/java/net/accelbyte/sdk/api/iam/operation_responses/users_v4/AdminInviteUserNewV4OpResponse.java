...
@Getter
@Setter
public class AdminInviteUserNewV4OpResponse extends ApiResponseWithData<ModelInviteUserResponseV3> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.users_v4.AdminInviteUserNewV4";
  }
}
