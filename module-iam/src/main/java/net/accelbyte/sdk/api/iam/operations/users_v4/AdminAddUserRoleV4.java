...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.AdminAddUserRoleV4OpResponse;
...
public class AdminAddUserRoleV4 extends Operation {
    ...
    */
    ...
    public AdminAddUserRoleV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminAddUserRoleV4OpResponse response = new AdminAddUserRoleV4OpResponse();
