...
public class PublicCreateUserV2 extends Operation {
    ...
    */
    ...
    public PublicCreateUserV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicCreateUserV2OpResponse response = new PublicCreateUserV2OpResponse();
