 ...
 * _/iam/v3/public/namespaces/{namespace}/users/reset [POST]_**
 *
 * @deprecated
 */
@Deprecated
...
public class ResetPassword extends Operation {
  ...
  @Deprecated
  public ResetPassword(String customBasePath, String namespace, ModelResetPasswordRequest body) {
  ...
  public ResetPasswordOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final ResetPasswordOpResponse response = new ResetPasswordOpResponse();
