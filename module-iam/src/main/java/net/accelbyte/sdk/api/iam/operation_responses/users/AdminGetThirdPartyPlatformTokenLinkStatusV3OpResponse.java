...
@Getter
@Setter
public class AdminGetThirdPartyPlatformTokenLinkStatusV3OpResponse extends ApiResponseWithData<ModelTokenThirdPartyLinkStatusResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminGetThirdPartyPlatformTokenLinkStatusV3";
    }
}