...
@Getter
@Setter
public class PublicVerifyHeadlessAccountV3OpResponse extends ApiResponseWithData<ModelUserResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.PublicVerifyHeadlessAccountV3";
    }
}