 ...
 * _/iam/v3/admin/namespaces/{namespace}/clients/{clientId} [PATCH]_**
 *
 * @deprecated
 */
@Deprecated
...
public class UpdateClient extends Operation {
  ...
  public UpdateClientOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final UpdateClientOpResponse response = new UpdateClientOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ClientmodelClientResponse().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public ClientmodelClientResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
