...
@Getter
@Setter
public class GetRoleMembersOpResponse extends ApiResponseWithData<ModelRoleMembersResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.roles.GetRoleMembers";
    }
}