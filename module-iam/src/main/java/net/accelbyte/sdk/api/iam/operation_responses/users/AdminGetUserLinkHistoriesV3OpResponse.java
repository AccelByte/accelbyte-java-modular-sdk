...
@Getter
@Setter
public class AdminGetUserLinkHistoriesV3OpResponse extends ApiResponseWithData<ModelUserPlatformLinkHistories> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminGetUserLinkHistoriesV3";
    }
}