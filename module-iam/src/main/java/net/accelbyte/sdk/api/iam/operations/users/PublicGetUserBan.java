 ...
 * _/iam/v3/public/namespaces/{namespace}/users/{userId}/bans [GET]_**
 *
 * @deprecated
 */
@Deprecated
...
public class PublicGetUserBan extends Operation {
  ...
  public PublicGetUserBan(
      String customBasePath, String namespace, String userId, Boolean activeOnly) {
  ...
  public PublicGetUserBanOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final PublicGetUserBanOpResponse response = new PublicGetUserBanOpResponse();
    ...
    if (code == 204) {
      ...
      response.setSuccess(true);
      response.setData(
          new ObjectMapper().readValue(json, new TypeReference<List<ModelUserBanResponse>>() {}));
    } else if (code == 401) {
      final String json = Helper.convertInputStreamToString(payload);
