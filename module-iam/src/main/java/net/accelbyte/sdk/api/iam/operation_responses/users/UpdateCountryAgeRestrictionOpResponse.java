...
@Getter
@Setter
public class UpdateCountryAgeRestrictionOpResponse extends ApiResponseWithData<ModelCountry> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.users.UpdateCountryAgeRestriction";
  }
}
