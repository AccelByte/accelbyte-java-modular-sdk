...
public class AdminRetrieveUserThirdPartyPlatformTokenV3 extends Operation {
    ...
    */
    ...
    public AdminRetrieveUserThirdPartyPlatformTokenV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminRetrieveUserThirdPartyPlatformTokenV3OpResponse response = new AdminRetrieveUserThirdPartyPlatformTokenV3OpResponse();
