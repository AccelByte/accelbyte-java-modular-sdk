...
public class ModelBulkBanCreateRequestV3 extends Model {
    ...
    @JsonIgnore
    public List<ModelBulkBanCreateRequestV3> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelBulkBanCreateRequestV3>>() {});
    }
