...
public class ThirdPartyCredential {
   ...
   */
  public RetrieveAllThirdPartyLoginPlatformCredentialV3OpResponse
   ...
   */
  public RetrieveAllActiveThirdPartyLoginPlatformCredentialV3OpResponse
   ...
   */
  public RetrieveThirdPartyLoginPlatformCredentialV3OpResponse
      retrieveThirdPartyLoginPlatformCredentialV3(RetrieveThirdPartyLoginPlatformCredentialV3 input)
          throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AddThirdPartyLoginPlatformCredentialV3OpResponse addThirdPartyLoginPlatformCredentialV3(
   ...
   */
  public DeleteThirdPartyLoginPlatformCredentialV3OpResponse
      deleteThirdPartyLoginPlatformCredentialV3(DeleteThirdPartyLoginPlatformCredentialV3 input)
          throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public UpdateThirdPartyLoginPlatformCredentialV3OpResponse
      updateThirdPartyLoginPlatformCredentialV3(UpdateThirdPartyLoginPlatformCredentialV3 input)
          throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public UpdateThirdPartyLoginPlatformDomainV3OpResponse updateThirdPartyLoginPlatformDomainV3(
   ...
   */
  public DeleteThirdPartyLoginPlatformDomainV3OpResponse deleteThirdPartyLoginPlatformDomainV3(
      DeleteThirdPartyLoginPlatformDomainV3 input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public RetrieveActiveOIDCClientsPublicV3OpResponse retrieveActiveOIDCClientsPublicV3(
