...
public class PublicListUserIDByPlatformUserIDsV3 extends Operation {
    ...
    */
    ...
    public PublicListUserIDByPlatformUserIDsV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicListUserIDByPlatformUserIDsV3OpResponse response = new PublicListUserIDByPlatformUserIDsV3OpResponse();
