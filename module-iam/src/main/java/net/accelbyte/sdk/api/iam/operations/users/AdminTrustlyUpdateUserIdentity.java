...
public class AdminTrustlyUpdateUserIdentity extends Operation {
    ...
    */
    ...
    public AdminTrustlyUpdateUserIdentityOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminTrustlyUpdateUserIdentityOpResponse response = new AdminTrustlyUpdateUserIdentityOpResponse();
