...
public class AdminUpdateAdminRoleStatusV3 extends Operation {
  ...
  @Deprecated
  public AdminUpdateAdminRoleStatusV3(String customBasePath, String roleId) {
    this.roleId = roleId;
  ...
  public AdminUpdateAdminRoleStatusV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminUpdateAdminRoleStatusV3OpResponse response =
        new AdminUpdateAdminRoleStatusV3OpResponse();
