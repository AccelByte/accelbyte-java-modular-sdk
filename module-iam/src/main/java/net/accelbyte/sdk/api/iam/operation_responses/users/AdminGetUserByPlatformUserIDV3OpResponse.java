...
@Getter
@Setter
public class AdminGetUserByPlatformUserIDV3OpResponse extends ApiResponseWithData<ModelUserResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminGetUserByPlatformUserIDV3";
    }
}