...
@Getter
@Setter
public class AdminGetAgeRestrictionStatusV3OpResponse extends ApiResponseWithData<ModelAgeRestrictionResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminGetAgeRestrictionStatusV3";
    }
}