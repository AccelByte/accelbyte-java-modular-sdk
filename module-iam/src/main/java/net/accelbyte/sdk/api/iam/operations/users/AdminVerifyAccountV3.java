...
public class AdminVerifyAccountV3 extends Operation {
    ...
    */
    ...
    public AdminVerifyAccountV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminVerifyAccountV3OpResponse response = new AdminVerifyAccountV3OpResponse();
