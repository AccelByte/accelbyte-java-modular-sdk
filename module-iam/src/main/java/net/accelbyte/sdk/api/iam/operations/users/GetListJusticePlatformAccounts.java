...
public class GetListJusticePlatformAccounts extends Operation {
    ...
    */
    ...
    public GetListJusticePlatformAccountsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetListJusticePlatformAccountsOpResponse response = new GetListJusticePlatformAccountsOpResponse();
