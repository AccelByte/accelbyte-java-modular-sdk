...
import net.accelbyte.sdk.api.iam.operation_responses.clients.AdminUpdateClientSecretV3OpResponse;
...
public class AdminUpdateClientSecretV3 extends Operation {
    ...
    */
    ...
    public AdminUpdateClientSecretV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateClientSecretV3OpResponse response = new AdminUpdateClientSecretV3OpResponse();
