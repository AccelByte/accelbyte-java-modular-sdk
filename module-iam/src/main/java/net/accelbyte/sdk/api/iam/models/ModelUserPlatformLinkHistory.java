...
public class ModelUserPlatformLinkHistory extends Model {
    ...
    @JsonIgnore
    public List<ModelUserPlatformLinkHistory> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelUserPlatformLinkHistory>>() {});
    }
