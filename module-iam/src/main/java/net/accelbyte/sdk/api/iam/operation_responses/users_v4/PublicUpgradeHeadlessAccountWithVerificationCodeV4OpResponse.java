...
@Getter
@Setter
public class PublicUpgradeHeadlessAccountWithVerificationCodeV4OpResponse extends ApiResponseWithData<AccountUserResponseV4> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.PublicUpgradeHeadlessAccountWithVerificationCodeV4";
    }
}