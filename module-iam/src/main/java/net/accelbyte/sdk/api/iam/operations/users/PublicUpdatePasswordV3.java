...
public class PublicUpdatePasswordV3 extends Operation {
    ...
    */
    ...
    public PublicUpdatePasswordV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicUpdatePasswordV3OpResponse response = new PublicUpdatePasswordV3OpResponse();
