...
import net.accelbyte.sdk.api.iam.operation_responses.roles.SetRoleAsAdminOpResponse;
...
public class SetRoleAsAdmin extends Operation {
  ...
  @Deprecated
  public SetRoleAsAdmin(String customBasePath, String roleId) {
    this.roleId = roleId;
  ...
  public SetRoleAsAdminOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final SetRoleAsAdminOpResponse response = new SetRoleAsAdminOpResponse();
