...
@Getter
@Setter
public class ListAdminsV3OpResponse extends ApiResponseWithData<ModelGetUsersResponseWithPaginationV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.ListAdminsV3";
    }
}