...
public class AdminGetUserByEmailAddressV3 extends Operation {
  ...
  public AdminGetUserByEmailAddressV3(
      String customBasePath, String namespace, String emailAddress) {
  ...
  public AdminGetUserByEmailAddressV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetUserByEmailAddressV3OpResponse response =
        new AdminGetUserByEmailAddressV3OpResponse();
