...
@Getter
@Setter
public class PublicGetUserByPlatformUserIDV4OpResponse
    extends ApiResponseWithData<ModelUserResponseV3> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.users_v4.PublicGetUserByPlatformUserIDV4";
  }
}
