...
public class AdminChangeRoleOverrideConfigStatusV3 extends Operation {
    ...
    */
    ...
    public AdminChangeRoleOverrideConfigStatusV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminChangeRoleOverrideConfigStatusV3OpResponse response = new AdminChangeRoleOverrideConfigStatusV3OpResponse();
