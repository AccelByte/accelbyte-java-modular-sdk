...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.AdminUpdateUserRoleV4OpResponse;
...
public class AdminUpdateUserRoleV4 extends Operation {
    ...
    */
    ...
    public AdminUpdateUserRoleV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateUserRoleV4OpResponse response = new AdminUpdateUserRoleV4OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelListUserRolesV4Response().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelListUserRolesV4Response parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
