 ...
 * Country use ISO3166-1 alpha-2 two letter, e.g. US. Date of Birth format : YYYY-MM-DD, e.g.
 * 2019-04-29. **Response body logic when user updating email address:** - User want to update email
 * address of which have been verified, newEmailAddress response field will be filled with new email
 ...
 *
 * <p>**Important notes:** Provides PATCH support for clients that do not support PATCH natively,
 * e.g. UE4 before v4.23 released. If the client support PATCH method, use [PATCH]
...
public class UpdateUserV3 extends Operation {
  ...
  public UpdateUserV3OpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final UpdateUserV3OpResponse response = new UpdateUserV3OpResponse();
