...
public class PlatformAuthenticateSAMLV3Handler extends Operation {
    ...
    */
    ...
    public PlatformAuthenticateSAMLV3HandlerOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PlatformAuthenticateSAMLV3HandlerOpResponse response = new PlatformAuthenticateSAMLV3HandlerOpResponse();
