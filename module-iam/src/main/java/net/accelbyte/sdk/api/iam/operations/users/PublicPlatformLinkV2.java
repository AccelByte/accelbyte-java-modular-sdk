...
public class PublicPlatformLinkV2 extends Operation {
    ...
    */
    ...
    public PublicPlatformLinkV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicPlatformLinkV2OpResponse response = new PublicPlatformLinkV2OpResponse();
