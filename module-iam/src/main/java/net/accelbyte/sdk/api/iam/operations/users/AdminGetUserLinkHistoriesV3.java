...
public class AdminGetUserLinkHistoriesV3 extends Operation {
  ...
  public AdminGetUserLinkHistoriesV3(
      String customBasePath, String namespace, String userId, String platformId) {
  ...
  public AdminGetUserLinkHistoriesV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetUserLinkHistoriesV3OpResponse response =
        new AdminGetUserLinkHistoriesV3OpResponse();
