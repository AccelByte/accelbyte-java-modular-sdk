...
@Getter
@Setter
public class AdminGetListJusticePlatformAccountsOpResponse extends ApiResponseWithData<List<ModelGetUserMapping>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminGetListJusticePlatformAccounts";
    }
}