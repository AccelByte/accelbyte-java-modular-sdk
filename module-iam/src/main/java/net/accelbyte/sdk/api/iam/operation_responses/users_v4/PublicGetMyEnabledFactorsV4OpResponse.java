...
@Getter
@Setter
public class PublicGetMyEnabledFactorsV4OpResponse extends ApiResponseWithData<ModelEnabledFactorsResponseV4> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.PublicGetMyEnabledFactorsV4";
    }
}