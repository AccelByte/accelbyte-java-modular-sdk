 ...
 * verify the user's contact address is correct Available ContactType : **email**
 */
@Getter
@Setter
public class PublicUserVerificationV3 extends Operation {
  ...
  public PublicUserVerificationV3(
      String customBasePath, String namespace, ModelUserVerificationRequestV3 body) {
  ...
  public PublicUserVerificationV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicUserVerificationV3OpResponse response = new PublicUserVerificationV3OpResponse();
