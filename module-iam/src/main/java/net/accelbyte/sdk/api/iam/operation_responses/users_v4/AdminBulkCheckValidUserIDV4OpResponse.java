...
@Getter
@Setter
public class AdminBulkCheckValidUserIDV4OpResponse extends ApiResponseWithData<ModelListValidUserIDResponseV4> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.AdminBulkCheckValidUserIDV4";
    }
}