...
public class PublicGetLinkHeadlessAccountToMyAccountConflictV3 extends Operation {
    ...
    */
    ...
    public PublicGetLinkHeadlessAccountToMyAccountConflictV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetLinkHeadlessAccountToMyAccountConflictV3OpResponse response = new PublicGetLinkHeadlessAccountToMyAccountConflictV3OpResponse();
