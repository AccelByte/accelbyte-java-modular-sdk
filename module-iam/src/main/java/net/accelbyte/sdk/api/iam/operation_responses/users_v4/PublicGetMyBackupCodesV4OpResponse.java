...
@Getter
@Setter
public class PublicGetMyBackupCodesV4OpResponse extends ApiResponseWithData<ModelBackupCodesResponseV4> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.PublicGetMyBackupCodesV4";
    }
}