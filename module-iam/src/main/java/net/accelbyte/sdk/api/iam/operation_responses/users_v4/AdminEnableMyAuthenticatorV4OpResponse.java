...
@Getter
@Setter
public class AdminEnableMyAuthenticatorV4OpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.AdminEnableMyAuthenticatorV4";
    }
}