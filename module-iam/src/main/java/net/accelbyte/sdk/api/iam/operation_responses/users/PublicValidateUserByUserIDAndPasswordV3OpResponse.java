...
@Getter
@Setter
public class PublicValidateUserByUserIDAndPasswordV3OpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.PublicValidateUserByUserIDAndPasswordV3";
    }
}