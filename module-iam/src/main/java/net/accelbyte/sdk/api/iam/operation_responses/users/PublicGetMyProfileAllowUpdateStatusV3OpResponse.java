...
@Getter
@Setter
public class PublicGetMyProfileAllowUpdateStatusV3OpResponse extends ApiResponseWithData<ModelUserProfileUpdateAllowStatus> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.PublicGetMyProfileAllowUpdateStatusV3";
    }
}