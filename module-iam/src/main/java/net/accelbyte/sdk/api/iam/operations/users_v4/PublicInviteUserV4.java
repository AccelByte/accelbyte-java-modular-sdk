...
public class PublicInviteUserV4 extends Operation {
    ...
    */
    ...
    public PublicInviteUserV4(
            String customBasePath,            ModelPublicInviteUserRequestV4 body
    )
    {
        this.body = body;
    ...
    public PublicInviteUserV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
