...
@Getter
@Setter
public class AdminBanUserV3OpResponse extends ApiResponseWithData<ModelUserBanResponseV3> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.users.AdminBanUserV3";
  }
}
