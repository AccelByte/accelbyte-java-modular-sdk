...
@Getter
@Setter
public class GetUsersByLoginIdsOpResponse extends ApiResponseWithData<ModelPublicUsersResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.users.GetUsersByLoginIds";
  }
}
