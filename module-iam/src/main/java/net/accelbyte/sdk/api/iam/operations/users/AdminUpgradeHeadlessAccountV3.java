...
public class AdminUpgradeHeadlessAccountV3 extends Operation {
    ...
    */
    ...
    public AdminUpgradeHeadlessAccountV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpgradeHeadlessAccountV3OpResponse response = new AdminUpgradeHeadlessAccountV3OpResponse();
