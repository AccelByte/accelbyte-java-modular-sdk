...
import net.accelbyte.sdk.api.iam.operation_responses.clients.AddClientPermissionOpResponse;
...
public class AddClientPermission extends Operation {
    ...
    */
    ...
    public AddClientPermissionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AddClientPermissionOpResponse response = new AddClientPermissionOpResponse();
