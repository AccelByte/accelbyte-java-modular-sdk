...
public class AdminDeleteUserPermissionV3 extends Operation {
    ...
    */
    ...
    public AdminDeleteUserPermissionV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDeleteUserPermissionV3OpResponse response = new AdminDeleteUserPermissionV3OpResponse();
