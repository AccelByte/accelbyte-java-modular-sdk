...
public class AdminGenerateMyBackupCodesV4 extends Operation {
  ...
  @Deprecated
  public AdminGenerateMyBackupCodesV4(String customBasePath) {
  ...
  public AdminGenerateMyBackupCodesV4OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGenerateMyBackupCodesV4OpResponse response =
        new AdminGenerateMyBackupCodesV4OpResponse();
