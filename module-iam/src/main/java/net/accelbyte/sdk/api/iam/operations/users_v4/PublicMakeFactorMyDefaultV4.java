...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.PublicMakeFactorMyDefaultV4OpResponse;
...
public class PublicMakeFactorMyDefaultV4 extends Operation {
    ...
    */
    ...
    public PublicMakeFactorMyDefaultV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicMakeFactorMyDefaultV4OpResponse response = new PublicMakeFactorMyDefaultV4OpResponse();
