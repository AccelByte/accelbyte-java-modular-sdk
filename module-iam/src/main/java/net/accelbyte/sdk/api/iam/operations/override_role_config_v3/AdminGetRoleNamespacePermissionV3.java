...
public class AdminGetRoleNamespacePermissionV3 extends Operation {
  ...
  @Deprecated
  public AdminGetRoleNamespacePermissionV3(String customBasePath, String namespace, String roleId) {
  ...
  public AdminGetRoleNamespacePermissionV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetRoleNamespacePermissionV3OpResponse response =
        new AdminGetRoleNamespacePermissionV3OpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ModelRolePermissionResponseV3().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 401) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public ModelRolePermissionResponseV3 parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
