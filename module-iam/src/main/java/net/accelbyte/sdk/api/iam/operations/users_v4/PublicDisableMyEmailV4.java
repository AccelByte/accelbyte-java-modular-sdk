...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.PublicDisableMyEmailV4OpResponse;
...
public class PublicDisableMyEmailV4 extends Operation {
    ...
    */
    ...
    public PublicDisableMyEmailV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicDisableMyEmailV4OpResponse response = new PublicDisableMyEmailV4OpResponse();
