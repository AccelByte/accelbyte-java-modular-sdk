 ...
 * RevokeUser
 *
 * <p>**This endpoint is deprecated.** Requires all requests to have authorization header set with
 * bearer token.
 *
 * <p>Revokes all access tokens and refresh tokens a user has prior the revocation time. It is a
 * convenient feature for the developer (or admin) who wanted to revokes all user's access tokens
 * and refresh tokens generated before some period of time. ### Endpoint migration guide -
 * **Substitute endpoint: _/iam/v3/oauth/admin/namespaces/{namespace}/users/{userId}/revoke
 * [POST]_**
 *
 * @deprecated
 */
...
public class RevokeUser extends Operation {
  ...
  public RevokeUserOpResponse parseResponse(int code, String contentType, InputStream payload)
