...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.PublicUpdateUserEmailAddressV4OpResponse;
 ...
 *
 * <p>Updates the authenticated user's email address. Requires a verification code from
...
public class PublicUpdateUserEmailAddressV4 extends Operation {
  ...
  public PublicUpdateUserEmailAddressV4(
      String customBasePath, String namespace, ModelEmailUpdateRequestV4 body) {
  ...
  public PublicUpdateUserEmailAddressV4OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicUpdateUserEmailAddressV4OpResponse response =
        new PublicUpdateUserEmailAddressV4OpResponse();
