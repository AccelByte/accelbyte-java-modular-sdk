...
public class PublicUpdateUserEmailAddressV4 extends Operation {
    ...
    */
    ...
    public PublicUpdateUserEmailAddressV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicUpdateUserEmailAddressV4OpResponse response = new PublicUpdateUserEmailAddressV4OpResponse();
