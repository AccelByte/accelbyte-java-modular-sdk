 ...
 * _/iam/v3/public/namespaces/{namespace}/users/me/password [PUT]_**
 *
 * @deprecated
 */
@Deprecated
...
public class PublicUpdatePasswordV2 extends Operation {
  ...
  public PublicUpdatePasswordV2(
      String customBasePath, String namespace, String userId, ModelUserPasswordUpdateRequest body) {
  ...
  public PublicUpdatePasswordV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicUpdatePasswordV2OpResponse response = new PublicUpdatePasswordV2OpResponse();
