...
public class PlatformAuthenticationV3 extends Operation {
    ...
    */
    ...
    public PlatformAuthenticationV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PlatformAuthenticationV3OpResponse response = new PlatformAuthenticationV3OpResponse();
