...
public class ModelUserWithPlatformInfo extends Model {
    ...
    @JsonIgnore
    public List<ModelUserWithPlatformInfo> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelUserWithPlatformInfo>>() {});
    }
