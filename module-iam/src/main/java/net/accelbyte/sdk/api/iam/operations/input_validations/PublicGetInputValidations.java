...
public class PublicGetInputValidations extends Operation {
    ...
    */
    ...
    public PublicGetInputValidations(
            String customBasePath,            Boolean defaultOnEmpty,
            String languageCode
    )
    {
    ...
    public PublicGetInputValidationsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
