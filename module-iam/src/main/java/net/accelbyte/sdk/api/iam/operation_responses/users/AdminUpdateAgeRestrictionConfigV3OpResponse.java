...
@Getter
@Setter
public class AdminUpdateAgeRestrictionConfigV3OpResponse extends ApiResponseWithData<ModelAgeRestrictionResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminUpdateAgeRestrictionConfigV3";
    }
}