 ...
 *
 * <p>Appends user's permissions with the ones defined in body. Schedule contains cron string or
...
public class AdminAddUserPermissionsV3 extends Operation {
  ...
  public AdminAddUserPermissionsV3(
      String customBasePath, String namespace, String userId, AccountcommonPermissions body) {
  ...
  public AdminAddUserPermissionsV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminAddUserPermissionsV3OpResponse response = new AdminAddUserPermissionsV3OpResponse();
