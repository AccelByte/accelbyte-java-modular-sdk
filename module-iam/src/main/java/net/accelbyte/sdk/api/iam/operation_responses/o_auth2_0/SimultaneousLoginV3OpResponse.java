...
@Getter
@Setter
public class SimultaneousLoginV3OpResponse extends ApiResponseWithData<OauthmodelTokenResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.o_auth2_0.SimultaneousLoginV3";
    }
}