...
@Getter
@Setter
public class AdminGetDevicesByUserV4OpResponse extends ApiResponseWithData<ModelDevicesResponseV4> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.devices_v4.AdminGetDevicesByUserV4";
  }
}
