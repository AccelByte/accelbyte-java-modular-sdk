...
@Getter
@Setter
public class AdminAddUserRoleV4OpResponse extends ApiResponseWithData<ModelListUserRolesV4Response> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.AdminAddUserRoleV4";
    }
}