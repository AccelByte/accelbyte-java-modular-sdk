...
public class PublicSendVerificationLinkV3 extends Operation {
    ...
    */
    ...
    public PublicSendVerificationLinkV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicSendVerificationLinkV3OpResponse response = new PublicSendVerificationLinkV3OpResponse();
