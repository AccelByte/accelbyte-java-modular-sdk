...
@Getter
@Setter
public class AdminGetRolesV3OpResponse extends ApiResponseWithData<ModelRoleResponseWithManagersAndPaginationV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.roles.AdminGetRolesV3";
    }
}