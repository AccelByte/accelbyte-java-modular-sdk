...
@Getter
@Setter
public class AdminCreateUserV4OpResponse extends ApiResponseWithData<AccountCreateUserResponseV4> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.AdminCreateUserV4";
    }
}