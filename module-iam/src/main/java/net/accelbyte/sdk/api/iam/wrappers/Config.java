...
import net.accelbyte.sdk.api.iam.operation_responses.config.*;
...
public class Config {
     ...
     */
    public AdminGetConfigValueV3OpResponse adminGetConfigValueV3(AdminGetConfigValueV3 input) throws Exception {
     ...
     */
    public PublicGetConfigValueV3OpResponse publicGetConfigValueV3(PublicGetConfigValueV3 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
