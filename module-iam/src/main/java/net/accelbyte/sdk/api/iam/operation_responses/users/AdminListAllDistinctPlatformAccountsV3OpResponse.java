...
@Getter
@Setter
public class AdminListAllDistinctPlatformAccountsV3OpResponse extends ApiResponseWithData<AccountcommonDistinctPlatformResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminListAllDistinctPlatformAccountsV3";
    }
}