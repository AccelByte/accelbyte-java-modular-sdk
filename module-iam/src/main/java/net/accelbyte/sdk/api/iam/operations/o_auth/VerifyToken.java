 ...
 * Basic access authentication constructed from client id and client secret. ### Endpoint migration
 * guide - **Substitute endpoint: _/iam/v3/oauth/verify [POST]_** - **Note: difference in V3
 * response:** 1. format differenceï¼Pascal case => Camel case): permissions field from Action =>
