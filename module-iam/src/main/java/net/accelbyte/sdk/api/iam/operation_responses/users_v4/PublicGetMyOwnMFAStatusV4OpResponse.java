...
@Getter
@Setter
public class PublicGetMyOwnMFAStatusV4OpResponse extends ApiResponseWithData<ModelUserMFAStatusResponseV4> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.PublicGetMyOwnMFAStatusV4";
    }
}