...
@Getter
@Setter
public class PublicMakeFactorMyDefaultV4OpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.PublicMakeFactorMyDefaultV4";
    }
}