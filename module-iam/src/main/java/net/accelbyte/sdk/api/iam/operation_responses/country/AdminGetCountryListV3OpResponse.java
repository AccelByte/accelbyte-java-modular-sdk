...
@Getter
@Setter
public class AdminGetCountryListV3OpResponse extends ApiResponseWithData<List<ModelCountryResponse>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.country.AdminGetCountryListV3";
    }
}