...
import net.accelbyte.sdk.api.iam.operation_responses.clients.AdminGetClientsbyNamespacebyIDV3OpResponse;
...
public class AdminGetClientsbyNamespacebyIDV3 extends Operation {
    ...
    */
    ...
    public AdminGetClientsbyNamespacebyIDV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetClientsbyNamespacebyIDV3OpResponse response = new AdminGetClientsbyNamespacebyIDV3OpResponse();
