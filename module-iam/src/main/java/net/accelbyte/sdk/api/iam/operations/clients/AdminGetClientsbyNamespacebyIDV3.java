...
public class AdminGetClientsbyNamespacebyIDV3 extends Operation {
  ...
  public AdminGetClientsbyNamespacebyIDV3(
      String customBasePath, String clientId, String namespace) {
  ...
  public AdminGetClientsbyNamespacebyIDV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetClientsbyNamespacebyIDV3OpResponse response =
        new AdminGetClientsbyNamespacebyIDV3OpResponse();
