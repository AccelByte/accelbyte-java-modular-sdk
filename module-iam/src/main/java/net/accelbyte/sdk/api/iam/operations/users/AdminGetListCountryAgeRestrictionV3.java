...
public class AdminGetListCountryAgeRestrictionV3 extends Operation {
  ...
  @Deprecated
  public AdminGetListCountryAgeRestrictionV3(String customBasePath, String namespace) {
  ...
  public AdminGetListCountryAgeRestrictionV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetListCountryAgeRestrictionV3OpResponse response =
        new AdminGetListCountryAgeRestrictionV3OpResponse();
    ...
    if (code == 204) {
      ...
      response.setSuccess(true);
      response.setData(
          new ObjectMapper().readValue(json, new TypeReference<List<ModelCountryV3Response>>() {}));
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
