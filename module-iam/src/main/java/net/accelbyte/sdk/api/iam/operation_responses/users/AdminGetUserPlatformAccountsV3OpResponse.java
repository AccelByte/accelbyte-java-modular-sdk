...
@Getter
@Setter
public class AdminGetUserPlatformAccountsV3OpResponse extends ApiResponseWithData<AccountcommonUserLinkedPlatformsResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminGetUserPlatformAccountsV3";
    }
}