...
public class AdminDeletePlatformLinkV2 extends Operation {
    ...
    */
    ...
    public AdminDeletePlatformLinkV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDeletePlatformLinkV2OpResponse response = new AdminDeletePlatformLinkV2OpResponse();
