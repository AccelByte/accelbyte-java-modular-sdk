...
public class PublicListUserAllPlatformAccountsDistinctV3 extends Operation {
  ...
  public PublicListUserAllPlatformAccountsDistinctV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicListUserAllPlatformAccountsDistinctV3OpResponse response =
        new PublicListUserAllPlatformAccountsDistinctV3OpResponse();
