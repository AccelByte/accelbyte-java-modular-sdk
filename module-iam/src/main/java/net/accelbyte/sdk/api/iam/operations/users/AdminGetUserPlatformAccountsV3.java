...
public class AdminGetUserPlatformAccountsV3 extends Operation {
    ...
    */
    ...
    public AdminGetUserPlatformAccountsV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetUserPlatformAccountsV3OpResponse response = new AdminGetUserPlatformAccountsV3OpResponse();
