...
@Getter
@Setter
public class AdminGetRoleMembersV3OpResponse extends ApiResponseWithData<ModelRoleMembersResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.roles.AdminGetRoleMembersV3";
    }
}