...
@Getter
@Setter
public class AdminGetUserBanV3OpResponse extends ApiResponseWithData<ModelGetUserBanV3Response> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminGetUserBanV3";
    }
}