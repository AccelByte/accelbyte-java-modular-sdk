...
public class AdminListClientAvailablePermissions extends Operation {
    ...
    */
    ...
    public AdminListClientAvailablePermissions(
            String customBasePath,            Boolean excludePermissions
    )
    {
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("excludePermissions", this.excludePermissions == null ? null : Arrays.asList(String.valueOf(this.excludePermissions)));
        return queryParams;
    }
    ...
    public AdminListClientAvailablePermissionsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminListClientAvailablePermissionsOpResponse response = new AdminListClientAvailablePermissionsOpResponse();
