...
@Getter
@Setter
public class AdminDownloadMyBackupCodesV4OpResponse extends ApiResponseWithData<InputStream> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.AdminDownloadMyBackupCodesV4";
    }
}