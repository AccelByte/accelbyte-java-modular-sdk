 ...
 * one and set it into response body **auth_trust_id** when successfully login.
 *
 * <p>## Track Login History It will track login history to detect suspicious login activity, please
 * provide **Device-Id** (alphanumeric) in request header parameter otherwise it will set to
 ...
 * and at capacity, this API returns a 202 Accepted response, with the queue ticket included in the
 * response body.
 *
