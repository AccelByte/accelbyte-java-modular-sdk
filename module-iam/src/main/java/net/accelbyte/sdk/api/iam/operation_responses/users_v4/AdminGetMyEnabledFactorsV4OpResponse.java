...
@Getter
@Setter
public class AdminGetMyEnabledFactorsV4OpResponse extends ApiResponseWithData<ModelEnabledFactorsResponseV4> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.AdminGetMyEnabledFactorsV4";
    }
}