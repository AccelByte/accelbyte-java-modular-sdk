...
public class GetRoles extends Operation {
    ...
    */
    ...
    @Deprecated
    public GetRoles(
            String customBasePath,            String isWildcard
    )
    {
    ...
    public GetRolesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<ModelRoleResponseWithManagers>>() {}));
        }
        else if (code == 401) {
            final String json = Helper.convertInputStreamToString(payload);
