...
public class PlatformLink extends Operation {
    ...
    */
    ...
    public PlatformLinkOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PlatformLinkOpResponse response = new PlatformLinkOpResponse();
