 ...
 *
 * <p>Creates a test user without sending a verification code email. Supports accepting agreements
 * for the created user via the acceptedPolicies attribute. See request body field descriptions for
 * per-field details.
 */
@Getter
@Setter
