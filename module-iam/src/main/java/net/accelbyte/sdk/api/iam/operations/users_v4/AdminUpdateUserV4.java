...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.AdminUpdateUserV4OpResponse;
 ...
 * AdminUpdateUserV4
 *
 * <p>Updates user based on given data. **Single request can update single field or multi fields.**
 * Supported field {country, displayName, languageTag, dateOfBirth, avatarUrl, userName} Country use
 * ISO3166-1 alpha-2 two letter, e.g. US. Date of Birth format : YYYY-MM-DD, e.g. 2019-04-29.
 *
...
public class AdminUpdateUserV4 extends Operation {
  ...
  public AdminUpdateUserV4OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminUpdateUserV4OpResponse response = new AdminUpdateUserV4OpResponse();
