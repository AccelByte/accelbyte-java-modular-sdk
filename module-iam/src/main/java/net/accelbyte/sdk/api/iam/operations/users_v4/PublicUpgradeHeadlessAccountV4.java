...
public class PublicUpgradeHeadlessAccountV4 extends Operation {
  ...
  public PublicUpgradeHeadlessAccountV4OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicUpgradeHeadlessAccountV4OpResponse response =
        new PublicUpgradeHeadlessAccountV4OpResponse();
