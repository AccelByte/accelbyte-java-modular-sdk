...
@Getter
@Setter
public class ListCrossNamespaceAccountLinkOpResponse extends ApiResponse {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.users.ListCrossNamespaceAccountLink";
  }
}
