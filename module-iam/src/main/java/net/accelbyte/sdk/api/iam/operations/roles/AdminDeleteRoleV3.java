...
public class AdminDeleteRoleV3 extends Operation {
    ...
    */
    ...
    public AdminDeleteRoleV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDeleteRoleV3OpResponse response = new AdminDeleteRoleV3OpResponse();
