...
public class AdminGetUserSinglePlatformAccount extends Operation {
  ...
  public AdminGetUserSinglePlatformAccountOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetUserSinglePlatformAccountOpResponse response =
        new AdminGetUserSinglePlatformAccountOpResponse();
