...
public class AdminGetUserSinglePlatformAccount extends Operation {
    ...
    */
    ...
    public AdminGetUserSinglePlatformAccountOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetUserSinglePlatformAccountOpResponse response = new AdminGetUserSinglePlatformAccountOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelUserPlatformMetadata().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
