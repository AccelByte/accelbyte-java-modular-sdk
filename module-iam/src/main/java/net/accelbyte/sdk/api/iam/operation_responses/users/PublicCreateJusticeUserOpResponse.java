...
@Getter
@Setter
public class PublicCreateJusticeUserOpResponse extends ApiResponseWithData<ModelCreateJusticeUserResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.PublicCreateJusticeUser";
    }
}