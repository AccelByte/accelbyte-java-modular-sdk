...
@Getter
@Setter
public class CreateClientOpResponse extends ApiResponseWithData<ClientmodelClientCreationResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.clients.CreateClient";
    }
}