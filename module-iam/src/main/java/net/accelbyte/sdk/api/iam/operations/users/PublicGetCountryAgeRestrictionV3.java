...
public class PublicGetCountryAgeRestrictionV3 extends Operation {
     ...
     */
    private String path = "/iam/v3/public/namespaces/{namespace}/agerestrictions/countries/{countryCode}";
    ...
    */
    ...
    public PublicGetCountryAgeRestrictionV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetCountryAgeRestrictionV3OpResponse response = new PublicGetCountryAgeRestrictionV3OpResponse();
