...
public class AdminGetRoleOverrideConfigV3 extends Operation {
    ...
    */
    ...
    public AdminGetRoleOverrideConfigV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetRoleOverrideConfigV3OpResponse response = new AdminGetRoleOverrideConfigV3OpResponse();
