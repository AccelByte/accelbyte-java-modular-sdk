...
@Getter
@Setter
public class AdminBanUserBulkV3OpResponse extends ApiResponseWithData<ModelListBulkUserBanResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.bans.AdminBanUserBulkV3";
    }
}