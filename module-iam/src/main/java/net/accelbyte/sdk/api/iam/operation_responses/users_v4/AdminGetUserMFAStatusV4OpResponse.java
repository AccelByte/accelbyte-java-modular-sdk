...
@Getter
@Setter
public class AdminGetUserMFAStatusV4OpResponse extends ApiResponseWithData<ModelUserMFAStatusResponseV4> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.AdminGetUserMFAStatusV4";
    }
}