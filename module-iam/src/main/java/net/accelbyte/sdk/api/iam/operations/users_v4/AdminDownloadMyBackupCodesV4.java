...
public class AdminDownloadMyBackupCodesV4 extends Operation {
  ...
  @Deprecated
  public AdminDownloadMyBackupCodesV4(String customBasePath) {
  ...
  public AdminDownloadMyBackupCodesV4OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminDownloadMyBackupCodesV4OpResponse response =
        new AdminDownloadMyBackupCodesV4OpResponse();
