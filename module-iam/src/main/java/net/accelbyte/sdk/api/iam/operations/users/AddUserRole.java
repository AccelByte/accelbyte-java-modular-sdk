 ...
 * _/iam/v3/admin/namespaces/{namespace}/users/{userId}/roles/{roleId} [POST]_**
 *
 * @deprecated
 */
@Deprecated
...
public class AddUserRole extends Operation {
  ...
  @Deprecated
  public AddUserRole(String customBasePath, String namespace, String roleId, String userId) {
  ...
  public AddUserRoleOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final AddUserRoleOpResponse response = new AddUserRoleOpResponse();
