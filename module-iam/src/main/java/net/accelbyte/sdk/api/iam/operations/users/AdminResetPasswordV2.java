 ...
 * _/iam/v3/admin/namespaces/{namespace}/users/{userId}/password [PUT]_**
 *
 * @deprecated
 */
@Deprecated
...
public class AdminResetPasswordV2 extends Operation {
  ...
  public AdminResetPasswordV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminResetPasswordV2OpResponse response = new AdminResetPasswordV2OpResponse();
