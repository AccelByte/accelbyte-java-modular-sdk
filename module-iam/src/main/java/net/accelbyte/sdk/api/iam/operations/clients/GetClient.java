...
public class GetClient extends Operation {
  ...
  @Deprecated
  public GetClient(String customBasePath, String clientId) {
  ...
  public GetClientOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetClientOpResponse response = new GetClientOpResponse();
