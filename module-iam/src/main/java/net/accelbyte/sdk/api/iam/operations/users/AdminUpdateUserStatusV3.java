 ...
 *
 * <p>Disables or enables a user account.
 */
@Getter
@Setter
public class AdminUpdateUserStatusV3 extends Operation {
  ...
  public AdminUpdateUserStatusV3(
      String customBasePath, String namespace, String userId, ModelUpdateUserStatusRequest body) {
  ...
  public AdminUpdateUserStatusV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminUpdateUserStatusV3OpResponse response = new AdminUpdateUserStatusV3OpResponse();
