...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.PublicEnableMyEmailV4OpResponse;
...
public class PublicEnableMyEmailV4 extends Operation {
    ...
    */
    ...
    public PublicEnableMyEmailV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicEnableMyEmailV4OpResponse response = new PublicEnableMyEmailV4OpResponse();
