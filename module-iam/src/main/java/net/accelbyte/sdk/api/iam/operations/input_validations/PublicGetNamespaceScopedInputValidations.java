...
import net.accelbyte.sdk.api.iam.operation_responses.input_validations.PublicGetNamespaceScopedInputValidationsOpResponse;
 ...
 *
 * <p>Supported namespace: - publisher namespace - studio namespace
 *
 * <p>Returns the list of input validation configuration. `regex` parameter will be returned if
 * `isCustomRegex` is true. Otherwise, it will be empty.
 */
@Getter
@Setter
public class PublicGetNamespaceScopedInputValidations extends Operation {
  /** generated field's value */
  private String path = "/iam/v3/public/namespaces/{namespace}/inputValidations";
  ...
  public PublicGetNamespaceScopedInputValidations(
      String customBasePath, String namespace, Boolean defaultOnEmpty, String languageCode) {
  ...
  public PublicGetNamespaceScopedInputValidationsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGetNamespaceScopedInputValidationsOpResponse response =
        new PublicGetNamespaceScopedInputValidationsOpResponse();
