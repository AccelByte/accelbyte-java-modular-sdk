...
public class EnableUserBan extends Operation {
  ...
  @Deprecated
  public EnableUserBan(String customBasePath, String banId, String namespace, String userId) {
    this.banId = banId;
  ...
  public EnableUserBanOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final EnableUserBanOpResponse response = new EnableUserBanOpResponse();
