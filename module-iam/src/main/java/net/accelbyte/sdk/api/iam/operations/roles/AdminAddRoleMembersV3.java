...
import net.accelbyte.sdk.api.iam.operation_responses.roles.AdminAddRoleMembersV3OpResponse;
...
public class AdminAddRoleMembersV3 extends Operation {
    ...
    */
    ...
    public AdminAddRoleMembersV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminAddRoleMembersV3OpResponse response = new AdminAddRoleMembersV3OpResponse();
