...
public class AdminEnableUserV2 extends Operation {
    ...
    */
    ...
    public AdminEnableUserV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminEnableUserV2OpResponse response = new AdminEnableUserV2OpResponse();
