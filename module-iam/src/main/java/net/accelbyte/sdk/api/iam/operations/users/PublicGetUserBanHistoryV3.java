...
public class PublicGetUserBanHistoryV3 extends Operation {
    ...
    */
    ...
    public PublicGetUserBanHistoryV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetUserBanHistoryV3OpResponse response = new PublicGetUserBanHistoryV3OpResponse();
