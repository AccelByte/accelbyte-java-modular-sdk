...
@Getter
@Setter
public class AdminUpdateClientV3OpResponse extends ApiResponseWithData<ClientmodelClientV3Response> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.clients.AdminUpdateClientV3";
    }
}