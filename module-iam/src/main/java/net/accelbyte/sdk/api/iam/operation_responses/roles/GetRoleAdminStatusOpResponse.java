...
@Getter
@Setter
public class GetRoleAdminStatusOpResponse extends ApiResponseWithData<ModelRoleAdminStatusResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.roles.GetRoleAdminStatus";
    }
}