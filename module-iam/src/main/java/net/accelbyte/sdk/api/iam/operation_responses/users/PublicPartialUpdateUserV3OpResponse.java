...
@Getter
@Setter
public class PublicPartialUpdateUserV3OpResponse extends ApiResponseWithData<ModelUserResponseV3> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.users.PublicPartialUpdateUserV3";
  }
}
