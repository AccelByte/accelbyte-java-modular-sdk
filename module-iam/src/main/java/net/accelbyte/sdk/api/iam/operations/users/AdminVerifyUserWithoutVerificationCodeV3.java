...
public class AdminVerifyUserWithoutVerificationCodeV3 extends Operation {
  ...
  public AdminVerifyUserWithoutVerificationCodeV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminVerifyUserWithoutVerificationCodeV3OpResponse response =
        new AdminVerifyUserWithoutVerificationCodeV3OpResponse();
