...
import net.accelbyte.sdk.api.iam.operation_responses.clients.AdminBulkUpdateClientsV3OpResponse;
...
public class AdminBulkUpdateClientsV3 extends Operation {
    ...
    */
    ...
    public AdminBulkUpdateClientsV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminBulkUpdateClientsV3OpResponse response = new AdminBulkUpdateClientsV3OpResponse();
