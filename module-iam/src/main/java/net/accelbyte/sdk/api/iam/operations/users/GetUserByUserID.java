 ...
 * _/iam/v3/public/namespaces/{namespace}/users/{userId} [GET]_** - **Substitute endpoint(Admin):
 * _/iam/v3/admin/namespaces/{namespace}/users/{userId} [GET]_** - **Note:** format difference in
 * response: Pascal case => Camel case
 *
 * @deprecated
 */
@Deprecated
...
public class GetUserByUserID extends Operation {
  ...
  @Deprecated
  public GetUserByUserID(String customBasePath, String namespace, String userId) {
  ...
  public GetUserByUserIDOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetUserByUserIDOpResponse response = new GetUserByUserIDOpResponse();
