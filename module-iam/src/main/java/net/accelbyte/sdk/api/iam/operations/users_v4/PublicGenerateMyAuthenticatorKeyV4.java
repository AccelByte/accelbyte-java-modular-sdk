...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.PublicGenerateMyAuthenticatorKeyV4OpResponse;
...
public class PublicGenerateMyAuthenticatorKeyV4 extends Operation {
    ...
    */
    ...
    public PublicGenerateMyAuthenticatorKeyV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGenerateMyAuthenticatorKeyV4OpResponse response = new PublicGenerateMyAuthenticatorKeyV4OpResponse();
