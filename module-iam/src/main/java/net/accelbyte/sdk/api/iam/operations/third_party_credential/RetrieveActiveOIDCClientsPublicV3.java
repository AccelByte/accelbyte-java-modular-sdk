...
public class RetrieveActiveOIDCClientsPublicV3 extends Operation {
    ...
    */
    ...
    public RetrieveActiveOIDCClientsPublicV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RetrieveActiveOIDCClientsPublicV3OpResponse response = new RetrieveActiveOIDCClientsPublicV3OpResponse();
