...
public class AdminGetClientsByNamespaceV3 extends Operation {
  ...
  public AdminGetClientsByNamespaceV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetClientsByNamespaceV3OpResponse response =
        new AdminGetClientsByNamespaceV3OpResponse();
