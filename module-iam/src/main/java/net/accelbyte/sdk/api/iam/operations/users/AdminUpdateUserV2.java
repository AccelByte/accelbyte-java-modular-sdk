...
public class AdminUpdateUserV2 extends Operation {
    ...
    */
    ...
    public AdminUpdateUserV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateUserV2OpResponse response = new AdminUpdateUserV2OpResponse();
