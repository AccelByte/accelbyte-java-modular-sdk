...
public class AdminSaveUserRoleV3 extends Operation {
    ...
    */
    ...
    public AdminSaveUserRoleV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminSaveUserRoleV3OpResponse response = new AdminSaveUserRoleV3OpResponse();
