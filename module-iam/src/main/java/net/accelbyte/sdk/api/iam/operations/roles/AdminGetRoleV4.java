...
import net.accelbyte.sdk.api.iam.operation_responses.roles.AdminGetRoleV4OpResponse;
...
public class AdminGetRoleV4 extends Operation {
  ...
  @Deprecated
  public AdminGetRoleV4(String customBasePath, String roleId) {
    this.roleId = roleId;
  ...
  public AdminGetRoleV4OpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final AdminGetRoleV4OpResponse response = new AdminGetRoleV4OpResponse();
