...
@Getter
@Setter
public class AdminDeleteUserLinkingHistoryByPlatformIDV3OpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminDeleteUserLinkingHistoryByPlatformIDV3";
    }
}