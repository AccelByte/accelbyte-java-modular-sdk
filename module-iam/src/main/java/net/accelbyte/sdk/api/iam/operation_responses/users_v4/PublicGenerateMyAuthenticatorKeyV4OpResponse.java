...
@Getter
@Setter
public class PublicGenerateMyAuthenticatorKeyV4OpResponse extends ApiResponseWithData<ModelAuthenticatorKeyResponseV4> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.PublicGenerateMyAuthenticatorKeyV4";
    }
}