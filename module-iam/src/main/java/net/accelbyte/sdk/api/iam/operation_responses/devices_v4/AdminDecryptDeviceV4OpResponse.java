...
@Getter
@Setter
public class AdminDecryptDeviceV4OpResponse extends ApiResponseWithData<ModelDeviceIDDecryptResponseV4> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.devices_v4.AdminDecryptDeviceV4";
    }
}