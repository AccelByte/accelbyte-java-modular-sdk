 ...
 * _/iam/v3/admin/roles/{roleId}/members [DELETE]_**
 *
 * @deprecated
 */
@Deprecated
...
public class RemoveRoleMembers extends Operation {
  ...
  @Deprecated
  public RemoveRoleMembers(String customBasePath, String roleId, ModelRoleMembersRequest body) {
    this.roleId = roleId;
    this.body = body;
  ...
  public RemoveRoleMembersOpResponse parseResponse(
