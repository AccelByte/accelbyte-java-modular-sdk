...
public class ValidateOneTimeLinkingCodeV3 extends Operation {
    ...
    */
    ...
    public ValidateOneTimeLinkingCodeV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ValidateOneTimeLinkingCodeV3OpResponse response = new ValidateOneTimeLinkingCodeV3OpResponse();
