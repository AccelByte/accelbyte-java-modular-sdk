...
public class PublicVerifyHeadlessAccountV3 extends Operation {
  ...
  public PublicVerifyHeadlessAccountV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicVerifyHeadlessAccountV3OpResponse response =
        new PublicVerifyHeadlessAccountV3OpResponse();
