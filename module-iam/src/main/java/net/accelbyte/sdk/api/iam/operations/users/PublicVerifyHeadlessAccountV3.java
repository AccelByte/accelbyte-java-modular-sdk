...
public class PublicVerifyHeadlessAccountV3 extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("needVerificationCode", this.needVerificationCode == null ? null : Arrays.asList(String.valueOf(this.needVerificationCode)));
        return queryParams;
    }
    ...
    public PublicVerifyHeadlessAccountV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicVerifyHeadlessAccountV3OpResponse response = new PublicVerifyHeadlessAccountV3OpResponse();
