 ...
 *
 * <p>Admin List User ID By Platform User ID Lists game user IDs from the given namespace by given
...
public class AdminListUserIDByPlatformUserIDsV3 extends Operation {
  ...
  public AdminListUserIDByPlatformUserIDsV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminListUserIDByPlatformUserIDsV3OpResponse response =
        new AdminListUserIDByPlatformUserIDsV3OpResponse();
