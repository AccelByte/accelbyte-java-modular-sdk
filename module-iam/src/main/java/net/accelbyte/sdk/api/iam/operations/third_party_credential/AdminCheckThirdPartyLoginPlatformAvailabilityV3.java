...
public class AdminCheckThirdPartyLoginPlatformAvailabilityV3 extends Operation {
    ...
    */
    ...
    public AdminCheckThirdPartyLoginPlatformAvailabilityV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminCheckThirdPartyLoginPlatformAvailabilityV3OpResponse response = new AdminCheckThirdPartyLoginPlatformAvailabilityV3OpResponse();
