...
public class AdminGetAgeRestrictionStatusV2 extends Operation {
    ...
    */
    ...
    public AdminGetAgeRestrictionStatusV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetAgeRestrictionStatusV2OpResponse response = new AdminGetAgeRestrictionStatusV2OpResponse();
