...
@Getter
@Setter
public class AdminCreateRoleV4OpResponse extends ApiResponseWithData<ModelRoleV4Response> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.roles.AdminCreateRoleV4";
  }
}
