...
@Getter
@Setter
public class AdminDeleteUserPermissionBulkV3OpResponse extends ApiResponse {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.users.AdminDeleteUserPermissionBulkV3";
  }
}
