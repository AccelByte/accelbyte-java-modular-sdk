...
public class PublicSendRegistrationCode extends Operation {
  ...
  public PublicSendRegistrationCode(
      String customBasePath, String namespace, ModelSendRegisterVerificationCodeRequest body) {
  ...
  public PublicSendRegistrationCodeOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicSendRegistrationCodeOpResponse response =
        new PublicSendRegistrationCodeOpResponse();
