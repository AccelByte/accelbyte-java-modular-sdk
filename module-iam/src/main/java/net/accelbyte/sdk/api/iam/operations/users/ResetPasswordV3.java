...
public class ResetPasswordV3 extends Operation {
  ...
  public ResetPasswordV3(
      String customBasePath, String namespace, ModelResetPasswordRequestV3 body) {
  ...
  public ResetPasswordV3OpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final ResetPasswordV3OpResponse response = new ResetPasswordV3OpResponse();
