...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.PublicUpdateUserV4OpResponse;
...
public class PublicUpdateUserV4 extends Operation {
    ...
    */
    ...
    public PublicUpdateUserV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicUpdateUserV4OpResponse response = new PublicUpdateUserV4OpResponse();
