...
@Getter
@Setter
public class AdminUpdateUserBanV3OpResponse extends ApiResponseWithData<ModelUserBanResponseV3> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.users.AdminUpdateUserBanV3";
  }
}
