 ...
 * _/iam/v3/public/namespaces/{namespace}/users/me/code/verify [POST]_**
 *
...
public class UserVerification extends Operation {
  ...
  public UserVerification(
      String customBasePath, String namespace, String userId, ModelUserVerificationRequest body) {
  ...
  public UserVerificationOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final UserVerificationOpResponse response = new UserVerificationOpResponse();
