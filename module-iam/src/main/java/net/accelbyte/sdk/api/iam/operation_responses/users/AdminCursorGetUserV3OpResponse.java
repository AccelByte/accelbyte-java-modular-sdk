...
@Getter
@Setter
public class AdminCursorGetUserV3OpResponse
    extends ApiResponseWithData<ModelCursorGetUserResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.users.AdminCursorGetUserV3";
  }
}
