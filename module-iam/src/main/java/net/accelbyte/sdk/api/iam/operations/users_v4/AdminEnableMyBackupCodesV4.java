...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.AdminEnableMyBackupCodesV4OpResponse;
...
public class AdminEnableMyBackupCodesV4 extends Operation {
    ...
    */
    ...
    public AdminEnableMyBackupCodesV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminEnableMyBackupCodesV4OpResponse response = new AdminEnableMyBackupCodesV4OpResponse();
