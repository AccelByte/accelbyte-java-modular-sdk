...
public class AdminUpdateUserV3 extends Operation {
    ...
    */
    ...
    public AdminUpdateUserV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateUserV3OpResponse response = new AdminUpdateUserV3OpResponse();
