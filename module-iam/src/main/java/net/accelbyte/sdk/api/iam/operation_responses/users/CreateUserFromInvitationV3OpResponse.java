...
@Getter
@Setter
public class CreateUserFromInvitationV3OpResponse extends ApiResponseWithData<ModelUserCreateResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.CreateUserFromInvitationV3";
    }
}