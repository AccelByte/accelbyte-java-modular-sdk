...
@Getter
@Setter
public class AdminGetUserDeletionStatusV3OpResponse extends ApiResponseWithData<ModelUserDeletionStatusResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminGetUserDeletionStatusV3";
    }
}