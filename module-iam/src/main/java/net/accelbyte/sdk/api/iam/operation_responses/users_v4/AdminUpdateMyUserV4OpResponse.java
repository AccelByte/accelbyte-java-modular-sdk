...
@Getter
@Setter
public class AdminUpdateMyUserV4OpResponse extends ApiResponseWithData<ModelUserResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.AdminUpdateMyUserV4";
    }
}