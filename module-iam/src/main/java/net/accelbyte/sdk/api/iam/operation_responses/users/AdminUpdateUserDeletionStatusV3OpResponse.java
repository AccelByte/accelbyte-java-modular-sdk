...
@Getter
@Setter
public class AdminUpdateUserDeletionStatusV3OpResponse extends ApiResponse {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.users.AdminUpdateUserDeletionStatusV3";
  }
}
