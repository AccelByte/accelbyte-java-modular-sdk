...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.AdminUpdateUserEmailAddressV4OpResponse;
...
public class AdminUpdateUserEmailAddressV4 extends Operation {
    ...
    */
    ...
    public AdminUpdateUserEmailAddressV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateUserEmailAddressV4OpResponse response = new AdminUpdateUserEmailAddressV4OpResponse();
