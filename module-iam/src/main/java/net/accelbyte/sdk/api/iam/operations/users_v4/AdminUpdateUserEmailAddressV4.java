...
public class AdminUpdateUserEmailAddressV4 extends Operation {
  ...
  public AdminUpdateUserEmailAddressV4(
      String customBasePath, String namespace, String userId, ModelEmailUpdateRequestV4 body) {
  ...
  public AdminUpdateUserEmailAddressV4OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminUpdateUserEmailAddressV4OpResponse response =
        new AdminUpdateUserEmailAddressV4OpResponse();
