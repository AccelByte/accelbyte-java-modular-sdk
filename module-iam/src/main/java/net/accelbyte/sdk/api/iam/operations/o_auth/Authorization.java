...
public class Authorization extends Operation {
    ...
    */
    ...
    public Authorization(
            String customBasePath,            String login,
            String password,
            String scope,
            String state,
            String clientId,
    ...
    public AuthorizationOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AuthorizationOpResponse response = new AuthorizationOpResponse();
