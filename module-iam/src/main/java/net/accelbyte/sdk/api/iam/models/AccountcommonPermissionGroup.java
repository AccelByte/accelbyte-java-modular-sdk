...
public class AccountcommonPermissionGroup extends Model {
    ...
    @JsonIgnore
    public List<AccountcommonPermissionGroup> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<AccountcommonPermissionGroup>>() {});
    }
