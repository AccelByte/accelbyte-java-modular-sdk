...
@Getter
@Setter
public class AdminGetBulkUserBanV3OpResponse extends ApiResponseWithData<ModelGetUserBanV3Response> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminGetBulkUserBanV3";
    }
}