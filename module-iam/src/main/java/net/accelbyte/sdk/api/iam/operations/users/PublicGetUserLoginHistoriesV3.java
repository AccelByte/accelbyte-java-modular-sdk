...
public class PublicGetUserLoginHistoriesV3 extends Operation {
    ...
    */
    ...
    public PublicGetUserLoginHistoriesV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetUserLoginHistoriesV3OpResponse response = new PublicGetUserLoginHistoriesV3OpResponse();
