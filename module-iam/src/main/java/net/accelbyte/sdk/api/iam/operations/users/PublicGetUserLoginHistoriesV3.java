 ...
 *
 * <p>- The maximum value of the limit is 100 and the minimum value of the limit is 1. - Returns the
 * first page of the data if `after` and `before` parameters is empty. - Returns the next page of
 * the data if we provide `after` parameters with valid Unix timestamp. - Returns the previous page
 * of the data if we provide `before` parameter with valid data Unix timestamp.
 *
...
public class PublicGetUserLoginHistoriesV3 extends Operation {
  ...
  public PublicGetUserLoginHistoriesV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGetUserLoginHistoriesV3OpResponse response =
        new PublicGetUserLoginHistoriesV3OpResponse();
