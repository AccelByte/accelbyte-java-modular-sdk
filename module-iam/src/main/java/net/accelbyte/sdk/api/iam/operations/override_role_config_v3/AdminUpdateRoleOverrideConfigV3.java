...
public class AdminUpdateRoleOverrideConfigV3 extends Operation {
  ...
  public AdminUpdateRoleOverrideConfigV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminUpdateRoleOverrideConfigV3OpResponse response =
        new AdminUpdateRoleOverrideConfigV3OpResponse();
