...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.PublicGetMyBackupCodesV4OpResponse;
...
public class PublicGetMyBackupCodesV4 extends Operation {
    ...
    */
    ...
    public PublicGetMyBackupCodesV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetMyBackupCodesV4OpResponse response = new PublicGetMyBackupCodesV4OpResponse();
