...
public class SimultaneousLoginV3 extends Operation {
    ...
    */
    ...
    public SimultaneousLoginV3(
            String customBasePath,            String simultaneousPlatform,
    ...
    public SimultaneousLoginV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
