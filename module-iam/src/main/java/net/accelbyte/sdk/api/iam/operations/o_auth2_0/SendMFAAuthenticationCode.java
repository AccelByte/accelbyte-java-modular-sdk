 ...
 *
 * <p>Send 2FA code Sends the 2FA code.
 */
@Getter
@Setter
public class SendMFAAuthenticationCode extends Operation {
  ...
  public SendMFAAuthenticationCode(
      String customBasePath, String clientId, String factor, String mfaToken) {
  ...
  public SendMFAAuthenticationCodeOpResponse parseResponse(
