...
public class AdminDeleteUserLinkingRestrictionByPlatformIDV3 extends Operation {
  ...
  public AdminDeleteUserLinkingRestrictionByPlatformIDV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminDeleteUserLinkingRestrictionByPlatformIDV3OpResponse response =
        new AdminDeleteUserLinkingRestrictionByPlatformIDV3OpResponse();
