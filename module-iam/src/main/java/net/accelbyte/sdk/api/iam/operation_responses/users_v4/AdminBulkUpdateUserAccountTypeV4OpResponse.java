...
@Getter
@Setter
public class AdminBulkUpdateUserAccountTypeV4OpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.AdminBulkUpdateUserAccountTypeV4";
    }
}