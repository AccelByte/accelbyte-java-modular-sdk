...
@Getter
@Setter
public class PublicGetUserInformationV3OpResponse extends ApiResponseWithData<AccountcommonUserInformationV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.PublicGetUserInformationV3";
    }
}