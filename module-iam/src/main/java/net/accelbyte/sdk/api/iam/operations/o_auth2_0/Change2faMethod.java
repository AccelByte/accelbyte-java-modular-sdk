...
public class Change2faMethod extends Operation {
  ...
  @Deprecated
  public Change2faMethod(String customBasePath, String factor, String mfaToken) {
    this.factor = factor;
  ...
  public Change2faMethodOpResponse parseResponse(int code, String contentType, InputStream payload)
