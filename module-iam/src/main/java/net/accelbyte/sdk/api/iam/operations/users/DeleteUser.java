 ...
 * _/iam/v3/admin/namespaces/{namespace}/users/{userId}/information [DELETE]_**
 *
 * @deprecated
 */
@Deprecated
...
public class DeleteUser extends Operation {
  ...
  @Deprecated
  public DeleteUser(String customBasePath, String namespace, String userId) {
  ...
  public DeleteUserOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final DeleteUserOpResponse response = new DeleteUserOpResponse();
