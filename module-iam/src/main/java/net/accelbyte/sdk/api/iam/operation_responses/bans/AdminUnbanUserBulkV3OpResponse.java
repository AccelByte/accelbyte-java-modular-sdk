...
@Getter
@Setter
public class AdminUnbanUserBulkV3OpResponse extends ApiResponseWithData<ModelListBulkUserBanResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.bans.AdminUnbanUserBulkV3";
    }
}