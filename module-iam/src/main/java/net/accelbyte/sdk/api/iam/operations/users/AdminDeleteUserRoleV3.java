...
public class AdminDeleteUserRoleV3 extends Operation {
    ...
    */
    ...
    public AdminDeleteUserRoleV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDeleteUserRoleV3OpResponse response = new AdminDeleteUserRoleV3OpResponse();
