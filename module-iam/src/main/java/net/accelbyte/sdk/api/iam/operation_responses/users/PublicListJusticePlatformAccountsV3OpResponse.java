...
@Getter
@Setter
public class PublicListJusticePlatformAccountsV3OpResponse extends ApiResponseWithData<List<ModelGetUserMappingV3>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.PublicListJusticePlatformAccountsV3";
    }
}