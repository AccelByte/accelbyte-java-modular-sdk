...
public class AccountcommonAvatarConfig extends Model {
    ...
    @JsonIgnore
    public List<AccountcommonAvatarConfig> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<AccountcommonAvatarConfig>>() {});
    }
