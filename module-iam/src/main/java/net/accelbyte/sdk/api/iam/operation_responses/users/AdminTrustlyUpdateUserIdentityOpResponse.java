...
@Getter
@Setter
public class AdminTrustlyUpdateUserIdentityOpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminTrustlyUpdateUserIdentity";
    }
}