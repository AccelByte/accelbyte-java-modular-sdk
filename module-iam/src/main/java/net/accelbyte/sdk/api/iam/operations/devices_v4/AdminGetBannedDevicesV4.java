...
import net.accelbyte.sdk.api.iam.operation_responses.devices_v4.AdminGetBannedDevicesV4OpResponse;
...
public class AdminGetBannedDevicesV4 extends Operation {
    ...
    */
    ...
    public AdminGetBannedDevicesV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetBannedDevicesV4OpResponse response = new AdminGetBannedDevicesV4OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelDeviceBannedResponseV4().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 401) {
            final String json = Helper.convertInputStreamToString(payload);
