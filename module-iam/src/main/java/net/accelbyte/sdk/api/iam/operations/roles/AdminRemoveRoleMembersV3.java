...
import net.accelbyte.sdk.api.iam.operation_responses.roles.AdminRemoveRoleMembersV3OpResponse;
 ...
 * the role's manager. Deprecate: Suggest to use this: AdminRevokeUserFromRoleV4
 *
 * @deprecated
 */
@Deprecated
...
public class AdminRemoveRoleMembersV3 extends Operation {
  ...
  public AdminRemoveRoleMembersV3(
      String customBasePath, String roleId, ModelRoleMembersRequestV3 body) {
    this.roleId = roleId;
    this.body = body;
  ...
  public AdminRemoveRoleMembersV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminRemoveRoleMembersV3OpResponse response = new AdminRemoveRoleMembersV3OpResponse();
