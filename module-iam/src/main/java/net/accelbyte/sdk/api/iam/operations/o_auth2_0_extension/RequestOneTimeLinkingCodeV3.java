...
public class RequestOneTimeLinkingCodeV3 extends Operation {
    ...
    */
    ...
    public RequestOneTimeLinkingCodeV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RequestOneTimeLinkingCodeV3OpResponse response = new RequestOneTimeLinkingCodeV3OpResponse();
