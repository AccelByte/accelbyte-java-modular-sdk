 ...
 *
 * <p>Requests a one-time code [8 characters] for a headless account to link or upgrade to a full
 * account. Should specify the target platform id and current user should already linked to this
 * platform. Current user should be a headless account. ## Supported platforms: - **steam** -
 * **steamopenid** - **facebook** - **google** - **googleplaygames** - **oculus** - **twitch** -
