...
public class RequestTokenByOneTimeLinkCodeResponseV3 extends Operation {
    ...
    */
    ...
    public RequestTokenByOneTimeLinkCodeResponseV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RequestTokenByOneTimeLinkCodeResponseV3OpResponse response = new RequestTokenByOneTimeLinkCodeResponseV3OpResponse();
