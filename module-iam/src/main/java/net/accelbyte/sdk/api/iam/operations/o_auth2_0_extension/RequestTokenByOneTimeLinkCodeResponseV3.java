 ...
 *
 * <p>Generates the user's token by one-time link code. It requires a code which can be generated
 * from `/iam/v3/link/code/request [POST]` or `/iam/v3/public/users/me/link/redirection [GET]`.
 *
 * <p>Supports creating a transient token by utilizing the **isTransient** param:
