 ...
 * fields.** Supported field {Country, DisplayName, LanguageTag}
 *
 * @deprecated
 */
@Deprecated
...
public class PublicUpdateUserV2 extends Operation {
  ...
  public PublicUpdateUserV2OpResponse parseResponse(
    ...
    if (code == 204) {
      ...
      response.setSuccess(true);
      response.setData(
          new ObjectMapper().readValue(json, new TypeReference<List<ModelUserResponse>>() {}));
    } else if (code == 400) {
