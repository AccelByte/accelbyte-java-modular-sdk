...
public class PublicDeletePlatformLinkV2 extends Operation {
    ...
    */
    ...
    public PublicDeletePlatformLinkV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicDeletePlatformLinkV2OpResponse response = new PublicDeletePlatformLinkV2OpResponse();
