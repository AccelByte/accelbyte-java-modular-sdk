 ...
 * _/iam/v3/public/namespaces/{namespace}/users/me/platforms/{platformId} [DELETE]_** - **Substitute
 * endpoint: _/iam/v3/public/namespaces/{namespace}/users/me/platforms/{platformId}/all [DELETE]_**
 *
...
public class PublicDeletePlatformLinkV2 extends Operation {
  ...
  public PublicDeletePlatformLinkV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicDeletePlatformLinkV2OpResponse response =
        new PublicDeletePlatformLinkV2OpResponse();
