...
public class AdminResetInputValidations extends Operation {
  ...
  @Deprecated
  public AdminResetInputValidations(String customBasePath, String field) {
    this.field = field;
  ...
  public AdminResetInputValidationsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminResetInputValidationsOpResponse response =
        new AdminResetInputValidationsOpResponse();
