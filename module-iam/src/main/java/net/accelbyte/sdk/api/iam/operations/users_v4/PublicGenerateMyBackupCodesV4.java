...
public class PublicGenerateMyBackupCodesV4 extends Operation {
  ...
  @Deprecated
  public PublicGenerateMyBackupCodesV4(String customBasePath, String namespace) {
  ...
  public PublicGenerateMyBackupCodesV4OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGenerateMyBackupCodesV4OpResponse response =
        new PublicGenerateMyBackupCodesV4OpResponse();
