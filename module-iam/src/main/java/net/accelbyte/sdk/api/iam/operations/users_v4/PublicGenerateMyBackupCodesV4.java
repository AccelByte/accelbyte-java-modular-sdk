...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.PublicGenerateMyBackupCodesV4OpResponse;
...
public class PublicGenerateMyBackupCodesV4 extends Operation {
    ...
    */
    ...
    public PublicGenerateMyBackupCodesV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGenerateMyBackupCodesV4OpResponse response = new PublicGenerateMyBackupCodesV4OpResponse();
