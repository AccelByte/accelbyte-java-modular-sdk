...
@Getter
@Setter
public class AuthenticationWithPlatformLinkV4OpResponse extends ApiResponseWithData<OauthmodelTokenResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.o_auth2_0_v4.AuthenticationWithPlatformLinkV4";
    }
}