...
public class RequestTokenExchangeCodeV3 extends Operation {
    ...
    */
    ...
    public RequestTokenExchangeCodeV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RequestTokenExchangeCodeV3OpResponse response = new RequestTokenExchangeCodeV3OpResponse();
    ...
    */
    ...
    public static class RequestTokenExchangeCodeV3Builder {
        ...
        public RequestTokenExchangeCodeV3Builder codeChallengeMethodFromEnum(final CodeChallengeMethod codeChallengeMethod) {
