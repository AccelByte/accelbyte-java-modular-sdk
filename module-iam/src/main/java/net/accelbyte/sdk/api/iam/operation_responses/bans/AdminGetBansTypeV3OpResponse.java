...
@Getter
@Setter
public class AdminGetBansTypeV3OpResponse extends ApiResponseWithData<AccountcommonBansV3> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.bans.AdminGetBansTypeV3";
  }
}
