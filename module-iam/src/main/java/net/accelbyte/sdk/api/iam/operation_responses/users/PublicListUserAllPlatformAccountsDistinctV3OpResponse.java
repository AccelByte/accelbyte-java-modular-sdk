...
@Getter
@Setter
public class PublicListUserAllPlatformAccountsDistinctV3OpResponse extends ApiResponseWithData<AccountcommonDistinctPlatformResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.PublicListUserAllPlatformAccountsDistinctV3";
    }
}