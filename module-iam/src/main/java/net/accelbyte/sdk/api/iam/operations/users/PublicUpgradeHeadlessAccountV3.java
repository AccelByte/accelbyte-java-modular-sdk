...
public class PublicUpgradeHeadlessAccountV3 extends Operation {
    ...
    */
    ...
    public PublicUpgradeHeadlessAccountV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicUpgradeHeadlessAccountV3OpResponse response = new PublicUpgradeHeadlessAccountV3OpResponse();
