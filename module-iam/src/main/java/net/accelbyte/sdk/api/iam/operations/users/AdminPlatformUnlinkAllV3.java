...
public class AdminPlatformUnlinkAllV3 extends Operation {
     ...
     */
    private String path = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/{platformId}/all";
    ...
    */
    ...
    public AdminPlatformUnlinkAllV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminPlatformUnlinkAllV3OpResponse response = new AdminPlatformUnlinkAllV3OpResponse();
