...
import net.accelbyte.sdk.api.iam.operation_responses.account_identifier_tag.AdminDeleteTagV3OpResponse;
...
public class AdminDeleteTagV3 extends Operation {
  ...
  @Deprecated
  public AdminDeleteTagV3(String customBasePath, String namespace, String tagId) {
  ...
  public AdminDeleteTagV3OpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final AdminDeleteTagV3OpResponse response = new AdminDeleteTagV3OpResponse();
