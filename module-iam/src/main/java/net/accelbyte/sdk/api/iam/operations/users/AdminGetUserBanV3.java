...
public class AdminGetUserBanV3 extends Operation {
    ...
    */
    ...
    public AdminGetUserBanV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetUserBanV3OpResponse response = new AdminGetUserBanV3OpResponse();
