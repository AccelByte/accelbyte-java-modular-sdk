 ...
 * _/iam/v3/admin/namespaces/{namespace}/users/{userId}/bans [POST]_**
 *
 * @deprecated
 */
@Deprecated
...
public class BanUser extends Operation {
  ...
  public BanUserOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final BanUserOpResponse response = new BanUserOpResponse();
