...
@Getter
@Setter
public class AdminGetListCountryAgeRestrictionV3OpResponse extends ApiResponseWithData<List<ModelCountryV3Response>> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminGetListCountryAgeRestrictionV3";
    }
}