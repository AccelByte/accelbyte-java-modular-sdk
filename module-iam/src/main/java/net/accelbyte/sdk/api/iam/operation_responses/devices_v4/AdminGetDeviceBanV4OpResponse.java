...
@Getter
@Setter
public class AdminGetDeviceBanV4OpResponse extends ApiResponseWithData<ModelDeviceBanResponseV4> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.devices_v4.AdminGetDeviceBanV4";
  }
}
