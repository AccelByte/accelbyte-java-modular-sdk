...
public class AdminPlatformLinkV3 extends Operation {
    ...
    */
    ...
    public AdminPlatformLinkV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminPlatformLinkV3OpResponse response = new AdminPlatformLinkV3OpResponse();
