...
public class OAuth20V4 {
     ...
     */
    public AuthenticationWithPlatformLinkV4OpResponse authenticationWithPlatformLinkV4(AuthenticationWithPlatformLinkV4 input) throws Exception {
     ...
     */
    public GenerateTokenByNewHeadlessAccountV4OpResponse generateTokenByNewHeadlessAccountV4(GenerateTokenByNewHeadlessAccountV4 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public PlatformTokenGrantV4OpResponse platformTokenGrantV4(PlatformTokenGrantV4 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public SimultaneousLoginV4OpResponse simultaneousLoginV4(SimultaneousLoginV4 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public RequestTargetTokenResponseV4OpResponse requestTargetTokenResponseV4(RequestTargetTokenResponseV4 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
