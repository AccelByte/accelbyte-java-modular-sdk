...
public class IamErrors
{
    ...
    public static ApiError error10136 = new ApiError("10136", "code is either been used or not valid anymore");
    ...
    public static ApiError error10142 = new ApiError("10142", "new password cannot be same with original");
    ...
    public static ApiError error10145 = new ApiError("10145", "disallow game access publisher user's ban");
    public static ApiError error10146 = new ApiError("10146", "userID not match");
    public static ApiError error10148 = new ApiError("10148", "verification code context doesn't match the required context");
    public static ApiError error10149 = new ApiError("10149", "verification contact type doesn't match");
    ...
    public static ApiError error10163 = new ApiError("10163", "platform is already linked with the user account");
    ...
    public static ApiError error10172 = new ApiError("10172", "platform user is already linked with the account");
    public static ApiError error10173 = new ApiError("10173", "platform is already linked with another user account");
    ...
    public static ApiError error10180 = new ApiError("10180", "admin invitation not found or expired");
    public static ApiError error10182 = new ApiError("10182", "given namespace cannot be assigned to the role");
    ...
    public static ApiError error10200 = new ApiError("10200", "link to a different platform account is not allowed");
    public static ApiError error10202 = new ApiError("10202", "active device ban config already exists");
    ...
    public static ApiError error10217 = new ApiError("10217", "Native ticket's account linked AGS account has different linking history with input simultaneous ticket's");
    public static ApiError error10218 = new ApiError("10218", "Simultaneous ticket's account linked AGS account has different linking history with input native ticket's");
    public static ApiError error10219 = new ApiError("10219", "Native ticket's account linked AGS is already linked simultaneous but different with the input simultaneous ticket's");
    public static ApiError error10220 = new ApiError("10220", "Native ticket's account linked AGS account is different with the one which simultaneous ticket's linked to");
    public static ApiError error10221 = new ApiError("10221", "Simultaneous ticket's account linked AGS is already linked native but different with the input native ticket's");
    public static ApiError error10222 = new ApiError("10222", "unique display name already exists");
    public static ApiError error10226 = new ApiError("10226", "third party platform is not supported");
    ...
    public static ApiError error1015073 = new ApiError("1015073", "new password same as old password");
}