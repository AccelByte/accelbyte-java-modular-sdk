...
@Getter
@Setter
public class AdminEnableMyBackupCodesV4OpResponse extends ApiResponseWithData<ModelBackupCodesResponseV4> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.AdminEnableMyBackupCodesV4";
    }
}