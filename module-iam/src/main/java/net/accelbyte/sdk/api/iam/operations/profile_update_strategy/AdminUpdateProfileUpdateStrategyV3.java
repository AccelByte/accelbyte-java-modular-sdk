...
public class AdminUpdateProfileUpdateStrategyV3 extends Operation {
    ...
    */
    ...
    public AdminUpdateProfileUpdateStrategyV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateProfileUpdateStrategyV3OpResponse response = new AdminUpdateProfileUpdateStrategyV3OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelSimpleProfileUpdateStrategyConfigs().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelSimpleProfileUpdateStrategyConfigs parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
