...
public class AdminUpdateAvailablePermissionsByModule extends Operation {
    ...
    */
    ...
    public AdminUpdateAvailablePermissionsByModuleOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateAvailablePermissionsByModuleOpResponse response = new AdminUpdateAvailablePermissionsByModuleOpResponse();
