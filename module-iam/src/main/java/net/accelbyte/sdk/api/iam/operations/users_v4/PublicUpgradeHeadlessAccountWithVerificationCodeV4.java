...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.PublicUpgradeHeadlessAccountWithVerificationCodeV4OpResponse;
...
public class PublicUpgradeHeadlessAccountWithVerificationCodeV4 extends Operation {
    ...
    */
    ...
    public PublicUpgradeHeadlessAccountWithVerificationCodeV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicUpgradeHeadlessAccountWithVerificationCodeV4OpResponse response = new PublicUpgradeHeadlessAccountWithVerificationCodeV4OpResponse();
