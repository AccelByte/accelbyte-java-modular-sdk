...
public class PublicUpgradeHeadlessAccountWithVerificationCodeV4 extends Operation {
  ...
  public PublicUpgradeHeadlessAccountWithVerificationCodeV4OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicUpgradeHeadlessAccountWithVerificationCodeV4OpResponse response =
        new PublicUpgradeHeadlessAccountWithVerificationCodeV4OpResponse();
