...
public class UpdateThirdPartyLoginPlatformDomainV3 extends Operation {
    ...
    */
    ...
    public UpdateThirdPartyLoginPlatformDomainV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateThirdPartyLoginPlatformDomainV3OpResponse response = new UpdateThirdPartyLoginPlatformDomainV3OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelPlatformDomainResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelPlatformDomainResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
