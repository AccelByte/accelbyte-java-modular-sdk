...
@Getter
@Setter
public class AdminGetUserStateByUserIdV3OpResponse
    extends ApiResponseWithData<ModelUserStateResponseV3> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.users.AdminGetUserStateByUserIdV3";
  }
}
