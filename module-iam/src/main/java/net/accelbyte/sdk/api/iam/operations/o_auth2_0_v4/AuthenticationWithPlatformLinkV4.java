...
public class AuthenticationWithPlatformLinkV4 extends Operation {
    ...
    */
    ...
    public AuthenticationWithPlatformLinkV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AuthenticationWithPlatformLinkV4OpResponse response = new AuthenticationWithPlatformLinkV4OpResponse();
