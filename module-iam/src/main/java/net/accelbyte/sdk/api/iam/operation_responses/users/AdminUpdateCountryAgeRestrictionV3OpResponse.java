...
@Getter
@Setter
public class AdminUpdateCountryAgeRestrictionV3OpResponse extends ApiResponseWithData<ModelCountryV3Response> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminUpdateCountryAgeRestrictionV3";
    }
}