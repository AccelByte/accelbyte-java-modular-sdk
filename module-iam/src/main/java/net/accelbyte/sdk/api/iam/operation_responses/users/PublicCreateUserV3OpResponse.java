...
@Getter
@Setter
public class PublicCreateUserV3OpResponse extends ApiResponseWithData<ModelUserCreateResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.PublicCreateUserV3";
    }
}