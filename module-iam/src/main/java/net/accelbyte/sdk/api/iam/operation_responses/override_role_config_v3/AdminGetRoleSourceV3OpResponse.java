...
@Getter
@Setter
public class AdminGetRoleSourceV3OpResponse extends ApiResponseWithData<ModelRoleOverrideSourceResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.override_role_config_v3.AdminGetRoleSourceV3";
    }
}