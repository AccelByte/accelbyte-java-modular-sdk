...
public class TokenIntrospectionV3 extends Operation {
    ...
    */
    ...
    public TokenIntrospectionV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final TokenIntrospectionV3OpResponse response = new TokenIntrospectionV3OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new OauthmodelTokenIntrospectResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
