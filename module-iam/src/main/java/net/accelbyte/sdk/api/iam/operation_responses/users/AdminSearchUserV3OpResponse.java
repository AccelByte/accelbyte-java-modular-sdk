...
@Getter
@Setter
public class AdminSearchUserV3OpResponse extends ApiResponseWithData<ModelSearchUsersResponseWithPaginationV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminSearchUserV3";
    }
}