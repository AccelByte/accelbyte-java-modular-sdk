 ...
 * AdminGetRolesV4
 *
 * <p>Retrieves a paginated list of roles with optional filters.
 */
@Getter
@Setter
public class AdminGetRolesV4 extends Operation {
  ...
  public AdminGetRolesV4(
      String customBasePath, Boolean adminRole, Boolean isWildcard, Integer limit, Integer offset) {
  ...
  public AdminGetRolesV4OpResponse parseResponse(int code, String contentType, InputStream payload)
