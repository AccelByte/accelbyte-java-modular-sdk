...
public class AdminGetCountryListV3 extends Operation {
    ...
    */
    ...
    public AdminGetCountryListV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetCountryListV3OpResponse response = new AdminGetCountryListV3OpResponse();
