...
@Getter
@Setter
public class AdminGenerateMyBackupCodesV4OpResponse extends ApiResponseWithData<ModelBackupCodesResponseV4> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.AdminGenerateMyBackupCodesV4";
    }
}