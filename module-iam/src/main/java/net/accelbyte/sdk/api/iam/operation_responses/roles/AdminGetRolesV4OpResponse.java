...
@Getter
@Setter
public class AdminGetRolesV4OpResponse extends ApiResponseWithData<ModelListRoleV4Response> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.roles.AdminGetRolesV4";
  }
}
