 ...
 *
 * <p>Deletes the third-party platform credential for the specified platform.
 */
@Getter
@Setter
public class DeleteThirdPartyLoginPlatformCredentialV3 extends Operation {
  ...
  public DeleteThirdPartyLoginPlatformCredentialV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final DeleteThirdPartyLoginPlatformCredentialV3OpResponse response =
        new DeleteThirdPartyLoginPlatformCredentialV3OpResponse();
