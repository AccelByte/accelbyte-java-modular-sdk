...
@Getter
@Setter
public class AdminVerifyUserWithoutVerificationCodeV3OpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminVerifyUserWithoutVerificationCodeV3";
    }
}