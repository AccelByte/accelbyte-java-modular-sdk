...
@Getter
@Setter
public class PublicSearchUserV3OpResponse extends ApiResponseWithData<ModelPublicUserInformationResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.PublicSearchUserV3";
    }
}