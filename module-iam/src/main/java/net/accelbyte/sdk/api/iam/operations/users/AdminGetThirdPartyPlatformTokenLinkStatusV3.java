...
public class AdminGetThirdPartyPlatformTokenLinkStatusV3 extends Operation {
     ...
     */
    private String path = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/{platformId}/linkStatus";
    ...
    */
    ...
    public AdminGetThirdPartyPlatformTokenLinkStatusV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetThirdPartyPlatformTokenLinkStatusV3OpResponse response = new AdminGetThirdPartyPlatformTokenLinkStatusV3OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelTokenThirdPartyLinkStatusResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelTokenThirdPartyLinkStatusResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
