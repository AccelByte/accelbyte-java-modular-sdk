...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.AdminDisableUserMFAV4OpResponse;
...
public class AdminDisableUserMFAV4 extends Operation {
    ...
    */
    ...
    public AdminDisableUserMFAV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDisableUserMFAV4OpResponse response = new AdminDisableUserMFAV4OpResponse();
