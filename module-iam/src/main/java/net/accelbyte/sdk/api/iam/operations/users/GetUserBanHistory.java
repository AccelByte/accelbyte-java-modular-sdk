...
public class GetUserBanHistory extends Operation {
  ...
  @Deprecated
  public GetUserBanHistory(String customBasePath, String namespace, String userId) {
  ...
  public GetUserBanHistoryOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final GetUserBanHistoryOpResponse response = new GetUserBanHistoryOpResponse();
