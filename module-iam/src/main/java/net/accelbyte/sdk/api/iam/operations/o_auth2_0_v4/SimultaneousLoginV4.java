...
public class SimultaneousLoginV4 extends Operation {
    ...
    */
    ...
    public SimultaneousLoginV4(
            String customBasePath,            String codeChallenge,
    ...
    public SimultaneousLoginV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    ...
    */
    ...
    public static class SimultaneousLoginV4Builder {
        ...
        public SimultaneousLoginV4Builder codeChallengeMethodFromEnum(final CodeChallengeMethod codeChallengeMethod) {
