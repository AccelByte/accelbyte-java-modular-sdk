...
public class UpgradeHeadlessAccountWithVerificationCode extends Operation {
    ...
    */
    ...
    public UpgradeHeadlessAccountWithVerificationCodeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpgradeHeadlessAccountWithVerificationCodeOpResponse response = new UpgradeHeadlessAccountWithVerificationCodeOpResponse();
