...
public class GenerateTokenByNewHeadlessAccountV4 extends Operation {
    ...
    */
    ...
    public GenerateTokenByNewHeadlessAccountV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GenerateTokenByNewHeadlessAccountV4OpResponse response = new GenerateTokenByNewHeadlessAccountV4OpResponse();
