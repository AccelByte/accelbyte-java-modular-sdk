...
public class AdminAddUserRoleV3 extends Operation {
    ...
    */
    ...
    public AdminAddUserRoleV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminAddUserRoleV3OpResponse response = new AdminAddUserRoleV3OpResponse();
