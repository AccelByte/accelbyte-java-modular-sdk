...
public class AdminGetUserByUserIdV3 extends Operation {
    ...
    */
    ...
    public AdminGetUserByUserIdV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetUserByUserIdV3OpResponse response = new AdminGetUserByUserIdV3OpResponse();
