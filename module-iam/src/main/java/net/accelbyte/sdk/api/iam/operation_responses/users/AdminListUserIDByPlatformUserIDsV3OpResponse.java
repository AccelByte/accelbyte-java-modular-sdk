...
@Getter
@Setter
public class AdminListUserIDByPlatformUserIDsV3OpResponse extends ApiResponseWithData<AccountcommonUserPlatforms> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminListUserIDByPlatformUserIDsV3";
    }
}