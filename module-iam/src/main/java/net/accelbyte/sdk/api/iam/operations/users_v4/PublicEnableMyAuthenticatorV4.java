...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.PublicEnableMyAuthenticatorV4OpResponse;
...
public class PublicEnableMyAuthenticatorV4 extends Operation {
    ...
    */
    ...
    public PublicEnableMyAuthenticatorV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicEnableMyAuthenticatorV4OpResponse response = new PublicEnableMyAuthenticatorV4OpResponse();
