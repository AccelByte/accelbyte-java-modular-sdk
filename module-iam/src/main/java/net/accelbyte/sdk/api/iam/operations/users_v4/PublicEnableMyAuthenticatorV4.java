...
public class PublicEnableMyAuthenticatorV4 extends Operation {
  ...
  public PublicEnableMyAuthenticatorV4OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicEnableMyAuthenticatorV4OpResponse response =
        new PublicEnableMyAuthenticatorV4OpResponse();
