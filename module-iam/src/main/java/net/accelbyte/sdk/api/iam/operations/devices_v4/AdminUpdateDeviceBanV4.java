...
import net.accelbyte.sdk.api.iam.operation_responses.devices_v4.AdminUpdateDeviceBanV4OpResponse;
...
public class AdminUpdateDeviceBanV4 extends Operation {
    ...
    */
    ...
    public AdminUpdateDeviceBanV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateDeviceBanV4OpResponse response = new AdminUpdateDeviceBanV4OpResponse();
