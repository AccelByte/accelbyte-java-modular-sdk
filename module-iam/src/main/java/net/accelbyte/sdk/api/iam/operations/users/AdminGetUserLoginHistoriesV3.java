...
public class AdminGetUserLoginHistoriesV3 extends Operation {
    ...
    */
    ...
    public AdminGetUserLoginHistoriesV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetUserLoginHistoriesV3OpResponse response = new AdminGetUserLoginHistoriesV3OpResponse();
