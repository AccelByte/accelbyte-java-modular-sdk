 ...
 *
 * <p>- This API only accept publisher/studio namespace and userId. - The maximum value of the limit
 * is 100 and the minimum value of the limit is 1. - Returns the first page of the data if `after`
 * and `before` parameters is empty. - Returns the next page of the data if we provide `after`
 * parameters with valid Unix timestamp. - Returns the previous page of the data if we provide
 * `before` parameter with valid Unix timestamp.
 */
@Getter
@Setter
