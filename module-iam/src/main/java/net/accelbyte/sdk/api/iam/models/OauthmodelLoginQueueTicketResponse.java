...
public class OauthmodelLoginQueueTicketResponse extends Model {
    ...
    @JsonIgnore
    public OauthmodelLoginQueueTicketResponse createFromJson(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, this.getClass());
    }

    @JsonIgnore
    public List<OauthmodelLoginQueueTicketResponse> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<OauthmodelLoginQueueTicketResponse>>() {});
    }
