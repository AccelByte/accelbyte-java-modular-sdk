...
@Getter
@Setter
public class PublicListUserIDByPlatformUserIDsV4OpResponse extends ApiResponseWithData<AccountcommonUserPlatforms> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.PublicListUserIDByPlatformUserIDsV4";
    }
}