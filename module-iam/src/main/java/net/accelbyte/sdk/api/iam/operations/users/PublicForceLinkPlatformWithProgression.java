 ...
 *
 * <p>Force update other account's Platform Account relation to current User Account. Can transfer
 * progression from 3rd platform binding account's to current account. Requires the same requestID
 * used in [Get link status](#operations-Users-PublicGetAsyncStatus).
 *
...
public class PublicForceLinkPlatformWithProgression extends Operation {
  ...
  public PublicForceLinkPlatformWithProgressionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicForceLinkPlatformWithProgressionOpResponse response =
        new PublicForceLinkPlatformWithProgressionOpResponse();
