...
public class PublicForceLinkPlatformWithProgression extends Operation {
    ...
    */
    ...
    public PublicForceLinkPlatformWithProgressionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicForceLinkPlatformWithProgressionOpResponse response = new PublicForceLinkPlatformWithProgressionOpResponse();
