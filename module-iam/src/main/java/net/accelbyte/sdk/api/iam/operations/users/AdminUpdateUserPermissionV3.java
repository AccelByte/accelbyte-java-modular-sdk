...
public class AdminUpdateUserPermissionV3 extends Operation {
    ...
    */
    ...
    public AdminUpdateUserPermissionV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateUserPermissionV3OpResponse response = new AdminUpdateUserPermissionV3OpResponse();
