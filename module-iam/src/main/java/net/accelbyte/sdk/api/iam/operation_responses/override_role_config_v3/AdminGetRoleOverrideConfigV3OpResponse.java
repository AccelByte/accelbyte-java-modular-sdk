...
@Getter
@Setter
public class AdminGetRoleOverrideConfigV3OpResponse extends ApiResponseWithData<ModelRoleOverrideResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.override_role_config_v3.AdminGetRoleOverrideConfigV3";
    }
}