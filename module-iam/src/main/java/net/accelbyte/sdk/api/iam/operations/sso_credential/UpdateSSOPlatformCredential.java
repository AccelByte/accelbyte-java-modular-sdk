...
import net.accelbyte.sdk.api.iam.operation_responses.sso_credential.UpdateSSOPlatformCredentialOpResponse;
...
public class UpdateSSOPlatformCredential extends Operation {
    ...
    */
    ...
    public UpdateSSOPlatformCredentialOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateSSOPlatformCredentialOpResponse response = new UpdateSSOPlatformCredentialOpResponse();
