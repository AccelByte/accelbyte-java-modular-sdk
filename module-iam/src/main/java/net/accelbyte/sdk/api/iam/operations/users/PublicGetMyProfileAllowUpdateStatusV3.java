...
public class PublicGetMyProfileAllowUpdateStatusV3 extends Operation {
    ...
    */
    ...
    public PublicGetMyProfileAllowUpdateStatusV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetMyProfileAllowUpdateStatusV3OpResponse response = new PublicGetMyProfileAllowUpdateStatusV3OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelUserProfileUpdateAllowStatus().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelUserProfileUpdateAllowStatus parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
