...
@Getter
@Setter
public class GetPublisherUserOpResponse extends ApiResponseWithData<ModelGetPublisherUserResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.users.GetPublisherUser";
  }
}
