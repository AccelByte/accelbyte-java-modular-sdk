...
public class ModelRoleOverrideUpdateRequest extends Model {
    ...
    @JsonIgnore
    public List<ModelRoleOverrideUpdateRequest> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelRoleOverrideUpdateRequest>>() {});
    }
