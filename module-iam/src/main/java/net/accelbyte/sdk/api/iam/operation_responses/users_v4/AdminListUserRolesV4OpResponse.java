...
@Getter
@Setter
public class AdminListUserRolesV4OpResponse extends ApiResponseWithData<ModelListUserRolesV4Response> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.AdminListUserRolesV4";
    }
}