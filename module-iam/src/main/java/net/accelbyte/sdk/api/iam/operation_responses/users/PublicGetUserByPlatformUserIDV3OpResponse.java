...
@Getter
@Setter
public class PublicGetUserByPlatformUserIDV3OpResponse extends ApiResponseWithData<ModelUserResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.PublicGetUserByPlatformUserIDV3";
    }
}