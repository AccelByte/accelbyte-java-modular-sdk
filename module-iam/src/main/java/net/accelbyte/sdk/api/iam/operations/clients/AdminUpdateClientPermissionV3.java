...
public class AdminUpdateClientPermissionV3 extends Operation {
    ...
    */
    ...
    public AdminUpdateClientPermissionV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateClientPermissionV3OpResponse response = new AdminUpdateClientPermissionV3OpResponse();
