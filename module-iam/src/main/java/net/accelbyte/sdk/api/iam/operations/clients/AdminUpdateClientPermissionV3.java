...
import net.accelbyte.sdk.api.iam.operation_responses.clients.AdminUpdateClientPermissionV3OpResponse;
 ...
 *
 * <p>**Note for Multi Tenant Mode:** Studio admin & game admin can only add custom permissions: *
 * The allowed prefix are: 1. ***CUSTOM:ADMIN:NAMESPACE:{namespace}*** 2.
 * ***CUSTOM:NAMESPACE:{namespace}*** * If the request body has new added/delete non-custom
 * permission, the request will fail.
 */
@Getter
@Setter
public class AdminUpdateClientPermissionV3 extends Operation {
  ...
  public AdminUpdateClientPermissionV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminUpdateClientPermissionV3OpResponse response =
        new AdminUpdateClientPermissionV3OpResponse();
