...
public class AdminDeleteUserLinkingHistoryByPlatformIDV3 extends Operation {
     ...
     */
    private String path = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/{platformId}/link/histories";
    ...
    */
    ...
    public AdminDeleteUserLinkingHistoryByPlatformIDV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDeleteUserLinkingHistoryByPlatformIDV3OpResponse response = new AdminDeleteUserLinkingHistoryByPlatformIDV3OpResponse();
