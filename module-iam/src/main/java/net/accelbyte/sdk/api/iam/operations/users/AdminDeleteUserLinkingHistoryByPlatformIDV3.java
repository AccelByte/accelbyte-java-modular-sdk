...
public class AdminDeleteUserLinkingHistoryByPlatformIDV3 extends Operation {
  ...
  public AdminDeleteUserLinkingHistoryByPlatformIDV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminDeleteUserLinkingHistoryByPlatformIDV3OpResponse response =
        new AdminDeleteUserLinkingHistoryByPlatformIDV3OpResponse();
