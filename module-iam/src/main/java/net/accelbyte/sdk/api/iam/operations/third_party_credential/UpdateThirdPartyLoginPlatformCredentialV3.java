...
public class UpdateThirdPartyLoginPlatformCredentialV3 extends Operation {
    ...
    */
    ...
    public UpdateThirdPartyLoginPlatformCredentialV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateThirdPartyLoginPlatformCredentialV3OpResponse response = new UpdateThirdPartyLoginPlatformCredentialV3OpResponse();
