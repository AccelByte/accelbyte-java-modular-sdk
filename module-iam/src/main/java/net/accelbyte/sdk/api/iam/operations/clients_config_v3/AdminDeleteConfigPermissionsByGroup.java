...
public class AdminDeleteConfigPermissionsByGroup extends Operation {
  ...
  public AdminDeleteConfigPermissionsByGroup(
      String customBasePath, Boolean forceDelete, ClientmodelPermissionSetDeleteGroupRequest body) {
  ...
  public AdminDeleteConfigPermissionsByGroupOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminDeleteConfigPermissionsByGroupOpResponse response =
        new AdminDeleteConfigPermissionsByGroupOpResponse();
