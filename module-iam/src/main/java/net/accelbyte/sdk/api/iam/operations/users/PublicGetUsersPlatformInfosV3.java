...
public class PublicGetUsersPlatformInfosV3 extends Operation {
  ...
  public PublicGetUsersPlatformInfosV3(
      String customBasePath, String namespace, ModelUsersPlatformInfosRequestV3 body) {
  ...
  public PublicGetUsersPlatformInfosV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGetUsersPlatformInfosV3OpResponse response =
        new PublicGetUsersPlatformInfosV3OpResponse();
