...
@Getter
@Setter
public class AdminGetUserBanSummaryV3OpResponse extends ApiResponseWithData<ModelGetUserBanSummaryV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminGetUserBanSummaryV3";
    }
}