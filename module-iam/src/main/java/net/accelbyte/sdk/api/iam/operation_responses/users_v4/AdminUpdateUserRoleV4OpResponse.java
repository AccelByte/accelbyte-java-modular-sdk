...
@Getter
@Setter
public class AdminUpdateUserRoleV4OpResponse extends ApiResponseWithData<ModelListUserRolesV4Response> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.AdminUpdateUserRoleV4";
    }
}