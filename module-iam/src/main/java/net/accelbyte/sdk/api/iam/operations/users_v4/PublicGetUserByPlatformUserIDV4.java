...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.PublicGetUserByPlatformUserIDV4OpResponse;
 ...
 * steamnetwork / steam / steamopenid as platformId path parameter. If the target platform is not
 * linked to the current user, will only return public information. ----------
 *
...
public class PublicGetUserByPlatformUserIDV4 extends Operation {
  ...
  public PublicGetUserByPlatformUserIDV4OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGetUserByPlatformUserIDV4OpResponse response =
        new PublicGetUserByPlatformUserIDV4OpResponse();
