 ...
 * AdminInviteUserV3
 *
 * <p>Invites an admin or non-admin user and assigns a role to them. The role must be scoped to
 * namespace based on the **{namespace}** value in path parameter. An admin user can only assign
 * role to namespaces that the admin user has the required permission. Role is optional, if not
 * specified then it will only assign User role
 *
...
public class AdminInviteUserV3 extends Operation {
  ...
  @Deprecated
  public AdminInviteUserV3(String customBasePath, String namespace, ModelInviteUserRequestV3 body) {
  ...
  public AdminInviteUserV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminInviteUserV3OpResponse response = new AdminInviteUserV3OpResponse();
