...
@Getter
@Setter
public class GetAdminUsersByRoleIdV3OpResponse extends ApiResponseWithData<ModelGetUsersResponseWithPaginationV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.GetAdminUsersByRoleIdV3";
    }
}