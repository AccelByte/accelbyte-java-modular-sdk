 ...
 * _/iam/v3/admin/namespaces/{namespace}/users/{userId}/status [PATCH]_**
 *
 * @deprecated
 */
@Deprecated
...
public class EnableUser extends Operation {
  ...
  @Deprecated
  public EnableUser(String customBasePath, String namespace, String userId) {
  ...
  public EnableUserOpResponse parseResponse(int code, String contentType, InputStream payload)
