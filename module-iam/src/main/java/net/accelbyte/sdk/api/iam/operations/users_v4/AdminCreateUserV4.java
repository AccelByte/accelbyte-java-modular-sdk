...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.AdminCreateUserV4OpResponse;
 ...
 * AdminCreateUserV4
 *
 * <p>Creates a new user with unique email address and username (admin operation). Supports
 * accepting agreements for the created user via the acceptedPolicies attribute. See request body
...
public class AdminCreateUserV4 extends Operation {
  ...
  public AdminCreateUserV4OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminCreateUserV4OpResponse response = new AdminCreateUserV4OpResponse();
