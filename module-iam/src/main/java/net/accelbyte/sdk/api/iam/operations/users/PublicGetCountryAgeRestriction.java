...
public class PublicGetCountryAgeRestriction extends Operation {
    ...
    */
    ...
    public PublicGetCountryAgeRestrictionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetCountryAgeRestrictionOpResponse response = new PublicGetCountryAgeRestrictionOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new AccountcommonCountry().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 401) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public AccountcommonCountry parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
