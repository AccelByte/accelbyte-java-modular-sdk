...
@Getter
@Setter
public class GetAdminUsersByRoleIDOpResponse extends ApiResponseWithData<ModelGetAdminUsersResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.GetAdminUsersByRoleID";
    }
}