...
public class AdminUpdateRolePermissionsV4 extends Operation {
    ...
    */
    ...
    public AdminUpdateRolePermissionsV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateRolePermissionsV4OpResponse response = new AdminUpdateRolePermissionsV4OpResponse();
