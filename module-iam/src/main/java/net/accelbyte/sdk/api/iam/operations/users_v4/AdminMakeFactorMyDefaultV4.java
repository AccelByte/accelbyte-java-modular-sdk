...
public class AdminMakeFactorMyDefaultV4 extends Operation {
  ...
  @Deprecated
  public AdminMakeFactorMyDefaultV4(String customBasePath, String factor) {
    this.factor = factor;
  ...
  public AdminMakeFactorMyDefaultV4OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminMakeFactorMyDefaultV4OpResponse response =
        new AdminMakeFactorMyDefaultV4OpResponse();
