...
import net.accelbyte.sdk.api.iam.operation_responses.roles.DeleteRolePermissionOpResponse;
 ...
 * _/iam/v3/admin/roles/{roleId}/permissions/{resource}/{action} [DELETE]_** - **Substitute
 * endpoint: _/iam/v4/admin/roles/{roleId}/permissions [DELETE]_**
 *
 * @deprecated
 */
@Deprecated
...
public class DeleteRolePermission extends Operation {
  ...
  public DeleteRolePermissionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final DeleteRolePermissionOpResponse response = new DeleteRolePermissionOpResponse();
