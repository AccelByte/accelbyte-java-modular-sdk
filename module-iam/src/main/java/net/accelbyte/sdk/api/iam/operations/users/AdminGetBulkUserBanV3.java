...
public class AdminGetBulkUserBanV3 extends Operation {
    ...
    */
    ...
    public AdminGetBulkUserBanV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetBulkUserBanV3OpResponse response = new AdminGetBulkUserBanV3OpResponse();
