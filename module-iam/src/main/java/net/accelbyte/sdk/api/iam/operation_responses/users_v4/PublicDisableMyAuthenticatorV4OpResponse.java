...
@Getter
@Setter
public class PublicDisableMyAuthenticatorV4OpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.PublicDisableMyAuthenticatorV4";
    }
}