 ...
 * _/iam/v3/admin/namespaces/{namespace}/agerestrictions [PATCH]_**
 *
 * @deprecated
 */
@Deprecated
...
public class AdminUpdateAgeRestrictionConfigV2 extends Operation {
  ...
  public AdminUpdateAgeRestrictionConfigV2(
      String customBasePath, String namespace, ModelAgeRestrictionRequest body) {
  ...
  public AdminUpdateAgeRestrictionConfigV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminUpdateAgeRestrictionConfigV2OpResponse response =
        new AdminUpdateAgeRestrictionConfigV2OpResponse();
