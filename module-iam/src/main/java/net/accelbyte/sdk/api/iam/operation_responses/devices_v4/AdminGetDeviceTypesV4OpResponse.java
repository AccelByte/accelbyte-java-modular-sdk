...
@Getter
@Setter
public class AdminGetDeviceTypesV4OpResponse extends ApiResponseWithData<ModelDeviceTypesResponseV4> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.devices_v4.AdminGetDeviceTypesV4";
    }
}