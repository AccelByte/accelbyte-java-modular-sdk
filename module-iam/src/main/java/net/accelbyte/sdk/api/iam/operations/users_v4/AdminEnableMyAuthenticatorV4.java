...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.AdminEnableMyAuthenticatorV4OpResponse;
...
public class AdminEnableMyAuthenticatorV4 extends Operation {
    ...
    */
    ...
    public AdminEnableMyAuthenticatorV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminEnableMyAuthenticatorV4OpResponse response = new AdminEnableMyAuthenticatorV4OpResponse();
