...
public class AdminEnableMyAuthenticatorV4 extends Operation {
  ...
  @Deprecated
  public AdminEnableMyAuthenticatorV4(String customBasePath, String code) {
    this.code = code;
  ...
  public AdminEnableMyAuthenticatorV4OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminEnableMyAuthenticatorV4OpResponse response =
        new AdminEnableMyAuthenticatorV4OpResponse();
