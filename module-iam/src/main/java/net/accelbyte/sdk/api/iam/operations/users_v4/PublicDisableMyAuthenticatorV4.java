...
public class PublicDisableMyAuthenticatorV4 extends Operation {
    ...
    */
    ...
    public PublicDisableMyAuthenticatorV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicDisableMyAuthenticatorV4OpResponse response = new PublicDisableMyAuthenticatorV4OpResponse();
