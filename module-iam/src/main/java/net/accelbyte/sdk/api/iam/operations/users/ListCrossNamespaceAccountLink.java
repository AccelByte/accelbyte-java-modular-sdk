...
public class ListCrossNamespaceAccountLink extends Operation {
  ...
  public ListCrossNamespaceAccountLinkOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final ListCrossNamespaceAccountLinkOpResponse response =
        new ListCrossNamespaceAccountLinkOpResponse();
