...
import net.accelbyte.sdk.api.iam.operation_responses.o_auth.NamespaceScopedPlatformTokenGrantOpResponse;
 ...
 * Basic access authentication constructed from client id and client secret. For publisher-game
...
@Getter
@Setter
public class NamespaceScopedPlatformTokenGrant extends Operation {
  ...
  @Deprecated
  public NamespaceScopedPlatformTokenGrant(
  ...
  public NamespaceScopedPlatformTokenGrantOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final NamespaceScopedPlatformTokenGrantOpResponse response =
        new NamespaceScopedPlatformTokenGrantOpResponse();
