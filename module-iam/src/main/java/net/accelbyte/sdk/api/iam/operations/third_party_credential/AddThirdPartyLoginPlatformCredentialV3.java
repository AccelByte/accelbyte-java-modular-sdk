 ...
 *
 * <p>Creates a third-party platform credential. Configure the Secret field according to the target
 * platform (see field description). For generic OAuth flow, set GenericOauthFlow to true and
...
public class AddThirdPartyLoginPlatformCredentialV3 extends Operation {
  ...
  public AddThirdPartyLoginPlatformCredentialV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AddThirdPartyLoginPlatformCredentialV3OpResponse response =
        new AddThirdPartyLoginPlatformCredentialV3OpResponse();
