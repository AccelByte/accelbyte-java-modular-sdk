...
public class AddThirdPartyLoginPlatformCredentialV3 extends Operation {
    ...
    */
    ...
    public AddThirdPartyLoginPlatformCredentialV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AddThirdPartyLoginPlatformCredentialV3OpResponse response = new AddThirdPartyLoginPlatformCredentialV3OpResponse();
