...
@Getter
@Setter
public class AdminGetUserByEmailAddressV3OpResponse extends ApiResponseWithData<ModelUserResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminGetUserByEmailAddressV3";
    }
}