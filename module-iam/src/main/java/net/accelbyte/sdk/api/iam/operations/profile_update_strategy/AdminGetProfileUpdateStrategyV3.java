...
public class AdminGetProfileUpdateStrategyV3 extends Operation {
    ...
    */
    ...
    public AdminGetProfileUpdateStrategyV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetProfileUpdateStrategyV3OpResponse response = new AdminGetProfileUpdateStrategyV3OpResponse();
