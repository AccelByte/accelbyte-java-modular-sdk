...
@Getter
@Setter
public class PublicChallengeMyMFAV4OpResponse extends ApiResponseWithData<ModelUserMFATokenResponseV4> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.PublicChallengeMyMFAV4";
    }
}