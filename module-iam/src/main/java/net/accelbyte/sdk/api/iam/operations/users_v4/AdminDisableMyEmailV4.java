...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.AdminDisableMyEmailV4OpResponse;
...
public class AdminDisableMyEmailV4 extends Operation {
    ...
    */
    ...
    public AdminDisableMyEmailV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDisableMyEmailV4OpResponse response = new AdminDisableMyEmailV4OpResponse();
