...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.AdminGetBackupCodesV4OpResponse;
...
public class AdminGetBackupCodesV4 extends Operation {
    ...
    */
    ...
    public AdminGetBackupCodesV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetBackupCodesV4OpResponse response = new AdminGetBackupCodesV4OpResponse();
