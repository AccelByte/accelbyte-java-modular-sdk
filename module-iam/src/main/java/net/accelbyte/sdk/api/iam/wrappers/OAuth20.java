...
public class OAuth20 {
     ...
     */
    public AdminRetrieveUserThirdPartyPlatformTokenV3OpResponse adminRetrieveUserThirdPartyPlatformTokenV3(AdminRetrieveUserThirdPartyPlatformTokenV3 input) throws Exception {
     ...
     */
    public TokenIntrospectionV3OpResponse tokenIntrospectionV3(TokenIntrospectionV3 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public SendMFAAuthenticationCodeOpResponse sendMFAAuthenticationCode(SendMFAAuthenticationCode input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public RetrieveUserThirdPartyPlatformTokenV3OpResponse retrieveUserThirdPartyPlatformTokenV3(RetrieveUserThirdPartyPlatformTokenV3 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public PlatformTokenGrantV3OpResponse platformTokenGrantV3(PlatformTokenGrantV3 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public GetRevocationListV3OpResponse getRevocationListV3(GetRevocationListV3 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public SimultaneousLoginV3OpResponse simultaneousLoginV3(SimultaneousLoginV3 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
