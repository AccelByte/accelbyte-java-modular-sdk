...
public class PublicDisableMyBackupCodesV4 extends Operation {
    ...
    */
    ...
    public PublicDisableMyBackupCodesV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicDisableMyBackupCodesV4OpResponse response = new PublicDisableMyBackupCodesV4OpResponse();
