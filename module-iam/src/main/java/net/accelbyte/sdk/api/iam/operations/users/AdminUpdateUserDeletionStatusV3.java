...
public class AdminUpdateUserDeletionStatusV3 extends Operation {
  ...
  public AdminUpdateUserDeletionStatusV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminUpdateUserDeletionStatusV3OpResponse response =
        new AdminUpdateUserDeletionStatusV3OpResponse();
