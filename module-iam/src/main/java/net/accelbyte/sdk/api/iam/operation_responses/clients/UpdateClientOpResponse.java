...
@Getter
@Setter
public class UpdateClientOpResponse extends ApiResponseWithData<ClientmodelClientResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.clients.UpdateClient";
    }
}