...
public class AdminUpdateRolePermissionsV3 extends Operation {
    ...
    */
    ...
    public AdminUpdateRolePermissionsV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateRolePermissionsV3OpResponse response = new AdminUpdateRolePermissionsV3OpResponse();
