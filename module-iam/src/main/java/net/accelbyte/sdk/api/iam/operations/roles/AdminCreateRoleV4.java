...
public class AdminCreateRoleV4 extends Operation {
    ...
    */
    ...
    public AdminCreateRoleV4(
            String customBasePath,            ModelRoleV4Request body
    )
    {
        this.body = body;
    ...
    public AdminCreateRoleV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
