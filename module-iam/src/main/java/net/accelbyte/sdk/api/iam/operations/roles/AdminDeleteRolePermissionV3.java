...
public class AdminDeleteRolePermissionV3 extends Operation {
  ...
  public AdminDeleteRolePermissionV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminDeleteRolePermissionV3OpResponse response =
        new AdminDeleteRolePermissionV3OpResponse();
