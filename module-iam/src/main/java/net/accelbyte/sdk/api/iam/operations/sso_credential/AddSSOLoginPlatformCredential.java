...
import net.accelbyte.sdk.api.iam.operation_responses.sso_credential.AddSSOLoginPlatformCredentialOpResponse;
...
public class AddSSOLoginPlatformCredential extends Operation {
    ...
    */
    ...
    public AddSSOLoginPlatformCredentialOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AddSSOLoginPlatformCredentialOpResponse response = new AddSSOLoginPlatformCredentialOpResponse();
