...
public class PublicGetUserByUserIDV2 extends Operation {
  ...
  @Deprecated
  public PublicGetUserByUserIDV2(String customBasePath, String namespace, String userId) {
  ...
  public PublicGetUserByUserIDV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGetUserByUserIDV2OpResponse response = new PublicGetUserByUserIDV2OpResponse();
