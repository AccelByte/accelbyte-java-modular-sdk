...
@Getter
@Setter
public class PublicWebReauthPlatformOpResponse
    extends ApiResponseWithData<ModelWebLinkingResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.users.PublicWebReauthPlatform";
  }
}
