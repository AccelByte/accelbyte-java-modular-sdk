 ...
 *
 * <p>Generates the target token. It requires basic header with ClientID and Secret, it should match
 * the ClientID when call `/iam/v3/namespace/{namespace}/token/request [POST]` The code should be
...
public class RequestTargetTokenResponseV3 extends Operation {
  ...
  public RequestTargetTokenResponseV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final RequestTargetTokenResponseV3OpResponse response =
        new RequestTargetTokenResponseV3OpResponse();
