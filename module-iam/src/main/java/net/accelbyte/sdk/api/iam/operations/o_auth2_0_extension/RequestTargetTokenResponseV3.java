...
public class RequestTargetTokenResponseV3 extends Operation {
    ...
    */
    ...
    public RequestTargetTokenResponseV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RequestTargetTokenResponseV3OpResponse response = new RequestTargetTokenResponseV3OpResponse();
