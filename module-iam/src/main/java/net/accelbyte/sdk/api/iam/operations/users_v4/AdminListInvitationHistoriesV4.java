...
public class AdminListInvitationHistoriesV4 extends Operation {
  ...
  public AdminListInvitationHistoriesV4(
      String customBasePath, Integer limit, String namespace, Integer offset) {
    this.limit = limit;
  ...
  public AdminListInvitationHistoriesV4OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminListInvitationHistoriesV4OpResponse response =
        new AdminListInvitationHistoriesV4OpResponse();
