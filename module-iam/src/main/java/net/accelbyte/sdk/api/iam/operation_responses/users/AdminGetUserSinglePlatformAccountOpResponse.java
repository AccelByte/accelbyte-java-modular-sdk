...
@Getter
@Setter
public class AdminGetUserSinglePlatformAccountOpResponse extends ApiResponseWithData<ModelUserPlatformMetadata> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminGetUserSinglePlatformAccount";
    }
}