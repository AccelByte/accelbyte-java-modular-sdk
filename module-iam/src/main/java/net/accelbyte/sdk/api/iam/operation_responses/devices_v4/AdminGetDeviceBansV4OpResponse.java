...
@Getter
@Setter
public class AdminGetDeviceBansV4OpResponse extends ApiResponseWithData<ModelDeviceBansResponseV4> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.devices_v4.AdminGetDeviceBansV4";
    }
}