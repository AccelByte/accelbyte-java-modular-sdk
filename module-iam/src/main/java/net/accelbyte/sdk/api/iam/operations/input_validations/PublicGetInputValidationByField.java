...
public class PublicGetInputValidationByField extends Operation {
  ...
  @Deprecated
  public PublicGetInputValidationByField(String customBasePath, String field) {
    this.field = field;
  ...
  public PublicGetInputValidationByFieldOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicGetInputValidationByFieldOpResponse response =
        new PublicGetInputValidationByFieldOpResponse();
