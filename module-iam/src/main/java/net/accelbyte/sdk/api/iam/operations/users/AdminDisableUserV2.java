...
public class AdminDisableUserV2 extends Operation {
    ...
    */
    ...
    public AdminDisableUserV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDisableUserV2OpResponse response = new AdminDisableUserV2OpResponse();
