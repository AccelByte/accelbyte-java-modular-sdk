...
import net.accelbyte.sdk.api.iam.operation_responses.roles.AddRolePermissionOpResponse;
...
public class AddRolePermission extends Operation {
    ...
    */
    ...
    public AddRolePermissionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AddRolePermissionOpResponse response = new AddRolePermissionOpResponse();
