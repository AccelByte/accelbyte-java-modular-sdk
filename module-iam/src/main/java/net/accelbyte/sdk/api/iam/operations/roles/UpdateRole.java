 ...
 * _/iam/v3/admin/roles/{roleId} [PATCH]_**
 *
 * @deprecated
 */
@Deprecated
...
public class UpdateRole extends Operation {
  ...
  @Deprecated
  public UpdateRole(String customBasePath, String roleId, ModelRoleUpdateRequest body) {
    this.roleId = roleId;
    this.body = body;
  ...
  public UpdateRoleOpResponse parseResponse(int code, String contentType, InputStream payload)
