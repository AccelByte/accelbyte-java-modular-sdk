...
@Getter
@Setter
public class AdminListUsersV3OpResponse extends ApiResponseWithData<AccountcommonListUsersWithPlatformAccountsResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminListUsersV3";
    }
}