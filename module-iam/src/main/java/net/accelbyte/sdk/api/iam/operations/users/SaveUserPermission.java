 ...
 * _/iam/v3/admin/namespaces/{namespace}/users/{userId}/permissions [POST]_**
 *
 * <p>Replaces user's permissions with the ones defined in body Schedule contains cron string or
...
public class SaveUserPermission extends Operation {
  ...
  public SaveUserPermissionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final SaveUserPermissionOpResponse response = new SaveUserPermissionOpResponse();
