...
public class AdminDeleteUserRolesV3 extends Operation {
    ...
    */
    ...
    public AdminDeleteUserRolesV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDeleteUserRolesV3OpResponse response = new AdminDeleteUserRolesV3OpResponse();
