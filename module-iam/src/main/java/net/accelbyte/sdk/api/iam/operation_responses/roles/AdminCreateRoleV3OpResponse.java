...
@Getter
@Setter
public class AdminCreateRoleV3OpResponse extends ApiResponseWithData<AccountcommonRoleV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.roles.AdminCreateRoleV3";
    }
}