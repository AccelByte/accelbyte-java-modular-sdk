...
@NoArgsConstructor
public class ModelReAuthRequest extends Model {
  ...
  @JsonIgnore
  public ModelReAuthRequest createFromJson(String json) throws JsonProcessingException {
    return new ObjectMapper().readValue(json, this.getClass());
  }

  @JsonIgnore
  public List<ModelReAuthRequest> createFromJsonList(String json) throws JsonProcessingException {
    return new ObjectMapper().readValue(json, new TypeReference<List<ModelReAuthRequest>>() {});
  }
}
