...
public class AdminLinkPlatformAccount extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("skipConflict", this.skipConflict == null ? null : Arrays.asList(String.valueOf(this.skipConflict)));
        return queryParams;
    }
    ...
    public AdminLinkPlatformAccountOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
