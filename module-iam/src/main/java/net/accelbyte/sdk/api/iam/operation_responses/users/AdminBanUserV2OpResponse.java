...
@Getter
@Setter
public class AdminBanUserV2OpResponse extends ApiResponseWithData<ModelUserBanResponse> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.users.AdminBanUserV2";
  }
}
