...
public class ClientmodelClientTemplate extends Model {
    ...
    @JsonIgnore
    public List<ClientmodelClientTemplate> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ClientmodelClientTemplate>>() {});
    }
