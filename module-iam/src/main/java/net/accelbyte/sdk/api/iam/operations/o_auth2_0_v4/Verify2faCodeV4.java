...
import net.accelbyte.sdk.api.iam.operation_responses.o_auth2_0_v4.Verify2faCodeV4OpResponse;
...
public class Verify2faCodeV4 extends Operation {
    ...
    */
    ...
    public Verify2faCodeV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final Verify2faCodeV4OpResponse response = new Verify2faCodeV4OpResponse();
