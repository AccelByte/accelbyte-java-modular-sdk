...
public class AdminBulkGetUsersPlatform extends Operation {
    ...
    */
    ...
    public AdminBulkGetUsersPlatformOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminBulkGetUsersPlatformOpResponse response = new AdminBulkGetUsersPlatformOpResponse();
