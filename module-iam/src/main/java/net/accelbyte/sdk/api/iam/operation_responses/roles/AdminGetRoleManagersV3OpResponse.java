...
@Getter
@Setter
public class AdminGetRoleManagersV3OpResponse extends ApiResponseWithData<ModelRoleManagersResponsesV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.roles.AdminGetRoleManagersV3";
    }
}