...
@Getter
@Setter
public class AdminUpdateUserEmailAddressV4OpResponse extends ApiResponse {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.AdminUpdateUserEmailAddressV4";
    }
}