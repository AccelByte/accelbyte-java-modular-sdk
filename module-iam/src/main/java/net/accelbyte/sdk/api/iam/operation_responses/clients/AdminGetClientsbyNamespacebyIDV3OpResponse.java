...
@Getter
@Setter
public class AdminGetClientsbyNamespacebyIDV3OpResponse extends ApiResponseWithData<ClientmodelClientV3Response> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.clients.AdminGetClientsbyNamespacebyIDV3";
    }
}