...
public class PublicSendVerificationCodeV3 extends Operation {
  ...
  public PublicSendVerificationCodeV3(
      String customBasePath, String namespace, ModelSendVerificationCodeRequestV3 body) {
  ...
  public PublicSendVerificationCodeV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicSendVerificationCodeV3OpResponse response =
        new PublicSendVerificationCodeV3OpResponse();
