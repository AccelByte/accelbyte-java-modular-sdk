...
public class OverrideRoleConfigV3 {
   ...
   */
  public AdminGetRoleOverrideConfigV3OpResponse adminGetRoleOverrideConfigV3(
      AdminGetRoleOverrideConfigV3 input) throws Exception {
   ...
   */
  public AdminUpdateRoleOverrideConfigV3OpResponse adminUpdateRoleOverrideConfigV3(
   ...
   */
  public AdminGetRoleSourceV3OpResponse adminGetRoleSourceV3(AdminGetRoleSourceV3 input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminChangeRoleOverrideConfigStatusV3OpResponse adminChangeRoleOverrideConfigStatusV3(
   ...
   */
  public AdminGetRoleNamespacePermissionV3OpResponse adminGetRoleNamespacePermissionV3(
