...
@Getter
@Setter
public class AdminUpgradeHeadlessAccountV3OpResponse extends ApiResponseWithData<ModelUserResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminUpgradeHeadlessAccountV3";
    }
}