...
public class AdminUpdateUserBanV3 extends Operation {
    ...
    */
    ...
    public AdminUpdateUserBanV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateUserBanV3OpResponse response = new AdminUpdateUserBanV3OpResponse();
