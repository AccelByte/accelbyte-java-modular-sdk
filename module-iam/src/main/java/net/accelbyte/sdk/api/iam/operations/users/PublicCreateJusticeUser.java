...
public class PublicCreateJusticeUser extends Operation {
  ...
  @Deprecated
  public PublicCreateJusticeUser(String customBasePath, String namespace, String targetNamespace) {
  ...
  public PublicCreateJusticeUserOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicCreateJusticeUserOpResponse response = new PublicCreateJusticeUserOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ModelCreateJusticeUserResponse().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public ModelCreateJusticeUserResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 201){
          final String json = Helper.convertInputStreamToString(payload);
