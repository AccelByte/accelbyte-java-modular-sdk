...
public class AdminDeleteRolePermissionsV4 extends Operation {
  ...
  public AdminDeleteRolePermissionsV4OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminDeleteRolePermissionsV4OpResponse response =
        new AdminDeleteRolePermissionsV4OpResponse();
