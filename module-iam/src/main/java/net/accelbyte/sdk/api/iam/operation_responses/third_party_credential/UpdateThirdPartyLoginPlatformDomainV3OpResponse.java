...
@Getter
@Setter
public class UpdateThirdPartyLoginPlatformDomainV3OpResponse extends ApiResponseWithData<ModelPlatformDomainResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.third_party_credential.UpdateThirdPartyLoginPlatformDomainV3";
    }
}