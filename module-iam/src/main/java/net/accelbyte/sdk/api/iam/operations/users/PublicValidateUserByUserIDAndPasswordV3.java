 ...
 *
 * <p>Validates the user password by specifying the userId and password.
 *
...
public class PublicValidateUserByUserIDAndPasswordV3 extends Operation {
  ...
  public PublicValidateUserByUserIDAndPasswordV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicValidateUserByUserIDAndPasswordV3OpResponse response =
        new PublicValidateUserByUserIDAndPasswordV3OpResponse();
