...
public class PublicListJusticePlatformAccountsV3 extends Operation {
  ...
  public PublicListJusticePlatformAccountsV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicListJusticePlatformAccountsV3OpResponse response =
        new PublicListJusticePlatformAccountsV3OpResponse();
    ...
    if (code == 204) {
      ...
      response.setSuccess(true);
      response.setData(
          new ObjectMapper().readValue(json, new TypeReference<List<ModelGetUserMappingV3>>() {}));
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
