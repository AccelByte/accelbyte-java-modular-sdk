...
public class AdminGetUserByPlatformUserIDV3 extends Operation {
    ...
    */
    ...
    public AdminGetUserByPlatformUserIDV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetUserByPlatformUserIDV3OpResponse response = new AdminGetUserByPlatformUserIDV3OpResponse();
