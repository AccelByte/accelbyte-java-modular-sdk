...
public class RetrieveSSOLoginPlatformCredential extends Operation {
  ...
  public RetrieveSSOLoginPlatformCredentialOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final RetrieveSSOLoginPlatformCredentialOpResponse response =
        new RetrieveSSOLoginPlatformCredentialOpResponse();
