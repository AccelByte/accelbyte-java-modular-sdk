...
public class PublicGetCountryListV3 extends Operation {
    ...
    */
    ...
    public PublicGetCountryListV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetCountryListV3OpResponse response = new PublicGetCountryListV3OpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<ModelCountryResponse>>() {}));
        }
        else if (code == 500) {
            final String json = Helper.convertInputStreamToString(payload);
