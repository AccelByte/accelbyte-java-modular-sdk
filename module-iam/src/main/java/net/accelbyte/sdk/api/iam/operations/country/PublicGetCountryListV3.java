...
public class PublicGetCountryListV3 extends Operation {
  ...
  @Deprecated
  public PublicGetCountryListV3(String customBasePath, String namespace) {
  ...
  public PublicGetCountryListV3OpResponse parseResponse(
    ...
    if (code == 204) {
      ...
      response.setSuccess(true);
      response.setData(
          new ObjectMapper().readValue(json, new TypeReference<List<ModelCountryResponse>>() {}));
    } else if (code == 500) {
      final String json = Helper.convertInputStreamToString(payload);
