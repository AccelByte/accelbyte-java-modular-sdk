...
@Getter
@Setter
public class AdminGetBulkUserByEmailAddressV3OpResponse extends ApiResponseWithData<ModelListUserResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminGetBulkUserByEmailAddressV3";
    }
}