...
public class PublicUpgradeHeadlessWithCodeV4Forward extends Operation {
  ...
  public PublicUpgradeHeadlessWithCodeV4ForwardOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicUpgradeHeadlessWithCodeV4ForwardOpResponse response =
        new PublicUpgradeHeadlessWithCodeV4ForwardOpResponse();
