...
@Getter
@Setter
public class AdminGetBannedDevicesV4OpResponse extends ApiResponseWithData<ModelDeviceBannedResponseV4> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.devices_v4.AdminGetBannedDevicesV4";
    }
}