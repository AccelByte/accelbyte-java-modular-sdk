...
@Getter
@Setter
public class CreateClientByNamespaceOpResponse extends ApiResponseWithData<ClientmodelClientCreationResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.clients.CreateClientByNamespace";
    }
}