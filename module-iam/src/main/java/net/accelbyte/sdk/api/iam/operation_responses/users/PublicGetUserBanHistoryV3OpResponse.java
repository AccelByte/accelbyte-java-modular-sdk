...
@Getter
@Setter
public class PublicGetUserBanHistoryV3OpResponse extends ApiResponseWithData<ModelGetUserBanV3Response> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.PublicGetUserBanHistoryV3";
    }
}