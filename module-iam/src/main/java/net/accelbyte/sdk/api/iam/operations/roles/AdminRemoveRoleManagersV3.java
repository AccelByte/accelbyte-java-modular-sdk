...
import net.accelbyte.sdk.api.iam.operation_responses.roles.AdminRemoveRoleManagersV3OpResponse;
...
public class AdminRemoveRoleManagersV3 extends Operation {
    ...
    */
    ...
    public AdminRemoveRoleManagersV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminRemoveRoleManagersV3OpResponse response = new AdminRemoveRoleManagersV3OpResponse();
