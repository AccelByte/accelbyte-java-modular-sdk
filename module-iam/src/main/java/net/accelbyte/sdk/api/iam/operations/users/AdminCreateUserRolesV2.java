...
public class AdminCreateUserRolesV2 extends Operation {
  ...
  public AdminCreateUserRolesV2(
      String customBasePath, String namespace, String userId, List<String> body) {
  ...
  public AdminCreateUserRolesV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminCreateUserRolesV2OpResponse response = new AdminCreateUserRolesV2OpResponse();
