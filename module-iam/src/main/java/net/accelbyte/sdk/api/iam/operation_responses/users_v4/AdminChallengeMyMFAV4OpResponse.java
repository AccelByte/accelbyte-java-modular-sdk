...
@Getter
@Setter
public class AdminChallengeMyMFAV4OpResponse extends ApiResponseWithData<ModelUserMFATokenResponseV4> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users_v4.AdminChallengeMyMFAV4";
    }
}