...
public class PublicGetUserByPlatformUserIDV3 extends Operation {
    ...
    */
    ...
    public PublicGetUserByPlatformUserIDV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetUserByPlatformUserIDV3OpResponse response = new PublicGetUserByPlatformUserIDV3OpResponse();
