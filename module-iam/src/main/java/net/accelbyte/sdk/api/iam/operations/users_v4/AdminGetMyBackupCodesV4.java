...
import net.accelbyte.sdk.api.iam.operation_responses.users_v4.AdminGetMyBackupCodesV4OpResponse;
 ...
 *
 * <p>Returns 8-digit backup codes. Each code is a one-time code and will be deleted once used.
 *
 * @deprecated
 */
@Deprecated
...
public class AdminGetMyBackupCodesV4 extends Operation {
  ...
  @Deprecated
  public AdminGetMyBackupCodesV4(String customBasePath) {
  ...
  public AdminGetMyBackupCodesV4OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetMyBackupCodesV4OpResponse response = new AdminGetMyBackupCodesV4OpResponse();
