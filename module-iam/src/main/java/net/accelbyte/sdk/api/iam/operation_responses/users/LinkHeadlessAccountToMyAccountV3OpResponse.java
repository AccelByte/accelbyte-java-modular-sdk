...
@Getter
@Setter
public class LinkHeadlessAccountToMyAccountV3OpResponse extends ApiResponse {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.iam.operations.users.LinkHeadlessAccountToMyAccountV3";
  }
}
