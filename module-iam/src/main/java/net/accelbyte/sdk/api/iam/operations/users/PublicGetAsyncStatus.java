...
public class PublicGetAsyncStatus extends Operation {
    ...
    */
    ...
    public PublicGetAsyncStatusOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetAsyncStatusOpResponse response = new PublicGetAsyncStatusOpResponse();
