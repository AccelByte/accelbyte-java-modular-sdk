...
public class CreateUserFromInvitationV3 extends Operation {
  ...
  public CreateUserFromInvitationV3(
      String customBasePath, String invitationId, String namespace, ModelUserCreateRequestV3 body) {
  ...
  public CreateUserFromInvitationV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final CreateUserFromInvitationV3OpResponse response =
        new CreateUserFromInvitationV3OpResponse();
