...
public class AuthenticationWithPlatformLinkV3 extends Operation {
    ...
    */
    ...
    public AuthenticationWithPlatformLinkV3(
            String customBasePath,            Boolean extendExp,
            String clientId,
            String linkingToken,
            String password,
            String username
    ...
    public AuthenticationWithPlatformLinkV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AuthenticationWithPlatformLinkV3OpResponse response = new AuthenticationWithPlatformLinkV3OpResponse();
