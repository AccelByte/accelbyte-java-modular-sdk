 ...
 *
 * <p>Authenticates a user account and performs platform linking. Validates user's email / username
 * and password. If user already enabled 2FA, invoke _/mfa/verify_ using **mfa_token** from the
 * response.
 *
 * <p>## Device Cookie Validation Device Cookie is used to protect the user account from brute force
 * login attack, [more detail from
 ...
 *
 * <p>## Login Queue When the Login Queue is enabled and at capacity, this API returns a 401
 * Unauthorized response, with the queue ticket included in the response body.
 */
@Getter
@Setter
public class AuthenticationWithPlatformLinkV3 extends Operation {
  ...
  public AuthenticationWithPlatformLinkV3OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AuthenticationWithPlatformLinkV3OpResponse response =
        new AuthenticationWithPlatformLinkV3OpResponse();
