 ...
 *
 * <p>**(Test only)** Removes a trusted device. Requires a device_token cookie.
 */
@Getter
@Setter
public class PublicRemoveTrustedDeviceV4 extends Operation {
  ...
  @Deprecated
  public PublicRemoveTrustedDeviceV4(String customBasePath, String namespace, String deviceToken) {
  ...
  public PublicRemoveTrustedDeviceV4OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicRemoveTrustedDeviceV4OpResponse response =
        new PublicRemoveTrustedDeviceV4OpResponse();
