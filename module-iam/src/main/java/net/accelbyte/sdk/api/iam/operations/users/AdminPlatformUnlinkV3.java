...
public class AdminPlatformUnlinkV3 extends Operation {
    ...
    */
    ...
    public AdminPlatformUnlinkV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminPlatformUnlinkV3OpResponse response = new AdminPlatformUnlinkV3OpResponse();
