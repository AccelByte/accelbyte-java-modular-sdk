...
import net.accelbyte.sdk.api.iam.operation_responses.clients.AdminAddClientPermissionsV3OpResponse;
...
public class AdminAddClientPermissionsV3 extends Operation {
    ...
    */
    ...
    public AdminAddClientPermissionsV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminAddClientPermissionsV3OpResponse response = new AdminAddClientPermissionsV3OpResponse();
