...
public class PublicListUserIDByPlatformUserIDsV4 extends Operation {
    ...
    */
    ...
    public PublicListUserIDByPlatformUserIDsV4OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicListUserIDByPlatformUserIDsV4OpResponse response = new PublicListUserIDByPlatformUserIDsV4OpResponse();
