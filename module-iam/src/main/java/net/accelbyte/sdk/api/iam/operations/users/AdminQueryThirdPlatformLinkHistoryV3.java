...
public class AdminQueryThirdPlatformLinkHistoryV3 extends Operation {
    ...
    */
    ...
    public AdminQueryThirdPlatformLinkHistoryV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminQueryThirdPlatformLinkHistoryV3OpResponse response = new AdminQueryThirdPlatformLinkHistoryV3OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelLinkingHistoryResponseWithPaginationV3().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelLinkingHistoryResponseWithPaginationV3 parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
