...
@Getter
@Setter
public class AdminGetRoleAdminStatusV3OpResponse extends ApiResponseWithData<ModelRoleAdminStatusResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.roles.AdminGetRoleAdminStatusV3";
    }
}