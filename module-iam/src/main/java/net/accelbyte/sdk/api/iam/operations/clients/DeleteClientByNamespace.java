 ...
 * _/iam/v3/admin/namespaces/{namespace}/clients/{clientId} [DELETE]_**
 *
 * @deprecated
 */
@Deprecated
...
public class DeleteClientByNamespace extends Operation {
  ...
  @Deprecated
  public DeleteClientByNamespace(String customBasePath, String clientId, String namespace) {
  ...
  public DeleteClientByNamespaceOpResponse parseResponse(
