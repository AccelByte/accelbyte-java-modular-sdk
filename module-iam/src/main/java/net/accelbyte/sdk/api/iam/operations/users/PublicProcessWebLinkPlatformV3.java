...
public class PublicProcessWebLinkPlatformV3 extends Operation {
    ...
    */
    ...
    public PublicProcessWebLinkPlatformV3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicProcessWebLinkPlatformV3OpResponse response = new PublicProcessWebLinkPlatformV3OpResponse();
