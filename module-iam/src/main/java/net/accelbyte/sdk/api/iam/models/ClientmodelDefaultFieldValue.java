...
public class ClientmodelDefaultFieldValue extends Model {
    ...
    @JsonIgnore
    public List<ClientmodelDefaultFieldValue> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ClientmodelDefaultFieldValue>>() {});
    }
