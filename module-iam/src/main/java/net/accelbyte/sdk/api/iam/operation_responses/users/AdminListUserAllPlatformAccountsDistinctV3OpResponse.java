...
@Getter
@Setter
public class AdminListUserAllPlatformAccountsDistinctV3OpResponse extends ApiResponseWithData<AccountcommonDistinctPlatformResponseV3> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.iam.operations.users.AdminListUserAllPlatformAccountsDistinctV3";
    }
}