...
public class UpdateCountryAgeRestriction extends Operation {
  ...
  public UpdateCountryAgeRestrictionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdateCountryAgeRestrictionOpResponse response =
        new UpdateCountryAgeRestrictionOpResponse();
