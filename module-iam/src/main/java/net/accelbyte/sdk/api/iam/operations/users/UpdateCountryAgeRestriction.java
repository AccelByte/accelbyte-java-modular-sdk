...
public class UpdateCountryAgeRestriction extends Operation {
    ...
    */
    ...
    public UpdateCountryAgeRestrictionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateCountryAgeRestrictionOpResponse response = new UpdateCountryAgeRestrictionOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelCountry().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelCountry parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
