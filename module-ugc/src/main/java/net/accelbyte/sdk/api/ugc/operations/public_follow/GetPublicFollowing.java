...
public class GetPublicFollowing extends Operation {
    ...
    */
    ...
    public GetPublicFollowingOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetPublicFollowingOpResponse response = new GetPublicFollowingOpResponse();
