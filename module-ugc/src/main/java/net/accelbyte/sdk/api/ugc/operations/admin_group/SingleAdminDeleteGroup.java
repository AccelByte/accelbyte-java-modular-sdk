...
public class SingleAdminDeleteGroup extends Operation {
    ...
    */
    ...
    public SingleAdminDeleteGroupOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SingleAdminDeleteGroupOpResponse response = new SingleAdminDeleteGroupOpResponse();
