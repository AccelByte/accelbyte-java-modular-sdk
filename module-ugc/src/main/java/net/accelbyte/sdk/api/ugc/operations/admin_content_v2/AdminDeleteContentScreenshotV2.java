...
public class AdminDeleteContentScreenshotV2 extends Operation {
     ...
     */
    private String path = "/ugc/v2/admin/namespaces/{namespace}/contents/{contentId}/screenshots/{screenshotId}";
    ...
    */
    ...
    public AdminDeleteContentScreenshotV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDeleteContentScreenshotV2OpResponse response = new AdminDeleteContentScreenshotV2OpResponse();
