...
import net.accelbyte.sdk.api.ugc.operation_responses.admin_channel.AdminCreateChannelOpResponse;
...
public class AdminCreateChannel extends Operation {
  ...
  @Deprecated
  public AdminCreateChannel(String customBasePath, String namespace, ModelsChannelRequest body) {
  ...
  public AdminCreateChannelOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminCreateChannelOpResponse response = new AdminCreateChannelOpResponse();
