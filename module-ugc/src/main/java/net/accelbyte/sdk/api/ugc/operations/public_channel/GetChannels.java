...
import net.accelbyte.sdk.api.ugc.operation_responses.public_channel.GetChannelsOpResponse;
...
public class GetChannels extends Operation {
    ...
    */
    ...
    public GetChannelsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetChannelsOpResponse response = new GetChannelsOpResponse();
