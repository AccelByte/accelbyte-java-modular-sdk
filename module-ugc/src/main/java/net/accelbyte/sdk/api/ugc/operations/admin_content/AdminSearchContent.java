...
public class AdminSearchContent extends Operation {
    ...
    */
    ...
    public AdminSearchContentOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminSearchContentOpResponse response = new AdminSearchContentOpResponse();
