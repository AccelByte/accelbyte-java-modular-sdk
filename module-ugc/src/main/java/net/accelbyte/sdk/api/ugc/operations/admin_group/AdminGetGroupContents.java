...
public class AdminGetGroupContents extends Operation {
    ...
    */
    ...
    public AdminGetGroupContentsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetGroupContentsOpResponse response = new AdminGetGroupContentsOpResponse();
