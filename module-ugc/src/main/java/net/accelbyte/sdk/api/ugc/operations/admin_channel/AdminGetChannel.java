...
import net.accelbyte.sdk.api.ugc.operation_responses.admin_channel.AdminGetChannelOpResponse;
...
public class AdminGetChannel extends Operation {
    ...
    */
    ...
    public AdminGetChannelOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetChannelOpResponse response = new AdminGetChannelOpResponse();
