...
public class AdminStagingContent {
   ...
   */
  public AdminListStagingContentsOpResponse adminListStagingContents(AdminListStagingContents input)
      throws Exception {
   ...
   */
  public AdminGetStagingContentByIDOpResponse adminGetStagingContentByID(
      AdminGetStagingContentByID input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminApproveStagingContentOpResponse adminApproveStagingContent(
      AdminApproveStagingContent input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminListUserStagingContentsOpResponse adminListUserStagingContents(
