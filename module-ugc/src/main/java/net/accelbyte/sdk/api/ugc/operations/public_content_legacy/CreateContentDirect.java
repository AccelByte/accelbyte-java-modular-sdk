...
public class CreateContentDirect extends Operation {
    ...
    */
    ...
    public CreateContentDirectOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreateContentDirectOpResponse response = new CreateContentDirectOpResponse();
