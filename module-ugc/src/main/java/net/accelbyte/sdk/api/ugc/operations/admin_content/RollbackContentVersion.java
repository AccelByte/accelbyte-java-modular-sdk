...
public class RollbackContentVersion extends Operation {
     ...
     */
    private String path = "/ugc/v1/admin/namespaces/{namespace}/contents/{contentId}/rollback/{versionId}";
    ...
    */
    ...
    public RollbackContentVersionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RollbackContentVersionOpResponse response = new RollbackContentVersionOpResponse();
