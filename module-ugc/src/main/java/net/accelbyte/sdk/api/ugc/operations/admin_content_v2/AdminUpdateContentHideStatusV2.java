...
public class AdminUpdateContentHideStatusV2 extends Operation {
     ...
     */
    private String path = "/ugc/v2/admin/namespaces/{namespace}/users/{userId}/contents/{contentId}/hide";
    ...
    */
    ...
    public AdminUpdateContentHideStatusV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateContentHideStatusV2OpResponse response = new AdminUpdateContentHideStatusV2OpResponse();
