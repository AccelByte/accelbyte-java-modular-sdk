...
public class ListUserStagingContents extends Operation {
    ...
    */
    ...
    public ListUserStagingContentsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ListUserStagingContentsOpResponse response = new ListUserStagingContentsOpResponse();
