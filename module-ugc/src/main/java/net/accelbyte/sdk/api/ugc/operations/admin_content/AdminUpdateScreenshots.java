...
public class AdminUpdateScreenshots extends Operation {
    ...
    */
    ...
    public AdminUpdateScreenshotsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateScreenshotsOpResponse response = new AdminUpdateScreenshotsOpResponse();
