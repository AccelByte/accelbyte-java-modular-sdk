...
@Getter
@Setter
public class AdminUpdateContentS3OpResponse extends ApiResponseWithData<ModelsCreateContentResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.ugc.operations.admin_content.AdminUpdateContentS3";
    }
}