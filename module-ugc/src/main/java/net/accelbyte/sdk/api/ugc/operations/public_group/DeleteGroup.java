...
public class DeleteGroup extends Operation {
    ...
    */
    ...
    public DeleteGroupOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteGroupOpResponse response = new DeleteGroupOpResponse();
