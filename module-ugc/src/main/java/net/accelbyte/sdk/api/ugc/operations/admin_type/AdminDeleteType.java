...
public class AdminDeleteType extends Operation {
  ...
  @Deprecated
  public AdminDeleteType(String customBasePath, String namespace, String typeId) {
  ...
  public AdminDeleteTypeOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final AdminDeleteTypeOpResponse response = new AdminDeleteTypeOpResponse();
