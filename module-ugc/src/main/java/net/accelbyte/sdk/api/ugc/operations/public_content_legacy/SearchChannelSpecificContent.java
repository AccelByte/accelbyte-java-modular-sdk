...
public class SearchChannelSpecificContent extends Operation {
    ...
    */
    ...
    public SearchChannelSpecificContentOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SearchChannelSpecificContentOpResponse response = new SearchChannelSpecificContentOpResponse();
