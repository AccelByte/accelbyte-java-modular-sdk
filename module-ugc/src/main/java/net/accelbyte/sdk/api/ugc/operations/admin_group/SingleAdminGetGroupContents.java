...
public class SingleAdminGetGroupContents extends Operation {
  ...
  public SingleAdminGetGroupContentsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final SingleAdminGetGroupContentsOpResponse response =
        new SingleAdminGetGroupContentsOpResponse();
