...
public class PublicLikeV2 {
   ...
   */
  public PublicListContentLikeV2OpResponse publicListContentLikeV2(PublicListContentLikeV2 input)
      throws Exception {
   ...
   */
  public UpdateContentLikeStatusV2OpResponse updateContentLikeStatusV2(
      UpdateContentLikeStatusV2 input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
