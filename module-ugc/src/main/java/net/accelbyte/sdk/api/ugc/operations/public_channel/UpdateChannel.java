...
import net.accelbyte.sdk.api.ugc.operation_responses.public_channel.UpdateChannelOpResponse;
...
public class UpdateChannel extends Operation {
    ...
    */
    ...
    public UpdateChannelOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateChannelOpResponse response = new UpdateChannelOpResponse();
