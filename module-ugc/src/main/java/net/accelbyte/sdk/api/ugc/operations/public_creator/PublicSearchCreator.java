...
import net.accelbyte.sdk.api.ugc.operation_responses.public_creator.PublicSearchCreatorOpResponse;
...
public class PublicSearchCreator extends Operation {
    ...
    */
    ...
    public PublicSearchCreatorOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicSearchCreatorOpResponse response = new PublicSearchCreatorOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsPaginatedCreatorOverviewResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
