...
import net.accelbyte.sdk.api.ugc.operation_responses.admin_tag.*;
...
public class AdminTag {
   ...
   * @see AdminGetTag
   */
  public AdminGetTagOpResponse adminGetTag(AdminGetTag input) throws Exception {
   ...
   * @see AdminUpdateTag
   */
  public AdminUpdateTagOpResponse adminUpdateTag(AdminUpdateTag input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
