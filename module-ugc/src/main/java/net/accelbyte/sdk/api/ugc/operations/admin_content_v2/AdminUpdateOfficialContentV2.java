...
public class AdminUpdateOfficialContentV2 extends Operation {
     ...
     */
    private String path = "/ugc/v2/admin/namespaces/{namespace}/channels/{channelId}/contents/{contentId}";
    ...
    */
    ...
    public AdminUpdateOfficialContentV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateOfficialContentV2OpResponse response = new AdminUpdateOfficialContentV2OpResponse();
