...
public class AdminGenerateUserContentUploadURLV2 extends Operation {
     ...
     */
    private String path = "/ugc/v2/admin/namespaces/{namespace}/users/{userId}/channels/{channelId}/contents/{contentId}/uploadUrl";
    ...
    */
    ...
    public AdminGenerateUserContentUploadURLV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGenerateUserContentUploadURLV2OpResponse response = new AdminGenerateUserContentUploadURLV2OpResponse();
