...
public class AdminUpdateUserContentFileLocation extends Operation {
     ...
     */
    private String path = "/ugc/v2/admin/namespaces/{namespace}/users/{userId}/channels/{channelId}/contents/{contentId}/fileLocation";
    ...
    */
    ...
    public AdminUpdateUserContentFileLocationOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateUserContentFileLocationOpResponse response = new AdminUpdateUserContentFileLocationOpResponse();
