...
public class AdminUpdateUserContentFileLocation extends Operation {
  ...
  public AdminUpdateUserContentFileLocationOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminUpdateUserContentFileLocationOpResponse response =
        new AdminUpdateUserContentFileLocationOpResponse();
