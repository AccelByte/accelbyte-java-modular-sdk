...
import net.accelbyte.sdk.api.ugc.operation_responses.admin_channel.SingleAdminUpdateChannelOpResponse;
...
public class SingleAdminUpdateChannel extends Operation {
    ...
    */
    ...
    public SingleAdminUpdateChannelOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SingleAdminUpdateChannelOpResponse response = new SingleAdminUpdateChannelOpResponse();
