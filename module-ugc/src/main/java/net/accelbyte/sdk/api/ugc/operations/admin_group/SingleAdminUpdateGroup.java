...
public class SingleAdminUpdateGroup extends Operation {
    ...
    */
    ...
    public SingleAdminUpdateGroupOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SingleAdminUpdateGroupOpResponse response = new SingleAdminUpdateGroupOpResponse();
