...
public class SingleAdminGetContent extends Operation {
    ...
    */
    ...
    public SingleAdminGetContentOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SingleAdminGetContentOpResponse response = new SingleAdminGetContentOpResponse();
