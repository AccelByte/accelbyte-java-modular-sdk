...
import net.accelbyte.sdk.api.ugc.operation_responses.public_like_legacy.UpdateContentLikeStatusOpResponse;
...
public class UpdateContentLikeStatus extends Operation {
    ...
    */
    ...
    public UpdateContentLikeStatusOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateContentLikeStatusOpResponse response = new UpdateContentLikeStatusOpResponse();
