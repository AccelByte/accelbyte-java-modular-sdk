...
public class AdminDeleteContentByShareCodeV2 extends Operation {
     ...
     */
    private String path = "/ugc/v2/admin/namespaces/{namespace}/users/{userId}/channels/{channelId}/contents/sharecodes/{shareCode}";
    ...
    */
    ...
    public AdminDeleteContentByShareCodeV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminDeleteContentByShareCodeV2OpResponse response = new AdminDeleteContentByShareCodeV2OpResponse();
