...
public class ModelsContentDownloadResponseV2 extends Model {
    ...
    @JsonIgnore
    public ModelsContentDownloadResponseV2 createFromJson(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, this.getClass());
    }

    @JsonIgnore
    public List<ModelsContentDownloadResponseV2> createFromJsonList(String json) throws JsonProcessingException {
