...
import net.accelbyte.sdk.api.ugc.operation_responses.public_content_v2.UploadContentScreenshotV2OpResponse;
...
public class UploadContentScreenshotV2 extends Operation {
    ...
    */
    ...
    public UploadContentScreenshotV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UploadContentScreenshotV2OpResponse response = new UploadContentScreenshotV2OpResponse();
