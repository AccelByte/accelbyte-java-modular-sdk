...
public class AdminUpdateContentS3ByShareCode extends Operation {
  ...
  public AdminUpdateContentS3ByShareCodeOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminUpdateContentS3ByShareCodeOpResponse response =
        new AdminUpdateContentS3ByShareCodeOpResponse();
