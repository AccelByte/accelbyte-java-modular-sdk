...
public class AdminUpdateContentS3ByShareCode extends Operation {
     ...
     */
    private String path = "/ugc/v1/admin/namespaces/{namespace}/users/{userId}/channels/{channelId}/contents/s3/sharecodes/{shareCode}";
    ...
    */
    ...
    public AdminUpdateContentS3ByShareCodeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateContentS3ByShareCodeOpResponse response = new AdminUpdateContentS3ByShareCodeOpResponse();
