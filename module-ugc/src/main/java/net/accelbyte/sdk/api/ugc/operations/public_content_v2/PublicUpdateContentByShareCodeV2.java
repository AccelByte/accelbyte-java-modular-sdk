...
import net.accelbyte.sdk.api.ugc.operation_responses.public_content_v2.PublicUpdateContentByShareCodeV2OpResponse;
...
public class PublicUpdateContentByShareCodeV2 extends Operation {
     ...
     */
    private String path = "/ugc/v2/public/namespaces/{namespace}/users/{userId}/channels/{channelId}/contents/s3/sharecodes/{shareCode}";
    ...
    */
    ...
    public PublicUpdateContentByShareCodeV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicUpdateContentByShareCodeV2OpResponse response = new PublicUpdateContentByShareCodeV2OpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsCreateContentResponseV2().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
