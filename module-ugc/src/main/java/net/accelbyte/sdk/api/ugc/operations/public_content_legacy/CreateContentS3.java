...
public class CreateContentS3 extends Operation {
    ...
    */
    ...
    public CreateContentS3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreateContentS3OpResponse response = new CreateContentS3OpResponse();
