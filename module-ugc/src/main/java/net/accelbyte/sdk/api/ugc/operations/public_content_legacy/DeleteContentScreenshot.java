...
public class DeleteContentScreenshot extends Operation {
    ...
    */
    ...
    public DeleteContentScreenshotOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteContentScreenshotOpResponse response = new DeleteContentScreenshotOpResponse();
