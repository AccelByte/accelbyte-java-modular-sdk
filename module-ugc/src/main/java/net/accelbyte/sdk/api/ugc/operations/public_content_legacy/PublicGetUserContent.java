...
public class PublicGetUserContent extends Operation {
    ...
    */
    ...
    public PublicGetUserContentOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetUserContentOpResponse response = new PublicGetUserContentOpResponse();
