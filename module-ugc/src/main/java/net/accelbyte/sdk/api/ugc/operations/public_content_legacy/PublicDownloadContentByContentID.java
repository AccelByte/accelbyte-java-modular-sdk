...
public class PublicDownloadContentByContentID extends Operation {
    ...
    */
    ...
    public PublicDownloadContentByContentIDOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicDownloadContentByContentIDOpResponse response = new PublicDownloadContentByContentIDOpResponse();
