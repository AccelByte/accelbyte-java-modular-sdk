...
public class PublicStagingContent {
   ...
   */
  public ListUserStagingContentsOpResponse listUserStagingContents(ListUserStagingContents input)
      throws Exception {
   ...
   */
  public GetUserStagingContentByIDOpResponse getUserStagingContentByID(
      GetUserStagingContentByID input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public UpdateStagingContentOpResponse updateStagingContent(UpdateStagingContent input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public DeleteUserStagingContentByIDOpResponse deleteUserStagingContentByID(
      DeleteUserStagingContentByID input) throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
