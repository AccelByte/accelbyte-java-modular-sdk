...
public class DeleteContent extends Operation {
    ...
    */
    ...
    public DeleteContentOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteContentOpResponse response = new DeleteContentOpResponse();
