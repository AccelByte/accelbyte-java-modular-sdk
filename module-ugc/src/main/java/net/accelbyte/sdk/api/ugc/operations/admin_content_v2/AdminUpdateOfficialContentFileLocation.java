...
public class AdminUpdateOfficialContentFileLocation extends Operation {
     ...
     */
    private String path = "/ugc/v2/admin/namespaces/{namespace}/channels/{channelId}/contents/{contentId}/fileLocation";
    ...
    */
    ...
    public AdminUpdateOfficialContentFileLocationOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateOfficialContentFileLocationOpResponse response = new AdminUpdateOfficialContentFileLocationOpResponse();
