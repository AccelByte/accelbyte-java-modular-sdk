...
public class AdminGetContent extends Operation {
    ...
    */
    ...
    public AdminGetContentOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetContentOpResponse response = new AdminGetContentOpResponse();
