...
@Getter
@Setter
public class AdminUpdateTagOpResponse extends ApiResponseWithData<ModelsCreateTagResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.ugc.operations.admin_tag.AdminUpdateTag";
    }
}