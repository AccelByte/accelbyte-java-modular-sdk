...
public class UpdateGroup extends Operation {
    ...
    */
    ...
    public UpdateGroupOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateGroupOpResponse response = new UpdateGroupOpResponse();
