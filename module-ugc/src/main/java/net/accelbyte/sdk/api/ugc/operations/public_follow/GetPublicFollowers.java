...
public class GetPublicFollowers extends Operation {
    ...
    */
    ...
    public GetPublicFollowersOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetPublicFollowersOpResponse response = new GetPublicFollowersOpResponse();
