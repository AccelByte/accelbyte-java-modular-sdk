...
public class AdminListContentV2 extends Operation {
    ...
    */
    ...
    public AdminListContentV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminListContentV2OpResponse response = new AdminListContentV2OpResponse();
