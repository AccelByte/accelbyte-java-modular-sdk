...
public class AdminHideUserContent extends Operation {
    ...
    */
    ...
    public AdminHideUserContentOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminHideUserContentOpResponse response = new AdminHideUserContentOpResponse();
