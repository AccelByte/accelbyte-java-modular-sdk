...
public class PublicGetGroupContentsV2 extends Operation {
    ...
    */
    ...
    public PublicGetGroupContentsV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicGetGroupContentsV2OpResponse response = new PublicGetGroupContentsV2OpResponse();
