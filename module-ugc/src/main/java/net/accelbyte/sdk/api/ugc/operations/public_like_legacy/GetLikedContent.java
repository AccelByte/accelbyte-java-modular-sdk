...
import net.accelbyte.sdk.api.ugc.operation_responses.public_like_legacy.GetLikedContentOpResponse;
...
public class GetLikedContent extends Operation {
    ...
    */
    ...
    public GetLikedContentOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetLikedContentOpResponse response = new GetLikedContentOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsPaginatedContentDownloadResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
