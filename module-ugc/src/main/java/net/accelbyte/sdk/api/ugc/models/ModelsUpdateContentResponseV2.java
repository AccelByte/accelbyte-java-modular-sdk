...
public class ModelsUpdateContentResponseV2 extends Model {
    ...
    @JsonIgnore
    public List<ModelsUpdateContentResponseV2> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelsUpdateContentResponseV2>>() {});
    }
    ...
    public static class ModelsUpdateContentResponseV2Builder {
        ...
        public ModelsUpdateContentResponseV2Builder contentStatusFromEnum(final ContentStatus contentStatus) {
            this.contentStatus = contentStatus.toString();
            return this;
        }
    }
