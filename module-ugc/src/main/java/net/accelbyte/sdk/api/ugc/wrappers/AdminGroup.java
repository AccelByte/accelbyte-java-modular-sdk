...
public class AdminGroup {
   ...
   */
  public SingleAdminGetAllGroupsOpResponse singleAdminGetAllGroups(SingleAdminGetAllGroups input)
      throws Exception {
   ...
   */
  public SingleAdminGetGroupOpResponse singleAdminGetGroup(SingleAdminGetGroup input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public SingleAdminUpdateGroupOpResponse singleAdminUpdateGroup(SingleAdminUpdateGroup input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public SingleAdminDeleteGroupOpResponse singleAdminDeleteGroup(SingleAdminDeleteGroup input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public SingleAdminGetGroupContentsOpResponse singleAdminGetGroupContents(
   ...
   */
  public AdminGetGroupContentsOpResponse adminGetGroupContents(AdminGetGroupContents input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public AdminGetOfficialGroupContentsV2OpResponse adminGetOfficialGroupContentsV2(
   ...
   */
  public AdminGetUserGroupContentsV2OpResponse adminGetUserGroupContentsV2(
