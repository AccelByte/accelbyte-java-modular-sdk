...
public class UpdateContentS3 extends Operation {
    ...
    */
    ...
    public UpdateContentS3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateContentS3OpResponse response = new UpdateContentS3OpResponse();
