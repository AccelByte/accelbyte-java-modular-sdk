...
import net.accelbyte.sdk.api.ugc.operation_responses.public_like_legacy.*;
...
public class PublicLikeLegacy {
     ...
     * @see GetLikedContent
     */
    public GetLikedContentOpResponse getLikedContent(GetLikedContent input) throws Exception {
     ...
     */
    public UpdateContentLikeStatusOpResponse updateContentLikeStatus(UpdateContentLikeStatus input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
