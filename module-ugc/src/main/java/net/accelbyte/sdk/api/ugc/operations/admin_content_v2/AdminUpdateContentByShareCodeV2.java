...
public class AdminUpdateContentByShareCodeV2 extends Operation {
     ...
     */
    private String path = "/ugc/v2/admin/namespaces/{namespace}/users/{userId}/channels/{channelId}/contents/s3/sharecodes/{shareCode}";
    ...
    */
    ...
    public AdminUpdateContentByShareCodeV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateContentByShareCodeV2OpResponse response = new AdminUpdateContentByShareCodeV2OpResponse();
