...
import net.accelbyte.sdk.api.ugc.operation_responses.admin_staging_content.AdminApproveStagingContentOpResponse;
...
public class AdminApproveStagingContent extends Operation {
    ...
    */
    ...
    public AdminApproveStagingContentOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminApproveStagingContentOpResponse response = new AdminApproveStagingContentOpResponse();
