...
public class AdminUpdateContentDirect extends Operation {
    ...
    */
    ...
    public AdminUpdateContentDirectOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateContentDirectOpResponse response = new AdminUpdateContentDirectOpResponse();
