...
public class AdminDownloadContentPreview extends Operation {
  ...
  public AdminDownloadContentPreviewOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminDownloadContentPreviewOpResponse response =
        new AdminDownloadContentPreviewOpResponse();
