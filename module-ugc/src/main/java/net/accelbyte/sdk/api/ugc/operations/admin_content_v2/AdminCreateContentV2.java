...
public class AdminCreateContentV2 extends Operation {
    ...
    */
    ...
    public AdminCreateContentV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminCreateContentV2OpResponse response = new AdminCreateContentV2OpResponse();
