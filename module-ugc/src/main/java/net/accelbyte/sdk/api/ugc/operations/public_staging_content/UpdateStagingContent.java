...
public class UpdateStagingContent extends Operation {
    ...
    */
    ...
    public UpdateStagingContentOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateStagingContentOpResponse response = new UpdateStagingContentOpResponse();
