...
@Getter
@Setter
public class AdminUpdateContentByShareCodeV2OpResponse extends ApiResponseWithData<ModelsCreateContentResponseV2> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.ugc.operations.admin_content_v2.AdminUpdateContentByShareCodeV2";
    }
}