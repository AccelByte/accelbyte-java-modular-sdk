...
import net.accelbyte.sdk.api.ugc.operation_responses.admin_channel.AdminUpdateChannelOpResponse;
...
public class AdminUpdateChannel extends Operation {
    ...
    */
    ...
    public AdminUpdateChannelOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateChannelOpResponse response = new AdminUpdateChannelOpResponse();
