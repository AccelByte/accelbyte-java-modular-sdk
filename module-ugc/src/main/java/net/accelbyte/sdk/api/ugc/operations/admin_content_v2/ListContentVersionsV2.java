...
public class ListContentVersionsV2 extends Operation {
    ...
    */
    ...
    public ListContentVersionsV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ListContentVersionsV2OpResponse response = new ListContentVersionsV2OpResponse();
