...
public class AdminGetContentBulkByShareCodes extends Operation {
  ...
  public AdminGetContentBulkByShareCodesOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetContentBulkByShareCodesOpResponse response =
        new AdminGetContentBulkByShareCodesOpResponse();
