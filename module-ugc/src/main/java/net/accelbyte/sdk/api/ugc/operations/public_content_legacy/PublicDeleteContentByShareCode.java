...
public class PublicDeleteContentByShareCode extends Operation {
     ...
     */
    private String path = "/ugc/v1/public/namespaces/{namespace}/users/{userId}/channels/{channelId}/contents/sharecodes/{shareCode}";
    ...
    */
    ...
    public PublicDeleteContentByShareCodeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicDeleteContentByShareCodeOpResponse response = new PublicDeleteContentByShareCodeOpResponse();
