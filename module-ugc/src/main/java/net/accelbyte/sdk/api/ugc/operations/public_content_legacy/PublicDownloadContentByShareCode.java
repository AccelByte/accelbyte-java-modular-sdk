...
public class PublicDownloadContentByShareCode extends Operation {
    ...
    */
    ...
    public PublicDownloadContentByShareCodeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicDownloadContentByShareCodeOpResponse response = new PublicDownloadContentByShareCodeOpResponse();
