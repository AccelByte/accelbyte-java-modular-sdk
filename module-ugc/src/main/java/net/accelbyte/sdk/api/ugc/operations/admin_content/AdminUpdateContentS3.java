...
public class AdminUpdateContentS3 extends Operation {
    ...
    */
    ...
    public AdminUpdateContentS3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminUpdateContentS3OpResponse response = new AdminUpdateContentS3OpResponse();
