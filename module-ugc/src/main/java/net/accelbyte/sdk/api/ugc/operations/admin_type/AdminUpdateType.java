...
public class AdminUpdateType extends Operation {
  ...
  public AdminUpdateType(
      String customBasePath, String namespace, String typeId, ModelsCreateTypeRequest body) {
  ...
  public AdminUpdateTypeOpResponse parseResponse(int code, String contentType, InputStream payload)
