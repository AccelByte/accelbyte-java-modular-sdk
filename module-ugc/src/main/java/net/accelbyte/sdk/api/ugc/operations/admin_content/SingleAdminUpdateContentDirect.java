...
public class SingleAdminUpdateContentDirect extends Operation {
  ...
  public SingleAdminUpdateContentDirectOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final SingleAdminUpdateContentDirectOpResponse response =
        new SingleAdminUpdateContentDirectOpResponse();
