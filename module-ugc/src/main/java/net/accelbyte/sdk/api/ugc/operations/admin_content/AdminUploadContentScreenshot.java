...
public class AdminUploadContentScreenshot extends Operation {
  ...
  public AdminUploadContentScreenshotOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminUploadContentScreenshotOpResponse response =
        new AdminUploadContentScreenshotOpResponse();
