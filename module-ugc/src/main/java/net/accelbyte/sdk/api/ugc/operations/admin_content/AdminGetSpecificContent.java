...
public class AdminGetSpecificContent extends Operation {
    ...
    */
    ...
    public AdminGetSpecificContentOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetSpecificContentOpResponse response = new AdminGetSpecificContentOpResponse();
