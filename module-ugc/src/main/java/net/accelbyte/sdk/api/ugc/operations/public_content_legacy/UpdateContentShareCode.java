...
public class UpdateContentShareCode extends Operation {
     ...
     */
    private String path = "/ugc/v1/public/namespaces/{namespace}/users/{userId}/channels/{channelId}/contents/{contentId}/sharecode";
    ...
    */
    ...
    public UpdateContentShareCodeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateContentShareCodeOpResponse response = new UpdateContentShareCodeOpResponse();
