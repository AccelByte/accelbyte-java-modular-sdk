...
public class AdminCreateType extends Operation {
  ...
  @Deprecated
  public AdminCreateType(String customBasePath, String namespace, ModelsCreateTypeRequest body) {
  ...
  public AdminCreateTypeOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final AdminCreateTypeOpResponse response = new AdminCreateTypeOpResponse();
