...
public class DeleteContentByShareCode extends Operation {
    ...
    */
    ...
    public DeleteContentByShareCodeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteContentByShareCodeOpResponse response = new DeleteContentByShareCodeOpResponse();
