...
public class UgcErrors
{
    ...
    public static ApiError error770100 = new ApiError("770100", "Malformed request/Invalid request body/channel do not exist");
    public static ApiError error770102 = new ApiError("770102", "Unable to check user ban status/Unable to save ugc content: unable to get channel");
    public static ApiError error770103 = new ApiError("770103", "Unable to save ugc content: shareCode exceed the limit");
    public static ApiError error770104 = new ApiError("770104", "User has been banned to create content");
    public static ApiError error770105 = new ApiError("770105", "Unable to save ugc content: failed generate upload URL");
    public static ApiError error770106 = new ApiError("770106", "channel doesn't exist");
    public static ApiError error770107 = new ApiError("770107", "Unable to update ugc content: invalid shareCode format");
    ...
    public static ApiError error770301 = new ApiError("770301", "Unable to get ugc content/Unable to get creator");
    ...
    public static ApiError error770503 = new ApiError("770503", "Invalid channel {ID}: should uuid without hypen");
    ...
    public static ApiError error770800 = new ApiError("770800", "invalid paging parameter/max allowed number of tags is {maxTags}/invalid official parameter/invalid ishidden parameter");
    public static ApiError error770801 = new ApiError("770801", "Unable to get ugc content: database/Unable to get creator");
    ...
    public static ApiError error770805 = new ApiError("770805", "Unable to get ugc content: database error");
    public static ApiError error770900 = new ApiError("770900", "invalid paging parameter");
    public static ApiError error770901 = new ApiError("770901", "Unable to get ugc content: database error/Unable to get creator");
    public static ApiError error770903 = new ApiError("770903", "Failed generate download URL");
    public static ApiError error771000 = new ApiError("771000", "Malformed request/Content not found/Unable to update like status: content not found");
    public static ApiError error771001 = new ApiError("771001", "unable to like content/Unable to update like status: database error");
    public static ApiError error771003 = new ApiError("771003", "Unable to like content: too many request");
    public static ApiError error771004 = new ApiError("771004", "invalid paging parameter");
    public static ApiError error771006 = new ApiError("771006", "unable to get list of content like: database error");
    public static ApiError error771100 = new ApiError("771100", "unable to parse isofficial param");
    public static ApiError error771101 = new ApiError("771101", "Unable to get ugc content: database error");
    ...
    public static ApiError error771201 = new ApiError("771201", "Unable to update follow status: database error");
    public static ApiError error771300 = new ApiError("771300", "Unable to get creators: database error");
    public static ApiError error771303 = new ApiError("771303", "Unable to get creators: database error");
    public static ApiError error771304 = new ApiError("771304", "invalid paging parameter");
    public static ApiError error771310 = new ApiError("771310", "Unable to get ugc content: database error");
    public static ApiError error771311 = new ApiError("771311", "invalid paging parameter");
    public static ApiError error771401 = new ApiError("771401", "Malformed request/Invalid request body");
    ...
    public static ApiError error771701 = new ApiError("771701", "Malformed request/Invalid request body");
    ...
    public static ApiError error771901 = new ApiError("771901", "Malformed request/Invalid request body");
    ...
    public static ApiError error772101 = new ApiError("772101", "Malformed request/Invalid request body");
    public static ApiError error772102 = new ApiError("772102", "Unable to create group");
    public static ApiError error772201 = new ApiError("772201", "Malformed request/Invalid request body");
    ...
    public static ApiError error772602 = new ApiError("772602", "Unable to check user ban status/Unable to get updated ugc content");
    public static ApiError error772603 = new ApiError("772603", "Content not found");
    public static ApiError error772604 = new ApiError("772604", "User has been banned to update content");
    public static ApiError error772605 = new ApiError("772605", "Unable to save ugc content: failed generate upload URL");
    public static ApiError error772606 = new ApiError("772606", "Share code already used");
    public static ApiError error772607 = new ApiError("772607", "Unable to update ugc content: invalid shareCode format");
    public static ApiError error772701 = new ApiError("772701", "Unable to delete content/Unable to update user liked count/Unable to delete like state/Unable to delete like state");
    public static ApiError error772702 = new ApiError("772702", "Content not found");
    public static ApiError error772801 = new ApiError("772801", "Malformed request/Invalid request body");
    ...
    public static ApiError error772902 = new ApiError("772902", "Unable to add content download: database error");
    public static ApiError error772903 = new ApiError("772903", "Unable to add content download: content not found");
    public static ApiError error772904 = new ApiError("772904", "Unable to list content downloader: database error");
    public static ApiError error772906 = new ApiError("772906", "Unable to add content download: too many request");
    ...
    public static ApiError error773102 = new ApiError("773102", "Unable to get ugc content: database error");
    ...
    public static ApiError error773201 = new ApiError("773201", "Unable to get ugc content/Unable to get creator/Unable to get included group");
    ...
    public static ApiError error773601 = new ApiError("773601", "Unable to get all user contents/Unable to delete user states");
    public static ApiError error773602 = new ApiError("773602", "user states are not found: content not found");
    ...
    public static ApiError error773801 = new ApiError("773801", "Invalid request body/Malformed request");
    public static ApiError error773802 = new ApiError("773802", "Unable to update hide status: database error");
    public static ApiError error773803 = new ApiError("773803", "Unable to update hide status: content not found");
    public static ApiError error773804 = new ApiError("773804", "Unable to save ugc content: failed generate upload URL");
    public static ApiError error773805 = new ApiError("773805", "Unable to save ugc content preview: failed generate upload URL");
    public static ApiError error773900 = new ApiError("773900", "Malformed request/Invalid request body");
    public static ApiError error773901 = new ApiError("773901", "Unable to get ugc content: database/Unable to get creator");
    public static ApiError error773902 = new ApiError("773902", "Failed generate download URL");
    public static ApiError error774001 = new ApiError("774001", "unable to read response body/unable to update file location");
    public static ApiError error774002 = new ApiError("774002", "unable to update content file location: content not found");
    public static ApiError error774003 = new ApiError("774003", "unable to update content file location");
    ...
    public static ApiError error774103 = new ApiError("774103", "unable to get ugc content/content cannot be restored using the current content version");
    ...
    public static ApiError error774408 = new ApiError("774408", "nable to save ugc content: shareCode exceed the limit");
    public static ApiError error774411 = new ApiError("774411", "Invalid request body");
    public static ApiError error774412 = new ApiError("774412", "user has been banned to update content");
