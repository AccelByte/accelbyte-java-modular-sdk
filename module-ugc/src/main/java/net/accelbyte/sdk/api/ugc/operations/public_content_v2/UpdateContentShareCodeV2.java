...
import net.accelbyte.sdk.api.ugc.operation_responses.public_content_v2.UpdateContentShareCodeV2OpResponse;
...
public class UpdateContentShareCodeV2 extends Operation {
     ...
     */
    private String path = "/ugc/v2/public/namespaces/{namespace}/users/{userId}/channels/{channelId}/contents/{contentId}/sharecode";
    ...
    */
    ...
    public UpdateContentShareCodeV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateContentShareCodeV2OpResponse response = new UpdateContentShareCodeV2OpResponse();
