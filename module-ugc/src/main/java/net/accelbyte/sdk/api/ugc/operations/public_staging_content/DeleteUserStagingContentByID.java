...
public class DeleteUserStagingContentByID extends Operation {
  ...
  public DeleteUserStagingContentByIDOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final DeleteUserStagingContentByIDOpResponse response =
        new DeleteUserStagingContentByIDOpResponse();
