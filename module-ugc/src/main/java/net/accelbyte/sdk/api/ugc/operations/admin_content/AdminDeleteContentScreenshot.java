...
public class AdminDeleteContentScreenshot extends Operation {
  ...
  public AdminDeleteContentScreenshotOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminDeleteContentScreenshotOpResponse response =
        new AdminDeleteContentScreenshotOpResponse();
