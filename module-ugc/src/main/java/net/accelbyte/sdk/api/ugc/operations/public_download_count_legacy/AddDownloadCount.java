...
public class AddDownloadCount extends Operation {
  ...
  @Deprecated
  public AddDownloadCount(String customBasePath, String contentId, String namespace) {
  ...
  public AddDownloadCountOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final AddDownloadCountOpResponse response = new AddDownloadCountOpResponse();
