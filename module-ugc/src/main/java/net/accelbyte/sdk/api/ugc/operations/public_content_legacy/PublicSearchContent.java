...
public class PublicSearchContent extends Operation {
    ...
    */
    ...
    public PublicSearchContentOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicSearchContentOpResponse response = new PublicSearchContentOpResponse();
