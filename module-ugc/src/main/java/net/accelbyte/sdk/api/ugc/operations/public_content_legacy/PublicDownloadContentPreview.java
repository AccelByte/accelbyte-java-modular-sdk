...
public class PublicDownloadContentPreview extends Operation {
  ...
  @Deprecated
  public PublicDownloadContentPreview(String customBasePath, String contentId, String namespace) {
  ...
  public PublicDownloadContentPreviewOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicDownloadContentPreviewOpResponse response =
        new PublicDownloadContentPreviewOpResponse();
