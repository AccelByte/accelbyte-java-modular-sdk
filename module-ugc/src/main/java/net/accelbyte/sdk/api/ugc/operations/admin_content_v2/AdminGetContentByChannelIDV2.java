...
public class AdminGetContentByChannelIDV2 extends Operation {
    ...
    */
    ...
    public AdminGetContentByChannelIDV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetContentByChannelIDV2OpResponse response = new AdminGetContentByChannelIDV2OpResponse();
