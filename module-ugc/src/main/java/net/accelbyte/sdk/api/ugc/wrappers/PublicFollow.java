...
public class PublicFollow {
     ...
     */
    public GetFollowedContentOpResponse getFollowedContent(GetFollowedContent input) throws Exception {
     ...
     */
    public UpdateUserFollowStatusOpResponse updateUserFollowStatus(UpdateUserFollowStatus input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public GetPublicFollowersOpResponse getPublicFollowers(GetPublicFollowers input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public GetPublicFollowingOpResponse getPublicFollowing(GetPublicFollowing input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
