...
import net.accelbyte.sdk.api.ugc.operation_responses.public_content_v2.PublicUpdateContentFileLocationOpResponse;
...
public class PublicUpdateContentFileLocation extends Operation {
     ...
     */
    private String path = "/ugc/v2/public/namespaces/{namespace}/users/{userId}/channels/{channelId}/contents/{contentId}/fileLocation";
    ...
    */
    ...
    public PublicUpdateContentFileLocationOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicUpdateContentFileLocationOpResponse response = new PublicUpdateContentFileLocationOpResponse();
