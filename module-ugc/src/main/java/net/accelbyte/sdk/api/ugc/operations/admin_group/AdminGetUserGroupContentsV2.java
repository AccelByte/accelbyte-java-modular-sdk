...
public class AdminGetUserGroupContentsV2 extends Operation {
  ...
  public AdminGetUserGroupContentsV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetUserGroupContentsV2OpResponse response =
        new AdminGetUserGroupContentsV2OpResponse();
