...
public class AdminGetUserGroupContentsV2 extends Operation {
     ...
     */
    private String path = "/ugc/v2/admin/namespaces/{namespace}/users/{userId}/groups/{groupId}/contents";
    ...
    */
    ...
    public AdminGetUserGroupContentsV2OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetUserGroupContentsV2OpResponse response = new AdminGetUserGroupContentsV2OpResponse();
