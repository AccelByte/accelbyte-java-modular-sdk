...
public class AdminSearchChannelSpecificContent extends Operation {
  ...
  public AdminSearchChannelSpecificContentOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminSearchChannelSpecificContentOpResponse response =
        new AdminSearchChannelSpecificContentOpResponse();
