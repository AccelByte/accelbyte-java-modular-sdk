...
public class AdminGetUserContentByShareCode extends Operation {
  ...
  @Deprecated
  public AdminGetUserContentByShareCode(String customBasePath, String namespace, String shareCode) {
  ...
  public AdminGetUserContentByShareCodeOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final AdminGetUserContentByShareCodeOpResponse response =
        new AdminGetUserContentByShareCodeOpResponse();
