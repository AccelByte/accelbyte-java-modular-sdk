...
public class AdminGetUserContentByShareCode extends Operation {
    ...
    */
    ...
    public AdminGetUserContentByShareCodeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminGetUserContentByShareCodeOpResponse response = new AdminGetUserContentByShareCodeOpResponse();
