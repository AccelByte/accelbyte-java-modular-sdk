...
public class ModelsCreateContentResponseV2 extends Model {
    ...
    @JsonIgnore
    public List<ModelsCreateContentResponseV2> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelsCreateContentResponseV2>>() {});
    }
    ...
    public static class ModelsCreateContentResponseV2Builder {
        ...
        public ModelsCreateContentResponseV2Builder contentStatusFromEnum(final ContentStatus contentStatus) {
            this.contentStatus = contentStatus.toString();
            return this;
        }
    }
