...
public class AdminCopyContent extends Operation {
    ...
    */
    ...
    public AdminCopyContentOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminCopyContentOpResponse response = new AdminCopyContentOpResponse();
