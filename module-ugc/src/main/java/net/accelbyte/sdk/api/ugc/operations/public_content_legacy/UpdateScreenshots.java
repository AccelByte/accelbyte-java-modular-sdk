...
public class UpdateScreenshots extends Operation {
    ...
    */
    ...
    public UpdateScreenshotsOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateScreenshotsOpResponse response = new UpdateScreenshotsOpResponse();
