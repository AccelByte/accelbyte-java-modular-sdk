...
public class PublicUpdateContentByShareCode extends Operation {
     ...
     */
    private String path = "/ugc/v1/public/namespaces/{namespace}/users/{userId}/channels/{channelId}/contents/s3/sharecodes/{shareCode}";
    ...
    */
    ...
    public PublicUpdateContentByShareCodeOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PublicUpdateContentByShareCodeOpResponse response = new PublicUpdateContentByShareCodeOpResponse();
