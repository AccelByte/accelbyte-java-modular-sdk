...
public class PublicUpdateContentByShareCode extends Operation {
  ...
  public PublicUpdateContentByShareCodeOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicUpdateContentByShareCodeOpResponse response =
        new PublicUpdateContentByShareCodeOpResponse();
