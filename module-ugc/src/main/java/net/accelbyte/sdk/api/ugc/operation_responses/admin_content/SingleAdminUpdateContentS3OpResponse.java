...
@Getter
@Setter
public class SingleAdminUpdateContentS3OpResponse extends ApiResponseWithData<ModelsCreateContentResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.ugc.operations.admin_content.SingleAdminUpdateContentS3";
    }
}