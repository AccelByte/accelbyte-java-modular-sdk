...
public class ModelsStagingContentResponse extends Model {
    ...
    @JsonIgnore
    public List<ModelsStagingContentResponse> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelsStagingContentResponse>>() {});
    }
