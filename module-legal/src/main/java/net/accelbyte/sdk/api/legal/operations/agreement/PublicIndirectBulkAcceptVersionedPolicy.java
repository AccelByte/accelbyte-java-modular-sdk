...
import net.accelbyte.sdk.api.legal.operation_responses.agreement.PublicIndirectBulkAcceptVersionedPolicyOpResponse;
...
public class PublicIndirectBulkAcceptVersionedPolicy extends Operation {
  ...
  public PublicIndirectBulkAcceptVersionedPolicyOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicIndirectBulkAcceptVersionedPolicyOpResponse response =
        new PublicIndirectBulkAcceptVersionedPolicyOpResponse();
