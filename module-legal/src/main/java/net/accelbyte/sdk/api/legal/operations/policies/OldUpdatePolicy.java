...
import net.accelbyte.sdk.api.legal.operation_responses.policies.OldUpdatePolicyOpResponse;
...
public class OldUpdatePolicy extends Operation {
  ...
  @Deprecated
  public OldUpdatePolicy(String customBasePath, String policyId, UpdatePolicyRequest body) {
  ...
  public OldUpdatePolicyOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final OldUpdatePolicyOpResponse response = new OldUpdatePolicyOpResponse();
