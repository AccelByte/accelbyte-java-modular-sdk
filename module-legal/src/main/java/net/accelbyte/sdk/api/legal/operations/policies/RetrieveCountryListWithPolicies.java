...
public class RetrieveCountryListWithPolicies extends Operation {
    ...
    */
    ...
    public RetrieveCountryListWithPoliciesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RetrieveCountryListWithPoliciesOpResponse response = new RetrieveCountryListWithPoliciesOpResponse();
