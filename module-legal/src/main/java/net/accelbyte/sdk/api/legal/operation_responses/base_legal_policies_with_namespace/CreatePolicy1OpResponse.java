...
@Getter
@Setter
public class CreatePolicy1OpResponse extends ApiResponseWithData<CreateBasePolicyResponse> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.legal.operations.base_legal_policies_with_namespace.CreatePolicy1";
    }
}