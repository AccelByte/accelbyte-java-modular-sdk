...
import net.accelbyte.sdk.api.legal.operation_responses.policies.RetrieveLatestPoliciesOpResponse;
...
public class RetrieveLatestPolicies extends Operation {
    ...
    */
    ...
    public RetrieveLatestPoliciesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RetrieveLatestPoliciesOpResponse response = new RetrieveLatestPoliciesOpResponse();
