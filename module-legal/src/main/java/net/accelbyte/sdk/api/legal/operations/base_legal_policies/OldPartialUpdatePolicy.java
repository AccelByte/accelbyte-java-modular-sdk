...
import net.accelbyte.sdk.api.legal.operation_responses.base_legal_policies.OldPartialUpdatePolicyOpResponse;
...
public class OldPartialUpdatePolicy extends Operation {
  ...
  public OldPartialUpdatePolicyOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final OldPartialUpdatePolicyOpResponse response = new OldPartialUpdatePolicyOpResponse();
