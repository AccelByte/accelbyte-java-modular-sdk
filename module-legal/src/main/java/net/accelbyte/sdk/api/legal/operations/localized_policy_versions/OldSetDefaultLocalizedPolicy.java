...
import net.accelbyte.sdk.api.legal.operation_responses.localized_policy_versions.OldSetDefaultLocalizedPolicyOpResponse;
...
public class OldSetDefaultLocalizedPolicy extends Operation {
  ...
  @Deprecated
  public OldSetDefaultLocalizedPolicy(String customBasePath, String localizedPolicyVersionId) {
  ...
  public OldSetDefaultLocalizedPolicyOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final OldSetDefaultLocalizedPolicyOpResponse response =
        new OldSetDefaultLocalizedPolicyOpResponse();
