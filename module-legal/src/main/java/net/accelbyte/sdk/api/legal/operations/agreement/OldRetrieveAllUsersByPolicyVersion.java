...
import net.accelbyte.sdk.api.legal.operation_responses.agreement.OldRetrieveAllUsersByPolicyVersionOpResponse;
...
public class OldRetrieveAllUsersByPolicyVersion extends Operation {
  ...
  public OldRetrieveAllUsersByPolicyVersionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final OldRetrieveAllUsersByPolicyVersionOpResponse response =
        new OldRetrieveAllUsersByPolicyVersionOpResponse();
