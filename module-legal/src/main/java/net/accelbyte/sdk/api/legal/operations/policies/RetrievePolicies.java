...
public class RetrievePolicies extends Operation {
  ...
  public RetrievePoliciesOpResponse parseResponse(int code, String contentType, InputStream payload)
    ...
    if (code == 204) {
      ...
      response.setSuccess(true);
      response.setData(
          new ObjectMapper().readValue(json, new TypeReference<List<RetrievePolicyResponse>>() {}));
    }
