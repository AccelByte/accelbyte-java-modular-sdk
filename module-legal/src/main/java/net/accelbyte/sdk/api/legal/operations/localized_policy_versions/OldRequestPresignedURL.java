...
import net.accelbyte.sdk.api.legal.operation_responses.localized_policy_versions.OldRequestPresignedURLOpResponse;
...
public class OldRequestPresignedURL extends Operation {
  ...
  public OldRequestPresignedURLOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final OldRequestPresignedURLOpResponse response = new OldRequestPresignedURLOpResponse();
