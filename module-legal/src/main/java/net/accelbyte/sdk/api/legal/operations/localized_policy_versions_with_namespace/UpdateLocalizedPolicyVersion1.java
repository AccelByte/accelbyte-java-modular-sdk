...
public class UpdateLocalizedPolicyVersion1 extends Operation {
    ...
    */
    ...
    public UpdateLocalizedPolicyVersion1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateLocalizedPolicyVersion1OpResponse response = new UpdateLocalizedPolicyVersion1OpResponse();
