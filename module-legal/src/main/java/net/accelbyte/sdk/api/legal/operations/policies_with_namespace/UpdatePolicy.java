...
import net.accelbyte.sdk.api.legal.operation_responses.policies_with_namespace.UpdatePolicyOpResponse;
...
public class UpdatePolicy extends Operation {
  ...
  @Deprecated
  public UpdatePolicy(
      String customBasePath, String namespace, String policyId, UpdatePolicyRequest body) {
  ...
  public UpdatePolicyOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final UpdatePolicyOpResponse response = new UpdatePolicyOpResponse();
