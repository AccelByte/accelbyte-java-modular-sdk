...
public class UpdateLocalizedPolicyVersion extends Operation {
    ...
    */
    ...
    public UpdateLocalizedPolicyVersionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateLocalizedPolicyVersionOpResponse response = new UpdateLocalizedPolicyVersionOpResponse();
