...
import net.accelbyte.sdk.api.legal.operation_responses.policies_with_namespace.DeletePolicyOpResponse;
...
public class DeletePolicy extends Operation {
  ...
  @Deprecated
  public DeletePolicy(String customBasePath, String namespace, String policyId) {
  ...
  public DeletePolicyOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final DeletePolicyOpResponse response = new DeletePolicyOpResponse();
