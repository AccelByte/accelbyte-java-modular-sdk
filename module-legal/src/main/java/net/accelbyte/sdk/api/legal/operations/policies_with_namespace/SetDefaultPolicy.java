...
import net.accelbyte.sdk.api.legal.operation_responses.policies_with_namespace.SetDefaultPolicyOpResponse;
...
public class SetDefaultPolicy extends Operation {
  ...
  @Deprecated
  public SetDefaultPolicy(String customBasePath, String namespace, String policyId) {
  ...
  public SetDefaultPolicyOpResponse parseResponse(int code, String contentType, InputStream payload)
