...
import net.accelbyte.sdk.api.legal.operation_responses.policies.OldRetrieveLatestPoliciesByNamespaceAndCountryPublicOpResponse;
...
public class OldRetrieveLatestPoliciesByNamespaceAndCountryPublic extends Operation {
  ...
  public OldRetrieveLatestPoliciesByNamespaceAndCountryPublicOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final OldRetrieveLatestPoliciesByNamespaceAndCountryPublicOpResponse response =
        new OldRetrieveLatestPoliciesByNamespaceAndCountryPublicOpResponse();
