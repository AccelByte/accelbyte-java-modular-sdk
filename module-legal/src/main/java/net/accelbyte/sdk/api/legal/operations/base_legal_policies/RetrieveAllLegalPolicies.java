...
public class RetrieveAllLegalPolicies extends Operation {
    ...
    */
    ...
    public RetrieveAllLegalPolicies(
            String customBasePath,            Boolean visibleOnly
    )
    {
    ...
    public RetrieveAllLegalPoliciesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
