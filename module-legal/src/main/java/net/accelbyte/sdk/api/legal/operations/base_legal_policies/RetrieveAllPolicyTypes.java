...
public class RetrieveAllPolicyTypes extends Operation {
    ...
    */
    ...
    public RetrieveAllPolicyTypes(
            String customBasePath,            Integer offset,
            Integer limit
    )
    {
        this.offset = offset;
    ...
    public RetrieveAllPolicyTypesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
