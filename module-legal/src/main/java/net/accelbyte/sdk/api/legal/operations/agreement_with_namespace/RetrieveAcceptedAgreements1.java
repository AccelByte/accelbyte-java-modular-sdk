...
public class RetrieveAcceptedAgreements1 extends Operation {
     ...
     */
    private String path = "/agreement/admin/namespaces/{namespace}/agreements/policies/users/{userId}";
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("excludeOtherNamespacesPolicies", this.excludeOtherNamespacesPolicies == null ? null : Arrays.asList(String.valueOf(this.excludeOtherNamespacesPolicies)));
        return queryParams;
    }
    ...
    public RetrieveAcceptedAgreements1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RetrieveAcceptedAgreements1OpResponse response = new RetrieveAcceptedAgreements1OpResponse();
