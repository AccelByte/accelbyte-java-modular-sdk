...
import net.accelbyte.sdk.api.legal.operation_responses.localized_policy_versions.OldRetrieveSingleLocalizedPolicyVersionOpResponse;
...
public class OldRetrieveSingleLocalizedPolicyVersion extends Operation {
  ...
  public OldRetrieveSingleLocalizedPolicyVersionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final OldRetrieveSingleLocalizedPolicyVersionOpResponse response =
        new OldRetrieveSingleLocalizedPolicyVersionOpResponse();
