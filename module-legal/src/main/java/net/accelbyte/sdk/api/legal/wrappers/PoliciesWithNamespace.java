...
import net.accelbyte.sdk.api.legal.operation_responses.policies_with_namespace.*;
...
public class PoliciesWithNamespace {
     ...
     * @see DeletePolicy
     */
    public DeletePolicyOpResponse deletePolicy(DeletePolicy input) throws Exception {
