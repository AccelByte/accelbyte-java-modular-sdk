...
import net.accelbyte.sdk.api.legal.operation_responses.admin_user_agreement.*;
...
public class AdminUserAgreement {
     ...
     */
    public IndirectBulkAcceptVersionedPolicyOpResponse indirectBulkAcceptVersionedPolicy(IndirectBulkAcceptVersionedPolicy input) throws Exception {
