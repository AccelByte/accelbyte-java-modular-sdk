...
import net.accelbyte.sdk.api.legal.operation_responses.localized_policy_versions_with_namespace.RetrieveSingleLocalizedPolicyVersionOpResponse;
...
public class RetrieveSingleLocalizedPolicyVersion extends Operation {
  ...
  public RetrieveSingleLocalizedPolicyVersionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final RetrieveSingleLocalizedPolicyVersionOpResponse response =
        new RetrieveSingleLocalizedPolicyVersionOpResponse();
