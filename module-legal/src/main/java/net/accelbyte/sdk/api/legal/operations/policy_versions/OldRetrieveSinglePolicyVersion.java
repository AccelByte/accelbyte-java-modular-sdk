...
import net.accelbyte.sdk.api.legal.operation_responses.policy_versions.OldRetrieveSinglePolicyVersionOpResponse;
...
public class OldRetrieveSinglePolicyVersion extends Operation {
  ...
  @Deprecated
  public OldRetrieveSinglePolicyVersion(String customBasePath, String policyId, String versionId) {
  ...
  public OldRetrieveSinglePolicyVersionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final OldRetrieveSinglePolicyVersionOpResponse response =
        new OldRetrieveSinglePolicyVersionOpResponse();
