...
import net.accelbyte.sdk.api.legal.operation_responses.agreement_with_namespace.RetrieveAcceptedAgreementsOpResponse;
...
public class RetrieveAcceptedAgreements extends Operation {
  ...
  public RetrieveAcceptedAgreementsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final RetrieveAcceptedAgreementsOpResponse response =
        new RetrieveAcceptedAgreementsOpResponse();
