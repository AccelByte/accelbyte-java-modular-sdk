...
public class InitiateExportAgreementsToCSV extends Operation {
  ...
  public InitiateExportAgreementsToCSV(
      String customBasePath, String namespace, String end, String policyVersionId, String start) {
  ...
  public InitiateExportAgreementsToCSVOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final InitiateExportAgreementsToCSVOpResponse response =
        new InitiateExportAgreementsToCSVOpResponse();
