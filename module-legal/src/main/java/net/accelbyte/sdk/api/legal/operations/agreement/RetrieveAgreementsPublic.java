...
import net.accelbyte.sdk.api.legal.operation_responses.agreement.RetrieveAgreementsPublicOpResponse;
...
public class RetrieveAgreementsPublic extends Operation {
    ...
    */
    ...
    public RetrieveAgreementsPublicOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RetrieveAgreementsPublicOpResponse response = new RetrieveAgreementsPublicOpResponse();
