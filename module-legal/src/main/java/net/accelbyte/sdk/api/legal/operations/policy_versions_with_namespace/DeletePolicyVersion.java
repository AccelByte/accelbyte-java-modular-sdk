...
import net.accelbyte.sdk.api.legal.operation_responses.policy_versions_with_namespace.DeletePolicyVersionOpResponse;
...
public class DeletePolicyVersion extends Operation {
    ...
    */
    ...
    public DeletePolicyVersionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeletePolicyVersionOpResponse response = new DeletePolicyVersionOpResponse();
