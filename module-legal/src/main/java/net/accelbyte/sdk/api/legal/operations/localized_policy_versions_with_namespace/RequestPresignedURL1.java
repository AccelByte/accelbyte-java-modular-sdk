...
import net.accelbyte.sdk.api.legal.operation_responses.localized_policy_versions_with_namespace.RequestPresignedURL1OpResponse;
...
public class RequestPresignedURL1 extends Operation {
     ...
     */
    private String path = "/agreement/admin/namespaces/{namespace}/localized-policy-versions/{localizedPolicyVersionId}/attachments";
    ...
    */
    ...
    public RequestPresignedURL1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RequestPresignedURL1OpResponse response = new RequestPresignedURL1OpResponse();
