...
import net.accelbyte.sdk.api.legal.operation_responses.policy_versions.OldCreatePolicyVersionOpResponse;
...
public class OldCreatePolicyVersion extends Operation {
  ...
  public OldCreatePolicyVersionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final OldCreatePolicyVersionOpResponse response = new OldCreatePolicyVersionOpResponse();
