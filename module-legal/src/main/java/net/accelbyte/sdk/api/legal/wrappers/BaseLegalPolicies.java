...
public class BaseLegalPolicies {
     ...
     */
    public RetrieveAllLegalPoliciesOpResponse retrieveAllLegalPolicies(RetrieveAllLegalPolicies input) throws Exception {
     ...
     */
    public RetrieveSinglePolicyOpResponse retrieveSinglePolicy(RetrieveSinglePolicy input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public PartialUpdatePolicyOpResponse partialUpdatePolicy(PartialUpdatePolicy input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public RetrievePolicyCountryOpResponse retrievePolicyCountry(RetrievePolicyCountry input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public RetrieveAllPolicyTypesOpResponse retrieveAllPolicyTypes(RetrieveAllPolicyTypes input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
