...
import net.accelbyte.sdk.api.legal.operation_responses.localized_policy_versions.OldRetrieveLocalizedPolicyVersionsOpResponse;
...
public class OldRetrieveLocalizedPolicyVersions extends Operation {
  ...
  @Deprecated
  public OldRetrieveLocalizedPolicyVersions(String customBasePath, String policyVersionId) {
  ...
  public OldRetrieveLocalizedPolicyVersionsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final OldRetrieveLocalizedPolicyVersionsOpResponse response =
        new OldRetrieveLocalizedPolicyVersionsOpResponse();
