...
public class RetrieveSingleLocalizedPolicyVersion1 extends Operation {
     ...
     */
    private String path = "/agreement/admin/namespaces/{namespace}/localized-policy-versions/{localizedPolicyVersionId}";
    ...
    */
    ...
    public RetrieveSingleLocalizedPolicyVersion1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RetrieveSingleLocalizedPolicyVersion1OpResponse response = new RetrieveSingleLocalizedPolicyVersion1OpResponse();
