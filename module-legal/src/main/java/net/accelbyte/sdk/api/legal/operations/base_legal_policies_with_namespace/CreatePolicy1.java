...
public class CreatePolicy1 extends Operation {
    ...
    */
    ...
    public CreatePolicy1(
            ...
            CreateBasePolicyRequestV2 body
    )
    {
    ...
    public CreatePolicy1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
