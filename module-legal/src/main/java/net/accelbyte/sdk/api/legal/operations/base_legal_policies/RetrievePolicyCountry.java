...
import net.accelbyte.sdk.api.legal.operation_responses.base_legal_policies.RetrievePolicyCountryOpResponse;
...
public class RetrievePolicyCountry extends Operation {
    ...
    */
    ...
    public RetrievePolicyCountryOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
