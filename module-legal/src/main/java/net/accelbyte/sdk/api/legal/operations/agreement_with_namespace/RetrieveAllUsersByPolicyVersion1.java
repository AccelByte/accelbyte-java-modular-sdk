...
import net.accelbyte.sdk.api.legal.operation_responses.agreement_with_namespace.RetrieveAllUsersByPolicyVersion1OpResponse;
...
public class RetrieveAllUsersByPolicyVersion1 extends Operation {
    ...
    */
    ...
    public Map<String, List<String>> getQueryParams(){
        ...
        queryParams.put("convertGameUserId", this.convertGameUserId == null ? null : Arrays.asList(String.valueOf(this.convertGameUserId)));
    ...
    public RetrieveAllUsersByPolicyVersion1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RetrieveAllUsersByPolicyVersion1OpResponse response = new RetrieveAllUsersByPolicyVersion1OpResponse();
