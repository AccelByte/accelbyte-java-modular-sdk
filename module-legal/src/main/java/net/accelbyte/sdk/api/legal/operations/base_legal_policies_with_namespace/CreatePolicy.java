...
import net.accelbyte.sdk.api.legal.operation_responses.base_legal_policies_with_namespace.CreatePolicyOpResponse;
...
public class CreatePolicy extends Operation {
  ...
  @Deprecated
  public CreatePolicy(String customBasePath, String namespace, CreateBasePolicyRequestV2 body) {
  ...
  public CreatePolicyOpResponse parseResponse(int code, String contentType, InputStream payload)
