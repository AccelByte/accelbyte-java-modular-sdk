...
import net.accelbyte.sdk.api.legal.operation_responses.localized_policy_versions_with_namespace.SetDefaultPolicy1OpResponse;
...
public class SetDefaultPolicy1 extends Operation {
     ...
     */
    private String path = "/agreement/admin/namespaces/{namespace}/localized-policy-versions/{localizedPolicyVersionId}/default";
    ...
    */
    ...
    public SetDefaultPolicy1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SetDefaultPolicy1OpResponse response = new SetDefaultPolicy1OpResponse();
