...
public class IndirectBulkAcceptVersionedPolicy extends Operation {
  ...
  public IndirectBulkAcceptVersionedPolicyOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final IndirectBulkAcceptVersionedPolicyOpResponse response =
        new IndirectBulkAcceptVersionedPolicyOpResponse();
