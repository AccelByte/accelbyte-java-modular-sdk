...
import net.accelbyte.sdk.api.legal.operation_responses.admin_user_agreement.IndirectBulkAcceptVersionedPolicyOpResponse;
...
public class IndirectBulkAcceptVersionedPolicy extends Operation {
    ...
    */
    ...
    public IndirectBulkAcceptVersionedPolicyOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final IndirectBulkAcceptVersionedPolicyOpResponse response = new IndirectBulkAcceptVersionedPolicyOpResponse();
