...
import net.accelbyte.sdk.api.legal.operation_responses.policies.UpdatePolicyOpResponse;
...
public class UpdatePolicy extends Operation {
  ...
  @Deprecated
  public UpdatePolicy(String customBasePath, String policyId, UpdatePolicyRequest body) {
