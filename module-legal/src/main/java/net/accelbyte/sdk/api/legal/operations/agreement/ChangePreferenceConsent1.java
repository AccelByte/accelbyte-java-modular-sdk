...
import net.accelbyte.sdk.api.legal.operation_responses.agreement.ChangePreferenceConsent1OpResponse;
...
public class ChangePreferenceConsent1 extends Operation {
    ...
    */
    ...
    public ChangePreferenceConsent1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ChangePreferenceConsent1OpResponse response = new ChangePreferenceConsent1OpResponse();
