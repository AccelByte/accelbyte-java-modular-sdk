...
public class DownloadExportedAgreementsInCSV extends Operation {
     ...
     */
    private String path = "/agreement/admin/namespaces/{namespace}/agreements/policy-versions/users/export-csv/download";
    ...
    */
    ...
    public DownloadExportedAgreementsInCSVOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DownloadExportedAgreementsInCSVOpResponse response = new DownloadExportedAgreementsInCSVOpResponse();
