...
import net.accelbyte.sdk.api.legal.operation_responses.eligibilities.*;
...
public class Eligibilities {
     ...
     */
    public RetrieveEligibilitiesPublicOpResponse retrieveEligibilitiesPublic(RetrieveEligibilitiesPublic input) throws Exception {
     ...
     */
    public RetrieveEligibilitiesPublicIndirectOpResponse retrieveEligibilitiesPublicIndirect(RetrieveEligibilitiesPublicIndirect input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
