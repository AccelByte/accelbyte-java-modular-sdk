...
import net.accelbyte.sdk.api.legal.operation_responses.admin_user_eligibilities.*;
...
public class AdminUserEligibilities {
     ...
     */
    public AdminRetrieveEligibilitiesOpResponse adminRetrieveEligibilities(AdminRetrieveEligibilities input) throws Exception {
