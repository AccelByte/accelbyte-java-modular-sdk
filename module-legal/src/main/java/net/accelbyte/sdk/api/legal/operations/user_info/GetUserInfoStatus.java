...
import net.accelbyte.sdk.api.legal.operation_responses.user_info.GetUserInfoStatusOpResponse;
...
public class GetUserInfoStatus extends Operation {
    ...
    */
    ...
    public GetUserInfoStatus(
            String customBasePath,            String namespaces
    )
    {
    ...
    public GetUserInfoStatusOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetUserInfoStatusOpResponse response = new GetUserInfoStatusOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<RetrieveUserInfoCacheStatusResponse>>() {}));
        }
    ...
    /*
    public List<RetrieveUserInfoCacheStatusResponse> parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
