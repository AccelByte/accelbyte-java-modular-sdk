...
import net.accelbyte.sdk.api.legal.operation_responses.policy_versions.OldUpdatePolicyVersionOpResponse;
...
public class OldUpdatePolicyVersion extends Operation {
  ...
  public OldUpdatePolicyVersion(
      String customBasePath, String policyVersionId, UpdatePolicyVersionRequest body) {
  ...
  public OldUpdatePolicyVersionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final OldUpdatePolicyVersionOpResponse response = new OldUpdatePolicyVersionOpResponse();
