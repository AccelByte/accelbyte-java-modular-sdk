...
public class IndirectBulkAcceptVersionedPolicy1 extends Operation {
    ...
    */
    ...
    public IndirectBulkAcceptVersionedPolicy1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final IndirectBulkAcceptVersionedPolicy1OpResponse response = new IndirectBulkAcceptVersionedPolicy1OpResponse();
