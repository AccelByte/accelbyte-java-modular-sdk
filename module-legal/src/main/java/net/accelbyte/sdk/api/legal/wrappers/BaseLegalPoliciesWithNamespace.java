...
public class BaseLegalPoliciesWithNamespace {
     ...
     */
    public RetrieveAllLegalPoliciesByNamespaceOpResponse retrieveAllLegalPoliciesByNamespace(RetrieveAllLegalPoliciesByNamespace input) throws Exception {
     ...
     */
    public RetrieveSinglePolicy1OpResponse retrieveSinglePolicy1(RetrieveSinglePolicy1 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public PartialUpdatePolicy1OpResponse partialUpdatePolicy1(PartialUpdatePolicy1 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public RetrievePolicyCountry1OpResponse retrievePolicyCountry1(RetrievePolicyCountry1 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public RetrieveAllPoliciesFromBasePolicyOpResponse retrieveAllPoliciesFromBasePolicy(RetrieveAllPoliciesFromBasePolicy input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public CreatePolicyUnderBasePolicyOpResponse createPolicyUnderBasePolicy(CreatePolicyUnderBasePolicy input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
     ...
     */
    public RetrieveAllPolicyTypes1OpResponse retrieveAllPolicyTypes1(RetrieveAllPolicyTypes1 input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
