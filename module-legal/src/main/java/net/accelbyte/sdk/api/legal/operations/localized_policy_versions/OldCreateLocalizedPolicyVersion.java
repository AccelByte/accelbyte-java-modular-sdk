...
import net.accelbyte.sdk.api.legal.operation_responses.localized_policy_versions.OldCreateLocalizedPolicyVersionOpResponse;
...
public class OldCreateLocalizedPolicyVersion extends Operation {
  ...
  public OldCreateLocalizedPolicyVersion(
      String customBasePath, String policyVersionId, CreateLocalizedPolicyVersionRequest body) {
  ...
  public OldCreateLocalizedPolicyVersionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final OldCreateLocalizedPolicyVersionOpResponse response =
        new OldCreateLocalizedPolicyVersionOpResponse();
