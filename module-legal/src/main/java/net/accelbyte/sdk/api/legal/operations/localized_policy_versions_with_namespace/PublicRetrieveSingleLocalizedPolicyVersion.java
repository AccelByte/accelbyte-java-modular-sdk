...
import net.accelbyte.sdk.api.legal.operation_responses.localized_policy_versions_with_namespace.PublicRetrieveSingleLocalizedPolicyVersionOpResponse;
...
public class PublicRetrieveSingleLocalizedPolicyVersion extends Operation {
  ...
  public PublicRetrieveSingleLocalizedPolicyVersionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublicRetrieveSingleLocalizedPolicyVersionOpResponse response =
        new PublicRetrieveSingleLocalizedPolicyVersionOpResponse();
