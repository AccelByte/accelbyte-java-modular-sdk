...
public class ChangePreferenceConsent extends Operation {
    ...
    */
    ...
    public ChangePreferenceConsentOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ChangePreferenceConsentOpResponse response = new ChangePreferenceConsentOpResponse();
