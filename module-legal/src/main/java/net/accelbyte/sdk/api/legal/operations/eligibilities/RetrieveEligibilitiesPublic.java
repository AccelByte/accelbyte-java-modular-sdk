...
import net.accelbyte.sdk.api.legal.operation_responses.eligibilities.RetrieveEligibilitiesPublicOpResponse;
...
public class RetrieveEligibilitiesPublic extends Operation {
  ...
  public RetrieveEligibilitiesPublicOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final RetrieveEligibilitiesPublicOpResponse response =
        new RetrieveEligibilitiesPublicOpResponse();
  ...
  /*
  public List<RetrieveUserEligibilitiesResponse> parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
