...
import net.accelbyte.sdk.api.legal.operation_responses.base_legal_policies.OldCreatePolicyOpResponse;
...
public class OldCreatePolicy extends Operation {
  ...
  @Deprecated
  public OldCreatePolicy(String customBasePath, CreateBasePolicyRequest body) {
    this.body = body;
  ...
  public OldCreatePolicyOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final OldCreatePolicyOpResponse response = new OldCreatePolicyOpResponse();
