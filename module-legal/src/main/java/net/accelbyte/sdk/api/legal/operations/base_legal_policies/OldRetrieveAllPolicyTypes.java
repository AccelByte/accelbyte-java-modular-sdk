...
import net.accelbyte.sdk.api.legal.operation_responses.base_legal_policies.OldRetrieveAllPolicyTypesOpResponse;
...
public class OldRetrieveAllPolicyTypes extends Operation {
  ...
  @Deprecated
  public OldRetrieveAllPolicyTypes(String customBasePath, Integer offset, Integer limit) {
    this.offset = offset;
    this.limit = limit;
  ...
  public OldRetrieveAllPolicyTypesOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final OldRetrieveAllPolicyTypesOpResponse response = new OldRetrieveAllPolicyTypesOpResponse();
