...
import net.accelbyte.sdk.api.legal.operation_responses.admin_user_eligibilities.AdminRetrieveEligibilitiesOpResponse;
...
public class AdminRetrieveEligibilities extends Operation {
    ...
    */
    ...
    public AdminRetrieveEligibilitiesOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final AdminRetrieveEligibilitiesOpResponse response = new AdminRetrieveEligibilitiesOpResponse();
