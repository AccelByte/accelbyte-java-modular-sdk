...
public class RetrieveLatestPoliciesPublic extends Operation {
  ...
  public RetrieveLatestPoliciesPublicOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final RetrieveLatestPoliciesPublicOpResponse response =
        new RetrieveLatestPoliciesPublicOpResponse();
