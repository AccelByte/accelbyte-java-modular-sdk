...
public class RetrieveAllPoliciesFromBasePolicy extends Operation {
    ...
    */
    ...
    public RetrieveAllPoliciesFromBasePolicyOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RetrieveAllPoliciesFromBasePolicyOpResponse response = new RetrieveAllPoliciesFromBasePolicyOpResponse();
        ...
        if (code == 204) {
            ...
            response.setSuccess(true);
            response.setData(new ObjectMapper().readValue(json, new TypeReference<List<RetrievePoliciesFromBasePolicyResponse>>() {}));
        }
        else if (code == 404) {
            final String json = Helper.convertInputStreamToString(payload);
