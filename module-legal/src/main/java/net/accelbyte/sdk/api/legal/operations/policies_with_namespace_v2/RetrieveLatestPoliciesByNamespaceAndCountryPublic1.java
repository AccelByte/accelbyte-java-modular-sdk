...
import net.accelbyte.sdk.api.legal.operation_responses.policies_with_namespace_v2.RetrieveLatestPoliciesByNamespaceAndCountryPublic1OpResponse;
...
public class RetrieveLatestPoliciesByNamespaceAndCountryPublic1 extends Operation {
  ...
  public RetrieveLatestPoliciesByNamespaceAndCountryPublic1(
      String customBasePath, String countryCode, String namespace, String clientId) {
  ...
  public RetrieveLatestPoliciesByNamespaceAndCountryPublic1OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final RetrieveLatestPoliciesByNamespaceAndCountryPublic1OpResponse response =
        new RetrieveLatestPoliciesByNamespaceAndCountryPublic1OpResponse();
  ...
  /*
  public List<RetrieveSimplePolicyPublicResponseV2> parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
          throw new HttpResponseException(code, json);
      }
      final String json = Helper.convertInputStreamToString(payload);
      return new ObjectMapper().readValue(json, new TypeReference<List<RetrieveSimplePolicyPublicResponseV2>>() {});
  }
  */
