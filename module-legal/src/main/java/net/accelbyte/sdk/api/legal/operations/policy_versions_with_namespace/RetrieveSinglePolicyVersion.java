...
import net.accelbyte.sdk.api.legal.operation_responses.policy_versions_with_namespace.RetrieveSinglePolicyVersionOpResponse;
...
public class RetrieveSinglePolicyVersion extends Operation {
  ...
  public RetrieveSinglePolicyVersionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final RetrieveSinglePolicyVersionOpResponse response =
        new RetrieveSinglePolicyVersionOpResponse();
