...
import net.accelbyte.sdk.api.legal.operation_responses.localized_policy_versions_with_namespace.RetrieveLocalizedPolicyVersionsOpResponse;
...
public class RetrieveLocalizedPolicyVersions extends Operation {
  ...
  public RetrieveLocalizedPolicyVersionsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final RetrieveLocalizedPolicyVersionsOpResponse response =
        new RetrieveLocalizedPolicyVersionsOpResponse();
