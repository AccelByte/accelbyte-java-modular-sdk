...
public class UpdateBasePolicyRequestV2 extends Model {
    ...
    @JsonIgnore
    public List<UpdateBasePolicyRequestV2> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<UpdateBasePolicyRequestV2>>() {});
    }
