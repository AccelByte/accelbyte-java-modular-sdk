...
public class CreatePolicyUnderBasePolicy extends Operation {
  ...
  public CreatePolicyUnderBasePolicy(
      String customBasePath, String basePolicyId, String namespace, CreatePolicyRequest body) {
  ...
  public CreatePolicyUnderBasePolicyOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final CreatePolicyUnderBasePolicyOpResponse response =
        new CreatePolicyUnderBasePolicyOpResponse();
