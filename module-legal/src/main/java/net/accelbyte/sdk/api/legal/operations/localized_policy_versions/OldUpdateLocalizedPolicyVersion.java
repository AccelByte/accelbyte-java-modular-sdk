...
import net.accelbyte.sdk.api.legal.operation_responses.localized_policy_versions.OldUpdateLocalizedPolicyVersionOpResponse;
...
public class OldUpdateLocalizedPolicyVersion extends Operation {
  ...
  public OldUpdateLocalizedPolicyVersionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final OldUpdateLocalizedPolicyVersionOpResponse response =
        new OldUpdateLocalizedPolicyVersionOpResponse();
