...
import net.accelbyte.sdk.api.legal.operation_responses.policy_versions_with_namespace.PublishPolicyVersionOpResponse;
...
public class PublishPolicyVersion extends Operation {
  ...
  public PublishPolicyVersion(
      String customBasePath, String namespace, String policyVersionId, Boolean shouldNotify) {
  ...
  public PublishPolicyVersionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final PublishPolicyVersionOpResponse response = new PublishPolicyVersionOpResponse();
