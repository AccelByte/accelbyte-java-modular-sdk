...
public class RetrieveEligibilitiesPublicIndirect extends Operation {
    ...
    */
    ...
    public RetrieveEligibilitiesPublicIndirectOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RetrieveEligibilitiesPublicIndirectOpResponse response = new RetrieveEligibilitiesPublicIndirectOpResponse();
