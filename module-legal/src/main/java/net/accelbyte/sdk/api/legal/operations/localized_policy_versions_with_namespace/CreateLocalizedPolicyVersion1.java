...
public class CreateLocalizedPolicyVersion1 extends Operation {
    ...
    */
    ...
    public CreateLocalizedPolicyVersion1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreateLocalizedPolicyVersion1OpResponse response = new CreateLocalizedPolicyVersion1OpResponse();
