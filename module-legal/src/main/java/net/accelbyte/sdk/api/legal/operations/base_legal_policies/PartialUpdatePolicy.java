...
import net.accelbyte.sdk.api.legal.operation_responses.base_legal_policies.PartialUpdatePolicyOpResponse;
...
public class PartialUpdatePolicy extends Operation {
    ...
    */
    ...
    public PartialUpdatePolicyOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final PartialUpdatePolicyOpResponse response = new PartialUpdatePolicyOpResponse();
