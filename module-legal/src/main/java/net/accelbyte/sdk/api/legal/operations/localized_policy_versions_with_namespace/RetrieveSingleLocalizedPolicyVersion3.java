...
public class RetrieveSingleLocalizedPolicyVersion3 extends Operation {
     ...
     */
    private String path = "/agreement/public/namespaces/{namespace}/localized-policy-versions/{localizedPolicyVersionId}";
    ...
    */
    ...
    public RetrieveSingleLocalizedPolicyVersion3OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RetrieveSingleLocalizedPolicyVersion3OpResponse response = new RetrieveSingleLocalizedPolicyVersion3OpResponse();
