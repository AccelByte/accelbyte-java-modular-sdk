...
import net.accelbyte.sdk.api.legal.operation_responses.localized_policy_versions_with_namespace.CreateLocalizedPolicyVersionOpResponse;
...
public class CreateLocalizedPolicyVersion extends Operation {
  ...
  public CreateLocalizedPolicyVersionOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final CreateLocalizedPolicyVersionOpResponse response =
        new CreateLocalizedPolicyVersionOpResponse();
