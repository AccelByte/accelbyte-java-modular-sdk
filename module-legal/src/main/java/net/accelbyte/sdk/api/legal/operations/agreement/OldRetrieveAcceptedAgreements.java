...
import net.accelbyte.sdk.api.legal.operation_responses.agreement.OldRetrieveAcceptedAgreementsOpResponse;
...
public class OldRetrieveAcceptedAgreements extends Operation {
  ...
  @Deprecated
  public OldRetrieveAcceptedAgreements(String customBasePath, String userId) {
    this.userId = userId;
  ...
  public OldRetrieveAcceptedAgreementsOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final OldRetrieveAcceptedAgreementsOpResponse response =
        new OldRetrieveAcceptedAgreementsOpResponse();
