...
import net.accelbyte.sdk.api.legal.operation_responses.base_legal_policies.OldRetrievePolicyCountryOpResponse;
...
public class OldRetrievePolicyCountry extends Operation {
  ...
  @Deprecated
  public OldRetrievePolicyCountry(String customBasePath, String basePolicyId, String countryCode) {
  ...
  public OldRetrievePolicyCountryOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final OldRetrievePolicyCountryOpResponse response = new OldRetrievePolicyCountryOpResponse();
