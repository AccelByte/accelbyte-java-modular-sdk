...
import net.accelbyte.sdk.api.legal.operation_responses.policies_with_namespace_v2.RetrieveLatestPoliciesByNamespaceAndCountryPublicOpResponse;
...
public class RetrieveLatestPoliciesByNamespaceAndCountryPublic extends Operation {
  ...
  public RetrieveLatestPoliciesByNamespaceAndCountryPublicOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final RetrieveLatestPoliciesByNamespaceAndCountryPublicOpResponse response =
        new RetrieveLatestPoliciesByNamespaceAndCountryPublicOpResponse();
