...
import net.accelbyte.sdk.api.legal.operation_responses.base_legal_policies.OldRetrieveSinglePolicyOpResponse;
...
public class OldRetrieveSinglePolicy extends Operation {
  ...
  @Deprecated
  public OldRetrieveSinglePolicy(String customBasePath, String basePolicyId) {
  ...
  public OldRetrieveSinglePolicyOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final OldRetrieveSinglePolicyOpResponse response = new OldRetrieveSinglePolicyOpResponse();
