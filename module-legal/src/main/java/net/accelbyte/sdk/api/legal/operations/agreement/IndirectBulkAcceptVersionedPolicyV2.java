...
public class IndirectBulkAcceptVersionedPolicyV2 extends Operation {
  ...
  public IndirectBulkAcceptVersionedPolicyV2OpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final IndirectBulkAcceptVersionedPolicyV2OpResponse response =
        new IndirectBulkAcceptVersionedPolicyV2OpResponse();
