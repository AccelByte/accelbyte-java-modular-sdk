...
import net.accelbyte.sdk.api.legal.operation_responses.policy_versions.PublishPolicyVersionOpResponse;
...
public class PublishPolicyVersion extends Operation {
    ...
    */
    ...
    public PublishPolicyVersionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
