...
public class RetrieveLocalizedPolicyVersions1 extends Operation {
     ...
     */
    private String path = "/agreement/admin/namespaces/{namespace}/localized-policy-versions/versions/{policyVersionId}";
    ...
    */
    ...
    public RetrieveLocalizedPolicyVersions1OpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RetrieveLocalizedPolicyVersions1OpResponse response = new RetrieveLocalizedPolicyVersions1OpResponse();
