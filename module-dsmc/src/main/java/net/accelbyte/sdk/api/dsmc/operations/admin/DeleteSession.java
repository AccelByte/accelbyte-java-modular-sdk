...
import net.accelbyte.sdk.api.dsmc.operation_responses.admin.DeleteSessionOpResponse;
...
public class DeleteSession extends Operation {
  ...
  @Deprecated
  public DeleteSession(String customBasePath, String namespace, String sessionID) {
  ...
  public DeleteSessionOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final DeleteSessionOpResponse response = new DeleteSessionOpResponse();
