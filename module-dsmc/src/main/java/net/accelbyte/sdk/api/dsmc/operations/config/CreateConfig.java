...
public class CreateConfig extends Operation {
  ...
  @Deprecated
  public CreateConfig(String customBasePath, String namespace, ModelsCreateDSMConfigRequest body) {
  ...
  public CreateConfigOpResponse parseResponse(int code, String contentType, InputStream payload)
