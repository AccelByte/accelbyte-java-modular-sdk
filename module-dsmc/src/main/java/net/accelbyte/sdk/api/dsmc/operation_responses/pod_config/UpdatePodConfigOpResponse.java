...
@Getter
@Setter
public class UpdatePodConfigOpResponse extends ApiResponseWithData<ModelsPodConfigRecord> {
  ...
  public String getFullOperationId() {
    return "net.accelbyte.sdk.api.dsmc.operations.pod_config.UpdatePodConfig";
  }
}
