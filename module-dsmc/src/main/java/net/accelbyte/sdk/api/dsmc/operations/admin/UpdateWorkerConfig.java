...
import net.accelbyte.sdk.api.dsmc.operation_responses.admin.UpdateWorkerConfigOpResponse;
...
public class UpdateWorkerConfig extends Operation {
    ...
    */
    ...
    public UpdateWorkerConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateWorkerConfigOpResponse response = new UpdateWorkerConfigOpResponse();
