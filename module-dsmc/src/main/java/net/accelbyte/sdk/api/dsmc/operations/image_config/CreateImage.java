...
public class CreateImage extends Operation {
    ...
    */
    ...
    @Deprecated
    public CreateImage(
            String customBasePath,            ModelsCreateImageRequest body
    )
    {
        this.body = body;
    ...
    public CreateImageOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreateImageOpResponse response = new CreateImageOpResponse();
