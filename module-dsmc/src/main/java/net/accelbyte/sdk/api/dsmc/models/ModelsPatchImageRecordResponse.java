...
public class ModelsPatchImageRecordResponse extends Model {
    ...
    @JsonIgnore
    public List<ModelsPatchImageRecordResponse> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelsPatchImageRecordResponse>>() {});
    }
