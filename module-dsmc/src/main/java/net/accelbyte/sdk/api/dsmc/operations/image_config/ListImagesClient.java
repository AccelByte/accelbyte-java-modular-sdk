...
public class ListImagesClient extends Operation {
    ...
    */
    ...
    public ListImagesClientOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ListImagesClientOpResponse response = new ListImagesClientOpResponse();
