...
public class DeleteDeployment extends Operation {
    ...
    */
    ...
    public DeleteDeploymentOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteDeploymentOpResponse response = new DeleteDeploymentOpResponse();
