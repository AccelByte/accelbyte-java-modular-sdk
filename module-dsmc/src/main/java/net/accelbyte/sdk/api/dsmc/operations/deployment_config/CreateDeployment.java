...
public class CreateDeployment extends Operation {
    ...
    */
    ...
    public CreateDeploymentOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreateDeploymentOpResponse response = new CreateDeploymentOpResponse();
