...
public class UpdateRootRegionOverride extends Operation {
    ...
    */
    ...
    public UpdateRootRegionOverrideOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdateRootRegionOverrideOpResponse response = new UpdateRootRegionOverrideOpResponse();
