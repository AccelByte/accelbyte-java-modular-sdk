...
public class DeleteDeploymentClient extends Operation {
    ...
    */
    ...
    public DeleteDeploymentClientOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteDeploymentClientOpResponse response = new DeleteDeploymentClientOpResponse();
