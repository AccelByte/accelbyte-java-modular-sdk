...
public class ImageDetailClient extends Operation {
  ...
  @Deprecated
  public ImageDetailClient(String customBasePath, String namespace, String version) {
  ...
  public ImageDetailClientOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final ImageDetailClientOpResponse response = new ImageDetailClientOpResponse();
