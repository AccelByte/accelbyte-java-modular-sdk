...
public class RegisterLocalServer extends Operation {
  ...
  public RegisterLocalServer(
      String customBasePath, String namespace, ModelsRegisterLocalServerRequest body) {
  ...
  public RegisterLocalServerOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final RegisterLocalServerOpResponse response = new RegisterLocalServerOpResponse();
