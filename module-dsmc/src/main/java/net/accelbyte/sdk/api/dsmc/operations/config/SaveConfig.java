...
import net.accelbyte.sdk.api.dsmc.operation_responses.config.SaveConfigOpResponse;
...
public class SaveConfig extends Operation {
    ...
    */
    ...
    @Deprecated
    public SaveConfig(
            String customBasePath,            ModelsDSMConfigRecord body
    )
    {
        this.body = body;
    ...
    public SaveConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final SaveConfigOpResponse response = new SaveConfigOpResponse();
