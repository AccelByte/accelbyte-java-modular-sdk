...
@Getter
@Setter
public class UpdateDeploymentOpResponse extends ApiResponseWithData<ModelsDeploymentWithOverride> {
    ...
    public String getFullOperationId() {
        return "net.accelbyte.sdk.api.dsmc.operations.deployment_config.UpdateDeployment";
    }
}