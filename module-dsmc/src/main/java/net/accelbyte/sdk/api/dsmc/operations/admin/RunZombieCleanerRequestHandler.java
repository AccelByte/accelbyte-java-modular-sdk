...
import net.accelbyte.sdk.api.dsmc.operation_responses.admin.RunZombieCleanerRequestHandlerOpResponse;
...
public class RunZombieCleanerRequestHandler extends Operation {
    ...
    */
    ...
    public RunZombieCleanerRequestHandlerOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final RunZombieCleanerRequestHandlerOpResponse response = new RunZombieCleanerRequestHandlerOpResponse();
