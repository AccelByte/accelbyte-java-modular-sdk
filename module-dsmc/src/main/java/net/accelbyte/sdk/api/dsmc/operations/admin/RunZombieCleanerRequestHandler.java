...
public class RunZombieCleanerRequestHandler extends Operation {
  ...
  public RunZombieCleanerRequestHandler(
      String customBasePath, String namespace, ModelsDeleteZombieRequest body) {
  ...
  public RunZombieCleanerRequestHandlerOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final RunZombieCleanerRequestHandlerOpResponse response =
        new RunZombieCleanerRequestHandlerOpResponse();
