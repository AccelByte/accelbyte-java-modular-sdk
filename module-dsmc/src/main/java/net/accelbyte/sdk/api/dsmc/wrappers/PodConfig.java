...
public class PodConfig {
   ...
   */
  public GetLowestInstanceSpecOpResponse getLowestInstanceSpec(GetLowestInstanceSpec input)
      throws Exception {
   ...
   */
  public GetAllPodConfigClientOpResponse getAllPodConfigClient(GetAllPodConfigClient input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public CreatePodConfigClientOpResponse createPodConfigClient(CreatePodConfigClient input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
   ...
   */
  public DeletePodConfigClientOpResponse deletePodConfigClient(DeletePodConfigClient input)
      throws Exception {
    if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
      input.setCustomBasePath(customBasePath);
    }
