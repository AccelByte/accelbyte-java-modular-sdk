...
import net.accelbyte.sdk.api.dsmc.operation_responses.pod_config.CreatePodConfigOpResponse;
...
public class CreatePodConfig extends Operation {
  ...
  public CreatePodConfig(
      String customBasePath, String name, String namespace, ModelsCreatePodConfigRequest body) {
    this.name = name;
  ...
  public CreatePodConfigOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final CreatePodConfigOpResponse response = new CreatePodConfigOpResponse();
