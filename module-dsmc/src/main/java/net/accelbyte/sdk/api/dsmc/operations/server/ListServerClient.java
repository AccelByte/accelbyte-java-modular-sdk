...
public class ListServerClient extends Operation {
  ...
  public ListServerClient(
      String customBasePath, String namespace, String region, Integer count, Integer offset) {
  ...
  public ListServerClientOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final ListServerClientOpResponse response = new ListServerClientOpResponse();
