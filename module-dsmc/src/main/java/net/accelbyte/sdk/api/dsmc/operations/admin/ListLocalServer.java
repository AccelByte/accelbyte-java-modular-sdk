...
import net.accelbyte.sdk.api.dsmc.operation_responses.admin.ListLocalServerOpResponse;
...
public class ListLocalServer extends Operation {
  ...
  @Deprecated
  public ListLocalServer(String customBasePath, String namespace) {
  ...
  public ListLocalServerOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final ListLocalServerOpResponse response = new ListLocalServerOpResponse();
