...
public class DeleteOverrideRegionOverride extends Operation {
  ...
  public DeleteOverrideRegionOverride(
      String customBasePath, String deployment, String namespace, String region, String version) {
  ...
  public DeleteOverrideRegionOverrideOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final DeleteOverrideRegionOverrideOpResponse response =
        new DeleteOverrideRegionOverrideOpResponse();
