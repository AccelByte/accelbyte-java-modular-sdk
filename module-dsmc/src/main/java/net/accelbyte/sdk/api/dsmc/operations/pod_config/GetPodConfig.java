...
import net.accelbyte.sdk.api.dsmc.operation_responses.pod_config.GetPodConfigOpResponse;
...
public class GetPodConfig extends Operation {
  ...
  @Deprecated
  public GetPodConfig(String customBasePath, String name, String namespace) {
    this.name = name;
  ...
  public GetPodConfigOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetPodConfigOpResponse response = new GetPodConfigOpResponse();
