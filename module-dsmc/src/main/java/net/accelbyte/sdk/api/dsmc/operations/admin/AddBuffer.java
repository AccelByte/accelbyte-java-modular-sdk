...
import net.accelbyte.sdk.api.dsmc.operation_responses.admin.AddBufferOpResponse;
...
public class AddBuffer extends Operation {
  ...
  @Deprecated
  public AddBuffer(String customBasePath, String namespace, ModelsAddBufferRequest body) {
  ...
  public AddBufferOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final AddBufferOpResponse response = new AddBufferOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ModelsAddBufferResponse().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public ModelsAddBufferResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
