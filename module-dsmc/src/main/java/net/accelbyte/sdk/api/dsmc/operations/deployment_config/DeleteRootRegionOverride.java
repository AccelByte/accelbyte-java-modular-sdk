...
public class DeleteRootRegionOverride extends Operation {
    ...
    */
    ...
    public DeleteRootRegionOverrideOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteRootRegionOverrideOpResponse response = new DeleteRootRegionOverrideOpResponse();
