...
public class RegisterServer extends Operation {
  ...
  @Deprecated
  public RegisterServer(String customBasePath, String namespace, ModelsRegisterServerRequest body) {
  ...
  public RegisterServerOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final RegisterServerOpResponse response = new RegisterServerOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ModelsServer().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
  ...
  /*
  public ModelsServer parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
      if(code != 200){
          final String json = Helper.convertInputStreamToString(payload);
