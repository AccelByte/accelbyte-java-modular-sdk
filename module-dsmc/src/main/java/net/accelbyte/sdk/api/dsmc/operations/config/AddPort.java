...
import net.accelbyte.sdk.api.dsmc.operation_responses.config.AddPortOpResponse;
...
public class AddPort extends Operation {
  ...
  @Deprecated
  public AddPort(
      String customBasePath, String name, String namespace, ModelsCreatePortRequest body) {
    this.name = name;
  ...
  public AddPortOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final AddPortOpResponse response = new AddPortOpResponse();
