...
public class GetAllDeployment extends Operation {
    ...
    */
    ...
    public GetAllDeploymentOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetAllDeploymentOpResponse response = new GetAllDeploymentOpResponse();
