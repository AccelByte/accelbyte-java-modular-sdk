...
public class ModelsServerDetailsResponse extends Model {
    ...
    @JsonIgnore
    public List<ModelsServerDetailsResponse> createFromJsonList(String json) throws JsonProcessingException {
        return new ObjectMapper().readValue(json, new TypeReference<List<ModelsServerDetailsResponse>>() {});
    }
