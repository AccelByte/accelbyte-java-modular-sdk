...
public class GetServerSession extends Operation {
    ...
    */
    ...
    public GetServerSessionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetServerSessionOpResponse response = new GetServerSessionOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsServerSessionResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 400) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsServerSessionResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
