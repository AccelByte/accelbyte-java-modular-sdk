...
public class UpdateOverrideRegionOverride extends Operation {
  ...
  public UpdateOverrideRegionOverrideOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final UpdateOverrideRegionOverrideOpResponse response =
        new UpdateOverrideRegionOverrideOpResponse();
