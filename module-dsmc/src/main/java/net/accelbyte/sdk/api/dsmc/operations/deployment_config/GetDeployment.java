...
public class GetDeployment extends Operation {
    ...
    */
    ...
    public GetDeploymentOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetDeploymentOpResponse response = new GetDeploymentOpResponse();
