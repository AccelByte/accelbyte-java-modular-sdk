...
public class GetDeployment extends Operation {
  ...
  @Deprecated
  public GetDeployment(String customBasePath, String deployment, String namespace) {
  ...
  public GetDeploymentOpResponse parseResponse(int code, String contentType, InputStream payload)
