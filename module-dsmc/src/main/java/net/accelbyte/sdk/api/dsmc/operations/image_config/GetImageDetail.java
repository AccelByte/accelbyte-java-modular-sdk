...
public class GetImageDetail extends Operation {
  ...
  @Deprecated
  public GetImageDetail(String customBasePath, String namespace, String version) {
  ...
  public GetImageDetailOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetImageDetailOpResponse response = new GetImageDetailOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ModelsGetImageDetailResponse().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 401) {
      final String json = Helper.convertInputStreamToString(payload);
