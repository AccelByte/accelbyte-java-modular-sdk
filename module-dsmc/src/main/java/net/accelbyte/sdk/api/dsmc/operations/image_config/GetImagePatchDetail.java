...
public class GetImagePatchDetail extends Operation {
    ...
    */
    ...
    public GetImagePatchDetailOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetImagePatchDetailOpResponse response = new GetImagePatchDetailOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsGetImagePatchDetailResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 401) {
            final String json = Helper.convertInputStreamToString(payload);
    ...
    /*
    public ModelsGetImagePatchDetailResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        if(code != 200){
            final String json = Helper.convertInputStreamToString(payload);
