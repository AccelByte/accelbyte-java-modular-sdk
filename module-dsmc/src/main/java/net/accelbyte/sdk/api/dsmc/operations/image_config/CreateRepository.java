...
public class CreateRepository extends Operation {
  ...
  @Deprecated
  public CreateRepository(String customBasePath, ModelsCreateRepositoryRequest body) {
    this.body = body;
  ...
  public CreateRepositoryOpResponse parseResponse(int code, String contentType, InputStream payload)
