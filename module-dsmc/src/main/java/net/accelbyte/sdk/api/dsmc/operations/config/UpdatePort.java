...
import net.accelbyte.sdk.api.dsmc.operation_responses.config.UpdatePortOpResponse;
...
public class UpdatePort extends Operation {
  ...
  @Deprecated
  public UpdatePort(
      String customBasePath, String name, String namespace, ModelsUpdatePortRequest body) {
    this.name = name;
  ...
  public UpdatePortOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final UpdatePortOpResponse response = new UpdatePortOpResponse();
