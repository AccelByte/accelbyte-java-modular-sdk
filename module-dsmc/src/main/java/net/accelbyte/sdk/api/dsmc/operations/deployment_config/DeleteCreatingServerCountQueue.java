...
public class DeleteCreatingServerCountQueue extends Operation {
     ...
     */
    private String path = "/dsmcontroller/admin/namespaces/{namespace}/configs/deployments/{deployment}/versions/{version}/queues";
    ...
    */
    ...
    public DeleteCreatingServerCountQueue(
            String customBasePath,            String deployment,
            String namespace,
            String version
    )
    {
    ...
    public DeleteCreatingServerCountQueueOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final DeleteCreatingServerCountQueueOpResponse response = new DeleteCreatingServerCountQueueOpResponse();
