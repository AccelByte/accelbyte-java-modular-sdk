...
public class DeleteCreatingServerCountQueue extends Operation {
  ...
  public DeleteCreatingServerCountQueueOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final DeleteCreatingServerCountQueueOpResponse response =
        new DeleteCreatingServerCountQueueOpResponse();
