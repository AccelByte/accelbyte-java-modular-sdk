...
public class Public {
     ...
     */
    public GetDefaultProviderOpResponse getDefaultProvider(GetDefaultProvider input) throws Exception {
     ...
     */
    public ListProvidersByRegionOpResponse listProvidersByRegion(ListProvidersByRegion input) throws Exception {
        if (input.getCustomBasePath().equals("") && !customBasePath.equals("")) {
            input.setCustomBasePath(customBasePath);
        }
