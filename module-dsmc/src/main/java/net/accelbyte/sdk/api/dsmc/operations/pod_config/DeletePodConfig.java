...
import net.accelbyte.sdk.api.dsmc.operation_responses.pod_config.DeletePodConfigOpResponse;
...
public class DeletePodConfig extends Operation {
  ...
  @Deprecated
  public DeletePodConfig(String customBasePath, String name, String namespace) {
    this.name = name;
  ...
  public DeletePodConfigOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final DeletePodConfigOpResponse response = new DeletePodConfigOpResponse();
