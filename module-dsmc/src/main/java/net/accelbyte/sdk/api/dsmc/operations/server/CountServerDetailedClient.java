...
public class CountServerDetailedClient extends Operation {
    ...
    */
    ...
    public CountServerDetailedClientOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CountServerDetailedClientOpResponse response = new CountServerDetailedClientOpResponse();
