...
import net.accelbyte.sdk.api.dsmc.operation_responses.admin.ListSessionOpResponse;
...
public class ListSession extends Operation {
    ...
    */
    ...
    public ListSessionOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final ListSessionOpResponse response = new ListSessionOpResponse();
        ...
        if (code == 204) {
            ...
            response.setData(new ModelsListSessionResponse().createFromJson(json));
            response.setSuccess(true);
        }
        else if (code == 401) {
            final String json = Helper.convertInputStreamToString(payload);
