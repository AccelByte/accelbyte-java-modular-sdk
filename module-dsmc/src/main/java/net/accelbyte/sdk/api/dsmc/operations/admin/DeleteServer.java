...
import net.accelbyte.sdk.api.dsmc.operation_responses.admin.DeleteServerOpResponse;
...
public class DeleteServer extends Operation {
  ...
  @Deprecated
  public DeleteServer(String customBasePath, String namespace, String podName) {
