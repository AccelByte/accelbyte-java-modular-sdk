...
public class CancelSession extends Operation {
  ...
  @Deprecated
  public CancelSession(String customBasePath, String namespace, String sessionID) {
  ...
  public CancelSessionOpResponse parseResponse(int code, String contentType, InputStream payload)
