...
import net.accelbyte.sdk.api.dsmc.operation_responses.pod_config.GetAllPodConfigClientOpResponse;
...
public class GetAllPodConfigClient extends Operation {
    ...
    */
    ...
    public GetAllPodConfigClientOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetAllPodConfigClientOpResponse response = new GetAllPodConfigClientOpResponse();
