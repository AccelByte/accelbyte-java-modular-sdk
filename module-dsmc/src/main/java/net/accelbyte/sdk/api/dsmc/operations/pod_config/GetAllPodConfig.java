...
import net.accelbyte.sdk.api.dsmc.operation_responses.pod_config.GetAllPodConfigOpResponse;
...
public class GetAllPodConfig extends Operation {
  ...
  @Deprecated
  public GetAllPodConfig(String customBasePath, String namespace, Integer count, Integer offset) {
  ...
  public GetAllPodConfigOpResponse parseResponse(int code, String contentType, InputStream payload)
      throws HttpResponseException, IOException {
    final GetAllPodConfigOpResponse response = new GetAllPodConfigOpResponse();
    ...
    if (code == 204) {
      ...
      response.setData(new ModelsListPodConfigResponse().createFromJson(json));
      response.setSuccess(true);
    } else if (code == 400) {
      final String json = Helper.convertInputStreamToString(payload);
