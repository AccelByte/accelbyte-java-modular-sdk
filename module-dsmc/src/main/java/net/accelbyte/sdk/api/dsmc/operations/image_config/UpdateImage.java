...
public class UpdateImage extends Operation {
  ...
  @Deprecated
  public UpdateImage(String customBasePath, ModelsImageRecordUpdate body) {
    this.body = body;
  ...
  public UpdateImageOpResponse parseResponse(int code, String contentType, InputStream payload)
