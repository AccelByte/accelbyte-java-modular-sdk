...
import net.accelbyte.sdk.api.dsmc.operation_responses.pod_config.UpdatePodConfigOpResponse;
...
public class UpdatePodConfig extends Operation {
    ...
    */
    ...
    public UpdatePodConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final UpdatePodConfigOpResponse response = new UpdatePodConfigOpResponse();
