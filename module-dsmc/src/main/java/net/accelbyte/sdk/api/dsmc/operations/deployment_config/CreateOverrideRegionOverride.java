...
public class CreateOverrideRegionOverride extends Operation {
  ...
  public CreateOverrideRegionOverrideOpResponse parseResponse(
      int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
    final CreateOverrideRegionOverrideOpResponse response =
        new CreateOverrideRegionOverrideOpResponse();
