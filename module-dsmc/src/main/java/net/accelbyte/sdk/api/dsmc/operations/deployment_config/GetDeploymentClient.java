...
public class GetDeploymentClient extends Operation {
    ...
    */
    ...
    public GetDeploymentClientOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final GetDeploymentClientOpResponse response = new GetDeploymentClientOpResponse();
