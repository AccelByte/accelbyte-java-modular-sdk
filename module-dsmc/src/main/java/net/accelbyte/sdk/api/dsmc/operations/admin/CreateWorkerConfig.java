...
import net.accelbyte.sdk.api.dsmc.operation_responses.admin.CreateWorkerConfigOpResponse;
...
public class CreateWorkerConfig extends Operation {
    ...
    */
    ...
    public CreateWorkerConfigOpResponse parseResponse(int code, String contentType, InputStream payload) throws HttpResponseException, IOException {
        final CreateWorkerConfigOpResponse response = new CreateWorkerConfigOpResponse();
